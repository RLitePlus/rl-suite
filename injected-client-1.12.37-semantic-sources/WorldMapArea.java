...
public class WorldMapArea implements WorldMapData {
   ...
   @ObfuscatedName("rx")
   public static void method5822(WorldMapArea var0, classXY var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("tm")
   public static classHM method5826(WorldMapArea var0, classXY var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lgx;Lxy;)Lhm;")
   @ObfuscatedName("vv")
   public static classHM method5828(WorldMapArea var0, classXY var1) {
      if (var0 == null) {
         var0.method5881();
      }
