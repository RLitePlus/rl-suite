...
public class classYA implements Iterator {
   ...
   @ObfuscatedName("az")
   IterableNodeHashTable field6962;
   @ObfuscatedName("ae")
   int field6963;
   @ObfuscatedSignature(descriptor = "Lvq;")
   @ObfuscatedName("ab")
   ...
   public classYA(IterableNodeHashTable var1) {
      this.field6962 = var1;
      this.method13278();
   }
   ...
   public Object next() {
      if (this.field6964 != this.field6962.field7017[this.field6963 - 1]) {
         Node var2 = this.field6964;
         this.field6964 = var2.field6554;
         this.field6961 = var2;
         return var2;
      } else {
         while (this.field6963 < this.field6962.field7018) {
            Node var1 = this.field6962.field7017[this.field6963++].field6554;
   ...
   @ObfuscatedName("fh")
   public static Node method13283(classYA var0) {
      if (var0 == null) {
         var0.method13294();
      }
   ...
   public static Object method13288(classYA var0) {
      if (var0.field6964 != var0.field6962.field7017[var0.field6963 - 1]) {
         Node var2 = var0.field6964;
         var0.field6964 = var2.field6554;
         var0.field6961 = var2;
         return var2;
      } else {
         while (var0.field6963 < var0.field6962.field7018) {
            Node var1 = var0.field6962.field7017[var0.field6963++].field6554;
   ...
   @ObfuscatedName("er")
   public static WorldEntity method13298(classCL var0, int var1) {
      return var0 == null ? var0.method1600(var1) : (WorldEntity)classCL.method1592(var0, 839252882).worldEntities.method13595(var1);
   }
   ...
   @ObfuscatedName("br")
   public static void method13276(classYA var0, IterableNodeHashTable var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("az")
   public void method13277(IterableNodeHashTable var1) {
      this.field6962 = var1;
      this.method13281();
   }
}
