...
public class classKA {
   ...
   @ObfuscatedName("fj")
   static ClanChannel field3513;

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lrt;Laae;)Lrr;")
   @ObfuscatedName("aq")
   public static User method6446(UserList var0, classAAE var1) {
      if (var0 == null) {
         var0.getMembers();
      }

      return !var1.method171(1073339404) ? null : (User)var0.field5844.get(var1);
   }
