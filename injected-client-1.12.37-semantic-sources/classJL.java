...
@ObfuscatedName("jl")
public class classJL extends Node {
   @ObfuscatedSignature(descriptor = "Lxs;")
   @ObfuscatedName("ac")
   public PacketBuffer field3343;
   ...
   public static classJL method6384() {
      classJL var0 = SceneTilePaint.method4793(1410588756);
      var0.field3342 = null;
      var0.field3339 = 0;
      var0.field3343 = new PacketBuffer(5000);
      return var0;
   }
   ...
   public static classJL method6382(classJS var0, classYT var1) {
      classJL var2 = SceneTilePaint.method4793(2109786031);
      var2.field3342 = var0;
      var2.field3339 = -1950310809 * var0.field3371;
      if (-1669214905 * var2.field3339 == -1) {
         var2.field3343 = new PacketBuffer(260);
      } else if (-1669214905 * var2.field3339 == -2) {
         var2.field3343 = new PacketBuffer(10000);
      } else if (var2.field3339 * -1669214905 <= 18) {
         var2.field3343 = new PacketBuffer(20);
      } else if (var2.field3339 * -1669214905 <= 98) {
         var2.field3343 = new PacketBuffer(100);
      } else {
         var2.field3343 = new PacketBuffer(260);
      }
   ...
   public static classJL method6383(classJS var0, classYT var1) {
      classJL var2 = SceneTilePaint.method4793(2128648648);
      var2.field3342 = var0;
      var2.field3339 = -1950310809 * var0.field3371;
      if (-1669214905 * var2.field3339 == -1) {
         var2.field3343 = new PacketBuffer(260);
   ...
   public static classJL method6385() {
      classJL var0 = SceneTilePaint.method4793(1619799152);
      var0.field3342 = null;
      var0.field3339 = 0;
      var0.field3343 = new PacketBuffer(5000);
      return var0;
   ...
   public static classJL method6386() {
      classJL var0 = SceneTilePaint.method4793(1568205369);
      var0.field3342 = null;
      var0.field3339 = 0;
      var0.field3343 = new PacketBuffer(5000);
      return var0;
