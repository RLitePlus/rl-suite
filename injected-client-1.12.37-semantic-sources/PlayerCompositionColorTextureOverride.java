...
public class PlayerCompositionColorTextureOverride implements ColorTextureOverride {
   ...
   @ObfuscatedName("aa")
   public static PlayerCompositionColorTextureOverride method8896(int var0, classXY var1) {
   ...
   @ObfuscatedSignature(descriptor = "(ILxy;)Lpi;")
   @ObfuscatedName("ac")
   public static PlayerCompositionColorTextureOverride method8897(int var0, classXY var1) {
      int var2 = classXY.method13039(var1, -346779531);
      boolean var3 = (var2 & 1) != 0;
      boolean var4 = 0 != (var2 & 2);
      boolean var5 = (var2 & 4) != 0;
