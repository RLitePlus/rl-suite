...
public class rl10 implements Tile {
   ...
   public void setGroundObject(GroundObject var1) {
      this.field5691.field2010[this.field5692] = (FloorDecoration)var1;
      if (var1 == null) {
   ...
   public void setSceneTilePaint(net.runelite.api.SceneTilePaint var1) {
      this.field5691.field2006[this.field5692] = (SceneTilePaint)var1;
   }

   public List getGroundItems() {
      ItemLayer var1 = this.method10040();
      if (var1 == null) {
         return null;
      } else {
         ArrayList var2 = new ArrayList();

         for (Object var3 = var1.method3955(); var3 instanceof TileItem; var3 = ((Node)var3).method12064()) {
   ...
   @ObfuscatedName("xz")
   public FloorDecoration method10039() {
   ...
   @ObfuscatedName("lf")
   public SceneTileModel method10035() {
   ...
   public void setSceneTileModel(net.runelite.api.SceneTileModel var1) {
      this.field5691.field2007[this.field5692] = (SceneTileModel)var1;
   }

   public rl10(Scene var1, int var2) {
      this.field5691 = var1;
      this.field5692 = var2;
   }
}
