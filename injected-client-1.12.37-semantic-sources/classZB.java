...
final class classZB implements classYH {
   ...
   public void vmethod656(Object var1, classXY var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "zb.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Lxy;)V")
   @ObfuscatedName("as")
   void method13822(String var1, classXY var2) {
      classXY.method12997(var2, var1, (short)21261);
   }
   ...
   public Object vmethod653(classXY var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "zb.af(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Lxy;)V")
   @ObfuscatedName("ao")
   void method13823(String var1, classXY var2) {
      classXY.method12997(var2, var1, (short)9466);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Lxy;)V")
   @ObfuscatedName("ab")
   void method13824(String var1, classXY var2) {
      classXY.method12997(var2, var1, (short)23706);
   }

   @ObfuscatedSignature(descriptor = "(Lzb;Ljava/lang/String;Lxy;I)V")
   @ObfuscatedName("sm")
   public static void method13825(classZB var0, String var1, classXY var2, int var3) {
      if (var0 == null) {
         var0.method13827(var1, var2, var3);
      } else {
         try {
            classXY.method12997(var2, var1, (short)2569);
         } catch (RuntimeException var4) {
            throw classEG.method3884(var4, "zb.az(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Lxy;)V")
   @ObfuscatedName("ag")
   void method13826(String var1, classXY var2) {
      classXY.method12997(var2, var1, (short)13128);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Lxy;I)V")
   @ObfuscatedName("az")
   void method13827(String var1, classXY var2, int var3) {
      try {
         classXY.method12997(var2, var1, (short)2569);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "zb.az(" + ')');
