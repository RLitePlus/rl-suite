...
public class classLK {
   ...
   public static void method7118(client var0) {
      ...
      if (MouseHandler.field6261 * 1229235359 == 1
         ...
         long var1 = MouseHandler.field6258 * 5802030557961029083L - client.field893 * -1592775510923690537L;
         if (var1 > 32767L) {
            var1 = 32767L;
         }

         client.field893 = MouseHandler.field6258 * 3775164370123526045L;
         ...
         var6.field3343.method12973((var5 << 1) + (1229235359 * MouseHandler.field6261 == 2 ? 1 : 0), -1542382992);
