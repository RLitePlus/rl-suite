...
public class WorldMapElement extends classVJ implements MapElementConfig {
   ...
   @ObfuscatedName("th")
   public static void method9187(WorldMapElement var0, classXY var1, byte var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("eh")
   public static void method9193(WorldMapElement var0, classXY var1, int var2, int var3) {
      if (var0 == null) {
