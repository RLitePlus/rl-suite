...
public final class IndexedObjectSet implements Iterable, net.runelite.api.IndexedObjectSet {
   ...
   @ObfuscatedName("uw")
   public static void method13402(ClientPreferences var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("tg")
   public static void method13395(IndexedObjectSet var0) {
      if (var0 == null) {
         var0.method13400();
      }
   ...
   @ObfuscatedName("fe")
   public static Node method13401(NodeHashTable var0) {
      if (var0 == null) {
         var0.method13379();
      }
   ...
   @ObfuscatedName("nr")
   public static void method13392(IndexedObjectSet var0, classVO var1, long var2) {
      if (var0 == null) {
