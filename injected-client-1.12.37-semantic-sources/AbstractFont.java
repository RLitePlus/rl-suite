...
@ObfuscatedName("aaa")
public abstract class AbstractFont extends classYW implements FontTypeFace {
   @ObfuscatedName("ah")
   byte[][] field4;
   @ObfuscatedName("at")
   public int field8 = 0;
   ...
   @ObfuscatedName("af")
   public static IndexedSprite[] field25;
   @ObfuscatedName("bc")
   int[] field7;
   @ObfuscatedName("bp")
   int[] field5;
   ...
   @ObfuscatedName("yv")
   public static void method58(AbstractFont var0, String var1, int var2, int var3, int var4, int var5, int var6) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ie")
   public static void method99(AbstractFont var0, int var1, int var2, int var3, int var4) {
      var3 -= var0.field8;
      int var5 = var1 & 0xFF;
      if (var5 != 32) {
   ...
   @ObfuscatedName("rf")
   public static void method87(AbstractFont var0, String var1, int var2, int var3, int var4, int var5, int[] var6) {
      if (var0 == null) {
                     ...
                     if (!var12.equals("nbh")) {
                        if (var12.startsWith("img=")) {
                           try {
                              ...
                              IndexedSprite var27 = field25[var26];
                              IndexedSprite.method13810(var27, var2 + var23, var3 + this.field8 - var27.field7120 + var25);
   ...
   @ObfuscatedSignature(descriptor = "(Laaa;IIII)V")
   @ObfuscatedName("be")
   public static void method100(AbstractFont var0, int var1, int var2, int var3, int var4) {
      var3 -= var0.field8;
      int var5 = var1 & 0xFF;
      if (var5 != 32) {
         var0.vmethod1(var0.field4[var5], var2 + var0.field5[var5], var3 + var0.field3[var5], var0.field6[var5], var0.field7[var5], var4);
                  ...
                  if (var13.equals("lt")) {
                     ...
                     if (var13.startsWith("img=")) {
                        try {
                           ...
                           IndexedSprite var18 = field25[var16];
                           IndexedSprite.method13810(var18, var2, var3 + this.field8 - var18.field7120);
   ...
   @ObfuscatedName("it")
   public static void method104(AbstractFont var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("nw")
   public static void method27(AbstractFont var0, byte[] var1) {
      if (var0 == null) {
         var0.method32(var1);
      } else {
   ...
   @ObfuscatedName("vx")
   public static void method117(AbstractFont var0, String var1, int var2, int var3) {
      var3 -= var0.field8;
      int var4 = -1;
      int var5 = -1;
                  ...
                  if (var13.equals("lt")) {
                     ...
                     if (var13.startsWith("img=")) {
                        try {
                           ...
                           IndexedSprite var18 = field25[var16];
                           IndexedSprite.method13810(var18, var2, var3 + var0.field8 - var18.field7120);
                           var2 += var18.field7124;
                           var5 = -1;
                        } catch (Exception var11) {
                        }
   ...
   @ObfuscatedName("ko")
   public static void method86(AbstractFont var0, String var1, int var2, int var3, int var4, int var5, int var6, int var7, int[] var8) {
      if (var0 == null) {
   ...
   @ObfuscatedName("qm")
   public static int[] method95(AbstractFont var0, int[] var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("hh")
   public static void method114(AbstractFont var0, String var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("hr")
   public static void method80(AbstractFont var0, String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
      if (var0 == null) {
   ...
   @ObfuscatedName("se")
   public static int method67(AbstractFont var0, String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Laaa;Ljava/lang/String;IIIII[I)V")
   @ObfuscatedName("ld")
   public static void method83(AbstractFont var0, String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
      if (var0 == null) {
         var0.method60(var1, var2, var2, var2, var2, var2);
      } else if (var1 != null) {
         method104(var0, var4, var5);
