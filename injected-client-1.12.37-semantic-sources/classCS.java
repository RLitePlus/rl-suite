               ...
               if (var31 == var7) {
                  ...
                  if (var29 == var8) {
                     ...
                     for (int var17 = var31 * var16; var17 < -622036481 * World.field1153; var17++) {
                        ...
                        label466: {
                           if (MouseHandler.field6255 * -38255113 >= var13 && MouseHandler.field6264 * -2144333897 >= var12) {
                              if (var2 <= 1) {
                                 throw new IllegalStateException();
                              }

                              if (-38255113 * MouseHandler.field6255 < var25 + var13) {
                                 if (var2 <= 1) {
                                    throw new IllegalStateException();
                                 }

                                 if (-2144333897 * MouseHandler.field6264 < var27 + var12) {
                                    if (var2 <= 1) {
                                       throw new IllegalStateException();
                                    }
                     ...
                     if (var15) {
                        ...
                        int var36 = MouseHandler.field6264 * -2144333897 + 25;
                        if (var35 + var36 > 480) {
                           if (var2 <= 1) {
                              throw new IllegalStateException();
                           }

                           var36 = -2144333897 * MouseHandler.field6264 - 25 - var35;
                        }

                        classYW.method13698(-38255113 * MouseHandler.field6255 - var34 / 2, var36, var34, var35, 16777120);
                        classYW.method13707(MouseHandler.field6255 * -38255113 - var34 / 2, var36, var34, var35, 0);
                        var1.method65(
                           World.field1170[classBF.field400 * -2105609177].field1167, MouseHandler.field6255 * -38255113, var36 + var1.field8 + 4, 0, -1
                        );
                     }
                     break;
                  }
