...
public class ClientPreferences implements Preferences {
   ...
   ClientPreferences(classXY var1) {
   ...
   static ClientPreferences method2701() {
      ...
      try {
         ...
         var1 = new ClientPreferences(new classXY(var2));
   ...
   classXY method2709() {
      ...
      classXY.method12997(var1, null != this.rememberedUsername ? this.rememberedUsername : "", (short)15792);
   ...
   classXY method2710() {
      ...
      classXY.method12997(var1, null != this.rememberedUsername ? this.rememberedUsername : "", (short)25840);
      classXY.method12994(var1, this.field1341, -1737488759);
   ...
   @ObfuscatedName("di")
   public static classXY method2711(ClientPreferences var0) {
      if (var0 == null) {
         var0.method2842();
      }
      ...
      classXY.method12997(var1, null != var0.rememberedUsername ? var0.rememberedUsername : "", (short)23385);
   ...
   @ObfuscatedName("sd")
   public static classXY method2712(ClientPreferences var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            classXY.method12997(var2, null != var0.rememberedUsername ? var0.rememberedUsername : "", (short)28546);
   ...
   classXY method2713(int var1) {
      try {
         ...
         classXY.method12997(var2, null != this.rememberedUsername ? this.rememberedUsername : "", (short)28546);
