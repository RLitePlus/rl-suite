      ...
      if (this.field2203 == null) {
         ...
         if (var2 != null && var2.method6998((byte)-26)) {
            switch (var1) {
               ...
               case 65:
                  if (this.field2201) {
                     Clipboard var7 = GameEngine.method10966(classOE.field4843, (byte)-77);
               ...
               case 66:
                  if (this.field2201) {
                     Clipboard var6 = GameEngine.method10966(classOE.field4843, (byte)-97);
               ...
               case 67:
                  if (this.field2201) {
                     Clipboard var5 = GameEngine.method10966(classOE.field4843, (byte)-22);
            ...
            if (var3 != null) {
               ...
               if (var3.method6998((byte)4)) {
                  switch (var1) {
                     ...
                     case 65:
                        if (this.field2201) {
                           Clipboard var9 = GameEngine.method10966(classOE.field4843, (byte)-5);
                     ...
                     case 66:
                        if (this.field2201) {
                           ...
                           Clipboard var8 = GameEngine.method10966(classOE.field4843, (byte)-34);
                     ...
                     case 67:
                        if (this.field2201) {
                           Clipboard var7 = GameEngine.method10966(classOE.field4843, (byte)-79);
