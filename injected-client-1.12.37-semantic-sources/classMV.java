...
public class classMV {
   ...
   public void method7730(Comparator var1, boolean var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "mv.az(" + ')');
      }
   }

   public classMV(classXY var1, boolean var2) {
      int var3 = classXY.method13047(var1, 1043215320);
      boolean var4 = classXY.method13039(var1, -346779531) == 1;
      byte var5;
      if (var4) {
         var5 = 1;
      } else {
      ...
      int var6 = classXY.method13047(var1, 1135316952);
