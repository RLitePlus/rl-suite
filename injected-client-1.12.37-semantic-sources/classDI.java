...
public final class classDI {
   ...
   @ObfuscatedName("bk")
   static final void method3314(WorldView var0, classXY var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;Lxy;IIIIII)V")
   @ObfuscatedName("bo")
   static final void method3315(WorldView var0, classXY var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int[][][] var8 = var0.field1688;
      byte[][][] var9 = var0.field1702;
      if (var2 >= 0 && var2 < 4 && var3 >= 0 && var3 < var8[0].length - 1 && var4 >= 0 && var4 < var8[0][0].length - 1) {
         var9[var2][var3][var4] = 0;
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;Lxy;IIIIII)V")
   @ObfuscatedName("bu")
   static final void method3316(WorldView var0, classXY var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      int[][][] var8 = var0.field1688;
      byte[][][] var9 = var0.field1702;
      if (var2 >= 0 && var2 < 4 && var3 >= 0 && var3 < var8[0].length - 1 && var4 >= 0 && var4 < var8[0][0].length - 1) {
         var9[var2][var3][var4] = 0;
