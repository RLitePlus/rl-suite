...
public class classUF extends classUR {
   ...
   @ObfuscatedName("ae")
   @Override
   void vmethod579(classXY var1, int var2) {
   }

   @ObfuscatedSignature(descriptor = "(Lxy;IB)V")
   @ObfuscatedName("az")
   @Override
   void vmethod580(classXY var1, int var2, byte var3) {
      try {
         ;
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "uf.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   @Override
   void vmethod581(classXY var1, int var2) {
   }
   ...
   public static void method11299(String var0, byte var1) {
      try {
         classOE.field4843.getCallbacks().openUrl(var0);
      } catch (Exception var3) {
         client.field1026.error("unable to open url {}", var0, var3);
      }
   }
}
