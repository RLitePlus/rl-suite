...
public class classES extends classRD {
   ...
   public int compare(Object var1, Object var2) {
      try {
         return method4072(this, (classRI)var1, (classRI)var2, 580558154);
   ...
   public int method4074(Object var1, Object var2) {
      return method4072(this, (classRI)var1, (classRI)var2, 1834300038);
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Les;Lri;Lri;)I")
   @ObfuscatedName("gt")
   public static int method4069(classES var0, classRI var1, classRI var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("af")
   int method4070(classRI var1, classRI var2) {
   ...
   @ObfuscatedSignature(descriptor = "(Lri;Lri;)I")
   @ObfuscatedName("ab")
   int method4071(classRI var1, classRI var2) {
   ...
   @ObfuscatedName("wb")
   public static int method4072(classES var0, classRI var1, classRI var2, int var3) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ag")
   static void method4075(classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         for (int var12 = 0; var12 < var10 + classZH.method14003(var0.field1697, (byte)10); var12++) {
            ...
            if (var12 < var10) {
               ...
               var13 = (classDH)var0.field1694.method13404(var11[var12]);
               if (var11[var12] == var8) {
                  continue;
               }
               ...
               var13 = (classDH)var0.field1698.method13404(var0.field1697.method14001(var12 - var10, 1596834634));
            }
   ...
   @ObfuscatedName("az")
   int method4073(classRI var1, classRI var2, int var3) {
      try {
