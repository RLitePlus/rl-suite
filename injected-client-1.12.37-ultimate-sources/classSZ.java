...
public class classSZ {
   ...
   @ObfuscatedName("at")
   static classLW field6110;

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lsp;Lsp;Z)Z")
   @ObfuscatedName("ae")
   public static boolean method10722(classSP var0, classSP var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else if (var1 == null) {
         return true;
   ...
   @ObfuscatedName("aw")
   static int method10730(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, classFP var9, int var10) {
      try {
         ...
         int var14 = var1 + classFP.method4909(var9, (byte)4);
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;Lsp;Z)Z")
   @ObfuscatedName("af")
   public static boolean method10723(classSP var0, classSP var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else if (var1 == null) {
         return true;
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;Lsp;Z)Z")
   @ObfuscatedName("ab")
   public static boolean method10724(classSP var0, classSP var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else if (var1 == null) {
         return true;
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;Lsp;Z)Z")
   @ObfuscatedName("ag")
   public static boolean method10725(classSP var0, classSP var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else if (var1 == null) {
         return true;
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;Lsp;Z)Z")
   @ObfuscatedName("as")
   public static boolean method10726(classSP var0, classSP var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else if (var1 == null) {
         return true;
   ...
   @ObfuscatedName("az")
   public static void method10729(classZR var0, int var1) {
      try {
         classEQ.method3952(var0, 500000, 475000, (byte)-55);
