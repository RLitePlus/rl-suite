...
@ObfuscatedName("hy")
public class classHY extends classGX {
   @ObfuscatedName("al")
   HashSet field2912;
   @ObfuscatedName("ay")
   List field2913;
   ...
   @ObfuscatedName("ce")
   void method6129(classXY var1, boolean var2, int var3) {
      try {
         this.field2913 = new LinkedList();
         int var4 = classXY.method13047(var1, -907205401);
         ...
         for (int var5 = 0; var5 < var4; var5++) {
            ...
            int var6 = classXY.method13110(var1, -324749371);
         ...
         throw classEG.method3884(var9, "hy.ce(" + ')');
      }
   }
   ...
   @ObfuscatedName("cm")
   void method6130(classXY var1, boolean var2) {
      this.field2913 = new LinkedList();
      int var3 = classXY.method13047(var1, -180237716);

      for (int var4 = 0; var4 < var3; var4++) {
         int var5 = classXY.method13110(var1, -324749371);
         classKY var6 = new classKY(var1.method13056((byte)1));
         boolean var7 = classXY.method13039(var1, -346779531) == 1;
         if (var2 || !var7) {
   ...
   @ObfuscatedName("en")
   public static void method6127(classHY var0, classXY var1, classXY var2, int var3, boolean var4, byte var5) {
      if (var0 == null) {
         var0.method6128(var1, var1, var3, var4, var5);
      } else {
         try {
            var0.method5820(var1, var3, 1246613763);
            int var6 = classXY.method13047(var2, -411743696);
            ...
            int var14 = classXY.method13047(var2, -949121677);
            ...
            throw classEG.method3884(var13, "hy.cx(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Z)V")
   @ObfuscatedName("dc")
   void method6131(classXY var1, boolean var2) {
      this.field2913 = new LinkedList();
      int var3 = classXY.method13047(var1, 1309326328);
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Z)V")
   @ObfuscatedName("dd")
   void method6132(classXY var1, boolean var2) {
      this.field2913 = new LinkedList();
      int var3 = classXY.method13047(var1, 752768595);
   ...
   @ObfuscatedName("cx")
   void method6128(classXY var1, classXY var2, int var3, boolean var4, byte var5) {
      try {
