...
@ObfuscatedName("ch")
public final class classCH extends classDW {
   ...
   void vmethod189(int var1) {
      try {
         ...
         } else if (this.field734.field1581 == null) {
            if (var1 >= 832295818) {
               throw new IllegalStateException();
            } else {
               this.method3662(-621591188);
            }
         } else if (this.field734.field1581.field5325 != null) {
            classPL var2 = this.field734.field1581.method8955(652890385);
            if (var2 == null) {
               if (var1 >= 832295818) {
                  throw new IllegalStateException();
               } else {
               ...
               classDW.method3648(this, var2.field5283, var2.field5335, (byte)-56);
         ...
         throw classEG.method3884(var4, "ch.az(" + ')');
      }
   }
   ...
   int vmethod194(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ch.af(" + 41);
      }
   }
   ...
   int vmethod197(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ch.ae(" + 41);
      }
   }
   ...
   int vmethod202(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ch.ab(" + 41);
      }
   }
   ...
   int vmethod205(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ch.ag(" + 41);
      }
   }
   ...
   void vmethod190() {
      if (this.field734 != null) {
         if (this.field734.field1581 == null) {
            this.method3662(560337998);
         } else if (this.field734.field1581.field5325 != null) {
            classPL var1 = this.field734.field1581.method8955(652890385);
            if (var1 == null) {
               this.field1643 = true;
            } else {
               int var2 = -1727985133 * this.field1653.field6689;
               classDW.method3648(this, var1.field5283, var1.field5335, (byte)-105);
      ...
      if (this.field734 != null) {
         if (this.field734.field1581 == null) {
            ...
            if (var1 == null) {
               ...
               int var2 = -1727985133 * this.field1653.field6689;
               classDW.method3648(this, var1.field5283, var1.field5335, (byte)-36);
               if (var2 != -1727985133 * this.field1653.field6689) {
                  this.field1643 = true;
               }
            }
   ...
   @ObfuscatedName("ei")
   public static boolean method1499(classAAP var0) {
      return var0 == null ? var0.method233() : classAAP.field92 == var0;
   }
   ...
   static void method1501(
      ...
      try {
         ...
         classFX var26 = var15.method8544(var3, var4, var22, var24, var23, var25, -1320580868);
         if (var26 != null) {
            if (var14 <= 1600128213) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.method3884(var28, "ch.dz(" + ')');
      }
   }
      ...
      if (this.field734 != null) {
         if (this.field734.field1581 == null) {
            ...
            if (var1 == null) {
               ...
               int var2 = -1727985133 * this.field1653.field6689;
               classDW.method3648(this, var1.field5283, var1.field5335, (byte)-93);
   ...
   classCH(classDN var1) {
      super(var1.vmethod258((byte)-74), var1.field1581.field5283, var1.field1581.field5335);
      this.field734 = var1;
      if (var1.field1581.field5325 != null) {
         classPL var2 = var1.field1581.method8955(652890385);
         if (var2 != null) {
            classDW.method3648(this, var2.field5283, var2.field5335, (byte)-79);
         }
      }
   }
   ...
   public static int method1500(int var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ch.aw(" + 41);
      }
   }
      ...
      if (this.field734 != null) {
         if (this.field734.field1581 == null) {
            ...
            if (var1 == null) {
               ...
               classDW.method3648(this, var1.field5283, var1.field5335, (byte)-67);
   ...
   @ObfuscatedName("cn")
   static void method1502(classLW var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ch.cn(" + ')');
      }
   }
}
