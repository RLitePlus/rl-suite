...
public class classSC extends classSQ {
   ...
   void vmethod568(classGY var1, classSR var2, int var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var5, "sc.af(" + ')');
      }
   }
   ...
   static final void method10367(int var0, int var1) {
      try {
         ...
         switch (var0) {
            case 1:
               classCT.method2664(1450325754);
               break;
            case 2:
               classAC.method326(24, 2130611027);
               classSP.method10624(classKK.field3841, classKK.field3842, classKK.field3843, (byte)-96);
         }
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "sc.ak(" + ')');
      }
   }
   ...
   void vmethod573(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "sc.ab(" + ')');
      }
   }
   ...
   boolean vmethod571(classGY var1, int var2, int var3, int var4) {
      try {
         if (this.field5908 * -1143115881 >= this.field5910 * 823938901) {
            ...
            float var5 = classRT.method10187(var2, this.field5908 * -1143115881, 823938901 * this.field5910, 862332991);
            classRU.method10275(this.field5907, this.field5909, var5, var1, (short)246);
            boolean var10000;
            if (var5 >= 1.0F) {
               if (var4 <= 517141950) {
                  throw new IllegalStateException();
         ...
         throw classEG.method3884(var6, "sc.ae(" + ')');
      }
   }
   ...
   boolean vmethod572(classGY var1, int var2, int var3) {
      if (this.field5908 * -1143115881 >= this.field5910 * 823938901) {
         ...
         float var4 = classRT.method10187(var2, this.field5908 * 1707513826, 1874518264 * this.field5910, 1880698948);
         classRU.method10275(this.field5907, this.field5909, var4, var1, (short)246);
         return var4 >= 1.0F;
      }
   }
