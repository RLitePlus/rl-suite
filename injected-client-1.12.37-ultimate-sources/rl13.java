...
class rl13 implements Rasterizer {
   ...
   public static void method10045(classQN var0) {
      for (classZR var1 = (classZR)var0.field5568.method8167(); null != var1; var1 = (classZR)classAAX.method294(var0.field5568)) {
         if (var1.method14130(-1238165748)) {
            var1.vmethod398();
            classZR.method14092(var1, 1323379080).field4322 = false;
         }
      }
