...
public class classYY implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "yy.az(" + 41);
      }
   }
   ...
   static String method13778(long var0, int var2, boolean var3, classRZ var4, byte var5) {
      try {
         ...
         throw classEG.method3884(var6, "yy.ae(" + ')');
      }
   }
   ...
   public static classYY method13783(Class var0, int var1) {
      try {
         ...
         throw classEG.method3884(var5, "yy.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Object;Lxy;S)V")
   @ObfuscatedName("ax")
   public static void method13784(Object var0, classXY var1, short var2) {
      try {
         ...
         throw classEG.method3884(var6, "yy.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("ac")
   public Object method13787(classXY var1, int var2) {
      try {
         return this.field7110.vmethod653(var1, (byte)-99);
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "yy.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/Object;")
   @ObfuscatedName("ap")
   public Object method13788(classXY var1) {
      return this.field7110.vmethod653(var1, (byte)-19);
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/Object;")
   @ObfuscatedName("aq")
   public Object method13789(classXY var1) {
   ...
   @ObfuscatedName("ay")
   public static void method13785(Object var0, classXY var1) {
   ...
   @ObfuscatedSignature(descriptor = "(Ljava/lang/Object;Lxy;)V")
   @ObfuscatedName("aj")
   public static void method13786(Object var0, classXY var1) {
      Class var3 = var0.getClass();
   ...
   public static classYY[] method13782(byte var0) {
      try {
         ...
         throw classEG.method3884(var1, "yy.ag(" + ')');
      }
   }
   ...
   public static classYY method13792(int var0) {
      return classRN.method10130(var0, 675005370);
   }
   ...
   @ObfuscatedName("bi")
   static classUZ method13790(classDZ var0, int var1, int var2, byte var3) {
      try {
         if (var0 != null) {
            if (var3 <= 99) {
               throw new IllegalStateException();
            ...
            if (var0 != classIS.field3053) {
               classSP var4 = (classSP)classIS.field3053.field1700.method13595(2140889407 * var0.field1699);
               if (var4 == null) {
                  if (var3 <= 99) {
                     throw new IllegalStateException();
                  }
         ...
         throw classEG.method3884(var5, "yy.bi(" + ')');
      }
   }
   ...
   static void method13791(int var0) {
      try {
         ...
         throw classEG.method3884(var1, "yy.hp(" + ')');
      }
   }
}
