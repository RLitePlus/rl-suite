...
public class classRK {
            ...
            if (classRX.field5869 != var24) {
               switch (var24.field5868 * 2061130823) {
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     classDN.method3495(var22, var2, var3, -1761067385);
                     break;
                  case 5:
            ...
            if (classRX.field5869 != var24) {
               switch (var24.field5868 * 2061130823) {
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     classDN.method3495(var22, var2, var3, -576677387);
                     break;
                  case 5:
            ...
            if (classRX.field5869 != var24) {
               switch (var24.field5868 * 2061130823) {
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     classDN.method3495(var22, var2, var3, -1396788117);
                     break;
                  case 5:
            ...
            if (classRX.field5869 != var24) {
               switch (var24.field5868 * 2061130823) {
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     classDN.method3495(var22, var2, var3, -1720562356);
                     break;
                  case 5:
      ...
      if (var4.length == 1) {
         ...
         if (var4.length > 1) {
            ...
            if (var7.equals("spacer")) {
               ...
               classRA var32 = classBS.method1207(var7.substring("spacer_".length()), -1330660453);
               ...
               classRA var31 = classBS.method1207(var7.substring("decimal_".length()), 907865414);
               ...
               classRA var29 = classBS.method1207(var7.substring("percent_".length()), -110816709);
   ...
   @ObfuscatedName("au")
   public static classYM method10006(classPX var0) {
      if (1254761701 * var0.field5479 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)classPX.field5476.method6422(var0.field5479 * 1254761701);
         if (var1 != null) {
            return var1;
         } else {
            var1 = classPN.method9038(classKJ.field3605, 1254761701 * var0.field5479, 0, -1923425365);
            if (null != var1) {
               classPX.field5476.method6428(var1, 1254761701 * var0.field5479);
            }
      ...
      if (var4.length == 1) {
         ...
         if (var4.length > 1) {
            ...
            if (var7.equals("spacer")) {
               ...
               classRA var32 = classBS.method1207(var7.substring("spacer_".length()), 1089735267);
               var6 = classXW.method12950(var5, 1910078687 * var32.field5631, true, var32.field5630, var8, (byte)-51);
            } else if (var7.startsWith("decimal_")) {
               classRA var31 = classBS.method1207(var7.substring("decimal_".length()), -1412412396);
               ...
               classRA var29 = classBS.method1207(var7.substring("percent_".length()), -767720142);
