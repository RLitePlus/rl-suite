...
@ObfuscatedName("wz")
public class classWZ implements Menu {
   @ObfuscatedName("jf")
   ...
   @ObfuscatedName("as")
   public final int[] field6800;
   @ObfuscatedName("ab")
   public final int[] field6801;
   @ObfuscatedName("ae")
   public final int[] field6802;
   @ObfuscatedName("ag")
   public final int[] field6803;
   @ObfuscatedName("aa")
   ...
   @ObfuscatedName("al")
   public final classWZ[] field6806;
   @ObfuscatedName("ai")
   int field6813;
   @ObfuscatedName("fo")
   ...
   public final void method12653(int var1, int var2, byte var3) {
      try {
         ...
         if (this.field6815 * 1457978411 + this.field6814 * -531540521 > classEU.field1938 * 8379747) {
            if (var3 != 0) {
               throw new IllegalStateException();
            }

            this.field6815 = classEU.field1938 * 132558761 - -28198139 * this.field6814;
         }
         ...
         if (this.field6816 * -1985221643 != -1) {
            ...
            if (null != this.field6806[this.field6816 * -1985221643]) {
               if (var3 != 0) {
                  throw new IllegalStateException();
               }

               this.field6806[this.field6816 * -1985221643].method12700(this, (short)4036);
            }
         }
   ...
   @ObfuscatedName("ab")
   final void method12700(classWZ var1, short var2) {
      ...
      if (this.field6814 * -531540521 + this.field6815 * 1457978411 > classEU.field1938 * 8379747) {
         this.field6815 = (classEU.field1938 * 8379747 - this.field6814 * -531540521) * -317857149;
      }
   ...
   public void method12699(int var1, int var2) {
      ...
      var4 = this.field6800[var1];
      this.field6800[var1] = this.field6800[var2];
      this.field6800[var2] = var4;
      ...
      var4 = this.field6802[var1];
      this.field6802[var1] = this.field6802[var2];
      this.field6802[var2] = var4;
      var4 = this.field6803[var1];
      this.field6803[var1] = this.field6803[var2];
      this.field6803[var2] = var4;
      boolean var5 = this.field6807[var1];
      this.field6807[var1] = this.field6807[var2];
      this.field6807[var2] = var5;
      classWZ var6 = this.field6806[var1];
      this.field6806[var1] = this.field6806[var2];
      this.field6806[var2] = var6;
   ...
   final int method12695(int var1, int var2, int var3) {
      int var4 = this == client.field974 ? client.field1087 : client.field1080;
   ...
   @ObfuscatedName("nq")
   public static void method12685(classWZ var0) {
      ...
      int var4 = classTZ.field6255 * -38255113;
      int var5 = -2144333897 * classTZ.field6264;
      ...
      for (int var6 = 0; var6 < -1927903443 * var0.field6797; var6++) {
         ...
         if (var6 == var0.field6816 * -1985221643 || -392503493 * var0.field6813 == var6 && var0.field6806[var6] != null) {
         ...
         if (var0.field6806[var6] != null) {
            classBB.field341.method101(62, 1308041153 * var0.field6812 + var1 - 10, var7, 16777215);
         }
      }

      if (-1 != -1985221643 * var0.field6816 && null != var0.field6806[var0.field6816 * -1985221643]) {
         var0.field6806[var0.field6816 * -1985221643].method12692(-2000686243);
      }
   }
   ...
   public final void method12673(int var1) {
      try {
         ...
         for (int var2 = 0; var2 < this.field6797 * -1927903443; var2++) {
            if (null != this.field6806[var2]) {
               if (var1 != 921182066) {
                  throw new IllegalStateException();
               }

               this.field6806[var2].method12673(921182066);
            }
         }
      } catch (RuntimeException var3) {
   ...
   public final void method12674() {
      ...
      for (int var1 = 0; var1 < this.field6797 * -1927903443; var1++) {
         if (null != this.field6806[var1]) {
            this.field6806[var1].method12673(921182066);
         }
      }
   }
      ...
      if (!classOE.field4843.isClientThread()) {
         ...
         if (var1 < this.field6797 * -1927903443) {
            ...
            for (int var4 = this.field6797 * -1927903443; var4 > var1; this.field6809[var4].field5802 = var4--) {
               ...
               this.field6800[var4] = this.field6800[var4 - 1];
               this.field6798[var4] = this.field6798[var4 - 1];
               this.field6799[var4] = this.field6799[var4 - 1];
               this.field6802[var4] = this.field6802[var4 - 1];
               this.field6803[var4] = this.field6803[var4 - 1];
               this.field6807[var4] = this.field6807[var4 - 1];
               this.field6806[var4] = this.field6806[var4 - 1];
         ...
         this.field6800[var2.field5802] = MenuAction.RUNELITE.getId();
         this.field6801[var2.field5802] = 0;
         this.field6798[var2.field5802] = 0;
         this.field6799[var2.field5802] = 0;
         this.field6802[var2.field5802] = -1;
         this.field6803[var2.field5802] = 0;
         this.field6806[var2.field5802] = null;
         var2.field5803 = null;
         return var2;
      }
   }
   ...
   public final void method12654(int var1, int var2) {
      ...
      if (this.field6815 * 1457978411 + this.field6814 * -531540521 > classEU.field1938 * 8379747) {
         this.field6815 = classEU.field1938 * -123479189 - -28198139 * this.field6814;
      }
      ...
      if (this.field6816 * -1985221643 != -1 && null != this.field6806[this.field6816 * -1985221643]) {
         this.field6806[this.field6816 * -796274021].method12700(this, (short)6966);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("if")
   public void method12691(classWZ var1) {
      int var2;
      if (var1 == null) {
      ...
      try {
         if (-1927903443 * this.field6797 < this.field6804.length) {
            if (var10 >= 657374242) {
               ...
               this.field6800[-1927903443 * this.field6797] = var3;
               ...
               this.field6802[-1927903443 * this.field6797] = var7;
               this.field6803[this.field6797 * -1927903443] = var9;
               this.field6807[-1927903443 * this.field6797] = var8;
               this.field6806[this.field6797 * -1927903443] = null;
   ...
   final void method12680(int var1) {
      try {
         if (-1985221643 * this.field6816 != -1) {
            if (null != this.field6806[-1985221643 * this.field6816]) {
               this.field6806[this.field6816 * -1985221643].method12678(-1332660037);
            }
   ...
   public final void method12686() {
      ...
      for (int var6 = 0; var6 < -1927903443 * this.field6797; var6++) {
         ...
         if (var6 == this.field6816 * -1985221643 || -392503493 * this.field6813 == var6 && this.field6806[var6] != null) {
         ...
         if (this.field6806[var6] != null) {
            classBB.field341.method101(62, 1308041153 * this.field6812 + var1 - 10, var7, 16777215);
         }
      }

      if (-1 != -1985221643 * this.field6816 && null != this.field6806[this.field6816 * -1985221643]) {
         this.field6806[this.field6816 * -1985221643].method12692(-1262452597);
      }
   }
   ...
   public final void method12655(int var1, int var2) {
      ...
      if (this.field6815 * -2010837480 + this.field6814 * -531540521 > classEU.field1938 * 1769000792) {
         this.field6815 = classEU.field1938 * -1549978419 - -28198139 * this.field6814;
      }
      ...
      if (this.field6816 * 79511146 != -1 && null != this.field6806[this.field6816 * -1985221643]) {
         this.field6806[this.field6816 * 677406674].method12700(this, (short)-21612);
      }
   }
   ...
   public final int method12684(String var1, String var2, int var3, int var4, int var5, int var6, int var7, boolean var8, int var9) {
      if (-1927903443 * this.field6797 < this.field6804.length) {
         ...
         this.field6799[this.field6797 * -1927903443] = var6;
         this.field6802[-1927903443 * this.field6797] = var7;
         this.field6803[this.field6797 * 481472702] = var9;
         this.field6807[938195248 * this.field6797] = var8;
         this.field6806[this.field6797 * 1044966345] = null;
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("di")
   public static void method12651(classWZ var0) {
      if (var0 == null) {
         var0.method12686();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("av")
   final void method12656(classWZ var1) {
      ...
      int var3 = 19 + var2;
      this.field6815 = var2 * -317857149;
      if (this.field6815 * 1457978411 + this.field6814 * -531540521 > 8379747 * classEU.field1938) {
   ...
   public void setMenuEntries(MenuEntry[] var1) {
      if (!classOE.field4843.isClientThread()) {
         ...
         if (classON.field4993 != null && this.field6797 * -1927903443 > 0) {
            var2 = classON.field4993.method1366() == this.field6800[this.field6797 * -1927903443 - 1]
               ...
               && classON.field4993.method1373() == this.field6802[this.field6797 * -1927903443 - 1]
               && classON.field4993.method1363() == this.field6803[this.field6797 * -1927903443 - 1];
         }
         ...
         if (var2 && this.field6797 * -1927903443 > 0) {
            ...
            classON.field4993.method1375(this.field6800[this.field6797 * -1927903443 - 1]);
            ...
            classON.field4993.method1361(this.field6802[this.field6797 * -1927903443 - 1]);
            classON.field4993.method1370(this.field6803[this.field6797 * -1927903443 - 1]);
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("at")
   final void method12657(classWZ var1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("og")
   public static void method12687(classWZ var0) {
      int var1 = var0.field6817 * 727605925;
      int var2 = 1457978411 * var0.field6815;
      int var3 = 6116423;
      classYW.method13698(var1, var2, var0.field6812 * 1308041153, var0.field6814 * -531540521, var3);
      ...
      if (-1 != -1985221643 * var0.field6816 && null != var0.field6806[var0.field6816 * -1985221643]) {
         var0.field6806[var0.field6816 * -1985221643].method12692(-1894339153);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("bf")
   public void method12708(classWZ var1) {
   ...
   @ObfuscatedName("uc")
   public static boolean method12669(classWZ var0, int var1, int var2) {
      if (-1 != -1985221643 * var0.field6816
         && null != var0.field6806[-1985221643 * var0.field6816]
         && var0.field6806[-1985221643 * var0.field6816].method12670(var1, var2, (short)14810)) {
         return true;
      } else {
      ...
      try {
         if (-1 != -1985221643 * this.field6816) {
            ...
            if (null != this.field6806[-1985221643 * this.field6816]) {
               ...
               if (this.field6806[-1985221643 * this.field6816].method12670(var1, var2, (short)-13951)) {
                  if (var3 == 765) {
                     throw new IllegalStateException();
                  }
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("ut")
   public static void method12688(classWZ var0) {
      if (var0 == null) {
         var0.method12676();
      } else {
         int var1 = var0.field6817 * 727605925;
         ...
         int var4 = classTZ.field6255 * 613408966;
         int var5 = -1630179091 * classTZ.field6264;
         ...
         for (int var6 = 0; var6 < -1927903443 * var0.field6797; var6++) {
            ...
            if (var6 == var0.field6816 * -1607949428 || -2128790815 * var0.field6813 == var6 && var0.field6806[var6] != null) {
         ...
         if (-1 != -1985221643 * var0.field6816 && null != var0.field6806[var0.field6816 * -1954792566]) {
            var0.field6806[var0.field6816 * -1985221643].method12692(-1803682473);
         }
      }
   }
   ...
   @ObfuscatedName("ms")
   public static boolean method12701(classWZ var0, int var1, int var2, int var3) {
      if (var0 == null) {
      ...
      if (var0.field6816 * -1985221643 != -1
         && var0.field6806[var0.field6816 * -1985221643] != null
         && var0.field6806[var0.field6816 * -1985221643].method12704(var1, var2)) {
         var4 = true;
         ...
         if (var5 != -1 && var5 != var0.field6816 * -1985221643) {
            ...
            if (var0.field6819 * -7988158060854933767L <= var6) {
               ...
               var0.method12703();
               classWZ var11 = var0.field6806[var5];
               if (var11 != null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("zw")
   public static void method12652(classWZ var0) {
      if (var0 == null) {
         var0.getMenuEntries();
      }
   ...
   @ObfuscatedName("dp")
   public static int method12660(classWZ var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("ak")
   final void method12658(classWZ var1) {
      ...
      int var3 = 19 + var2;
      this.field6815 = var2 * -317857149;
      if (this.field6815 * -196193027 + this.field6814 * -531540521 > 8379747 * classEU.field1938) {
         this.field6815 = (var3 - this.field6814 * -531540521) * -317857149;
      }
   ...
   public final boolean method12666(int var1, int var2) {
      if (this.field6816 * -1985221643 != -1
         && this.field6806[-1985221643 * this.field6816] != null
         && method12701(this.field6806[this.field6816 * -1985221643], var1, var2, -2098090181)) {
         return true;
         ...
         if (var3 != -1 && var3 != -1985221643 * this.field6816) {
            ...
            if (this.field6819 * -7988158060854933767L <= classDD.method2983(16711680)) {
               ...
               if (this.field6806[var3] != null) {
                  ...
                  this.field6806[var3].method12700(this, (short)-13464);
               }
            }
         }
   ...
   @ObfuscatedName("ik")
   public static String method12647(classWZ var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;II)Z")
   @ObfuscatedName("ni")
   public static boolean method12667(classWZ var0, int var1, int var2) {
      if (var0.field6816 * 1256246264 != -1
         && var0.field6806[1011150737 * var0.field6816] != null
         && method12701(var0.field6806[var0.field6816 * -1985221643], var1, var2, -1655548224)) {
         return true;
         ...
         if (var3 != -1 && var3 != -1018693876 * var0.field6816) {
            ...
            if (var0.field6819 * -7988158060854933767L <= classDD.method2983(16711680)) {
               ...
               if (var0.field6806[var3] != null) {
                  var0.field6816 = var3 * -1982257059;
                  var0.field6806[var3].method12700(var0, (short)11042);
               }
            }
         }
   ...
   public final boolean method12671(int var1, int var2) {
      if (-1 != -1985221643 * this.field6816
         && null != this.field6806[683048908 * this.field6816]
         && this.field6806[-1985221643 * this.field6816].method12670(var1, var2, (short)-13089)) {
         return true;
      } else {
   ...
   public final boolean method12672(int var1, int var2) {
      if (-1 != -1985221643 * this.field6816
         && null != this.field6806[-1985221643 * this.field6816]
         && this.field6806[-1985221643 * this.field6816].method12670(var1, var2, (short)16742)) {
         return true;
      } else {
   ...
   public boolean method12693(int var1, int var2) {
      if (this.field6816 * -1985221643 == -1) {
         ...
         classWZ var3 = this.field6806[this.field6816 * -1985221643];
         if (var3 == null) {
            return false;
   ...
   @ObfuscatedSignature(descriptor = "(Lwz;)V")
   @ObfuscatedName("mg")
   public static void method12689(classWZ var0) {
      int var1 = var0.field6817 * 727605925;
      int var2 = 1457978411 * var0.field6815;
      int var3 = 6116423;
      classYW.method13698(var1, var2, var0.field6812 * 1308041153, var0.field6814 * -531540521, var3);
      ...
      if (-1 != -1985221643 * var0.field6816 && null != var0.field6806[var0.field6816 * -1985221643]) {
         var0.field6806[var0.field6816 * -1985221643].method12692(-1765428614);
      }
   }
   ...
   final void method12681() {
      if (-1985221643 * this.field6816 != -1) {
         if (null != this.field6806[-1985221643 * this.field6816]) {
            this.field6806[this.field6816 * -1985221643].method12678(-1932347280);
         }
   ...
   final void method12682() {
      if (-141318718 * this.field6816 != -1) {
         if (null != this.field6806[2032838106 * this.field6816]) {
            this.field6806[this.field6816 * -1985221643].method12678(37541411);
         }
   ...
   public classWZ(boolean var1) {
      ...
      this.field6802 = new int[var2];
      this.field6803 = new int[var2];
      this.field6804 = new String[var2];
      this.field6805 = new String[var2];
      this.field6806 = new classWZ[var2];
   ...
   @ObfuscatedName("go")
   public static String method12648(classWZ var0, int var1, int var2) {
      if (var0 == null) {
   ...
   public final boolean method12668(int var1, int var2) {
      if (this.field6816 * 1251479852 != -1
         && this.field6806[-1985221643 * this.field6816] != null
         && method12701(this.field6806[this.field6816 * -1985221643], var1, var2, -1553941953)) {
         return true;
         ...
         if (var3 != -1 && var3 != -1664095241 * this.field6816) {
            ...
            if (this.field6819 * -7988158060854933767L <= classDD.method2983(16711680)) {
               ...
               if (this.field6806[var3] != null) {
                  this.field6816 = var3 * -1982257059;
                  this.field6806[var3].method12700(this, (short)-8110);
               }
            }
         }
   ...
   public final void method12690() {
      ...
      if (-1 != -1985221643 * this.field6816 && null != this.field6806[this.field6816 * -1985221643]) {
         this.field6806[this.field6816 * -1985221643].method12692(-1689280628);
      }
   }
   ...
   static void method12650(int var0, int var1, int var2, int var3, int var4) {
      try {
         classBH var5 = (classBH)classBH.field454.method13363(var0);
         if (var5 == null) {
            var5 = new classBH();
            classBH.field454.method13372(var5, var0);
         }

         if (var5.field456.length <= var1) {
            if (var4 == 1575592240) {
               throw new IllegalStateException();
            }
            ...
            for (int var8 = 0; var8 < var5.field456.length; var8++) {
               var6[var8] = var5.field456[var8];
               var7[var8] = var5.field455[var8];
            }

            for (int var10 = var5.field456.length; var10 < var1; var10++) {
               if (var4 == 1575592240) {
                  throw new IllegalStateException();
               }
         ...
         var5.field456[var1] = var2;
         var5.field455[var1] = var3;
   ...
   public final boolean method12702(int var1, int var2, int var3) {
      ...
      if (this.field6815 * -1985221643 != -1
         && this.field6806[this.field6813 * -1985221643] != null
         && this.field6806[this.field6816 * -1985221643].method12693(var1, var2)) {
         var4 = true;
         ...
         if (var5 != -1 && var5 != this.field6813 * -1985221643) {
            ...
            if (this.field6819 * -7988158060854933767L <= var6) {
               ...
               this.method12707();
               classWZ var11 = this.field6806[var5];
               if (var11 != null) {
