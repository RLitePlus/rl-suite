...
final class classYF implements classYH {
   ...
   public Object vmethod653(classXY var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "yf.af(" + ')');
      }
   }
   ...
   public void vmethod656(Object var1, classXY var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "yf.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lyf;Ljava/lang/Long;Lxy;I)V")
   @ObfuscatedName("vm")
   public static void method13327(classYF var0, Long var1, classXY var2, int var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var4, "yf.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Long;Lxy;)V")
   @ObfuscatedName("ag")
   void method13328(Long var1, classXY var2) {
      var2.method12987(var1);
   }
   ...
   @ObfuscatedName("lm")
   public static void method13329(classYF var0, Long var1, classXY var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("az")
   void method13330(Long var1, classXY var2, int var3) {
      try {
