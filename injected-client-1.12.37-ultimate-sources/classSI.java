...
@ObfuscatedName("si")
public class classSI extends classEE implements ActorSpotAnim {
   @ObfuscatedName("as")
   ...
   protected boolean vmethod96() {
      if (null == this.field5957) {
         ...
         classFX var1 = classAI.method376(this.field5959 * -1839511320, -1302911466).method8726(-376558306);
   ...
   public boolean method10444(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "si.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("eq")
   public static boolean method10448(classSI var0, int var1) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "si.af(" + ')');
      }
   }
   ...
   protected boolean vmethod95(int var1) {
      try {
         if (null == this.field5957) {
            ...
            classFX var2 = classAI.method376(this.field5959 * -1568506297, -1538969825).method8726(1068370205);
         ...
         throw classEG.method3884(var3, "si.ab(" + ')');
      }
   }
   ...
   protected final classFX vmethod92() {
      if (null == this.field5957) {
         ...
         classFX var2 = var1.method8724(this.field5958.method9738(1750593616), 1603539580);
         if (var2 == null) {
            return null;
         } else {
            var2.method5232(-(-666341653 * this.field5960));
            if (classDH.method3168(this.field5957, -1969508409) == 1) {
               var2.field2421 = true;
            }
   ...
   protected final classFX vmethod93() {
      if (null == this.field5957) {
         ...
         classFX var2 = var1.method8724(this.field5958.method9738(1769764105), 2108134630);
         if (var2 == null) {
            return null;
         } else {
            var2.method5232(-(825461571 * this.field5960));
            if (classDH.method3168(this.field5957, 1977588115) == 1) {
               var2.field2421 = true;
            }
   ...
   protected boolean vmethod94() {
      if (null == this.field5957) {
         ...
         classFX var1 = classAI.method376(this.field5959 * -1568506297, -1941507830).method8726(-579858414);
         return null != var1 && null != var1.field2444;
      }
   }
   ...
   protected boolean vmethod97() {
      if (null == this.field5957) {
         ...
         classFX var1 = classAI.method376(this.field5959 * -1568506297, -2108963618).method8726(219138195);
         return null != var1 && null != var1.field2444;
      }
   }
   ...
   protected int vmethod98(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "si.ag(" + 41);
      }
   }
   ...
   @ObfuscatedName("xh")
   public static int method10455(classDH var0) {
      ...
      try {
         ...
         try {
            if (null == var5.field5957) {
               ...
               classFX var8 = var7.method8724(var5.field5958.method9738(2073738908), 875936462);
               if (var8 == null) {
                  if (var6 <= -1767431455) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (classDH.method3168(var5.field5957, -2032654562) == 1) {
                     if (var6 <= -1767431455) {
                        throw new IllegalStateException();
                     }
            ...
            throw classEG.method3884(var11, "si.ae(" + ')');
         }
   ...
   public classSI(int var1, int var2, int var3, classDH var4, boolean var5) {
