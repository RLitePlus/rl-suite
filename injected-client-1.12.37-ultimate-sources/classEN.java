...
public class classEN implements classXZ {
   ...
   public static int method3931(int var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "en.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("az")
   public static classCT method3930(int var0, classCL var1, int var2) {
      try {
         classCT var3 = null;
         ...
         while (var4.hasNext()) {
            ...
            classCT var6 = (classCT)var5.field1694.method13404(var0);
            if (null != var6) {
               if (var2 == 697875933) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var7, "en.az(" + ')');
      }
   }
}
