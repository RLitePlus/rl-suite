...
public class classWR {
   ...
   @ObfuscatedName("xy")
   public static int method12610(classPI var0, int var1) {
   ...
   @ObfuscatedName("cj")
   public static int method12611(classXY var0) {
      return 0 - var0.field6954[(var0.field6955 += -1095856699) * 702114061 - 1] & 0xFF;
   }
