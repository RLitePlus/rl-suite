...
@ObfuscatedName("rw")
public class classRW extends classRT implements FriendsChatManager {
   @ObfuscatedName("ax")
   ...
   @ObfuscatedName("au")
   public final void method10315(classXY var1) {
      classAAE var2 = new classAAE(var1.method13071(-36353355), this.field5862);
      int var3 = classXY.method13047(var1, 148692140);
      byte var4 = classXY.method13043(var1, (byte)17);
      boolean var5 = false;
      if (var4 == -128) {
         var5 = true;
      }
      ...
      if (var5) {
         ...
         classRU var6 = (classRU)classRT.method10209(this, var2, -1497990786);
         if (null != var6 && var6.method9970(1881338771) == var3) {
            this.method10220(var6, -1538804275);
         }
      } else {
         var1.method13071(-675040349);
         classRU var7 = (classRU)classRT.method10209(this, var2, -535679696);
         if (null == var7) {
            if (this.method10191(-1588362016) > this.field5840 * 488407471) {
               return;
            }

            var7 = (classRU)this.method10223(var2, 1599629102);
         }

         classRI.method9966(var7, var3, (this.field5861 += 66639041) * -2018919615 - 1, (byte)87);
   ...
   classRR vmethod555(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "rw.az(" + ')');
      }
   }
   ...
   classRR[] vmethod558(int var1, byte var2) {
      try {
         return new classRU[var1];
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "rw.af(" + ')');
      }
   }
   ...
   final void method10309(String var1, int var2) {
      try {
         ...
         throw classEG.method3884(var11, "rw.ae(" + ')');
      }
   }
   ...
   final void method10310(String var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var11, "rw.ax(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;B)V")
   @ObfuscatedName("ac")
   public final void method10314(classXY var1, byte var2) {
      try {
         ...
         this.field5865 = classXY.method13043(var1, (byte)17);
         int var5 = classXY.method13096(var1, -66258477);
         if (var5 == -1) {
            if (var2 == 1) {
               ;
            }
            ...
            for (int var6 = 0; var6 < var5; var6++) {
               ...
               classRU var7 = (classRU)this.method10223(new classAAE(var1.method13071(590806966), this.field5862), -234641024);
               int var8 = classXY.method13047(var1, -739509588);
               classRI.method9966(var7, var8, (this.field5861 += 66639041) * -2018919615 - 1, (byte)47);
               var7.field5671 = classXY.method13043(var1, (byte)17) * -998616451;
               var1.method13071(1837149470);
               this.method10330(var7, (byte)3);
            }
         }
      } catch (RuntimeException var9) {
         throw classEG.method3884(var9, "rw.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lru;)V")
   @ObfuscatedName("ah")
   final void method10329(classRU var1) {
   ...
   @ObfuscatedName("aa")
   public final void method10316(classXY var1, int var2) {
      try {
         classAAE var3 = new classAAE(var1.method13071(1485498111), this.field5862);
         int var4 = classXY.method13047(var1, -699139394);
         byte var5 = classXY.method13043(var1, (byte)17);
         boolean var6 = false;
         if (var5 == -128) {
            if (var2 != -1099809795) {
               throw new IllegalStateException();
         ...
         if (var6) {
            ...
            classRU var7 = (classRU)classRT.method10209(this, var3, 689185044);
            ...
            classRU var9 = (classRU)classRT.method10209(this, var3, 1765452863);
            if (null == var9) {
               ...
               var9 = (classRU)this.method10223(var3, 352800993);
            }

            classRI.method9966(var9, var4, (this.field5861 += 66639041) * -2018919615 - 1, (byte)74);
            var9.field5671 = -998616451 * var5;
            this.method10330(var9, (byte)3);
         }
      } catch (RuntimeException var8) {
         throw classEG.method3884(var8, "rw.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("aj")
   final void method10330(classRU var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "rw.aj(" + ')');
      }
   }
   ...
   @ObfuscatedName("we")
   public static void method10325(classRW var0) {
      if (var0 == null) {
         var0.vmethod557();
      }

      for (int var1 = 0; var1 < var0.method10191(-1394488016); var1++) {
         ((classRU)classRT.method10231(var0, var1, 1919373891)).method10279(1435757556);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ap")
   public final void method10317(classXY var1) {
      classAAE var2 = new classAAE(var1.method13071(-259352950), this.field5862);
      int var3 = classXY.method13047(var1, -1865306368);
      byte var4 = classXY.method13043(var1, (byte)17);
      boolean var5 = false;
      if (var4 == -128) {
         var5 = true;
      ...
      if (var5) {
         ...
         classRU var6 = (classRU)classRT.method10209(this, var2, 873815666);
         if (null != var6 && var6.method9970(2091583420) == var3) {
            this.method10220(var6, -1597379912);
         }
      } else {
         var1.method13071(-721182977);
         classRU var7 = (classRU)classRT.method10209(this, var2, -1959582385);
         if (null == var7) {
            if (this.method10191(-591628002) > this.field5840 * 488407471) {
               return;
            }

            var7 = (classRU)this.method10223(var2, 2134777065);
         }

         classRI.method9966(var7, var3, (this.field5861 += 66639041) * -2018919615 - 1, (byte)63);
         var7.field5671 = -998616451 * var4;
         this.method10330(var7, (byte)3);
      }
   }
   ...
   public final void method10326() {
      for (int var1 = 0; var1 < this.method10191(-397813111); var1++) {
         ((classRU)classRT.method10231(this, var1, 2106234288)).method10279(1639521935);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lrw;)V")
   @ObfuscatedName("js")
   public static void method10320(classRW var0) {
      if (var0 == null) {
         var0.method10324();
      }

      for (int var1 = 0; var1 < var0.method10191(-2016507328); var1++) {
         classRU.method10269((classRU)classRT.method10231(var0, var1, 1551990598), 1696325499);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lru;)V")
   @ObfuscatedName("am")
   final void method10331(classRU var1) {
   ...
   public final void method10321(int var1) {
      try {
         for (int var2 = 0; var2 < this.method10191(-1392296789); var2++) {
            ...
            classRU.method10269((classRU)classRT.method10231(this, var2, 1288292465), 1696325499);
         }
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "rw.ao(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lrw;I)V")
   @ObfuscatedName("ms")
   public static void method10327(classRW var0, int var1) {
      if (var0 == null) {
         ...
         try {
            for (int var2 = 0; var2 < var0.method10191(-785088642); var2++) {
               ...
               ((classRU)classRT.method10231(var0, var2, 1421395390)).method10279(1595887057);
            }
         } catch (RuntimeException var3) {
            throw classEG.method3884(var3, "rw.al(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ar")
   public final void method10318(classXY var1) {
      classAAE var2 = new classAAE(var1.method13071(-789878377), this.field5862);
      int var3 = classXY.method13047(var1, 574010689);
      byte var4 = classXY.method13043(var1, (byte)17);
      boolean var5 = false;
      if (var4 == -128) {
         var5 = true;
      ...
      if (var5) {
         ...
         classRU var6 = (classRU)classRT.method10209(this, var2, -1189549438);
         if (null != var6 && var6.method9970(2059142997) == var3) {
            this.method10220(var6, -1981449810);
         }
      } else {
         var1.method13071(-790723981);
         classRU var7 = (classRU)classRT.method10209(this, var2, 1152470863);
         if (null == var7) {
            if (this.method10191(-786682736) > this.field5840 * 488407471) {
               return;
            }

            var7 = (classRU)this.method10223(var2, -386012183);
         }

         classRI.method9966(var7, var3, (this.field5861 += -182925841) * 156465811 - 1, (byte)20);
   ...
   public final void method10322() {
      for (int var1 = 0; var1 < this.method10191(-614511598); var1++) {
         classRU.method10269((classRU)classRT.method10231(this, var1, 1958568870), 1696325499);
      }
   }
   ...
   public classRW(classAAO var1, classRG var2) {
      super(500);
      this.field5864 = null;
   ...
   public final void method10328() {
      for (int var1 = 0; var1 < this.method10191(-1476119352); var1++) {
         ((classRU)classRT.method10231(this, var1, 2122027480)).method10279(1372159213);
      }
   }
   ...
   public void vmethod567(classAAE var1, classAAE var2) {
      ...
      if (var3 != null) {
         ...
         classOE.field4843.getCallbacks().postDeferred(var4);
      }
   }
   ...
   @ObfuscatedName("is")
   public static void method10319(classRW var0, classXY var1) {
      if (var0 == null) {
         var0.getKickRank();
      }

      classAAE var2 = new classAAE(var1.method13071(-846338536), var0.field5862);
      int var3 = classXY.method13047(var1, 39866774);
      byte var4 = classXY.method13043(var1, (byte)17);
      boolean var5 = false;
      if (var4 == -1691232296) {
         var5 = true;
      ...
      if (var5) {
         ...
         classRU var6 = (classRU)classRT.method10209(var0, var2, 599466963);
         if (null != var6 && var6.method9970(1923168841) == var3) {
            var0.method10220(var6, 525514085);
         }
      } else {
         var1.method13071(824823172);
         classRU var7 = (classRU)classRT.method10209(var0, var2, 1374271516);
         if (null == var7) {
            if (var0.method10191(-1155890527) > var0.field5840 * 1131225938) {
               return;
            }

            var7 = (classRU)var0.method10223(var2, 753878477);
         }

         classRI.method9966(var7, var3, (var0.field5861 += 66639041) * 149771164 - 1, (byte)84);
   ...
   public void vmethod566(classRR var1) {
      ...
      if (var2 != null) {
         ...
         classOE.field4843.getCallbacks().postDeferred(var3);
      }
   }
   ...
   public final void method10324() {
      for (int var1 = 0; var1 < this.method10191(-2016507328); var1++) {
         classRU.method10269((classRU)classRT.method10231(this, var1, 1551990598), 1696325499);
      }
   }
}
