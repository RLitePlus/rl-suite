...
@ObfuscatedName("ee")
public abstract class classEE extends classVO implements Renderable {
   @ObfuscatedName("ed")
   ...
   void vmethod414(
      ...
      if (1 != classFH.field2257.field2217 || this.vmethod95(-6876261)) {
         classFX var15 = this.vmethod104(1316629443);
         if (var15 != null) {
   ...
   void vmethod419(int var1, classUU var2, int var3, int var4, int var5, long var6) {
      try {
         if (1 != classFH.field2257.field2217 || this.vmethod95(409103606)) {
            classFX var8 = this.vmethod104(284128743);
            if (null != var8) {
   ...
   void vmethod415(
      ...
      try {
         if (1 != classFH.field2257.field2217 || this.vmethod95(-785834226)) {
            classFX var15 = this.vmethod104(-1455788262);
            if (var15 != null) {
   ...
   void vmethod416(
      ...
      if (1 != classFH.field2257.field2217 || this.vmethod95(1957067718)) {
         classFX var15 = this.vmethod104(-1642790657);
         if (var15 != null) {
   ...
   @ObfuscatedName("co")
   static void method3838(classDZ var0, byte var1) {
      try {
         classSP var2 = (classSP)var0.field1700.method13595(-2034209657 * client.field846);
         if (var2 == null) {
            if (var1 == 0) {
               ;
            }
   ...
   void vmethod417(
      ...
      if (1 != classFH.field2257.field2217 || this.vmethod95(960025440)) {
         classFX var15 = this.vmethod104(-1421815584);
         if (var15 != null) {
   ...
   void vmethod418(
      ...
      if (1 != classFH.field2257.field2217 || this.vmethod95(-428553131)) {
         classFX var15 = this.vmethod104(1119298836);
         if (var15 != null) {
   ...
   void vmethod420(int var1, classUU var2, int var3, int var4, int var5, long var6) {
      if (1 != classFH.field2257.field2217 || this.vmethod95(561642254)) {
         classFX var8 = this.vmethod104(-1414331705);
         if (null != var8) {
   ...
   void vmethod421(int var1, classUU var2, int var3, int var4, int var5, long var6) {
      if (1 != classFH.field2257.field2217 || this.vmethod95(-764973486)) {
         classFX var8 = this.vmethod104(-394479590);
         if (null != var8) {
   ...
   @ObfuscatedName("ae")
   protected classFX vmethod104(int var1) {
      try {
         return null;
      } catch (RuntimeException var2) {
   ...
   @ObfuscatedName("bt")
   static int method3837(int var0, classBL var1, boolean var2, byte var3) {
      try {
         if (var0 == 3200) {
            if (var3 >= 6) {
               ...
               classBI.field475
                  .method10472(
                     classBB.field323[classDY.field1679 * -324749371],
                     classBB.field323[-324749371 * classDY.field1679 + 1],
                     classBB.field323[classDY.field1679 * -324749371 + 2],
                     (byte)0
                  );
               return 1;
            }
            ...
            if (var3 >= 6) {
               ...
               int var20 = classBB.field323[classDY.field1679 * -324749371];
               int var29 = classBB.field323[1 + -324749371 * classDY.field1679];
               int var38 = classBB.field323[2 + -324749371 * classDY.field1679];
               int var52 = classBB.field323[-324749371 * classDY.field1679 + 3];
               int var57 = classBB.field323[4 + -324749371 * classDY.field1679];
            ...
            classBL.method1148(classBB.field323[-324749371 * classDY.field1679], classBB.field323[-324749371 * classDY.field1679 + 1], 1433612772);
            return 1;
         } else {
                     ...
                     if (var0 != 3205) {
                        ...
                        if (var0 != 3207) {
                                 ...
                                 if (var0 != 3182 && 3204 != var0 && var0 != 3206) {
                                    ...
                                    if (var0 != 3208) {
                                       ...
                                       if (3216 == var0) {
                                          ...
                                          classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var28;
                                          return 1;
                                       }
                                       ...
                                       if (3217 != var0) {
                                          ...
                                          if (3219 != var0) {
                                             if (var0 == 3220) {
                                                ...
                                                int var26 = classBB.field323[classDY.field1679 * -324749371 + 1];
                                             ...
                                             if (3221 == var0) {
                                                ...
                                                int var16 = classBB.field323[classDY.field1679 * -324749371];
                                                int var25 = classBB.field323[1 + classDY.field1679 * -324749371];
                                                int var35 = classBB.field323[2 + classDY.field1679 * -324749371];
                                                int var51 = classBB.field323[3 + classDY.field1679 * -324749371];
                                                int var56 = classBB.field323[4 + classDY.field1679 * -324749371];
                                                int var9 = classBB.field323[5 + -324749371 * classDY.field1679];
                                             ...
                                             if (var0 == 3222) {
                                                ...
                                                int var24 = classBB.field323[classDY.field1679 * -324749371 + 1];
                                                int var34 = classBB.field323[2 + classDY.field1679 * -324749371];
                                                int var50 = classBB.field323[3 + classDY.field1679 * -324749371];
                                       ...
                                       if (3219 == var0) {
                                          ...
                                          int var53 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                                       ...
                                       classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var32;
                                       classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var48;
                                       return 1;
                                    }
                                 }
                              }
                           ...
                           if (var0 == 3214) {
                              ...
                              int var43 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                           ...
                           if (3210 == var0) {
                              ...
                              int var45 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                           ...
                           if (var21 == classCU.field1286) {
                              ...
                              switch (var12.field648 * 611340289) {
                                 case 1:
                                    byte var61;
                                    if (classCY.method2724(classAB.field122, (short)3944)) {
                                       if (var3 >= 6) {
                                          throw new IllegalStateException();
                                       }
                                 ...
                                 case 4:
                                    ...
                                    break;
                                 case 5:
                                    var30 = classBS.method1223(-576800219);
                                    break;
                                 case 6:
                                 ...
                                 case 8:
                                    byte var10000;
                                    if (classCY.method2824(classAB.field122, -1980786523)) {
                                       if (var3 >= 6) {
                                          throw new IllegalStateException();
                                       }
            ...
            if (classCU.field1286 == var5) {
               ...
               switch (var4.field648 * 611340289) {
                  ...
                  case 2:
                     ...
                     classCY.method2736(classAB.field122, var65, (byte)16);
                     break;
                  case 3:
                     boolean var64;
                     if (var6 == 1) {
                  ...
                  case 4:
                     ...
                     classCY.method2752(classAB.field122, var6, (byte)12);
                     break;
                  case 5:
                  ...
                  case 8:
                     ...
                     classCY.method2829(classAB.field122, var10001, -1353457148);
                     break;
                  default:
               ...
               switch (321038383 * var5.field1292) {
                  case 1:
                     ...
                     break;
                  case 2:
                     classCY.method2765(classAB.field122, var6, 1222866659);
                     classKL.method6494(-1698036639);
                     break;
                  case 3:
                     classCY.method2774(classAB.field122, var6, -1335837787);
