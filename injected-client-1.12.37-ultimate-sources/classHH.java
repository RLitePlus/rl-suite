...
public class classHH {
   ...
   @ObfuscatedName("cs")
   static void method6055(classDZ var0, classDH var1, int var2, int var3, long var4) {
      try {
         if (var1.field1447 * 49255335 != 0) {
            classYA.method13276(client.field806, var1.field1469);

            for (classSI var6 = (classSI)rl3.method10079(client.field806); null != var6; var6 = (classSI)client.field806.next()) {
               if (1612595797 * client.field855 >= 1168432457 * var6.field5961) {
                  long var7 = var6.method10444(2103253898) ? var4 : -1L;
                  var0.field1689.method4421(var2, var1.field1487 * -1547553299, -1272026483 * var1.field1489, var3, var6, var1.field1488 * 1457033841, var7);
               }
            }
         }
