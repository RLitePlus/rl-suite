...
public class classIV extends classHB {
      ...
      try {
         ...
         label81: {
            ...
            if (classCY.method2782(classAB.field122, (byte)8) != null) {
               ...
               classBF.field389 = classCY.method2782(classAB.field122, (byte)8);
               client.method2363(-1);
   ...
   void vmethod499(classIQ var1, byte var2) {
      try {
         classIQ.method6293(var1, 102865497 * this.field3068, this.field3069, (byte)-85);
      } catch (RuntimeException var3) {
   ...
   @ObfuscatedName("ug")
   public static boolean method6318(classCY var0) {
   ...
   void vmethod502(classIQ var1) {
      classIQ.method6293(var1, 102865497 * this.field3068, this.field3069, (byte)-121);
   }
   ...
   void vmethod503(classIQ var1) {
      classIQ.method6293(var1, 102865497 * this.field3068, this.field3069, (byte)-124);
   }
   ...
   @ObfuscatedName("cm")
   static final void method6321(classXS var0, int var1) {
   ...
   @ObfuscatedName("ax")
   static classCM method6319(int var0) {
      try {
         classCM.field1156 = 0;
