...
public class classVC {
   ...
   public static classAAR method11934(classDS var0, boolean var1) {
      return var0 == null ? var0.method3576(var1) : classFE.method4612("2", classYP.field7028.field4053, var1, (byte)1);
   }

   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("al")
   public void method11928(classLW var1) {
      this.field6490 = var1;
   }
   ...
   @ObfuscatedName("ab")
   public boolean method11932(classLW var1, byte var2) {
      try {
   ...
   @ObfuscatedName("ag")
   public void method11929(classLW var1, int var2) {
      try {
         this.field6490 = var1;
      } catch (RuntimeException var3) {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;I)V")
   @ObfuscatedName("ae")
   public void method11933(classLW var1, int var2) {
      try {
         this.field6489 = var1;
      } catch (RuntimeException var3) {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;B)Z")
   @ObfuscatedName("af")
   public boolean method11927(classLW var1, byte var2) {
      try {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("ao")
   public void method11930(classLW var1) {
      this.field6490 = var1;
   }

   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("aj")
   public void method11931(classLW var1) {
      this.field6490 = var1;
   }

   @ObfuscatedSignature(descriptor = "(Lva;Lva;B)I")
   @ObfuscatedName("az")
   static int method11935(classVA var0, classVA var1, byte var2) {
      try {
         int var3 = 0;
