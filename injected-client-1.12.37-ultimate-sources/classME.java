...
public class classME {
   ...
   public static void method7539(String var0, String var1, String var2, int var3, int var4) throws IOException {
      ...
      classCV.field1305 = new String[]{".jagex_cache_" + classNB.field4637 * 1602897005, ".file_store_" + classNB.field4637 * 1697206599};

      label479:
      for (int var5 = 0; var5 < 4; var5++) {
         String var7 = 0 == var5 ? "" : "" + var5;
         classDB.field1379 = new File(classIE.field2954, "jagex_cl_" + var0 + "_" + var2 + var7 + ".dat");
         String var8 = null;
         String var9 = null;
         boolean var10 = false;
         if (classDB.field1379.exists()) {
            ...
            try {
               ...
               classXY var12 = new classXY((int)var11.method257(-153393736));

               while (702114061 * var12.field6955 < var12.field6954.length) {
                  int var13 = var11.method260(var12.field6954, var12.field6955 * 702114061, var12.field6954.length - 2077077400 * var12.field6955, -1397369950);
                  if (var13 == -1) {
                     throw new IOException();
                  }

                  var12.field6955 += -1673129772 * var13;
               }

               var12.field6955 = 0;
               int var61 = classXY.method13039(var12, -346779531);
               if (var61 < 1 || var61 > 3) {
               ...
               int var14 = 0;
               if (var61 > 1) {
                  var14 = classXY.method13039(var12, -346779531);
               }
               ...
               if (var61 <= 2) {
                  ...
                  var8 = classXY.method13082(var12, 1081461655);
                  if (var14 == 1) {
                     var9 = classXY.method13082(var12, 755786984);
                  }
               }
         ...
         if (var8 == null) {
            var8 = classIE.field2954 + File.separatorChar + "jagexcache" + var7 + File.separatorChar + var0 + File.separatorChar + var2 + File.separatorChar;
            var10 = true;
         }
         ...
         if (var10) {
            ...
            try {
               ...
               classXY var66 = new classXY(500);
               classXY.method12971(var66, 3, (byte)-60);
               classXY.method12971(var66, null != var60 ? 1 : 0, (byte)-101);
               var66.method13001(var55.getPath(), -910745300);
               if (var60 != null) {
                  var66.method13001(var60.getPath(), -910745300);
               }

               var64.method242(var66.field6954, 0, 689286479 * var66.field6955, -900673116);
      ...
      if (!classMT.field4586.exists()) {
         ...
         try {
            File var42 = new File(classIE.field2954, "random.dat");
            if (var42.exists()) {
         ...
         classBI.field477 = new classAAC[classUP.field6363 * -1127736048];

         for (int var43 = 0; var43 < -646722873 * classUP.field6363; var43++) {
            classBI.field477[var43] = new classAAC(new classAAR(classBJ.method1113("main_file_cache.idx" + var43, 140195232), "rw", 1048576L), 6000, 0);
         }
      }
   }
   ...
   @ObfuscatedName("at")
   public static void method7553(classXY var0, int var1) {
      if (field4490 != null) {
         try {
            field4490.method138(0L);
            field4490.method153(var0.field6954, var1, 24, -1298094667);
   ...
   public static void method7540(String var0, String var1, String var2, int var3, int var4) throws IOException {
      ...
      for (int var5 = 0; var5 < 4; var5++) {
         ...
         if (classDB.field1379.exists()) {
            ...
            try {
               ...
               while (702114061 * var12.field6955 < var12.field6954.length) {
                  int var13 = var11.method260(var12.field6954, var12.field6955 * 702114061, var12.field6954.length - 702114061 * var12.field6955, -1397369950);
                  if (var13 == -1) {
                     throw new IOException();
                  }

                  var12.field6955 += -1095856699 * var13;
               }
               ...
               if (var61 <= 2) {
                  ...
                  var8 = classXY.method13082(var12, 1500461334);
                  if (var14 == 1) {
                     var9 = classXY.method13082(var12, -484778587);
                  }
               }
            } catch (Exception var39) {
               var39.printStackTrace();
         ...
         if (var10) {
            ...
            try {
               classAAR var64 = new classAAR(classDB.field1379, "rw", 10000L);
               classXY var66 = new classXY(500);
               classXY.method12971(var66, 3, (byte)-103);
               classXY.method12971(var66, null != var60 ? 1 : 0, (byte)-57);
               var66.method13001(var55.getPath(), -910745300);
               if (var60 != null) {
                  var66.method13001(var60.getPath(), -910745300);
               }

               var64.method242(var66.field6954, 0, 702114061 * var66.field6955, -612629987);
               classAAR.method247(var64, (byte)1);
            } catch (IOException var32) {
               var32.printStackTrace();
            }
      ...
      if (!classMT.field4586.exists()) {
         ...
         for (int var43 = 0; var43 < -646722873 * classUP.field6363; var43++) {
            classBI.field477[var43] = new classAAC(new classAAR(classBJ.method1113("main_file_cache.idx" + var43, 25814695), "rw", 1048576L), 6000, 0);
         }
      }
   }
   ...
   public static void method7541(String var0, String var1, String var2, int var3, int var4) throws IOException {
      ...
      classWQ.field6768 = new String[]{"c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/", "c:/", classIE.field2954, "/tmp/", ""};
      classCV.field1305 = new String[]{".jagex_cache_" + classNB.field4637 * 1555860074, ".file_store_" + classNB.field4637 * -1613496402};
      ...
      for (int var5 = 0; var5 < 4; var5++) {
         ...
         if (classDB.field1379.exists()) {
            ...
            try {
               ...
               while (-33347134 * var12.field6955 < var12.field6954.length) {
                  int var13 = var11.method260(var12.field6954, var12.field6955 * 430135352, var12.field6954.length - 1255560002 * var12.field6955, -1397369950);
                  if (var13 == -1) {
                     throw new IOException();
                  }
               ...
               if (var61 <= 2) {
                  ...
                  var8 = classXY.method13082(var12, -53657240);
                  if (var14 == 1) {
                     var9 = classXY.method13082(var12, 1584755635);
                  }
               }
            } catch (Exception var39) {
               var39.printStackTrace();
         ...
         if (var10) {
            ...
            try {
               classAAR var64 = new classAAR(classDB.field1379, "rw", 10000L);
               classXY var66 = new classXY(-1871609904);
               classXY.method12971(var66, 3, (byte)-62);
               classXY.method12971(var66, null != var60 ? 1 : 0, (byte)-128);
               var66.method13001(var55.getPath(), -910745300);
               if (var60 != null) {
                  var66.method13001(var60.getPath(), -910745300);
               }

               var64.method242(var66.field6954, 0, 702114061 * var66.field6955, -1391552243);
               classAAR.method247(var64, (byte)1);
            } catch (IOException var32) {
               var32.printStackTrace();
            }
      ...
      if (!classMT.field4586.exists()) {
         ...
         for (int var43 = 0; var43 < -646722873 * classUP.field6363; var43++) {
            classBI.field477[var43] = new classAAC(new classAAR(classBJ.method1113("main_file_cache.idx" + var43, -742991889), "rw", 1048576L), 2029690893, 0);
         }
      }
   }
   ...
   public static void method7557() {
      try {
         ...
         for (int var0 = 0; var0 < -646722873 * classUP.field6363; var0++) {
            classAAC.method132(classBI.field477[var0], 890084153);
         }
   ...
   public static classAAR method7547(String var0, String var1, boolean var2) {
      ...
      String var4 = "";
      if (33 == -471465215 * classNB.field4637) {
         var4 = "_rc";
      } else if (classNB.field4637 * -1646067518 == 2142874692) {
         var4 = "_wip";
      }

      File var5 = new File(classIE.field2954, "jagex_" + var1 + "_preferences" + var0 + var4 + ".dat");
      if (!var2 && var5.exists()) {
         try {
   ...
   public static void method7542(String var0, String var1, String var2, int var3, int var4) throws IOException {
      ...
      classWQ.field6768 = new String[]{"c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/", "c:/", classIE.field2954, "/tmp/", ""};
      classCV.field1305 = new String[]{".jagex_cache_" + classNB.field4637 * 1602897005, ".file_store_" + classNB.field4637 * 1213339710};
      ...
      for (int var5 = 0; var5 < 4; var5++) {
         ...
         if (classDB.field1379.exists()) {
            ...
            try {
               ...
               while (-1068916252 * var12.field6955 < var12.field6954.length) {
                  int var13 = var11.method260(
                     var12.field6954, var12.field6955 * -298238560, var12.field6954.length - -1267189305 * var12.field6955, -1397369950
                  );
                  if (var13 == -1) {
                     throw new IOException();
                  }

                  var12.field6955 += -944789764 * var13;
               }
               ...
               if (var61 <= 2) {
                  ...
                  var8 = classXY.method13082(var12, 264384070);
                  if (var14 == 1) {
                     var9 = classXY.method13082(var12, 1274257698);
                  }
               }
            } catch (Exception var39) {
               var39.printStackTrace();
         ...
         if (var10) {
            ...
            try {
               classAAR var64 = new classAAR(classDB.field1379, "rw", 10000L);
               classXY var66 = new classXY(500);
               classXY.method12971(var66, 3, (byte)-85);
               classXY.method12971(var66, null != var60 ? 1 : 0, (byte)-103);
               var66.method13001(var55.getPath(), -910745300);
               if (var60 != null) {
                  var66.method13001(var60.getPath(), -910745300);
               }

               var64.method242(var66.field6954, 0, -1564525175 * var66.field6955, -1186495551);
               classAAR.method247(var64, (byte)1);
            } catch (IOException var32) {
               var32.printStackTrace();
            }
      ...
      if (!classMT.field4586.exists()) {
         ...
         for (int var43 = 0; var43 < 1070940093 * classUP.field6363; var43++) {
            classBI.field477[var43] = new classAAC(new classAAR(classBJ.method1113("main_file_cache.idx" + var43, -589539822), "rw", 1048576L), 6000, 0);
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ak")
   public static void method7554(classXY var0, int var1) {
      if (field4490 != null) {
         try {
            field4490.method138(0L);
            field4490.method153(var0.field6954, var1, 24, -1927671615);
         } catch (Exception var3) {
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("av")
   public static void method7555(classXY var0, int var1) {
      if (field4490 != null) {
         try {
            field4490.method138(0L);
            field4490.method153(var0.field6954, var1, 24, 578153911);
         } catch (Exception var3) {
         }
      }
   }
   ...
   public static classAAR method7548(String var0, String var1, boolean var2) {
      ...
      String var4 = "";
      if (33 == 2015166692 * classNB.field4637) {
         var4 = "_rc";
      } else if (classNB.field4637 * -1462858247 == 2019241592) {
         var4 = "_wip";
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("an")
   public static void method7556(classXY var0, int var1) {
      if (field4490 != null) {
         try {
            field4490.method138(0L);
            field4490.method153(var0.field6954, var1, 24, 841578820);
         } catch (Exception var3) {
         }
      }
   }
   ...
   public static void method7558() {
      try {
         ...
         for (int var0 = 0; var0 < 75685140 * classUP.field6363; var0++) {
            classAAC.method132(classBI.field477[var0], 95779239);
         }
   ...
   public static void method7559() {
      try {
         ...
         for (int var0 = 0; var0 < -646722873 * classUP.field6363; var0++) {
            classAAC.method132(classBI.field477[var0], -1428403396);
         }
   ...
   @ObfuscatedName("aw")
   static int method7561(int var0, classBL var1, boolean var2, byte var3) {
      try {
         classLW var10000;
         if (var2) {
            if (var3 == 12) {
         ...
         if (1500 == var0) {
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var4.field4281 * 744286069;
            return 1;
         } else if (1501 == var0) {
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1570844829 * var4.field4257;
            return 1;
         } else if (1502 == var0) {
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1115597881 * var4.field4249;
            return 1;
         } else if (1503 == var0) {
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 293773697 * var4.field4259;
            return 1;
         } else if (1504 == var0) {
            if (var3 == 12) {
               throw new IllegalStateException();
            ...
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -1502647899 * var4.field4342;
            return 1;
         } else if (var0 == 1506) {
            if (var3 == 12) {
               throw new IllegalStateException();
               ...
               if (var5 == -1) {
                  ...
                  for (classPK var7 = (classPK)var6.field6613.method13375(); null != var7; var7 = (classPK)classYK.method13401(var6.field6613)) {
                     if (var3 == 12) {
                        throw new IllegalStateException();
                     }
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var5;
               return 1;
            }
         } else {
            return 2;
         ...
         throw classEG.method3884(var8, "me.aw(" + 41);
      }
   }
   ...
   static String method7560(String var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "me.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IIII)Luz;")
   @ObfuscatedName("cx")
   static classUZ method7562(classDZ var0, int var1, int var2, int var3, int var4) {
      try {
         int var5 = var1 * 128;
         int var6 = 128 * var2;
         ...
         classUZ var18 = classGX.method5840(var13, (byte)-15);
         ...
         throw classEG.method3884(var22, "me.cx(" + ')');
      }
   }
}
