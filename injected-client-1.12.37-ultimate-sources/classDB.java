...
public class classDB {
   ...
   @ObfuscatedName("av")
   static void method2886(classCM var0, int var1) {
      try {
         ...
         if (-2024190683 * client.field883 != var0.field1163 * -458552905) {
            ...
            if ((var3 & classXE.field6840.vmethod8((byte)1)) != 0) {
               ...
               classFP.field2372 = classSU.method10680(var2, "logo_deadman_mode", "", -188356597);
            } else if ((var3 & classXE.field6851.vmethod8((byte)1)) != 0) {
               if (var1 != 1660308192) {
                  throw new IllegalStateException();
               }

               classFP.field2372 = classSU.method10680(var2, "logo_seasonal_mode", "", -1306596214);
               ...
               classFP.field2372 = classSU.method10680(var2, "logo_speedrunning", "", -117981147);
            } else if ((var3 & classXE.field6839.vmethod8((byte)1)) != 0) {
               if (var1 != 1660308192) {
                  throw new IllegalStateException();
               }

               classFP.field2372 = classSU.method10680(var2, "logo_ugc_world", "", -215054047);
            } else {
               classFP.field2372 = classSU.method10680(var2, "logo", "", 320308891);
            }
         }
