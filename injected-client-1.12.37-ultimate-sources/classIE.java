...
@ObfuscatedName("ie")
public class classIE extends classVQ implements ClanChannel {
   ...
   @ObfuscatedName("ay")
   void method6173(classHN var1) {
      this.field2955.add(var1);
      this.field2957 = null;
   }

   public classIE(classXY var1) {
   ...
   @ObfuscatedName("bk")
   public static void method6189(classIE var0, classXY var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("zo")
   public static int[] method6169(classIE var0, int var1) {
      if (var0 == null) {
      ...
      try {
         if (var0.field2957 == null) {
            ...
            for (int var3 = 0; var3 < var0.field2955.size(); var0.field2957[var3] = var3++) {
               var2[var3] = ((classHN)var0.field2955.get(var3)).field2846.method166(-2003115826);
            }
   ...
   @ObfuscatedSignature(descriptor = "(Lhn;)V")
   @ObfuscatedName("vn")
   public void method6194(classHN var1) {
   ...
   public int[] method6170() {
      if (this.field2957 == null) {
         ...
         for (int var2 = 0; var2 < this.field2955.size(); this.field2957[var2] = var2++) {
            var1[var2] = ((classHN)this.field2955.get(var2)).field2846.method166(-2003115826);
         }
   ...
   @ObfuscatedName("af")
   void method6177(classHN var1, byte var2) {
      try {
         this.field2955.add(var1);
         this.field2957 = null;
   ...
   public void method6192(int var1) {
      ...
      classHN var3 = (classHN)var2.get(var1);
   ...
   public int method6185(String var1) {
      if (!this.field2947) {
         ...
         for (int var2 = 0; var2 < this.field2955.size(); var2++) {
            if (((classHN)this.field2955.get(var2)).field2846.method164(1523255766).equalsIgnoreCase(var1)) {
               return var2;
            }
         }
      ...
      try {
         if (!this.field2947) {
            ...
            for (int var3 = 0; var3 < this.field2955.size(); var3++) {
               ...
               if (((classHN)this.field2955.get(var3)).field2846.method164(1214968684).equalsIgnoreCase(var1)) {
                  if (var2 != 33) {
                     throw new IllegalStateException();
                  }
   ...
   static void method6193(byte var0) {
      try {
         if (!client.field979) {
            ...
            classLW var1 = classLY.method7378(classWK.field6691, 565061963 * classBQ.field529, 1333668003 * client.field980, (byte)-103);
            if (var1 != null) {
               if (var0 >= 0) {
                  return;
               }
               ...
               if (var1.field4350 != null) {
                  ...
                  classZR var2 = classZS.method14182(classUQ.method11465(var1, 1629912630).method14145(var1.field4350, (byte)2), (byte)52);
   ...
   @ObfuscatedName("dz")
   public static int method6183(classIE var0, byte var1) {
      if (var0 == null) {
      ...
      try {
         if (this.field2957 == null) {
            ...
            for (int var3 = 0; var3 < this.field2955.size(); this.field2957[var3] = var3++) {
               var2[var3] = ((classHN)this.field2955.get(var3)).field2846.method166(-2003115826);
            }
   ...
   public ClanChannelMember findMember(String var1) {
      classAAE var2 = new classAAE(var1, classPK.field5279);
      var1 = var2.method185();
      if (var1 == null) {
         return null;
      } else {
         ...
         while (var5 <= var6) {
            ...
            int var8 = var4[var7];
            classHN var9 = (classHN)var3.get(var8);
