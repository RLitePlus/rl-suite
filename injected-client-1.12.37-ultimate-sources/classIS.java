...
@ObfuscatedName("is")
public abstract class classIS extends classVQ {
   @ObfuscatedSignature(descriptor = "Ldz;")
   @ObfuscatedName("dk")
   public static classDZ field3053;
   ...
   @ObfuscatedName("af")
   abstract void vmethod509(classIE var1, int var2);

   @ObfuscatedSignature(descriptor = "(Lie;)V")
   @ObfuscatedName("ax")
   abstract void vmethod508(classIE var1);

   @ObfuscatedSignature(descriptor = "(Lie;)V")
   @ObfuscatedName("ag")
   abstract void vmethod510(classIE var1);
   ...
   @ObfuscatedSignature(descriptor = "(Lie;)V")
   @ObfuscatedName("as")
   abstract void vmethod511(classIE var1);
}
