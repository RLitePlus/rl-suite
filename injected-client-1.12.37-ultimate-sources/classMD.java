...
public abstract class classMD {
   ...
   public String method7535(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "md.aa(" + ')');
      }
   }
   ...
   static void method7534(byte var0) {
      try {
         ...
         classYN.method13579(classCN.field1174);
         classCN.field1173.method8262();
         classCN.field1172 = 0;
      } catch (RuntimeException var1) {
         throw classEG.method3884(var1, "md.as(" + ')');
      }
   }
   ...
   public String vmethod519(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "md.as(" + ')');
      }
   }
   ...
   public int vmethod523(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "md.af(" + 41);
      }
   }
         ...
         if (var3 == 0) {
            ...
            if (var5 < 0) {
               ...
               if (var3 == 1) {
                  ...
                  synchronized (classVA.field6439) {
                     classVA.field6439.method272(var2, var6);
                  }
               }
