...
@ObfuscatedName("ze")
public class classZE extends classVJ implements DBRowConfig {
   @ObfuscatedName("ax")
   ...
   @ObfuscatedName("ag")
   public static classJZ field7171 = new classJZ(64);

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ag")
   public static void method13982(classVA var0) {
      field7177 = var0;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ab")
   public static void method13983(classVA var0) {
      field7177 = var0;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("as")
   public static void method13984(classVA var0) {
      field7177 = var0;
   }
   ...
   @ObfuscatedName("ax")
   public static classZE method13985(int var0) {
      classZE var1 = (classZE)field7171.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
         byte[] var2 = field7177.method11867(38, var0, -816950851);
         var1 = new classZE(new classXY(var2), var0, -1);
   ...
   @ObfuscatedSignature(descriptor = "(I)Lze;")
   @ObfuscatedName("aa")
   public static classZE method13986(int var0) {
      classZE var1 = (classZE)field7171.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
   ...
   @ObfuscatedName("hn")
   public static Object[] method13990(classZE var0, int var1) {
   ...
   @ObfuscatedSignature(descriptor = "(I)Lze;")
   @ObfuscatedName("ao")
   public static classZE method13987(int var0) {
      classZE var1 = (classZE)field7171.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
   ...
   @ObfuscatedSignature(descriptor = "(I)Lze;")
   @ObfuscatedName("ac")
   public static classZE method13988(int var0) {
      classZE var1 = (classZE)field7171.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
   ...
   classZE(classXY var1, int var2, int var3) {
                  ...
                  for (int var9 = classXY.method13039(var1, -346779531); 255 != var9; var9 = classXY.method13039(var1, -346779531)) {
                     ...
                     for (int var17 = 0; var17 < var15; var17++) {
                        for (int var18 = 0; var18 < var11.length; var18++) {
                           ...
                           classYY var20 = classRN.method10130(var11[var18], 1994570088);
