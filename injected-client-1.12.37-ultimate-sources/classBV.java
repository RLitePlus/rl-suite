...
@ObfuscatedName("bv")
public class classBV implements ChatLineBuffer {
   @ObfuscatedSignature(descriptor = "Lyz;")
   @ObfuscatedName("de")
   static classYZ field590;
   ...
   @ObfuscatedName("af")
   classCG[] field580 = new classCG[100];
   @ToRemove(unused = "true")
   @ObfuscatedName("ay")
   ...
   @ObfuscatedName("rl")
   public static classCG method1251(classBV var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("az")
   classCG method1249(int var1, String var2, String var3, String var4, int var5) {
      try {
         classCG var6 = this.field580[99];
         ...
         if (var6 == null) {
            ...
            var6 = new classCG(var1, var2, var4, var3);
         } else {
            var6.vmethod398();
            var6.method11958();
   ...
   @ObfuscatedName("is")
   public static classCG method1250(classBV var0, int var1, String var2, String var3, String var4) {
      classCG var5 = var0.field580[99];
      ...
      if (var5 == null) {
         var5 = new classCG(var1, var2, var4, var3);
      } else {
         var5.vmethod398();
         var5.method11958();
   ...
   @ObfuscatedName("xm")
   public static classCG method1252(classBV var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("af")
   classCG method1253(int var1, int var2) {
      try {
         if (var1 >= 0) {
            if (var2 == 620798481) {
               throw new IllegalStateException();
