...
public class classEY {
   ...
   public boolean method4106(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ey.az(" + ')');
      }
   }
   ...
   public byte[] method4112(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ey.af(" + ')');
      }
   }
   ...
   static void method4120(byte var0) {
      try {
         classFP.method4919(-1905538131);
         client.field974.field6803[0] = 0;
         client.field974.field6804[0] = classKK.field3854;
         client.field974.field6805[0] = "";
         client.field974.field6800[0] = 1006;
         client.field974.field6807[0] = false;
         client.field974.field6806[0] = null;
         client.field974.field6797 = 1932681381;
         client.field974.method12696(-1);
      } catch (RuntimeException var1) {
         throw classEG.method3884(var1, "ey.er(" + ')');
      }
   }
   ...
   public static String method4117(classEY var0, byte var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "ey.ae(" + ')');
      }
   }
