...
public final class classHU {
   ...
   @ObfuscatedName("bo")
   static int method6118(int var0, classBL var1, boolean var2, byte var3) {
      try {
         if (var0 == 3600) {
            if (0 == 215887637 * classQQ.field5597.field594) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -2;
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classQQ.field5597.field593.method10191(-1975366404);
            }
            ...
            if (var3 >= 0) {
               ...
               int var50 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
               if (classQQ.field5597.method1277(-1995215397)) {
                  ...
                  if (var50 >= 0) {
                     ...
                     if (var50 < classQQ.field5597.field593.method10191(-265945226)) {
                        ...
                        classRP var53 = (classRP)classRT.method10231(classQQ.field5597.field593, var50, 1650310413);
                        classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classRR.method10170(var53, (byte)1);
                        classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classRR.method10171(var53, (byte)91);
                        return 1;
                     }
                  }
               }
            ...
            if (var3 >= 0) {
               ...
               int var49 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
               if (classQQ.field5597.method1277(-38469855)) {
                  ...
                  if (var49 >= 0) {
                     ...
                     if (var49 < classQQ.field5597.field593.method10191(-1705074353)) {
                        ...
                        classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = ((classRI)classRT.method10231(
            ...
            if (var3 >= 0) {
               ...
               int var48 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
            ...
            if (var3 >= 0) {
               ...
               int var77 = (classDY.field1679 += 120041229) * -324749371 - 1;
               byte var80;
               if (classQQ.field5597.method1296(new classAAE(var41, classPK.field5279), false, 728254179)) {
                  if (var3 >= 0) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 >= 0) {
               ...
               if (null != classIB.field2935) {
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classIB.field2935.method10191(-1805895116);
               } else {
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 0;
               }
            ...
            if (var3 >= 0) {
               ...
               if (classIB.field2935 != null && var40 < classIB.field2935.method10191(-2018528307)) {
                  ...
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classRT.method10231(classIB.field2935, var40, 1740076631)
                     .method10166((byte)16)
                     .method164(925124102);
               } else {
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = "";
            ...
            if (var3 >= 0) {
               ...
               if (null != classIB.field2935 && var39 < classIB.field2935.method10191(-1010776819)) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = ((classRI)classRT.method10231(classIB.field2935, var39, 1814276808))
            ...
            if (var3 >= 0) {
               ...
               if (null != classIB.field2935 && var38 < classIB.field2935.method10191(-1796962933)) {
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = ((classRI)classRT.method10231(classIB.field2935, var38, 1388187095)).field5671
                     * 1234122453;
               } else {
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 0;
               }
            ...
            int var76 = (classDY.field1679 += 120041229) * -324749371 - 1;
            byte var79;
            if (null != classIB.field2935) {
               if (var3 >= 0) {
                  throw new IllegalStateException();
            ...
            if (var3 >= 0) {
               ...
               if (!classQQ.field5597.method1277(-1462513166)) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classQQ.field5597.field591.method10191(-396855415);
               }
               ...
               if (classQQ.field5597.method1277(-1335537384)) {
                  ...
                  if (var35 >= 0) {
                     ...
                     if (var35 < classQQ.field5597.field591.method10191(-823470546)) {
                        ...
                        classRS var5 = (classRS)classRT.method10231(classQQ.field5597.field591, var35, 1297124491);
                        classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classRR.method10170(var5, (byte)1);
                        classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classRR.method10171(var5, (byte)40);
                        return 1;
                     }
                  }
               }
            ...
            if (var3 >= 0) {
               ...
               byte var10002;
               if (classQQ.field5597.method1299(new classAAE(var33, classPK.field5279), -1181618808)) {
                  if (var3 >= 0) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 >= 0) {
               ...
               if (null != classIB.field2935) {
                  ...
                  if (var32 < classIB.field2935.method10191(-1481923975)) {
                     ...
                     if (classRT.method10231(classIB.field2935, var32, 2092533098).method10166((byte)16).equals(classOE.field4843.vmethod255((byte)101))) {
                        classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1;
                        return 1;
                     }
                  }
            ...
            if (classIB.field2935 != null && var31 < classIB.field2935.method10191(-647202361)) {
               ...
               if (classRU.method10272((classRU)classRT.method10231(classIB.field2935, var31, 2132647428), 1742624293)) {
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1;
                  return 1;
               }
            }
            ...
            if (var0 == 3628) {
               ...
               if (var3 >= 0) {
                  ...
                  boolean var20 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371] == 1;
               ...
               if (var3 >= 0) {
                  ...
                  boolean var18 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371] == 1;
                  if (null != classIB.field2935) {
               ...
               if (var3 >= 0) {
                  ...
                  boolean var16 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371] == 1;
                  if (null != classIB.field2935) {
                     if (var3 >= 0) {
                        throw new IllegalStateException();
                     }
               ...
               if (var3 >= 0) {
                  ...
                  boolean var15 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371] == 1;
                  if (null != classIB.field2935) {
                     if (var3 >= 0) {
                        throw new IllegalStateException();
                     }
               ...
               if (var3 >= 0) {
                  ...
                  boolean var9 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371] == 1;
                  if (classIB.field2935 != null) {
                     if (var3 >= 0) {
                        throw new IllegalStateException();
                     }
            ...
            if (classIB.field2935 != null) {
               ...
               if (var4 < classIB.field2935.method10191(-1948161542)) {
                  ...
                  if (((classRU)classRT.method10231(classIB.field2935, var4, 1433024429)).method10282(-1714319706)) {
                     if (var3 >= 0) {
                        throw new IllegalStateException();
                     }
