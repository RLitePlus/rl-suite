...
public class classCX {
   ...
   @ObfuscatedName("az")
   public static classJL method2697(int var0, String var1, classXO var2, int var3, int var4) {
      try {
         classJL var5 = classEF.method3849(classJS.MESSAGE_PUBLIC, client.field795.field1535, (byte)13);
         classXY.method12971(var5.field3343, 0, (byte)-106);
         int var6 = 702114061 * var5.field3343.field6955;
         classXY.method12971(var5.field3343, var0, (byte)-118);
         ...
         classXY.method12971(var5.field3343, var8, (byte)-123);
         classXY.method12971(var5.field3343, var20, (byte)-112);
         if (var9 != null) {
            if (var4 <= 491127009) {
               throw new IllegalStateException();
            }
            ...
            for (int var21 = 0; var21 < var9.length; var21++) {
               classXY.method12971(var5.field3343, var9[var21], (byte)-4);
            }
         }

         classWZ.method12644(var5.field3343, var1, 1634305105);
         if (var0 == classKT.field4020.vmethod8((byte)1)) {
            classXY.method12971(var5.field3343, var3, (byte)-43);
         }

         classXY.method13022(var5.field3343, var5.field3343.field6955 * 702114061 - var6, -942063960);
         return var5;
      } catch (RuntimeException var18) {
         throw classEG.method3884(var18, "cx.az(" + ')');
      }
   }
   ...
   static long method2698(int var0, int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "cx.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IIIIII)V")
   @ObfuscatedName("ab")
   static void method2699(classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         classCE.field689 = 0;
         ...
         for (int var7 = 0; var7 < classZH.method14003(var0.field1693, (byte)10); var7++) {
            ...
            classSP var8 = (classSP)var0.field1700.method13595(var0.field1693.method14001(var7, 1878255702));
            if (null != var8) {
               if (var6 <= 2043869258) {
                  throw new IllegalStateException();
               }
         ...
         if (var24) {
            ...
            if (var25 < 0) {
               ...
               classDZ var9 = classQB.method9434(var25, client.field814, 287040560);
               classCT var10 = var9.method3737(var25, (byte)1);
               if (null != var10) {
                  if (var6 <= 2043869258) {
                     throw new IllegalStateException();
                  }
         ...
         if (var26 < 0) {
            ...
            classDZ var27 = classQB.method9434(var26, client.field814, -1522945937);
            classCT var29 = var27.method3737(var26, (byte)1);
            if (null != var29) {
               if (var6 <= 2043869258) {
                  throw new IllegalStateException();
               }
         ...
         classZV var30 = classBB.field341;
         ...
         throw classEG.method3884(var23, "cx.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZB)I")
   @ObfuscatedName("cu")
   static int method2700(int var0, classBL var1, boolean var2, byte var3) {
      try {
         if (6809 == var0) {
            if (var3 == 6) {
               throw new IllegalStateException();
         ...
         throw classEG.method3884(var6, "cx.cu(" + 41);
      }
   }
   ...
   static double method2695(double var0) {
      try {
         ...
         throw classEG.method3884(var2, "cx.az(" + ')');
      }
   }
   ...
   public static classYE[] method2696(int var0) {
      try {
         ...
         throw classEG.method3884(var1, "cx.ag(" + ')');
      }
   }
}
