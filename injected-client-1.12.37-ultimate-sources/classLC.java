...
@ObfuscatedName("lc")
public class classLC implements PlayerComposition {
   @ObfuscatedName("aq")
   ...
   @ObfuscatedName("ax")
   static classJZ field4100 = new classJZ(260);
   ...
   classLC(classLC var1) {
      ...
      if (var1 != null) {
         ...
         classPI[] var4 = null != var1.field4097 ? Arrays.copyOf(var1.field4097, var1.field4097.length) : null;
   ...
   boolean method6731(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "lc.ar(" + ')');
      }
   }
   ...
   public void method6676(int[] var1, int[] var2, int[] var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.method3884(var7, "lc.ab(" + ')');
      }
   }
   ...
   int[] method6681(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var5, "lc.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llc;IZS)V")
   @ObfuscatedName("og")
   public static void method6684(classLC var0, int var1, boolean var2, short var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var6, "lc.as(" + ')');
         }
      }
   }
   ...
   public void method6725(int var1) {
      classOP var2 = classOB.method8299(var1, (byte)6);
   ...
   @ObfuscatedName("ij")
   public static void method6670(classLC var0, int[] var1, int[] var2, classPI[] var3, boolean var4, int[] var5, int var6, int var7, int var8) {
      if (var0 == null) {
         var0.method6722();
      }
   ...
   public void method6690(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "lc.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("aa")
   public void method6693(classXY var1, int var2) {
      try {
         classXY.method12971(var1, 1705409403 * this.field4094, (byte)-40);
         ...
         for (int var6 = 0; var6 < 5; var6++) {
            ...
            classXY.method12971(var1, this.field4098[var6], (byte)-81);
         }
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "lc.aa(" + ')');
      }
   }
   ...
   public int method6707(int var1) {
      try {
         ...
         throw classEG.method3884(var5, "lc.ay(" + 41);
      }
   }
   ...
   void method6711(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "lc.aq(" + ')');
      }
   }
   ...
   public void method6723(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "lc.au(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llc;II)V")
   @ObfuscatedName("gf")
   public static void method6726(classLC var0, int var1, int var2) {
      if (var0 == null) {
         var0.method6730(var1, var1);
      } else {
         try {
            classOP var3 = classOB.method8299(var1, (byte)69);
            ...
            throw classEG.method3884(var4, "lc.ai(" + ')');
         }
      }
   }
   ...
   classER method6704(byte var1) {
      try {
            ...
            if (!var2) {
               ...
               for (int var13 = 0; var13 < 12; var13++) {
                  ...
                  if (this.method6738(var6, 1289614546)) {
                     ...
                     classPI var16 = var18;
                     classER var17 = this.method6739(var6, (byte)0).method8679(1705409403 * this.field4094, var16, -1218924652);
                     if (var17 != null) {
                        if (var1 != 0) {
                           throw new IllegalStateException();
                        }
               ...
               classER var14 = new classER(var10, var11);
         ...
         throw classEG.method3884(var9, "lc.aj(" + ')');
      }
   }
   ...
   classOF method6735(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "lc.aw(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llc;IZB)V")
   @ObfuscatedName("ay")
   public static void method6687(classLC var0, int var1, boolean var2, byte var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var6, "lc.ax(" + ')');
         }
      }
   }
   ...
   boolean method6738(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "lc.ak(" + ')');
      }
   }
   ...
   @ObfuscatedName("av")
   classOP method6739(int var1, byte var2) {
      try {
         return classOB.method8299(var1 - 2048, (byte)24);
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "lc.av(" + ')');
      }
   }
   ...
   int method6742(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "lc.at(" + 41);
      }
   }
   ...
   @ObfuscatedName("al")
   public classFX method6701(classOU var1, int var2, classOU var3, int var4, byte var5) {
      try {
         if (729560399 * this.field4099 != -1) {
            ...
            classFX var9 = (classFX)field4100.method6422(var6);
            if (var9 == null) {
               if (var5 != 1) {
                  throw new IllegalStateException();
               }
               ...
               for (int var11 = 0; var11 < 12; var11++) {
                  ...
                  if (this.method6738(var12, 2025551705)) {
                     ...
                     classPI var22 = var10000;
                     if (!classOP.method8670(this.method6739(var12, (byte)0), this.field4094 * 1705409403, var22, (short)8479)) {
                        if (var5 != 1) {
                           throw new IllegalStateException();
                        }
               ...
               if (var10) {
                  ...
                  if (this.field4106 * 2990377911060063119L != -1L) {
                     ...
                     var9 = (classFX)field4100.method6422(2990377911060063119L * this.field4106);
                  }
               ...
               if (null == var9) {
                  ...
                  for (int var23 = 0; var23 < 12; var23++) {
                     ...
                     if (this.method6738(var14, 1643713934)) {
                        ...
                        classOP var26 = this.method6739(var14, (byte)0);
                        classPI var28;
                        if (null == this.field4097) {
                           if (var5 != 1) {
                              throw new IllegalStateException();
                        ...
                        classPI var27 = var28;
                        classER var17 = classOP.method8676(var26, 1705409403 * this.field4094, var27, 1986500445);
                        if (null != var17) {
                           if (var5 != 1) {
                              throw new IllegalStateException();
                           }
                  ...
                  classER var24 = new classER(var20, var21);
            ...
            if (var1 == null) {
               ...
               if (var3 == null) {
                  classFX var31 = var9.method5081(true);
                  return var31;
               }
            }
            ...
            if (null != var1) {
               ...
               if (null != var3) {
                  ...
                  classFX var30 = var1.method8791(var9, var2, var3, var4, -1500497548);
                  return var30;
               }
            }
            ...
            classFX var19;
            if (null != var1) {
               var19 = classOU.method8793(var1, var9, var2, (byte)0);
            } else {
               var19 = classOU.method8793(var3, var9, var4, (byte)0);
            }

            return var19;
         }
      } catch (RuntimeException var18) {
         throw classEG.method3884(var18, "lc.al(" + ')');
      }
   }
   ...
   @ObfuscatedName("bp")
   public void method6671(int[] var1, int[] var2, classPI[] var3, boolean var4, int[] var5, int var6, int var7, int var8) {
      this.field4097 = var3;
      this.field4096 = var4;
   ...
   @ObfuscatedName("ky")
   public static classFX method6702(classLC var0, classOU var1, int var2, classOU var3, int var4) {
      if (-638706963 * var0.field4099 != -1) {
         ...
         classFX var8 = (classFX)field4100.method6422(var5);
         if (var8 == null) {
            boolean var9 = false;
            ...
            for (int var10 = 0; var10 < 12; var10++) {
               ...
               if (var0.method6738(var11, 1722141783)) {
                  classPI var20 = null == var0.field4097 ? null : var0.field4097[var10];
                  if (!classOP.method8670(var0.method6739(var11, (byte)0), var0.field4094 * 1705409403, var20, (short)5783)) {
                     var9 = true;
                  }
               }
            }
            ...
            if (var9) {
               if (var0.field4106 * 2990377911060063119L != -1L) {
                  var8 = (classFX)field4100.method6422(2990377911060063119L * var0.field4106);
               }
            ...
            if (null == var8) {
               ...
               for (int var21 = 0; var21 < 12; var21++) {
                  ...
                  if (var0.method6738(var13, 1769043077)) {
                     classOP var24 = var0.method6739(var13, (byte)0);
                     classPI var25 = null == var0.field4097 ? null : var0.field4097[var21];
                     classER var16 = classOP.method8676(var24, 546017664 * var0.field4094, var25, 1986500445);
                     if (null != var16) {
                        var18[var19++] = var16;
                     }
                  }
               ...
               classER var22 = new classER(var18, var19);
         ...
         if (var1 == null && var3 == null) {
            ...
            var17 = classOU.method8793(var1, var8, var2, (byte)0);
         } else {
            var17 = classOU.method8793(var3, var8, var4, (byte)0);
         }
   ...
   @ObfuscatedName("qp")
   public static int method6709(classLC var0) {
   ...
   public void method6716(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var7, "lc.ad(" + ')');
      }
   }
   ...
   @ObfuscatedName("yd")
   public static void method6712(classLC var0) {
   ...
   @ObfuscatedName("by")
   public void method6694(classXY var1) {
      classXY.method12971(var1, 1705409403 * this.field4094, (byte)-69);
      ...
      for (int var4 = 0; var4 < 5; var4++) {
         classXY.method12971(var1, this.field4098[var4], (byte)-62);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("be")
   public void method6695(classXY var1) {
      classXY.method12971(var1, 1705409403 * this.field4094, (byte)-9);
      ...
      for (int var4 = 0; var4 < 5; var4++) {
         classXY.method12971(var1, this.field4098[var4], (byte)-97);
      }
   }
      ...
      if (729560399 * this.field4099 != -1) {
         ...
         for (int var2 = 0; var2 < 12; var2++) {
            ...
            if (this.method6738(var3, 1515726625)) {
               classPI var10 = this.field4097 == null ? null : this.field4097[var2];
         ...
         if (var1) {
            ...
            for (int var11 = 0; var11 < 12; var11++) {
               ...
               if (this.method6738(var5, 1340149426)) {
                  classPI var14 = this.field4097 == null ? null : this.field4097[var11];
                  classER var15 = this.method6739(var5, (byte)0).method8679(1705409403 * this.field4094, var14, -1218924652);
                  if (var15 != null) {
                     var8[var9++] = var15;
                  }
               }
            ...
            classER var12 = new classER(var8, var9);
   ...
   @ObfuscatedName("gf")
   public static void method6685(classLC var0, int var1, boolean var2) {
         ...
         if (var1) {
            ...
            for (int var11 = 0; var11 < 12; var11++) {
               ...
               if (this.method6738(var5, 1633448407)) {
                  classPI var14 = this.field4097 == null ? null : this.field4097[var11];
                  classER var15 = this.method6739(var5, (byte)0).method8679(224650426 * this.field4094, var14, -1218924652);
                  if (var15 != null) {
                     var8[var9++] = var15;
                  }
               }
   ...
   @ObfuscatedSignature(descriptor = "(Llc;[I[I[Lpi;Z[IIII)V")
   @ObfuscatedName("fb")
   public static void method6672(classLC var0, int[] var1, int[] var2, classPI[] var3, boolean var4, int[] var5, int var6, int var7, int var8) {
      if (var0 == null) {
      ...
      try {
         if (this.method6738(this.field4095[0], 1563080477)) {
            if (var1 >= 128386535) {
               ...
               classOP var2 = this.method6739(this.field4095[0], (byte)0);
         ...
         throw classEG.method3884(var3, "lc.ap(" + ')');
      }
   }
   ...
   boolean method6720() {
      if (!this.method6738(this.field4095[0], 2112935319)) {
         ...
         classOP var1 = this.method6739(this.field4095[0], (byte)0);
   ...
   @ObfuscatedName("sx")
   public static void method6699(classLC var0, int var1) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var7, "lc.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("ae")
   public void method6673(int[] var1, int[] var2, classPI[] var3, boolean var4, int[] var5, int var6, int var7, int var8, int var9) {
      try {
         this.field4097 = var3;
         this.field4096 = var4;
         this.field4093 = var8 * -1540749783;
         ...
         throw classEG.method3884(var10, "lc.ae(" + ')');
      }
   }

   public ColorTextureOverride createColorTextureOverride(KitType var1, int var2) {
      classPI var3 = new classPI(var2);
      if (this.field4097 == null) {
         this.field4097 = new classPI[12];
      }
   ...
   public void method6727(int var1) {
      classOP var2 = classOB.method8299(var1, (byte)-127);
   ...
   public void method6728(int var1) {
      classOP var2 = classOB.method8299(var1, (byte)9);
      this.field4095[var2.field5044 * 1481543581] = var1 + 2048;
      if (-1 != var2.field5010 * -1462570117) {
         this.field4095[-1462570117 * var2.field5010] = 0;
      }
   ...
   @ObfuscatedSignature(descriptor = "([I[I[Lpi;Z[IIII)V")
   @ObfuscatedName("br")
   public void method6674(int[] var1, int[] var2, classPI[] var3, boolean var4, int[] var5, int var6, int var7, int var8) {
      this.field4097 = var3;
      this.field4096 = var4;
      this.field4093 = var8 * -1540749783;
      this.method6676(var1, var2, var5, var6, var7, -741931325);
   ...
   @ObfuscatedSignature(descriptor = "(Llc;Lou;ILou;I)Lfx;")
   @ObfuscatedName("wo")
   public static classFX method6703(classLC var0, classOU var1, int var2, classOU var3, int var4) {
         ...
         if (var8 == null) {
            ...
            for (int var10 = 0; var10 < 12; var10++) {
               ...
               if (var0.method6738(var11, 1347949179)) {
                  classPI var20 = null == var0.field4097 ? null : var0.field4097[var10];
                  if (!classOP.method8670(var0.method6739(var11, (byte)0), var0.field4094 * 1931442818, var20, (short)2425)) {
                     var9 = true;
                  }
               }
            }
            ...
            if (null == var8) {
               ...
               for (int var21 = 0; var21 < 12; var21++) {
                  ...
                  if (var0.method6738(var13, 2033277357)) {
                     classOP var24 = var0.method6739(var13, (byte)0);
                     classPI var25 = null == var0.field4097 ? null : var0.field4097[var21];
                     classER var16 = classOP.method8676(var24, 178328413 * var0.field4094, var25, 1986500445);
                     if (null != var16) {
                        var18[var19++] = var16;
                     }
                  }
   ...
   public void method6729(int var1) {
      classOP var2 = classOB.method8299(var1, (byte)70);
      this.field4095[var2.field5044 * 1481543581] = var1 + 2048;
      if (-1 != var2.field5010 * -1462570117) {
         this.field4095[-1462570117 * var2.field5010] = 0;
      }
   ...
   @ObfuscatedSignature(descriptor = "(Llc;I)V")
   @ObfuscatedName("fx")
   public static void method6692(classLC var0, int var1) {
   ...
   public static classUQ method6675(classGY var0, classVH var1, int var2) {
      try {
         ...
         throw classEG.method3884(var34, "lc.ab(" + ')');
      }
   }
   ...
   public static byte[] method6663(Object var0, boolean var1, int var2) {
      try {
         ...
         throw classEG.method3884(var4, "lc.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("qj")
   public static int[] method6683(classLC var0, int var1) {
      if (var0 == null) {
