...
public class classEG extends classRD {
   ...
   @ObfuscatedName("af")
   public static classAAF method3884(Throwable var0, String var1) {
      classAAF var2;
   ...
   public int compare(Object var1, Object var2) {
      try {
         return this.method3876((classRI)var1, (classRI)var2, 1822819216);
      } catch (RuntimeException var3) {
         throw method3884(var3, "eg.compare(" + 41);
      }
   }
   ...
   public int method3879(Object var1, Object var2) {
      return this.method3876((classRI)var1, (classRI)var2, 1500200517);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Object;Ljava/lang/Object;)I")
   @ObfuscatedName("ax")
   public int method3880(Object var1, Object var2) {
      return this.method3876((classRI)var1, (classRI)var2, 1895651778);
   }
   ...
   public static int method3882(int var0, byte var1) {
      try {
         ...
         throw method3884(var2, "eg.ax(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lri;Lri;I)I")
   @ObfuscatedName("az")
   int method3876(classRI var1, classRI var2, int var3) {
      try {
         ...
         throw method3884(var4, "eg.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("jd")
   public static int method3877(classEG var0, classRI var1, classRI var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("at")
   static int method3883(classLW var0, int var1) {
      try {
         if (11 != var0.field4375 * -1510882375) {
            ...
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var0.method7250(var2, 918177898);
            return 1;
         }
      } catch (RuntimeException var3) {
         throw method3884(var3, "eg.at(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lri;Lri;)I")
   @ObfuscatedName("af")
   int method3878(classRI var1, classRI var2) {
