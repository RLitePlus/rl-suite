      ...
      try {
         if (client.field973) {
            ...
            if (var0 >= 0) {
               ...
               if (var0 < client.field974.field6806.length) {
                  if (client.field974.field6806[var0] == null) {
                     if (var9 != -1739941876) {
                        throw new IllegalStateException();
                     }

                     client.field974.field6806[var0] = new classWZ(false);
                  }

                  client.field974.field6806[var0].method12683(var1, var2, var3, var4, var5, var6, var7, false, var8, -1505694045);
                  return;
               }
