...
public class classGF extends classHA {
   ...
   void vmethod467(classXY var1, int var2) {
      try {
         ...
         throw classEG.method3884(var5, "gf.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lgf;Lxy;I)V")
   @ObfuscatedName("dr")
   public static void method5404(classGF var0, classXY var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            if (var3 != 1177860011 * classHI.field2803.field2801) {
               ...
               var0.field2754 = classXY.method13047(var1, -2124153845) * -735630941;
               var0.field2755 = classXY.method13047(var1, -1018264231) * -1209921667;
               var0.field2569 = classXY.method13039(var1, -346779531) * 113218633;
               var0.field2568 = classXY.method13039(var1, -346779531) * 2071171191;
               var0.field2751 = classXY.method13047(var1, 4478478) * -1652832041;
               var0.field2750 = classXY.method13047(var1, -406885852) * -1381327085;
               var0.field2567 = classXY.method13039(var1, -346779531) * 1465087555;
               var0.field2566 = classXY.method13039(var1, -346779531) * 747418529;
            }
         } catch (RuntimeException var4) {
            throw classEG.method3884(var4, "gf.az(" + ')');
         }
      }
   }
   ...
   int method5426(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "gf.ac(" + 41);
      }
   }
   ...
   int method5415(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "gf.ag(" + 41);
      }
   }
   ...
   @ObfuscatedName("vx")
   public static void method5417(classCG var0) {
   ...
   @ObfuscatedName("bg")
   public static void method5405(classGF var0, classXY var1) {
      if (var0 == null) {
         var0.method5416();
      }
      ...
      if (var2 != 1177860011 * classHI.field2803.field2801) {
         ...
         var0.field2753 = classXY.method13039(var1, -346779531) * -2015926021;
         var0.field2752 = classXY.method13039(var1, -346779531) * -765552747;
         var0.field2754 = classXY.method13047(var1, -1163671264) * -735630941;
         var0.field2755 = classXY.method13047(var1, 563495098) * -1209921667;
         var0.field2569 = classXY.method13039(var1, -346779531) * 113218633;
         var0.field2568 = classXY.method13039(var1, -346779531) * 2071171191;
         var0.field2751 = classXY.method13047(var1, -847400085) * -1652832041;
         var0.field2750 = classXY.method13047(var1, -1658254727) * -1381327085;
         var0.field2567 = classXY.method13039(var1, -346779531) * 1465087555;
         var0.field2566 = classXY.method13039(var1, -346779531) * 747418529;
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.method3884(var3, "gf.equals(" + ')');
      }
   }
   ...
   public static int method5419(classGF var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "gf.as(" + 41);
         }
      }
   }
   ...
   public int hashCode() {
      try {
         ...
         throw classEG.method3884(var1, "gf.hashCode(" + 41);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lgf;Lxy;)V")
   @ObfuscatedName("em")
   public static void method5406(classGF var0, classXY var1) {
      if (var0 == null) {
         ...
         if (var2 != 1177860011 * classHI.field2803.field2801) {
            ...
            var0.field2753 = classXY.method13039(var1, -346779531) * -2015926021;
            var0.field2752 = classXY.method13039(var1, -346779531) * -765552747;
            var0.field2754 = classXY.method13047(var1, -61034170) * -735630941;
            var0.field2755 = classXY.method13047(var1, 685524750) * -1209921667;
            var0.field2569 = classXY.method13039(var1, -346779531) * 113218633;
            var0.field2568 = classXY.method13039(var1, -346779531) * 2071171191;
            var0.field2751 = classXY.method13047(var1, 1045258800) * -1652832041;
            var0.field2750 = classXY.method13047(var1, 1695287848) * -1381327085;
            var0.field2567 = classXY.method13039(var1, -346779531) * 1465087555;
            var0.field2566 = classXY.method13039(var1, -346779531) * 747418529;
         }
      }
   ...
   int method5422(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "gf.ax(" + 41);
      }
   }
   ...
   static float method5427(float[] var0, int var1, float var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var6, "gf.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IIB)Lcg;")
   @ObfuscatedName("ae")
   static classCG method5408(int var0, int var1, byte var2) {
      try {
         classBV var3 = (classBV)classCN.field1171.get(var0);
         return classBV.method1252(var3, var1, 1248547089);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "gf.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("az")
   void method5407(classXY var1, int var2) {
      try {
         this.field2752 = Math.min(-1667236931 * this.field2752, 4) * -765552747;
