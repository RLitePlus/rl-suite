...
@ObfuscatedName("fe")
public final class classFE implements WallObject, TileObject {
   @ObfuscatedName("zx")
   ...
   public Shape getConvexHull() {
      classFX var1 = this.method4616();
      if (var1 == null) {
         return null;
      } else {
         int var2 = Perspective.getTileHeight(classOE.field4843, this.getLocalLocation(), this.getPlane());
   ...
   public Shape getClickbox() {
      classDZ var1 = this.method4615();
      Shape var2 = Perspective.getClickbox(
         classOE.field4843, var1, this.method4616(), 0, this.field2244 * -777838807, this.field2245 * 31139801, this.field2242 * 1315862339
      );
      Shape var3 = Perspective.getClickbox(
         classOE.field4843, var1, this.method4618(), 0, this.field2244 * -777838807, this.field2245 * 31139801, this.field2242 * 1315862339
      );
   ...
   @ObfuscatedName("ym")
   public void method4626(classEE var1) {
      this.field2248 = var1;
   }
   ...
   @ObfuscatedName("lq")
   public classFX method4618() {
      classEE var1 = this.method4620();
      if (var1 == null) {
         return null;
      } else {
         return var1 instanceof classFX ? (classFX)var1 : var1.method3842();
      }
   }

   @ObfuscatedSignature(descriptor = "()Ldz;")
   @ObfuscatedName("ux")
   public classDZ method4615() {
      return classDZ.method3780(this.method4617());
   }
   ...
   public static classAAR method4612(String var0, String var1, boolean var2, byte var3) {
      try {
         ...
         String var5 = "";
         if (33 == 1602897005 * classNB.field4637) {
            if (var3 != 1) {
               throw new IllegalStateException();
            }

            var5 = "_rc";
         } else if (classNB.field4637 * 1602897005 == 34) {
            if (var3 != 1) {
               throw new IllegalStateException();
            }
         ...
         File var6 = new File(classIE.field2954, "jagex_" + var1 + "_preferences" + var0 + var5 + ".dat");
         if (!var2) {
            if (var3 != 1) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.method3884(var11, "fe.ae(" + ')');
      }
   }

   public WorldPoint getWorldLocation() {
      classDZ var1 = classDZ.method3780(this.method4617());
      if (var1 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lee;)V")
   @ObfuscatedName("nb")
   public void method4627(classEE var1) {
      this.field2249 = var1;
   }
   ...
   @ObfuscatedSignature(descriptor = "()Lfx;")
   @ObfuscatedName("re")
   public classFX method4616() {
      classEE var1 = this.method4623();
      if (var1 == null) {
         return null;
      } else {
         return var1 instanceof classFX ? (classFX)var1 : var1.method3842();
   ...
   @ObfuscatedName("bu")
   static int method4614(int var0, classBL var1, boolean var2, byte var3) {
      try {
         return 2;
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "fe.bu(" + 41);
      }
   }
