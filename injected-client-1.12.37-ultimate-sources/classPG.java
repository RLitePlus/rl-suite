...
public class classPG extends classVJ {
   ...
   @ObfuscatedName("ac")
   static classJZ field5238 = new classJZ(16);
   @ObfuscatedName("ao")
   final int field5240;
   @ObfuscatedName("aj")
   ...
   @ObfuscatedName("al")
   public static void method8857(classVA var0) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ao")
   public static void method8858(classVA var0) {
      classBQ.field531 = var0;
   }
