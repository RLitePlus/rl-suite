...
public class classXK {
   ...
   @ObfuscatedName("lr")
   public static void method12829(classXK var0, classXS var1, int var2, int var3, int var4) {
      if (var0 == null) {
         var0.method12827(var1, var2);
      } else {
         var0.field6884 = true;
         int var5 = classXY.method13047(var1, -1772956017);
         classXS.method12921(var1, (byte)88);

         for (int var6 = 0; var6 < var2; var6++) {
            for (int var7 = 0; var7 < var3; var7++) {
               for (int var8 = 0; var8 < var4; var8++) {
                  int var9 = classXS.method12923(var1, 1, 1958226558);
                  if (1 == var9) {
                     var0.field6885[var6][var7][var8] = classXS.method12923(var1, 26, 1859449697);
                  } else {
         ...
         classXS.method12926(var1, -2124279271);
   ...
   @ObfuscatedName("kz")
   public static void method12824(classXK var0, classXS var1, int var2) {
      if (var0 == null) {
         var0.method12827(var1, var2);
      } else {
         try {
   ...
   public static boolean method12834(classPN var0) {
      return var0 == null ? var0.method9029() : classRN.method10130(var0.field5353 * 1468976603, -68556490) == classYY.field7115;
   }
   ...
   @ObfuscatedName("ao")
   public void method12828(classXS var1, int var2, int var3, byte var4) {
      try {
   ...
   @ObfuscatedName("al")
   void method12830(classXS var1, int var2, int var3, int var4, int var5) {
      try {
         this.field6884 = true;
         int var6 = classXY.method13047(var1, -1737903474);
         classXS.method12921(var1, (byte)120);
         ...
         for (int var7 = 0; var7 < var2; var7++) {
            ...
            for (int var8 = 0; var8 < var3; var8++) {
               ...
               for (int var9 = 0; var9 < var4; var9++) {
                  ...
                  int var10 = classXS.method12923(var1, 1, -607133939);
                  if (1 == var10) {
                     if (var5 == -1926460509) {
                        throw new IllegalStateException();
                     }

                     this.field6885[var7][var8][var9] = classXS.method12923(var1, 26, 2052400899);
                  } else {
         ...
         classXS.method12926(var1, -2145664019);
   ...
   @ObfuscatedName("bu")
   public void method12825(classXS var1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;)V")
   @ObfuscatedName("bo")
   public void method12826(classXS var1) {
      this.method12830(var1, 4, 13, 13, -78621124);
   }

   @ObfuscatedSignature(descriptor = "(Lxs;III)V")
   @ObfuscatedName("bi")
   void method12831(classXS var1, int var2, int var3, int var4) {
      this.field6884 = true;
      int var5 = classXY.method13047(var1, -80072341);
      classXS.method12921(var1, (byte)4);

      for (int var6 = 0; var6 < var2; var6++) {
         for (int var7 = 0; var7 < var3; var7++) {
            for (int var8 = 0; var8 < var4; var8++) {
               int var9 = classXS.method12923(var1, 1, -910046796);
               if (1 == var9) {
                  this.field6885[var6][var7][var8] = classXS.method12923(var1, 26, 654595080);
               } else {
      ...
      classXS.method12926(var1, -2037731173);
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;III)V")
   @ObfuscatedName("ba")
   void method12832(classXS var1, int var2, int var3, int var4) {
      this.field6884 = true;
      int var5 = classXY.method13047(var1, -1055517426);
      classXS.method12921(var1, (byte)87);

      for (int var6 = 0; var6 < var2; var6++) {
         for (int var7 = 0; var7 < var3; var7++) {
            for (int var8 = 0; var8 < var4; var8++) {
               int var9 = classXS.method12923(var1, 1, -866579681);
               if (1 == var9) {
                  this.field6885[var6][var7][var8] = classXS.method12923(var1, 26, 1948589036);
               } else {
                  this.field6885[var6][var7][var8] = -1;
               }
            }
      ...
      classXS.method12926(var1, -2001055688);
      this.field6887 = new int[var5];
      Arrays.fill(this.field6887, -1);
      var5 = 0;
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;III)V")
   @ObfuscatedName("bb")
   void method12833(classXS var1, int var2, int var3, int var4) {
      this.field6884 = true;
      int var5 = classXY.method13047(var1, -85887301);
      classXS.method12921(var1, (byte)51);

      for (int var6 = 0; var6 < var2; var6++) {
         for (int var7 = 0; var7 < var3; var7++) {
            for (int var8 = 0; var8 < var4; var8++) {
               int var9 = classXS.method12923(var1, 1, -935446910);
               if (1 == var9) {
                  this.field6885[var6][var7][var8] = classXS.method12923(var1, 26, -508447026);
               } else {
                  this.field6885[var6][var7][var8] = -1;
               }
            }
      ...
      classXS.method12926(var1, -2101878870);
      this.field6887 = new int[var5];
      Arrays.fill(this.field6887, -1);
      var5 = 0;
   ...
   public static void method12823(int var0) {
      try {
         classJZ.method6431(classOR.field5098);
         classJZ.method6431(classOR.field5099);
   ...
   @ObfuscatedName("aa")
   public void method12827(classXS var1, int var2) {
      try {
