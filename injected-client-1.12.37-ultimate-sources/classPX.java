...
@ObfuscatedName("px")
public class classPX extends classVJ implements HealthBarConfig {
   @ObfuscatedName("av")
   ...
   @ObfuscatedName("au")
   static classJZ field5476 = new classJZ(64);
   @ObfuscatedName("at")
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ap")
   static classJZ field5475 = new classJZ(64);

   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("aj")
   public classYM method9367() {
      if (this.field5478 * -1922748515 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)field5476.method6422(this.field5478 * 1104423047);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedName("ae")
   public classYM method9365(int var1) {
      try {
         if (1254761701 * this.field5479 < 0) {
            ...
            classYM var2 = (classYM)field5476.method6422(this.field5479 * 1254761701);
            if (var2 != null) {
               if (var1 == -988824982) {
                  throw new IllegalStateException();
               } else {
         ...
         throw classEG.method3884(var3, "px.ae(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("zp")
   public classYM method9372() {
      return this.method9368((byte)-90);
   }

   @ObfuscatedSignature(descriptor = "(B)Lym;")
   @ObfuscatedName("ab")
   public classYM method9368(byte var1) {
      try {
         if (this.field5478 * 1914620357 < 0) {
            return null;
         } else {
            classYM var2 = (classYM)field5476.method6422(this.field5478 * 1914620357);
            if (var2 != null) {
               return var2;
            } else {
         ...
         throw classEG.method3884(var3, "px.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("yr")
   public static classYM method9369(classPX var0) {
      if (var0.field5478 * 1914620357 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)field5476.method6422(var0.field5478 * 1914620357);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedName("ag")
   public static classPX method9360(int var0) {
      classPX var1 = (classPX)field5475.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
         byte[] var2 = classMN.field4545.method11867(33, var0, -1602994962);
         var1 = new classPX(new classXY(var2), var0);
   ...
   @ObfuscatedSignature(descriptor = "(I)Lpx;")
   @ObfuscatedName("as")
   public static classPX method9361(int var0) {
      classPX var1 = (classPX)field5475.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
   ...
   public static void method9362() {
      classJZ.method6431(field5475);
      classJZ.method6431(field5476);
   }
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("ay")
   public classYM method9370() {
      if (this.field5478 * 1914620357 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)field5476.method6422(this.field5478 * 1914620357);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("ao")
   public classYM method9366() {
      if (-1087166743 * this.field5479 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)field5476.method6422(this.field5479 * 1254761701);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("sb")
   public classYM method9374() {
      return this.method9365(782773199);
   }

   classPX(classXY var1, int var2) {
         ...
         while (true) {
            ...
            switch (var12) {
               case 0:
                  break label53;
               case 1:
                  classXY.method13047(var1, -477261215);
                  continue;
               case 2:
               ...
               case 4:
                  ...
                  continue;
               case 5:
                  var7 = classXY.method13047(var1, 659653123);
                  continue;
               case 6:
               ...
               case 7:
                  ...
                  continue;
               case 8:
                  var9 = classXY.method13110(var1, -324749371);
               case 9:
               case 10:
               case 12:
               case 13:
               default:
                  continue;
               case 11:
                  var5 = classXY.method13047(var1, -1638589704);
                  continue;
               case 14:
                  var10 = classXY.method13039(var1, -346779531);
                  continue;
               case 15:
            }
