...
public class classCS {
   ...
   void method2619(int var1, int var2, int var3) {
      if (client.field1145) {
         classFQ.method4952(var1 - 22, 0, var1 + 128, classEU.field1938 * 8379747);
      }
      ...
      if (field1240) {
         try {
            ...
            try {
               ...
               throw classEG.method3884(var10, "cs.ag(" + ')');
            }
         } catch (Exception var11) {
            client.field1026.debug("failed drawing fire", var11);
         }
      }
   }
   ...
   void method2584(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "cs.ab(" + ')');
      }
   }
   ...
   public static void method2602(classCS var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.method3884(var4, "cs.ac(" + ')');
      }
   }
   ...
   final void method2591(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var16, "cs.as(" + ')');
      }
   }
   ...
   final void method2607(int var1, int[] var2, short var3) {
      try {
         ...
         throw classEG.method3884(var6, "cs.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("al")
   final void method2615(classYZ var1, int var2) {
      try {
         ...
         throw classEG.method3884(var9, "cs.al(" + ')');
      }
   }
   ...
   public static int method2599(classCS var0, int var1, int var2, int var3, int var4) {
      ...
      try {
         ...
         throw classEG.method3884(var6, "cs.ax(" + 41);
      }
   }
   ...
   public static void method2582(classCS var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "cs.ae(" + ')');
         }
      }
   }
   ...
   final void method2611(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var16, "cs.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("ba")
   final void method2616(classYZ var1) {
   ...
   static int[] method2577(int var0, int var1, int var2, int var3, int var4) {
      ...
      for (int var6 = 0; var6 < 64; var6++) {
         var5[var6] = classEI.method3896(var0, var1, var6, -2077477038);
      }

      for (int var7 = 0; var7 < 64; var7++) {
         var5[64 + var7] = classEI.method3896(var1, var2, var7, -2017816990);
      }

      for (int var8 = 0; var8 < 64; var8++) {
         var5[128 + var8] = classEI.method3896(var2, var3, var8, -1881223230);
      }

      for (int var9 = 0; var9 < 64; var9++) {
         var5[var9 + 192] = classEI.method3896(var3, var4, var9, -1598757105);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lyz;)V")
   @ObfuscatedName("bw")
   final void method2617(classYZ var1) {
      for (int var2 = 0; var2 < this.field1250.length; var2++) {
         this.field1250[var2] = 0;
      }
   ...
   public static int method2576(int var0) {
      try {
         ...
         throw classEG.method3884(var1, "cs.ab(" + 41);
      }
   }
   ...
   static final int method2595(int var0) {
      try {
         ...
         throw classEG.method3884(var1, "cs.aq(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lzv;Lzv;B)V")
   @ObfuscatedName("aw")
   static void method2618(classZV var0, classZV var1, byte var2) {
      try {
         if (classCR.field1230 == null) {
            classVP var4 = classHC.field2767;
            classYM[] var3;
            if (!classVA.method11853(var4, "sl_back", "", -1199864680)) {
               if (var2 <= 1) {
                  throw new IllegalStateException();
               }
         ...
         if (null == classBV.field590) {
            ...
            classBV.field590 = classSU.method10680(classHC.field2767, "leftarrow", "", 145885891);
         }
         ...
         if (null != classPD.field5227) {
            ...
            classYZ.method13810(classPD.field5227[1], 140 + -329898575 * classBF.field385, 1);
            var1.method56(classKK.field3913, 152 + classBF.field385 * -329898575, 10, 16777215, -1);
            classYZ.method13810(classPD.field5227[0], 140 + -329898575 * classBF.field385, 12);
         ...
         if (null != classPM.field5349) {
            ...
            label531: {
               if (classCM.field1154[0] == 0) {
                  if (var2 <= 1) {
                     throw new IllegalStateException();
                  }

                  if (1 == classCM.field1155[0]) {
                     if (var2 <= 1) {
                        return;
                     }

                     classYZ.method13810(classPM.field5349[3], var24 + 15, 4);
                     break label531;
                  }
               }

               classYZ.method13810(classPM.field5349[1], var24 + 15, 4);
            }
            ...
            label520: {
               if (classCM.field1154[0] == 1) {
                  if (var2 <= 1) {
                     return;
                  }

                  if (1 == classCM.field1155[0]) {
                     classYZ.method13810(classPM.field5349[3], 15 + var26, 4);
                     break label520;
                  }
               }

               classYZ.method13810(classPM.field5349[1], 15 + var26, 4);
            }
            ...
            label514: {
               ...
               if (classCM.field1154[0] == 2) {
                  if (var2 <= 1) {
                     throw new IllegalStateException();
                  }

                  if (0 == classCM.field1155[0]) {
            ...
            label508: {
               if (classCM.field1154[0] == 2) {
                  ...
                  if (classCM.field1155[0] == 1) {
                     if (var2 <= 1) {
                        throw new IllegalStateException();
                     }

                     classYZ.method13810(classPM.field5349[3], var28 + 15, 4);
                     break label508;
                  }
               }

               classYZ.method13810(classPM.field5349[1], var28 + 15, 4);
            }
            ...
            label502: {
               ...
               if (3 == classCM.field1154[0]) {
                  ...
                  if (0 == classCM.field1155[0]) {
                     ...
                     classYZ.method13810(classPM.field5349[2], var30, 4);
                     break label502;
                  }
               }

               classYZ.method13810(classPM.field5349[0], var30, 4);
            }
            ...
            if (classCM.field1154[0] == 3 && classCM.field1155[0] == 1) {
               ...
               classYZ.method13810(classPM.field5349[3], 15 + var30, 4);
            } else {
               classYZ.method13810(classPM.field5349[1], 15 + var30, 4);
            }
         ...
         if (classCR.field1230 != null) {
            ...
            while (true) {
               int var7 = var31;
               int var8 = var29;
               if (var31 * (var29 - 1) >= -622036481 * classCM.field1153) {
                  if (var2 <= 1) {
                     throw new IllegalStateException();
                  }
               ...
               if ((var31 - 1) * var29 >= classCM.field1153 * -622036481) {
                  if (var2 <= 1) {
                     throw new IllegalStateException();
                  }
               ...
               if (var29 * (var31 - 1) >= classCM.field1153 * -622036481) {
                  if (var2 <= 1) {
                     throw new IllegalStateException();
                  }
               ...
               if (var31 == var7) {
                  ...
                  if (var29 == var8) {
                     ...
                     int var11 = (classCM.field1153 * -622036481 + var31 - 1) / var31;
                     ...
                     for (int var17 = var31 * var16; var17 < -622036481 * classCM.field1153; var17++) {
                        if (var2 <= 1) {
                           throw new IllegalStateException();
                        }
                        ...
                        classCM var18 = classCM.field1170[var17];
                        boolean var19 = true;
                        ...
                        if (var18.method2506(-403512673)) {
                           ...
                           var21 = var10000;
                        } else if (classCM.method2487(var18, -2093717319)) {
                           if (var2 <= 1) {
                              throw new IllegalStateException();
                           }
                           ...
                           var21 = var38;
                        } else if (classCM.method2514(var18, (byte)20)) {
                           if (var2 <= 1) {
                              throw new IllegalStateException();
                           }
                        ...
                        label466: {
                           if (classTZ.field6255 * -38255113 >= var13 && classTZ.field6264 * -2144333897 >= var12) {
                              if (var2 <= 1) {
                                 throw new IllegalStateException();
                              }

                              if (-38255113 * classTZ.field6255 < var25 + var13) {
                                 if (var2 <= 1) {
                                    throw new IllegalStateException();
                                 }

                                 if (-2144333897 * classTZ.field6264 < var27 + var12) {
                                    if (var2 <= 1) {
                                       throw new IllegalStateException();
                                    }
                        ...
                        if (classCF.field720 != null) {
                           ...
                           classYZ[] var42 = classCF.field720;
                           int var10001;
                           if (var18.method2482((byte)-9)) {
                              if (var2 <= 1) {
                                 return;
                           ...
                           classYZ.method13810(var42[var10001 + var18.field1160 * -288138629], 29 + var13, var12);
                        }
                     ...
                     if (var15) {
                        ...
                        int var34 = var1.method36(classCM.field1170[classBF.field400 * -2105609177].field1167) + 6;
                        int var35 = var1.field8 + 8;
                        int var36 = classTZ.field6264 * -2144333897 + 25;
                        if (var35 + var36 > 480) {
                           if (var2 <= 1) {
                              throw new IllegalStateException();
                           }

                           var36 = -2144333897 * classTZ.field6264 - 25 - var35;
                        }

                        classYW.method13698(-38255113 * classTZ.field6255 - var34 / 2, var36, var34, var35, 16777120);
                        classYW.method13707(classTZ.field6255 * -38255113 - var34 / 2, var36, var34, var35, 0);
                        var1.method65(
                           classCM.field1170[classBF.field400 * -2105609177].field1167, classTZ.field6255 * -38255113, var36 + var1.field8 + 4, 0, -1
                        );
                     }
                     break;
                  }
         ...
         throw classEG.method3884(var23, "cs.aw(" + ')');
      }
   }
