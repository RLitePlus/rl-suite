...
@ObfuscatedName("jz")
public final class classJZ implements NodeCache {
   @ObfuscatedName("af")
   int field3503;
   @ObfuscatedName("lv")
   ...
   public static void method6443() {
      method6438("EnumDefinition_cached", classOD.field4820);
      method6438("animPoseCache", classOU.field5145);
      method6438("animationCache", classOU.field5141);
      method6438("animayaPoses", classOU.field5144);
      method6438("dbRowConfigCache", classZE.field7171);
      method6438("dbTableConfigCache", classZU.field7271);
      method6438("dbTableIndexCache", client.field978);
      method6438("field4546", classOI.field4872);
      method6438("field4739", classOW.field5183);
      method6438("field4817", classPS.field5406);
      ...
      method6438("healthBarCache", classPX.field5475);
      method6438("healthBarSpriteCache", classPX.field5476);
      ...
      method6438("itemModelCache", classOP.field5007);
      method6438("itemSpriteCache", classOP.field5008);
      method6438("items", classOP.field5006);
      ...
      method6438("playerModelCache", classLC.field4100);
      method6438("scriptCache", classBL.field491);
      ...
      method6438("varbits", classPT.field5418);
      method6438("varplayers", classOY.field5194);
      method6438("wecSpriteCache", classOI.field4873);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Ljz;)V")
   @ObfuscatedName("ql")
   public static void method6438(String var0, classJZ var1) {
      synchronized (var1) {
         classJZ var3 = var1;
         ...
         if (var4) {
            if (var3.field3501 > 0.2F) {
               client.field1026.trace("cache {} is thrashing", var0);
            }

            if (var3.field3501 > 0.9F && var3.field3503 < var3.field3507 * 8) {
               var3.method6437(var3.field3503 * 2);
               client.field1026.info("cache {} thrashing, enlarging to {} entries", var0, var3.field3503);
            }
         }
   ...
   public void method6428(classVJ var1, long var2) {
      ...
      classYN.method13576(this.field3502, var1, var2);
   ...
   @ObfuscatedName("rl")
   public static void method6431(classJZ var0) {
      if (var0 == null) {
         var0.method6436();
      }

      var0.field3504.method8262();
      classYN.method13579(var0.field3502);
   ...
   @ObfuscatedSignature(descriptor = "(Ljz;)V")
   @ObfuscatedName("kz")
   public static void method6432(classJZ var0) {
      var0.field3504.method8262();
      classYN.method13579(var0.field3502);
      var0.field3506 = new classVJ();
      var0.field3505 = var0.field3503;
   ...
   public classJZ(int var1) {
      ...
      this.field3502 = new classYN(var2);
      this.method6442();
   }
   ...
   public void method6433() {
      ...
      classYN.method13579(this.field3502);
   ...
   @ObfuscatedName("zf")
   public static void method6427(classJZ var0, long var1) {
