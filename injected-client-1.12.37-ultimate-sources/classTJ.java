...
public class classTJ {
   ...
   public static void method10873(long[] var0, Object[] var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var15, "tj.aq(" + ')');
      }
   }
         ...
         if (null != var1 && var1.method10756(-1934152677) < var2) {
            ...
            if (classYY.field7111 == var0.field6128) {
               ...
               if (var1 == null) {
                  ...
                  classTI.method10835((String[])classTE.method10753(var0, -2114224744), classTE.method10753(var1, -1101999915), 0, var2 - 1, -894259080);
               }
            }
         ...
         if (null != var1 && var1.method10756(265293717) < var2) {
            ...
            if (classYY.field7111 == var0.field6128) {
               ...
               if (var1 == null) {
                  ...
                  classTI.method10835((String[])classTE.method10753(var0, 1961840106), classTE.method10753(var1, -81783157), 0, var2 - 1, -579184311);
               }
            }
         ...
         if (null != var1 && var1.method10756(646782686) < var2) {
            ...
            if (classYY.field7111 == var0.field6128) {
               ...
               if (var1 == null) {
                  ...
                  classTI.method10835((String[])classTE.method10753(var0, -302255839), classTE.method10753(var1, -524403677), 0, var2 - 1, 32546055);
               }
            }
   ...
   protected static final void method10853(int var0) {
      try {
         ...
         for (int var3 = 0; var3 < 32; var3++) {
            ...
            classTQ.field6195[var3] = 0L;
         }

         classSI.field5964 = 0;
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "tj.afc(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "([I[Ljava/lang/Object;Lxs;I)V")
   @ObfuscatedName("ac")
   static void method10856(int[] var0, Object[] var1, classXS var2, int var3) {
      try {
         for (int var4 = 0; var4 < var0.length; var4++) {
            switch (classRN.method10130(var0[var4], 1542835111).field7107 * -900901303) {
               case 2:
         ...
         throw classEG.method3884(var5, "tj.ac(" + ')');
      }
   }
