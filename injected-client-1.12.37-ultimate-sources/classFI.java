...
@ObfuscatedName("fi")
public final class classFI implements DecorativeObject, TileObject {
   @ObfuscatedName("gl")
   ...
   public WorldPoint getWorldLocation() {
      classDZ var1 = classDZ.method3780(this.method4777());
      if (var1 == null) {
   ...
   @ObfuscatedName("aj")
   public classDZ method4780() {
      return classDZ.method3780(this.method4777());
   }

   @ObfuscatedSignature(descriptor = "(Lee;)V")
   @ObfuscatedName("eo")
   public void method4791(classEE var1) {
      this.field2278 = var1;
   }

   @ObfuscatedSignature(descriptor = "()Lfx;")
   @ObfuscatedName("hw")
   public classFX method4778() {
      classEE var1 = this.method4786();
      if (var1 == null) {
         return null;
      } else {
         classFX var2;
   ...
   @ObfuscatedSignature(descriptor = "(Lee;)V")
   @ObfuscatedName("go")
   public void method4792(classEE var1) {
      this.field2279 = var1;
   }

   @ObfuscatedSignature(descriptor = "()Lfx;")
   @ObfuscatedName("mv")
   public classFX method4779() {
      classEE var1 = this.method4789();
      if (var1 == null) {
         return null;
      } else {
         classFX var2;
