...
public abstract class classUR implements classTY {
   ...
   @ObfuscatedName("dz")
   static classYZ field6374;

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("af")
   abstract void vmethod581(classXY var1, int var2);

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ab")
   public void method11510(classXY var1, int var2) {
      try {
         while (true) {
            ...
            if (var4 != null) {
               ...
               switch (1829787843 * var4.field6356) {
                  case 0:
                     ...
                     classOF.method8404(var5, classXY.method13039(var1, -346779531), 522790870);
                     break;
                  case 1:
                  ...
                  case 3:
                     ...
                     this.field6373 = classRN.method10130(var6, 675005370);
         ...
         throw classEG.method3884(var7, "ur.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;IB)V")
   @ObfuscatedName("az")
   abstract void vmethod580(classXY var1, int var2, byte var3);

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ac")
   public void method11511(classXY var1) {
      while (true) {
         ...
         if (var3 != null) {
            switch (1829787843 * var3.field6356) {
               case 0:
                  ...
                  classOF.method8404(var4, classXY.method13039(var1, -346779531), -1379317163);
                  break;
               case 1:
               ...
               case 3:
                  ...
                  this.field6373 = classRN.method10130(var5, 1024371840);
                  if (null == this.field6373) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ae")
   abstract void vmethod579(classXY var1, int var2);
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ax")
   public void method11512(classXY var1) {
      while (true) {
         int var2 = classXY.method13039(var1, -346779531);
         if (var2 == 0) {
            return;
         ...
         if (var3 != null) {
            switch (1829787843 * var3.field6356) {
               case 0:
                  classKI[] var4 = new classKI[]{classKI.field3593, classKI.field3592, classKI.field3591, classKI.field3590};
                  classOF.method8404(var4, classXY.method13039(var1, -346779531), 1288041846);
                  break;
               case 1:
               ...
               case 3:
                  int var5 = classXY.method13039(var1, -346779531);
                  this.field6373 = classRN.method10130(var5, 1547033116);
                  if (null == this.field6373) {
                     throw new IllegalStateException("Unknown ScriptVarType ID in VarType.decode: " + var5);
                  }
            }
   ...
   static void method11526(byte var0) {
      try {
         ...
         throw classEG.method3884(var1, "ur.bn(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("aa")
   public void method11513(classXY var1) {
      while (true) {
         int var2 = classXY.method13039(var1, -346779531);
         if (var2 == 0) {
            return;
         ...
         if (var3 != null) {
            switch (-699991708 * var3.field6356) {
               case 0:
                  classKI[] var4 = new classKI[]{classKI.field3593, classKI.field3592, classKI.field3591, classKI.field3590};
                  classOF.method8404(var4, classXY.method13039(var1, -346779531), 762853606);
                  break;
               case 1:
               ...
               case 3:
                  int var5 = classXY.method13039(var1, -346779531);
                  this.field6373 = classRN.method10130(var5, -410694638);
                  if (null == this.field6373) {
                     throw new IllegalStateException("Unknown ScriptVarType ID in VarType.decode: " + var5);
                  }
            }
   ...
   public static boolean method11519(classUR var0, int var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "ur.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ao")
   public void method11514(classXY var1) {
      while (true) {
         int var2 = classXY.method13039(var1, -346779531);
         if (var2 == 0) {
            return;
         ...
         if (var3 != null) {
            switch (1829787843 * var3.field6356) {
               case 0:
                  classKI[] var4 = new classKI[]{classKI.field3593, classKI.field3592, classKI.field3591, classKI.field3590};
                  classOF.method8404(var4, classXY.method13039(var1, -346779531), -1740964773);
                  break;
               case 1:
               ...
               case 3:
                  int var5 = classXY.method13039(var1, -346779531);
                  this.field6373 = classRN.method10130(var5, 608112257);
                  if (null == this.field6373) {
                     throw new IllegalStateException("Unknown ScriptVarType ID in VarType.decode: " + var5);
                  }
            }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("al")
   public void method11515(classXY var1) {
      while (true) {
         int var2 = classXY.method13039(var1, -346779531);
         if (var2 == 0) {
            return;
         ...
         if (var3 != null) {
            switch (1829787843 * var3.field6356) {
               case 0:
                  classKI[] var4 = new classKI[]{classKI.field3593, classKI.field3592, classKI.field3591, classKI.field3590};
                  classOF.method8404(var4, classXY.method13039(var1, -346779531), -1195889883);
                  break;
               case 1:
               ...
               case 3:
                  int var5 = classXY.method13039(var1, -346779531);
                  this.field6373 = classRN.method10130(var5, -532509648);
                  if (null == this.field6373) {
                     throw new IllegalStateException("Unknown ScriptVarType ID in VarType.decode: " + var5);
                  }
            }
   ...
   Object method11523(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ur.as(" + ')');
      }
   }
