...
public final class classXN {
   ...
   @ObfuscatedName("fn")
   public static int method12853(classCY var0) {
   ...
   @ObfuscatedName("gr")
   public static classRR method12851(classRT var0, classAAE var1) {
      if (var0 == null) {
         var0.method10198();
      }

      return !var1.method171(-919842158) ? null : (classRR)var0.field5844.get(var1);
   }
