...
@ObfuscatedName("nb")
public class classNB implements MidiRequest {
   @ObfuscatedSignature(descriptor = "Lva;")
   @ObfuscatedName("az")
   public classVA field4642;
   ...
   public classNB(classVA var1, int var2, int var3, int var4, boolean var5) {
   ...
   @ObfuscatedName("af")
   void method7756(classVA var1, int var2, int var3, int var4, boolean var5) {
      this.field4642 = var1;
   ...
   public classNB(classVA var1, String var2, String var3, int var4, boolean var5) {
      this.field4630 = -424024677;
      this.field4635 = 0;
      this.field4631 = 0.0F;
      this.field4636 = false;
   ...
   @ObfuscatedSignature(descriptor = "(Lva;IIIZ)V")
   @ObfuscatedName("ab")
   void method7757(classVA var1, int var2, int var3, int var4, boolean var5) {
      this.field4642 = var1;
      this.field4632 = var2 * 1190162147;
   ...
   @ObfuscatedSignature(descriptor = "(Lva;IIIZ)V")
   @ObfuscatedName("yj")
   public void method7761(classVA var1, int var2, int var3, int var4, boolean var5) {
   ...
   @ObfuscatedName("og")
   public static void method7758(classNB var0, classVA var1, int var2, int var3, int var4, boolean var5, short var6) {
      if (var0 == null) {
   ...
   @ObfuscatedName("nd")
   public static void method7759(classNB var0, classVA var1, int var2, int var3, int var4, boolean var5) {
      if (var0 == null) {
   ...
   @ObfuscatedName("az")
   void method7760(classVA var1, int var2, int var3, int var4, boolean var5, short var6) {
