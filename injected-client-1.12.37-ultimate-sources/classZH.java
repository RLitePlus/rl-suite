...
public class classZH {
   ...
   @ObfuscatedName("vb")
   public static void method14010(classTQ var0, FocusEvent var1) {
      if (var0 == null) {
         var0.method10987();
      }

      classTQ.field6190 = true;
      var0.field6207 = true;
   }
   ...
   public void method13999(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "zh.az(" + ')');
      }
   }
   ...
   public int method14001(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "zh.af(" + 41);
      }
   }
   ...
   public void method14007(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "zh.ab(" + ')');
      }
   }
   ...
   public static int method14003(classZH var0, byte var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "zh.ae(" + 41);
      }
   }
