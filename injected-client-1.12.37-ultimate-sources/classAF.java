...
public class classAF implements Callable {
   ...
   classAF(classAC var1, classXY var2, classAE var3) {
      this.this$0 = var1;
      this.field143 = var2;
      this.field142 = var3;
   }
   ...
   @ObfuscatedName("fk")
   static void method341(int var0, classPL var1, int var2, boolean var3, classDN var4, String var5, int var6, int var7, int var8, int var9, byte var10) {
      try {
         if (var1.method8930(936289412).vmethod546((byte)0)) {
            ...
            for (int var11 = 4; var11 >= 0; var11--) {
               ...
               if (var12 != null) {
                  ...
                  int var14 = classRP.method10155(var12, var5, var13, var6, var7, var8, -1, false, var9, -324749371);
                  classJC.method6354(var14, var1.method8930(936289412), var11, var5, var13, var6, var7, var8, var9, -1533141989);
               }
            }
         }
      } catch (RuntimeException var15) {
         throw classEG.method3884(var15, "af.fk(" + ')');
      }
   }
   ...
   public static int method336(classEJ var0, Object var1, Object var2) {
      return var0 == null ? var0.method3902(var1, var1) : var0.method3901((classRI)var1, (classRI)var2, -1723306706);
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;II)V")
   @ObfuscatedName("ag")
   static void method339(classDZ var0, int var1, int var2, classUP var3, classKH var4, int var5, int var6) {
      try {
         if (1 == var5) {
            if (var6 >= -1673958617) {
               throw new IllegalStateException();
            ...
            classDN var7 = classCW.method2689(client.field941.method6533(-987724280), client.field814, 499194751);
            if (var7 != null) {
               if (var6 >= -1673958617) {
                  throw new IllegalStateException();
               }
            ...
            classDZ var11 = client.field814.method1596(client.field941.method6535(1166741555), client.field941.method6537(-1955951477), -992137014);
            ...
            classCT var12 = classEN.method3930(client.field941.method6533(-839253239), client.field814, -1096730237);
            if (var12 != null) {
               if (var6 >= -1673958617) {
                  throw new IllegalStateException();
               }
            ...
            classSP var14 = (classSP)classIS.field3053.field1700.method13595(var13);
            if (null != var14) {
               if (var6 >= -1673958617) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var10, "af.ag(" + ')');
      }
   }
   ...
   public Object call() {
      try {
         ...
         throw classEG.method3884(var1, "af.call(" + ')');
      }
   }
   ...
   static classCB[] method335(byte var0) {
      try {
         ...
         throw classEG.method3884(var1, "af.ag(" + ')');
      }
   }
   ...
   public static void method340(classTE var0, Object var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.method3884(var6, "af.ax(" + ')');
      }
   }
}
