...
public class classML {
   ...
   @ObfuscatedName("ej")
   public static void method7596(classQC var0, String[] var1) {
      if (var0 == null) {
   ...
   static void method7597(String var0, StringBuilder var1, classQI var2, int var3, int var4) {
      try {
         ...
         throw classEG.method3884(var8, "ml.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZI)I")
   @ObfuscatedName("bc")
   static int method7598(int var0, classBL var1, boolean var2, int var3) {
      try {
         classLW var4 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)38);
         if (2600 == var0) {
            if (var3 != 544148111) {
               throw new IllegalStateException();
            } else {
            ...
            if (var3 != 544148111) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var4.field4269 * -714521463;
               return 1;
            }
         } else if (2605 == var0) {
            if (var3 != 544148111) {
            ...
            if (var3 != 544148111) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -1246332317 * var4.field4356;
               return 1;
            }
         } else if (2607 == var0) {
            if (var3 != 544148111) {
            ...
            if (var3 != 544148111) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1740831551 * var4.field4270;
               return 1;
            }
         } else if (2612 == var0) {
            if (var3 != 544148111) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var4.field4295 * 948260113;
               return 1;
            }
         } else if (2613 == var0) {
            if (var3 != 544148111) {
            ...
            if (var3 != 544148111) {
               ...
               int var55 = (classDY.field1679 += 120041229) * -324749371 - 1;
               byte var70;
               if (var4.field4298) {
                  if (var3 != 544148111) {
                     throw new IllegalStateException();
            ...
            if (var0 == 2617) {
               ...
               classLI var5 = classLW.method7285(var4, 437269178);
            ...
            if (2618 == var0) {
               if (var3 != 544148111) {
                  ...
                  classLI var25 = classLW.method7285(var4, 1757148795);
                  int[] var39 = classBB.field323;
                  int var54 = (classDY.field1679 += 120041229) * -324749371 - 1;
                  int var69;
                  if (var25 != null) {
                     if (var3 != 544148111) {
                        throw new IllegalStateException();
               ...
               if (var3 != 544148111) {
                  ...
                  classLI var23 = classLW.method7285(var4, 707451256);
                  int[] var37 = classBB.field323;
                  int var52 = (classDY.field1679 += 120041229) * -324749371 - 1;
                  int var67;
                  if (null != var23) {
                     if (var3 != 544148111) {
                        throw new IllegalStateException();
               ...
               if (var3 != 544148111) {
                  ...
                  int var51 = (classDY.field1679 += 120041229) * -324749371 - 1;
                  int var66;
                  if (null != var22) {
                     if (var3 != 544148111) {
                        throw new IllegalStateException();
               ...
               if (var3 != 544148111) {
                  ...
                  label420: {
                     ...
                     var48 = (classDY.field1679 += 120041229) * -324749371 - 1;
                     if (var19 != null) {
                        if (var3 != 544148111) {
                           throw new IllegalStateException();
                        }
               ...
               if (var3 != 544148111) {
                  ...
                  label429: {
                     ...
                     var47 = (classDY.field1679 += 120041229) * -324749371 - 1;
                     if (var18 != null) {
                        if (var3 != 544148111) {
                           throw new IllegalStateException();
                        }
               ...
               int var44 = (classDY.field1679 += 120041229) * -324749371 - 1;
               int var59;
               if (null != var14) {
                  if (var3 != 544148111) {
                     throw new IllegalStateException();
               ...
               int var42 = (classDY.field1679 += 120041229) * -324749371 - 1;
               int var57;
               if (null != var12) {
                  if (var3 != 544148111) {
                     throw new IllegalStateException();
               ...
               if (var3 != 544148111) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = null != var11 ? var11.method7039((byte)-1) : 0;
                  return 1;
               }
            } else if (2633 == var0) {
               if (var3 != 544148111) {
                  ...
                  classBB.field323[-324749371 * classDY.field1679 - 1] = var10 != null
                     ? var10.method11138(classBB.field323[-324749371 * classDY.field1679 - 1], 1819826338)
                     : 0;
                  return 1;
               }
            } else if (2634 == var0) {
               if (var3 != 544148111) {
                  ...
                  int var41 = classDY.field1679 * -324749371 - 1;
                  int var56;
                  if (null != var9) {
                     if (var3 != 544148111) {
                        throw new IllegalStateException();
                     ...
                     var56 = var9.method11143((char)classBB.field323[classDY.field1679 * -324749371 - 1], 1475886825);
                  } else {
                     var56 = 0;
                  }
         ...
         throw classEG.method3884(var8, "ml.bc(" + 41);
      }
   }
}
