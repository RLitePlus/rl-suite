...
class classSL implements Callable {
   ...
   @ObfuscatedName("uf")
   public static int method10469(classTZ var0, MouseEvent var1) {
      if (var0 == null) {
   ...
   public static String method10470(CharSequence var0, short var1) {
      try {
         ...
         throw classEG.method3884(var2, "sl.ai(" + ')');
      }
   }
   ...
   public Object call() {
      try {
         ...
         throw classEG.method3884(var1, "sl.call(" + ')');
      }
   }
   ...
   classSL(classSN var1, classXY var2, int var3) {
      this.this$0 = var1;
      this.val$p = var2;
   ...
   static classSJ method10471(int var0) {
      try {
         ...
         throw classEG.method3884(var1, "sl.el(" + ')');
      }
   }
}
