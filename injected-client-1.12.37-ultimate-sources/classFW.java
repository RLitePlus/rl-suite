...
public class classFW {
   ...
   public boolean method5062(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var4, "fw.ax(" + ')');
      }
   }
   ...
   public void method5039(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fw.az(" + ')');
      }
   }
   ...
   public int method5056(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "fw.ag(" + 41);
      }
   }
   ...
   public int method5060(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "fw.as(" + 41);
      }
   }
   ...
   public int method5043(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fw.af(" + 41);
      }
   }
   ...
   public void method5055(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "fw.ab(" + ')');
      }
   }
   ...
   public boolean method5051(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fw.ae(" + ')');
      }
   }
   ...
   static void method5066(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         classEU.method4080(classCQ.field1220, var0, var1, var2, var3, var4, var5, -822185665);
      } catch (RuntimeException var7) {
         throw classEG.method3884(var7, "fw.dr(" + ')');
      }
   }
   ...
   @ObfuscatedName("kk")
   public static classKR method5065(classSP var0) {
      return var0.field6021;
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZI)I")
   @ObfuscatedName("cs")
   static int method5067(int var0, classBL var1, boolean var2, int var3) {
      try {
         if (8000 == var0) {
            if (var3 <= 658009662) {
               throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               int var63 = classBB.field323[1 + -324749371 * classDY.field1679];
            ...
            if (var3 <= 658009662) {
               ...
               int var109 = (classDY.field1679 += 120041229) * -324749371 - 1;
               byte var117;
               if (null == var37) {
                  if (var3 <= 658009662) {
                     throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               int var108 = (classDY.field1679 += 120041229) * -324749371 - 1;
               int var116;
               if (var36 != null) {
                  if (var3 <= 658009662) {
                     throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classSY.method10714(var35, var62, -325353510);
               return 1;
            }
         } else if (var0 == 8005) {
            if (var3 <= 658009662) {
               ...
               int var34 = classBB.field323[classDY.field1679 * -324749371];
               int var61 = classBB.field323[classDY.field1679 * -324749371 + 1];
               int var80 = classBB.field323[classDY.field1679 * -324749371 + 2];
               ...
               int var107 = (classDY.field1679 += 120041229) * -324749371 - 1;
               int var115;
               if (null != var91) {
                  if (var3 <= 658009662) {
                     throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               int var60 = classBB.field323[1 + classDY.field1679 * -324749371];
               int var79 = classBB.field323[-324749371 * classDY.field1679 + 2];
               ...
               int var106 = (classDY.field1679 += 120041229) * -324749371 - 1;
               int var114;
               if (var90 != null) {
                  if (var3 <= 658009662) {
                     throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               int var59 = classBB.field323[1 + classDY.field1679 * -324749371];
               int var78 = classBB.field323[classDY.field1679 * -324749371 + 2];
               ...
               int var105 = (classDY.field1679 += 120041229) * -324749371 - 1;
               int var113;
               if (var89 != null) {
                  if (var3 <= 658009662) {
                     throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               if (var31.field6128 == classYY.field7111) {
                  ...
                  int var103 = (classDY.field1679 += 120041229) * -324749371 - 1;
                  int var111;
                  if (var58 >= 0) {
                     if (var3 <= 658009662) {
                        throw new IllegalStateException();
            ...
            if (var3 <= 658009662) {
               ...
               classDY.field1679 -= 360123687;
               int var29 = classBB.field323[-324749371 * classDY.field1679];
               int var56 = classBB.field323[1 + -324749371 * classDY.field1679];
               int var75 = classBB.field323[2 + -324749371 * classDY.field1679];
            ...
            if (var3 <= 658009662) {
               ...
               classDY.field1679 -= 360123687;
               int var28 = classBB.field323[-324749371 * classDY.field1679];
               int var55 = classBB.field323[1 + -324749371 * classDY.field1679];
               int var74 = classBB.field323[classDY.field1679 * -324749371 + 2];
            ...
            int var52 = classBB.field323[-324749371 * classDY.field1679 + 1];
            int var72 = classBB.field323[classDY.field1679 * -324749371 + 2];
            classBB.field338 -= -1849233978;
            ...
            classDW.method3676(var82, var8, var24, var52, var72, 1473076970);
            return 1;
         } else if (8016 == var0) {
            classTE var23 = classJM.method6398(classBB.field328[(classBB.field338 -= 1222866659) * 1375698635], null, 1578948926);
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = (int)classQA.method9429(var23, -1710981879);
            return 1;
         } else if (var0 == 8017) {
            if (var3 <= 658009662) {
               throw new IllegalStateException();
               ...
               int var51 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classFK.method4819(var22, var51, (byte)-92);
               return 1;
            }
         } else if (8018 == var0) {
            if (var3 <= 658009662) {
               ...
               var20 = classUP.method11420(var20, classRR.method10179(-1124459322), classBB.field334, classBB.field333, (byte)0);
            ...
            classDY.field1679 -= 240082458;
            char var18 = (char)classBB.field323[classDY.field1679 * -324749371];
            int var48 = classBB.field323[-324749371 * classDY.field1679 + 1];
            classOD var71 = classKD.method6461(var48, 1996266443);
            if (!classOD.method8345(var71, var18, 1755902995)) {
               if (var3 <= 658009662) {
                  throw new IllegalStateException();
               } else {
            ...
            if (var3 <= 658009662) {
               ...
               int var47 = classBB.field323[-324749371 * classDY.field1679 + 1];
               classOD var70 = classKD.method6461(var47, 1856902854);
               if (!var70.method8348((char)var17, (byte)-121)) {
                  ...
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classOD.method8324(var70, (byte)27);
                  return 1;
               }
            }
         } else if (8022 == var0) {
            ...
            int var46 = classBB.field323[classDY.field1679 * -324749371 + 1];
            int var69 = classBB.field323[classDY.field1679 * -324749371 + 2];
            if (var69 < var46) {
               if (var3 <= 658009662) {
                  throw new IllegalStateException();
               }
            ...
            if (var3 <= 658009662) {
               ...
               classDY.field1679 -= 240082458;
               int var13 = classBB.field323[classDY.field1679 * -324749371];
               int var43 = classBB.field323[-324749371 * classDY.field1679 + 1];
         ...
         throw classEG.method3884(var9, "fw.cs(" + 41);
      }
   }
   ...
   public static double[] method5046(double var0, double var2, int var4, int var5) {
      try {
         ...
         throw classEG.method3884(var10, "fw.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llg;II)Llg;")
   @ObfuscatedName("ab")
   public static classLG method5064(classLG var0, int var1, int var2) {
      try {
         for (classLG var3 = var0; null != var3; var3 = var3.field4140) {
            if (var2 == -1907613182) {
               throw new IllegalStateException();
            }
