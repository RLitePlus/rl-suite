...
@ObfuscatedName("iq")
public class classIQ implements ClanSettings {
   @ObfuscatedName("al")
   ...
   boolean method6287(int var1, long var2) {
      try {
         if (this.field3033 != null) {
            classVQ var4 = this.field3033.method13595(var1);
            if (var4 != null) {
            ...
            this.field3033 = new classYN(4);
         }

         classYN.method13576(this.field3033, new classVK(var2), var1);
         return true;
      } catch (RuntimeException var6) {
         throw classEG.method3884(var6, "iq.ai(" + ')');
      }
   }
   ...
   @ObfuscatedName("aw")
   void method6297(classXY var1, int var2) {
      try {
         ...
         if (var3 >= 1) {
            if (var3 <= 6) {
               ...
               this.field3028 = classXY.method13047(var1, -502896030) * -987100999;
               this.field3027 = classXY.method13039(var1, -346779531) * 1554377879;
               ...
               this.field3023 = classXY.method13043(var1, (byte)17);
               this.field3025 = classXY.method13043(var1, (byte)17);
               this.field3024 = classXY.method13043(var1, (byte)17);
               this.field3019 = classXY.method13043(var1, (byte)17);
               if (this.field3028 * -1967686263 > 0) {
                  ...
                  for (int var5 = 0; var5 < this.field3028 * -1967686263; var5++) {
                     ...
                     this.field3037[var5] = classXY.method13043(var1, (byte)17);
                     if (var3 >= 2) {
                     ...
                     if (var3 >= 5) {
                        ...
                        this.field3039[var5] = classXY.method13047(var1, 709782397);
                     } else {
               ...
               if (var3 >= 3) {
                  ...
                  int var13 = classXY.method13047(var1, -734598826);
                  if (var13 > 0) {
                     if (var2 <= 439419475) {
                        return;
                     }

                     classYN var17 = new classYN;
                     int var10003;
                     if (var13 < 16) {
                        if (var2 <= 439419475) {
                           throw new IllegalStateException();
                     ...
                     while (var13-- > 0) {
                        ...
                        if (var8 == 0) {
                           ...
                           classYN.method13576(this.field3033, new classVG(var9), var7);
                        } else if (var8 == 1) {
                           if (var2 <= 439419475) {
                              return;
                           }
                           ...
                           classYN.method13576(this.field3033, new classVK(var14), var7);
                        } else if (2 == var8) {
                           if (var2 <= 439419475) {
                              return;
                           }
                           ...
                           classYN.method13576(this.field3033, new classVE(var15), var7);
                        }
                     }
                  }
               }
         ...
         throw classEG.method3884(var11, "iq.aw(" + ')');
      }
   }
   ...
   @ObfuscatedName("ju")
   public static boolean method6292(classIQ var0, int var1, String var2) {
      if (var0 == null) {
      ...
      if (null != var0.field3033) {
         classVQ var3 = var0.field3033.method13595(var1);
         if (var3 != null) {
            if (var3 instanceof classVE) {
               ...
               if (var4.field6498 instanceof String) {
                  ...
                  var4.vmethod398();
                  classYN.method13576(var0.field3033, new classVE(var2), var4.field6552);
                  return true;
               }
            }
         ...
         var0.field3033 = new classYN(4);
      }

      classYN.method13576(var0.field3033, new classVE(var2), var1);
      return true;
   }
   ...
   boolean method6284(int var1, int var2, int var3, int var4) {
      ...
      if (null != this.field3033) {
         classVQ var8 = this.field3033.method13595(var1);
         if (var8 != null) {
            if (var8 instanceof classVG) {
               classVG var9 = (classVG)var8;
               if ((var9.field6503 & var7) == var2) {
                  return false;
               }
      ...
      classYN.method13576(this.field3033, new classVG(var2), var1);
      return true;
   }
   ...
   @ObfuscatedName("jk")
   public static int method6270(classIQ var0, int var1, byte var2) {
      if (var0 == null) {
   ...
   void method6252(long var1, String var3, int var4, int var5) {
      try {
         ...
         throw classEG.method3884(var6, "iq.ax(" + ')');
      }
   }
   ...
   void method6264(long var1, String var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var5, "iq.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("ui")
   public static boolean method6293(classIQ var0, int var1, String var2, byte var3) {
      if (var0 == null) {
         ...
         try {
            ...
            if (null != var0.field3033) {
               ...
               classVQ var4 = var0.field3033.method13595(var1);
               if (var4 != null) {
                  if (var3 >= 106) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (var4 instanceof classVE) {
                     ...
                     if (var5.field6498 instanceof String) {
                        ...
                        var5.vmethod398();
                        classYN.method13576(var0.field3033, new classVE(var2), var5.field6552);
                        return true;
                     }
                  }
            ...
            throw classEG.method3884(var6, "iq.ar(" + ')');
         }
      }
   }
   ...
   void method6268(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "iq.al(" + ')');
      }
   }
   ...
   int method6271(int var1, byte var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "iq.aj(" + 41);
      }
   }

   public classIQ(classXY var1) {
   ...
   int method6281(int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         throw classEG.method3884(var10, "iq.ad(" + 41);
      }
   }
   ...
   @ObfuscatedName("mz")
   public static boolean method6288(classIQ var0, int var1, long var2) {
      ...
      classYN.method13576(var0.field3033, new classVK(var2), var1);
      return true;
   }
   ...
   void method6260(int var1) {
      try {
         ...
         throw classEG.method3884(var5, "iq.aa(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Liq;ILjava/lang/String;)Z")
   @ObfuscatedName("gg")
   public static boolean method6294(classIQ var0, int var1, String var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ut")
   public static int method6276(classIQ var0, int var1, boolean var2, int var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var4, "iq.aq(" + 41);
      }
   }
   ...
   boolean method6285(int var1, int var2, int var3, int var4, short var5) {
      try {
         ...
         if (null != this.field3033) {
            ...
            classVQ var9 = this.field3033.method13595(var1);
            if (var9 != null) {
               if (var5 != 16256) {
                  throw new IllegalStateException();
               }

               if (var9 instanceof classVG) {
                  classVG var10 = (classVG)var9;
                  if ((var10.field6503 & var8) == var2) {
                     if (var5 != 16256) {
                        throw new IllegalStateException();
                     }
                  ...
                  var10.field6503 &= ~var8;
                  var10.field6503 |= var2;
                  return true;
               }
         ...
         throw classEG.method3884(var11, "iq.au(" + ')');
      }
   }
   ...
   public ClanTitle titleForRank(ClanRank var1) {
      if (!classOE.field4843.isClientThread()) {
         ...
         if (var2 == 1023) {
            ...
            classOD var3 = classOE.field4843.method2279(3797);
   ...
   @ObfuscatedName("cq")
   public static void method6265(classIQ var0, long var1, String var3) {
      if (var0 == null) {
         var0.method6262();
      }
   ...
   public int[] method6249(byte var1) {
      try {
         ...
         throw classEG.method3884(var4, "iq.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("bc")
   public static void method6237(classIQ var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var3, "iq.af(" + ')');
         }
      }
   }
   ...
   public Integer method6246(int var1) {
      if (null == this.field3033) {
         ...
         classVQ var2 = this.field3033.method13595(var1);
         return var2 != null && var2 instanceof classVG ? new Integer(((classVG)var2).field6503) : null;
      }
   }
   ...
   @ObfuscatedName("md")
   public static int method6277(classIQ var0, int var1, boolean var2) {
      if (var2 == var0.field3045[var1]) {
         return -1;
      } else {
         var0.field3045[var1] = var2;
   ...
   @ObfuscatedSignature(descriptor = "(Liq;IJ)Z")
   @ObfuscatedName("at")
   public static boolean method6289(classIQ var0, int var1, long var2) {
      if (var0.field3033 != null) {
         classVQ var4 = var0.field3033.method13595(var1);
         if (var4 != null) {
            if (var4 instanceof classVK) {
   ...
   @ObfuscatedSignature(descriptor = "(Liq;II)V")
   @ObfuscatedName("vf")
   public static void method6255(classIQ var0, int var1, int var2) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var3, "iq.ac(" + ')');
      }
   }
   ...
   boolean method6274(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "iq.ay(" + ')');
      }
   }
   ...
   @ObfuscatedName("nm")
   public static int method6244(classIQ var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var6, "iq.ab(" + 41);
         }
      }
   }
   ...
   public Integer method6247(int var1, byte var2) {
      try {
         if (null == this.field3033) {
            ...
            classVQ var3 = this.field3033.method13595(var1);
            if (var3 != null) {
               if (var2 != 75) {
                  throw new IllegalStateException();
               }

               if (var3 instanceof classVG) {
                  return new Integer(((classVG)var3).field6503);
               }
         ...
         throw classEG.method3884(var4, "iq.ag(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Liq;IIS)Z")
   @ObfuscatedName("rw")
   public static boolean method6282(classIQ var0, int var1, int var2, short var3) {
      if (var0 == null) {
      ...
      try {
         if (null != var0.field3033) {
            ...
            if (null != var4) {
               ...
               if (var4 instanceof classVG) {
                  if (var3 == 1000) {
                     throw new IllegalStateException();
                  }

                  classVG var5 = (classVG)var4;
                  if (var2 == var5.field6503) {
                     if (var3 == 1000) {
                        throw new IllegalStateException();
                     }
         ...
         classYN.method13576(var0.field3033, new classVG(var2), var1);
         return true;
      } catch (RuntimeException var6) {
         throw classEG.method3884(var6, "iq.ap(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("cv")
   void method6298(classXY var1) {
      ...
      if (var2 >= 1 && var2 <= 6) {
         ...
         this.field3028 = classXY.method13047(var1, 1085925872) * -987100999;
         this.field3027 = classXY.method13039(var1, -346779531) * 1554377879;
         ...
         this.field3034 = classXY.method13039(var1, -346779531) == 1;
         this.field3023 = classXY.method13043(var1, (byte)17);
         this.field3025 = classXY.method13043(var1, (byte)17);
         this.field3024 = classXY.method13043(var1, (byte)17);
         this.field3019 = classXY.method13043(var1, (byte)17);
         if (this.field3028 * -1967686263 > 0) {
            ...
            for (int var4 = 0; var4 < this.field3028 * -1967686263; var4++) {
               ...
               this.field3037[var4] = classXY.method13043(var1, (byte)17);
               if (var2 >= 2) {
                  this.field3038[var4] = var1.method13056((byte)1);
               }

               if (var2 >= 5) {
                  this.field3039[var4] = classXY.method13047(var1, -384456557);
               } else {
                  this.field3039[var4] = 0;
               }

               if (var2 >= 6) {
                  this.field3045[var4] = classXY.method13039(var1, -346779531) == 1;
               } else {
         ...
         if (var2 >= 3) {
            int var11 = classXY.method13047(var1, 907409062);
            if (var11 > 0) {
               this.field3033 = new classYN(var11 < 16 ? classBZ.method1385(var11, -1573601361) : 16);
               ...
               while (var11-- > 0) {
                  ...
                  if (var7 == 0) {
                     ...
                     classYN.method13576(this.field3033, new classVG(var8), var6);
                  } else if (var7 == 1) {
                     long var12 = var1.method13059(2090571963);
                     classYN.method13576(this.field3033, new classVK(var12), var6);
                  } else if (2 == var7) {
                     String var13 = var1.method13071(-986049037);
                     classYN.method13576(this.field3033, new classVE(var13), var6);
                  }
               }
            }
         }
   ...
   @ObfuscatedName("du")
   public static int[] method6251(classIQ var0) {
      if (var0 == null) {
         var0.getName();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Liq;JLjava/lang/String;)V")
   @ObfuscatedName("km")
   public static void method6267(classIQ var0, long var1, String var3) {
      if (var0 == null) {
         var0.method6261();
      }
   ...
   void method6236(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "iq.az(" + ')');
      }
   }
   ...
   boolean method6295(int var1, String var2) {
         ...
         if (var3 != null) {
            if (var3 instanceof classVE) {
               ...
               if (var4.field6498 instanceof String) {
                  ...
                  var4.vmethod398();
                  classYN.method13576(this.field3033, new classVE(var2), var4.field6552);
                  return true;
               }
            }
      ...
      classYN.method13576(this.field3033, new classVE(var2), var1);
      return true;
   }
   ...
   @ObfuscatedName("eu")
   public static Integer method6248(classIQ var0, int var1) {
      if (null == var0.field3033) {
         return null;
      } else {
         classVQ var2 = var0.field3033.method13595(var1);
         return var2 != null && var2 instanceof classVG ? new Integer(((classVG)var2).field6503) : null;
      }
   }
   ...
   boolean method6283(int var1, int var2, short var3) {
      try {
         if (null != this.field3033) {
            ...
            classVQ var4 = this.field3033.method13570(var1);
            if (null != var4) {
               if (var3 == 1000) {
                  throw new IllegalStateException();
               }
   ...
   boolean method6296(int var1, String var2, byte var3) {
      try {
         ...
         if (null != this.field3033) {
            ...
            classVQ var4 = this.field3033.method13571(var1);
            if (var4 != null) {
               if (var3 >= 106) {
                  throw new IllegalStateException();
               }
               ...
               if (var4 instanceof classVE) {
                  ...
                  if (var5.field6498 instanceof String) {
                     ...
                     var5.method12065();
                     classYN.method13576(this.field3033, new classVE(var2), var5.field6552);
                     return true;
                  }
               }
