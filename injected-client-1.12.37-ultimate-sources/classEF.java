...
public class classEF {
   ...
   @ObfuscatedName("ax")
   static void method3867(int var0, int var1, int var2, classYM var3, byte var4) {
      try {
         int var5 = 128 * var2;
   ...
   @ObfuscatedName("kp")
   public static void method3868(classFX var0) {
      if (var0.field2489 != 2) {
         var0.field2489 = 2;
         var0.field2491 = 0;
   ...
   public static classJL method3849(classJS var0, classYT var1, byte var2) {
      try {
         classJL var3 = classFJ.method4793(2062869276);
         var3.field3342 = var0;
         ...
         if (-1669214905 * var3.field3339 == -1) {
            ...
            var3.field3343 = new classXS(260);
         } else if (-1669214905 * var3.field3339 == -2) {
            if (var2 == 80) {
               throw new IllegalStateException();
            }

            var3.field3343 = new classXS(10000);
         } else if (var3.field3339 * -1669214905 <= 18) {
            var3.field3343 = new classXS(20);
         } else if (var3.field3339 * -1669214905 <= 98) {
            if (var2 == 80) {
               throw new IllegalStateException();
            }

            var3.field3343 = new classXS(100);
         } else {
            var3.field3343 = new classXS(260);
         }
   ...
   @ObfuscatedName("bj")
   static int method3870(int var0, classBL var1, boolean var2, int var3) {
      try {
         if (var0 == 3400) {
            if (var3 <= -1510882375) {
               throw new IllegalStateException();
               ...
               int var13 = classBB.field323[1 + classDY.field1679 * -324749371];
               classOD var14 = classKD.method6461(var11, 530175687);
            ...
            char var10 = (char)classBB.field323[classDY.field1679 * -324749371];
            char var12 = (char)classBB.field323[1 + classDY.field1679 * -324749371];
            int var6 = classBB.field323[-324749371 * classDY.field1679 + 2];
            int var7 = classBB.field323[3 + classDY.field1679 * -324749371];
            classOD var8 = classKD.method6461(var6, 1708727636);
            if (classOD.method8345(var8, var10, 1682366299)) {
               if (var3 <= -1510882375) {
                  throw new IllegalStateException();
               }
               ...
               if (var8.method8348(var12, (byte)-11)) {
                  if (var8.method8348('s', (byte)-5)) {
                     ...
                     classBB.field322[(classXT.field6939 += -1297854163) * 18294437 - 1] = classOD.method8341(var8, var7, -980214786);
                  } else {
                     classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var8.method8334(var7, -1739848449);
                  }
            ...
            if (var3 <= -1510882375) {
               ...
               classOD var5 = classKD.method6461(var4, 697661822);
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var5.method8316(1033162533);
               return 1;
            }
         } else {
            return 2;
