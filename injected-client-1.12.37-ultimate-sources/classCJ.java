...
@ObfuscatedName("cj")
public class classCJ extends classEE {
   ...
   protected classFX vmethod104(int var1) {
      try {
         if (classQR.method9763(this.field756, 30, -582512908)) {
            ...
            classFX var3 = var2.method8724(this.field756.method9738(1752853829), 693671413);
            if (null == var3) {
               if (var1 <= -1767431455) {
                  throw new IllegalStateException();
               } else {
   ...
   public static classUZ method1528(classCJ var0, int var1, int var2, int var3, int var4, classCL var5) {
      ...
      if (var1 != 0) {
         ...
         if (var1 > 0) {
            ...
            var8 = (classDH)var6.field1698.method13404(var9);
         } else {
            int var15 = -var1 - 1;
         ...
         if (var8 != null) {
            classKY var16 = ((classDH)var8).method3162(var6, (short)14590);
      ...
      if (classUZ.method11745(var7, (byte)-105)) {
         ...
         classSP var10 = (classSP)classCL.method1592(var5, 389165674).field1700.method13595(2140889407 * var6.field1699);
         if (var10 != null) {
      ...
      classSP var13 = (classSP)classIS.field3053.field1700.method13595(2140889407 * var6.field1699);
      if (var13 != null) {
   ...
   protected boolean vmethod95(int var1) {
      try {
         if (!this.field756.method9726(374233424) || !this.field756.method9731((byte)20).method8749(this.field756.method9738(1772728062), 1284412146)) {
            ...
            classFX var3 = var2.method8726(-1330005868);
            if (var3 != null) {
               if (var1 == -702405562) {
                  throw new IllegalStateException();
               }
      ...
      try {
         ...
         if (var1 != 0) {
            ...
            if (var1 > 0) {
               ...
               var9 = (classDH)var7.field1698.method13404(var10);
            } else {
               int var17 = -var1 - 1;
            ...
            if (var9 != null) {
               ...
               classKY var18 = ((classDH)var9).method3162(var7, (short)22956);
         ...
         if (classUZ.method11745(var8, (byte)-74)) {
            ...
            classSP var11 = (classSP)classCL.method1592(var5, -511366864).field1700.method13595(2140889407 * var7.field1699);
            if (var11 != null) {
               if (var6 <= -620999211) {
                  throw new IllegalStateException();
               }
         ...
         classSP var14 = (classSP)classIS.field3053.field1700.method13595(2140889407 * var7.field1699);
         if (var14 != null) {
            if (var6 <= -620999211) {
               throw new IllegalStateException();
            }
   ...
   float method1533(int var1, int var2, byte var3) {
      try {
         ...
         classZR var4 = classZS.method14182(classCA.method1392(86, -1915095011).method14145(this.field757, (byte)2), (byte)76);
   ...
   protected classFX vmethod92() {
      if (classQR.method9763(this.field756, 30, -358027484)) {
         ...
         classFX var2 = var1.method8724(this.field756.method9738(2070897939), 2115114581);
         if (null == var2) {
            return null;
         } else {
   ...
   protected classFX vmethod93() {
      if (classQR.method9763(this.field756, 30, -1665523617)) {
         ...
         classFX var2 = var1.method8724(this.field756.method9738(1685883776), 986120572);
         if (null == var2) {
            return null;
         } else {
   ...
   protected boolean vmethod94() {
      if (this.field756.method9726(374233424) && this.field756.method9731((byte)117).method8749(this.field756.method9738(1842855393), 1284412146)) {
         ...
         classFX var2 = var1.method8726(-1288479329);
   ...
   protected boolean vmethod97() {
      if (this.field756.method9726(374233424) && this.field756.method9731((byte)121).method8749(this.field756.method9738(1794646517), 1284412146)) {
         ...
         classFX var2 = var1.method8726(635083275);
         return var2 != null && null != var2.field2444;
      }
   }
   ...
   float method1534(int var1, int var2) {
      this.field757[0] = var1;
      this.field757[1] = var2;
      classZR var3 = classZS.method14182(classCA.method1392(86, -1211743857).method14145(this.field757, (byte)2), (byte)17);
   ...
   float method1535(int var1, int var2) {
      this.field757[0] = var1;
      this.field757[1] = var2;
      classZR var3 = classZS.method14182(classCA.method1392(86, -1318195149).method14145(this.field757, (byte)2), (byte)8);
   ...
   float method1536(int var1, int var2) {
      this.field757[0] = var1;
      this.field757[1] = var2;
      classZR var3 = classZS.method14182(classCA.method1392(1347938593, -1827146925).method14145(this.field757, (byte)2), (byte)72);
   ...
   public static float method1537(classCJ var0, int var1, int var2) {
      ...
      classZR var3 = classZS.method14182(classCA.method1392(86, -1128929206).method14145(var0.field757, (byte)2), (byte)94);
   ...
   protected boolean vmethod96() {
      if (this.field756.method9726(374233424) && this.field756.method9731((byte)66).method8749(this.field756.method9738(1911726146), 1284412146)) {
         ...
         classFX var2 = var1.method8726(-149157205);
         return var2 != null && null != var2.field2444;
      }
   }
   ...
   classUZ method1530(int var1, int var2, int var3, int var4, classCL var5) {
      ...
      if (var1 != 0) {
         ...
         if (var8 != null) {
            classKY var16 = ((classDH)var8).method3162(var6, (short)21769);
            var7.field6427 = var16.field4055 * 1870919123;
            var7.field6426 = var16.field4056 * 819227381;
         }
      }
      ...
      if (classUZ.method11745(var7, (byte)-76)) {
         ...
         int var14 = var2 - -1444178379 * var6.field1709;
         int var17 = var4 - -351145363 * var6.field1708;
         classSP var10 = (classSP)classCL.method1592(var5, -864240403).field1700.method13595(2140889407 * var6.field1699);
         if (var10 != null) {
   ...
   float method1538(int var1, int var2) {
      this.field757[0] = var1;
      this.field757[1] = var2;
      classZR var3 = classZS.method14182(classCA.method1392(86, -1322829539).method14145(this.field757, (byte)2), (byte)19);
   ...
   static boolean method1572(byte[] var0, int var1) {
      try {
         return classFP.method4918(var0, 0, 0, 63, 63, (short)-18383);
      } catch (RuntimeException var2) {
