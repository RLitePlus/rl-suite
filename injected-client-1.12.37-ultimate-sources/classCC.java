...
public class classCC {
   ...
   static void method1408(int var0) {
      try {
         classCT var1 = classMB.method7521(-1477207973);
         if (null != var1) {
            if (var0 != -806820883) {
         ...
         throw classEG.method3884(var2, "cc.cb(" + ')');
      }
   }
   ...
   static classVP method1407(int var0, boolean var1, boolean var2, boolean var3, boolean var4, byte var5) {
      try {
         ...
         if (null != classME.field4488) {
            ...
            var6 = new classUS(var0, classME.field4488, classBI.field477[var0], 1000000);
         }

         return new classVP(var6, classQX.field5623, classEB.field1726, var0, var1, var2, var3, var4, false);
      } catch (RuntimeException var7) {
         throw classEG.method3884(var7, "cc.ad(" + ')');
      }
   }
   ...
   static final void method1409(byte var0) {
      try {
         for (classBS var1 = (classBS)client.field817.method7915(); null != var1; var1 = (classBS)classNN.method7924(client.field817)) {
            if (var0 != 0) {
               throw new IllegalStateException();
            }
            ...
            if (1612595797 * client.field855 > var1.field558 * 384835215) {
               ...
               classBS.method1224(var1, client.field814, 1612595797 * client.field855, client.field949 * -322689719, (byte)1);
               classEZ.method4477(
         ...
         throw classEG.method3884(var2, "cc.cf(" + ')');
      }
   }
   ...
   static final void method1406(int[][][] var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.method3884(var7, "cc.as(" + ')');
      }
   }
}
