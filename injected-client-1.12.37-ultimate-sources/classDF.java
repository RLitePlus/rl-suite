...
public class classDF {
   ...
   @ObfuscatedName("vf")
   public static void method3005(classDF var0, classXS var1) {
      if (var0 == null) {
         var0.method3023();
      }
      ...
      var0.field1421 = 0;
      int var2 = 0;
      classXS.method12921(var1, (byte)124);
      ...
      for (int var3 = 0; var3 < -2087374717 * var0.field1419; var3++) {
         ...
         if (0 == (var0.field1411[var4].field1390 & 1)) {
            if (var2 > 0) {
               ...
               int var5 = classXS.method12923(var1, 1, 1303445017);
               if (0 == var5) {
      ...
      classXS.method12926(var1, -2041514663);
      if (0 != var2) {
         throw new RuntimeException();
      } else {
         classXS.method12921(var1, (byte)84);
         ...
         for (int var6 = 0; var6 < var0.field1419 * -2087374717; var6++) {
            ...
            if (0 != (var0.field1411[var10].field1390 & 1)) {
               if (var2 > 0) {
                  ...
                  int var13 = classXS.method12923(var1, 1, 687097639);
                  if (0 == var13) {
         ...
         classXS.method12926(var1, -2098706057);
         if (0 != var2) {
            throw new RuntimeException();
         } else {
            classXS.method12921(var1, (byte)100);
            ...
            for (int var7 = 0; var7 < -392147439 * var0.field1420; var7++) {
               ...
               if ((var0.field1411[var11].field1390 & 1) != 0) {
                  if (var2 > 0) {
                     ...
                     int var14 = classXS.method12923(var1, 1, 1023345228);
                     if (0 == var14) {
            ...
            classXS.method12926(var1, -2084469240);
            if (0 != var2) {
               throw new RuntimeException();
            } else {
               classXS.method12921(var1, (byte)74);
               ...
               for (int var8 = 0; var8 < -392147439 * var0.field1420; var8++) {
                  ...
                  if ((var0.field1411[var12].field1390 & 1) == 0) {
                     if (var2 > 0) {
                        ...
                        int var15 = classXS.method12923(var1, 1, 1078779395);
                        if (0 == var15) {
               ...
               classXS.method12926(var1, -1997811777);
               if (var2 != 0) {
                  throw new RuntimeException();
               } else {
                  var0.field1419 = 0;
   ...
   @ObfuscatedName("ak")
   final void method2998(classXS var1) {
      this.method3047((byte)-26);
      classXS.method12921(var1, (byte)73);
      int var2 = client.field845 * -2130951373;
      classDC var3 = this.field1411[var2];
      int var4 = classXS.method12923(var1, 30, -902348308);
      ...
      for (int var5 = 1; var5 < -1229865211; var5++) {
         if (var2 != var5) {
            int var6 = classXS.method12923(var1, 18, 694404393);
            int var7 = var6 >> 16;
      ...
      classXS.method12926(var1, -2065401702);
   }
   ...
   static void method3053(int var0, byte var1) {
      try {
         classOU var2 = classQA.method9430(var0, 1151859829);
   ...
   @ObfuscatedName("af")
   final void method2999(classXS var1, int var2) {
      try {
         this.method3047((byte)37);
         classXS.method12921(var1, (byte)106);
         int var3 = client.field845 * -2130951373;
         classDC var4 = this.field1411[var3];
         int var5 = classXS.method12923(var1, 30, 507360607);
         ...
         for (int var6 = 1; var6 < 2048; var6++) {
            ...
            if (var3 != var6) {
               int var7 = classXS.method12923(var1, 18, -876826065);
               int var8 = var7 >> 16;
         ...
         classXS.method12926(var1, -2131718181);
   ...
   @ObfuscatedName("ao")
   void method3028(classDZ var1, int var2) {
      try {
         for (int var3 = 0; var3 < -2087374717 * this.field1419; var3++) {
            ...
            label92: {
               ...
               var7 = (classCT)var1.field1694.method13404(var4);
            ...
            if (var8) {
               ...
               if (var7 == null) {
                  ...
                  classYK.method13392(var1.field1694, var7, var4);
                  continue;
               }
            }
   ...
   @ObfuscatedName("ax")
   boolean method3017(classXS var1, int var2, byte var3) {
      try {
         classDC var4 = this.field1411[var2];
         int var5 = classXS.method12923(var1, 2, 142189890);
         if (0 == var5) {
            if (var3 >= 1) {
               throw new IllegalStateException();
            } else {
               if (classXS.method12923(var1, 1, 141540366) != 0) {
                  if (var3 >= 1) {
                     throw new IllegalStateException();
                  }
               ...
               int var17 = classXS.method12923(var1, 13, 534680227);
               int var20 = classXS.method12923(var1, 13, 1255518308);
               boolean var10000;
               if (classXS.method12923(var1, 1, 1535870282) == 1) {
                  if (var3 >= 1) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 >= 1) {
               ...
               int var16 = classXS.method12923(var1, 2, 1499016338);
            ...
            if (var3 >= 1) {
               ...
               int var15 = classXS.method12923(var1, 5, -215102774);
               int var18 = var15 >> 3;
               int var21 = var15 & 7;
            ...
            int var6 = classXS.method12923(var1, 18, -482688450);
            int var7 = var6 >> 16;
            int var8 = var6 >> 8 & 0xFF;
            int var9 = var6 & 0xFF;
      ...
      try {
         for (int var2 = 0; var2 < -117780849 * this.field1421; var2++) {
            ...
            while (var5.hasNext()) {
               ...
               classDZ var6 = (classDZ)var5.next();
               classCT var7 = (classCT)var6.field1694.method13404(var3);
               if (null != var7) {
                  if (var1 != 13) {
                     throw new IllegalStateException();
                  }
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("xu")
   public void method3056(classXS var1, int var2) {
      classDH.field1483 = true;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("al")
   void method3032(classXS var1, int var2) {
      try {
   ...
   @ObfuscatedName("bs")
   void method3036(classXS var1, int var2, int var3) {
      classDC var4 = this.field1411[var2];
      ...
      if ((var3 & 4096) != 0) {
         ...
         this.field1414.field6955 = 0;
         String var12 = classAAA.method8(classJE.method6358(classND.method7818(this.field1414, 1593979022), (byte)-53));
         byte[] var13 = null;
         if (var40 > 0 && var40 <= 8) {
   ...
   @ObfuscatedName("xi")
   public void method3055(classCT var1) {
      if (var1 != null) {
   ...
   @ObfuscatedName("ay")
   void method3037(classXS var1, int var2, int var3, int var4) {
      try {
         ...
         if ((var3 & 4096) != 0) {
            ...
            this.field1414.field6955 = 0;
            String var13 = classAAA.method8(classJE.method6358(classND.method7818(this.field1414, 2085654973), (byte)-41));
            byte[] var14 = null;
            if (var42 > 0) {
               if (var4 != -774455835) {
                  throw new IllegalStateException();
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;)V")
   @ObfuscatedName("aw")
   final void method3000(classXS var1) {
      this.method3047((byte)61);
      classXS.method12921(var1, (byte)25);
      int var2 = client.field845 * -2130951373;
      classDC var3 = this.field1411[var2];
      int var4 = classXS.method12923(var1, 30, 1113671095);
      classDC.method2893(var3, -1, -387955630);
      ...
      for (int var5 = 1; var5 < 2048; var5++) {
         if (var2 != var5) {
            int var6 = classXS.method12923(var1, 18, -164466485);
            int var7 = var6 >> 16;
            int var8 = var6 >> 8 & 0xFF;
            int var9 = var6 & 0xFF;
      ...
      classXS.method12926(var1, -2044633650);
   }
   ...
   @ObfuscatedName("lj")
   public static void method3041(classDF var0, classCT var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("at")
   final void method3001(classXS var1, int var2) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;)V")
   @ObfuscatedName("ah")
   void method3006(classXS var1) {
      this.field1421 = 0;
      int var2 = 0;
      classXS.method12921(var1, (byte)11);
      ...
      for (int var3 = 0; var3 < -2087374717 * this.field1419; var3++) {
         ...
         if (0 == (this.field1411[var4].field1390 & 1)) {
            if (var2 > 0) {
               ...
               int var5 = classXS.method12923(var1, 1, -696129177);
               if (0 == var5) {
      ...
      classXS.method12926(var1, -2073075344);
      if (0 != var2) {
         throw new RuntimeException();
      } else {
         classXS.method12921(var1, (byte)44);
         ...
         for (int var6 = 0; var6 < this.field1419 * -2087374717; var6++) {
            ...
            if (0 != (this.field1411[var10].field1390 & 1)) {
               if (var2 > 0) {
                  ...
                  int var13 = classXS.method12923(var1, 1, 1726458331);
                  if (0 == var13) {
         ...
         classXS.method12926(var1, -2014856266);
         if (0 != var2) {
            throw new RuntimeException();
         } else {
            classXS.method12921(var1, (byte)56);
            ...
            for (int var7 = 0; var7 < -392147439 * this.field1420; var7++) {
               ...
               if ((this.field1411[var11].field1390 & 1) != 0) {
                  if (var2 > 0) {
                     ...
                     int var14 = classXS.method12923(var1, 1, 1267311306);
                     if (0 == var14) {
            ...
            classXS.method12926(var1, -2049945442);
            if (0 != var2) {
               throw new RuntimeException();
            } else {
               classXS.method12921(var1, (byte)7);
               ...
               for (int var8 = 0; var8 < -392147439 * this.field1420; var8++) {
                  ...
                  if ((this.field1411[var12].field1390 & 1) == 0) {
                     if (var2 > 0) {
                        ...
                        int var15 = classXS.method12923(var1, 1, 1322352265);
                        if (0 == var15) {
               ...
               classXS.method12926(var1, -2105646061);
               if (var2 != 0) {
                  throw new RuntimeException();
               } else {
                  this.field1419 = 0;
   ...
   @ObfuscatedName("br")
   boolean method3018(classXS var1, int var2) {
      classDC var3 = this.field1411[var2];
      int var4 = classXS.method12923(var1, 2, -593790965);
      if (0 == var4) {
         if (classXS.method12923(var1, 1, 309772517) != 0) {
            this.method3017(var1, var2, (byte)-119);
         }

         int var15 = classXS.method12923(var1, 13, 1553307871);
         int var18 = classXS.method12923(var1, 13, -636824328);
         boolean var21 = classXS.method12923(var1, 1, 1450494940) == 1;
         if (var21) {
            this.field1417[(this.field1413 += -2126160331) * -764574691 - 1] = var2;
         }
         ...
         int var14 = classXS.method12923(var1, 2, 359155538);
         ...
         int var13 = classXS.method12923(var1, 5, 240078741);
         int var16 = var13 >> 3;
         int var19 = var13 & 7;
         ...
         int var5 = classXS.method12923(var1, 18, 16412291);
         int var6 = var5 >> 16;
   ...
   void method3020() {
      for (int var1 = 0; var1 < -117780849 * this.field1421; var1++) {
         ...
         for (classDZ var5 : client.field814) {
            classCT var6 = (classCT)var5.field1694.method13404(var2);
            if (null != var6) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldf;Lxs;)V")
   @ObfuscatedName("ng")
   public static void method3007(classDF var0, classXS var1) {
      if (var0 == null) {
         var0.method3024();
      } else {
         var0.field1421 = 0;
         int var2 = 0;
         classXS.method12921(var1, (byte)103);
         ...
         for (int var3 = 0; var3 < -2087374717 * var0.field1419; var3++) {
            ...
            if (0 == (var0.field1411[var4].field1390 & 1)) {
               if (var2 > 0) {
                  ...
                  int var5 = classXS.method12923(var1, 1, 257954179);
                  if (0 == var5) {
         ...
         classXS.method12926(var1, -2076567891);
         if (0 != var2) {
            throw new RuntimeException();
         } else {
            classXS.method12921(var1, (byte)15);
            ...
            for (int var6 = 0; var6 < var0.field1419 * -2087374717; var6++) {
               ...
               if (0 != (var0.field1411[var10].field1390 & 1)) {
                  if (var2 > 0) {
                     ...
                     int var13 = classXS.method12923(var1, 1, 1860421692);
                     if (0 == var13) {
            ...
            classXS.method12926(var1, -2061190182);
            if (0 != var2) {
               throw new RuntimeException();
            } else {
               classXS.method12921(var1, (byte)47);
               ...
               for (int var7 = 0; var7 < -392147439 * var0.field1420; var7++) {
                  ...
                  if ((var0.field1411[var11].field1390 & 1) != 0) {
                     if (var2 > 0) {
                        ...
                        int var14 = classXS.method12923(var1, 1, 764267746);
                        if (0 == var14) {
               ...
               classXS.method12926(var1, -2071313335);
               if (0 != var2) {
                  throw new RuntimeException();
               } else {
                  classXS.method12921(var1, (byte)19);
                  ...
                  for (int var8 = 0; var8 < -392147439 * var0.field1420; var8++) {
                     ...
                     if ((var0.field1411[var12].field1390 & 1) == 0) {
                        if (var2 > 0) {
                           ...
                           int var15 = classXS.method12923(var1, 1, 1017593654);
                           if (0 == var15) {
                  ...
                  classXS.method12926(var1, -1991036730);
                  if (var2 != 0) {
                     throw new RuntimeException();
                  } else {
                     var0.field1419 = 0;
   ...
   @ObfuscatedName("uu")
   public static int method3009(classDF var0, classXS var1, int var2) {
      if (var0 == null) {
         return var0.method3012(var1, var2);
      } else {
         try {
            int var3 = classXS.method12923(var1, 2, -566844910);
            int var4;
            if (0 == var3) {
               if (var2 == 825241857) {
                  throw new IllegalStateException();
               ...
               var4 = classXS.method12923(var1, 5, 1966523972);
            } else if (var3 == 2) {
               if (var2 == 825241857) {
                  throw new IllegalStateException();
               }

               var4 = classXS.method12923(var1, 8, 1770189469);
            } else {
               var4 = classXS.method12923(var1, 11, -276199589);
            }
   ...
   @ObfuscatedName("bp")
   int method3010(classXS var1) {
      int var2 = classXS.method12923(var1, 2, 1090199453);
      int var3;
      if (0 == var2) {
         var3 = 0;
      } else if (1 == var2) {
         var3 = classXS.method12923(var1, 5, 842667183);
      } else if (var2 == 2) {
         var3 = classXS.method12923(var1, 8, 1302897533);
      } else {
         var3 = classXS.method12923(var1, 11, 1501356260);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;II)V")
   @ObfuscatedName("by")
   void method3038(classXS var1, int var2, int var3) {
      classDC var4 = this.field1411[var2];
      int var5 = -922988928;
      if ((var3 & 8) != 0) {
      ...
      if ((var3 & 4096) != 0) {
         ...
         this.field1414.field6955 = 0;
         String var12 = classAAA.method8(classJE.method6358(classND.method7818(this.field1414, -961480929), (byte)32));
         byte[] var13 = null;
         if (var40 > 0 && var40 <= 8) {
            var13 = new byte[var40];
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;II)V")
   @ObfuscatedName("bq")
   void method3039(classXS var1, int var2, int var3) {
      classDC var4 = this.field1411[var2];
      int var5 = Integer.MAX_VALUE;
      if ((var3 & 8) != 0) {
      ...
      if ((var3 & 4096) != 0) {
         ...
         this.field1414.field6955 = 0;
         String var12 = classAAA.method8(classJE.method6358(classND.method7818(this.field1414, -1865475282), (byte)94));
         byte[] var13 = null;
         if (var40 > 0 && var40 <= 8) {
            var13 = new byte[var40];
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;II)V")
   @ObfuscatedName("bf")
   void method3040(classXS var1, int var2, int var3) {
      classDC var4 = this.field1411[var2];
      int var5 = Integer.MAX_VALUE;
      if ((var3 & 8) != 0) {
      ...
      if ((var3 & 4096) != 0) {
         ...
         this.field1414.field6955 = 0;
         String var12 = classAAA.method8(classJE.method6358(classND.method7818(this.field1414, -590118962), (byte)58));
         byte[] var13 = null;
         if (var40 > 0 && var40 <= 8) {
            var13 = new byte[var40];
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;II)V")
   @ObfuscatedName("ae")
   final void method3002(classXS var1, int var2, int var3) {
   ...
   @ObfuscatedName("dr")
   public static void method3015(classDF var0, classXS var1, int var2, byte var3) {
      if (var0 == null) {
         var0.method3016(var1, var2, var3);
      } else {
         try {
            boolean var10000;
            if (classXS.method12923(var1, 1, -998577547) == 1) {
               if (var3 >= 6) {
                  return;
               }
            ...
            int var5 = classXS.method12923(var1, 2, 328478500);
            ...
            if (var5 == 0) {
               if (var4) {
                  ...
                  if (classXS.method12923(var1, 1, -748527848) != 0) {
                     if (var3 >= 6) {
                        throw new IllegalStateException();
                     }
               ...
               if (var3 >= 6) {
                  ...
                  int var15 = classXS.method12923(var1, 3, 779393692);
               ...
               if (var3 >= 6) {
                  ...
                  int var14 = classXS.method12923(var1, 4, 173498494);
               ...
               int var7 = classXS.method12923(var1, 1, 1344124283);
               if (var7 == 0) {
                  if (var3 < 6) {
                     int var16 = classXS.method12923(var1, 12, -234384970);
                     int var19 = var16 >> 10;
                  ...
                  int var8 = classXS.method12923(var1, 30, 1513831361);
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;)I")
   @ObfuscatedName("bx")
   int method3011(classXS var1) {
      int var2 = classXS.method12923(var1, 2, 1144488309);
      int var3;
      if (0 == var2) {
         var3 = 0;
      } else if (1 == var2) {
         var3 = classXS.method12923(var1, 5, -800988753);
      } else if (var2 == 2) {
         var3 = classXS.method12923(var1, 8, 1082666753);
      } else {
         var3 = classXS.method12923(var1, 11, 279502634);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("av")
   final void method3003(classXS var1, int var2) {
      int var3 = 702114061 * var1.field6955;
      this.field1413 = 0;
      method3008(this, var1, 448842070);
      this.method3019((byte)13);
   ...
   @ObfuscatedName("ag")
   int method3012(classXS var1, int var2) {
      try {
         int var3 = classXS.method12923(var1, 2, -566844910);
         int var4;
         if (0 == var3) {
   ...
   @ObfuscatedName("wc")
   public static int method3013(classDF var0, classXS var1) {
      if (var0 == null) {
         var0.method3025();
      }

      int var2 = classXS.method12923(var1, 2, 216882995);
      int var3;
      if (0 == var2) {
         var3 = 0;
      } else if (1 == var2) {
         var3 = classXS.method12923(var1, 5, 813753866);
      } else if (var2 == 2) {
         var3 = classXS.method12923(var1, 8, 596870314);
      } else {
         var3 = classXS.method12923(var1, 11, 928967232);
      }
   ...
   @ObfuscatedName("aq")
   void method3045(classCT var1, int var2) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldf;Lxs;)I")
   @ObfuscatedName("me")
   public static int method3014(classDF var0, classXS var1) {
      if (var0 == null) {
         var0.method3021();
      }

      int var2 = classXS.method12923(var1, 2, 1668416360);
      int var3;
      if (0 == var2) {
         var3 = 0;
      } else if (1 == var2) {
         var3 = classXS.method12923(var1, 5, 1840317125);
      } else if (var2 == 2) {
         var3 = classXS.method12923(var1, 8, -469014597);
      } else {
         var3 = classXS.method12923(var1, 11, 1636662552);
      }
   ...
   @ObfuscatedName("lw")
   public static void method3008(classDF var0, classXS var1, int var2) {
      if (var0 == null) {
      ...
      try {
         var0.field1421 = 0;
         int var3 = 0;
         classXS.method12921(var1, (byte)39);
         ...
         for (int var4 = 0; var4 < -2087374717 * var0.field1419; var4++) {
            ...
            if (0 == (var0.field1411[var5].field1390 & 1)) {
               ...
               if (var3 > 0) {
                  ...
                  int var6 = classXS.method12923(var1, 1, -925340340);
                  if (0 == var6) {
                     if (var2 != 448842070) {
                        throw new IllegalStateException();
                     }
         ...
         classXS.method12926(var1, -2113762511);
         if (0 != var3) {
            throw new RuntimeException();
         } else {
            classXS.method12921(var1, (byte)110);
            ...
            for (int var8 = 0; var8 < var0.field1419 * -2087374717; var8++) {
               ...
               if (0 != (var0.field1411[var12].field1390 & 1)) {
                  ...
                  if (var3 > 0) {
                     ...
                     int var15 = classXS.method12923(var1, 1, 802148163);
                     if (0 == var15) {
                        if (var2 != 448842070) {
                           throw new IllegalStateException();
                        }
            ...
            classXS.method12926(var1, -2086296611);
            if (0 != var3) {
               if (var2 != 448842070) {
                  throw new IllegalStateException();
               } else {
               ...
               classXS.method12921(var1, (byte)71);
               ...
               for (int var9 = 0; var9 < -392147439 * var0.field1420; var9++) {
                  ...
                  if ((var0.field1411[var13].field1390 & 1) != 0) {
                     ...
                     if (var3 > 0) {
                        ...
                        int var16 = classXS.method12923(var1, 1, 1159021329);
                        if (0 == var16) {
               ...
               classXS.method12926(var1, -2019821228);
               if (0 != var3) {
                  if (var2 != 448842070) {
                     throw new IllegalStateException();
                  } else {
                  ...
                  classXS.method12921(var1, (byte)70);
                  ...
                  for (int var10 = 0; var10 < -392147439 * var0.field1420; var10++) {
                     ...
                     if ((var0.field1411[var14].field1390 & 1) == 0) {
                        ...
                        if (var3 > 0) {
                           ...
                           int var17 = classXS.method12923(var1, 1, 136234705);
                           if (0 == var17) {
                              if (var2 != 448842070) {
                                 return;
                              }
                  ...
                  classXS.method12926(var1, -2076587269);
                  if (var3 == 0) {
                     var0.field1419 = 0;
                     var0.field1420 = 0;
   ...
   @ObfuscatedName("as")
   void method3016(classXS var1, int var2, byte var3) {
      try {
         boolean var10000;
         if (classXS.method12923(var1, 1, -998577547) == 1) {
            if (var3 >= 6) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("ab")
   void method3004(classXS var1, int var2) {
      int var3 = 702114061 * var1.field6955;
      this.field1420 = 0;
      method3008(this, var1, 448842070);
