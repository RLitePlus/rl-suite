...
public class classEB {
   ...
   @ObfuscatedName("bs")
   static final void method3803(classDZ var0, classDH var1, int var2) {
      try {
         int var3;
         boolean var4;
         label157: {
            ...
            if (var1.method3149(1857490025)) {
               ...
               if (var1.method3206(1542551662)) {
                  ...
                  classDH.method3160(var1, -983329598);
                  break label157;
               }
            }

            if (classDH.method3157(var1, 1718590827)) {
               if (var2 >= -1317666184) {
                  return;
               }
               ...
               if (var1.method3213((byte)55)) {
                  ...
                  classDH.method3231(var1, false, 51205404);
                  break label157;
               }
            }
            ...
            if (var1.method3151(-685442936)) {
               ...
               if (var1.method3235(-1217021755) == classLJ.field4177) {
                  ...
                  var8 = (classYB)var5.field1698.method13404(var1.method3245((short)148));
         ...
         throw classEG.method3884(var13, "eb.bs(" + ')');
      }
   }
   ...
   public static int method3801(CharSequence var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var5, "eb.al(" + 41);
      }
   }
   ...
   public static boolean method3802(char var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "eb.ay(" + ')');
      }
   }
