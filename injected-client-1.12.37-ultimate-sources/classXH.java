...
public class classXH {
   ...
   @ObfuscatedName("ae")
   public void method12758(classXS var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var5, "xh.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("fp")
   public static void method12761(classXH var0, classXS var1, int var2) {
      if (var0 == null) {
   ...
   public static classXG method12772(classXH var0, long var1) {
      ...
      try {
         ...
         throw classEG.method3884(var6, "xh.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILxs;I)V")
   @ObfuscatedName("ab")
   void method12765(int var1, classXS var2, int var3) {
      try {
         int var4 = classXY.method13096(var2, 434878691);
         if (-1 == var4) {
            ...
            classPC var8 = classDZ.method3717(var4, -1060823799);
         ...
         throw classEG.method3884(var9, "xh.ab(" + ')');
      }
   }
   ...
   public classXG method12768(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "xh.ag(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;II)V")
   @ObfuscatedName("af")
   public void method12762(classXS var1, int var2, int var3) {
      try {
         while (702114061 * var1.field6955 < var2) {
            if (var3 >= 111634418) {
               throw new IllegalStateException();
         ...
         throw classEG.method3884(var8, "xh.ae(" + ')');
      }
   }
   ...
   public static void method12755(classXH var0, byte var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "xh.az(" + ')');
      }
   }
   ...
   void method12774(int var1, int var2, long var3) {
      try {
         classZR var5 = classZS.method14182(classCA.method1392(85, -1495127640).method14145(new Object[]{var1, var2, var3}, (byte)2), (byte)102);
         classSZ.method10729(var5, -605675329);
      } catch (RuntimeException var6) {
         throw classEG.method3884(var6, "xh.ax(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("al")
   public void method12759(classXS var1, int var2) {
      while (702114061 * var1.field6955 < var2) {
         int var3 = classXY.method13039(var1, -346779531);
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("aj")
   public void method12760(classXS var1, int var2) {
      while (702114061 * var1.field6955 < var2) {
         int var3 = classXY.method13039(var1, -346779531);
         if (var3 >= this.field6869.length) {
            this.field6869 = Arrays.copyOf(this.field6869, 1 + var3);
   ...
   @ObfuscatedName("ek")
   public static void method12766(classXH var0, int var1, classXS var2) {
      if (var0 == null) {
         var0.method12758(var2, var1, var1);
      } else {
         int var3 = classXY.method13096(var2, 355879082);
         if (-1 == var3) {
            ...
            classPC var7 = classDZ.method3717(var3, -2119284705);
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("aq")
   public void method12763(classXS var1, int var2) {
      while (702114061 * var1.field6955 < var2) {
         int var3 = classXY.method13039(var1, -346779531);
         int var4 = var1.method13056((byte)1);
         Object var5 = null;
   ...
   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("ad")
   public void method12764(classXS var1, int var2) {
      while (702114061 * var1.field6955 < var2) {
         int var3 = classXY.method13039(var1, -346779531);
         int var4 = var1.method13056((byte)1);
         Object var5 = null;
   ...
   @ObfuscatedName("at")
   static void method12777(int[] var0, Object[] var1, classXS var2) {
      for (int var3 = 0; var3 < var0.length; var3++) {
         switch (classRN.method10130(var0[var3], 1275371533).field7107 * -900901303) {
            case 2:
   ...
   @ObfuscatedName("au")
   void method12767(int var1, classXS var2) {
      int var3 = classXY.method13096(var2, 305636474);
      if (-1 == var3) {
         if (this.field6869[var1] != null) {
         ...
         classPC var7 = classDZ.method3717(var3, -428530804);
   ...
   void method12775(int var1, int var2, long var3) {
      classZR var5 = classZS.method14182(classCA.method1392(85, -1964057342).method14145(new Object[]{var1, var2, var3}, (byte)2), (byte)24);
   ...
   void method12776(int var1, int var2, long var3) {
      classZR var5 = classZS.method14182(classCA.method1392(85, -1905575321).method14145(new Object[]{var1, var2, var3}, (byte)2), (byte)25);
   ...
   @ObfuscatedSignature(descriptor = "([I[Ljava/lang/Object;Lxs;)V")
   @ObfuscatedName("an")
   static void method12778(int[] var0, Object[] var1, classXS var2) {
      for (int var3 = 0; var3 < var0.length; var3++) {
         switch (classRN.method10130(var0[var3], 244796811).field7107 * -900901303) {
            case 2:
