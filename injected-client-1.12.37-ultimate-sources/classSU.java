...
public class classSU {
   ...
   @ObfuscatedName("az")
   int method10651(classXY var1, int var2, int var3) {
      try {
         int var4 = classXY.method13047(var1, 461953608);
         classJR.method6406(classXY.method13039(var1, -346779531), -1726225436);
         this.field6063 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
         this.field6062 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
         this.field6064 = classXY.method13039(var1, -346779531) != 0;
         ...
         throw classEG.method3884(var8, "su.az(" + 41);
      }
   }
   ...
   void method10656(int var1) {
      try {
         ...
         throw classEG.method3884(var3, "su.af(" + ')');
      }
   }
   ...
   public float method10658(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "su.ae(" + ')');
      }
   }
   ...
   int method10666(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "su.ag(" + 41);
      }
   }
   ...
   classSY method10682(float var1, int var2) {
      try {
         ...
         throw classEG.method3884(var4, "su.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)I")
   @ObfuscatedName("al")
   int method10652(classXY var1, int var2) {
      int var3 = classXY.method13047(var1, -199029456);
      classJR.method6406(classXY.method13039(var1, -346779531), -2106840990);
      this.field6063 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
      this.field6062 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
      this.field6064 = classXY.method13039(var1, -346779531) != 0;
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)I")
   @ObfuscatedName("aj")
   int method10653(classXY var1, int var2) {
      int var3 = classXY.method13047(var1, 1229038560);
      classJR.method6406(classXY.method13039(var1, -346779531), -694550972);
      this.field6063 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
      this.field6062 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
      this.field6064 = classXY.method13039(var1, -346779531) != 0;
      this.field6068 = new classSY[var3];
   ...
   public static int method10662(classSU var0, byte var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "su.ab(" + 41);
      }
   }
   ...
   int method10672(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "su.as(" + 41);
      }
   }
   ...
   public static int method10676(classSU var0, float var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var8, "su.ax(" + 41);
         }
      }
   }
   ...
   @ObfuscatedName("bh")
   static int method10688(int var0, classBL var1, boolean var2, byte var3) {
      try {
         if (6500 == var0) {
            if (var3 >= 0) {
               throw new IllegalStateException();
               ...
               int var33 = (classDY.field1679 += 120041229) * -324749371 - 1;
               byte var34;
            ...
            if (var3 >= 0) {
               ...
               classCM var17 = classIV.method6319(-126674783);
               if (var17 != null) {
                  if (var3 >= 0) {
                     throw new IllegalStateException();
                  }

                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 851246551 * var17.field1162;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -458552905 * var17.field1163;
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = var17.field1167;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -288138629 * var17.field1160;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 597852065 * var17.field1161;
            ...
            if (var3 >= 0) {
               ...
               classCM var16 = classSX.method10711(-1953402072);
               if (null != var16) {
                  if (var3 >= 0) {
                     throw new IllegalStateException();
                  }

                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var16.field1162 * 851246551;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var16.field1163 * -458552905;
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = var16.field1167;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -288138629 * var16.field1160;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var16.field1161 * 597852065;
            ...
            if (var3 >= 0) {
               ...
               for (int var30 = 0; var30 < classCM.field1153 * -622036481; var30++) {
                  if (classCM.field1170[var30].field1162 * 851246551 == var15) {
                     var24 = classCM.field1170[var30];
                     break;
                  }
               }
               ...
               if (var24 != null) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var24.field1162 * 851246551;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -458552905 * var24.field1163;
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = var24.field1167;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -288138629 * var24.field1160;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 597852065 * var24.field1161;
            ...
            if (var3 >= 0) {
               ...
               int var14 = classBB.field323[classDY.field1679 * -324749371];
               boolean var23 = classBB.field323[classDY.field1679 * -324749371 + 1] == 1;
               int var29 = classBB.field323[2 + classDY.field1679 * -324749371];
               boolean var31;
               if (classBB.field323[3 + -324749371 * classDY.field1679] == 1) {
                  if (var3 >= 0) {
                     throw new IllegalStateException();
                  }
            ...
            if (6512 == var0) {
               client.field1003 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371] == 1;
               return 1;
            } else if (var0 == 6513) {
               if (var3 >= 0) {
                  throw new IllegalStateException();
                  ...
                  int var13 = classBB.field323[-324749371 * classDY.field1679];
                  int var22 = classBB.field323[1 + classDY.field1679 * -324749371];
                  ...
                  if (classPN.method9026(var28, (byte)2)) {
                     ...
                     classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classPL.method8961(
               ...
               int var21 = classBB.field323[-324749371 * classDY.field1679 + 1];
               ...
               if (classPN.method9026(var27, (byte)2)) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classMU.method7729(var12, 2031921184)
               ...
               if (var3 >= 0) {
                  ...
                  classDY.field1679 -= 240082458;
                  int var11 = classBB.field323[-324749371 * classDY.field1679];
                  int var20 = classBB.field323[1 + classDY.field1679 * -324749371];
                  ...
                  if (classPN.method9026(var26, (byte)2)) {
                     ...
                     classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classOB.method8299(var11, (byte)39)
               ...
               classDY.field1679 -= 240082458;
               int var10 = classBB.field323[classDY.field1679 * -324749371];
               int var19 = classBB.field323[1 + classDY.field1679 * -324749371];
               ...
               if (classPN.method9026(var25, (byte)2)) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classUY.method11710(var10, 64572192)
               ...
               if (var3 >= 0) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = client.field888 * 461082519;
                  return 1;
               }
            } else if (var0 == 6520) {
               return 1;
               ...
               if (var3 >= 0) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -372108587 * client.field889;
                  return 1;
               }
            } else if (var0 == 6528) {
               if (var3 >= 0) {
                  ...
                  int var18 = classBB.field323[-324749371 * classDY.field1679 + 1];
                  ...
                  if (classPN.method9026(var6, (byte)2)) {
                     ...
                     classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classMR.method7647(var9, (byte)2)
               ...
               if (var3 >= 0) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 240;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1;
                  return 1;
               }
            } else {
            ...
            if (var4 >= 0) {
               ...
               if (var4 < -622036481 * classCM.field1153) {
                  if (var3 >= 0) {
                     throw new IllegalStateException();
                  }

                  classCM var5 = classCM.field1170[var4];
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var5.field1162 * 851246551;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -458552905 * var5.field1163;
                  classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = var5.field1167;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -288138629 * var5.field1160;
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 597852065 * var5.field1161;
         ...
         throw classEG.method3884(var8, "su.bh(" + 41);
      }
   }
   ...
   int method10685(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "su.aa(" + 41);
      }
   }
   ...
   @ObfuscatedName("po")
   public static int method10654(classSU var0, classXY var1, int var2) {
      if (var0 == null) {
         var0.method10666(var2);
      }

      int var3 = classXY.method13047(var1, 439261380);
      classJR.method6406(classXY.method13039(var1, -346779531), -121571945);
      var0.field6063 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
      var0.field6062 = classOB.method8298(classXY.method13039(var1, -346779531), -47642443);
      var0.field6064 = classXY.method13039(var1, -346779531) != 0;
   ...
   @ObfuscatedName("ag")
   public static classYZ method10680(classVA var0, String var1, String var2, int var3) {
      try {
         if (!classVA.method11853(var0, var1, var2, -578231059)) {
            return null;
         } else {
         ...
         throw classEG.method3884(var6, "su.ag(" + ')');
      }
   }
