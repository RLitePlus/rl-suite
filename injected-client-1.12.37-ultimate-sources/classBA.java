...
public class classBA {
   ...
   @ObfuscatedName("ar")
   static classYM[] field310 = new classYM[1000];

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;)V")
   @ObfuscatedName("ad")
   static void method752(classDZ var0, int var1, int var2, classUP var3, classKH var4) {
   ...
   static classZC method779(int var0, int var1) {
      try {
         ...
         throw classEG.method3884(var3, "ba.hf(" + ')');
      }
   }
   ...
   @ObfuscatedName("an")
   static void method761(int var0, int var1, int var2, int var3, classUP var4, classYM var5, classKH var6) {
      if (var5 != null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;)V")
   @ObfuscatedName("ap")
   static void method755(classDZ var0, int var1, int var2, classUP var3, classKH var4) {
      for (int var5 = 0; var5 < classZH.method14003(var0.field1697, (byte)10); var5++) {
         classDN var6 = (classDN)var0.field1698.method13404(var0.field1697.method14001(var5, 2038477992));
         if (var6 != null && var6.vmethod262((byte)53)) {
            classPL var7 = var6.field1581;
   ...
   static final void method773(int var0, int var1, int var2, int var3, int var4) {
      classEZ var5 = classIS.field3053.field1689;
      long var6 = var5.method4455(var0, var1, var2);
      if (var6 != 0L) {
         int var8 = classEZ.method4462(var5, var0, var1, var2, var6);
         int var9 = var8 >> 6 & 3;
         int var10 = var8 & 31;
         int var11 = var3;
         ...
         if (var16.field4954 * 1680279607 != -1) {
            classYZ var17 = classOY.field5202[1680279607 * var16.field4954];
            if (null != var17) {
               int var18 = (var16.field4944 * 1965741260 - var17.field7121) / 2;
               int var19 = (1611505692 * var16.field4924 - var17.field7119) / 2;
               classYZ.method13810(var17, 48 + 4 * var1 + var18, var19 + 4 * (104 - var2 - var16.field4924 * 402876423) + 48);
            }
         } else {
            if (0 == var10 || 2 == var10) {
               if (0 == var9) {
      ...
      if (0L != var6) {
         ...
         if (-1 != var25.field4954 * 1680279607) {
            classYZ var27 = classOY.field5202[var25.field4954 * 1680279607];
            if (var27 != null) {
               int var29 = (var25.field4944 * 1965741260 - var27.field7121) / 2;
               int var30 = (var25.field4924 * 1611505692 - var27.field7119) / 2;
               classYZ.method13810(var27, var29 + 48 + 4 * var1, var30 + 48 + 4 * (104 - var2 - 402876423 * var25.field4924));
            }
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;)V")
   @ObfuscatedName("ai")
   static void method757(classDZ var0, int var1, int var2, classUP var3, classKH var4) {
      int var5 = -2087374717 * client.field837.field1419;
      int[] var6 = client.field837.field1423;
      classCT var8 = classMB.method7521(1411230716);
      int var7 = var8 != null ? 532975721 * var8.field1265 : 0;
      int var20 = var7;

      for (int var9 = 0; var9 < var5; var9++) {
         classCT var10 = (classCT)var0.field1694.method13404(var6[var9]);
         if (null != var10 && var10.vmethod262((byte)8) && !var10.field1259) {
            ...
            } else if (classCT.method2629(var10, -1753555249)) {
               classBO.method1165(var1, var2, var14, var15, var3, classPE.field5234[5], var4, (byte)17);
            } else if (classCT.method2648(var10, -776764193)) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;)V")
   @ObfuscatedName("aq")
   static void method753(classDZ var0, int var1, int var2, classUP var3, classKH var4) {
   ...
   @ObfuscatedName("aw")
   static void method759(classDZ var0, int var1, int var2, classUP var3, classKH var4, int var5) {
      if (1 == var5) {
         classDN var6 = classCW.method2689(client.field941.method6533(-1070697245), client.field814, 801576230);
         if (var6 != null) {
            classNF.method7833(
         ...
         classDZ var9 = client.field814.method1596(client.field941.method6535(-1455153706), client.field941.method6537(-1443802040), -483955428);
         ...
         classCT var10 = classEN.method3930(client.field941.method6533(-154846912), client.field814, -2017609414);
         if (var10 != null) {
            classNF.method7833(
         ...
         classSP var12 = (classSP)classIS.field3053.field1700.method13595(var11);
         if (null != var12) {
            classNF.method7833(
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;I)V")
   @ObfuscatedName("ak")
   static void method760(classDZ var0, int var1, int var2, classUP var3, classKH var4, int var5) {
      if (1 == var5) {
         classDN var6 = classCW.method2689(client.field941.method6533(-709900526), client.field814, -558304721);
         if (var6 != null) {
            classNF.method7833(
         ...
         classDZ var9 = client.field814.method1596(client.field941.method6535(1505597208), client.field941.method6537(-1788119431), 102330149);
         ...
         classCT var10 = classEN.method3930(client.field941.method6533(-205513085), client.field814, 795550484);
         if (var10 != null) {
            classNF.method7833(
   ...
   @ObfuscatedSignature(descriptor = "(IIIILup;Lym;Lkh;)V")
   @ObfuscatedName("av")
   static void method762(int var0, int var1, int var2, int var3, classUP var4, classYM var5, classKH var6) {
      if (var5 != null) {
         int var7 = var3 * var3 + var2 * var2;
         if (var7 <= 6400) {
   ...
   @ObfuscatedSignature(descriptor = "(IIIILup;Lym;Lkh;)V")
   @ObfuscatedName("at")
   static void method763(int var0, int var1, int var2, int var3, classUP var4, classYM var5, classKH var6) {
      if (var5 != null) {
         int var7 = var3 * var3 + var2 * var2;
         if (var7 <= 6400) {
   ...
   static final void method749(int var0) {
      try {
         ...
         throw classEG.method3884(var2, "ba.ae(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(IIIILup;Lym;Lkh;)V")
   @ObfuscatedName("am")
   static void method764(int var0, int var1, int var2, int var3, classUP var4, classYM var5, classKH var6) {
      if (var5 != null) {
         int var7 = var3 * var3 + var2 * var2;
         if (var7 <= -285801947) {
   ...
   @ObfuscatedName("ah")
   static void method765(int var0, int var1, int var2, classYM var3) {
   ...
   static final void method770(int var0) {
      ...
      for (int var11 = 1; var11 < 103; var11++) {
         ...
         for (int var5 = 1; var5 < 103; var5++) {
            if ((classIS.field3053.field1702[var0][var5][var11] & 24) == 0) {
               classIS.field3053.field1689.method4459(var1, var4, 512, var0, var5, var11);
            }

            if (var0 < 3 && (classIS.field3053.field1702[var0 + 1][var5][var11] & 8) != 0) {
               classIS.field3053.field1689.method4459(var1, var4, 512, 1 + var0, var5, var11);
            }
      ...
      for (int var15 = 0; var15 < 104; var15++) {
         for (int var16 = 0; var16 < 104; var16++) {
            long var7 = classIS.field3053.field1689.method4476(classIS.field3053.field1710 * -483624883, var15, var16);
            if (var7 != 0L) {
               int var9 = classCN.method2552(var7);
               int var10 = classMU.method7729(var9, 2021945666).field4953 * 1412472849;
               if (var10 >= 0 && classFJ.method4796(var10, (byte)-81).field5399) {
                  field310[field306 * 1296562401] = classFJ.method4796(var10, (byte)-11).method9199(false, -104496217);
   ...
   @ObfuscatedSignature(descriptor = "(IIILym;)V")
   @ObfuscatedName("bn")
   static void method766(int var0, int var1, int var2, classYM var3) {
      int var4 = 128 * var2;
   ...
   @ObfuscatedName("bc")
   static final void method768(classDZ var0, int var1, int var2, int var3, int var4, classUP var5, classYM var6, classKH var7) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IIIILup;Lym;Lkh;)V")
   @ObfuscatedName("bp")
   static final void method769(classDZ var0, int var1, int var2, int var3, int var4, classUP var5, classYM var6, classKH var7) {
      ...
      for (int var15 = 0; var15 < 104; var15++) {
         for (int var16 = 0; var16 < 104; var16++) {
            ...
            if (var7 != 0L) {
               ...
               if (var10 >= 0 && classFJ.method4796(var10, (byte)-97).field5399) {
                  field310[field306 * 1296562401] = classFJ.method4796(var10, (byte)-10).method9199(false, -2067511066);
                  field308[1296562401 * field306] = var15;
                  field312[1296562401 * field306] = var16;
                  field306 += 313477921;
               }
      ...
      for (int var15 = 0; var15 < 104; var15++) {
         for (int var16 = 0; var16 < 104; var16++) {
            ...
            if (var7 != 0L) {
               ...
               if (var10 >= 0 && classFJ.method4796(var10, (byte)-76).field5399) {
                  field310[field306 * 1296562401] = classFJ.method4796(var10, (byte)-32).method9199(false, -854440296);
                  field308[1296562401 * field306] = var15;
                  field312[1296562401 * field306] = var16;
                  field306 += 313477921;
               }
   ...
   static final void method774(int var0, int var1, int var2, int var3, int var4) {
      ...
      if (var6 != 0L) {
         ...
         if (var16.field4954 * 1549617510 != -1) {
            ...
            if (null != var17) {
               int var18 = (var16.field4944 * 1965741260 - var17.field7121) / 2;
               int var19 = (1611505692 * var16.field4924 - var17.field7119) / 2;
               classYZ.method13810(var17, 1872125890 + 4 * var1 + var18, var19 + 4 * (971558603 - var2 - var16.field4924 * 402876423) + 48);
            }
         } else {
            if (0 == var10 || 2 == var10) {
               if (0 == var9) {
      ...
      if (var6 != 0L) {
         ...
         if (-1 != -154579665 * var12.field4954) {
            classYZ var32 = classOY.field5202[var12.field4954 * 1783719383];
            if (null != var32) {
               int var35 = (1965741260 * var12.field4944 - var32.field7121) / 2;
               int var36 = (-2054711646 * var12.field4924 - var32.field7119) / 2;
               classYZ.method13810(var32, var35 + 1088464403 + 4 * var1, var36 + (104 - var2 - var12.field4924 * 402876423) * 4 + -735260496);
            }
         } else if (var26 == 9) {
            int var33 = -680556669;
            boolean var37 = var6 != 0L;
      ...
      if (0L != var6) {
         ...
         if (-1 != var25.field4954 * 1680279607) {
            classYZ var27 = classOY.field5202[var25.field4954 * -165607449];
            if (var27 != null) {
               int var29 = (var25.field4944 * -192835277 - var27.field7121) / 2;
               int var30 = (var25.field4924 * 590633945 - var27.field7119) / 2;
               classYZ.method13810(var27, var29 + -2051946565 + 4 * var1, var30 + 48 + 4 * (104 - var2 - -2139610840 * var25.field4924));
            }
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;)V")
   @ObfuscatedName("ar")
   static void method758(classDZ var0, int var1, int var2, classUP var3, classKH var4) {
      int var5 = -2099832778 * client.field837.field1419;
      int[] var6 = client.field837.field1423;
      classCT var8 = classMB.method7521(489694554);
      ...
      for (int var9 = 0; var9 < var5; var9++) {
         ...
         if (null != var10 && var10.vmethod262((byte)14) && !var10.field1259) {
            ...
            } else if (classCT.method2629(var10, -1829858296)) {
               classBO.method1165(var1, var2, var14, var15, var3, classPE.field5234[5], var4, (byte)51);
            } else if (classCT.method2648(var10, -1665884717)) {
   ...
   @ObfuscatedName("bk")
   public static final void method775(classLW var0, int var1, int var2) {
      if (0 == field305 * -782895767 || 3 == field305 * -782895767) {
         if (!client.field973 && (1 == classTZ.field6261 * 1229235359 || !classON.field4995 && 4 == classTZ.field6261 * 1229235359)) {
            classKH var3 = var0.method7204(classWK.field6691, true, 558940702);
            if (null == var3) {
               return;
            }

            int var4 = 1422993977 * classTZ.field6266 - var1;
            int var5 = classTZ.field6257 * 1243590197 - var2;
            if (classKH.method6479(var3, var4, var5, -1293259974)) {
               ...
               if (classTN.field6172 == var14) {
                  ...
                  int var18 = 1820112216 * classTZ.field6255 - var16;
                  int var19 = -2144333897 * classTZ.field6264 - var17;
   ...
   @ObfuscatedSignature(descriptor = "(Llw;II)V")
   @ObfuscatedName("bo")
   public static final void method776(classLW var0, int var1, int var2) {
         ...
         if (!client.field973 && (1 == classTZ.field6261 * 1229235359 || !classON.field4995 && 4 == classTZ.field6261 * 1229235359)) {
            ...
            if (classKH.method6479(var3, var4, var5, -1389493769)) {
               ...
               if (classTN.field6172 == var14) {
                  ...
                  int var16 = var3.field3586 * -1246906611 / 2 + var1;
                  int var17 = -1637380195 * var3.field3585 / 2 + var2;
                  int var18 = 2068950188 * classTZ.field6255 - var16;
                  int var19 = -1143156006 * classTZ.field6264 - var17;
   ...
   @ObfuscatedSignature(descriptor = "(Llw;II)V")
   @ObfuscatedName("bu")
   public static final void method777(classLW var0, int var1, int var2) {
      if (0 == field305 * -891815568 || 3 == field305 * -782895767) {
         if (!client.field973 && (1 == classTZ.field6261 * 1309041254 || !classON.field4995 && 4 == classTZ.field6261 * 1229235359)) {
            ...
            int var4 = 1422993977 * classTZ.field6266 - var1;
            int var5 = classTZ.field6257 * -2018685645 - var2;
            if (classKH.method6479(var3, var4, var5, 1373029462)) {
               ...
               if (classTN.field6172 == var14) {
                  ...
                  int var18 = 2051786790 * classTZ.field6255 - var16;
                  int var19 = -2144333897 * classTZ.field6264 - var17;
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;)V")
   @ObfuscatedName("au")
   static void method756(classDZ var0, int var1, int var2, classUP var3, classKH var4) {
      for (int var5 = 0; var5 < classZH.method14003(var0.field1697, (byte)10); var5++) {
         classDN var6 = (classDN)var0.field1698.method13404(var0.field1697.method14001(var5, 1730556256));
   ...
   static void method778(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, byte var10) {
      try {
         ...
         throw classEG.method3884(var11, "ba.do(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;I)V")
   @ObfuscatedName("az")
   public static void method754(classVA var0, int var1) {
      try {
         classZU.field7277 = var0;
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "ba.az(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(IIILym;)V")
   @ObfuscatedName("bx")
   static void method767(int var0, int var1, int var2, classYM var3) {
      int var4 = 128 * var2;
