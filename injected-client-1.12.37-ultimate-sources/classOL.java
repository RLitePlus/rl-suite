...
public class classOL implements classXZ {
   ...
   static double method8509(double var0, double var2, double var4) {
      try {
         ...
         throw classEG.method3884(var6, "ol.af(" + ')');
      }
   }
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "ol.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("af")
   public static classPT method8510(int var0, short var1) {
      try {
         classPT var2 = (classPT)classPT.field5418.method6422(var0);
         if (null != var2) {
            if (var1 == 206) {
            ...
            byte[] var3 = classPT.field5423.method11867(14, var0, -1667244085);
            var2 = new classPT(new classXY(var3));
            classPT.field5418.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "ol.af(" + ')');
      }
   }
   ...
   static void method8512(classTE var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ol.am(" + ')');
      }
   }
   ...
   static void method8511(classTE var0, classYY var1, boolean var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "ol.at(" + ')');
      }
   }
   ...
   static boolean method8513(int var0) {
      try {
         ...
         throw classEG.method3884(var2, "ol.ao(" + ')');
      }
   }
