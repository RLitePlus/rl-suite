...
@ObfuscatedName("fu")
public class classFU extends classVQ implements Texture {
   @ObfuscatedName("ax")
   int field2396;
   ...
   classFU(classXY var1) {
      this.field2400 = classXY.method13047(var1, 1053835864);
      this.field2396 = classXY.method13047(var1, -1765518754);
      this.field2399 = classXY.method13039(var1, -346779531) == 1;
      this.field2401 = classXY.method13039(var1, -346779531);
      this.field2395 = classXY.method13039(var1, -346779531);
      this.field2397 = null;
   }

   @ObfuscatedSignature(descriptor = "(DILyz;I)Z")
   @ObfuscatedName("af")
   boolean method5008(double var1, int var3, classYZ var4, int var5) {
      var4.method13803();
      int[] var6 = var4.field7126;

      for (int var7 = 0; var7 < var6.length; var7++) {
         var6[var7] = classFH.method4698(var6[var7], var1);
      }

      byte[] var11 = var4.field7125;
   ...
   @ObfuscatedName("ag")
   boolean method5003(double var1, int var3, classVA var4) {
      if (classVA.method11822(var4, this.field2400, -306630322) == null) {
         return false;
      } else {
         int var5 = var3 * var3;
         this.field2397 = new int[var5];
         classYZ var6 = classLJ.method7113(var4, this.field2400, (byte)70);
   ...
   @ObfuscatedName("md")
   public static boolean method5004(classFU var0, double var1, int var3, classVA var4) {
      if (var0 == null) {
         var0.method5007(var1, var3, var4);
      }

      if (classVA.method11822(var4, var0.field2400, 1721902503) == null) {
         return false;
      } else {
         int var5 = var3 * var3;
         var0.field2397 = new int[var5];
         classYZ var6 = classLJ.method7113(var4, var0.field2400, (byte)113);
   ...
   @ObfuscatedSignature(descriptor = "(Lfu;DILva;)Z")
   @ObfuscatedName("wk")
   public static boolean method5005(classFU var0, double var1, int var3, classVA var4) {
      if (classVA.method11822(var4, var0.field2400, -834634006) == null) {
         return false;
      } else {
         int var5 = var3 * var3;
         var0.field2397 = new int[var5];
         classYZ var6 = classLJ.method7113(var4, var0.field2400, (byte)99);
         return var0.method5008(var1, var3, var6, var5);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(DILva;)Z")
   @ObfuscatedName("ax")
   boolean method5006(double var1, int var3, classVA var4) {
      if (classVA.method11822(var4, this.field2400, 1058908422) == null) {
         return false;
      } else {
         int var5 = var3 * var3;
         this.field2397 = new int[var5];
         classYZ var6 = classLJ.method7113(var4, this.field2400, (byte)38);
         return this.method5008(var1, var3, var6, var5);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(DILyz;I)Z")
   @ObfuscatedName("aa")
   boolean method5009(double var1, int var3, classYZ var4, int var5) {
      var4.method13803();
      int[] var6 = var4.field7126;
   ...
   @ObfuscatedSignature(descriptor = "(DILyz;I)Z")
   @ObfuscatedName("ac")
   boolean method5010(double var1, int var3, classYZ var4, int var5) {
      var4.method13803();
      int[] var6 = var4.field7126;
   ...
   @ObfuscatedName("og")
   public static void method5013(classFU var0) {
      if (var0 == null) {
         var0.isLoaded();
      }
   ...
   @ObfuscatedSignature(descriptor = "(DILva;)Z")
   @ObfuscatedName("az")
   boolean method5007(double var1, int var3, classVA var4) {
      if (classVA.method11822(var4, this.field2401, 1721902503) == null) {
         return false;
      } else {
         int var5 = var3 * var3;
         this.field2397 = new int[var5];
         classYZ var6 = classLJ.method7113(var4, this.field2395, (byte)113);
         return this.method5008(var1, var3, var6, var5);
      }
   }
}
