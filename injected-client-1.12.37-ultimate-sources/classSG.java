...
public class classSG {
   ...
   void method10381(byte var1) {
      try {
         ...
         throw classEG.method3884(var5, "sg.az(" + ')');
      }
   }
   ...
   classUU method10384(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "sg.af(" + ')');
      }
   }
   ...
   void method10397(classUU var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "sg.as(" + ')');
      }
   }
   ...
   public classUU method10403(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "sg.ac(" + ')');
      }
   }
   ...
   public static float[] method10414(classSG var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.method3884(var3, "sg.al(" + ')');
      }
   }
   ...
   classUU method10399(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "sg.ax(" + ')');
      }
   }
   ...
   public static float[] method10406(classSG var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var3, "sg.aa(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("mb")
   public static int method10380(classRS var0, classRS var1) {
   ...
   public classSG(int var1, classXY var2, boolean var3) {
   ...
   float[] method10410(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "sg.ao(" + ')');
      }
   }
   ...
   public static void method10417(classTE var0, int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var7, "sg.al(" + ')');
      }
   }
   ...
   @ObfuscatedName("ci")
   static boolean method10419(classDZ var0, int var1, int var2, int var3, int var4) {
      try {
         if (var1 < 3) {
            if (var4 <= 718661024) {
               throw new IllegalStateException();
         ...
         throw classEG.method3884(var5, "sg.ci(" + ')');
      }
   }
