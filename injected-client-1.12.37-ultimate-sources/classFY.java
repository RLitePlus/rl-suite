...
public class classFY {
   ...
   static final float method5271(float var0, float var1, float var2, float var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var5, "fy.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("fu")
   public static boolean method5273(classRN var0, classAAE var1, boolean var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ck")
   static void method5274(classDZ var0, classKR var1, byte var2) {
      try {
         int var3 = 0;
         ...
         for (int var4 = 0; var4 < classZH.method14003(var0.field1693, (byte)10); var4++) {
            ...
            classSP var5 = (classSP)var0.field1700.method13595(var0.field1693.method14001(var4, 1891622283));
            if (var5 != null) {
         ...
         throw classEG.method3884(var8, "fy.ck(" + ')');
      }
   }
      ...
      try {
         ...
         if (null == var3) {
            ...
            if (var1 >= 0) {
               ...
               if (var1 < var3.field456.length) {
                  return var3.field456[var1];
               }
         ...
         throw classEG.method3884(var4, "fy.az(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;I)V")
   @ObfuscatedName("az")
   public static void method5272(classVA var0, int var1) {
      try {
         classBQ.field531 = var0;
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "fy.az(" + ')');
      }
   }
}
