...
public class classUA implements classUI {
   ...
   public int method11235(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "ua.az(" + 41);
      }
   }
   ...
   public static void method11237(byte[] var0, int var1) {
      try {
         ...
         throw classEG.method3884(var6, "ua.af(" + ')');
      }
   }
   ...
   static final void method11240(int var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "ua.ek(" + ')');
      }
   }
   ...
   @ObfuscatedName("ev")
   public static void method11239(classXY var0, int var1) {
      if (var0 == null) {
