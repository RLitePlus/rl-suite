...
public class classXR extends classUY implements classUT {
   ...
   protected classUR vmethod606(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var7, "xr.az(" + ')');
      }
   }
   ...
   classUF method12877(int var1, int var2) {
      try {
         ...
         if (null != var3) {
            var4.method11510(new classXY(var3), -1830946202);
         }

         return var4;
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "xr.aq(" + ')');
      }
   }
   ...
   public Iterator iterator() {
      try {
         ...
         throw classEG.method3884(var1, "xr.iterator(" + ')');
      }
   }
   ...
   public classXR(classKX var1, int var2, classXO var3, classVA var4) {
   ...
   classUF method12878(int var1) {
      ...
      if (null != var2) {
         var3.method11510(new classXY(var2), -1830946202);
      }
   ...
   public static void method12884(classXR var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var5, "xr.ad(" + ')');
         }
      }
   }
