...
@ObfuscatedName("mm")
public class classMM implements GrandExchangeOffer {
   @ObfuscatedName("ag")
   ...
   public classMM(classXY var1, boolean var2) {
   ...
   @ObfuscatedName("ic")
   public static void method7615(classMM var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("il")
   public static void method7616(classMM var0, int var1) {
      if (var0 == null) {
         var0.getSpent();
      }
   ...
   @ObfuscatedName("qn")
   public static int method7607(classMM var0, short var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ad")
   public static int method7614(classMM var0) {
   ...
   @ObfuscatedName("ax")
   static void method7620(classDZ var0, classDH var1, int var2, int var3) {
      try {
   ...
   @ObfuscatedName("ar")
   static boolean method7619(classFX var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         classFP var6 = var0.method5093(var1);
         ...
         } else if (Math.abs(var15 * 348139717 * classDK.field1542 - classEO.field1811 * -1947307103 * var14)
            > classEV.field1943 * 1304241803 * var11 + classJI.field3164 * 1266420275 * var12) {
            return false;
         } else if (Math.abs(-1947307103 * classEO.field1811 * var13 - -331219525 * classBY.field614 * var15)
