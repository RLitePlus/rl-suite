...
public class classNM {
   ...
   @ObfuscatedName("ae")
   public final classMM field4685;
   @ObfuscatedName("ag")
   String field4688;
   @ObfuscatedName("az")
   ...
   public String method7889(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "nm.az(" + ')');
      }
   }
   ...
   public String method7891(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "nm.af(" + ')');
      }
   }
   ...
   classNM(classXY var1, byte var2, int var3) {
      this.field4689 = var1.method13071(2117716806);
      this.field4688 = var1.method13071(1817698247);
      this.field4686 = classXY.method13047(var1, -617856821) * -1507921803;
      ...
      this.field4685 = new classMM();
      this.field4685.method7611(2, (byte)4);
      classMM.method7615(this.field4685, var2, 2008825883);
