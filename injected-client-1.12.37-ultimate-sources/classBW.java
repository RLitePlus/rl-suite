...
public class classBW {
   ...
   @ObfuscatedName("bu")
   final void method1283(classXY var1, int var2) {
   ...
   boolean method1277(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "bw.as(" + ')');
      }
   }
   ...
   final void method1281(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "bw.ax(" + ')');
      }
   }
   ...
   final boolean method1322() {
      return classRT.method10195(this.field591, 2037364072) || this.field591.method10191(-387387364) >= 100 && 1 != 1610258521 * client.field847;
   }
   ...
   public static boolean method1295(classBW var0, classAAE var1, boolean var2) {
      ...
      if (null == var1) {
         ...
         return var1.equals(classOE.field4843.vmethod255((byte)76)) ? true : var0.field593.method10134(var1, var2, -2091803639);
      }
   }
   ...
   final void method1287(int var1) {
      try {
         for (classRH var2 = (classRH)this.field593.field5812.method7868(); var2 != null; var2 = (classRH)this.field593.field5812.method7872()) {
            if (var1 >= -2090297944) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.method3884(var3, "bw.aa(" + ')');
      }
   }
      ...
      if (var0 == null) {
         ...
         if (var3.method171(-884069400)) {
            if (var0.field591.method10218(var3, 726858335)) {
               ...
               if (var2) {
                  classJL var4 = classEF.method3849(classJS.IGNORELIST_DEL, client.field795.field1535, (byte)39);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)112), (byte)-1);
                  classXY.method12997(var4.field3343, var1, (short)16430);
   ...
   public static boolean method1309(classBW var0) {
      ...
      return classRT.method10195(var0.field593, 2037364072) || var0.field593.method10191(-1050473645) >= 200 && 1 != client.field847 * 1610258521;
   }
   ...
   final void method1293(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "bw.ao(" + ')');
      }
   }
   ...
   final boolean method1296(classAAE var1, boolean var2, int var3) {
      try {
         ...
         } else if (var1.equals(classOE.field4843.vmethod255((byte)103))) {
            if (var3 <= 391357984) {
               throw new IllegalStateException();
            } else {
               return true;
         ...
         throw classEG.method3884(var4, "bw.al(" + ')');
      }
   }
   ...
   final boolean method1299(classAAE var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "bw.aj(" + ')');
      }
   }
   ...
   final void method1303(String var1, int var2) {
      try {
         if (null != var1) {
            ...
            if (var3.method171(-53981419)) {
               if (method1312(this, (byte)109)) {
                  ...
                  classAAE var4 = classOE.field4843.vmethod255((byte)70);
                  if (null != var4) {
                     if (var2 == -886915762) {
                        return;
                     }
                  ...
                  if (this.method1296(var3, false, 2073566234)) {
                     ...
                     classJL var5 = classEF.method3849(classJS.FRIENDLIST_ADD, client.field795.field1535, (byte)-4);
                     classXY.method12971(var5.field3343, classAU.method712(var1, (byte)107), (byte)-128);
                     classXY.method12997(var5.field3343, var1, (short)4936);
         ...
         throw classEG.method3884(var6, "bw.ay(" + ')');
      }
   }
      ...
      if (null != var1) {
         ...
         if (var2.method171(1252145016)) {
            if (method1323(this, (byte)24)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)44);
               if (null != var3 && var3.equals(var2)) {
                  ...
                  classJL var4 = classEF.method3849(classJS.IGNORELIST_ADD, client.field795.field1535, (byte)-92);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)83), (byte)-54);
                  classXY.method12997(var4.field3343, var1, (short)5771);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
   ...
   final void method1325(String var1, byte var2) {
      ...
      try {
         if (var1 == null) {
            ...
            if (!var3.method171(1489933299)) {
               ...
               if (this.field593.method10218(var3, -2031138017)) {
                  ...
                  classJL var4 = classEF.method3849(classJS.FRIENDLIST_DEL, client.field795.field1535, (byte)-27);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)77), (byte)-38);
                  classXY.method12997(var4.field3343, var1, (short)13396);
                  client.field795.method3367(var4, -1301097035);
               }
         ...
         throw classEG.method3884(var5, "bw.au(" + ')');
      }
   }
      ...
      if (var1 != null) {
         ...
         if (var2.method171(756097414)) {
            if (this.field593.method10218(var2, -1293162660)) {
               ...
               classJL var3 = classEF.method3849(classJS.FRIENDLIST_DEL, client.field795.field1535, (byte)57);
               classXY.method12971(var3.field3343, classAU.method712(var1, (byte)83), (byte)-99);
               classXY.method12997(var3.field3343, var1, (short)8665);
   ...
   public final void method1331(String var1, boolean var2, int var3) {
      ...
      try {
            ...
            if (!var4.method171(-591637563)) {
               ...
               if (this.field591.method10218(var4, -716292657)) {
                  ...
                  if (var2) {
                     ...
                     classJL var5 = classEF.method3849(classJS.IGNORELIST_DEL, client.field795.field1535, (byte)-18);
                     classXY.method12971(var5.field3343, classAU.method712(var1, (byte)71), (byte)-11);
                     classXY.method12997(var5.field3343, var1, (short)18148);
                     client.field795.method3367(var5, -1301097035);
                  }
               }
         ...
         throw classEG.method3884(var6, "bw.ai(" + ')');
      }
   }
      ...
      if (null != var1) {
         ...
         if (var2.method171(1115080568)) {
            if (method1323(this, (byte)24)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)69);
               if (null != var3 && var3.equals(var2)) {
                  String var6 = classKK.field3796;
                  ...
                  classJL var4 = classEF.method3849(classJS.IGNORELIST_ADD, client.field795.field1535, (byte)94);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)123), (byte)-110);
                  classXY.method12997(var4.field3343, var1, (short)22468);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
   ...
   public static boolean method1310(classBW var0) {
      return classRT.method10195(var0.field593, 2037364072) || var0.field593.method10191(-1571057932) >= -699968365 && 1 != client.field847 * 1610258521;
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;)V")
   @ObfuscatedName("sh")
   public void method1339(String var1) {
      Friend var2 = (Friend)this.method1344().findByName(var1);
      if (var2 != null) {
         classOE.field4843.getCallbacks().post(new RemovedFriend(var2));
      }
   }
      ...
      try {
         if (null == var1) {
            ...
            if (!var3.method171(720233136)) {
               ...
               classAAE var4 = classOE.field4843.vmethod255((byte)98);
               if (null != var4) {
                  if (var2 != -169290065) {
                     throw new IllegalStateException();
                  }
               ...
               if (this.method1299(var3, -1181618808)) {
                  ...
                  classJL var5 = classEF.method3849(classJS.IGNORELIST_ADD, client.field795.field1535, (byte)12);
                  classXY.method12971(var5.field3343, classAU.method712(var1, (byte)78), (byte)-62);
                  classXY.method12997(var5.field3343, var1, (short)8390);
                  client.field795.method3367(var5, -1301097035);
               }
            }
         }
      } catch (RuntimeException var6) {
         throw classEG.method3884(var6, "bw.ad(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("bw")
   final void method1284(classXY var1, int var2) {
      this.field593.method10135(var1, var2, (byte)1);
      this.field594 = 596332666;
   ...
   classBW(classAAO var1) {
      this.field592 = var1;
      this.field593 = new classRN(var1);
      ...
      if (var1 != null) {
         ...
         if (var2.method171(1953768461)) {
            if (this.field593.method10218(var2, 1722157389)) {
               ...
               classJL var3 = classEF.method3849(classJS.FRIENDLIST_DEL, client.field795.field1535, (byte)87);
               classXY.method12971(var3.field3343, classAU.method712(var1, (byte)98), (byte)-87);
               classXY.method12997(var3.field3343, var1, (short)10772);
               client.field795.method3367(var3, -1301097035);
            }
   ...
   final void method1288() {
      for (classRH var1 = (classRH)this.field593.field5812.method7868(); var1 != null; var1 = (classRH)this.field593.field5812.method7872()) {
   ...
   public void method1340(String var1, boolean var2) {
      ...
      if (var3 != null) {
         classOE.field4843.getCallbacks().post(new RemovedFriend(var3));
      }
   }
   ...
   public static boolean method1323(classBW var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            if (!classRT.method10195(var0.field591, 2037364072)) {
               if (var1 != 24) {
                  throw new IllegalStateException();
               }
            ...
            throw classEG.method3884(var2, "bw.ap(" + ')');
         }
      }
   }
   ...
   final boolean method1324() {
      return classRT.method10195(this.field591, 2037364072) || this.field591.method10191(-1164656627) >= 100 && 1 != 1610258521 * client.field847;
   }
   ...
   public static boolean method1311(classBW var0) {
      return classRT.method10195(var0.field593, 2037364072) || var0.field593.method10191(-1954472056) >= 200 && 1 != client.field847 * 1610258521;
   }
   ...
   public static boolean method1312(classBW var0, byte var1) {
      ...
      try {
         if (!classRT.method10195(var0.field593, 2037364072)) {
         ...
         throw classEG.method3884(var2, "bw.aq(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ba")
   final void method1285(classXY var1, int var2) {
      this.field593.method10135(var1, var2, (byte)1);
   ...
   final boolean method1297(classAAE var1, boolean var2) {
      if (null == var1) {
         ...
         return var1.equals(classOE.field4843.vmethod255((byte)75)) ? true : this.field593.method10134(var1, var2, -2083902275);
      }
   }
      ...
      if (null != var1) {
         ...
         if (var2.method171(1220803059)) {
            if (method1312(this, (byte)23)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)115);
               if (null != var3 && var3.equals(var2)) {
                  classAD.method327(-855954109);
                  ...
                  classJL var4 = classEF.method3849(classJS.FRIENDLIST_ADD, client.field795.field1535, (byte)71);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)84), (byte)-115);
                  classXY.method12997(var4.field3343, var1, (short)25494);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
      ...
      if (null != var1) {
         ...
         if (var2.method171(166348403)) {
            if (method1312(this, (byte)42)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)102);
               if (null != var3 && var3.equals(var2)) {
                  classAD.method327(-855954109);
                  ...
                  classJL var4 = classEF.method3849(classJS.FRIENDLIST_ADD, client.field795.field1535, (byte)-16);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)98), (byte)-86);
                  classXY.method12997(var4.field3343, var1, (short)21222);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
      ...
      if (null != var1) {
         ...
         if (var2.method171(1661536918)) {
            if (method1312(var0, (byte)35)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)70);
               if (null != var3 && var3.equals(var2)) {
                  classAD.method327(-855954109);
                  ...
                  classJL var4 = classEF.method3849(classJS.FRIENDLIST_ADD, client.field795.field1535, (byte)-83);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)95), (byte)-102);
                  classXY.method12997(var4.field3343, var1, (short)3053);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
      ...
      if (null != var1) {
         ...
         if (var2.method171(1967711338)) {
            if (method1312(this, (byte)20)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)49);
               if (null != var3 && var3.equals(var2)) {
                  classAD.method327(-855954109);
                  ...
                  classJL var4 = classEF.method3849(classJS.FRIENDLIST_ADD, client.field795.field1535, (byte)-16);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)73), (byte)-38);
                  classXY.method12997(var4.field3343, var1, (short)9901);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
   ...
   final boolean method1313() {
      return classRT.method10195(this.field593, 2037364072) || this.field593.method10191(-358458507) >= 200 && 1 != client.field847 * 1610258521;
   }
      ...
      if (null != var1) {
         ...
         if (var2.method171(1600364524)) {
            if (method1323(this, (byte)24)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)63);
               if (null != var3 && var3.equals(var2)) {
                  String var6 = classKK.field3796;
                  ...
                  classJL var4 = classEF.method3849(classJS.IGNORELIST_ADD, client.field795.field1535, (byte)11);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)58), (byte)-71);
                  classXY.method12997(var4.field3343, var1, (short)13509);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
   ...
   static void method1338(int var0, int var1, int var2) {
      try {
         if (null == classON.field4993 || classOE.field4843.method2330(classON.field4993.field612 * 568212409, classON.field4993.field618, (byte)100)) {
            classOE.field4843.method2298(var0, var1, -1225618138);
         } else if (-1927903443 * client.field974.field6797 > 0) {
            if (var2 <= 665885693) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.method3884(var3, "bw.fd(" + ')');
      }
   }
      ...
      if (var1 != null) {
         ...
         if (var2.method171(-4988351)) {
            if (this.field593.method10218(var2, 1239113959)) {
               ...
               classJL var3 = classEF.method3849(classJS.FRIENDLIST_DEL, client.field795.field1535, (byte)-102);
               classXY.method12971(var3.field3343, classAU.method712(var1, (byte)91), (byte)-12);
               classXY.method12997(var3.field3343, var1, (short)26832);
               client.field795.method3367(var3, -1301097035);
            }
      ...
      if (var0 == null) {
         ...
         if (var3.method171(-280857570)) {
            if (var0.field591.method10218(var3, -503332637)) {
               ...
               if (var2) {
                  classJL var4 = classEF.method3849(classJS.IGNORELIST_DEL, client.field795.field1535, (byte)-55);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)91), (byte)-124);
                  classXY.method12997(var4.field3343, var1, (short)980);
                  client.field795.method3367(var4, -1301097035);
               }
            }
      ...
      if (var1 != null) {
         ...
         if (var2.method171(1260526473)) {
            if (this.field593.method10218(var2, 1644864300)) {
               ...
               classJL var3 = classEF.method3849(classJS.FRIENDLIST_DEL, client.field795.field1535, (byte)110);
               classXY.method12971(var3.field3343, classAU.method712(var1, (byte)100), (byte)-121);
               classXY.method12997(var3.field3343, var1, (short)32261);
               client.field795.method3367(var3, -1301097035);
            }
   ...
   public static boolean method1334(classBW var0, classAAE var1) {
      ...
      classRP var2 = (classRP)var0.field593.method10207(var1, 282151994);
      return var2 != null && classRI.method9973(var2, -2034169450);
   }

   @ObfuscatedSignature(descriptor = "(Lxy;II)V")
   @ObfuscatedName("ac")
   final void method1286(classXY var1, int var2, int var3) {
      try {
         this.field593.method10135(var1, var2, (byte)1);
         this.field594 = 596332666;
         classPW.method9358(182571929);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "bw.ac(" + ')');
      }
   }
   ...
   final boolean method1298(classAAE var1, boolean var2) {
      if (null == var1) {
         ...
         return var1.equals(classOE.field4843.vmethod255((byte)61)) ? true : this.field593.method10134(var1, var2, -1989858874);
      }
   }

   @ObfuscatedSignature(descriptor = "()Lrn;")
   @ObfuscatedName("ip")
   public classRN method1344() {
      ...
      if (var1 != null) {
         ...
         if (var3.method171(33006293)) {
            if (this.field591.method10218(var3, -1764000461)) {
               ...
               if (var2) {
                  classJL var4 = classEF.method3849(classJS.IGNORELIST_DEL, client.field795.field1535, (byte)-2);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)95), (byte)-101);
                  classXY.method12997(var4.field3343, var1, (short)23043);
                  client.field795.method3367(var4, -1301097035);
               }
            }
   ...
   final boolean method1335(classAAE var1) {
      classRP var2 = (classRP)this.field593.method10207(var1, 282151994);
      return var2 != null && classRI.method9973(var2, -2128771078);
   }
   ...
   public static classYY method1267(int var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "bw.ae(" + ')');
      }
   }
      ...
      if (var0 == null) {
         ...
         if (var2.method171(792654581)) {
            if (method1312(var0, (byte)61)) {
               ...
               classAAE var3 = classOE.field4843.vmethod255((byte)109);
               if (null != var3 && var3.equals(var2)) {
                  classAD.method327(-855954109);
                  ...
                  classJL var4 = classEF.method3849(classJS.FRIENDLIST_ADD, client.field795.field1535, (byte)-64);
                  classXY.method12971(var4.field3343, classAU.method712(var1, (byte)124), (byte)-118);
                  classXY.method12997(var4.field3343, var1, (short)5194);
                  client.field795.method3367(var4, -1301097035);
               }
            }
         }
   ...
   @ObfuscatedName("ae")
   static long method1276(classYN var0, int var1, long var2) {
      try {
         if (var0 == null) {
            return var2;
         } else {
         ...
         throw classEG.method3884(var5, "bw.ae(" + ')');
      }
   }
   ...
   final boolean method1336(classAAE var1, short var2) {
      try {
         classRP var3 = (classRP)this.field593.method10207(var1, 282151994);
         if (var3 != null) {
            if (var2 == 160) {
               throw new IllegalStateException();
            }

            if (classRI.method9973(var3, -2092993019)) {
               if (var2 == 160) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var4, "bw.ar(" + ')');
      }
   }
   ...
   public static String method1260(CharSequence var0, classAAO var1, int var2) {
      try {
         ...
         throw classEG.method3884(var13, "bw.az(" + ')');
      }
   }
   ...
   final boolean method1314(byte var1) {
      try {
         if (!classRT.method10195(this.field593, 2037364072)) {
   ...
   @ObfuscatedName("bj")
   boolean method1315() {
      return classRT.method10195(this.field593, 2037364072) || this.field593.method10191(-1571057932) >= -699968365 && 1 != client.field1069 * 1610258521;
   }
   ...
   final boolean method1317() {
      return classRT.method10195(this.field593, 2037364072) || this.field593.method10191(-358458507) >= 200 && 1 != client.field825 * 1610258521;
   }
