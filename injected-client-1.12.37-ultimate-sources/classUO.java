...
public class classUO implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "uo.az(" + 41);
      }
   }
   ...
   static void method11414(int var0, int var1) {
      try {
         ...
         if (classLH.method7105(-615017728) == 1) {
            ...
            classOE.field4843.method11097(765, 503, (byte)82);
         } else {
            classOE.field4843.method11097(7680, 2160, (byte)81);
         }
         ...
         if (client.field828 * -44590225 >= 25) {
            ...
            if (client.field795 != null) {
               ...
               if (null == client.field795.field1535) {
                  if (var1 >= -2042311248) {
                     throw new IllegalStateException();
                  }
               } else {
                  classJL var2 = classEF.method3849(classJS.WINDOW_STATUS, client.field795.field1535, (byte)43);
                  classXY.method12971(var2.field3343, classLH.method7105(1212026946), (byte)-100);
                  var2.field3343.method12973(773246731 * classSA.field5897, -1542382992);
                  var2.field3343.method12973(8379747 * classEU.field1938, -1542382992);
                  client.field795.method3367(var2, -1301097035);
               }
            }
         }
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "uo.bh(" + ')');
      }
   }
   ...
   public static void method11413(String[] var0, int[] var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "uo.ae(" + ')');
      }
   }
}
