...
@ObfuscatedName("tc")
public final class classTC implements classMF, MouseWheelListener {
   @ObfuscatedName("az")
   int field6118 = 0;
   ...
   void method10740(Component var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "tc.ab(" + ')');
      }
   }
   ...
   void method10743(Component var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "tc.ag(" + ')');
      }
   }

   @Override
   public synchronized void mouseWheelMoved(MouseWheelEvent var1) {
      var1 = classOE.field4843.getCallbacks().mouseWheelMoved(var1);
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            throw classEG.method3884(var4, "tc.mouseWheelMoved(" + ')');
         }
      }
   }
   ...
   public synchronized int vmethod528(int var1) {
      try {
         ...
         throw classEG.method3884(var3, "tc.az(" + 41);
      }
   }
