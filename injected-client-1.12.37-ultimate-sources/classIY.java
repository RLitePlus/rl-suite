...
public class classIY extends classHB {
   ...
   @ObfuscatedName("am")
   public static classVA field3099;
   @ObfuscatedName("az")
   long field3091;
   @ToRemove(unused = "true")
   @ObfuscatedName("aa")
   ...
   void vmethod499(classIQ var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "iy.af(" + ')');
      }
   }
   ...
   void vmethod498(classXY var1, int var2) {
      try {
         ...
         this.field3090 = classXY.method13047(var1, 108447796) * -1722364165;
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "iy.az(" + ')');
      }
   }
   ...
   public static boolean method6336(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         ...
         throw classEG.method3884(var20, "iy.as(" + ')');
      }
   }
   ...
   void vmethod500(classXY var1) {
      if (classXY.method13039(var1, -346779531) != -451600790) {
         var1.field6955 -= -1025508226;
         this.field3091 = var1.method13059(1629690656) * 5458781402499895515L;
      }

      this.field3089 = var1.method13069((byte)-54);
      this.field3090 = classXY.method13047(var1, 716605601) * -1722364165;
   }
   ...
   public static classPH method6334(int var0, int var1) {
      try {
         ...
         if (null != var2) {
            ...
            var2 = new classPH(new classXY(var3));
            classPH.field5252.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "iy.af(" + ')');
      }
   }
}
