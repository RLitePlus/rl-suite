...
public class classXC {
   ...
   public HashMap method12742(classXJ[] var1) {
      ...
      for (int var4 = 0; var4 < var3.length; var4++) {
         ...
         if (this.field6823.containsKey(var5)) {
            ...
            classZV var6 = classCU.method2675(this.field6822, this.field6824, var5.field6880, "", -2045331213);
            if (null != var6) {
   ...
   public static HashMap method12743(classXC var0, classXJ[] var1) {
      ...
      for (int var4 = 0; var4 < var3.length; var4++) {
         ...
         if (var0.field6823.containsKey(var5)) {
            ...
            classZV var6 = classCU.method2675(var0.field6822, var0.field6824, var5.field6880, "", 421295953);
            if (null != var6) {
      ...
      try {
         ...
         for (int var5 = 0; var5 < var4.length; var5++) {
            ...
            if (this.field6823.containsKey(var6)) {
               ...
               classZV var7 = classCU.method2675(this.field6822, this.field6824, var6.field6880, "", -1878459293);
               if (null != var7) {
                  if (var2 != -1607507693) {
                     throw new IllegalStateException();
                  }
   ...
   public classXC(classVA var1, classVA var2) {
      this.field6822 = var1;
      this.field6824 = var2;
   ...
   public HashMap method12745(classXJ[] var1) {
      ...
      for (int var4 = 0; var4 < var3.length; var4++) {
         ...
         if (this.field6823.containsKey(var5)) {
            ...
            classZV var6 = classCU.method2675(this.field6822, this.field6824, var5.field6880, "", 1731852835);
            if (null != var6) {
               this.field6823.put(var5, var6);
               var2.put(var5, var6);
            }
   ...
   public HashMap method12746(classXJ[] var1) {
      ...
      for (int var4 = 0; var4 < var3.length; var4++) {
         ...
         if (this.field6823.containsKey(var5)) {
            ...
            classZV var6 = classCU.method2675(this.field6822, this.field6822, var5.field6880, "", -2045331213);
            if (null != var6) {
               this.field6823.put(var5, var6);
               var2.put(var5, var6);
            }
