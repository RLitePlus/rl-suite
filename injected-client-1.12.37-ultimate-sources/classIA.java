...
public class classIA extends classIS {
   ...
   @ObfuscatedName("ag")
   public static classVA field2927;
   @ToRemove(unused = "true")
   @ObfuscatedName("as")
   ...
   void vmethod505(classXY var1) {
      this.field2919 = classXY.method13047(var1, 1342024445) * -1326993401;
      this.field2920 = classXY.method13043(var1, (byte)17);
      this.field2921 = classXY.method13047(var1, 70727043) * 1810015857;
   ...
   void vmethod508(classIE var1) {
      classHN var2 = (classHN)var1.field2955.get(1665855653 * this.field2919);
   ...
   void vmethod506(classXY var1) {
      this.field2919 = classXY.method13047(var1, 683294502) * -848595155;
      this.field2920 = classXY.method13043(var1, (byte)17);
      this.field2921 = classXY.method13047(var1, 96279455) * -832897509;
   ...
   void vmethod507(classXY var1, int var2) {
      try {
         this.field2919 = classXY.method13047(var1, 500121357) * -848595155;
         this.field2920 = classXY.method13043(var1, (byte)17);
         this.field2921 = classXY.method13047(var1, -1680678979) * -832897509;
         var1.method13059(829292351);
         this.field2926 = var1.method13071(-226046619);
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "ia.az(" + ')');
      }
   }
   ...
   void vmethod511(classIE var1) {
      classHN var2 = (classHN)var1.field2955.get(209597842 * this.field2919);
      var2.field2841 = this.field2920;
      var2.field2842 = this.field2921 * 1642452849;
      var2.field2846 = new classAAE(this.field2926);
   }
