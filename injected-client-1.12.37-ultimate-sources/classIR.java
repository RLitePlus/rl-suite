...
public class classIR extends classIS {
   ...
   @ObfuscatedName("af")
   public static classYM[] method6307(classVA var0, int var1, int var2, int var3) {
      try {
         if (!classHK.method6068(var0, var1, var2, (byte)-24)) {
            ...
            classYM[] var5 = new classYM[1616155503 * classYL.field7001];
            ...
            for (int var6 = 0; var6 < classYL.field7001 * 1616155503; var6++) {
               ...
               classYM var7 = var5[var6] = new classYM();
         ...
         if (!classNP.field4700.isEmpty()) {
            ...
            if (!classNP.field4698.isEmpty()) {
               ...
               if (classNP.field4698.get(0) != null) {
                  ...
                  if (((classNB)classNP.field4698.get(0)).field4641 != null) {
                     return ((classNB)classNP.field4698.get(0)).field4641.method8041((byte)10);
                  }
               }
            }
   ...
   @ObfuscatedName("az")
   public static classOI method6309(int var0, int var1) {
      try {
         classOI var2 = (classOI)classOI.field4872.method6422(var0);
         if (var2 != null) {
            if (var1 <= -1417546985) {
               throw new IllegalStateException();
            } else {
            ...
            var2 = new classOI(new classXY(var3), var0);
            classOI.field4872.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
   ...
   @ObfuscatedName("zd")
   public static void method6312(classEZ var0, int var1, int var2, int var3) {
      if (var0 == null) {
   ...
   public static final void method6308(int var0, boolean var1, int var2, int var3) {
      try {
         if (var0 >= 8000) {
            if (var0 <= 48000) {
               classLG.field4138 = var0 * -411122787;
