...
public class classAI {
   ...
   void method381(classXY var1) {
      ...
      for (int var3 = 0; var3 < var2; var3++) {
         ...
         int var5;
         do {
            var5 = classXY.method13039(var1, -346779531);
            var4 += var5;
         } while (var5 >= 255);
   ...
   int method377(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ai.af(" + 41);
      }
   }
   ...
   public static float[] method389(classAI var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.method3884(var44, "ai.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("ri")
   public static void method382(classAI var0, classXY var1) {
      if (var0 == null) {
         var0.method372();
      }
   ...
   @ObfuscatedName("ab")
   void method383(classXY var1, int var2) {
      try {
         this.field160 = var1.method13056((byte)1) * 245885603;
         this.field162 = var1.method13056((byte)1) * -572006573;
         this.field158 = var1.method13056((byte)1) * 1011042621;
         ...
         for (int var4 = 0; var4 < var3; var4++) {
            ...
            int var6;
            do {
               var6 = classXY.method13039(var1, -346779531);
               var5 += var6;
            } while (var6 >= 255);
         ...
         throw classEG.method3884(var7, "ai.ab(" + ')');
      }
   }
   ...
   classAJ method386(byte var1) {
      try {
         ...
         throw classEG.method3884(var8, "ai.ag(" + ')');
      }
   }
   ...
   void method396(byte[] var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var22, "ai.ax(" + ')');
      }
   }
   ...
   public static int method373(classAI var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "ai.az(" + 41);
         }
      }
   }
   ...
   int method380(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ai.ae(" + 41);
      }
   }
   ...
   public static classOR method376(int var0, int var1) {
      try {
         ...
         if (null != var2) {
            ...
            var2 = new classOR(new classXY(var3), var0);
            classOR.field5098.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "ai.az(" + ')');
      }
   }
   ...
   static classRZ method370(classXO var0, int var1) {
      try {
         ...
         throw classEG.method3884(var3, "ai.az(" + ')');
      }
   }
