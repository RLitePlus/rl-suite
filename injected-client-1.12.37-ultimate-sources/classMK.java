...
public class classMK {
   ...
   @ObfuscatedName("xk")
   public static void method7594(classDN var0, String var1) {
      if (var0 == null) {
         var0.vmethod270();
      }
   ...
   @ObfuscatedName("ap")
   static final void method7595(classLW var0, int var1, byte[] var2, byte[] var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var6, "mk.ap(" + ')');
      }
   }
}
