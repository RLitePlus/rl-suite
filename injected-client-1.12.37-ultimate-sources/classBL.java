...
@ObfuscatedName("bl")
public class classBL extends classVJ implements Script {
   @ObfuscatedName("ax")
   long[] field503;
   ...
   @ObfuscatedName("az")
   static classJZ field491 = new classJZ(128);
   @ObfuscatedName("aa")
   int field492;
   @ObfuscatedName("ao")
   int field496;
   ...
   @ObfuscatedName("ac")
   classYN[] method1144(int var1, byte var2) {
      try {
         return new classYN[var1];
      } catch (RuntimeException var3) {
   ...
   @ObfuscatedName("aa")
   static classBL method1120(int var0) {
      classBL var1 = (classBL)field491.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
         ...
         if (var2 == null) {
            ...
            var1 = classLW.method7156(var2, -652641174);
   ...
   @ObfuscatedName("ap")
   static classBL method1126(int var0, int var1) {
      classBL var2 = (classBL)field491.method6422(var0 << 16);
      if (null != var2) {
         return var2;
      } else {
         ...
         if (var4 == -1) {
            ...
            byte[] var5 = classVA.method11814(classWN.field6759, var4, 1229660067);
            if (null != var5) {
               if (var5.length <= 1) {
                  return null;
               }

               var2 = classLW.method7156(var5, -755539074);
               if (var2 != null) {
   ...
   @ObfuscatedSignature(descriptor = "(I)Lbl;")
   @ObfuscatedName("al")
   static classBL method1121(int var0) {
      classBL var1 = (classBL)field491.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
         ...
         if (var2 == null) {
            ...
            var1 = classLW.method7156(var2, -660300074);
            field491.method6428(var1, var0);
            return var1;
         }
      }
   ...
   @ObfuscatedName("aj")
   static classBL method1123(int var0, int var1, int var2) {
      int var3 = var0 + (var1 << 8);
      classBL var5 = classQW.method9830(var3, var0, -1324601792);
      if (var5 != null) {
         return var5;
      } else {
   ...
   @ObfuscatedName("av")
   static classBL method1131(byte[] var0) {
      classBL var1 = new classBL();
      ...
      if (var6 > 0) {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            ...
            classYN var9 = new classYN(var8 > 0 ? classBZ.method1385(var8, -1565080523) : 1);
            var1.field505[var7] = var9;

            while (var8-- > 0) {
               int var10 = var2.method13056((byte)1);
               int var11 = var2.method13056((byte)1);
               classYN.method13576(var9, new classVG(var11), var10);
            }
         }
      }
   ...
   @ObfuscatedSignature(descriptor = "(I)Lbl;")
   @ObfuscatedName("ao")
   static classBL method1122(int var0) {
      classBL var1 = (classBL)field491.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
         ...
         if (var2 == null) {
            ...
            var1 = classLW.method7156(var2, 301197489);
            field491.method6428(var1, var0);
            return var1;
         }
      }
   ...
   @ObfuscatedSignature(descriptor = "(II)Lbl;")
   @ObfuscatedName("ad")
   static classBL method1127(int var0, int var1) {
      classBL var2 = (classBL)field491.method6422(var0 << 16);
      if (null != var2) {
         return var2;
      } else {
         ...
         if (var4 == -1) {
            ...
            byte[] var5 = classVA.method11814(classWN.field6759, var4, 93317186);
            if (null != var5) {
               if (var5.length <= 1) {
                  return null;
               }

               var2 = classLW.method7156(var5, 378970215);
               if (var2 != null) {
                  field491.method6428(var2, var0 << 16);
                  return var2;
               }
   ...
   @ObfuscatedSignature(descriptor = "([B)Lbl;")
   @ObfuscatedName("at")
   static classBL method1132(byte[] var0) {
      classBL var1 = new classBL();
      classXY var2 = new classXY(var0);
      ...
      if (var6 > 0) {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            ...
            classYN var9 = new classYN(var8 > 0 ? classBZ.method1385(var8, -1920534847) : 1);
            var1.field505[var7] = var9;
   ...
   @ObfuscatedSignature(descriptor = "(II)Lbl;")
   @ObfuscatedName("au")
   static classBL method1128(int var0, int var1) {
      classBL var2 = (classBL)field491.method6422(var0 << 16);
      if (null != var2) {
         return var2;
      } else {
         ...
         if (var4 == -1) {
            ...
            byte[] var5 = classVA.method11814(classWN.field6759, var4, 1071886326);
            if (null != var5) {
               if (var5.length <= 1) {
                  return null;
               }

               var2 = classLW.method7156(var5, -357754762);
               if (var2 != null) {
                  field491.method6428(var2, var0 << 16);
                  return var2;
               }
   ...
   @ObfuscatedSignature(descriptor = "(III)Lbl;")
   @ObfuscatedName("aq")
   static classBL method1124(int var0, int var1, int var2) {
      int var3 = var0 + (var1 << 8);
      classBL var5 = classQW.method9830(var3, var0, -1770482952);
      if (var5 != null) {
         return var5;
      } else {
   ...
   @ObfuscatedSignature(descriptor = "(II)Lbl;")
   @ObfuscatedName("ar")
   static classBL method1129(int var0, int var1) {
      classBL var2 = (classBL)field491.method6422(var0 << 16);
      if (null != var2) {
         return var2;
      } else {
         ...
         if (var4 == -1) {
            ...
            byte[] var5 = classVA.method11814(classWN.field6759, var4, 968147341);
            if (null != var5) {
               if (var5.length <= 1) {
                  return null;
               }

               var2 = classLW.method7156(var5, -1084359021);
               if (var2 != null) {
                  field491.method6428(var2, var0 << 16);
                  return var2;
               }
   ...
   @ObfuscatedSignature(descriptor = "([B)Lbl;")
   @ObfuscatedName("aw")
   static classBL method1133(byte[] var0) {
      classBL var1 = new classBL();
      classXY var2 = new classXY(var0);
      ...
      if (var6 > 0) {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            ...
            classYN var9 = new classYN(var8 > 0 ? classBZ.method1385(var8, 29664065) : 1);
            var1.field505[var7] = var9;
   ...
   @ObfuscatedSignature(descriptor = "([B)Lbl;")
   @ObfuscatedName("ak")
   static classBL method1134(byte[] var0) {
      classBL var1 = new classBL();
      classXY var2 = new classXY(var0);
      ...
      if (var6 > 0) {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            ...
            classYN var9 = new classYN(var8 > 0 ? classBZ.method1385(var8, -1203260193) : 1);
            var1.field505[var7] = var9;
   ...
   @ObfuscatedSignature(descriptor = "(II)Lbl;")
   @ObfuscatedName("ai")
   static classBL method1130(int var0, int var1) {
      classBL var2 = (classBL)field491.method6422(var0 << 16);
      if (null != var2) {
         return var2;
      } else {
         ...
         if (var4 == -1) {
            ...
            byte[] var5 = classVA.method11814(classWN.field6759, var4, -1100792790);
            if (null != var5) {
               if (var5.length <= 1) {
                  return null;
               }

               var2 = classLW.method7156(var5, -452129036);
               if (var2 != null) {
                  field491.method6428(var2, var0 << 16);
                  return var2;
               }
   ...
   @ObfuscatedName("br")
   classYN[] method1145(int var1) {
      return new classYN[var1];
   }

   @ObfuscatedSignature(descriptor = "(I)[Lyn;")
   @ObfuscatedName("bp")
   classYN[] method1146(int var1) {
      return new classYN[var1];
   }
      ...
      try {
         if (classMH.method7572((byte)11) != 0) {
            ...
            if (var0 != -1) {
               ...
               var3.add(new classNB(classCB.field650, var0, 0, classMH.method7572((byte)11), false));
   ...
   @ObfuscatedSignature(descriptor = "(III)Lbl;")
   @ObfuscatedName("ay")
   static classBL method1125(int var0, int var1, int var2) {
      int var3 = var0 + (var1 << 8);
      classBL var5 = classQW.method9830(var3, var0, -1084871735);
      if (var5 != null) {
         return var5;
      } else {
   ...
   public static final classUZ method1135(classUZ var0, float var1, int var2) {
      try {
         classUZ var3 = classGX.method5840(var0, (byte)19);
