...
@ObfuscatedName("rn")
public class classRN extends classRT implements FriendContainer {
   ...
   public boolean method10131(classAAE var1, boolean var2) {
      classRP var3 = (classRP)this.method10207(var1, 282151994);
         ...
         while (702114061 * var1.field6955 < var2) {
            ...
            if (null != var5) {
               ...
               if (var5.method171(84304373)) {
                  classRP var12 = (classRP)classRT.method10209(this, var5, 215663160);
                  if (var4) {
                     if (var3 != 1) {
                        throw new IllegalStateException();
                     }

                     classRP var13 = (classRP)classRT.method10209(this, var6, -213415090);
                     if (var13 != null) {
                        if (var3 != 1) {
                           throw new IllegalStateException();
                        }
                  ...
                  if (null != var12) {
                     ...
                     if (var7 != var12.field5669 * -760305529) {
                        ...
                        for (classRH var14 = (classRH)this.field5812.method7868(); var14 != null; var14 = (classRH)this.field5812.method7872()) {
                           if (var3 != 1) {
                              throw new IllegalStateException();
                           }
                        ...
                        if (var16) {
                           classNK.method7865(this.field5812, new classRH(var5, var7));
                        }
                     }
                  } else {
                     ...
                     var12 = (classRP)this.method10226(var5, var6, (byte)1);
                  }
   ...
   public void method10136(classXY var1, int var2) {
      while (702114061 * var1.field6955 < var2) {
         ...
         classRP var11 = (classRP)classRT.method10209(this, var4, -483768489);
         if (var3) {
            classRP var12 = (classRP)classRT.method10209(this, var5, 10049706);
         ...
         if (null != var11) {
            ...
            if (var6 != var11.field5669 * -637919054) {
               ...
               for (classRH var13 = (classRH)this.field5812.method7868(); var13 != null; var13 = (classRH)this.field5812.method7872()) {
               ...
               if (var14) {
                  classNK.method7865(this.field5812, new classRH(var4, var6));
               }
            }
         } else {
            ...
            var11 = (classRP)this.method10226(var4, var5, (byte)-71);
         }
   ...
   public void method10137(classXY var1, int var2) {
      while (702114061 * var1.field6955 < var2) {
         ...
         classRP var11 = (classRP)classRT.method10209(this, var4, -1919857173);
         if (var3) {
            classRP var12 = (classRP)classRT.method10209(this, var5, 888126702);
            if (var12 != null && var12 != var11) {
               if (null != var11) {
         ...
         if (null != var11) {
            ...
            var11 = (classRP)this.method10226(var4, var5, (byte)-28);
         }
   ...
   public boolean method10134(classAAE var1, boolean var2, int var3) {
      try {
         classRP var4 = (classRP)this.method10207(var1, 282151994);
         if (null == var4) {
            return false;
         } else {
            if (var2) {
