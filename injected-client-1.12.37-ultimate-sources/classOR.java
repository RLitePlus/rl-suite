...
public class classOR extends classVJ {
   ...
   @ObfuscatedName("aj")
   public static classVA field5085;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ay")
   static classJZ field5098 = new classJZ(64);
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("aq")
   static classJZ field5099 = new classJZ(30);
   @ObfuscatedName("ad")
   final int field5088;
   @ToRemove(unused = "true")
   @ObfuscatedName("aa")
   ...
   public boolean method8728(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "or.ag(" + ')');
      }
   }
   ...
   public static classOR method8719(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classOR(new classXY(var2), var0);
         field5098.method6428(var1, var0);
         return var1;
      }
   }

   classOR(classXY var1, int var2) {
         ...
         while (true) {
            ...
            switch (var15) {
               ...
               default:
                  continue;
               case 2:
                  var4 = classXY.method13047(var1, -1950398158);
                  continue;
               case 3:
                  var3 = var1.method13117(classXM.field6888.field6890, 1437379579);
                  continue;
               case 4:
                  var9 = classXY.method13047(var1, 667998590);
                  continue;
               case 5:
                  var10 = classXY.method13047(var1, -865461482);
                  continue;
               case 6:
                  var11 = classXY.method13047(var1, 123616886);
                  continue;
               case 7:
               ...
               case 40:
                  ...
                  while (true) {
                     ...
                     var5[var19] = (short)classXY.method13047(var1, -1246683280);
                     var6[var19] = (short)classXY.method13047(var1, -1766064453);
                     var19++;
                  }
               case 41:
            }
            ...
            for (int var17 = 0; var17 < var16; var17++) {
               var7[var17] = (short)classXY.method13047(var1, -1882949024);
               var8[var17] = (short)classXY.method13047(var1, -781866163);
            }
         }
      }
   ...
   @ObfuscatedName("ao")
   public final classFX method8723(int var1) {
      classFX var2 = this.method8726(457912642);
      if (null == var2) {
         return null;
      } else {
         classFX var3;
   ...
   @ObfuscatedName("ae")
   public final classFX method8724(int var1, int var2) {
      try {
         classFX var3 = this.method8726(2031766993);
         if (null == var3) {
            if (var2 <= 608537135) {
         ...
         throw classEG.method3884(var5, "or.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Lfx;")
   @ObfuscatedName("ab")
   public final classFX method8726(int var1) {
      try {
         classFX var2 = (classFX)field5099.method6422(-770187307 * this.field5088);
         if (var2 == null) {
            if (var1 == -444705952) {
               throw new IllegalStateException();
            }

            classER var3 = classER.method4047(field5085, -1176461121 * this.field5084, 0);
            if (null == var3) {
               if (var1 == -444705952) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var5, "or.ab(" + ')');
      }
   }
   ...
   public static void method8721() {
      classJZ.method6431(field5098);
      classJZ.method6431(field5099);
   }

   @ObfuscatedSignature(descriptor = "(I)Lfx;")
   @ObfuscatedName("aa")
   public final classFX method8725(int var1) {
      classFX var2 = this.method8726(-1712517118);
      if (null == var2) {
         return null;
      } else {
         classFX var3;
   ...
   @ObfuscatedName("al")
   public final classFX method8727() {
      classFX var1 = (classFX)field5099.method6422(-770187307 * this.field5088);
      if (var1 == null) {
         classER var2 = classER.method4047(field5085, -1176461121 * this.field5084, 0);
         if (null == var2) {
            return null;
         }
   ...
   public static int method8729(CharSequence var0, int var1, int var2, byte[] var3, int var4, int var5) {
      try {
         ...
         throw classEG.method3884(var9, "or.ag(" + 41);
      }
   }
}
