...
public class classGM {
   ...
   @ObfuscatedName("ab")
   public static void method5497(classXY var0, classGY var1, int var2, int var3) {
      ...
      byte var4 = classXY.method13043(var0, (byte)17);
      if (var4 != 0) {
   ...
   @ObfuscatedName("as")
   public static int method5499(classXY var0, byte var1, int var2) {
      ...
      if (var3 == 3) {
         ...
         return 1 == var3 ? classXY.method13043(var0, (byte)17) : 0;
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;BI)I")
   @ObfuscatedName("ag")
   public static int method5500(classXY var0, byte var1, int var2) {
      int var3 = var1 >> var2 & 3;
      if (var3 == 3) {
         return var0.method13056((byte)1);
      } else if (2 == var3) {
   ...
   @ObfuscatedName("rt")
   public static void method5502(classTQ var0, WindowEvent var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Lgy;II)V")
   @ObfuscatedName("ae")
   public static void method5498(classXY var0, classGY var1, int var2, int var3) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;BI)I")
   @ObfuscatedName("ax")
   public static int method5501(classXY var0, byte var1, int var2) {
      int var3 = var1 >> var2 & 3;
      if (var3 == 3) {
         return var0.method13056((byte)1);
      } else if (2 == var3) {
