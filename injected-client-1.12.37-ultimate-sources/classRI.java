...
@ObfuscatedName("ri")
public class classRI extends classRR implements ChatPlayer {
   @ObfuscatedName("as")
   ...
   @ObfuscatedName("vc")
   public static boolean method9973(classRI var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ln")
   public static void method9966(classRI var0, int var1, int var2, byte var3) {
      if (var0 == null) {
   ...
   @ObfuscatedName("sp")
   public static boolean method9974(classRI var0) {
