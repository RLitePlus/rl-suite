...
@ObfuscatedName("lg")
public class classLG extends classVQ implements WidgetConfigNode {
   @ObfuscatedName("im")
   ...
   public int method6782(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "lg.az(" + 41);
      }
   }

   classLG(int var1, int var2, int var3, int var4) {
   ...
   static final void method6792(int var0) {
      try {
         if (classYY.field7118) {
            ...
            while (var1.hasNext()) {
               ...
               for (int var3 = 0; var3 < client.field837.field1419 * -2087374717; var3++) {
                  ...
                  classCT var4 = (classCT)classIS.field3053.field1694.method13404(client.field837.field1423[var3]);
                  if (var4 != null) {
                     if (var0 != 293773697) {
                        throw new IllegalStateException();
                     }

                     classCT.method2642(var4, (byte)-4);
                  }
               }
            }
         ...
         throw classEG.method3884(var5, "lg.bm(" + ')');
      }
   }
   ...
   @ObfuscatedName("aa")
   public static classLG method6787(classLG var0, int var1, int var2, int var3, int var4) {
      classLG var5 = var0;

      for (classLG var6 = null; null != var5; var5 = var5.field4140) {
         if (-1057754721 * var5.field4136 >= var1 && 1443675333 * var5.field4134 <= var2) {
            ...
            if (var5.field4134 * 1443675333 < var1) {
               classLG var7 = new classLG(var5.field4134 * 1443675333, var1 - 1, var5.field4137 * -802457829, 123180743 * var5.field4135);
               if (var6 != null) {
            ...
            if (var5.field4136 * -1057754721 > var2) {
               classLG var11 = new classLG(var2 + 1, var5.field4136 * -1057754721, var5.field4137 * -802457829, var5.field4135 * 123180743);
               if (var6 != null) {
      ...
      for (classLG var9 = var0; null != var9 && var9.field4134 * 1443675333 <= var1; var9 = var9.field4140) {
         var5 = var9;
      }

      classLG var10 = new classLG(var1, var2, var3, var4);
      if (var5 != null) {
   ...
   @ObfuscatedName("ja")
   public static int method6791(classEZ var0) {
   ...
   @ObfuscatedName("mp")
   public static int method6785(classLG var0, int var1) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "lg.af(" + 41);
      }
   }
   ...
   @ObfuscatedName("ao")
   public static classLG method6789(classLG var0, int var1) {
      for (classLG var2 = var0; null != var2; var2 = var2.field4140) {
   ...
   @ObfuscatedSignature(descriptor = "(Llg;I)Llg;")
   @ObfuscatedName("al")
   public static classLG method6790(classLG var0, int var1) {
      for (classLG var2 = var0; null != var2; var2 = var2.field4140) {
         if (var1 >= 1443675333 * var2.field4134 && var1 <= var2.field4136 * -1057754721) {
            return var2;
         }
   ...
   @ObfuscatedSignature(descriptor = "(Llg;IIII)Llg;")
   @ObfuscatedName("ac")
   public static classLG method6788(classLG var0, int var1, int var2, int var3, int var4) {
      classLG var5 = var0;
