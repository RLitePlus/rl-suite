...
@ObfuscatedName("ql")
public class classQL extends SSLSocketFactory {
   @ObfuscatedSignature(descriptor = "Lql;")
   @ObfuscatedName("az")
   static classQL field5559;
   @ObfuscatedName("af")
   ...
   public Socket createSocket(InetAddress var1, int var2) throws IOException {
      try {
         ...
         throw classEG.method3884(var3, "ql.createSocket(" + ')');
      }
   }
   ...
   public String[] getSupportedCipherSuites() {
      try {
         ...
         throw classEG.method3884(var1, "ql.getSupportedCipherSuites(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "()Lql;")
   @ObfuscatedName("ae")
   public static classQL method9609() {
      if (field5559 == null) {
         field5559 = new classQL();
      }
   ...
   public String[] getDefaultCipherSuites() {
      try {
         ...
         throw classEG.method3884(var1, "ql.getDefaultCipherSuites(" + ')');
      }
   }
   ...
   public Socket createSocket(String var1, int var2, InetAddress var3, int var4) throws IOException, UnknownHostException {
      try {
         ...
         throw classEG.method3884(var5, "ql.createSocket(" + ')');
      }
   }
   ...
   public Socket createSocket(Socket var1, String var2, int var3, boolean var4) throws IOException {
      try {
         ...
         throw classEG.method3884(var6, "ql.createSocket(" + ')');
      }
   }
   ...
   SSLSocket method9628(String var1, TlsClientProtocol var2, int var3) {
      try {
         return new classQC(this, var2, var1);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "ql.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   public static classQL method9610(int var0) {
      try {
         if (field5559 == null) {
            if (var0 <= -640788119) {
         ...
         throw classEG.method3884(var1, "ql.az(" + ')');
      }
   }
