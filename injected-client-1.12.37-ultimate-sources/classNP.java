...
public class classNP {
   ...
   @ObfuscatedName("ax")
   public static classVA field4705;
   @ObfuscatedName("af")
      ...
      if (!var0.isEmpty()) {
         ...
         if (var5) {
            ...
            for (int var6 = 0; var6 < field4698.size(); var6++) {
               classNB var7 = (classNB)field4698.get(var6);
               if (var7 == null) {
   ...
   public static void method7972(classDC var0, int var1, int var2, int var3, int var4) {
      ...
      for (int var5 = 0; var5 < var0.field1389.size(); var5++) {
         ((classDH)var0.field1389.get(var5)).method3126(var1, var2, client.field855 * 1612595797, var3, var4, 472951642);
      }
   }
   ...
   public static void method7953(int var0) {
      if (!field4698.isEmpty()) {
         for (classNB var2 : field4698) {
            if (null != var2) {
               var2.field4635 = var0 * -1016653583;
            }
         }

         classNB var3 = (classNB)field4698.get(0);
   ...
   public static boolean method7962(int var0) {
      if (field4699.isEmpty()) {
         ...
         classNB var1 = (classNB)field4699.get(0);
   ...
   public static boolean method7959() {
      if (!field4700.isEmpty()) {
         ...
         return !field4698.isEmpty() && field4698.get(0) != null && ((classNB)field4698.get(0)).field4641 != null
            ? ((classNB)field4698.get(0)).field4641.method8041((byte)10)
            : false;
      }
   }
   ...
   public static void method7960(int var0, int var1, int var2, int var3) {
      if (field4698.size() > 1
         ...
         && ((classNB)field4698.get(1)).field4641.method8041((byte)10)) {
         ...
         if (field4699.get(0) != null && field4699.get(1) != null) {
            classNB var5 = (classNB)field4699.get(0);
   ...
   @ObfuscatedName("bo")
   public static void method7969(classVA var0, int var1) {
      if (!field4699.isEmpty()) {
         ArrayList var2 = new ArrayList();

         for (classNB var4 : field4699) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I)V")
   @ObfuscatedName("bk")
   public static void method7970(classVA var0, int var1) {
      if (!field4699.isEmpty()) {
         ArrayList var2 = new ArrayList();
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I)V")
   @ObfuscatedName("bu")
   public static void method7971(classVA var0, int var1) {
      if (!field4699.isEmpty()) {
         ArrayList var2 = new ArrayList();
