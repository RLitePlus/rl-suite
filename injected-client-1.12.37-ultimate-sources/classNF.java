...
class classNF implements ThreadFactory {
   ...
   public Thread newThread(Runnable var1) {
      try {
         ...
         throw classEG.method3884(var2, "nf.newThread(" + ')');
      }
   }
   ...
   @ObfuscatedName("cd")
   static int method7835(int var0, classBL var1, boolean var2, int var3) {
      try {
         return 2;
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "nf.cd(" + 41);
      }
   }
   ...
   static int method7834(int var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var3, "nf.aj(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IIIILup;Lym;Lkh;B)V")
   @ObfuscatedName("ac")
   static final void method7833(classDZ var0, int var1, int var2, int var3, int var4, classUP var5, classYM var6, classKH var7, byte var8) {
      try {
         ...
         throw classEG.method3884(var23, "nf.ac(" + ')');
      }
   }
   ...
   public static int method7830(int var0, int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var4, "nf.ab(" + 41);
      }
   }
}
