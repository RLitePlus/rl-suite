...
public class classFC implements classTL {
   ...
   @ObfuscatedName("az")
   public classLW method4571(int var1) {
      try {
         return this.field2203;
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "fc.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("aj")
   public void method4575(classLW var1) {
      if (var1 != null) {
         ...
         if (var2 != null) {
            if (!var2.field4419.method6982(1270661639) && var2.field4426 != null) {
               classZR var3 = classZS.method14182(classUQ.method11465(var1, 1995815078).method14145(var2.field4426, (byte)2), (byte)89);
   ...
   @ObfuscatedName("af")
   public void method4576(classLW var1, byte var2) {
      try {
         if (var1 != null) {
            if (var2 == 2) {
            ...
            if (var3 != null) {
               ...
               if (!var3.field4419.method6982(1570032005)) {
                  ...
                  if (var3.field4426 != null) {
                     ...
                     classZR var4 = classZS.method14182(classUQ.method11465(var1, 19062755).method14145(var3.field4426, (byte)2), (byte)68);
         ...
         throw classEG.method3884(var5, "fc.af(" + ')');
      }
   }
   ...
   public void method4582(byte var1) {
      try {
            ...
            if (var2 != null) {
               if (var2.field4419.method6982(1936314001)) {
                  ...
                  if (null != var2.field4426) {
                     ...
                     classZR var4 = classZS.method14182(classUQ.method11465(var3, 873340457).method14145(var2.field4426, (byte)2), (byte)80);
                     client.field823.method9658(var4, 1697206599);
                  }
               }
         ...
         throw classEG.method3884(var5, "fc.ae(" + ')');
      }
   }
   ...
   public boolean vmethod446(int var1, byte var2) {
      try {
         if (this.field2203 == null) {
            ...
            classTT var3 = classLW.method7287(this.field2203, 1289741507);
            if (var3 == null) {
               if (var2 != 2) {
                  throw new IllegalStateException();
               } else {
         ...
         throw classEG.method3884(var4, "fc.ab(" + ')');
      }
   }
   ...
   public boolean vmethod447(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "fc.ag(" + ')');
      }
   }
   ...
   @ObfuscatedName("ky")
   public static void method4585(classCG var0) {
      ...
      if (this.field2203 == null) {
         ...
         if (var2 != null && var2.method6998((byte)-26)) {
            switch (var1) {
               ...
               case 65:
                  if (this.field2201) {
                     Clipboard var7 = classTQ.method10966(classOE.field4843, (byte)-77);
               ...
               case 66:
                  if (this.field2201) {
                     Clipboard var6 = classTQ.method10966(classOE.field4843, (byte)-97);
               ...
               case 67:
                  if (this.field2201) {
                     Clipboard var5 = classTQ.method10966(classOE.field4843, (byte)-22);
               ...
               case 84:
                  if (var2.method7018(1617848039) == 0) {
                     ...
                     classZR var4 = classZS.method14182(classUQ.method11465(this.field2203, 121484135).method14145(var3.field4428, (byte)2), (byte)14);
                     client.field823.method9658(var4, 1697206599);
   ...
   public boolean vmethod444(boolean var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "fc.ax(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZI)I")
   @ObfuscatedName("bf")
   static int method4590(int var0, classBL var1, boolean var2, int var3) {
      try {
         if (var0 == 5504) {
            if (var3 != -1165804573) {
               throw new IllegalStateException();
               ...
               int var7 = classBB.field323[classDY.field1679 * -324749371];
            ...
            if (var3 != -1165804573) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = client.field942.method11454(-2071860481);
               return 1;
            }
         } else if (var0 == 5506) {
            if (var3 != -1165804573) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = client.field994.method11454(-952996512);
               return 1;
            }
         } else if (var0 == 5530) {
            if (var3 != -1165804573) {
            ...
            if (var3 != -1165804573) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -184240077 * client.field840;
               return 1;
            }
         } else {
            return 2;
         ...
         throw classEG.method3884(var6, "fc.bf(" + 41);
      }
   }
   ...
   public boolean vmethod448(char var1, int var2) {
      try {
         if (this.field2203 == null) {
            ...
            if (null != var3) {
               ...
               if (var3.method6998((byte)-55)) {
                  classTT var4 = classLW.method7287(this.field2203, 1289741507);
                  if (var4 == null) {
                     return false;
                  }
         ...
         throw classEG.method3884(var5, "fc.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Llw;")
   @ObfuscatedName("ao")
   public classLW method4572() {
      return this.field2203;
   }

   @ObfuscatedSignature(descriptor = "()Llw;")
   @ObfuscatedName("al")
   public classLW method4573() {
      return this.field2203;
   }
   ...
   public void method4583() {
      if (null != this.field2203) {
         ...
         classLW var2 = this.field2203;
         this.field2203 = null;
         if (var1 != null) {
            if (var1.field4419.method6982(1037802945) && null != var1.field4426) {
               classZR var3 = classZS.method14182(classUQ.method11465(var2, -3732236).method14145(var1.field4426, (byte)2), (byte)60);
               client.field823.method9658(var3, 1697206599);
            }
   ...
   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("aq")
   public void method4577(classLW var1) {
      if (var1 != null) {
         if (this.field2203 != var1) {
         ...
         if (var2 != null) {
            if (!var2.field4419.method6982(1042511688) && var2.field4426 != null) {
               classZR var3 = classZS.method14182(classUQ.method11465(var1, 477128989).method14145(var2.field4426, (byte)2), (byte)30);
               client.field823.method9658(var3, 1697206599);
            }
   ...
   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("ad")
   public void method4578(classLW var1) {
      if (var1 != null) {
         if (this.field2203 != var1) {
         ...
         if (var2 != null) {
            if (!var2.field4419.method6982(1418404830) && var2.field4426 != null) {
               classZR var3 = classZS.method14182(classUQ.method11465(var1, -18973962).method14145(var2.field4426, (byte)2), (byte)17);
               client.field823.method9658(var3, 1697206599);
            }
   ...
   boolean method4588(int var1, byte var2) {
      try {
            ...
            if (var3 != null) {
               ...
               if (var3.method6998((byte)4)) {
                  switch (var1) {
                     ...
                     case 65:
                        if (this.field2201) {
                           Clipboard var9 = classTQ.method10966(classOE.field4843, (byte)-5);
                     ...
                     case 66:
                        if (this.field2201) {
                           ...
                           Clipboard var8 = classTQ.method10966(classOE.field4843, (byte)-34);
                     ...
                     case 67:
                        if (this.field2201) {
                           Clipboard var7 = classTQ.method10966(classOE.field4843, (byte)-79);
                     ...
                     case 84:
                        if (var3.method7018(-636173591) == 0) {
                           ...
                           classZR var5 = classZS.method14182(classUQ.method11465(this.field2203, 870533817).method14145(var4.field4428, (byte)2), (byte)38);
         ...
         throw classEG.method3884(var6, "fc.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("ay")
   public void method4579(classLW var1) {
      if (var1 != null) {
         if (this.field2203 != var1) {
         ...
         if (var2 != null) {
            if (!var2.field4419.method6982(982716387) && var2.field4426 != null) {
               classZR var3 = classZS.method14182(classUQ.method11465(var1, 594079630).method14145(var2.field4426, (byte)2), (byte)19);
               client.field823.method9658(var3, 1697206599);
            }
   ...
   public boolean vmethod439(int var1) {
      if (this.field2203 == null) {
         ...
         classTT var2 = classLW.method7287(this.field2203, 1289741507);
         if (var2 == null) {
            return false;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;)V")
   @ObfuscatedName("ap")
   public void method4580(classLW var1) {
      if (var1 != null) {
         if (this.field2203 != var1) {
         ...
         if (var2 != null) {
            if (!var2.field4419.method6982(1419512645) && var2.field4426 != null) {
               classZR var3 = classZS.method14182(classUQ.method11465(var1, 314397734).method14145(var2.field4426, (byte)2), (byte)109);
               client.field823.method9658(var3, 1697206599);
            }
   ...
   public static void method4584(classFC var0) {
      if (null != var0.field2203) {
         ...
         classLW var2 = var0.field2203;
         var0.field2203 = null;
         if (var1 != null) {
            if (var1.field4419.method6982(1264639224) && null != var1.field4426) {
               classZR var3 = classZS.method14182(classUQ.method11465(var2, -132233407).method14145(var1.field4426, (byte)2), (byte)81);
               client.field823.method9658(var3, 1697206599);
            }
   ...
   @ObfuscatedName("af")
   public static void method4586(classLW[] var0, classLW var1, boolean var2, classVV var3, classQN var4, int var5) {
      try {
         ...
         if (var1.field4340 != null) {
            ...
            classPP.method9086(var1.field4340, 0, var1.field4340.length - 1, var1.field4329 * -1163656551, -1, var6, var7, var2, var3, var4, 819056711);
         }
         ...
         if (-1 == var1.field4260 * 63131743) {
            ...
            classPK var8 = (classPK)var3.field6613.method13363(var1.field4329 * -1163656551);
            if (null != var8) {
               if (var5 == -1037162862) {
                  return;
               }
         ...
         throw classEG.method3884(var9, "fc.af(" + ')');
      }
   }
   ...
   static void method4589(String var0, StringBuilder var1, classQI var2, int var3, int var4) {
      try {
         ...
         if (var5.length == 1) {
            ...
            if (var5.length > 1) {
               ...
               if (var8.equals("spacer")) {
                  ...
                  classRA var34 = classBS.method1207(var8.substring("spacer_".length()), 763367599);
                  ...
                  classRA var33 = classBS.method1207(var8.substring("decimal_".length()), 633990357);
                  ...
                  classRA var31 = classBS.method1207(var8.substring("percent_".length()), -1110347053);
         ...
         throw classEG.method3884(var27, "fc.ae(" + ')');
      }
   }
}
