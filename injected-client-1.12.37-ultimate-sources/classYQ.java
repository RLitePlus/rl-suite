...
public final class classYQ {
   ...
   @ObfuscatedName("fv")
   public static void method13609(classWM var0) {
      if (var0 == null) {
         var0.getWorldMapData();
      }

      if (classWM.method12414(var0, 2104218553)) {
         ...
         classWM.method12403(var0, var1 + -1268315106 * var0.field6736, var0.field6738 * 1010414839 + var2, true, -2063968209);
   ...
   @ObfuscatedName("kv")
   public static void method13610(classYM var0, int var1, int var2, int var3, int var4, int var5) {
      if (var0 == null) {
         ...
         int var18 = var1 + var2 * classYM.field7102;
         int var15 = classYM.field7102 - var3;
         if (var2 + var4 > classYM.field7098) {
            var4 -= var2 + var4 - classYM.field7098;
         }

         if (var2 < classYM.field7096) {
            int var16 = classYM.field7096 - var2;
            var4 -= var16;
            var18 += var16 * classYM.field7102;
            var9 += var13 * var16;
         }

         if (var1 + var3 > classYM.field7099) {
            int var19 = var1 + var3 - classYM.field7099;
            var3 -= var19;
            var15 += var19;
         }

         if (var1 < classYM.field7097) {
            int var20 = classYM.field7097 - var1;
            var3 -= var20;
            var18 += var20;
            var8 += var12 * var20;
            var15 += var20;
         ...
         classYM.method13452(classYM.field7104, var0.field7005, 0, var8, var9, var18, var15, var3, var4, var12, var13, var6, var5);
      }
   }
