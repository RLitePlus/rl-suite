...
public interface classYH {
   ...
   @ObfuscatedName("ae")
   void vmethod656(Object var1, classXY var2, int var3);

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lbw;Lxy;I)V")
   @ObfuscatedName("vv")
   static void method13362(classBW var0, classXY var1, int var2) {
   ...
   @ObfuscatedName("ac")
   Object vmethod655(classXY var1);

   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/Object;")
   @ObfuscatedName("ax")
   Object vmethod654(classXY var1);

   @ObfuscatedSignature(descriptor = "(Lxy;B)Ljava/lang/Object;")
   @ObfuscatedName("af")
   Object vmethod653(classXY var1, byte var2);

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Object;Lxy;)V")
   @ObfuscatedName("aa")
   void vmethod657(Object var1, classXY var2);
}
