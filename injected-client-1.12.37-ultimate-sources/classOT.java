...
public class classOT {
   ...
   @ObfuscatedName("du")
   public static classVA field5117;

   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;I)V")
   @ObfuscatedName("af")
   static void method8731(classDZ var0, int var1, int var2, classUP var3, classKH var4, int var5) {
      try {
   ...
   @ObfuscatedName("ab")
   public static classYZ[] method8732(classVA var0, String var1, String var2, byte var3) {
      try {
         if (!classVA.method11853(var0, var1, var2, 1946412001)) {
            if (var3 <= 14) {
               throw new IllegalStateException();
            } else {
               return null;
