...
@ObfuscatedName("hd")
public abstract class classHD implements WorldMapIcon {
   ...
   boolean method5999(int var1, int var2, int var3) {
      try {
         if (!this.method5997((byte)-13)) {
            ...
            classPS var4 = classFJ.method4796(this.vmethod486((byte)-34), (byte)-12);
   ...
   @ObfuscatedName("ni")
   public static boolean method6000(classHD var0, int var1, int var2) {
      if (var0 == null) {
         var0.getType();
      }
      ...
      if (!var0.method5997((byte)-103)) {
         ...
         classPS var3 = classFJ.method4796(var0.vmethod486((byte)-114), (byte)-81);
   ...
   classHD(classKY var1, classKY var2) {
      this.field2770 = var1;
      this.field2769 = var2;
   }
   ...
   static final void method6003(byte var0) {
      try {
         if (!client.field959) {
            ...
            int var1 = classKY.method6612(classFB.field2199 * -1584251835, -1889906639);
            int var2 = classKY.method6612(-214044967 * classBI.field474, 1693229959);
