...
public class classZX {
   ...
   @ObfuscatedName("ap")
   public final void method14227(int var1, int var2, classYM var3, float var4) {
      int var5 = (int)(18.0F * var4);
      classYM var6 = this.method14219(var5, -339174694);
      int var7 = 1 + 2 * var5;
   ...
   void method14216(int var1, int var2) {
      try {
         ...
         classYM var13 = new classYM(var7, var3, var3);
         this.field7288.put(var1, var13);
      } catch (RuntimeException var12) {
         throw classEG.method3884(var12, "zx.af(" + ')');
      }
   }
   ...
   public final void method14220(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "zx.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lym;Lym;Luq;B)V")
   @ObfuscatedName("ax")
   void method14232(classYM var1, classYM var2, classUQ var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var11, "zx.ax(" + ')');
      }
   }
   ...
   public static void method14224(classZX var0, int var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "zx.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Lym;")
   @ObfuscatedName("ao")
   classYM method14217(int var1) {
      if (!this.field7288.containsKey(var1)) {
         this.method14216(var1, 2069481781);
      }

      return (classYM)this.field7288.get(var1);
   }

   @ObfuscatedSignature(descriptor = "(I)Lym;")
   @ObfuscatedName("aa")
   classYM method14218(int var1) {
      if (!this.field7288.containsKey(var1)) {
   ...
   @ObfuscatedName("ar")
   void method14233(classYM var1, classYM var2, classUQ var3) {
   ...
   @ObfuscatedSignature(descriptor = "(IILym;F)V")
   @ObfuscatedName("au")
   public final void method14228(int var1, int var2, classYM var3, float var4) {
      int var5 = (int)(18.0F * var4);
      classYM var6 = this.method14219(var5, 473429035);
      int var7 = 1 + 2 * var5;
      classUQ var8 = new classUQ(0, 0, var3.field7007, var3.field7009);
      classUQ var9 = new classUQ(0, 0);
   ...
   @ObfuscatedSignature(descriptor = "(IILym;F)V")
   @ObfuscatedName("ad")
   public final void method14229(int var1, int var2, classYM var3, float var4) {
      int var5 = (int)(18.0F * var4);
      classYM var6 = this.method14219(var5, 981780693);
      int var7 = 1 + 2 * var5;
      classUQ var8 = new classUQ(0, 0, var3.field7007, var3.field7009);
      classUQ var9 = new classUQ(0, 0);
   ...
   @ObfuscatedName("ae")
   classYM method14219(int var1, int var2) {
      try {
         if (!this.field7288.containsKey(var1)) {
            if (var2 <= -2122380289) {
               throw new IllegalStateException();
         ...
         throw classEG.method3884(var3, "zx.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lym;Lym;Luq;)V")
   @ObfuscatedName("ai")
   void method14234(classYM var1, classYM var2, classUQ var3) {
      if (0 != var3.field6370 * 518523273 && var3.field6371 * -874893249 != 0) {
         int var4 = 0;
         int var5 = 0;
         if (0 == var3.field6368 * -1357616065) {
   ...
   @ObfuscatedSignature(descriptor = "(Lym;Lym;Luq;)V")
   @ObfuscatedName("aw")
   void method14235(classYM var1, classYM var2, classUQ var3) {
      if (0 != var3.field6370 * 518523273 && var3.field6371 * -874893249 != 0) {
         int var4 = 0;
         int var5 = 0;
   ...
   @ObfuscatedName("ye")
   public static void method14230(classZX var0, int var1, int var2, classYM var3, float var4, int var5) {
      if (var0 == null) {
         var0.method14231(var1, var1, var3, var4, var1);
      } else {
         try {
            int var6 = (int)(18.0F * var4);
            classYM var7 = var0.method14219(var6, -1270092059);
            int var8 = 1 + 2 * var6;
            ...
            throw classEG.method3884(var16, "zx.as(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("as")
   public final void method14231(int var1, int var2, classYM var3, float var4, int var5) {
      try {
         int var6 = (int)(18.0F * var4);
         classYM var7 = this.method14219(var6, -1270092059);
         int var8 = 1 + 2 * var6;
         classUQ var9 = new classUQ(0, 0, var3.field7007, var3.field7009);
         classUQ var10 = new classUQ(0, 0);
