...
public class classDD {
   ...
   static final int method2984(long var0, String var2) {
      ...
      classXY var4 = new classXY(128);
      classXY var5 = new classXY(128);
      int[] var6 = new int[]{var3.nextInt(), var3.nextInt(), (int)(var0 >> 32), (int)var0};
      classXY.method12971(var4, 10, (byte)-68);
      ...
      classXY.method12971(var5, 10, (byte)-3);
      ...
      if (null != client.field944) {
         classXY.method13007(var5, client.field944, 0, client.field944.length, (byte)121);
      } else {
         byte[] var22 = classJL.method6392((byte)0);
         classXY.method13007(var5, var22, 0, var22.length, (byte)46);
      }
      ...
      classXY var8 = new classXY(var23);
      classXY.method12997(var8, var2, (short)24309);
      var8.field6955 = -1095856699 * var23;
      var8.method13126(var6, (byte)3);
      classXY var9 = new classXY(702114061 * var8.field6955 + 702114061 * var5.field6955 + 5 + 702114061 * var4.field6955);
      classXY.method12971(var9, 2, (byte)-121);
      classXY.method12971(var9, var4.field6955 * 702114061, (byte)-15);
      classXY.method13007(var9, var4.field6954, 0, var4.field6955 * 702114061, (byte)27);
      classXY.method12971(var9, 702114061 * var5.field6955, (byte)-22);
      classXY.method13007(var9, var5.field6954, 0, 702114061 * var5.field6955, (byte)71);
      var9.method12973(702114061 * var8.field6955, -1542382992);
      classXY.method13007(var9, var8.field6954, 0, var8.field6955 * 702114061, (byte)76);
      byte[] var11 = var9.field6954;
      ...
      try {
         ...
         var28.write("data2=" + classDN.method3435(var12, (byte)93) + "&dest=" + classDN.method3435("passwordchoice.ws", (byte)17));
         var28.flush();
         InputStream var29 = var27.getInputStream();
         var9 = new classXY(new byte[1000]);

         do {
            int var30 = var29.read(var9.field6954, var9.field6955 * 702114061, 1000 - var9.field6955 * 702114061);
            if (var30 == -1) {
               var28.close();
               var29.close();
               String var31 = new String(var9.field6954);
               if (var31.startsWith("OFFLINE")) {
                  ...
                  while (702114061 * var9.field6955 > 0 && 0 == var9.field6954[702114061 * var9.field6955 - 1]) {
                     var9.field6955 -= -1095856699;
                  }

                  String var32 = new String(var9.field6954, 0, var9.field6955 * 702114061);
                  if (classCG.method1495(var32, 1163143878)) {
            ...
            var9.field6955 += -1095856699 * var30;
         } while (var9.field6955 * 702114061 < 1000);
   ...
   static final int method2985(long var0, String var2) {
      Random var3 = new Random();
      classXY var4 = new classXY(1538782702);
      classXY var5 = new classXY(128);
      int[] var6 = new int[]{var3.nextInt(), var3.nextInt(), (int)(var0 >> 32), (int)var0};
      classXY.method12971(var4, 10, (byte)-20);
      ...
      classXY.method12971(var5, 10, (byte)-75);
      ...
      var5.method12981(var3.nextLong());
      if (null != client.field944) {
         classXY.method13007(var5, client.field944, 0, client.field944.length, (byte)59);
      } else {
         byte[] var22 = classJL.method6392((byte)0);
         classXY.method13007(var5, var22, 0, var22.length, (byte)34);
      }
      ...
      classXY var8 = new classXY(var23);
      classXY.method12997(var8, var2, (short)11012);
      var8.field6955 = -1095856699 * var23;
      var8.method13126(var6, (byte)28);
      classXY var9 = new classXY(-1332734761 * var8.field6955 + 606524701 * var5.field6955 + 5 + -917339784 * var4.field6955);
      classXY.method12971(var9, 2, (byte)-45);
      classXY.method12971(var9, var4.field6955 * 702114061, (byte)-93);
      classXY.method13007(var9, var4.field6954, 0, var4.field6955 * 702114061, (byte)96);
      classXY.method12971(var9, 702114061 * var5.field6955, (byte)-38);
      classXY.method13007(var9, var5.field6954, 0, -1684193283 * var5.field6955, (byte)32);
      var9.method12973(1205919196 * var8.field6955, -1542382992);
      classXY.method13007(var9, var8.field6954, 0, var8.field6955 * 702114061, (byte)91);
      byte[] var11 = var9.field6954;
      int var13 = var11.length;
      StringBuilder var14 = new StringBuilder();
      ...
      try {
         ...
         var27.setConnectTimeout(5000);
         OutputStreamWriter var28 = new OutputStreamWriter(var27.getOutputStream());
         var28.write("data2=" + classDN.method3435(var12, (byte)28) + "&dest=" + classDN.method3435("passwordchoice.ws", (byte)44));
         var28.flush();
         InputStream var29 = var27.getInputStream();
         var9 = new classXY(new byte[1000]);

         do {
            int var30 = var29.read(var9.field6954, var9.field6955 * -373900180, 1259992177 - var9.field6955 * -461319478);
            if (var30 == -1) {
               var28.close();
               var29.close();
               String var31 = new String(var9.field6954);
               if (var31.startsWith("OFFLINE")) {
                  ...
                  while (702114061 * var9.field6955 > 0 && 0 == var9.field6954[702114061 * var9.field6955 - 1]) {
                     var9.field6955 -= 2061856494;
                  }

                  String var32 = new String(var9.field6954, 0, var9.field6955 * 702114061);
                  if (classCG.method1495(var32, 1533628026)) {
            ...
            var9.field6955 += -1095856699 * var30;
         } while (var9.field6955 * 702114061 < -993687384);
   ...
   static void method2987(int var0) {
      try {
         for (classDW var1 = (classDW)classDW.field1645.method7915(); var1 != null; var1 = (classDW)classNN.method7924(classDW.field1645)) {
         ...
         throw classEG.method3884(var2, "dd.ar(" + ')');
      }
   }
   ...
   static final int method2986(long var0, String var2) {
      ...
      classXY var5 = new classXY(128);
      int[] var6 = new int[]{var3.nextInt(), var3.nextInt(), (int)(var0 >> 32), (int)var0};
      classXY.method12971(var4, 10, (byte)-128);
      ...
      classXY.method12971(var5, 10, (byte)-111);
      ...
      var5.method12981(var3.nextLong());
      if (null != client.field944) {
         classXY.method13007(var5, client.field944, 0, client.field944.length, (byte)91);
      } else {
         byte[] var22 = classJL.method6392((byte)0);
         classXY.method13007(var5, var22, 0, var22.length, (byte)111);
      }
      ...
      classXY var8 = new classXY(var23);
      classXY.method12997(var8, var2, (short)15815);
      var8.field6955 = -1095856699 * var23;
      var8.method13126(var6, (byte)91);
      classXY var9 = new classXY(702114061 * var8.field6955 + 702114061 * var5.field6955 + 5 + 702114061 * var4.field6955);
      classXY.method12971(var9, 2, (byte)-118);
      classXY.method12971(var9, var4.field6955 * 702114061, (byte)-84);
      classXY.method13007(var9, var4.field6954, 0, var4.field6955 * 702114061, (byte)110);
      classXY.method12971(var9, 702114061 * var5.field6955, (byte)-89);
      classXY.method13007(var9, var5.field6954, 0, 702114061 * var5.field6955, (byte)90);
      var9.method12973(702114061 * var8.field6955, -1542382992);
      classXY.method13007(var9, var8.field6954, 0, var8.field6955 * 702114061, (byte)65);
      byte[] var11 = var9.field6954;
      int var13 = var11.length;
      StringBuilder var14 = new StringBuilder();
      ...
      try {
         ...
         var27.setConnectTimeout(5000);
         OutputStreamWriter var28 = new OutputStreamWriter(var27.getOutputStream());
         var28.write("data2=" + classDN.method3435(var12, (byte)125) + "&dest=" + classDN.method3435("passwordchoice.ws", (byte)63));
         var28.flush();
         InputStream var29 = var27.getInputStream();
         var9 = new classXY(new byte[1000]);
         ...
         do {
            ...
            if (var30 == -1) {
               ...
               if (var31.startsWith("OFFLINE")) {
                  ...
                  String var32 = new String(var9.field6954, 0, var9.field6955 * 702114061);
                  if (classCG.method1495(var32, 483993095)) {
   ...
   public static final synchronized long method2983(int var0) {
      try {
         ...
         throw classEG.method3884(var3, "dd.az(" + ')');
      }
   }
   ...
   static classUL method2988(classUZ var0, int var1) {
      try {
         ...
         throw classEG.method3884(var6, "dd.as(" + ')');
      }
   }
   ...
   public static String method2992(String var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "dd.ae(" + ')');
      }
   }
}
