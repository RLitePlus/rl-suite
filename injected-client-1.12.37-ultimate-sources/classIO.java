...
public class classIO extends classHB {
   ...
   void vmethod500(classXY var1) {
      ...
      this.field3008 = classXY.method13039(var1, -346779531) * 870058123;
      this.field3007 = classXY.method13039(var1, -346779531) * -991622745;
   }
   ...
   void vmethod499(classIQ var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "io.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(B)Lwm;")
   @ObfuscatedName("ag")
   static classWM method6230(byte var0) {
      try {
         return client.field1125;
      } catch (RuntimeException var1) {
         throw classEG.method3884(var1, "io.ag(" + ')');
      }
   }
   ...
   void vmethod501(classXY var1) {
      ...
      this.field3008 = classXY.method13039(var1, -346779531) * 870058123;
      this.field3007 = classXY.method13039(var1, -346779531) * -1083626788;
   }
   ...
   void vmethod498(classXY var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "io.az(" + ')');
      }
   }
   ...
   static final void method6231(byte var0) {
      try {
         classJL var1 = classEF.method3849(classJS.FRIENDCHAT_JOIN_LEAVE, client.field795.field1535, (byte)46);
         classXY.method12971(var1.field3343, 0, (byte)-115);
         client.field795.method3367(var1, -1301097035);
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "io.gm(" + ')');
      }
   }
}
