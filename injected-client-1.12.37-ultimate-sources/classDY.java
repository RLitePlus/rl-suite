...
@ObfuscatedName("dy")
public class classDY extends classEE implements DynamicObject {
   ...
   protected boolean vmethod97() {
      ...
      if (null == var1) {
         ...
         classFX var2 = var1.method8594(this.field1666 * 480644337, -1904611005 * this.field1670, (int[][])null, 0, 0, 0, null, -1, -1135264680);
   ...
   protected boolean vmethod95(int var1) {
      try {
         ...
         if (null == var2) {
            ...
            classFX var3 = var2.method8594(this.field1666 * 480644337, -1904611005 * this.field1670, (int[][])null, 0, 0, 0, null, -1, -1135264680);
            if (var3 != null) {
               if (var1 == -702405562) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var4, "dy.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Lfx;")
   @ObfuscatedName("hu")
   public classFX method3714() {
      return this.method3713(null, classQR.field5603);
   }

   @ObfuscatedSignature(descriptor = "()Lfx;")
   @ObfuscatedName("iz")
   public classFX method3715() {
   ...
   @ObfuscatedName("mh")
   public classFX method3707(@Nullable rl21 param1) {
   ...
   public void method3710() {
      ...
      if (var1 != null) {
         ...
         int var7 = classOU.method8800(this.field1671, var6, classAT.field277);
   ...
   protected boolean vmethod96() {
      ...
      if (null == var1) {
         ...
         classFX var2 = var1.method8594(this.field1666 * -500462189, 540706257 * this.field1670, (int[][])null, 0, 0, 0, null, -1, -1135264680);
         return var2 != null && null != var2.field2444;
      }
   }
   ...
   protected boolean vmethod94() {
      ...
      if (null == var1) {
         ...
         classFX var2 = var1.method8594(this.field1666 * 1029319934, -1904611005 * this.field1670, (int[][])null, 0, 0, 0, null, -1, -1135264680);
         return var2 != null && null != var2.field2444;
      }
   }
   ...
   protected int vmethod98(int var1) {
      try {
         ...
         throw classEG.method3884(var3, "dy.ag(" + 41);
      }
   }
   ...
   @ObfuscatedName("xg")
   public classFX method3713(@Nullable rl21 param1, classQR nullx) {
   ...
   classDY(classDZ var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, classEE var10) {
      this.field1667 = var1.field1689;
      if (var10 instanceof classDY) {
         this.field1665 = ((classDY)var10).field1665;
         this.field1669 = ((classDY)var10).field1669;
      }
      ...
      if (var8 != -1) {
         ...
         classOU var11 = this.field1671.method9731((byte)124);
   ...
   static void method3705(long[] var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var6, "dy.bc(" + ')');
      }
   }
}
