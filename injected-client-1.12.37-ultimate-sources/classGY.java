...
public class classGY {
   ...
   @ObfuscatedName("ir")
   public static int method5950(classWM var0) {
      return var0.field6744 == null ? -1 : var0.field6738 * 1010414839 + classGX.method5880(var0.field6744, (short)-15363) * 64;
   }
   ...
   static final int method5922(long var0, String var2, byte var3) {
      try {
         ...
         try {
            ...
            var30.write("data2=" + classDN.method3435(var13, (byte)60) + "&dest=" + classDN.method3435("passwordchoice.ws", (byte)17));
            var30.flush();
            ...
            do {
               ...
               if (var32 == -1) {
                  ...
                  if (var33.startsWith("OFFLINE")) {
                     ...
                     if (classCG.method1495(var34, 1385240717)) {
                        if (var3 >= 0) {
                           throw new IllegalStateException();
                        } else {
