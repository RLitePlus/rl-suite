...
public class classCI implements Comparator {
   ...
   @ObfuscatedName("yp")
   public static void method1505(classDH var0) {
   ...
   @ObfuscatedName("tv")
   public static void method1503(classPZ var0) {
   ...
   @ObfuscatedName("aq")
   static final void method1518(classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6, classGC var7, int var8) {
      ...
      if (var6 == 22) {
         ...
         if (var29) {
            ...
            if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
               var54 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
            } else {
               classDY var67 = new classDY(var0, var4, 22, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
               var67.field1667 = var10;
               var54 = var67;
            }

            var10.method4518(var1, var2, var3, var22, (classEE)var54, var26, var28);
         ...
         Object var40;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var40 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var55 = new classDY(var0, var4, var6, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var55.field1667 = var10;
            var40 = var55;
         }

         var10.method4513(var1, var2, var3, var22, 1, 1, (classEE)var40, 0, var26, var28);
         ...
         Object var53;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var53 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, 10, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var65 = new classDY(var0, var4, 10, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var65.field1667 = var10;
            var53 = var65;
         }

         if (var53 != null && var10.method4513(var1, var2, var3, var22, var12, var13, (classEE)var53, var6 == 11 ? 256 : 0, var26, var28) && var11.field4938) {
            int var66 = 15;
            if (var53 instanceof classFX) {
               classFX var73 = (classFX)var53;
         ...
         Object var41;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var41 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var56 = new classDY(var0, var4, 0, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var56.field1667 = var10;
            var41 = var56;
         }

         var10.method4524(var1, var2, var3, var22, (classEE)var41, null, 1 << var5, 0, var26, var28);
         if (var5 == 0) {
            if (var11.field4938) {
         ...
         Object var52;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var52 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var64 = new classDY(var0, var4, var6, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var64.field1667 = var10;
            var52 = var64;
         }

         var10.method4524(var1, var2, var3, var22, (classEE)var52, null, 16 << var5, 0, var26, var28);
         if (var11.field4938) {
            if (var5 == 0) {
               var9.field5777[var1][var18][var19 + 1] = 50;
            } else if (var5 == 1) {
         ...
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            ...
            classDY var32 = new classDY(var0, var4, 2, var5 + 4, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            classDY var33 = new classDY(var0, var4, 2, var42, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var32.field1667 = var33.field1667 = var10;
            var57 = var32;
            var68 = var33;
         }

         var10.method4524(var1, var2, var3, var22, (classEE)var68, (classEE)var57, 1 << var5, 1 << var42, var26, var28);
         if (var11.field4950) {
            if (var5 == 0) {
               var9.field5776[var1][var18][var19] = var9.field5776[var1][var18][var19] | 585;
               var9.field5776[var1][var18][var19 + 1] = var9.field5776[var1][var18][var19 + 1] | 1170;
         ...
         Object var43;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var43 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var58 = new classDY(var0, var4, var6, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var58.field1667 = var10;
            var43 = var58;
         }

         var10.method4513(var1, var2, var3, var22, 1, 1, (classEE)var43, 0, var26, var28);
         if (var11.field4946 * -2040437663 != 0 && var7 != null && var20) {
            var7.method5386(var2, var3, var12, var13, var11.field4947);
         }
         ...
         Object var44;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var44 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, var6, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var59 = new classDY(var0, var4, 4, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var59.field1667 = var10;
            var44 = var59;
         }

         var10.method4504(var1, var2, var3, var22, (classEE)var44, null, 1 << var5, 0, classDI.field1507[var5], classDI.field1508[var5], 0, 0, var26, var28);
      } else if (var6 == 5) {
         int var45 = 16;
         classFE var60 = var10.method4501(var1, var2, var3);
         if (var60 != null) {
         ...
         Object var69;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var69 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, 4, var5, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var75 = new classDY(var0, var4, 4, var5, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var75.field1667 = var10;
            var69 = var75;
         }

         var10.method4504(
            var1, var2, var3, var22, (classEE)var69, null, 1 << var5, 0, var45 * classDI.field1507[var5], var45 * classDI.field1508[var5], 0, 0, var26, var28
         );
      } else if (var6 == 6) {
         int var47 = 8;
         classFB var61 = var10.method4519(var1, var2, var3);
         if (var61 != null) {
         ...
         Object var70;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var70 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, 4, var5 + 4, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var76 = new classDY(var0, var4, 4, var5 + 4, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var76.field1667 = var10;
            var70 = var76;
         }

         var10.method4504(
            var1, var2, var3, var22, (classEE)var70, null, 256, var5, var47 * classDI.field1509[var5], var47 * classDI.field1510[var5], 0, 0, var26, var28
         );
      } else if (var6 == 7) {
         int var49 = var5 + 2 & 3;
         Object var62;
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            var62 = client.method2267(var0.field1689, var10, var11, var21, var6, var5, 4, var49 + 4, var1, var2, var3, var23, var22, var24);
         } else {
            classDY var71 = new classDY(var0, var4, 4, var49 + 4, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            var71.field1667 = var10;
            var62 = var71;
         }

         var10.method4504(var1, var2, var3, var22, (classEE)var62, null, 256, var49, classDI.field1509[var49], classDI.field1510[var49], 0, 0, var26, var28);
      } else if (var6 == 8) {
         int var50 = 8;
         classFB var63 = var10.method4519(var1, var2, var3);
         if (var63 != null) {
         ...
         if (var11.field4951 * -1542230501 == -1 && var11.field4930 == null) {
            ...
            classDY var34 = new classDY(var0, var4, 4, var5 + 4, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
            classDY var35 = new classDY(var0, var4, 4, var72 + 4, var1, var2, var3, var11.field4951 * -1542230501, var11.field4964, null);
   ...
   static void method1506(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         classCM.field1165 = -1152046927 * var5;
         ...
         classEO.field1811 = (var5 - var2) / 2 * -1577570207;
         ...
         classEV.field1943 = Math.abs(-1947307103 * classEO.field1811) * -36859613;
   ...
   static void method1507(int var0, byte var1) {
      ...
      try {
         ...
         if (var0 == -3) {
            ...
            classSP.method10624(classKK.field3708, classKK.field3653, classKK.field3811, (byte)-26);
         } else if (var0 == -2) {
            if (var1 <= 0) {
               throw new IllegalStateException();
            }

            classSP.method10624(classKK.field3737, classKK.field3920, classKK.field3789, (byte)-61);
         } else if (var0 == -1) {
            if (var1 <= 0) {
               throw new IllegalStateException();
            }

            classSP.method10624(classKK.field3699, classKK.field3687, classKK.field3660, (byte)-5);
         } else if (var0 == 3) {
            ...
            classSP.method10624(classKK.field3664, classKK.field3665, classKK.field3666, (byte)-55);
         } else if (68 == var0) {
            if (var1 <= 0) {
               return;
            }
            ...
            classSP.method10624(classKK.field3667, classKK.field3668, classKK.field3611, (byte)-60);
         } else {
            if (!client.field890) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               ...
               if (var0 == 6) {
                  ...
                  classSP.method10624(classKK.field3667, classKK.field3668, classKK.field3611, (byte)-66);
                  return;
               }
            }

            if (var0 == 7) {
               classSP.method10624(classKK.field3670, classKK.field3671, classKK.field3748, (byte)-16);
            } else if (var0 == 8) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3673, classKK.field3674, classKK.field3675, (byte)-8);
            } else if (9 == var0) {
               classSP.method10624(classKK.field3676, classKK.field3704, classKK.field3678, (byte)-103);
            } else if (10 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3835, classKK.field3680, classKK.field3681, (byte)-41);
            } else if (11 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3624, classKK.field3683, classKK.field3684, (byte)-16);
            } else if (12 == var0) {
               if (var1 <= 0) {
                  return;
               }

               classSP.method10624(classKK.field3685, classKK.field3686, classKK.field3738, (byte)-89);
               ...
               classSP.method10624(classKK.field3661, classKK.field3915, classKK.field3690, (byte)-121);
            } else if (14 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3691, classKK.field3692, classKK.field3731, (byte)-49);
            } else if (var0 == 16) {
               if (var1 <= 0) {
                  return;
               }

               classSP.method10624(classKK.field3694, classKK.field3695, classKK.field3696, (byte)-113);
               ...
               classSP.method10624(classKK.field3808, classKK.field3698, classKK.field3905, (byte)-113);
            } else if (var0 == 18) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }
               ...
               classSP.method10624(classKK.field3703, classKK.field3614, classKK.field3705, (byte)-121);
            } else if (var0 == 20) {
               if (var1 <= 0) {
                  return;
               }

               classSP.method10624(classKK.field3627, classKK.field3707, classKK.field3659, (byte)-6);
            } else if (22 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3729, classKK.field3914, classKK.field3810, (byte)-115);
            } else if (var0 == 23) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3712, classKK.field3693, classKK.field3714, (byte)-4);
            } else if (24 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3715, classKK.field3716, classKK.field3717, (byte)-20);
            } else if (25 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3718, classKK.field3719, classKK.field3720, (byte)-81);
            } else if (var0 == 26) {
               classSP.method10624(classKK.field3721, classKK.field3722, classKK.field3723, (byte)-75);
            } else if (var0 == 27) {
               classSP.method10624(classKK.field3724, classKK.field3725, classKK.field3726, (byte)-50);
            } else if (31 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3733, classKK.field3791, classKK.field3848, (byte)-38);
            } else if (var0 == 32) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }
               ...
               classSP.method10624(classKK.field3739, classKK.field3740, classKK.field3828, (byte)-20);
            } else if (var0 == 38) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3742, classKK.field3743, classKK.field3744, (byte)-56);
            } else if (var0 == 74) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3873, classKK.field3876, classKK.field3746, (byte)-4);
            } else if (55 == var0) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }
               ...
               classSP.method10624(classKK.field3752, classKK.field3753, classKK.field3754, (byte)-9);
            } else if (var0 == 57) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624(classKK.field3755, classKK.field3756, classKK.field3757, (byte)-1);
            } else if (var0 == 61) {
               if (var1 <= 0) {
                  throw new IllegalStateException();
               }

               classSP.method10624("", "Please enter your date of birth (DD/MM/YYYY)", "", (byte)-63);
               classAC.method326(7, 2133821696);
            } else if (var0 == 62) {
               classSP.method10624(classKK.field3758, classKK.field3761, classKK.field3760, (byte)-85);
            } else if (63 == var0) {
               classSP.method10624(classKK.field3833, classKK.field3711, classKK.field3764, (byte)-38);
            } else {
               if (var0 != 65) {
                  if (var1 <= 0) {
                     throw new IllegalStateException();
                  ...
                  if (67 != var0) {
                     if (var0 == 71) {
                        ...
                        classSP.method10624(classKK.field3672, classKK.field3773, classKK.field3863, (byte)-101);
                        return;
                     } else {
                        if (var0 == 72) {
                           if (var1 <= 0) {
                           ...
                           classSP.method10624(classKK.field3652, classKK.field3734, classKK.field3770, (byte)-35);
                        }
               ...
               classSP.method10624(classKK.field3765, classKK.field3766, classKK.field3767, (byte)-99);
            }
         }
      } catch (RuntimeException var2) {
   ...
   @ObfuscatedName("cp")
   static void method1508(classDZ var0, int var1, classFX var2, byte var3) {
      try {
         short var4 = 512;
         ...
         classEZ.method4477(var0.field1689, -483624883 * var0.field1710, var8, var12, client.field884 * -452033647, 60, var2, var1, var13, false);
