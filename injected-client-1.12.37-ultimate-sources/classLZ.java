...
public class classLZ {
   ...
   @ObfuscatedName("az")
   public void method7399(int var1, classLW var2, int var3, int var4) {
      try {
         this.field4451 = var2;
         this.field4449 = 0;
         this.field4446 = 0;
               ...
               if (var2 != null) {
                  ...
                  if (var2.field4340 != null) {
                     if (var1 == 0) {
                        ...
                        classLW[] var5 = var2.field4340;

                        for (int var6 = 0; var6 < var5.length; var6++) {
                           classLW var7 = var5[var6];
                           if (null != var7) {
                              if (var4 != 1453250184) {
                                 throw new IllegalStateException();
                              }
         ...
         throw classEG.method3884(var8, "lz.az(" + ')');
      }
   }
   ...
   public int method7420(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "lz.as(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;ZI)V")
   @ObfuscatedName("ae")
   final void method7406(classLW var1, boolean var2, int var3) {
      try {
         int var10000;
         ...
         for (int var6 = var4; var6 <= var5; var6++) {
            ...
            classLW var7 = this.field4451.field4340[var6];
            if (null != var7) {
               if (var3 >= -179907272) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var8, "lz.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("ou")
   public static void method7407(classLZ var0, classLW var1, boolean var2) {
      ...
      for (int var5 = var3; var5 <= var4; var5++) {
         classLW var6 = var0.field4451.field4340[var5];
   ...
   @ObfuscatedName("sh")
   public static void method7426(classXY var0, int[] var1, int var2, int var3) {
      int var4 = var0.field6955 * 702114061;
      var0.field6955 = var2 * -1095856699;
      ...
      var0.field6955 = var4 * -1095856699;
   }

   @ObfuscatedSignature(descriptor = "(I)Llw;")
   @ObfuscatedName("ag")
   public classLW method7415(int var1) {
      try {
         ...
         throw classEG.method3884(var3, "lz.ag(" + ')');
      }
   }
   ...
   @ObfuscatedName("ao")
   public void method7400(int var1, classLW var2, int var3) {
      this.field4451 = var2;
      this.field4449 = 0;
      this.field4446 = 0;
      if (var1 >= 0 && var1 < 3) {
   ...
   @ObfuscatedSignature(descriptor = "(ILlw;I)V")
   @ObfuscatedName("aa")
   public void method7401(int var1, classLW var2, int var3) {
      this.field4451 = var2;
      this.field4449 = 0;
      this.field4446 = 0;
      if (var1 >= 0 && var1 < 3) {
   ...
   public void method7424(int var1, Object var2, Object var3, byte var4) {
      try {
         ...
         for (int var7 = 0; var7 < var6; var7++) {
            classLW var8 = this.field4451.field4340[var5[var7]];
            if (null != var8) {
               if (var4 >= 71) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var10, "lz.ac(" + ')');
      }
   }
   ...
   final void method7403(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "lz.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;Z)V")
   @ObfuscatedName("ad")
   final void method7408(classLW var1, boolean var2) {
      ...
      for (int var5 = var3; var5 <= var4; var5++) {
         classLW var6 = this.field4451.field4340[var5];
         if (null != var6 && var6.field4263 * 653784551 == var1.field4260 * 63131743) {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;Z)V")
   @ObfuscatedName("ap")
   final void method7409(classLW var1, boolean var2) {
      int var3 = var1 == this.field4451 ? 0 : var1.field4265 * -1210177335;
   ...
   static String method7427(String var0, boolean var1, int var2) {
      try {
         ...
         return var3 + var0 + "." + var5 + "/l=" + classLU.field4232 + "/a=" + classBS.field570 * 606350751 + var4 + "/";
      } catch (RuntimeException var6) {
         throw classEG.method3884(var6, "lz.gx(" + ')');
      }
   }
   ...
   public static int method7412(classLZ var0, int var1) {
      ...
      try {
         ...
         throw classEG.method3884(var2, "lz.ab(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "()Llw;")
   @ObfuscatedName("av")
   public classLW method7416() {
   ...
   @ObfuscatedName("si")
   public static classLW method7417(classLZ var0) {
      if (var0 == null) {
         var0.method7422();
      }
   ...
   public static void method7425(classLZ var0, int var1, Object var2, Object var3) {
      ...
      for (int var6 = 0; var6 < var5; var6++) {
         classLW var7 = var0.field4451.field4340[var4[var6]];
         if (null != var7) {
   ...
   public int[] method7423(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "lz.ax(" + ')');
      }
   }
