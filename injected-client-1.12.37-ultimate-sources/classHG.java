...
public class classHG {
   ...
   public static void method6008(int var0) {
      try {
         classJZ.method6431(classPX.field5475);
         classJZ.method6431(classPX.field5476);
   ...
   static final void method6011(byte var0) {
      try {
         for (classCG var2 : classCN.field1174) {
         ...
         if (null != classIB.field2935) {
            ...
            classRW.method10327(classIB.field2935, 853246097);
         }
