...
@ObfuscatedName("tg")
public final class classTG extends classYD implements MainBufferProvider {
   @ObfuscatedName("af")
   Component field6135;
   @ObfuscatedName("pk")
   ...
   @ObfuscatedName("mw")
   public static Object method10808(classYY var0, classXY var1) {
   ...
   final void method10805(Graphics var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.method3884(var7, "tg.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("gc")
   public static void method10807(classDJ var0) {
      if (var0 == null) {
         var0.method3366();
      }
   ...
   @ObfuscatedName("si")
   public static void method10802(classTG var0, Component var1, byte var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var3, "tg.az(" + ')');
         }
      }
   }
   ...
   public final void vmethod578(int var1, int var2, byte var3) {
      if (this.field6136 == null) {
         Canvas var4 = (Canvas)this.method10810();
         this.field6136 = var4.getGraphics();
      }

      classOE.field4843.getCallbacks().draw(this, this.field6136, var1, var2);
   }
