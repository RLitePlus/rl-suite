...
public final class classRJ {
   ...
   @ObfuscatedName("ae")
   final classPZ field5676;
   @ObfuscatedSignature(descriptor = "Lpz;")
   @ObfuscatedName("ab")
   final classPZ field5678;
   @ObfuscatedName("az")
   ...
   @ObfuscatedName("nj")
   public static void method9997(classCY var0, int var1) {
      if (var0 == null) {
         var0.method2779();
      }
               ...
               if (!classFM.method4846(var6, (byte)-33)) {
                  ...
                  if (classMH.method7572((byte)11) != 0) {
                     ...
                     for (int var8 = 0; var8 < var0.size(); var8++) {
                        ...
                        var7.add(new classNB(classFC.field2208, (Integer)var0.get(var8), 0, classMH.method7572((byte)11), false));
                     }
   ...
   classRJ(long var1, int var3, classRB var4) {
      ...
      if (-1 == -456314879 * this.field5675) {
         ...
         this.field5676 = new classPZ(64, this.field5674);
         this.field5678 = null;
      } else {
         ...
         this.field5676 = new classPZ(-456314879 * this.field5675, this.field5674);
         this.field5678 = new classPZ(this.field5675 * -456314879);
      }
   }
