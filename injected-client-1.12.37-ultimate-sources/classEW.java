...
@ObfuscatedName("ew")
public final class classEW extends classVQ implements Tile {
   ...
   @ObfuscatedName("ax")
   classFB[] field1951 = new classFB[5];
   @ObfuscatedName("ac")
   int field1958;
   @ObfuscatedName("aa")
   ...
   @ObfuscatedName("az")
   public classEO method4088(int var1) {
      try {
   ...
   @ObfuscatedSignature(descriptor = "()[Lfb;")
   @ObfuscatedName("eg")
   public classFB[] method4097() {
      return this.field1951;
   }

   @ObfuscatedSignature(descriptor = "()Lfj;")
   @ObfuscatedName("zu")
   public classFJ method4098() {
      return this.field1972;
   }

   @ObfuscatedSignature(descriptor = "()Leo;")
   @ObfuscatedName("ae")
   public classEO method4089() {
      return this.field1967;
   }
   ...
   public void setGroundObject(GroundObject var1) {
      this.field1967 = (classEO)var1;
   }

   @ObfuscatedSignature(descriptor = "()Leo;")
   @ObfuscatedName("nw")
   public classEO method4099() {
      return this.field1967;
   }
   ...
   @ObfuscatedSignature(descriptor = "()Leo;")
   @ObfuscatedName("ab")
   public classEO method4090() {
      return this.field1967;
   }

   public void setSceneTileModel(SceneTileModel var1) {
      this.field1973 = (classFN)var1;
   }

   @ObfuscatedSignature(descriptor = "()Leo;")
   @ObfuscatedName("ag")
   public classEO method4091() {
      return this.field1967;
   }

   @ObfuscatedSignature(descriptor = "()Leq;")
   @ObfuscatedName("vd")
   public classEQ method4102() {
