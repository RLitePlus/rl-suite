...
@ObfuscatedName("yz")
public final class classYZ extends classYW implements IndexedSprite {
   @ObfuscatedName("ae")
      ...
      if (this.field7121 != this.field7124 || this.field7119 != this.field7120) {
         ...
         for (int var3 = 0; var3 < this.field7119; var3++) {
            for (int var4 = 0; var4 < this.field7121; var4++) {
               var1[var4 + this.field7122 + (var3 + this.field7123) * this.field7124] = this.field7125[var2++];
            }
         }
   ...
   public void method13805(int var1, int var2, int var3) {
      for (int var4 = 0; var4 < this.field7126.length; var4++) {
         int var5 = this.field7126[var4] >> 16 & 0xFF;
         var5 += var1;
         if (var5 < 0) {
            var5 = 0;
         } else if (var5 > 255) {
         ...
         int var6 = this.field7126[var4] >> 8 & 0xFF;
         var6 += var2;
         if (var6 < 0) {
            var6 = 0;
         } else if (var6 > 255) {
         ...
         int var7 = this.field7126[var4] & 0xFF;
         var7 += var3;
         if (var7 < 0) {
            var7 = 0;
         } else if (var7 > 255) {
         ...
         this.field7126[var4] = (var5 << 16) + (var6 << 8) + var7;
      }
   }
   ...
   public void method13812(int var1, int var2, int var3, int var4) {
      ...
      method13798(field7104, this.field7125, this.field7126, var7, var8, var17, var14, var3, var4, var11, var12, var5);
   }
   ...
   public void method13806(int var1, int var2, int var3) {
      for (int var4 = 0; var4 < this.field7126.length; var4++) {
         int var5 = this.field7126[var4] >> 16 & -33093298;
         var5 += var1;
         if (var5 < 0) {
            var5 = 0;
         } else if (var5 > 255) {
   ...
   public void method13809(int var1, int var2) {
      ...
      if (var6 > 0 && var5 > 0) {
         method13793(field7104, this.field7125, this.field7126, var4, var3, var6, var5, var7, var8);
      }
   }
   ...
   @ObfuscatedName("sb")
   public static void method13810(classYZ var0, int var1, int var2) {
      if (var0 == null) {
         ...
         if (var6 > 0 && var5 > 0) {
            method13793(field7104, var0.field7125, var0.field7126, var4, var3, var6, var5, var7, var8);
         }
      }
   }
