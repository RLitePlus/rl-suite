...
public class classBZ {
   ...
   static boolean method1381(int var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "bz.az(" + ')');
      }
   }
   ...
   void method1378(classBZ var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "bz.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILxs;B)V")
   @ObfuscatedName("ae")
   void method1382(int var1, classXS var2, byte var3) {
      try {
         ...
         switch (-1494362127 * this.field624.field4230) {
            ...
            case 3:
               ...
               this.field632 = classXY.method13110(var2, -324749371) * 2126001287;
               this.field629 = var2.method13094((short)17673) * -1502303207;
         }
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "bz.ae(" + ')');
      }
   }
   ...
   void method1386(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "bz.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("aa")
   void method1383(int var1, classXS var2) {
      ...
      switch (-1253733206 * this.field624.field4230) {
         ...
         case 3:
            ...
            this.field632 = classXY.method13110(var2, -324749371) * 1568671516;
   ...
   static String method1390(int var0, int var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.method3884(var10, "bz.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("mb")
   public static void method1384(classBZ var0, int var1, classXS var2) {
      if (var0 == null) {
         var0.method1387();
      } else {
         ...
         switch (300470661 * var0.field624.field4230) {
            ...
            case 3:
               ...
               var0.field632 = classXY.method13110(var2, -324749371) * 2126001287;
   ...
   @ObfuscatedName("ag")
   public static void method1391(classXY var0, int var1, int var2) {
      try {
         if (classME.field4490 != null) {
            ...
            try {
               ...
               classME.field4490.method153(var0.field6954, var1, 24, -1523322060);
            } catch (Exception var4) {
            }
         }
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "bz.ag(" + ')');
      }
   }
   ...
   public static int method1385(int var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "bz.aa(" + 41);
      }
   }
}
