...
public class classCO extends classVQ {
   ...
   void method2559(int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         if (null != var6) {
            classNV.method8150(new classCV(var1, var2, var3, var4), var6);
            if (var7 >= 4) {
               if (var5 <= 1) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var9, "co.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Lpx;")
   @ObfuscatedName("bv")
   public classPX method2568() {
   ...
   classCV method2562(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var5, "co.af(" + ')');
      }
   }
   ...
   static void method2567(byte var0) {
      try {
         ...
         throw classEG.method3884(var1, "co.ht(" + ')');
      }
   }
   ...
   void method2560(int var1, int var2, int var3, int var4) {
      ...
      if (null == var5) {
         ...
         classNV.method8150(new classCV(var1, var2, var3, var4), var5);
         if (var6 >= 4) {
            this.field1176.method8167().vmethod398();
         }
      }
   ...
   boolean method2566(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "co.ae(" + ')');
      }
   }
   ...
   public static int method2558(int var0, int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "co.az(" + 41);
      }
   }
}
