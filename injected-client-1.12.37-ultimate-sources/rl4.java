...
public class rl4 implements Runnable {
   ...
   @ObfuscatedName("hj")
   public final classDZ field5771;
   @ObfuscatedName("lj")
   ...
   @ObfuscatedName("ey")
   public classJZ field5757;
   @ObfuscatedName("to")
   public final int[][][] field5776;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ne")
   public classJZ field5756 = new classJZ(64);
   @ObfuscatedName("zz")
   ...
   public rl4(DrawCallbacks var1, int var2, classDZ var3, classXK var4) {
      this.field5757 = new classJZ(64);
                  ...
                  if (var57 >= 1
                     ...
                     if (var60 > 0 || var14 > 0) {
                        ...
                        if (var14 == 0) {
                           ...
                           int var31;
                           if (var29 >= 0) {
                              var31 = classRS.field5839.getDefaultColor(var29);
                              var30 = -1;
   ...
   @ObfuscatedName("if")
   public static void method10108(classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6, classGC var7) {
   ...
   public void method10103(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      classGC var11 = this.field5793[var2];
   ...
   @ObfuscatedName("wo")
   public void method10088(classDZ var1, byte[] var2, int var3, int var4, classGC[] var5) {
   ...
   @ObfuscatedName("bw")
   public void method10099(classDZ var1, byte[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, classGC[] var10) {
   ...
   public boolean method10093() {
      ...
      if (var2 > 0) {
         ...
         if (!var27) {
            ...
            this.field5793 = new classGC[4];

            for (int var29 = 0; var29 < 4; var29++) {
               this.field5793[var29] = new classGC(this.field5760, this.field5761, !this.field5771.isTopLevel());
            }
   ...
   @ObfuscatedName("jl")
   public void method10092(byte[] var1, int var2, int var3, int var4, int var5, classGC[] var6) {
      assert var6 != null;
