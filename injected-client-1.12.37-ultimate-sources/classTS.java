...
public class classTS {
   ...
   @ObfuscatedName("ae")
   public static final classYM method11127(byte[] var0) {
      ...
      try {
         ...
         if (var1 != null) {
            ...
            var5.grabPixels();
            return new classYM(var4, var10, var3);
         }
   ...
   @ObfuscatedSignature(descriptor = "([B)Lym;")
   @ObfuscatedName("af")
   public static final classYM method11128(byte[] var0) {
      BufferedImage var1 = null;
   ...
   @ObfuscatedSignature(descriptor = "([B)Lym;")
   @ObfuscatedName("ab")
   public static final classYM method11129(byte[] var0) {
      BufferedImage var1 = null;
   ...
   @ObfuscatedSignature(descriptor = "([B)Lym;")
   @ObfuscatedName("ag")
   public static final classYM method11130(byte[] var0) {
      BufferedImage var1 = null;
