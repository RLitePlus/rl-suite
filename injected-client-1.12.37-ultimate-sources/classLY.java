...
public class classLY {
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("aa")
   classJZ field4430 = new classJZ(200);
   @ObfuscatedSignature(descriptor = "Lva;")
   @ObfuscatedName("ae")
   classVA field4439;
   @ObfuscatedSignature(descriptor = "Ljz;")
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ao")
   classJZ field4431 = new classJZ(50);
   @ObfuscatedSignature(descriptor = "Lrj;")
   @ObfuscatedName("aq")
   classRJ field4436;
   @ObfuscatedName("rj")
   ...
   public void method7392() {
      classJZ.method6431(this.field4430);
      classJZ.method6431(this.field4431);
      classJZ.method6431(this.field4429);
      classJZ.method6431(this.field4432);
   }
            ...
            if (var1 >= 0) {
               if (var1 < var0.field4440.length) {
                  ...
                  if (null == var0.field4440[var1]) {
                     ...
                     var0.field4440[var1] = new classLW[var3];
                  }
                     ...
                     if (null == var0.field4440[var1][var4]) {
                        ...
                        if (null != var5) {
                           ...
                           if (-1 == var5[0]) {
                              ...
                              classLW.method7170(var6, new classXY(var5), (byte)-16);
                           }
                  ...
                  for (int var9 = 0; var9 < var3; var9++) {
                     classLW var10 = var0.field4440[var1][var9];
                     if (null != var10) {
                        if (var2 <= -324749371) {
                           throw new IllegalStateException();
                        }
                        ...
                        if (-1502647899 * var10.field4342 != -1) {
                           ...
                           classLW var11 = var0.field4440[var1][-1502647899 * var10.field4342 & 65535];
   ...
   @ObfuscatedName("lf")
   public classLW method7397(int var1) {
         ...
         if (this.field4433[var1]) {
            ...
            if (var2 == 0) {
               ...
               if (null == this.field4440[var1]) {
                  this.field4440[var1] = new classLW[var2];
               }
               ...
               for (int var7 = 0; var7 < var2; var7++) {
                  classLW var8 = this.field4440[var1][var7];
                  if (null != var8 && -1502647899 * var8.field4342 != -1) {
                     classLW var9 = this.field4440[var1][-1502647899 * var8.field4342 & -2043971647];
   ...
   @ObfuscatedName("ax")
   public classLW method7377(int var1, int var2) {
      classLW var3 = method7375(this, var1, (byte)88);
      if (-1 == var2) {
         return var3;
      } else {
   ...
   @ObfuscatedName("jg")
   public static classLW method7378(classLY var0, int var1, int var2, byte var3) {
      if (var0 == null) {
         var0.method7380(var1, var1, var3);
      }

      try {
         classLW var4 = method7375(var0, var1, (byte)82);
         if (-1 == var2) {
            if (var3 >= 32) {
               throw new IllegalStateException();
            } else {
   ...
   @ObfuscatedName("is")
   public static classLW method7375(classLY var0, int var1, byte var2) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(II)Llw;")
   @ObfuscatedName("as")
   public classLW method7379(int var1, int var2) {
      classLW var3 = method7375(this, var1, (byte)19);
      if (-1 == var2) {
         return var3;
      } else {
         return null != var3 && null != var3.field4340 && var2 < var3.field4340.length ? var3.field4340[var2] : null;
         ...
         if (this.field4433[var1]) {
            ...
            if (var2 == 0) {
                  ...
                  if (null == this.field4440[var1][var3]) {
                     ...
                     if (null != var4) {
                        ...
                        if (-1 == var4[0]) {
                           ...
                           classLW.method7170(var5, new classXY(var4), (byte)-71);
                        }
               ...
               for (int var7 = 0; var7 < var2; var7++) {
                  classLW var8 = this.field4440[var1][var7];
                  if (null != var8 && -1502647899 * var8.field4342 != -1) {
                     classLW var9 = this.field4440[var1][-1502647899 * var8.field4342 & 65535];
                  ...
                  if (null == this.field4440[var1][var3]) {
                     ...
                     if (null != var4) {
                        ...
                        if (-1 == var4[0]) {
                           ...
                           classLW.method7170(var5, new classXY(var4), (byte)-6);
                        }
   ...
   protected classLY(classVA var1, classVA var2, classVA var3, classVA var4, classVA var5) {
      this.field4429 = new classJZ(20);
      this.field4432 = new classJZ(8);
      ...
      this.field4440 = new classLW[var6][];
   ...
   @ObfuscatedName("lr")
   public static void method7386(classGC var0, int var1, int var2, int var3) {
         ...
         if (var1 >= 0) {
            if (var1 < this.field4440.length) {
               ...
               if (null == this.field4440[var1]) {
                  ...
                  this.field4440[var1] = new classLW[var3];
               }
               ...
               for (int var9 = 0; var9 < var3; var9++) {
                  classLW var10 = this.field4440[var1][var9];
                  if (null != var10) {
                     if (var2 <= -324749371) {
                        throw new IllegalStateException();
                     }
                     ...
                     if (-1502647899 * var10.field4342 != -1) {
                        ...
                        classLW var11 = this.field4440[var1][-1502647899 * var10.field4242 & 65535];
   ...
   @ObfuscatedName("az")
   public classLW method7376(int var1, byte var2) {
      try {
         int var3 = var1 >> 16;
         int var4 = var1 & 65535;
   ...
   @ObfuscatedName("af")
   public classLW method7380(int var1, int var2, byte var3) {
      try {
         classLW var4 = method7375(this, var1, (byte)82);
         if (-1 == var2) {
            if (var3 >= 32) {
               throw new IllegalStateException();
            } else {
