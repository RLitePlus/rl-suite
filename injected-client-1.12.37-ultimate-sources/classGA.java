...
public class classGA {
   ...
   @ObfuscatedName("ie")
   public static void method5286(classGA var0, classZD var1, classZV var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ae")
   void method5287(classZD var1, classZV var2, int var3) {
      try {
         if (var2 == null) {
            if (var3 != 120041229) {
   ...
   @ObfuscatedName("bp")
   static int method5292(int var0, classBL var1, boolean var2, int var3) {
      try {
         if (var0 == 2700) {
            if (var3 >= 665692147) {
               throw new IllegalStateException();
            } else {
               classLW var15 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)69);
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 2073671441 * var15.field4319;
               return 1;
            }
         } else if (var0 == 2701) {
            classLW var14 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)69);
            if (2073671441 * var14.field4319 != -1) {
               if (var3 >= 665692147) {
                  throw new IllegalStateException();
               }

               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1190987649 * var14.field4344;
            } else {
            ...
            if (var3 >= 665692147) {
               ...
               classPK var17 = (classPK)classWK.field6691.field6613.method13363(var13);
               if (var17 != null) {
                  if (var3 >= 665692147) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 >= 665692147) {
               ...
               int var12 = classBB.field323[classDY.field1679 * -324749371];
               classLW var16 = classLY.method7378(
                  classWK.field6691, classBB.field323[1 + -324749371 * classDY.field1679], classBB.field323[2 + classDY.field1679 * -324749371], (byte)-100
               );
               ...
               if (classPN.method9026(var18, (byte)2)) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classLW.method7226(var16, var12, var18.field5352 * -1601970641, (byte)9);
               }
            ...
            if (var3 >= 665692147) {
               ...
               classDY.field1679 -= 360123687;
               classLW var11 = classLY.method7378(
                  classWK.field6691, classBB.field323[classDY.field1679 * -324749371], classBB.field323[1 + -324749371 * classDY.field1679], (byte)22
               );
               int var5 = classBB.field323[2 + classDY.field1679 * -324749371];
            ...
            if (var3 >= 665692147) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -77072447 * classWK.field6691.field6612;
               return 1;
            }
         } else if (2707 == var0) {
            classLW var10 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)75);
            ...
            classLW var9 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)88);
            return classEG.method3883(var9, 1268080743);
         } else if (var0 == 2709) {
            if (var3 >= 665692147) {
               throw new IllegalStateException();
            } else {
               classLW var4 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)65);
   ...
   @ObfuscatedName("ao")
   void method5288(classZD var1, classZV var2) {
      if (var2 != null) {
         int var3 = var2.field8;
   ...
   @ObfuscatedSignature(descriptor = "(Lzd;Lzv;)V")
   @ObfuscatedName("al")
   void method5289(classZD var1, classZV var2) {
      if (var2 != null) {
         int var3 = var2.field8;
   ...
   @ObfuscatedName("ex")
   static void method5293(classDN var0, byte var1) {
      try {
         var0.field1441 = -1188676331 * var0.field1581.field5284;
         var0.field1472 = -1692128277 * var0.field1581.field5299;
         var0.field1445 = -1396416521 * var0.field1581.field5285;
         var0.field1462 = 1282027453 * var0.field1581.field5308;
         var0.field1450 = -1864595447 * var0.field1581.field5286;
         var0.field1448 = var0.field1581.field5309 * -1944547999;
         var0.field1436 = var0.field1581.field5306 * -2041668601;
         var0.field1444 = 164467025 * var0.field1581.field5291;
         var0.field1457 = var0.field1581.field5307 * 1722908955;
         var0.field1449 = 23640527 * var0.field1581.field5281;
         var0.field1443 = -1297027025 * var0.field1581.field5310;
         var0.field1451 = 1997438045 * var0.field1581.field5301;
         var0.field1452 = -771437299 * var0.field1581.field5311;
         var0.field1453 = -1595575305 * var0.field1581.field5282;
         var0.field1446 = 631388589 * var0.field1581.field5298;
         var0.field1455 = -1060340881 * var0.field1581.field5303;
         var0.field1456 = var0.field1581.field5312 * -1105503079;
      } catch (RuntimeException var2) {
