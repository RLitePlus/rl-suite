...
@ObfuscatedName("gr")
public class classGR implements WorldMapRegion {
   @ObfuscatedName("ao")
   ...
   @ObfuscatedName("ij")
   public static void method5638(classGR var0, List var1) {
      if (var0 == null) {
         var0.getMapIcons();
      }

      for (classHF var3 : var1) {
         if (classFJ.method4796(var3.field2785 * -1047464521, (byte)-83).field5392
   ...
   void method5625(ArrayList var1, List var2, int var3) {
      try {
         ...
         throw classEG.method3884(var6, "gr.as(" + ')');
      }
   }
   ...
   void method5712(int var1, int var2, HashSet var3, int var4) {
      ...
      for (classHD var7 : this.field2658) {
   ...
   void method5633(classOM var1, int var2, int var3, int var4, classHA var5, int var6) {
      try {
         ...
         if (null != var1.field4930) {
            ...
            classPS var10 = classFJ.method4796(var1.field4953 * 1412472849, (byte)-18);
            var13 = new classHF((classKY)var8, var7, var10.field5405 * 872689451, this.method5725(var10, 1639042190));
         }

         classPS var14 = classFJ.method4796(((classHD)var13).vmethod486((byte)-45), (byte)-15);
         if (var14.field5392) {
            if (var6 <= -894742854) {
               return;
            }
         ...
         throw classEG.method3884(var11, "gr.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lym;Lpe;)I")
   @ObfuscatedName("er")
   int method5714(classYM var1, classPE var2) {
   ...
   void method5639(List var1, byte var2) {
      try {
         ...
         while (var3.hasNext()) {
            ...
            if (!classFJ.method4796(var4.field2785 * -1047464521, (byte)-63).field5392) {
               if (var2 == 32) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var6, "gr.ao(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lgr;IIIIII)Ljava/util/List;")
   @ObfuscatedName("cq")
   public static List method5728(classGR var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var0 == null) {
      ...
      try {
               ...
               if (var4 < var1 + var3) {
                  ...
                  if (var5 < var2 + var3) {
                     ...
                     while (var8.hasNext()) {
                        ...
                        classHD var12 = (classHD)var8.next();
         ...
         throw classEG.method3884(var10, "gr.bj(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;)V")
   @ObfuscatedName("dc")
   void method5659(classHH var1, classYZ[] var2, classHU var3, classGE var4) {
   ...
   @ObfuscatedName("aj")
   boolean method5646(int var1, classVA var2, int var3) {
      try {
         this.field2659.clear();
         ...
         throw classEG.method3884(var10, "gr.aj(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IILha;Lhh;[Lyz;B)V")
   @ObfuscatedName("ai")
   void method5668(int var1, int var2, classHA var3, classHH var4, classYZ[] var5, byte var6) {
      try {
         this.method5688(var1, var2, var3, -344925418);
         this.method5684(var1, var2, var3, var5, 801221335);
      } catch (RuntimeException var7) {
         throw classEG.method3884(var7, "gr.ai(" + ')');
      }
   }
   ...
   @ObfuscatedName("bm")
   public static void method5697(classGR var0, classPS var1, int var2, int var3, int var4, int var5) {
      if (var0 == null) {
         var0.method5722(var2, var2);
      }

      classYM var6 = var1.method9199(false, 1692508071);
      if (null != var6) {
         classYM.method13511(var6, var2 - var6.field7007 / 2, var3 - var6.field7009 / 2);
         if (var4 % var5 < var5 / 2) {
   ...
   @ObfuscatedName("lm")
   public static void method5650(classGR var0, classGX var1, int var2, classHH var3, classYZ[] var4, classVA var5, classVA var6, double var7) {
      if (var0 == null) {
      ...
      if (null != var0.field2669 || !var0.field2657.isEmpty()) {
         ...
         classYM var9 = (classYM)field2663.method6147(classCX.method2698(var10, var11, var2, (byte)1));
         if (null == var9) {
            ...
            if (var12) {
               ...
               if (var13 == null) {
                  ...
                  classYM var16 = classIT.method6314(var13, 1207354536);
                  if (null == var16) {
                     var15 = new classHU();
                  } else {
               ...
               classYM var17 = new classYM(-757278971 * var0.field2667, 1744034391 * var0.field2667);
               var17.method13477();
   ...
   @ObfuscatedName("vv")
   public static void method5626(classGR var0, ArrayList var1, List var2) {
   ...
   void method5653(int var1, int var2, int var3, HashSet var4, byte var5) {
      try {
         ...
         throw classEG.method3884(var6, "gr.aq(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;II)V")
   @ObfuscatedName("ej")
   void method5704(classPS var1, int var2, int var3) {
      classYM var4 = var1.method9199(false, -1534229956);
      if (null != var4) {
         int var5 = this.method5715(var4, var1.field5402, 1654920068);
         int var6 = this.method5719(var4, var1.field5397, 696529173);
         classYM.method13511(var4, var2 + var5, var3 + var6);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;I)V")
   @ObfuscatedName("au")
   void method5664(classHH var1, classYZ[] var2, classHU var3, classGE var4, int var5) {
      try {
         ...
         throw classEG.method3884(var10, "gr.au(" + ')');
      }
   }
      ...
      try {
         for (int var7 = 1; var7 < var3.field2752 * -1667236931; var7++) {
            ...
            if (var8 > -1) {
               ...
               int var9 = classPS.method9182(var8, this.field2660 * 288074485, var5, -1517689602);
         ...
         throw classEG.method3884(var10, "gr.aw(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IILha;[Lyz;I)V")
   @ObfuscatedName("av")
   void method5684(int var1, int var2, classHA var3, classYZ[] var4, int var5) {
      try {
         ...
         throw classEG.method3884(var15, "gr.av(" + ')');
      }
   }
   ...
   void method5688(int var1, int var2, classHA var3, int var4) {
      try {
         ...
         throw classEG.method3884(var14, "gr.at(" + ')');
      }
   }
   ...
   void method5690(int var1, int var2, HashSet var3, int var4, byte var5) {
      try {
         ...
         while (var8.hasNext()) {
            ...
            classHD var13 = (classHD)var9.getValue();
            if (var13 != null) {
               if (var5 != 3) {
                  throw new IllegalStateException();
               }
               ...
               if (var13.method5997((byte)-52)) {
                  ...
                  classPS var14 = classFJ.method4796(var13.vmethod486((byte)-115), (byte)-66);
         ...
         throw classEG.method3884(var15, "gr.an(" + ')');
      }
   }

   classGR(int var1, int var2, int var3, HashMap var4) {
   ...
   @ObfuscatedSignature(descriptor = "(Lps;II)V")
   @ObfuscatedName("ek")
   void method5705(classPS var1, int var2, int var3) {
      classYM var4 = var1.method9199(false, 317703748);
      if (null != var4) {
   ...
   @ObfuscatedName("gy")
   public static classHW method5721(classGR var0, int var1) {
      if (var0 == null) {
         return var0.method5723(var1);
      } else {
         classPS var2 = classFJ.method4796(var1, (byte)5);
   ...
   @ObfuscatedName("th")
   public static void method5635(classGR var0) {
      for (classHD var2 : var0.field2659.values()) {
   ...
   @ObfuscatedName("dc")
   public static List method5733(classGR var0) {
      if (var0 == null) {
         var0.method5642();
      }
   ...
   @ObfuscatedName("cz")
   boolean method5647(int var1, classVA var2) {
      this.field2659.clear();
   ...
   void method5713(int var1, int var2, HashSet var3, int var4, int var5) {
      try {
         ...
         while (var7.hasNext()) {
            ...
            classHD var8 = (classHD)var7.next();
         ...
         throw classEG.method3884(var11, "gr.bp(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;III)V")
   @ObfuscatedName("bx")
   void method5706(classPS var1, int var2, int var3, int var4) {
      try {
         classYM var5 = var1.method9199(false, -1683811326);
         if (null != var5) {
            if (var4 >= 586322231) {
               throw new IllegalStateException();
            }
            ...
            classYM.method13511(var5, var2 + var6, var3 + var7);
         }
      } catch (RuntimeException var8) {
         throw classEG.method3884(var8, "gr.bx(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lym;Lol;I)I")
   @ObfuscatedName("bm")
   int method5719(classYM var1, classOL var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "gr.bm(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;I)Lhw;")
   @ObfuscatedName("bg")
   classHW method5725(classPS var1, int var2) {
      try {
         if (null != var1.field5412) {
            ...
            if (null != this.field2661) {
               ...
               if (this.field2661.get(classHP.field2856) != null) {
                  ...
                  classZV var4 = (classZV)this.field2661.get(var3);
                  if (null == var4) {
                     if (var2 <= 1412510579) {
                        throw new IllegalStateException();
                     }
         ...
         throw classEG.method3884(var13, "gr.bg(" + ')');
      }
   }
   ...
   List method5734(int var1) {
      try {
         ...
         throw classEG.method3884(var3, "gr.bk(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lgr;IILha;Lhh;Lhu;Lge;B)V")
   @ObfuscatedName("uq")
   public static void method5671(classGR var0, int var1, int var2, classHA var3, classHH var4, classHU var5, classGE var6, byte var7) {
      if (var0 == null) {
      ...
      try {
         ...
         int var10 = 16711935;
         if (var9 != -1) {
            var10 = classPS.method9182(var9, 288074485 * var0.field2660, var6, -2092820255);
         }
         ...
         throw classEG.method3884(var12, "gr.ar(" + ')');
      }
   }
   ...
   void method5736(int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.method3884(var6, "gr.bo(" + ')');
      }
   }
   ...
   void method5640(List var1) {
      for (classHF var3 : var1) {
         if (classFJ.method4796(var3.field2785 * -1047464521, (byte)-92).field5392
   ...
   @ObfuscatedName("bn")
   void method5700(classHD var1, int var2, int var3, float var4, byte var5) {
      try {
         classPS var6 = classFJ.method4796(var1.vmethod486((byte)-68), (byte)-77);
         this.method5706(var6, var2, var3, 148705509);
         this.method5708(var1, var6, var2, var3, var4, 364928686);
      } catch (RuntimeException var7) {
         throw classEG.method3884(var7, "gr.bn(" + ')');
      }
   }
   ...
   void method5636(int var1) {
      try {
         for (classHD var3 : this.field2659.values()) {
         ...
         throw classEG.method3884(var4, "gr.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("nx")
   public static classHW method5726(classGR var0, classPS var1) {
      if (var0 == null) {
         var0.method5637();
      }
      ...
      if (null != var1.field5412 && null != var0.field2661 && var0.field2661.get(classHP.field2856) != null) {
         ...
         if (var2 == null) {
            ...
            classZV var3 = (classZV)var0.field2661.get(var2);
            if (null == var3) {
               return null;
            } else {
   ...
   void method5643(byte var1) {
      try {
         ...
         throw classEG.method3884(var4, "gr.al(" + ')');
      }
   }
   ...
   @ObfuscatedName("ao")
   public static List method5729(classGR var0, int var1, int var2, int var3, int var4, int var5) {
      if (var0 == null) {
         ...
         if (var4 >= var1 && var5 >= var2) {
            if (var4 < var1 + var3 && var5 < var2 + var3) {
               for (classHD var8 : var0.field2659.values()) {
                  if (var8.method5997((byte)-51) && var8.method5993(var4, var5, (byte)-96)) {
                     var6.add(var8);
                  }
               }

               for (classHD var10 : var0.field2658) {
   ...
   void method5615(int var1, int var2, int var3) {
      ...
      classYM var4 = (classYM)field2663.method6147(classCX.method2698(var5, var6, var7, (byte)1));
      if (null != var4) {
   ...
   classHW method5722(int var1, int var2) {
      try {
         classPS var3 = classFJ.method4796(var1, (byte)-98);
         return this.method5725(var3, 1467959558);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "gr.bt(" + ')');
      }
   }
   ...
   @ObfuscatedName("dn")
   void method5685(int var1, int var2, classHA var3, classYZ[] var4) {
      for (int var5 = 0; var5 < -1667236931 * var3.field2752; var5++) {
         classHZ[] var6 = var3.field2760[var5][var1][var2];
   ...
   @ObfuscatedName("br")
   int method5715(classYM var1, classPE var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "gr.br(" + 41);
      }
   }
   ...
   @ObfuscatedName("cn")
   void method5637() {
      for (classHD var2 : this.field2659.values()) {
         if (var2 instanceof classGS) {
   ...
   void method5641(List var1) {
      for (classHF var3 : var1) {
         if (classFJ.method4796(var3.field2785 * -1047464521, (byte)1).field5392
   ...
   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;)V")
   @ObfuscatedName("dm")
   void method5665(classHH var1, classYZ[] var2, classHU var3, classGE var4) {
   ...
   void method5672(int var1, int var2, classHA var3, classHH var4, classHU var5, classGE var6) {
      ...
      int var9 = 16711935;
      if (var8 != -1) {
         var9 = classPS.method9182(var8, 288074485 * this.field2660, var6, -1378665219);
      }
   ...
   void method5677(int var1, int var2, classHA var3, classHH var4, classGE var5) {
      for (int var6 = 1; var6 < var3.field2752 * -1667236931; var6++) {
         ...
         if (var7 > -1) {
            int var8 = classPS.method9182(var7, this.field2660 * 288074485, var5, -1313828822);
   ...
   @ObfuscatedSignature(descriptor = "(ILva;)Z")
   @ObfuscatedName("ch")
   boolean method5648(int var1, classVA var2) {
      this.field2659.clear();
      int var3 = classDG.method3057(this.field2662 * -551401517, 1312423097 * this.field2656, (byte)-43);
   ...
   @ObfuscatedName("ah")
   void method5698(classPS var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         classYM var7 = var1.method9199(false, -1113911178);
         if (null == var7) {
            if (var6 >= 1564893887) {
               throw new IllegalStateException();
            }
         } else {
            classYM.method13511(var7, var2 - var7.field7007 / 2, var3 - var7.field7009 / 2);
            if (var4 % var5 < var5 / 2) {
               if (var6 >= 1564893887) {
                  return;
               }
         ...
         throw classEG.method3884(var8, "gr.ah(" + ')');
      }
   }
   ...
   @ObfuscatedName("sh")
   public static int method5716(classGR var0, classYM var1, classPE var2) {
      if (var0 == null) {
         var0.method5737();
      }
   ...
   @ObfuscatedName("ay")
   void method5651(classGX var1, int var2, classHH var3, classYZ[] var4, classVA var5, classVA var6, double var7) {
      try {
            ...
            if (null == var9) {
               ...
               if (var12) {
                  ...
                  if (var13 == null) {
                     ...
                     classYM var16 = classIT.method6314(var13, 1820082454);
                     if (null == var16) {
                        var15 = new classHU();
                     } else {
                        var15 = new classHU(var16.field7005);
                  ...
                  classYM var17 = new classYM(621957952 * this.field2667, 621957952 * this.field2667);
                  var17.method13477();
                  if (null != this.field2669) {
         ...
         throw classEG.method3884(var21, "gr.ay(" + ')');
      }
   }
   ...
   @ObfuscatedName("yk")
   public static void method5629(classGR var0, int var1, int var2, int var3, int var4, classHA var5) {
      if (var0 == null) {
   ...
   @ObfuscatedName("gp")
   public static int method5680(classGR var0, int var1, int var2, classHA var3, classHU var4, int var5) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var6, "gr.ak(" + 41);
      }
   }
   ...
   void method5655(HashSet var1, int var2, int var3) {
      for (classHD var5 : this.field2659.values()) {
         if (var5.method5997((byte)-54)) {
            int var6 = var5.vmethod486((byte)-45);
            if (var1.contains(var6)) {
               classPS var7 = classFJ.method4796(var6, (byte)-52);
   ...
   void method5656(HashSet var1, int var2, int var3) {
      for (classHD var5 : this.field2659.values()) {
         if (var5.method5997((byte)-78)) {
            ...
            if (var1.contains(var6)) {
               classPS var7 = classFJ.method4796(var6, (byte)-72);
   ...
   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;)V")
   @ObfuscatedName("cm")
   void method5660(classHH var1, classYZ[] var2, classHU var3, classGE var4) {
      for (int var5 = 0; var5 < 64; var5++) {
         for (int var6 = 0; var6 < 64; var6++) {
   ...
   void method5694(HashSet var1, int var2, int var3) {
      for (classHD var5 : this.field2658) {
         if (var5.method5997((byte)-115)) {
            classPS var6 = classFJ.method4796(var5.vmethod486((byte)-79), (byte)-80);
   ...
   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;)V")
   @ObfuscatedName("dd")
   void method5666(classHH var1, classYZ[] var2, classHU var3, classGE var4) {
      for (classGF var6 : this.field2657) {
   ...
   @ObfuscatedName("nf")
   public static void method5619(classGR var0, int var1, int var2, int var3, short var4) {
      if (var0 == null) {
         ...
         try {
            ...
            classYM var5 = (classYM)field2663.method6147(classCX.method2698(var6, var7, var8, (byte)1));
            if (null == var5) {
               if (var4 > 128) {
                  ;
               }
            ...
            throw classEG.method3884(var10, "gr.ab(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;)V")
   @ObfuscatedName("dx")
   void method5667(classHH var1, classYZ[] var2, classHU var3, classGE var4) {
      for (classGF var6 : this.field2657) {
   ...
   @ObfuscatedName("dy")
   void method5669(int var1, int var2, classHA var3, classHH var4, classYZ[] var5) {
   ...
   @ObfuscatedSignature(descriptor = "(IILha;Lhh;[Lyz;)V")
   @ObfuscatedName("di")
   void method5670(int var1, int var2, classHA var3, classHH var4, classYZ[] var5) {
   ...
   void method5673(int var1, int var2, classHA var3, classHH var4, classHU var5, classGE var6) {
      ...
      int var9 = 16711935;
      if (var8 != -1) {
         var9 = classPS.method9182(var8, -155991272 * this.field2660, var6, -959833637);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;)V")
   @ObfuscatedName("ce")
   void method5661(classHH var1, classYZ[] var2, classHU var3, classGE var4) {
      for (int var5 = 0; var5 < 64; var5++) {
   ...
   void method5674(int var1, int var2, classHA var3, classHH var4, classHU var5, classGE var6) {
      ...
      int var9 = -1456385724;
      if (var8 != -1) {
         var9 = classPS.method9182(var8, 288074485 * this.field2660, var6, -2046105688);
      }
   ...
   void method5678(int var1, int var2, classHA var3, classHH var4, classGE var5) {
      for (int var6 = 1; var6 < var3.field2752 * -1667236931; var6++) {
         int var7 = var3.field2759[var6][var1][var2] - 1;
         if (var7 > -1) {
            int var8 = classPS.method9182(var7, this.field2660 * -962674413, var5, -1410352166);
            if (0 == var3.field2757[var6][var1][var2]) {
               classYW.method13698(
   ...
   void method5679(int var1, int var2, classHA var3, classHH var4, classGE var5) {
      for (int var6 = 1; var6 < var3.field2752 * -1667236931; var6++) {
         int var7 = var3.field2759[var6][var1][var2] - 1;
         if (var7 > -1) {
            int var8 = classPS.method9182(var7, this.field2660 * 288074485, var5, -884422306);
            if (0 == var3.field2757[var6][var1][var2]) {
               classYW.method13698(
   ...
   @ObfuscatedSignature(descriptor = "(ILva;)Z")
   @ObfuscatedName("cg")
   boolean method5649(int var1, classVA var2) {
      this.field2659.clear();
   ...
   @ObfuscatedName("vc")
   public static void method5692(classGR var0, int var1, int var2, HashSet var3, int var4) {
      if (var0 == null) {
         var0.method5730(var1, var1, var1, var1, var1);
      }
      ...
      for (Entry var8 : var0.field2659.entrySet()) {
         ...
         if (var12 != null && var12.method5997((byte)-18)) {
            ...
            classPS var13 = classFJ.method4796(var12.vmethod486((byte)-65), (byte)-99);
            if (!var3.contains(var13.method9203((byte)0))) {
   ...
   @ObfuscatedSignature(descriptor = "(IILha;[Lyz;)V")
   @ObfuscatedName("dv")
   void method5686(int var1, int var2, classHA var3, classYZ[] var4) {
      for (int var5 = 0; var5 < -1667236931 * var3.field2752; var5++) {
         classHZ[] var6 = var3.field2760[var5][var1][var2];
         if (null != var6 && var6.length != 0) {
            classHZ[] var7 = var6;
   ...
   @ObfuscatedSignature(descriptor = "(Lgr;Lym;Lpe;)I")
   @ObfuscatedName("gm")
   public static int method5717(classGR var0, classYM var1, classPE var2) {
      if (var0 == null) {
         var0.getMapIcons();
      }
   ...
   @ObfuscatedSignature(descriptor = "(IILha;[Lyz;)V")
   @ObfuscatedName("dz")
   void method5687(int var1, int var2, classHA var3, classYZ[] var4) {
   ...
   @ObfuscatedName("bq")
   public static void method5662(classGR var0, classHH var1, classYZ[] var2, classHU var3, classGE var4, int var5) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var8, "gr.ap(" + ')');
      }
   }
   ...
   void method5693(int var1, int var2, HashSet var3, int var4) {
      ...
      for (Entry var8 : this.field2659.entrySet()) {
         ...
         if (var12 != null && var12.method5997((byte)-86)) {
            ...
            var12.field2772 = var11 * 1689733203;
            classPS var13 = classFJ.method4796(var12.vmethod486((byte)-37), (byte)-104);
            if (!var3.contains(var13.method9203((byte)0))) {
               this.method5700(var12, var10, var11, var5, (byte)32);
            }
         }
   ...
   @ObfuscatedName("bc")
   void method5708(classHD var1, classPS var2, int var3, int var4, float var5, int var6) {
      try {
         ...
         if (null != var7) {
            if (!var7.field2901.method6087(var5, -152388045)) {
               ...
               classZV var8 = (classZV)this.field2661.get(var7.field2901);
               var8.method66(
                  var7.field2900,
         ...
         throw classEG.method3884(var9, "gr.bc(" + ')');
      }
   }
   ...
   void method5695(HashSet var1, int var2, int var3) {
      for (classHD var5 : this.field2658) {
         if (var5.method5997((byte)-10)) {
            classPS var6 = classFJ.method4796(var5.vmethod486((byte)-58), (byte)-69);
            if (var6 != null && var1.contains(var6.method9203((byte)0))) {
   ...
   void method5657(HashSet var1, int var2, int var3, byte var4) {
      try {
         ...
         while (var5.hasNext()) {
            ...
            classHD var6 = (classHD)var5.next();
            if (!var6.method5997((byte)-76)) {
               ...
               if (var1.contains(var7)) {
                  ...
                  classPS var8 = classFJ.method4796(var7, (byte)-89);
         ...
         throw classEG.method3884(var9, "gr.ad(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;IIII)V")
   @ObfuscatedName("dj")
   void method5699(classPS var1, int var2, int var3, int var4, int var5) {
      classYM var6 = var1.method9199(false, 413620383);
      if (null != var6) {
         classYM.method13511(var6, var2 - var6.field7007 / 2, var3 - var6.field7009 / 2);
         if (var4 % var5 < var5 / 2) {
            classYW.method13689(var2, var3, 15, 16776960, 128);
   ...
   @ObfuscatedName("el")
   void method5709(classHD var1, classPS var2, int var3, int var4, float var5) {
      classHW var6 = var1.vmethod491((byte)-64);
      if (null != var6) {
         if (var6.field2901.method6087(var5, -378769035)) {
            classZV var7 = (classZV)this.field2661.get(var6.field2901);
            var7.method66(
               var6.field2900,
   ...
   @ObfuscatedName("ey")
   void method5701(classHD var1, int var2, int var3, float var4) {
      classPS var5 = classFJ.method4796(var1.vmethod486((byte)-73), (byte)-82);
   ...
   @ObfuscatedSignature(descriptor = "(Lhd;IIF)V")
   @ObfuscatedName("ea")
   void method5702(classHD var1, int var2, int var3, float var4) {
      classPS var5 = classFJ.method4796(var1.vmethod486((byte)7), (byte)-14);
   ...
   static classSN method5658(int var0, int var1) {
      try {
         ...
         throw classEG.method3884(var3, "gr.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;II)V")
   @ObfuscatedName("es")
   void method5707(classPS var1, int var2, int var3) {
      classYM var4 = var1.method9199(false, 1155356910);
      if (null != var4) {
      ...
      try {
         ...
         while (var5.hasNext()) {
            ...
            if (!var6.method5997((byte)-5)) {
               ...
               classPS var7 = classFJ.method4796(var6.vmethod486((byte)-77), (byte)-23);
         ...
         throw classEG.method3884(var8, "gr.am(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lhd;Lps;IIF)V")
   @ObfuscatedName("ev")
   void method5710(classHD var1, classPS var2, int var3, int var4, float var5) {
   ...
   @ObfuscatedSignature(descriptor = "(Lhd;Lps;IIF)V")
   @ObfuscatedName("eh")
   void method5711(classHD var1, classPS var2, int var3, int var4, float var5) {
   ...
   void method5634(classOM var1, int var2, int var3, int var4, classHA var5) {
      ...
      if (null != var1.field4930) {
         ...
         classPS var9 = classFJ.method4796(var1.field4953 * 1571238399, (byte)-105);
         var11 = new classHF((classKY)var7, var6, var9.field5405 * -1991769382, this.method5725(var9, 2023781404));
      }

      classPS var12 = classFJ.method4796(((classHD)var11).vmethod486((byte)-123), (byte)5);
      if (var12.field5392) {
   ...
   @ObfuscatedSignature(descriptor = "(Lym;Lpe;)I")
   @ObfuscatedName("ex")
   int method5718(classYM var1, classPE var2) {
   ...
   @ObfuscatedName("eo")
   int method5720(classYM var1, classOL var2) {
      switch (-1205275063 * var2.field4917) {
         case 0:
            return -var1.field7009 / 2;
         case 1:
   ...
   classHW method5723(int var1) {
      classPS var2 = classFJ.method4796(var1, (byte)-103);
   ...
   classHW method5727(classPS var1) {
      if (null != var1.field5412 && null != this.field2661 && this.field2661.get(classHP.field2856) != null) {
         ...
         if (var2 == null) {
            ...
            classZV var3 = (classZV)this.field2661.get(var2);
            if (null == var3) {
               return null;
            } else {
               int var4 = var3.method43(var1.field5412, 1000000);
   ...
   @ObfuscatedName("ac")
   public static void method5623(classGR var0, classGL var1, List var2, byte var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var4, "gr.ag(" + ')');
      }
   }
   ...
   List method5730(int var1, int var2, int var3, int var4, int var5) {
      ...
      if (var4 >= var1 && var5 >= var2) {
         if (var4 < var1 + var3 && var5 < var2 + var3) {
            for (classHD var8 : this.field2659.values()) {
               if (var8.method5997((byte)-117) && var8.method5993(var4, var5, (byte)-127)) {
                  var6.add(var8);
               }
            }

            for (classHD var10 : this.field2658) {
   ...
   @ObfuscatedName("qk")
   public static void method5631(classGR var0, int var1, int var2, int var3, int var4, classHA var5, int var6) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var15, "gr.ax(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lhd;IIF)V")
   @ObfuscatedName("dp")
   void method5703(classHD var1, int var2, int var3, float var4) {
      classPS var5 = classFJ.method4796(var1.vmethod486((byte)-36), (byte)-85);
   ...
   void method5620(int var1, int var2, int var3, short var4) {
      try {
         ...
         classYM var5 = (classYM)field2663.method6143(classCX.method2698(var6, var7, var8, (byte)1));
         if (null == var5) {
            if (var4 > 128) {
               ;
            }
   ...
   @ObfuscatedSignature(descriptor = "(Lhh;[Lyz;Lhu;Lge;I)V")
   @ObfuscatedName("ap")
   void method5663(classHH var1, classYZ[] var2, classHU var3, classGE var4, int var5) {
      try {
         for (int var6 = 0; var6 < 64; var6++) {
            if (var5 >= -711998756) {
               return;
   ...
   void method5675(int var1, int var2, classHA var3, classHH var4, classHU var5, classGE var6, byte var7) {
      try {
         ...
         int var10 = 16711935;
         if (var9 != -1) {
            var10 = classPS.method9182(var9, 288074485 * this.field2662, var6, -2092820255);
         }
   ...
   @ObfuscatedSignature(descriptor = "(Lgx;ILhh;[Lyz;Lva;Lva;D)V")
   @ObfuscatedName("cw")
   void method5652(classGX var1, int var2, classHH var3, classYZ[] var4, classVA var5, classVA var6, double var7) {
      this.field2656 = 212048344 * var2;
      if (null != this.field2669 || !this.field2657.isEmpty()) {
         int var10 = -1405153691 * this.field2656;
         int var11 = this.field2667 * -1670926402;
         classYM var9 = (classYM)field2663.method6143(classCX.method2698(var10, var11, var2, (byte)1));
         if (null == var9) {
            ...
            if (var12) {
               ...
               classYM var17 = new classYM(-757278971 * this.field2667, 1744034391 * this.field2667);
               var17.method13477();
               if (null != this.field2669) {
