...
public class classLI {
   ...
   @ObfuscatedName("as")
   static int method7106(classCM var0, classCM var1, int var2, boolean var3, int var4) {
      try {
         if (var2 == 1) {
            if (var4 >= 485700367) {
               throw new IllegalStateException();
            ...
            if (var4 >= 485700367) {
               ...
               byte var9;
               if (classCM.method2491(var0, 1783010309)) {
                  if (var4 >= 485700367) {
                     throw new IllegalStateException();
                  }

                  if (classCM.method2491(var1, -1190184001)) {
                     if (var4 >= 485700367) {
                        throw new IllegalStateException();
                     }
               ...
               } else if (classCM.method2491(var1, -1057671836)) {
                  if (var4 >= 485700367) {
                     throw new IllegalStateException();
                  }
   ...
   public static void method7108(int var0) {
      try {
         classJZ.method6431(classOP.field5006);
         classJZ.method6431(classOP.field5007);
         classJZ.method6431(classOP.field5008);
   ...
   @ObfuscatedName("am")
   static int method7109(int var0, classBL var1, boolean var2, int var3) {
      try {
         classLW var10000;
         if (var2) {
            if (var3 == -324749371) {
         ...
         if (1800 == var0) {
            if (var3 == -324749371) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classCK.method1575(
            ...
            if (var3 == -324749371) {
               ...
               var5--;
               if (var4.field4337 != null) {
                  if (var3 == -324749371) {
                     throw new IllegalStateException();
                  }

                  if (var5 < var4.field4337.length) {
                     if (var4.field4337[var5] != null) {
