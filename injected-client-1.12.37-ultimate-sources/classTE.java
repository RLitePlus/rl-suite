...
public class classTE {
   ...
   public final int method10756(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "te.ab(" + 41);
      }
   }
   ...
   public final int[] method10748(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "te.az(" + ')');
      }
   }
   ...
   public final long[] method10750(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "te.af(" + ')');
      }
   }
   ...
   public static void method10782(classTE var0, int var1, byte var2) {
      ...
      try {
         ...
         throw classEG.method3884(var6, "te.al(" + ')');
      }
   }
   ...
   final Object method10759(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "te.ag(" + ')');
      }
   }
   ...
   final void method10765(int var1, Object var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "te.as(" + ')');
      }
   }
   ...
   public final void method10767(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "te.ax(" + ')');
      }
   }
   ...
   int method10776(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var4, "te.aa(" + 41);
      }
   }
   ...
   @ObfuscatedName("cl")
   public static classTE method10798(classXY var0, boolean var1) {
      int var2 = classXY.method13047(var0, -415805025);
      if (var2 >= 0 && var2 <= 5000) {
         ...
         if (var3 == 0 || 1 == var3) {
            ...
            classTE var10;
            if (var1) {
               var10 = classFJ.method4804(var4, 325060923);
            } else {
   ...
   @ObfuscatedName("au")
   public void method10795(classXY var1, byte var2) {
      try {
         ...
         if (classYY.field7111 == this.field6128) {
            ...
            classXY.method12971(var1, var10001, (byte)-94);
            ...
            classXY.method12971(var1, this.field6122 != null && (Long)this.field6122 == -1L ? 3 : 2, (byte)-13);
            ...
            classXY.method12971(var1, 4, (byte)-30);
            ...
            for (int var6 = 0; var6 < -1943548931 * this.field6131; var6++) {
               ...
               classXY.method12997(var1, (String)this.field6125[var6], (short)25085);
            }
         }
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "te.au(" + ')');
      }
   }
   ...
   public static Object[] method10753(classTE var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "te.ae(" + ')');
         }
      }
   }
   ...
   final void method10774(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "te.ac(" + ')');
      }
   }
   ...
   void method10781(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "te.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("cb")
   public void method10796(classXY var1) {
      var1.method12973(-1943548931 * this.field6131, -1542382992);
      if (classYY.field7111 == this.field6128) {
         classXY.method12971(var1, null != this.field6122 && (Integer)this.field6122 == -1 ? 1 : 0, (byte)-97);

         for (int var2 = 0; var2 < -1943548931 * this.field6131; var2++) {
            var1.method12979(this.field6126[var2], -193597109);
         }
      } else if (this.field6128 == classYY.field7115) {
         classXY.method12971(var1, this.field6122 != null && (Long)this.field6122 == -1L ? 3 : 2, (byte)-59);

         for (int var3 = 0; var3 < this.field6131 * -1943548931; var3++) {
            var1.method12987(this.field6127[var3]);
         }
      } else if (classYY.field7113 == this.field6128) {
         classXY.method12971(var1, 4, (byte)-13);

         for (int var4 = 0; var4 < -1943548931 * this.field6131; var4++) {
            classXY.method12997(var1, (String)this.field6125[var4], (short)26595);
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ct")
   public void method10797(classXY var1) {
      var1.method12973(-1943548931 * this.field6131, -1542382992);
      if (classYY.field7111 == this.field6128) {
         classXY.method12971(var1, null != this.field6122 && (Integer)this.field6122 == -1 ? 1 : 0, (byte)-49);

         for (int var2 = 0; var2 < -1943548931 * this.field6131; var2++) {
            var1.method12979(this.field6126[var2], 576025583);
         }
      } else if (this.field6128 == classYY.field7115) {
         classXY.method12971(var1, this.field6122 != null && (Long)this.field6122 == -1L ? 3 : 2, (byte)-90);

         for (int var3 = 0; var3 < this.field6131 * -1250620310; var3++) {
            var1.method12987(this.field6127[var3]);
         }
      } else if (classYY.field7113 == this.field6128) {
         classXY.method12971(var1, 4, (byte)-89);

         for (int var4 = 0; var4 < -1943548931 * this.field6131; var4++) {
            classXY.method12997(var1, (String)this.field6125[var4], (short)11373);
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Z)Lte;")
   @ObfuscatedName("cp")
   public static classTE method10799(classXY var0, boolean var1) {
      int var2 = classXY.method13047(var0, -103836328);
      if (var2 >= 0 && var2 <= 5000) {
         int var3 = classXY.method13039(var0, -346779531);
         if (var3 == 0 || 1 == var3) {
            int[] var9 = new int[var2];
            ...
            classTE var10;
            if (var1) {
               var10 = classFJ.method4804(var4, -2022602313);
            } else {
               classTE var7 = new classTE(classYY.field7113, false);
               var7.field6125 = var4;
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Z)Lte;")
   @ObfuscatedName("cq")
   public static classTE method10800(classXY var0, boolean var1) {
      int var2 = classXY.method13047(var0, -836339954);
      if (var2 >= 0 && var2 <= 5000) {
         int var3 = classXY.method13039(var0, -346779531);
         if (var3 == 0 || 1 == var3) {
            int[] var9 = new int[var2];
            ...
            classTE var10;
            if (var1) {
               var10 = classFJ.method4804(var4, 326583914);
            } else {
               classTE var7 = new classTE(classYY.field7113, false);
               var7.field6125 = var4;
               var7.field6131 = var4.length * -1063196331;
