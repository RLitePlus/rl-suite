...
@ObfuscatedName("oi")
public class classOI extends classVJ implements WorldEntityConfig {
   ...
   @ObfuscatedName("an")
   static classJZ field4872 = new classJZ(64);
   @ToRemove(unused = "true")
   @ObfuscatedName("ap")
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("bw")
   public static classJZ field4873 = new classJZ(64);
   @ObfuscatedName("bc")
   final int field4885;
   @ToRemove(unused = "true")
   @ObfuscatedName("ak")
   ...
   public int method8479(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.as(" + 41);
      }
   }
   ...
   public int method8461(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.af(" + 41);
      }
   }
   ...
   @ObfuscatedName("aj")
   public static classOI method8456(int var0) {
      classOI var1 = (classOI)field4872.method6422(var0);
      if (var1 != null) {
         return var1;
      } else {
         byte[] var2 = classCB.field649.method11867(-132306035, var0, -693118684);
         var1 = new classOI(new classXY(var2), var0);
   ...
   @ObfuscatedName("kz")
   public static int method8497(classOI var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "oi.al(" + 41);
         }
      }
   }
   ...
   public classJB method8490(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.aa(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Lym;")
   @ObfuscatedName("ao")
   public classYM method8492(int var1) {
      try {
         if (this.field4888 * -486845133 < 0) {
            return null;
         } else {
            classYM var2 = (classYM)field4873.method6422(-486845133 * this.field4888);
            if (var2 != null) {
               return var2;
            } else {
         ...
         throw classEG.method3884(var3, "oi.ao(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("sq")
   public classYM method8504() {
   ...
   @ObfuscatedSignature(descriptor = "(I)Loi;")
   @ObfuscatedName("ay")
   public static classOI method8457(int var0) {
      classOI var1 = (classOI)field4872.method6422(var0);
      if (var1 != null) {
         return var1;
      } else {
   ...
   @ObfuscatedSignature(descriptor = "(I)Loi;")
   @ObfuscatedName("aq")
   public static classOI method8458(int var0) {
      classOI var1 = (classOI)field4872.method6422(var0);
      if (var1 != null) {
         return var1;
      } else {
   ...
   @ObfuscatedSignature(descriptor = "(I)Loi;")
   @ObfuscatedName("ad")
   public static classOI method8459(int var0) {
      classOI var1 = (classOI)field4872.method6422(var0);
      if (var1 != null) {
         return var1;
      } else {
   ...
   @ObfuscatedSignature(descriptor = "(I)Loi;")
   @ObfuscatedName("ap")
   public static classOI method8460(int var0) {
      classOI var1 = (classOI)field4872.method6422(var0);
      if (var1 != null) {
         return var1;
      } else {
   ...
   public classVH method8482(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.ax(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Loi;I)I")
   @ObfuscatedName("rr")
   public static int method8467(classOI var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "oi.ae(" + 41);
         }
      }
   }
         ...
         while (true) {
            ...
            switch (var19) {
               ...
               default:
                  continue;
               case 2:
                  var14 = classXY.method13039(var1, -346779531);
                  continue;
               case 4:
               ...
               case 7:
                  ...
                  continue;
               case 8:
                  var11 = classXY.method13047(var1, 569407538);
                  continue;
               case 9:
                  var12 = classXY.method13047(var1, -1997974894);
                  continue;
               case 12:
               ...
               case 19:
                  ...
                  continue;
               case 20:
                  var4 = classXY.method13047(var1, -942119645);
                  continue;
               case 23:
                  var15 = (classKW)classOF.method8404(classMA.method7428((byte)-103), classXY.method13039(var1, -346779531), 346173919);
                  continue;
               case 24:
                  classJB[] var20 = new classJB[]{classJB.field3114, classJB.field3117, classJB.field3115};
                  var16 = (classJB)classOF.method8404(var20, classXY.method13039(var1, -346779531), 1234798768);
                  continue;
               case 25:
                  var13 = classXY.method13047(var1, 1383209310);
                  continue;
               case 26:
                  var17 = classXY.method13110(var1, -324749371);
                  continue;
               case 27:
            }

            var18 = classXY.method13047(var1, 1675846563);
         }
      }
   ...
   @ObfuscatedName("ba")
   static int method8503(int var0, classBL var1, boolean var2, int var3) {
      try {
         if (3800 == var0) {
            ...
            if (var3 == -1863749917) {
               ...
               int var28 = (classDY.field1679 += 120041229) * -324749371 - 1;
               byte var30;
            ...
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3023;
               return 1;
            }
         } else if (3805 == var0) {
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3025;
            return 1;
         } else if (var0 == 3806) {
            if (var3 == -1863749917) {
               throw new IllegalStateException();
            } else {
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3024;
               return 1;
            }
         } else if (var0 == 3807) {
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3019;
               return 1;
            }
         } else if (3809 == var0) {
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3028 * -1967686263;
               return 1;
            }
         } else if (3810 == var0) {
            if (var3 == -1863749917) {
            ...
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3037[var18];
               return 1;
            }
         } else if (var0 == 3812) {
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3027 * -845393113;
               return 1;
            }
         } else if (var0 == 3813) {
            if (var3 == -1863749917) {
            ...
            int var16 = classBB.field323[-324749371 * classDY.field1679];
            int var22 = classBB.field323[1 + classDY.field1679 * -324749371];
            int var23 = classBB.field323[classDY.field1679 * -324749371 + 2];
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classIQ.method6244(classNJ.field4678, var16, var22, var23, -841278672);
            return 1;
         } else if (var0 == 3815) {
            if (var3 == -1863749917) {
               throw new IllegalStateException();
            } else {
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3014 * -577292071;
               return 1;
            }
         } else if (var0 == 3816) {
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = -1725108575 * classNJ.field4678.field3017;
               return 1;
            }
         } else if (var0 == 3817) {
            if (var3 == -1863749917) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classBE.method993(
                  classNJ.field4678, (String)classBB.field328[(classBB.field338 -= 1222866659) * 1375698635], -2067157559
               );
               return 1;
            }
         } else if (3818 == var0) {
            classBB.field323[classDY.field1679 * -324749371 - 1] = classNJ.field4678.method6249((byte)-64)[classBB.field323[classDY.field1679 * -324749371 - 1]];
            return 1;
         } else if (var0 == 3819) {
            if (var3 == -1863749917) {
               throw new IllegalStateException();
               ...
               int var15 = classBB.field323[-324749371 * classDY.field1679];
            ...
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classNJ.field4678.field3039[var14];
            return 1;
         } else {
            if (3821 == var0) {
               classDY.field1679 -= 360123687;
               ...
               boolean var10000;
               if (classBB.field323[1 + classDY.field1679 * -324749371] == 1) {
                  if (var3 == -1863749917) {
                     throw new IllegalStateException();
                  }
               ...
               int var6 = classBB.field323[classDY.field1679 * -324749371 + 2];
               classPT.method9217(var6, var4, var5, 45209452);
            }
            ...
            if (3822 == var0) {
               if (var3 == -1863749917) {
                  ...
                  int var27 = (classDY.field1679 += 120041229) * -324749371 - 1;
                  byte var29;
               ...
               if (var3 == -1863749917) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classPO.field5368.field2950;
                  return 1;
               }
            } else if (3854 == var0) {
               if (var3 == -1863749917) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classPO.field5368.field2949;
                  return 1;
               }
            } else if (3855 == var0) {
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classIE.method6183(classPO.field5368, (byte)-26);
               return 1;
            } else if (var0 == 3856) {
               int var11 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
               classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = ((classHN)classPO.field5368.field2955.get(var11))
                  .field2846
               ...
               if (var3 == -1863749917) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = ((classHN)classPO.field5368.field2955.get(var10)).field2841;
                  return 1;
               }
            } else if (3858 == var0) {
               if (var3 == -1863749917) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = ((classHN)classPO.field5368.field2955.get(var9)).field2842 * -906550845;
                  return 1;
               }
            } else if (3859 == var0) {
               if (var3 == -1863749917) {
                  ...
                  classCG.method1496(-1270719559 * classHU.field2891, var8, 973334607);
                  return 1;
               }
            } else if (var0 == 3860) {
               if (var3 == -1863749917) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classPO.field5368
                     .method6186((String)classBB.field328[(classBB.field338 -= 1222866659) * 1375698635], (byte)33);
                  return 1;
               }
            } else if (3861 == var0) {
               classBB.field323[classDY.field1679 * -324749371 - 1] = classIE.method6169(classPO.field5368, -1957709273)[classBB.field323[-324749371
                     * classDY.field1679
                  - 1]];
               return 1;
            } else if (3890 == var0) {
         ...
         throw classEG.method3884(var7, "oi.ba(" + 41);
      }
   }
   ...
   @ObfuscatedName("hp")
   public static classYM method8493(classOI var0) {
      if (var0 == null) {
         var0.method8500();
      }
      ...
      if (var0.field4888 * -486845133 < 0) {
         ...
         classYM var1 = (classYM)field4873.method6422(-486845133 * var0.field4888);
         if (var1 != null) {
            return var1;
         } else {
   ...
   public int method8478(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.ag(" + 41);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("bb")
   public classYM method8494() {
      if (this.field4888 * 1536601507 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)field4873.method6422(-1546897097 * this.field4888);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("bi")
   public classYM method8495() {
      if (this.field4888 * -486845133 < 0) {
         return null;
      } else {
         classYM var1 = (classYM)field4873.method6422(-486845133 * this.field4888);
         if (var1 != null) {
            return var1;
         } else {
   ...
   public int method8474(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.ab(" + 41);
      }
   }
   ...
   @ObfuscatedName("jv")
   public static classKW method8486(classOI var0) {
   ...
   public classKW method8487(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "oi.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("mu")
   public static classKW method8488(classOI var0, int var1) {
      if (var0 == null) {
