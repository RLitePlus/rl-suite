...
public abstract class classGG {
   ...
   @ObfuscatedName("mf")
   static classYM field2577;

   @ObfuscatedSignature(descriptor = "(IIILgc;)Z")
   @ObfuscatedName("ae")
   protected abstract boolean vmethod146(int var1, int var2, int var3, classGC var4);

   @ObfuscatedSignature(descriptor = "(IIILgc;B)Z")
   @ObfuscatedName("az")
   protected abstract boolean vmethod144(int var1, int var2, int var3, classGC var4, byte var5);

   @ObfuscatedSignature(descriptor = "(IIILgc;)Z")
   @ObfuscatedName("af")
   protected abstract boolean vmethod145(int var1, int var2, int var3, classGC var4);
   ...
   public static void method5428(int var0) {
      try {
         classJZ.method6431(classPA.field5203);
      } catch (RuntimeException var1) {
         throw classEG.method3884(var1, "gg.ae(" + ')');
      }
   }
   ...
   static void method5430(int var0) {
      try {
         ...
         throw classEG.method3884(var7, "gg.ad(" + ')');
      }
   }
}
