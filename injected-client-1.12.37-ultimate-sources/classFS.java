...
public class classFS extends classVJ {
   ...
   @ObfuscatedName("ae")
   public static classFS method4972(classVA var0, classVA var1, int var2) {
      boolean var3 = true;
      int var4 = -1;
   ...
   classFS(classVA var1, classVA var2, int var3) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;Lva;I)Lfs;")
   @ObfuscatedName("ab")
   public static classFS method4973(classVA var0, classVA var1, int var2) {
      boolean var3 = true;
      int var4 = -1;
   ...
   @ObfuscatedName("ac")
   public static classYZ[] method4978(byte var0) {
      try {
         classYZ[] var1 = new classYZ[classYL.field7001 * 1616155503];
         ...
         for (int var2 = 0; var2 < classYL.field7001 * 1616155503; var2++) {
            ...
            classYZ var3 = var1[var2] = new classYZ();
            ...
            var3.field7125 = classYL.field7004[var2];
         }

         classVZ.method12278((byte)-99);
         return var1;
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "fs.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("ab")
   static String method4977(classYN var0, int var1, String var2, byte var3) {
      try {
         if (null == var0) {
            if (var3 <= 9) {
               throw new IllegalStateException();
         ...
         throw classEG.method3884(var5, "fs.ab(" + ')');
      }
   }
   ...
   public static void method4979(int var0) {
      try {
         classJZ.method6431(classPL.field5336);
         classJZ.method6431(classPL.field5337);
      } catch (RuntimeException var1) {
         throw classEG.method3884(var1, "fs.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZB)I")
   @ObfuscatedName("cy")
   static int method4980(int var0, classBL var1, boolean var2, byte var3) {
      try {
         if (var0 == 8501) {
            if (var3 >= 3) {
               throw new IllegalStateException();
               ...
               byte var24;
               label135: {
                  classXG var12 = classXH.method12772(classOE.field4843.field790, classBB.field322[(classXT.field6939 -= -1297854163) * 18294437]);
                  int var14 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                  var20 = classBB.field323;
                  var22 = (classDY.field1679 += 120041229) * -324749371 - 1;
                  if (var12 != null) {
                     if (var3 >= 3) {
                        throw new IllegalStateException();
                     }
            ...
            if (var3 >= 3) {
               ...
               classXG var11 = classOE.field4843.field790.method12768(classBB.field323[(classDY.field1679 -= 120041229) * -324749371], -112924041);
            ...
            classXG var10 = classXH.method12772(classOE.field4843.field790, classBB.field322[(classXT.field6939 -= -1297854163) * 18294437]);
            ...
            if (var3 >= 3) {
               ...
               classXG var13 = classXH.method12772(classOE.field4843.field790, classBB.field322[(classXT.field6939 -= -1297854163) * 18294437]);
               if (null == var13) {
                  if (var3 >= 3) {
                     throw new IllegalStateException();
                  }

                  classPC var16 = classDZ.method3717(classIZ.method6339(var9, (byte)108), 805125283);
            ...
            if (var3 >= 3) {
               ...
               classXG var5 = classXH.method12772(classOE.field4843.field790, classBB.field322[(classXT.field6939 -= -1297854163) * 18294437]);
               if (var5 == null) {
                  if (var3 >= 3) {
                     throw new IllegalStateException();
                  }

                  classPC var6 = classDZ.method3717(classIZ.method6339(var4, (byte)124), -2100207088);
                  Object[] var10000;
         ...
         throw classEG.method3884(var8, "fs.cy(" + 41);
      }
   }
   ...
   public boolean method4976(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "fs.af(" + ')');
      }
   }
}
