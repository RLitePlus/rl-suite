...
public class classNI {
   ...
   public static void method7860(classTE var0, classTE var1, int var2) {
      try {
            ...
            if (var0.method10756(-479801780) > 1) {
               ...
               if (classYY.field7111 == var0.field6128) {
                  ...
                  if (var1 == null) {
                     ...
                     classTI.method10835((String[])classTE.method10753(var0, 1333750313), classTE.method10753(var1, 752603625), 0, var3 - 1, -452915977);
                  }
               }
         ...
         throw classEG.method3884(var4, "ni.ay(" + ')');
      }
   }
