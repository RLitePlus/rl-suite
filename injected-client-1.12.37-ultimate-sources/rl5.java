...
public class rl5 implements MenuEntry {
   ...
   @ObfuscatedName("bj")
   public final classWZ field5801;
   @ObfuscatedName("ag")
   ...
   public int getItemOp() {
      ...
      if (var1 == MenuAction.CC_OP || var1 == MenuAction.CC_OP_LOW_PRIORITY || var1 == MenuAction.RUNELITE_WIDGET) {
         ...
         if (var3 == 9764864) {
            switch (var2) {
               case 1:
                  classLW var5 = classOE.field4843.method2295(var3);
                  if (var5 != null && var4 != -1) {
                     Widget var7 = var5.getChild(var4);
   ...
   public Player getPlayer() {
      ...
      switch (this.getType()) {
         ...
         case RUNELITE_PLAYER:
            classDZ var2 = this.method10111();
            if (var2 == null) {
               return null;
            }

            return (Player)var2.field1694.method13405(var1);
         default:
            return null;
      }
   }
   ...
   @ObfuscatedName("lk")
   public classDZ method10111() {
      return classDZ.method3780(this.getWorldViewId());
   }

   @ObfuscatedSignature(descriptor = "(Lnet/runelite/api/MenuAction;)Lrl5;")
   @ObfuscatedName("ii")
   public rl5 method10117(MenuAction var1) {
      int var2 = this.field5801.field6800[this.field5802];
      short var3 = 0;
      if (var2 >= 2000) {
         var3 = 2000;
      }

      this.field5801.field6800[this.field5802] = var1.getId() + var3;
      return this;
   }
   ...
   public NPC getNpc() {
      switch (this.getType()) {
         ...
         case EXAMINE_NPC:
            classDZ var1 = this.method10111();
            int var2 = this.getIdentifier();
            return (NPC)var1.field1698.method13405(var2);
         default:
            return null;
      }
   }
   ...
   public Menu createSubMenu() {
      return this.field5801.field6806[this.field5802] = new classWZ(false);
   }
   ...
   public boolean isDeprioritized() {
      return this.field5801.field6800[this.field5802] >= 2000;
   }

   @ObfuscatedSignature(descriptor = "()Lwz;")
   @ObfuscatedName("tk")
   public classWZ method10114() {
      return this.field5801.field6806[this.field5802];
   }
   ...
   public MenuEntry setDeprioritized(boolean var1) {
      if (var1) {
         if (this.field5801.field6800[this.field5802] < 2000) {
            this.field5801.field6800[this.field5802] = this.field5801.field6800[this.field5802] + 2000;
         }
      } else if (this.field5801.field6800[this.field5802] >= 2000) {
         this.field5801.field6800[this.field5802] = this.field5801.field6800[this.field5802] - 2000;
      }
   ...
   public MenuAction getType() {
      int var1 = this.field5801.field6800[this.field5802];
      if (var1 >= 2000) {
         var1 -= 2000;
      }
   ...
   public void deleteSubMenu() {
      this.field5801.field6806[this.field5802] = null;
   }
   ...
   public int getWorldViewId() {
      return this.field5801.field6803[this.field5802];
   }

   @ObfuscatedSignature(descriptor = "(I)Lrl5;")
   @ObfuscatedName("rc")
   public rl5 method10116(int var1) {
      this.field5801.field6802[this.field5802] = var1;
      return this;
   }
   ...
   public rl5 method10113(int var1) {
      this.field5801.field6803[this.field5802] = var1;
      return this;
   }
   ...
   public int getItemId() {
      return this.field5801.field6802[this.field5802];
   }
   ...
   public rl5(classWZ var1, int var2) {
      this.field5801 = var1;
      this.field5802 = var2;
   }
}
