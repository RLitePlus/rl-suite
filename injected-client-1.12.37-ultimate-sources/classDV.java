...
public class classDV implements Hitsplat {
   ...
   int method3615(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "dv.af(" + 41);
      }
   }
   ...
   int method3619(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "dv.ae(" + 41);
      }
   }
   ...
   void method3611(int var1, int var2, int var3, byte var4) {
      ...
      try {
         ...
         throw classEG.method3884(var5, "dv.az(" + ')');
      }
   }
   ...
   int method3622(short var1) {
      try {
         ...
         throw classEG.method3884(var2, "dv.ab(" + 41);
      }
   }
   ...
   @ObfuscatedName("cd")
   static void method3627(classDZ var0, int var1, boolean var2, int var3) {
      try {
         classCT var4 = (classCT)var0.field1694.method13404(var1);
         if (null != var4) {
            if (var3 <= 1222866659) {
         ...
         throw classEG.method3884(var11, "dv.cd(" + ')');
      }
   }
      ...
      try {
         if (!classNP.field4698.isEmpty()) {
            ...
            while (var2.hasNext()) {
               ...
               classNB var3 = (classNB)var2.next();
               if (null != var3) {
                  var3.field4635 = var0 * -1016653583;
               }
            }

            classNB var5 = (classNB)classNP.field4698.get(0);
            if (var5 != null) {
               if (var1 != -9107) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var4, "dv.ae(" + ')');
      }
   }
