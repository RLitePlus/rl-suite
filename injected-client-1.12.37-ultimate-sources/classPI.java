...
@ObfuscatedName("pi")
public class classPI implements ColorTextureOverride {
   @ToRemove(unused = "true")
   @ObfuscatedName("ab")
   static final int field5264 = 8;
   @ObfuscatedSignature(descriptor = "Lfx;")
   @ObfuscatedName("aj")
   public classFX field5268;
   @ToRemove(unused = "true")
   @ObfuscatedName("ap")
   ...
   public boolean method8900(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "pi.ae(" + ')');
      }
   }
   ...
   boolean method8905(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "pi.ag(" + ')');
      }
   }
   ...
   @ObfuscatedName("cz")
   public static int method8909(classPI var0, int var1) {
      if (var0 == null) {
   ...
   int method8910(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "pi.as(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lpi;I)Z")
   @ObfuscatedName("gw")
   public static boolean method8898(classPI var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "pi.af(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lpi;I)Z")
   @ObfuscatedName("lc")
   public static boolean method8901(classPI var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lpi;I)Z")
   @ObfuscatedName("if")
   public static boolean method8902(classPI var0, int var1) {
      if (var0 == null) {
   ...
   int method8914(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "pi.ax(" + 41);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lpi;I)Z")
   @ObfuscatedName("ja")
   public static boolean method8903(classPI var0, int var1) {
   ...
   boolean method8904(int var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "pi.ab(" + ')');
      }
   }
   ...
   public static classPI method8896(int var0, classXY var1) {
      ...
      if (var3) {
         ...
         for (int var11 = 0; var11 < 2; var11++) {
            if (15 != var9[var11]) {
               short var12 = (short)classXY.method13047(var1, -958221560);
               if (var10) {
      ...
      if (var4) {
         ...
         for (int var16 = 0; var16 < 2; var16++) {
            if (15 != var14[var16]) {
               short var17 = (short)classXY.method13047(var1, -1039993073);
               if (var15) {
   ...
   @ObfuscatedSignature(descriptor = "(ILxy;)Lpi;")
   @ObfuscatedName("ac")
   public static classPI method8897(int var0, classXY var1) {
      int var2 = classXY.method13039(var1, -346779531);
      boolean var3 = (var2 & 1) != 0;
      boolean var4 = 0 != (var2 & 2);
      boolean var5 = (var2 & 4) != 0;
      ...
      if (var3) {
         ...
         for (int var11 = 0; var11 < 2; var11++) {
            if (15 != var9[var11]) {
               short var12 = (short)classXY.method13047(var1, -911564702);
               if (var10) {
                  var7.field5261[var9[var11]] = var12;
               }
            }
      ...
      if (var4) {
         ...
         for (int var16 = 0; var16 < 2; var16++) {
            if (15 != var14[var16]) {
               short var17 = (short)classXY.method13047(var1, 923550907);
               if (var15) {
                  var7.field5260[var14[var16]] = var17;
               }
            }
   ...
   public classPI(int var1) {
      classOP var2 = classOB.method8299(var1, (byte)52);
