...
@ObfuscatedName("rs")
public class classRS extends classRR implements Ignore {
   @ObfuscatedSignature(descriptor = "Lec;")
   @ObfuscatedName("mr")
   static classEC field5839;
   ...
   public int vmethod565(Object var1) {
      return method10184(this, (classRS)var1, (byte)-116);
   }
   ...
   public int vmethod562(classRR var1, int var2) {
      try {
         return method10184(this, (classRS)var1, (byte)-38);
   ...
   public int vmethod563(classRR var1) {
      return method10184(this, (classRS)var1, (byte)-51);
   }
   ...
   public int vmethod564(classRR var1) {
      return method10184(this, (classRS)var1, (byte)-94);
   }

   @ObfuscatedSignature(descriptor = "(Lrs;)I")
   @ObfuscatedName("ag")
   int method10185(classRS var1) {
   ...
   public int compareTo(Object var1) {
      try {
         return method10184(this, (classRS)var1, (byte)-28);
   ...
   @ObfuscatedName("az")
   int method10186(classRS var1, byte var2) {
      try {
         return -847650061 * this.field5836 - var1.field5836 * -847650061;
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "rs.az(" + 41);
