...
public class classPC extends classVJ {
   ...
   @ObfuscatedName("ag")
   static classJZ field5219 = new classJZ(8);
   @ObfuscatedName("ax")
   ...
   @ObfuscatedName("ab")
   public static classVA field5222;
   @ObfuscatedName("aa")
            ...
            switch (var9) {
               ...
               case 7:
                  ...
                  for (int var12 = 0; var12 < var3.length; var12++) {
                     ...
                     var6[var12] = classRN.method10130(var3[var12], 677004428).method13787(var1, 827988912);
                  }
                  break;
               case 8:
                  ...
                  for (int var11 = 0; var11 < var4.length; var11++) {
                     ...
                     var7[var11] = classRN.method10130(var4[var11], 265449944).method13787(var1, 827988912);
                  }
                  break;
               case 11:
                  ...
                  for (int var10 = 0; var10 < var5.length; var10++) {
                     ...
                     var8[var10] = classRN.method10130(var5[var10], 1939035565).method13787(var1, 827988912);
                  }
            }
         }
      }
   ...
   static void method8841(int var0, classKY var1, boolean var2, int var3) {
      try {
         classWM var4 = classIO.method6230((byte)-93);
         classGX var5 = var4.method12486(var0, 1778951456);
