...
public abstract class classTH implements classUT {
   ...
   @ObfuscatedName("az")
   static classYZ method10812(classVA var0, int var1, int var2, int var3) {
      try {
         if (!classHK.method6068(var0, var1, var2, (byte)-42)) {
            return null;
         } else {
            classYZ var5 = new classYZ();
            ...
            var5.field7126 = classRB.field5639;
            var5.field7125 = classYL.field7004[0];
   ...
   @ObfuscatedName("oa")
   public static int method10813(classGX var0) {
   ...
   @ObfuscatedName("ck")
   public static void method10811(classTD var0, Graphics var1) {
