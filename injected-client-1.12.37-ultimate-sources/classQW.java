...
public final class classQW {
   ...
   @ObfuscatedName("uf")
   public static void method9831(classDC var0, classCT var1) {
      var0.field1389.remove(var1);
   }

   @ObfuscatedSignature(descriptor = "(III)Lbl;")
   @ObfuscatedName("ae")
   static classBL method9830(int var0, int var1, int var2) {
      try {
         classBL var3 = (classBL)classBL.field491.method6422(var0 << 16);
         if (null != var3) {
            return var3;
         } else {
            ...
            if (var5 == -1) {
               ...
               byte[] var6 = classVA.method11814(classWN.field6759, var5, 1297268776);
               if (null != var6) {
                  if (var2 >= -1007302143) {
                     throw new IllegalStateException();
                  }
                  ...
                  var3 = classLW.method7156(var6, -1504310355);
                  if (var3 != null) {
                     classBL.field491.method6428(var3, var0 << 16);
                     return var3;
                  }
               }
   ...
   public static int method9828(classES var0, Object var1, Object var2) {
      ...
      return classES.method4072(var0, (classRI)var1, (classRI)var2, -834814643);
   }
