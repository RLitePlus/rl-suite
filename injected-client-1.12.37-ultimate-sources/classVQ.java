...
@ObfuscatedName("vq")
public class classVQ implements Node {
   @ObfuscatedSignature(descriptor = "Lvq;")
   @ObfuscatedName("hu")
   public classVQ field6554;
   @ObfuscatedName("ho")
   public long field6552;
   @ObfuscatedSignature(descriptor = "Lvq;")
   @ObfuscatedName("hj")
   public classVQ field6553;

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lvq;)Z")
   @ObfuscatedName("hi")
   public static boolean method12057(classVQ var0) {
      return var0.field6553 != null;
   }

   @ObfuscatedSignature(descriptor = "()Lvq;")
   @ObfuscatedName("ai")
   public classVQ method12063() {
      return this.field6553;
   }

   @ObfuscatedSignature(descriptor = "()Lvq;")
   @ObfuscatedName("id")
   public classVQ method12064() {
   ...
   @ObfuscatedName("uy")
   public static void method12061(classDZ var0, classSP var1, int var2, int var3, int var4, int var5) {
      if (var0 == null) {
         var0.method3758(var1, var2, var2, var2, var2);
      } else {
         for (classDW var6 = (classDW)var0.field1695.method7915(); var6 != null; var6 = (classDW)classNN.method7924(var0.field1695)) {
            boolean var7 = classDZ.method3753(var0, var1, var2, var6, -12900460);
