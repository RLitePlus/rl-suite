...
public class classWP extends classWT {
   ...
   @ObfuscatedName("ro")
   public static void method12609(classDL var0, classPI var1) {
      if (var0 == null) {
         var0.vmethod92();
      }
   ...
   public boolean vmethod627(byte var1) {
      try {
         ...
         throw classEG.method3884(var4, "wp.az(" + ')');
      }
   }
   ...
   public classWP(classWT var1, int var2, boolean var3, int var4) {
      ...
      if (var2 >= 0) {
         if (var3 && var2 < classNP.field4697.size()) {
            this.field6765 = (classNB)classNP.field4697.get(var2);
         } else if (!var3 && var2 < classNP.field4698.size()) {
            this.field6765 = (classNB)classNP.field4698.get(var2);
         }
