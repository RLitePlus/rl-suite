...
public class classEK extends classRD {
   ...
   @ObfuscatedName("cn")
   static classYZ field1779;

   @ObfuscatedSignature(descriptor = "(Lri;Lri;)I")
   @ObfuscatedName("ae")
   int method3904(classRI var1, classRI var2) {
   ...
   @ObfuscatedName("az")
   int method3905(classRI var1, classRI var2, short var3) {
      try {
         ...
         throw classEG.method3884(var4, "ek.az(" + 41);
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         return this.method3905((classRI)var1, (classRI)var2, (short)26972);
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "ek.compare(" + 41);
      }
   }
   ...
   public int method3907(Object var1, Object var2) {
      return this.method3905((classRI)var1, (classRI)var2, (short)28438);
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lek;Lri;Lri;)I")
   @ObfuscatedName("wk")
   public static int method3906(classEK var0, classRI var1, classRI var2) {
      if (var0 == null) {
   ...
   static classTE method3909(long[] var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var3, "ek.ay(" + ')');
      }
   }
   ...
   public static int method3908(int var0, int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "ek.aj(" + 41);
      }
   }
}
