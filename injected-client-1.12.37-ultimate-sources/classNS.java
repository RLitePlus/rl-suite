...
public class classNS {
   ...
   static int method7997(int var0, int var1) {
      try {
         classBV var2 = (classBV)classCN.field1171.get(var0);
         if (var2 == null) {
            if (var1 >= 839963150) {
   ...
   @ObfuscatedName("hu")
   public static String[] method7999(classQC var0) {
      if (var0 == null) {
         var0.method9457();
      }
   ...
   @ObfuscatedName("al")
   public static final void method8001(classLW var0, int var1, int var2, byte var3) {
      if (classBA.field305 * -782895767 == 0 || classBA.field305 * -782895767 == 3) {
         if (!classOE.field4843.isMenuOpen()) {
            int var4 = classTZ.field6261 * 1229235359;
            if (var4 == 0) {
               int var5 = client.field926 * 1762426687;
               if (client.field1136 && var5 != 0) {
                  boolean var6 = classTZ.field6255 * -38255113 >= var1
                     && classTZ.field6264 * -2144333897 >= var2
                     && classTZ.field6255 * -38255113 < var1 + var0.getWidth()
                     && classTZ.field6264 * -2144333897 < var2 + var0.getHeight();
                  if (var6) {
               ...
               int var20 = classTZ.field6266 * 1422993977 - var1;
               int var22 = classTZ.field6257 * 1243590197 - var2;
               ...
               if (var4 == 1 || !classON.field4995 && var4 == 4) {
                  ...
                  if (var8 == classTN.field6172) {
                     ...
                     int var26 = classTZ.field6255 * -38255113 - var24;
                     int var27 = classTZ.field6264 * -2144333897 - var25;
   ...
   protected static int method7998(int var0) {
      try {
            ...
            try {
               for (GarbageCollectorMXBean var3 : ManagementFactory.getGarbageCollectorMXBeans()) {
                  if (var3.isValid()) {
                     ...
                     classTQ.field6188 = 1622412589189406289L;
                     classTQ.field6199 = -6728113685686042049L;
                  }
               }
         ...
         if (classAT.field279 != null) {
            ...
            if (-1L != 3566866902695694913L * classTQ.field6199) {
               if (var0 >= 120041229) {
                  throw new IllegalStateException();
               }

               long var6 = var4 - classTQ.field6199 * 3566866902695694913L;
               long var8 = var12 - classTQ.field6188 * -5967588509917407921L;
               if (var8 != 0L) {
                  if (var0 >= 120041229) {
                     throw new IllegalStateException();
                  }
            ...
            classTQ.field6199 = var4 * 6728113685686042049L;
            classTQ.field6188 = -1622412589189406289L * var12;
         }
   ...
   @ObfuscatedName("aa")
   static boolean method8000(classDZ var0, byte[] var1, int var2, int var3, int var4) {
      try {
         return classFP.method4918(var1, var2, var3, var0.field1696 * 1296729483 - 1, -1269171107 * var0.field1692 - 1, (short)-9080);
