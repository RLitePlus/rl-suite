...
@ObfuscatedName("dz")
public class classDZ extends classVQ implements WorldView {
   ...
   public Tile getSelectedSceneTile() {
      int var1 = classOE.field4843.isMenuOpen() ? this.field1689.field2036 : this.field1689.field2026;
      int var2 = classOE.field4843.isMenuOpen() ? this.field1689.field2037 : this.field1689.field2034;
      return var1 >= this.field1689.field2144 && var2 >= this.field1689.field2148 && var1 < this.field1689.field2145 && var2 < this.field1689.field2111
         ? this.field1689.field1993[this.getPlane()][var1 + this.field1689.field2147][var2 + this.field1689.field2147]
         : null;
   }
   ...
   classKY method3726(int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.method3884(var5, "dz.ae(" + ')');
      }
   }
   ...
   public boolean method3719(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "dz.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lfn;IIII)I")
   @ObfuscatedName("bl")
   int method3763(classFN var1, int var2, int var3, int var4, int var5) {
      for (int var6 = 0; var6 < var1.field2330.length; var6++) {
         ...
         if (classEZ.method4144(var4, var5, var8, var10, var12, var7, var9, var11)) {
   ...
   public void method3779(int var1, int var2, int var3, classOM var4, int var5) {
      classDW var6 = (classDW)this.field1695.method7930();
   ...
   void method3728(int var1) {
      try {
         ...
         while (var2.hasNext()) {
            ...
            classDH var3 = (classDH)var2.next();
            var3.method3106(-1633029114);
         }
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "dz.ab(" + ')');
      }
   }
   ...
   public boolean method3729(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var4, "dz.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IB)Lct;")
   @ObfuscatedName("ax")
   classCT method3737(int var1, byte var2) {
      try {
         return (classCT)this.field1694.method13404(var1);
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "dz.ax(" + ')');
      }
   }
   ...
   void method3739(int var1, int var2, int var3, classOM var4, int var5, int var6) {
      try {
         ...
         throw classEG.method3884(var14, "dz.ac(" + ')');
      }
   }
      ...
      try {
         if (null != var4) {
            ...
            if (classOM.method8569(var4, 1754865660)) {
               ...
               for (classDW var18 = (classDW)this.field1695.method7915(); var18 != null; var18 = (classDW)classNN.method7924(this.field1695)) {
                  if (var6 <= 1) {
                     throw new IllegalStateException();
                  }
         ...
         throw classEG.method3884(var15, "dz.al(" + ')');
      }
   }
   ...
   @ObfuscatedName("bb")
   boolean method3752(classSP var1, int var2, classDW var3) {
      classSP var4 = classCL.method1601(client.field814, this.field1699 * 2140889407, -307658315);
      ...
      if (var5) {
         ...
         if (var1 != null && classOI.method8467(var1.field6026, -1821270104) != var2) {
            return false;
         }

         if (null != var4 && classOI.method8467(var4.field6026, -1821270104) != var3.method3667(-997052817)) {
            return false;
         }
   ...
   @ObfuscatedName("pu")
   public static boolean method3753(classDZ var0, classSP var1, int var2, classDW var3, int var4) {
      if (var0 == null) {
         return var0.method3756(var1, var2, var3, var2);
      } else {
         try {
            classSP var5 = classCL.method1601(client.field814, var0.field1699 * 2140889407, -4048135);
            boolean var10000;
            if (var1 == var5) {
               if (var4 >= 1009431996) {
                  throw new IllegalStateException();
            ...
            if (var6) {
               ...
               if (var1 != null) {
                  ...
                  if (classOI.method8467(var1.field6026, -1821270104) != var2) {
                     if (var4 >= 1009431996) {
                        throw new IllegalStateException();
                     }
               ...
               if (null != var5) {
                  ...
                  if (classOI.method8467(var5.field6026, -1821270104) != var3.method3667(734241976)) {
                     if (var4 >= 1009431996) {
                        throw new IllegalStateException();
                     }
            ...
            throw classEG.method3884(var9, "dz.aj(" + ')');
         }
      }
   }
   ...
   public void method3782() {
      if (classOE.field4843.method2221() != null) {
         rl10[][][] var1 = this.field1689.method4425();
         ...
         for (int var3 = 0; var3 < 104; var3++) {
            for (int var4 = 0; var4 < 104; var4++) {
               ...
               if (var5 != null) {
                  ...
                  if (this.field1689.method4389(var6.field5692)) {
                     assert var6.method10040() != null;

                     for (classDL var7 = (classDL)var5.method7931(); var7 != null; var7 = (classDL)var5.method7935()) {
   ...
   classDZ(int var1, int var2, int var3, int var4, classEX var5) {
      this.field1686 = new classNN[4][var2][var3];
      this.field1695 = new classNN();
      this.field1687 = new classGC[4];
      ...
      this.field1694 = new classYK(var1 == 0 ? 512 : 8);
      this.field1698 = new classYK(0 == var1 ? 128 : 8);
      this.field1700 = new classYN(var1 == 0 ? 32 : 1);
      ...
      for (int var7 = 0; var7 < 4; var7++) {
         this.field1687[var7] = new classGC(var2, var3, var6);
      }

      this.field1689 = new classEZ(this.method3719(-2087374717), 4, var2, var3, var4, var5, this.field1688);
      this.method3781();
   }
   ...
   void method3759(int var1) {
      try {
         for (classDW var2 = (classDW)this.field1695.method7915(); null != var2; var2 = (classDW)classNN.method7924(this.field1695)) {
            if (var1 != -1592433219) {
               return;
            }
         ...
         throw classEG.method3884(var3, "dz.aq(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()[Lgc;")
   @ObfuscatedName("rs")
   public classGC[] method3778() {
      return this.field1687;
   }

   @ObfuscatedSignature(descriptor = "(Lfn;IIIIB)I")
   @ObfuscatedName("ap")
   int method3764(classFN var1, int var2, int var3, int var4, int var5, byte var6) {
      try {
         for (int var7 = 0; var7 < var1.field2330.length; var7++) {
            ...
            if (classEZ.method4144(var4, var5, var9, var11, var13, var8, var10, var12)) {
         ...
         throw classEG.method3884(var18, "dz.ap(" + 41);
      }
   }

   public Projection getMainWorldProjection() {
      return classUU.field6384.equals(this.field1689.field2018.field1764) ? null : this.field1689.field2018;
   }

   @ObfuscatedSignature(descriptor = "(Lfj;IIIII)I")
   @ObfuscatedName("xc")
   public int method3785(classFJ var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   @ObfuscatedName("ij")
   public static boolean method3732(classDZ var0, int var1, int var2, int var3) {
      if (var0 == null) {
   ...
   @ObfuscatedName("au")
   int method3774(classFJ var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      var2 += this.field1689.field2147;
      var3 += this.field1689.field2147;
      var4 += this.field1689.field2147 << 7;
      var5 += this.field1689.field2147 << 7;
      int[][][] var8 = this.field1688;
      this.field1688 = this.field1689.field2060;
      int var16 = var6;
      int var15 = var5;
      int var14 = var4;
      int var13 = var3;
      ...
      try {
         if (var11.field2283) {
            ...
            label49: {
               classEC.method3804(0, var10.field1688, var16, var12, var13, field1704[0], field1705[0], field1706[0], 1181281029);
               classEC.method3804(1, var10.field1688, var16, var12, var13, field1704[1], field1705[1], field1706[1], 1181281029);
               ...
               for (int var18 = 0; var18 < 2; var18++) {
                  ...
                  if (classEZ.method4144(var14, var15, var20, var22, var24, var19, var21, var23)) {
                     if (var17 <= -360080939) {
                        throw new IllegalStateException();
                     }
         ...
         throw classEG.method3884(var29, "dz.au(" + 41);
      }
   ...
   int method3770(int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.method3884(var11, "dz.ai(" + 41);
      }
   }
   ...
   void method3749(int var1, int var2, int var3, classOM var4, int var5) {
      if (null != var4 && classOM.method8569(var4, 1754865660)) {
         ...
         for (classDW var16 = (classDW)this.field1695.method7915(); var16 != null; var16 = (classDW)classNN.method7924(this.field1695)) {
   ...
   @ObfuscatedName("yp")
   public static boolean method3734(classDZ var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var5, "dz.as(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lfj;IIIII)I")
   @ObfuscatedName("cr")
   int method3766(classFJ var1, int var2, int var3, int var4, int var5, int var6) {
      if (var1.field2283) {
         return this.field1688[var6][var2][var3];
      } else {
         classEC.method3804(0, this.field1688, var6, var2, var3, field1704[0], field1705[0], field1706[0], 1181281029);
         classEC.method3804(1, this.field1688, var6, var2, var3, field1704[1], field1705[1], field1706[1], 1181281029);
   ...
   void method3723() {
      ...
      classYN.method13579(this.field1700);
      ...
      this.field1689.method4491();

      for (int var4 = 0; var4 < 4; var4++) {
         classGC.method5324(this.field1687[var4], (byte)-61);
      }
   }
   ...
   @ObfuscatedName("ay")
   void method3757(classSP var1, int var2, int var3, int var4, int var5, byte var6) {
      try {
         for (classDW var7 = (classDW)this.field1695.method7915(); var7 != null; var7 = (classDW)classNN.method7924(this.field1695)) {
            if (var6 == 21) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.method3884(var15, "dz.ay(" + ')');
      }
   }
   ...
   public void method3781() {
      this.field1689.field2150 = this;
      this.field1689.field2112 = this.field1699 * 2140889407;
      this.field1689.field2159 = this.field1702;
   }
   ...
   @ObfuscatedName("bg")
   void method3740(classDN var1) {
      if (var1.field1581.method8998((byte)-118)) {
   ...
   @ObfuscatedName("zm")
   public static classDZ method3780(int var0) {
      return var0 == -1 ? classIS.field3053 : client.field814.method1634(var0);
   }

   @ObfuscatedSignature(descriptor = "(I)Lct;")
   @ObfuscatedName("hk")
   public classCT method3786(int var1) {
      return this.method3737(var1, (byte)1);
   }

   public Projection getCanvasProjection() {
      if (this.field1689.field2024 instanceof classEI) {
         classEI var1 = (classEI)this.field1689.field2024;
         if (classUU.field6384.equals(var1.field1764)) {
            return null;
         }
      }

      return this.field1689.field2024;
   }
   ...
   final int method3777(int var1, int var2, int var3, byte var4) {
      int var5 = (var1 >> 7) + this.field1689.field2147;
      int var6 = (var2 >> 7) + this.field1689.field2147;
      int var7 = this.field1689.field2147 << 1;
      if (var5 >= 0 && var6 >= 0 && var5 < this.field1696 * 1296729483 + var7 && var6 < this.field1692 * -1269171107 + var7) {
         rl10 var8 = this.field1689.field1993[var3][var5][var6];
         int var9 = var3;
         if (var3 < 3 && (this.field1689.field2159[1][var5][var6] & 2) == 2) {
            var9 = var3 + 1;
         }

         int var10 = -2147483647;
         if (var8 != null) {
            classFN var11 = var8.method10035();
            if (var11 != null) {
               var10 = this.method3789(var11, -1, -1, var1, var2);
            }

            classFJ var12 = var8.method10033();
         ...
         if (var8 != null) {
            classEO var13 = var8.method10039();
            if (var13 != null) {
   ...
   @ObfuscatedName("fm")
   public static boolean method3721(classDZ var0) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldn;)V")
   @ObfuscatedName("bt")
   void method3741(classDN var1) {
      if (var1.field1581.method8998((byte)-117)) {
         classCH var2 = new classCH(var1);
         classNN.method7900(this.field1695, var2);
      }
   }
   ...
   @ObfuscatedName("bo")
   void method3743() {
      for (classDW var1 = (classDW)this.field1695.method7915(); null != var1; var1 = (classDW)classNN.method7924(this.field1695)) {
   ...
   @ObfuscatedName("nb")
   public static int method3760(classDZ var0, int var1, int var2, int var3) {
      if (var0 == null) {
      ...
      if (var4 >= 0 && var5 >= 0 && var4 < var0.field1702[0].length && var5 < var0.field1702[0][0].length) {
         ...
         classEW var7 = var0.field1689.field2058[var3][var4][var5];
         int var8 = -2147483647;
         ...
         if (var7 != null) {
            classEO var9 = var7.method4088(-1348999018);
            if (var9 != null) {
   ...
   public int getTileHeight(int var1, int var2, int var3) {
      int var4 = (var1 >> 7) + this.field1689.field2147;
      int var5 = (var2 >> 7) + this.field1689.field2147;
      int var6 = this.field1689.field2147 << 1;
      if (var4 >= 0 && var5 >= 0 && var4 < this.field1696 * 1296729483 + var6 && var5 < this.field1692 * -1269171107 + var6) {
         int var7 = var3;
         if (var3 > 0 && (this.field1689.field2159[1][var4][var5] & 2) == 2) {
            var7 = var3 - 1;
         }

         rl10 var8 = this.field1689.field1993[var7][var4][var5];
         int var9 = -2147483647;
         if (var8 != null) {
            classFN var10 = var8.method10035();
            if (var10 != null) {
               var9 = this.method3789(var10, -1, -1, var1, var2);
            }

            classFJ var11 = var8.method10033();
         ...
         if (var8 != null) {
            classEO var12 = var8.method10039();
            if (var12 != null) {
   ...
   @ObfuscatedName("aa")
   void method3742(classDN var1, byte var2) {
      try {
         if (var1.field1581.method8998((byte)-109)) {
            if (var2 == 0) {
               return;
            }
         ...
         throw classEG.method3884(var4, "dz.aa(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;I)V")
   @ObfuscatedName("kd")
   public static void method3724(classDZ var0, int var1) {
      if (var0 == null) {
      ...
      try {
         ...
         classYN.method13579(var0.field1700);
         ...
         for (int var6 = 0; var6 < 4; var6++) {
            ...
            classGC.method5324(var0.field1687[var6], (byte)-61);
         }
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "dz.af(" + ')');
      }
   }
   ...
   void method3725() {
      ...
      for (int var4 = 0; var4 < 4; var4++) {
         classGC.method5324(this.field1687[var4], (byte)-50);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;ILdw;)Z")
   @ObfuscatedName("bi")
   boolean method3754(classSP var1, int var2, classDW var3) {
      classSP var4 = classCL.method1601(client.field814, this.field1699 * 2140889407, -1301152667);
      boolean var5 = var1 == var4;
      if (var5) {
         ...
         if (null != var4 && classOI.method8467(var4.field6026, -1821270104) != var3.method3667(-90354477)) {
            return false;
         }
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;ILdw;)Z")
   @ObfuscatedName("be")
   boolean method3755(classSP var1, int var2, classDW var3) {
      classSP var4 = classCL.method1601(client.field814, this.field1699 * -2041911845, 969897101);
      boolean var5 = var1 == var4;
      if (var5) {
         ...
         if (null != var4 && classOI.method8467(var4.field6026, -1821270104) != var3.method3667(-1883809231)) {
            return false;
         }
   ...
   @ObfuscatedName("zz")
   public static void method3745(classDZ var0, byte var1) {
      if (var0 == null) {
         var0.method3747(var1);
      } else {
         try {
            for (classDW var2 = (classDW)var0.field1695.method7915(); null != var2; var2 = (classDW)classNN.method7924(var0.field1695)) {
               if (var1 == 7) {
                  throw new IllegalStateException();
               }
            ...
            throw classEG.method3884(var3, "dz.ao(" + ')');
         }
      }
   }
   ...
   final int method3761(int var1, int var2, int var3) {
      ...
      if (var4 >= 0 && var5 >= 0 && var4 < this.field1702[0].length && var5 < this.field1702[0][0].length) {
         ...
         classEW var7 = this.field1689.field2058[var3][var4][var5];
         int var8 = -2147483647;
         if (null != var7 && null != var7.field1973) {
         ...
         if (var7 != null) {
            classEO var9 = var7.method4088(-1671345169);
            if (var9 != null) {
               int var10 = classCN.method2552(5132338419383099835L * var9.field1815);
   ...
   final int method3762(int var1, int var2, int var3) {
      ...
      if (var4 >= 0 && var5 >= 0 && var4 < this.field1702[0].length && var5 < this.field1702[0][0].length) {
         ...
         if (var7 != null) {
            classEO var9 = var7.method4088(-1691787276);
            if (var9 != null) {
               int var10 = classCN.method2552(5132338419383099835L * var9.field1815);
   ...
   @ObfuscatedSignature(descriptor = "(Lfn;IIII)I")
   @ObfuscatedName("bd")
   int method3765(classFN var1, int var2, int var3, int var4, int var5) {
      for (int var6 = 0; var6 < var1.field2330.length; var6++) {
         int var7 = var1.field2322[var1.field2330[var6]];
         int var8 = var1.field2327[var1.field2330[var6]];
         int var9 = var1.field2322[var1.field2331[var6]];
   ...
   public Projectile createProjectile(
      ...
      return classOE.field4843.method2271(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13);
   }

   @ObfuscatedSignature(descriptor = "(Lfj;IIIII)I")
   @ObfuscatedName("bv")
   int method3767(classFJ var1, int var2, int var3, int var4, int var5, int var6) {
      if (var1.field2283) {
         return this.field1688[var6][var2][var3];
      } else {
         classEC.method3804(0, this.field1688, var6, var2, var3, field1704[0], field1705[0], field1706[0], 1181281029);
   ...
   @ObfuscatedName("ih")
   public static int method3768(classDZ var0, classFJ var1, int var2, int var3, int var4, int var5, int var6) {
      if (var0 == null) {
         var0.method3720();
      }
      ...
      if (var1.field2283) {
         ...
         classEC.method3804(0, var0.field1688, var6, var2, var3, field1704[0], field1705[0], field1706[0], 1181281029);
         classEC.method3804(1, var0.field1688, var6, var2, var3, field1704[1], field1705[1], field1706[1], 1181281029);
   ...
   public int method3772(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var3 & 127;
      int var7 = var4 & 127;
      int var8 = this.field1689.field2060[var5][var1][var2] * (128 - var6) + var6 * this.field1689.field2060[var5][var1 + 1][var2] >> 7;
      int var9 = this.field1689.field2060[var5][var1 + 1][var2 + 1] * var6 + this.field1689.field2060[var5][var1][var2 + 1] * (128 - var6) >> 7;
   ...
   @ObfuscatedSignature(descriptor = "(Lfj;IIIII)I")
   @ObfuscatedName("bz")
   int method3769(classFJ var1, int var2, int var3, int var4, int var5, int var6) {
      if (var1.field2283) {
         return this.field1688[var6][var2][var3];
      } else {
         classEC.method3804(0, this.field1688, var6, var2, var3, field1704[0], field1705[0], field1706[0], 1181281029);
   ...
   public static classPC method3717(int var0, int var1) {
      try {
         ...
         if (null != var2) {
            ...
            var2 = new classPC(new classXY(var3), var0);
            classPC.field5219.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "dz.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("dw")
   static void method3773(classDZ var0, int var1, int var2, int var3, int var4, int var5, short var6, int var7, short var8, int var9, int var10, int var11) {
      try {
         ...
         if (var12 != null) {
            ...
            for (classDL var13 = (classDL)var12.method7915(); var13 != null; var13 = (classDL)classNN.method7924(var12)) {
               if (var11 == -1151520074) {
                  return;
               }
               ...
               if (-1370204663 * var13.field1552 == var4) {
                  ...
                  if (var13.field1554 * 1413659045 == var5) {
                     classPI var14 = var13.method3399((short)-15479);
                     if (null == var14) {
                        if (var11 == -1151520074) {
                           throw new IllegalStateException();
                        }

                        var14 = new classPI(var4);
                     }

                     if (classPI.method8898(var14, -1606068063)) {
                        if (var11 == -1151520074) {
                           throw new IllegalStateException();
                        }
         ...
         throw classEG.method3884(var15, "dz.dw(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lfn;IIII)I")
   @ObfuscatedName("ao")
   public int method3789(classFN var1, int var2, int var3, int var4, int var5) {
   ...
   void method3747(byte var1) {
      try {
         for (classDW var2 = (classDW)this.field1695.method7922(); null != var2; var2 = (classDW)classNN.method7924(this.field1695)) {
            if (var1 == 7) {
               throw new IllegalStateException();
            }
   ...
   @ObfuscatedName("aj")
   boolean method3756(classSP var1, int var2, classDW var3, int var4) {
      try {
         classSP var5 = classCL.method1601(client.field814, this.field1710 * 2140889407, -4048135);
         boolean var10000;
         if (var1 == var5) {
            if (var4 >= 1009431996) {
               throw new IllegalStateException();
   ...
   @ObfuscatedName("by")
   void method3758(classSP var1, int var2, int var3, int var4, int var5) {
      for (classDW var6 = (classDW)this.field1695.method7912(); var6 != null; var6 = (classDW)classNN.method7924(this.field1695)) {
