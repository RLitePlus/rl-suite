...
public class classPO implements classOZ, EntityOps {
   ...
   int method9074(int var1, int[] var2, int var3) {
      try {
         classPT var5 = (classPT)classPT.field5418.method6422(var1);
         classPT var4;
         if (null != var5) {
            if (var3 <= -2054679977) {
               throw new IllegalStateException();
            ...
            byte[] var6 = classPT.field5423.method11867(14, var1, -1355154202);
            var5 = new classPT(new classXY(var6));
            classPT.field5418.method6428(var5, var1);
            var4 = var5;
         }
   ...
   int method9075(int var1, int[] var2) {
      classPT var4 = (classPT)classPT.field5418.method6422(var1);
      classPT var3;
      if (null != var4) {
         var3 = var4;
      } else {
         byte[] var5 = classPT.field5423.method11867(14, var1, -1738556661);
         var4 = new classPT(new classXY(var5));
         classPT.field5418.method6428(var4, var1);
         var3 = var4;
      }
   ...
   int method9076(int var1, int[] var2) {
      ...
      if (null != var4) {
         ...
         byte[] var5 = classPT.field5423.method11867(14, var1, -2140708705);
         var4 = new classPT(new classXY(var5));
         classPT.field5418.method6428(var4, var1);
         var3 = var4;
      }
   ...
   int method9077(int var1, int[] var2) {
      ...
      if (null != var4) {
         ...
         byte[] var5 = classPT.field5423.method11867(14, var1, -1766660822);
         var4 = new classPT(new classXY(var5));
         classPT.field5418.method6428(var4, var1);
         var3 = var4;
      }
