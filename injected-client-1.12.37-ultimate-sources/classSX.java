...
public class classSX {
   ...
   @ObfuscatedName("ag")
   public static classCT method10701(int var0, classCL var1) {
      classCT var2 = null;
   ...
   @ObfuscatedName("aa")
   public static classDN method10705(int var0, classCL var1) {
      for (classDZ var3 : var1) {
         classDN var4 = (classDN)var3.field1698.method13404(var0);
         if (var4 != null) {
            return var4;
         }
      }
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Lct;")
   @ObfuscatedName("as")
   public static classCT method10702(int var0, classCL var1) {
      classCT var2 = null;
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Lct;")
   @ObfuscatedName("ac")
   public static classCT method10703(int var0, classCL var1) {
      classCT var2 = null;
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Lct;")
   @ObfuscatedName("ax")
   public static classCT method10704(int var0, classCL var1) {
      classCT var2 = null;
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Ldn;")
   @ObfuscatedName("ao")
   public static classDN method10706(int var0, classCL var1) {
      for (classDZ var3 : var1) {
         classDN var4 = (classDN)var3.field1698.method13404(var0);
         if (var4 != null) {
            return var4;
   ...
   @ObfuscatedName("al")
   public static classDZ method10707(int var0, classCL var1) {
      for (classDZ var3 : var1) {
         classCT var4 = (classCT)var3.field1694.method13404(var0);
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Ldz;")
   @ObfuscatedName("aj")
   public static classDZ method10708(int var0, classCL var1) {
      for (classDZ var3 : var1) {
         classCT var4 = (classCT)var3.field1694.method13404(var0);
         if (null != var4 && !var3.method3719(-2087374717)) {
            return var3;
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Ldz;")
   @ObfuscatedName("ay")
   public static classDZ method10709(int var0, classCL var1) {
      for (classDZ var3 : var1) {
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Ldz;")
   @ObfuscatedName("aq")
   public static classDZ method10710(int var0, classCL var1) {
      for (classDZ var3 : var1) {
         if (var3.field1698.method13404(var0) != null) {
            return var3;
         }
   ...
   @ObfuscatedName("fx")
   public static boolean method10712(classCM var0) {
      if (var0 == null) {
         var0.method2519();
      }
   ...
   @ObfuscatedName("ac")
   static classCM method10711(int var0) {
      try {
         return -932636273 * classCM.field1156 < classCM.field1153 * -622036481 ? classCM.field1170[(classCM.field1156 += 2111825263) * -932636273 - 1] : null;
