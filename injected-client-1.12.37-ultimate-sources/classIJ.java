...
public class classIJ extends classHB {
   ...
   static final void method6216(String var0, int var1) {
      try {
         if (var0.equals("")) {
            ...
            classJL var2 = classEF.method3849(classJS.FRIENDCHAT_JOIN_LEAVE, client.field795.field1535, (byte)-48);
            classXY.method12971(var2.field3343, classAU.method712(var0, (byte)59), (byte)-76);
            classXY.method12997(var2.field3343, var0, (short)19626);
            client.field795.method3367(var2, -1301097035);
         }
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "ij.gt(" + ')');
      }
   }
   ...
   void vmethod501(classXY var1) {
      this.field2976 = classXY.method13047(var1, 1811243603) * -595538065;
   }
   ...
   void vmethod498(classXY var1, int var2) {
      try {
         this.field2976 = classXY.method13047(var1, -518976421) * -595538065;
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "ij.az(" + ')');
      }
   }
   ...
   void vmethod500(classXY var1) {
      this.field2976 = classXY.method13047(var1, -1405582422) * -378118865;
   }
   ...
   void vmethod502(classIQ var1) {
      classIQ.method6255(var1, 1779789711 * this.field2976, 702383331);
   }
   ...
   void vmethod503(classIQ var1) {
      classIQ.method6255(var1, 1779789711 * this.field2976, 434519228);
   }
   ...
   void vmethod504(classIQ var1) {
      classIQ.method6255(var1, 1779789711 * this.field2976, 55426774);
   }
   ...
   void vmethod499(classIQ var1, byte var2) {
      try {
         classIQ.method6255(var1, 1779789711 * this.field2976, 1185036733);
      } catch (RuntimeException var3) {
         throw classEG.method3884(var3, "ij.af(" + ')');
      }
   }
   ...
   public static void method6215(ArrayList var0, int var1, int var2, int var3, int var4, boolean var5, int var6) {
      try {
         if (var0.isEmpty()) {
            ...
            if (var5) {
               ...
               for (int var7 = 0; var7 < classNP.field4698.size(); var7++) {
                  classNB var8 = (classNB)classNP.field4698.get(var7);
                  if (var8 == null) {
                     if (var6 >= 492858962) {
                        throw new IllegalStateException();
                     }
            ...
            if (classNP.field4697.isEmpty()) {
               ...
               if (!classNP.field4698.isEmpty()) {
                  ...
                  while (var11.hasNext()) {
                     ...
                     classNB var12 = (classNB)var11.next();
                     var10.add(var12);
                  }
         ...
         throw classEG.method3884(var13, "ij.af(" + ')');
      }
   }
}
