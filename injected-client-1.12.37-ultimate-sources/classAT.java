...
public class classAT {
   ...
   classAJ method667(int var1, int var2, int[] var3, int var4) {
      try {
         ...
         throw classEG.method3884(var10, "at.az(" + ')');
      }
   }
   ...
   classAJ method674(int var1, int[] var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "at.ae(" + ')');
      }
   }
   ...
   public static long method687(classAT var0, int var1, int var2, boolean var3, int var4) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var6, "at.as(" + ')');
         }
      }
   }
   ...
   public classAU method678(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "at.ab(" + ')');
      }
   }
   ...
   public classAJ method684(int var1, byte var2) {
      try {
         ...
         throw classEG.method3884(var3, "at.ag(" + ')');
      }
   }
   ...
   public static void method693(int[] var0, Object[] var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.method3884(var13, "at.ay(" + ')');
      }
   }
   ...
   classAU method673(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var9, "at.af(" + ')');
      }
   }
   ...
   static void method694(
      classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, String[] var9, int var10, int var11, int var12
   ) {
      try {
         ...
         throw classEG.method3884(var16, "at.df(" + ')');
      }
   }
   ...
   public static classAE method666(classAS var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "at.az(" + ')');
      }
   }

   public classAT(classVA var1, classVA var2) {
      new classYI(256);
      this.field272 = new classYI(256);
      this.field274 = var1;
      this.field273 = var2;
   }
