...
public abstract class classHA {
   ...
   @ObfuscatedName("ab")
   static final void method5982(classDZ var0, byte[] var1, int var2, int var3, int var4, int var5, byte var6) {
      try {
         if (var0.field1687 != null) {
            ...
            for (int var7 = 0; var7 < 4; var7++) {
               ...
               classGC var8 = var0.field1687[var7];
   ...
   static final void method5989(double var0) {
      try {
         ...
         ((classEC)classFH.field2257.field2239).method3811(var0);
