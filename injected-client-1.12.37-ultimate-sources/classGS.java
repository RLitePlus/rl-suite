...
@ObfuscatedName("gs")
public class classGS extends classHD {
   @ObfuscatedSignature(descriptor = "Lmj;")
   @ObfuscatedName("lw")
   static classMJ field2677;
   @ObfuscatedSignature(descriptor = "Lgr;")
   @ObfuscatedName("af")
   final classGR field2671;
   @ObfuscatedName("ae")
   int field2672;
   ...
   int vmethod494(short var1) {
      try {
         ...
         throw classEG.method3884(var2, "gs.ag(" + 41);
      }
   }
   ...
   public int vmethod486(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "gs.af(" + 41);
      }
   }
   ...
   classGS(classKY var1, classKY var2, int var3, classGR var4) {
      super(var1, var2);
   ...
   void method5739() {
      ...
      this.field2676 = this.field2671.method5725(classFJ.method4796(438436917 * this.field2672, (byte)-120), 2100600624);
      classPS var1 = classFJ.method4796(this.vmethod486((byte)-56), (byte)-127);
      classYM var2 = var1.method9199(false, -1091971536);
      if (null != var2) {
   ...
   void method5740() {
      ...
      this.field2676 = this.field2671.method5725(classFJ.method4796(438436917 * this.field2672, (byte)-100), 2116896056);
      classPS var1 = classFJ.method4796(this.vmethod486((byte)-100), (byte)-88);
      classYM var2 = var1.method9199(false, -1028849822);
      if (null != var2) {
   ...
   public static void method5741(classGS var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            var0.field2676 = var0.field2671.method5725(classFJ.method4796(438436917 * var0.field2672, (byte)-117), 1548070523);
            classPS var2 = classFJ.method4796(var0.vmethod486((byte)-77), (byte)-60);
            classYM var3 = var2.method9199(false, -979775303);
            if (null != var3) {
               if (var1 >= -550936162) {
            ...
            throw classEG.method3884(var4, "gs.az(" + ')');
         }
      }
   }
   ...
   classHW vmethod491(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "gs.ae(" + ')');
      }
   }
   ...
   public static void method5742(classGS var0) {
      ...
      var0.field2676 = var0.field2671.method5725(classFJ.method4796(438436917 * var0.field2672, (byte)-86), 1683798244);
      classPS var1 = classFJ.method4796(var0.vmethod486((byte)-71), (byte)-23);
      classYM var2 = var1.method9199(false, 696385653);
      if (null != var2) {
   ...
   int vmethod493(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "gs.ab(" + 41);
      }
   }
   ...
   public static void method5744(int[] var0, long[] var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.method3884(var15, "gs.ac(" + ')');
      }
   }
   ...
   void method5743(int var1) {
      try {
         ...
         this.field2676 = this.field2671.method5725(classFJ.method4796(438436917 * this.field2672, (byte)-117), 1548070523);
         classPS var2 = classFJ.method4796(this.vmethod486((byte)-77), (byte)-60);
         classYM var3 = var2.method9199(false, -979775303);
         if (null != var3) {
            if (var1 >= -550936162) {
               throw new IllegalStateException();
