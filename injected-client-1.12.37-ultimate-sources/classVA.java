...
@ObfuscatedName("va")
public abstract class classVA implements IndexDataBase {
   @ObfuscatedName("bs")
   Object[][] field6457;
   ...
   @ObfuscatedName("cc")
   public static boolean method11802(classVA var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("nc")
   public static boolean method11841(classVA var0, int var1, int[] var2) {
      if (var0 == null) {
         ...
         if (var6) {
            ...
            if (null == var2 || var2[0] == 0 && 0 == var2[1] && 0 == var2[2] && var2[3] == 0) {
               var19 = classLC.method6663(var0.field6453[var1], false, -174334988);
            } else {
               var19 = classLC.method6663(var0.field6453[var1], true, -174334988);
   ...
   @ObfuscatedName("bg")
   public static byte[] method11813(classVA var0, int var1) {
            ...
            if (var7) {
               ...
               label188: {
                  label187: {
                     ...
                     var21 = classLC.method6663(this.field6453[var1], false, -174334988);
                     break label188;
                  }

                  var21 = classLC.method6663(this.field6453[var1], true, -174334988);
   ...
   classVA(boolean var1, boolean var2) {
      this.field6437 = var1;
      this.field6436 = var2;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I)Z")
   @ObfuscatedName("se")
   public static boolean method11803(classVA var0, int var1) {
      if (1 == var0.field6457.length) {
   ...
   @ObfuscatedName("xp")
   public static void method11838(classVA var0) {
      if (var0 == null) {
   ...
   boolean method11843(int var1, int[] var2) {
      if (null == this.field6453[var1]) {
         ...
         if (var6) {
            ...
            byte[] var19;
            if (null == var2 || var2[0] == 0 && 0 == var2[1] && 0 == var2[2] && var2[3] == 0) {
               var19 = classLC.method6663(this.field6453[var1], false, -174334988);
            } else {
               var19 = classLC.method6663(this.field6453[var1], true, -174334988);
               classXY var8 = new classXY(var19);
               var8.method13136(var2, 5, var8.field6954.length, -1664008178);
            }
   ...
   static boolean method11864(int var0) {
      try {
         boolean var10000;
         if (classCY.method2793(classAB.field122, (byte)-115) >= 347524667 * client.field886) {
            if (var0 != -2053271753) {
               throw new IllegalStateException();
            }
   ...
   public byte[] method11817(int var1, int var2) {
      if (var1 >= 0 && var1 < this.field6457.length && this.field6457[var1] != null && var2 >= 0 && var2 < this.field6457[var1].length) {
         ...
         return classLC.method6663(this.field6457[var1][var2], false, -174334988);
      } else {
         return null;
      }
   }
   ...
   @ObfuscatedName("lc")
   public static byte[] method11814(classVA var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("rz")
   public static boolean method11860(classVA var0, String var1, String var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("dk")
   public static byte[] method11855(classVA var0, String var1, String var2) {
      if (var0 == null) {
         var0.isOverlayOutdated();
      }
   ...
   @ObfuscatedName("nq")
   public static boolean method11853(classVA var0, String var1, String var2, int var3) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("bn")
   public static void method11836(classVA var0) {
      if (var0 == null) {
         var0.method11812();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;II)[B")
   @ObfuscatedName("by")
   public static byte[] method11822(classVA var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("yb")
   public static int[] method11828(classVA var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I[I)Z")
   @ObfuscatedName("vp")
   public static boolean method11844(classVA var0, int var1, int[] var2) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I)Z")
   @ObfuscatedName("jt")
   public static boolean method11806(classVA var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I)[B")
   @ObfuscatedName("as")
   public static byte[] method11815(classVA var0, int var1) {
      if (var0 == null) {
   ...
   byte[] method11799(int var1, int var2, int[] var3) {
      if (var1 >= 0 && var1 < this.field6457.length && null != this.field6457[var1] && var2 >= 0 && var2 < this.field6457[var1].length) {
         ...
         byte[] var6 = classLC.method6663(this.field6457[var1][var2], false, -174334988);
         if (this.field6436) {
            this.field6457[var1][var2] = null;
         }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;Ljava/lang/String;Ljava/lang/String;)Z")
   @ObfuscatedName("gr")
   public static boolean method11861(classVA var0, String var1, String var2) {
      if (var0 == null) {
   ...
   public static byte[] method11882(Object var0, boolean var1) {
      return classLC.method6663(var0, var1, -174334988);
   }
