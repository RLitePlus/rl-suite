...
public class classXM {
   ...
   @ObfuscatedName("wn")
   public static boolean method12844(classWM var0, int var1) {
   ...
   @ObfuscatedName("ga")
   public static void method12843(classGR var0, classHD var1, classPS var2, int var3, int var4, float var5) {
      if (var0 == null) {
         var0.method5637();
      } else {
         ...
         if (null != var6) {
            if (var6.field2901.method6087(var5, 1247117025)) {
               classZV var7 = (classZV)var0.field2661.get(var6.field2901);
               var7.method66(
                  var6.field2900,
   ...
   public int method12840(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "xm.az(" + 41);
      }
   }
