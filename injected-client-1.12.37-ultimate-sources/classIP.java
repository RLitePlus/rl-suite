...
public class classIP extends classHB {
   ...
   @ObfuscatedName("bx")
   static int method6232(int var0, classBL var1, boolean var2, int var3) {
      try {
         classLW var4 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)89);
         if (var0 == 2500) {
            if (var3 != 1804259678) {
            ...
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var4.field4249 * 1115597881;
            return 1;
         } else if (2503 == var0) {
            if (var3 != 1804259678) {
               throw new IllegalStateException();
            ...
            if (var3 != 1804259678) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var4.field4342 * -1502647899;
               return 1;
            }
         } else if (2506 == var0) {
            if (var3 != 1804259678) {
