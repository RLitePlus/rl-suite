...
public class classCU implements classXZ {
   ...
   @ObfuscatedName("bl")
   static void method2676(classCT var0, int var1, int var2, int var3) {
      try {
         if (var0 == null) {
            if (var3 == 1659085546) {
            ...
            classOU var4 = var0.field1465.method9731((byte)44);
         ...
         throw classEG.method3884(var6, "cu.bl(" + ')');
      }
   }
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "cu.az(" + 41);
      }
   }
   ...
   static void method2678(int var0, int var1) {
      try {
         classDZ var2 = client.field814.method1590(var0, (short)-6788);
         if (var2 == null) {
            if (var1 == -1615596217) {
               throw new IllegalStateException();
            }
            ...
            for (int var3 = 0; var3 < -2087374717 * client.field837.field1419; var3++) {
               ...
               classDF.method3041(client.field837, (classCT)var2.field1694.method13404(var4), -406854399);
            }

            classCL.method1583(client.field814, var0, (byte)-1);
         }
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "cu.ej(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;Lcd;I)V")
   @ObfuscatedName("da")
   static final void method2677(classDZ var0, classCD var1, int var2) {
      try {
         classEZ var3 = var0.field1689;
         long var4 = 0L;
         int var6 = -1;
         int var7 = 0;
         int var8 = 0;
         ...
         if (var4 != 0L) {
            ...
            int var9 = classEZ.method4462(var3, -1436432311 * var1.field679, -1779660971 * var1.field676, -522576623 * var1.field680, var4);
         ...
         throw classEG.method3884(var10, "cu.da(" + ')');
      }
   }
   ...
   @ObfuscatedName("as")
   public static classZV method2675(classVA var0, classVA var1, String var2, String var3, int var4) {
      try {
         if (!classVA.method11853(var0, var2, var3, 2038265183)) {
            if (var4 == 896511757) {
               throw new IllegalStateException();
            } else {
               return null;
         ...
         throw classEG.method3884(var11, "cu.as(" + ')');
      }
   }
}
