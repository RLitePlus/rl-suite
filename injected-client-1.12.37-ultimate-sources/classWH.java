...
public class classWH {
   ...
   int method12369(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "wh.af(" + 41);
      }
   }
   ...
   public static int method12375(classWH var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "wh.ab(" + 41);
         }
      }
   }
   ...
   @ObfuscatedName("fn")
   public static void method12365(classWH var0, classGX var1) {
      if (var0 == null) {
         var0.method12372();
      }
   ...
   boolean method12373(short var1) {
      try {
         ...
         throw classEG.method3884(var2, "wh.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lwh;Lgx;B)V")
   @ObfuscatedName("ra")
   public static void method12366(classWH var0, classGX var1, byte var2) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var3, "wh.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   void method12367(classGX var1, byte var2) {
      try {
         if (null == var1) {
            if (var2 == 1) {
               throw new IllegalStateException();
