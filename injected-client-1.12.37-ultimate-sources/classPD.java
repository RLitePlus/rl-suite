...
public final class classPD {
   ...
   static void method8845(String var0, int var1, byte var2) {
      try {
         ...
         var3.add(new classNB(classFC.field2208, var0, "", var1, false));
         classIJ.method6215(var3, 0, 0, 0, 100, false, -1473723703);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "pd.br(" + ')');
      }
   }
   ...
   @ObfuscatedName("ai")
   public static classTE method8843(classXY var0, boolean var1, int var2) {
      try {
         int var3 = classXY.method13047(var0, 1206608293);
         if (var3 >= 0) {
            if (var2 != -193629541) {
                        ...
                        if (var4 != 3) {
                           if (var4 == 4) {
                              ...
                              if (var1) {
                                 ...
                                 var15 = classFJ.method4804(var11, -1179293840);
                              } else {
         ...
         throw classEG.method3884(var9, "pd.ai(" + ')');
      }
   }
   ...
   static String method8844(String var0, boolean var1, int var2) {
      try {
         ...
         throw classEG.method3884(var7, "pd.aa(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;B)V")
   @ObfuscatedName("az")
   public static void method8842(classVA var0, byte var1) {
      try {
         classZE.field7177 = var0;
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "pd.az(" + ')');
      }
   }
}
