...
@ObfuscatedName("fp")
public class classFP implements AABB {
   @ObfuscatedName("az")
   final int field2364;
   @ObfuscatedName("af")
   int field2367;
   ...
   @ObfuscatedName("ck")
   static classYZ field2372;
   @ObfuscatedSignature(descriptor = "[Lyz;")
   @ObfuscatedName("mj")
   static classYZ[] field2373;
   ...
   int method4900(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fp.az(" + 41);
      }
   }
   ...
   int method4902(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fp.af(" + 41);
      }
   }
   ...
   int method4905(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fp.ae(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lfp;B)I")
   @ObfuscatedName("xz")
   public static int method4909(classFP var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "fp.ab(" + 41);
         }
      }
   }
   ...
   int method4912(int var1) {
      try {
         ...
         throw classEG.method3884(var2, "fp.ag(" + 41);
      }
   }
   ...
   int method4915(byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "fp.as(" + 41);
      }
   }
   ...
   @ObfuscatedName("zk")
   public static void method4917(classCT var0) {
      if (var0 == null) {
         var0.isClanMember();
      }
         ...
         while (true) {
            ...
            while (true) {
               while (!var11) {
                  ...
                  int var15 = classXY.method13039(var7, -346779531) >> 2;
               ...
               classXY.method13039(var7, -346779531);
            }
         }
      } catch (RuntimeException var20) {
         throw classEG.method3884(var20, "fp.al(" + ')');
      }
   }
   ...
   static void method4919(int var0) {
      try {
         client.field974.field6797 = 0;
         client.field974.method12696(-1);
         client.field973 = false;
      } catch (RuntimeException var1) {
         throw classEG.method3884(var1, "fp.eq(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;I)V")
   @ObfuscatedName("az")
   public static void method4899(classVA var0, int var1) {
      try {
         classPH.field5254 = var0;
      } catch (RuntimeException var2) {
         throw classEG.method3884(var2, "fp.az(" + ')');
      }
   }

   classFP(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
