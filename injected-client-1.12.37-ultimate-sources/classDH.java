...
@ObfuscatedName("dh")
public abstract class classDH extends classEE implements classYB, Actor {
   @ObfuscatedName("dz")
   int field1454;
   @ObfuscatedSignature(descriptor = "Ldh;")
   @ObfuscatedName("fb")
   public static classDH field1499;
   @ObfuscatedName("du")
   int field1470;
   @ObfuscatedName("cz")
   int field1467;
   ...
   @ObfuscatedName("ah")
   public static boolean method3180(classDH var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("mp")
   public static boolean method3103(classDH var0) {
   ...
   void method3138(int var1) {
      try {
         ...
         for (classSI var3 = (classSI)rl3.method10079(var2); var3 != null; var3 = (classSI)var2.next()) {
            var3.vmethod398();
         }
   ...
   @ObfuscatedName("pq")
   public static void method3269(classDZ var0, classDH var1) {
   ...
   @ObfuscatedName("cn")
   public static void method3281(classDH var0, float var1) {
      if (var0.field1497 * -665535259 < client.field855 * 1612595797 && var0.field1498 * -1055069695 < client.field855 * 1612595797) {
         if (var0.field1473 * -1798356091 != 0) {
            if (var0.field1465.field5599 != null && var0.field1467 * -211489501 == 0) {
               classOU var2 = var0.field1465.field5599;
            ...
            while (var0.field1473 * -1798356091 > 0 && var1 > 0.0F) {
               ...
               byte var6 = 4;
               boolean var7 = true;
               if (var0 instanceof classDN) {
                  var7 = ((classDN)var0).field1581.field5327;
               }
   ...
   public void setSpotAnimFrame(int var1) {
      ...
      if (var2.hasNext()) {
         classSI var3 = (classSI)var2.next();
         var3.setFrame(var1);
      }
   }
   ...
   @ObfuscatedName("gk")
   public static void method3107(classDH var0) {
   ...
   public int vmethod259() {
      if (0 != this.field1439 * -1105444433) {
         classDZ var1 = client.field814.method1590(this.field1439 * -1561534244, (short)10157);
         if (var1 != null) {
   ...
   boolean method3200(int var1) {
      try {
         if (this.method3102(-1995590748)) {
            ...
            classOU var2 = this.field1465.method9731((byte)60);
   ...
   @ObfuscatedName("gk")
   public static void method3263(classDH var0, int var1) {
      var0.field1463.field627 = var1 * -689558257;
   }

   @ObfuscatedSignature(descriptor = "(Ldz;Ldh;I)V")
   @ObfuscatedName("wp")
   public static void method3275(classDZ var0, classDH var1, int var2) {
      field1499 = var1;
   ...
   @ObfuscatedName("sf")
   public static void method3231(classDH var0, boolean var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ek")
   classKY method3162(classDZ var1, short var2) {
      try {
         if (var1 == classIS.field3053) {
            ...
            classSP var3 = (classSP)classIS.field3053.field1700.method13595(2140889407 * var1.field1699);
            if (var3 == null) {
               if (var2 <= 5000) {
                  throw new IllegalStateException();
               } else {
   ...
   public int vmethod258(byte var1) {
      try {
         if (0 != this.field1439 * -1105444433) {
            ...
            classDZ var2 = client.field814.method1590(this.field1439 * -1105444433, (short)-22287);
            if (var2 != null) {
               if (var1 >= 0) {
                  throw new IllegalStateException();
               }
   ...
   public void createSpotAnim(int var1, int var2, int var3, int var4) {
      classYN var5 = this.method3294();
      classSI var6 = (classSI)var5.method13600(var1);
      if (var6 != null) {
         var6.method12065();
      ...
      if (var2 != -1) {
         var5.method13597(new classSI(var2, var3, classOE.field4843.getGameCycle() + var4, this, false), var1);
         this.field1447 = (this.field1447 * 49255335 + 1) * 509600791;
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)V")
   @ObfuscatedName("ww")
   public static void method3240(classDH var0) {
   ...
   public boolean hasSpotAnim(int var1) {
      for (classSI var3 : this.method3294()) {
         if (var3.getId() == var1) {
            return true;
         }
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)Z")
   @ObfuscatedName("zj")
   public static boolean method3153(classDH var0) {
   ...
   void method3139() {
      ...
      for (classSI var2 = (classSI)rl3.method10079(var1); var2 != null; var2 = (classSI)var1.next()) {
         var2.vmethod398();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)Z")
   @ObfuscatedName("xo")
   public static boolean method3201(classDH var0) {
      if (var0 == null) {
         var0.getAnimation();
      }

      if (var0.method3102(-1995590748)) {
         classOU var1 = var0.field1465.method9731((byte)32);
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)V")
   @ObfuscatedName("tx")
   public static void method3277(classDH var0) {
      if (var0.field1497 * -665535259 >= client.field855 * 1612595797) {
         ...
         if (!var11) {
            classOU var14 = var0.field1465.field5599;
         ...
         if (var0.field1473 * -1798356091 == 0) {
            ...
            if (var6 <= 288.0F) {
               ...
               boolean var9 = true;
               if (var0 instanceof classDN) {
                  var9 = ((classDN)var0).field1581.field5327;
               }
      ...
      if (!classOE.field4843.isClientThread()) {
         ...
         for (classDZ var2 : client.field814) {
            if (var2.field1699 * 2140889407 != 0) {
               classDH var3 = this.field1463.field623 == classLJ.field4177
                  ? (classDH)var2.field1698.method13405(this.field1463.field632 * 893538615)
                  : (classDH)var2.field1694.method13405(this.field1463.field632 * 893538615);
               if (var3 != null) {
                  return var3;
               }
            }
         ...
         classDZ var4 = classIS.field3053;
         return this.field1463.field623 == classLJ.field4177
            ? (Actor)var4.field1698.method13405(this.field1463.field632 * 893538615)
            : (Actor)var4.field1694.method13405(this.field1463.field632 * 893538615);
      }
   }
   ...
   public int getGraphicHeight() {
      ...
      if (var1.hasNext()) {
         classSI var2 = (classSI)var1.next();
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;Ldh;)V")
   @ObfuscatedName("pj")
   public static void method3293(classDZ var0, classDH var1) {
   ...
   @ObfuscatedName("br")
   static int method3268(int var0, classBL var1, boolean var2, int var3) {
      try {
         classLW var4 = classLY.method7375(classWK.field6691, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], (byte)66);
         if (var0 == 2800) {
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classCK.method1575(classWK.field6691.method12173(var4, (byte)0), -2106114841);
            return 1;
         } else if (var0 == 2801) {
            if (var3 == -201810439) {
               throw new IllegalStateException();
               ...
               var5--;
               if (null != var4.field4337) {
                  if (var3 == -201810439) {
                     throw new IllegalStateException();
                  }

                  if (var5 < var4.field4337.length) {
                     if (var3 == -201810439) {
                        throw new IllegalStateException();
                     }

                     if (null != var4.field4337[var5]) {
                        classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = var4.field4337[var5];
                        return 1;
                     }
                  }
               }
   ...
   @ObfuscatedName("ue")
   public static void method3124(classDH var0, int var1, int var2, int var3, int var4, int var5) {
      if (var0 == null) {
         var0.vmethod103();
      }
   ...
   @ObfuscatedName("kl")
   public static void method3114(classDH var0, int var1, int var2) {
      if (var0 == null) {
   ...
   public void setGraphic(int var1) {
      ...
      if (var1 > -1) {
         classSI var2 = new classSI(var1, 0, 0, this, false);
   ...
   final void method3132(int var1, int var2) {
      try {
         classPX var3 = classDS.method3535(var1, 2082054101);
   ...
   @ObfuscatedName("ma")
   public static void method3219(classDH var0, int var1, classXS var2, byte var3) {
      if (var0 == null) {
   ...
   final void method3129(int var1, int var2, int var3, int var4, int var5, int var6) {
      classPX var7 = classDS.method3535(var1, 1912691981);
      classCO var8 = null;
      classCO var9 = null;
   ...
   void method3133(int var1, int var2, int var3, int var4, boolean var5) {
      ...
      classSI var7 = (classSI)this.field1469.method13595(var1);
      if (var7 != null) {
         var7.vmethod398();
      ...
      if (65535 != var2 && var2 != -1) {
         classYN.method13576(this.field1469, new classSI(var2, var3, var6, this, var5), var1);
         this.field1447 += 509600791;
      }
   }
   ...
   public void method3272(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var5 == 0) {
         ...
         if (this instanceof classDN && ((classDN)this).getId() == 319 && this.field1504) {
            return;
         }
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;Ldh;I)V")
   @ObfuscatedName("yj")
   public static void method3271(classDZ var0, classDH var1, int var2) {
      field1499 = null;
   }
   ...
   @ObfuscatedName("rx")
   public void method3278(int var1, classXS var2) {
      this.field1484 = (byte)(this.field1484 | 1);
   }
   ...
   final void method3130(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      try {
         classPX var8 = classDS.method3535(var1, 2020516296);
         classCO var9 = null;
         classCO var10 = null;
   ...
   @ObfuscatedName("he")
   classKY method3163(classDZ var1) {
      if (var1 == classIS.field3053) {
         return new classKY(this.vmethod258((byte)-103), this.vmethod368(311606126), this.vmethod371(62069074));
      } else {
         classSP var2 = (classSP)classIS.field3053.field1700.method13595(2140889407 * var1.field1699);
         if (var2 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;)Lky;")
   @ObfuscatedName("hy")
   classKY method3164(classDZ var1) {
      if (var1 == classIS.field3053) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)Z")
   @ObfuscatedName("nl")
   public static boolean method3208(classDH var0) {
      if (var0 == null) {
         var0.vmethod376();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;I)V")
   @ObfuscatedName("io")
   public static void method3160(classDH var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)Z")
   @ObfuscatedName("jp")
   public static boolean method3174(classDH var0) {
   ...
   boolean method3202() {
      if (this.method3102(-1995590748)) {
         classOU var1 = this.field1465.method9731((byte)61);
   ...
   @ObfuscatedName("dy")
   public static classLJ method3236(classDH var0) {
      if (var0 == null) {
         var0.method3238();
      }
   ...
   @ObfuscatedName("xc")
   public static classLV method3224(classDH var0) {
   ...
   @ObfuscatedName("uy")
   public static void method3111(classDH var0, int var1, int var2, classGT var3, int var4) {
      if (var0 == null) {
   ...
   @ObfuscatedName("fy")
   public static void method3134(classDH var0, int var1, int var2, int var3, int var4, boolean var5, byte var6) {
      if (var0 == null) {
         var0.method3136(var1, var1, var1, var1, var5, var6);
      } else {
         try {
            int var7 = var4 + client.field855 * 1612595797;
            classSI var8 = (classSI)var0.field1469.method13595(var1);
            if (var8 != null) {
               if (var6 == 0) {
                  throw new IllegalStateException();
               }
            ...
            if (65535 != var2) {
               ...
               if (var2 != -1) {
                  classYN.method13576(var0.field1469, new classSI(var2, var3, var7, var0, var5), var1);
                  var0.field1447 += 509600791;
                  var0.method3280(var1, var2, var3, var4, var5);
                  return;
               }
   ...
   @ObfuscatedSignature(descriptor = "(ILxs;)V")
   @ObfuscatedName("jj")
   void method3220(int var1, classXS var2) {
      this.field1463.method1382(var1, var2, (byte)2);
   }

   @ObfuscatedSignature(descriptor = "(ILxs;)V")
   @ObfuscatedName("jt")
   void method3221(int var1, classXS var2) {
      this.field1463.method1382(var1, var2, (byte)2);
   }
   ...
   @ObfuscatedName("gu")
   public static int method3198(classDH var0) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)Z")
   @ObfuscatedName("sl")
   public static boolean method3211(classDH var0) {
      if (var0 == null) {
         var0.method3121();
      }
   ...
   public void removeSpotAnim(int var1) {
      classSI var2 = (classSI)this.method3294().method13600(var1);
      if (var2 != null) {
         var2.method12065();
         this.field1447 = (this.field1447 * 49255335 - 1) * 509600791;
      }
   ...
   @ObfuscatedName("pa")
   public static void method3131(classDH var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      if (var0 == null) {
         var0.method3195(var1);
      }

      classPX var7 = classDS.method3535(var1, 1904378382);
      classCO var8 = null;
      classCO var9 = null;
      int var10 = var7.field5482 * 918203003;
      int var11 = 0;
   ...
   @ObfuscatedName("lv")
   public static void method3135(classDH var0, int var1, int var2, int var3, int var4, boolean var5) {
      if (var0 == null) {
         var0.method3229();
      }

      int var6 = var4 + client.field855 * 1612595797;
      classSI var7 = (classSI)var0.field1469.method13595(var1);
      if (var7 != null) {
         var7.vmethod398();
         var0.field1447 -= 509600791;
      }
      ...
      if (65535 != var2 && var2 != -1) {
         classYN.method13576(var0.field1469, new classSI(var2, var3, var6, var0, var5), var1);
         var0.field1447 += 509600791;
      }
   }
   ...
   @ObfuscatedName("uc")
   public static void method3188(classDH var0, int var1, int var2, classFL var3) {
      if (var0 == null) {
         var0.method3199();
      }
   ...
   @ObfuscatedName("qh")
   public static int method3168(classDH var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;I)Z")
   @ObfuscatedName("jf")
   public static boolean method3157(classDH var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ez")
   void method3222(int var1, classXS var2, byte var3) {
   ...
   @ObfuscatedName("yz")
   public static void method3189(classDH var0, int var1, int var2, classFL var3, int var4) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;I)V")
   @ObfuscatedName("jj")
   public static void method3101(classDH var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)Z")
   @ObfuscatedName("te")
   public static boolean method3105(classDH var0) {
      return var0.field1465.method9726(374233424) && 0 == -211489501 * var0.field1467;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ldh;)V")
   @ObfuscatedName("ly")
   public static void method3143(classDH var0) {
   ...
   void method3136(int var1, int var2, int var3, int var4, boolean var5, byte var6) {
      try {
         ...
         classSI var8 = (classSI)this.field1469.method13595(var1);
         if (var8 != null) {
            if (var6 == 0) {
               throw new IllegalStateException();
            }
         ...
         if (65535 != var2) {
            ...
            if (var2 != -1) {
               classYN.method13576(this.field1469, new classSI(var2, var3, var7, this, var5), var1);
