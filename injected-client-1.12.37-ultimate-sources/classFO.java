...
public class classFO {
   ...
   @ObfuscatedName("ca")
   static boolean method4893(classFX var0, int var1, int var2, int var3, int var4) {
      classFP var5 = var0.method5093(var1);
      ...
      if (Math.abs(var12) > classVI.field6513 * 756191369 + var9) {
         ...
         return false;
      } else if (Math.abs(var14 * 348139717 * classDK.field1542 - classEO.field1811 * -1947307103 * var13)
         > classEV.field1943 * 1304241803 * var10 + classJI.field3164 * 1266420275 * var11) {
         return false;
      } else {
         return Math.abs(-1947307103 * classEO.field1811 * var12 - -331219525 * classBY.field614 * var14)
   ...
   @ObfuscatedSignature(descriptor = "(Lfx;IIII)Z")
   @ObfuscatedName("ck")
   static boolean method4894(classFX var0, int var1, int var2, int var3, int var4) {
      classFP var5 = var0.method5093(var1);
      int var6 = -915116879 * var5.field2367 + var2;
      int var7 = var3 + var5.field2366 * -1027280203;
      ...
      if (Math.abs(var12) > classVI.field6513 * 756191369 + var9) {
         ...
         return false;
      } else if (Math.abs(var14 * -528879009 * classDK.field1542 - classEO.field1811 * -1947307103 * var13)
         > classEV.field1943 * 1024561494 * var10 + classJI.field3164 * 392783693 * var11) {
         return false;
      } else {
         return Math.abs(-77712431 * classEO.field1811 * var12 - 1627644741 * classBY.field614 * var14)
               > var9 * classEV.field1943 * 1304241803 + classVI.field6513 * 756191369 * var11
            ? false
   ...
   static final boolean method4892(
      classFX var0, int var1, int var2, int var3, int var4, float var5, float var6, float var7, float var8, int var9, int var10, int var11
   ) {
      if (!classAS.method660(2034401484)) {
         return false;
      } else {
         classEV.method4087(var5, var6, var7, var8, var9, var10, var11, (byte)-101);
         return classMM.method7619(var0, var1, var2, var3, var4, (byte)-55);
      }
   }
   ...
   @ObfuscatedName("cf")
   static int method4896(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, classFP var9) {
      ...
      int var13 = var1 + classFP.method4909(var9, (byte)4);
   ...
   static void method4891(int var0, int var1, int var2, int var3, int var4, int var5) {
      ...
      classCM.field1165 = -1730565422 * var5;
      ...
      classEV.field1943 = Math.abs(-473056817 * classEO.field1811) * -36859613;
   ...
   @ObfuscatedSignature(descriptor = "(Lfx;IIII)Z")
   @ObfuscatedName("co")
   static boolean method4895(classFX var0, int var1, int var2, int var3, int var4) {
      classFP var5 = var0.method5093(var1);
      ...
      if (Math.abs(var12) > classVI.field6513 * 47532510 + var9) {
         ...
         return false;
      } else if (Math.abs(var14 * 965988066 * classDK.field1542 - classEO.field1811 * -1947307103 * var13)
   ...
   @ObfuscatedSignature(descriptor = "(IIIIIIIIILfp;)I")
   @ObfuscatedName("cc")
   static int method4897(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, classFP var9) {
   ...
   static int method4850(int var0, int var1, int var2) {
      try {
         return (var1 << 7) + 128 * classFJ.field2281[var0];
