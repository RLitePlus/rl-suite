...
public class classPN extends classVJ {
   ...
   @ObfuscatedName("ax")
   static classVA field5362;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ac")
   static classJZ field5350 = new classJZ(64);
   @ObfuscatedName("aa")
   final int field5353;
   @ToRemove(unused = "true")
   @ObfuscatedName("ae")
   ...
   @ObfuscatedName("ax")
   public static void method9017(classVA var0) {
      field5362 = var0;
   }
   ...
   public static boolean method9025(classPN var0) {
      return classRN.method10130(var0.field5353 * 1468976603, -114938271) == classYY.field7113;
   }
   ...
   public boolean method9028(byte var1) {
      try {
         boolean var10000;
         if (classRN.method10130(this.field5353 * 1468976603, 1381354391) == classYY.field7115) {
            if (var1 <= 1) {
   ...
   @ObfuscatedName("xd")
   public static void method9037(classLC var0, int var1, int var2) {
   ...
   public static boolean method9026(classPN var0, byte var1) {
      ...
      try {
         boolean var10000;
         if (classRN.method10130(var0.field5353 * 1468976603, 1214906981) == classYY.field7113) {
            if (var1 != 2) {
               throw new IllegalStateException();
            }
   ...
   public boolean method9027() {
      return classRN.method10130(this.field5353 * 1468976603, -567015048) == classYY.field7113;
   }
   ...
   @ObfuscatedName("ae")
   public static classYM method9038(classVA var0, int var1, int var2, int var3) {
      SpritePixels var4 = (SpritePixels)client.field1037.get(var1);
      if (var4 != null) {
         return ((classYM)var4).method13563();
      } else {
         int var7 = var2;
         int var6 = var1;
         classVA var5 = var0;
         ...
         try {
            ...
            if (!classHK.method6068(var5, var6, var7, (byte)-30)) {
               ...
               classYM var11 = classSA.method10357((byte)45);
               var10000 = var11;
            }
   ...
   public boolean method9029() {
      return classRN.method10130(this.field5353 * 1468976603, -68556490) == classYY.field7113;
   }
   ...
   public boolean method9030(byte var1) {
      try {
         boolean var10000;
         if (classRN.method10130(this.field5353 * 1468976603, 1381354391) == classYY.field7111) {
            if (var1 <= 1) {
               throw new IllegalStateException();
            }
