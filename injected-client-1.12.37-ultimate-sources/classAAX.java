...
public class classAAX implements classQV {
   ...
   @ObfuscatedName("xo")
   public static void method285(classAAX var0, classDZ var1, int var2, int var3, boolean var4) {
      if (var0 == null) {
         var0.method296();
      }
   ...
   @ObfuscatedName("zj")
   public void method295(classDZ var1, int var2, int var3, boolean var4) {
   ...
   @ObfuscatedName("ab")
   @Override
   public void vmethod12(classOU var1, int var2) {
   ...
   @ObfuscatedName("bq")
   public static classVQ method294(classNV var0) {
      if (var0 == null) {
         var0.method8174();
      }
   ...
   @ObfuscatedName("as")
   public void method286(classDZ var1, int var2, int var3, boolean var4, int var5) {
      try {
         this.field113 = var1;
         ...
         throw classEG.method3884(var6, "aax.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   @Override
   public void vmethod13(classOU var1, int var2, int var3) {
      try {
         if (null == this.field113) {
            if (var3 > -969970217) {
               ;
         ...
         throw classEG.method3884(var11, "aax.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("ag")
   @Override
   public void vmethod14(classOU var1, int var2) {
      if (null != this.field113) {
         if (!this.field109.method10499(1966526081)) {
            if (null != var1.field5120 && var1.field5120.containsKey(var2)) {
               ArrayList var3 = (ArrayList)var1.field5120.get(var2);
   ...
   @ObfuscatedName("kp")
   @Override
   public void vmethod15(classOU var1, int var2) {
      if (null != this.field113) {
         if (!this.field109.method10499(1966526081)) {
            if (null != var1.field5120 && var1.field5120.containsKey(var2)) {
               ArrayList var3 = (ArrayList)var1.field5120.get(var2);
   ...
   public static void method290(classAAX var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "aax.ax(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("af")
   @Override
   public void vmethod16(classOU var1, int var2) {
      if (null != this.field113) {
         if (!this.field109.method10499(1966526081)) {
            if (null != var1.field5120 && var1.field5120.containsKey(var2)) {
               ArrayList var3 = (ArrayList)var1.field5120.get(var2);
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IIZ)V")
   @ObfuscatedName("ao")
   public void method287(classDZ var1, int var2, int var3, boolean var4) {
      this.field113 = var1;
      this.field112 = 1408887245 * var2;
      this.field111 = -1743370353 * var3;
      this.field114 = var4;
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;IIZ)V")
   @ObfuscatedName("ac")
   public void method288(classDZ var1, int var2, int var3, boolean var4) {
      this.field113 = var1;
      this.field112 = 1408887245 * var2;
      this.field111 = -1743370353 * var3;
      this.field114 = var4;
   ...
   @ObfuscatedName("ae")
   @Override
   public void vmethod17(classOU var1, int var2) {
