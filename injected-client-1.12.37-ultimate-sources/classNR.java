...
@ObfuscatedName("nr")
public class classNR extends classVQ {
   @ObfuscatedName("af")
   int field4710;
   ...
   boolean method7989(classAT var1, BitSet var2, int var3) {
      try {
         ...
         throw classEG.method3884(var11, "nr.af(" + ')');
      }
   }
   ...
   classNR(byte[] var1) {
      ...
      while (0 != var2.field6954[702114061 * var2.field6955 + var3]) {
         var3++;
      }
      ...
      for (int var5 = 0; var5 < var3; var5++) {
         var4[var5] = classXY.method13043(var2, (byte)17);
      }

      var2.field6955 += -1095856699;
      var3++;
      int var39 = var2.field6955 * 702114061;
      var2.field6955 += -1095856699 * var3;
      int var6 = 0;

      while (0 != var2.field6954[702114061 * var2.field6955 + var6]) {
         var6++;
      }
      ...
      for (int var8 = 0; var8 < var6; var8++) {
         var7[var8] = classXY.method13043(var2, (byte)17);
      }

      var2.field6955 += -1095856699;
      var6++;
      int var41 = var2.field6955 * 702114061;
      var2.field6955 += -1095856699 * var6;
      int var9 = 0;

      while (0 != var2.field6954[var9 + 702114061 * var2.field6955]) {
         var9++;
      }
      ...
      for (int var11 = 0; var11 < var9; var11++) {
         var10[var11] = classXY.method13043(var2, (byte)17);
      }
      ...
      for (int var45 = 0; var45 < var44.length; var45++) {
         ...
         var16 = classXY.method13039(var2, -346779531);
         if (var16 > 0) {
      ...
      int var46 = classXY.method13039(var2, -346779531);
      byte[] var49 = var46 > 0 ? new byte[2 * var46] : null;
      var46 = classXY.method13039(var2, -346779531);
      byte[] var52 = var46 > 0 ? new byte[var46 * 2] : null;
      int var17 = 0;

      while (0 != var2.field6954[var17 + 702114061 * var2.field6955]) {
         var17++;
      }
      ...
      for (int var19 = 0; var19 < var17; var19++) {
         var18[var19] = classXY.method13043(var2, (byte)17);
      }
      ...
      for (int var20 = 0; var20 < 128; var20++) {
         var55 += classXY.method13039(var2, -346779531);
      ...
      for (int var25 = 0; var25 < 128; var25++) {
         if (0 != this.field4714[var25]) {
            if (var62 == 0) {
               ...
               var72 = var2.field6954[var41++] + 16 << 2;
            }
      ...
      for (int var27 = 0; var27 < 128; var27++) {
         if (var62 == 0) {
            ...
            if (this.field4714[var27] > 0) {
               var74 = classXY.method13039(var2, -346779531) + 1;
            }
         }
      ...
      this.field4710 = (classXY.method13039(var2, -346779531) + 1) * -1318668967;
      ...
      for (int var75 = 0; var75 < var12; var75++) {
         ...
         if (var28.field4798 != null) {
            for (byte var29 = 1; var29 < var28.field4798.length; var29 += 2) {
               var28.field4798[var29] = classXY.method13043(var2, (byte)17);
            }
         }

         if (null != var28.field4799) {
            for (byte var96 = 3; var96 < var28.field4799.length - 2; var96 += 2) {
               var28.field4799[var96] = classXY.method13043(var2, (byte)17);
            }
         }
      }
      ...
      if (null != var49) {
         for (byte var76 = 1; var76 < var49.length; var76 += 2) {
            var49[var76] = classXY.method13043(var2, (byte)17);
         }
      }

      if (var52 != null) {
         for (byte var77 = 1; var77 < var52.length; var77 += 2) {
            var52[var77] = classXY.method13043(var2, (byte)17);
         }
      }
      ...
      for (int var78 = 0; var78 < var12; var78++) {
         ...
         if (var89.field4799 != null) {
            ...
            for (byte var97 = 2; var97 < var89.field4799.length; var97 += 2) {
               var55 = 1 + var55 + classXY.method13039(var2, -346779531);
      ...
      for (int var84 = 0; var84 < var12; var84++) {
         var44[var84].field4793 = classXY.method13039(var2, -346779531) * -1264008049;
      }

      for (int var85 = 0; var85 < var12; var85++) {
         classNY var93 = var44[var85];
         if (null != var93.field4798) {
            var93.field4791 = classXY.method13039(var2, -346779531) * -875309257;
         }

         if (var93.field4799 != null) {
            var93.field4794 = classXY.method13039(var2, -346779531) * 1090002817;
         }

         if (-939533713 * var93.field4793 > 0) {
            var93.field4795 = classXY.method13039(var2, -346779531) * -247497773;
         }
      }

      for (int var86 = 0; var86 < var12; var86++) {
         var44[var86].field4792 = classXY.method13039(var2, -346779531) * -210418761;
      }

      for (int var87 = 0; var87 < var12; var87++) {
         classNY var94 = var44[var87];
         if (-771094009 * var94.field4792 > 0) {
            var94.field4796 = classXY.method13039(var2, -346779531) * -906938583;
         }
      }
      ...
      for (int var88 = 0; var88 < var12; var88++) {
         ...
         if (var95.field4796 * -1472637671 > 0) {
            var95.field4790 = classXY.method13039(var2, -346779531) * -636622149;
         }
      }
   }
   ...
   @ObfuscatedName("ag")
   static classNR method7987(classVA var0, int var1) {
      byte[] var2 = classVA.method11814(var0, var1, 1879018076);
   ...
   @ObfuscatedSignature(descriptor = "(Lva;I)Lnr;")
   @ObfuscatedName("ab")
   static classNR method7988(classVA var0, int var1) {
      byte[] var2 = classVA.method11814(var0, var1, 229663212);
      return null == var2 ? null : new classNR(var2);
   }
   ...
   public static boolean method7985(char var0, int var1) {
      try {
         ...
         throw classEG.method3884(var5, "nr.af(" + ')');
      }
   }
   ...
   public static void method7994(classNR var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.method3884(var2, "nr.ae(" + ')');
         }
      }
   }
