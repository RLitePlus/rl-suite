...
public class classLL {
   ...
   public static int method7119(int var0, int var1) {
      try {
         return classDH.method3082(var0, 2111857814);
   ...
   @ObfuscatedName("ac")
   static void method7120(classDZ var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         int var6 = var1;
         int var7 = var2;
         ...
         if (!var0.method3719(-2087374717)) {
            ...
            classSP var9 = (classSP)classIS.field3053.field1700.method13595(var0.field1699 * 2140889407);
            if (null != var9) {
               if (var5 >= 1580238376) {
                  throw new IllegalStateException();
               }
