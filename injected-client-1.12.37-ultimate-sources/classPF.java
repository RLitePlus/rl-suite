...
public class classPF extends classVJ {
   ...
   @ObfuscatedName("az")
   static classJZ field5235 = new classJZ(64);
   @ObfuscatedName("mk")
   ...
   @ObfuscatedName("as")
   public static void method8846(classVA var0) {
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ae")
   public static void method8847(classVA var0) {
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ab")
   public static void method8848(classVA var0) {
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ag")
   public static void method8849(classVA var0) {
   }
   ...
   @ObfuscatedName("ag")
   static void method8855(classLW var0, int var1, int var2, boolean var3, classVV var4, classQN var5, short var6) {
      try {
         ...
         if (var3) {
            ...
            if (var0.field4246 != null) {
               ...
               classZR var9 = classZS.method14182(classUQ.method11465(var0, 1435437416).method14145(var0.field4246, (byte)2), (byte)73);
   ...
   static void method8856(int var0, int var1, int var2, int var3, Object[] var4, byte var5) {
      try {
         boolean var6 = false;
         classLW var7 = classLY.method7378(classWK.field6691, var0, var1, (byte)-106);
         if (!var6) {
            if (var5 == 4) {
               throw new IllegalStateException();
            }
   ...
   public static void method8854(byte var0) {
      try {
         classGR.field2663.method6161(5);
