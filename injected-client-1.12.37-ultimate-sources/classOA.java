...
public class classOA extends classPB {
   ...
   public static int method8289(byte var0) {
      try {
         ...
         throw classEG.method3884(var1, "oa.ac(" + 41);
      }
   }
   ...
   static classKY method8290(int var0) {
      try {
         classDZ var3 = client.field814.method1590(client.field846 * -2034209657, (short)542);
         classCT var5 = var3.method3737(client.field845 * -2130951373, (byte)1);
         classUZ var2;
         if (var5 != null) {
            if (var0 != 1544651080) {
         ...
         throw classEG.method3884(var7, "oa.eh(" + ')');
      }
   }
}
