...
@ObfuscatedName("cm")
public class classCM implements World {
   @ObfuscatedName("al")
   int field1160;
   ...
   @ObfuscatedName("qb")
   public static boolean method2514(classCM var0, byte var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ir")
   public static void method2526(classCY var0, boolean var1) {
      if (var0 == null) {
         var0.method2710();
      }
   ...
   static boolean method2460() {
      try {
         if (classIS.field3054 == null) {
            ...
            field1170 = new classCM[-622036481 * field1153];

            for (int var2 = 0; var2 < field1153 * 1005185384; var2++) {
               classCM var3 = field1170[var2] = new classCM();
   ...
   @ObfuscatedName("iu")
   public static boolean method2487(classCM var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("sb")
   public static boolean method2483(classCM var0) {
      if (var0 == null) {
         var0.method2503();
      }
   ...
   @ObfuscatedName("an")
   static void method2466(classCM[] var0, int var1, int var2, int[] var3, int[] var4) {
      if (var1 < var2) {
         int var5 = var1 - 1;
         int var6 = var2 + 1;
         int var7 = (var2 + var1) / 2;
         classCM var8 = var0[var7];
         var0[var7] = var0[var1];
         var0[var1] = var8;
   ...
   @ObfuscatedSignature(descriptor = "([Lcm;II[I[I)V")
   @ObfuscatedName("am")
   static void method2467(classCM[] var0, int var1, int var2, int[] var3, int[] var4) {
      if (var1 < var2) {
         int var5 = var1 - 1;
         int var6 = var2 + 1;
         int var7 = (var2 + var1) / 2;
   ...
   public void method2527(int var1) {
      classCM[] var2 = classOE.field4843.method2454();
   ...
   @ObfuscatedName("ru")
   public static classDZ method2462(classCL var0) {
      if (var0 == null) {
         var0.method1593();
      }
   ...
   @ObfuscatedSignature(descriptor = "([Lcm;II[I[I)V")
   @ObfuscatedName("ah")
   static void method2468(classCM[] var0, int var1, int var2, int[] var3, int[] var4) {
      if (var1 < var2) {
         int var5 = var1 - 1;
         int var6 = var2 + 1;
         int var7 = (var2 + var1) / 2;
   ...
   @ObfuscatedName("br")
   static int method2474(classCM var0, classCM var1, int var2, boolean var3) {
      if (var2 == 1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lcm;Lcm;IZ)I")
   @ObfuscatedName("bt")
   static int method2475(classCM var0, classCM var1, int var2, boolean var3) {
      if (var2 == 1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lcm;Lcm;IZ)I")
   @ObfuscatedName("bm")
   static int method2476(classCM var0, classCM var1, int var2, boolean var3) {
      if (var2 == 1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lcm;I)Z")
   @ObfuscatedName("hj")
   public static boolean method2491(classCM var0, int var1) {
      if (var0 == null) {
   ...
   static void method2473(int var0, int var1, int var2, boolean var3, int var4, boolean var5) {
      if (var0 < var1) {
         ...
         int var7 = var0;
         classCM var8 = field1170[var6];
         field1170[var6] = field1170[var1];
         field1170[var1] = var8;

         for (int var9 = var0; var9 < var1; var9++) {
            classCM var11 = field1170[var9];
