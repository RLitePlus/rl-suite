...
@ObfuscatedName("fv")
public abstract class classFV implements Projection {
   @ObfuscatedName("mg")
   ...
   @ObfuscatedName("kz")
   public void method5032(classEZ var1, classFN var2, int var3, int var4, int var5) {
      field2411 = var3;
   ...
   @ObfuscatedName("ao")
   abstract void vmethod430(classEZ var1, classFJ var2, int var3, int var4, int var5);
   ...
   public static void method5020(
      ...
      if ((var20 - var24) * (var21 - var23) - (var22 - var24) * (var19 - var23) > 0.0F) {
         ...
         if (classEZ.method4144(var1.field2045, var1.field2046, (int)var22, (int)var24, (int)var20, (int)var21, (int)var23, (int)var19)) {
         ...
         if (var2.field2287 * -374133199 == -1) {
            ...
            classFH.method4758(
               ...
               var28,
               var26,
               classEZ.method4142(var32, -665850825 * var2.field2286),
               classEZ.method4142(var32, var2.field2284 * 1860831095),
               classEZ.method4142(var32, var2.field2288 * 1735654675)
            );
         }
      }
      ...
      if ((var24 - var20) * (var17 - var19) - (var23 - var19) * (var18 - var20) > 0.0F) {
         ...
         if (classEZ.method4144(var1.field2045, var1.field2046, (int)var18, (int)var20, (int)var24, (int)var17, (int)var19, (int)var23)) {
         ...
         if (-1 == var2.field2287 * -1656613927) {
            ...
            classFH.method4758(
               ...
               var26,
               var28,
               classEZ.method4142(var34, var2.field2285 * 1145127777),
               classEZ.method4142(var34, -109486114 * var2.field2288),
               classEZ.method4142(var34, var2.field2284 * -2126403163)
            );
         }
      }
   }
   ...
   @ObfuscatedName("az")
   abstract void vmethod435(classEE var1, int var2, int var3, int var4, int var5, long var6);

   @ObfuscatedSignature(descriptor = "(Lez;Lfj;IIII)V")
   @ObfuscatedName("af")
   abstract void vmethod426(classEZ var1, classFJ var2, int var3, int var4, int var5, int var6);

   @ObfuscatedSignature(descriptor = "(Lee;IIIIJ)V")
   @ObfuscatedName("as")
   abstract void vmethod422(classEE var1, int var2, int var3, int var4, int var5, long var6);

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lfv;Lez;Lfn;II)V")
   @ObfuscatedName("gf")
   public static void method5025(classFV var0, classEZ var1, classFN var2, int var3, int var4) {
      if (var0 == null) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            float var10 = classFN.field2337[var7];
            float var11 = classFN.field2337[var8];
            float var12 = classFN.field2337[var9];
            float var13 = classFN.field2340[var7];
            float var14 = classFN.field2340[var8];
            float var15 = classFN.field2340[var9];
            float var16 = classFN.field2338[var7];
            float var17 = classFN.field2338[var8];
            float var18 = classFN.field2338[var9];
            if ((var10 - var11) * (var15 - var14) - (var12 - var11) * (var13 - var14) > 0.0F) {
               ...
               if (classEZ.method4144(var1.field2045, var1.field2046, (int)var13, (int)var14, (int)var15, (int)var10, (int)var11, (int)var12)) {
                  ...
                  if (!classEZ.field2084) {
                     if (var2.field2319) {
                        ...
                        classFH.method4769(
                           ...
                           var2.field2325[var6],
                           var2.field2328[var6],
                           classFN.field2339[var7],
                           classFN.field2339[var8],
                           classFN.field2339[var9],
                           classFN.field2335[var7],
                           classFN.field2335[var8],
                           classFN.field2335[var9],
                           classFN.field2341[var7],
                           classFN.field2341[var8],
                           classFN.field2341[var9],
                           var2.field2324[var6]
                        );
                     }
                  } else {
                     ...
                     classFH.method4758(
                        ...
                        var17,
                        var18,
                        classEZ.method4142(var21, var2.field2332[var6]),
                        classEZ.method4142(var21, var2.field2325[var6]),
                        classEZ.method4142(var21, var2.field2328[var6])
                     );
                  }
   ...
   @ObfuscatedName("tn")
   public static classYN method5030(classDH var0) {
   ...
   @ObfuscatedName("ay")
   abstract void vmethod434(classEZ var1, classFN var2, int var3, int var4);

   @ObfuscatedSignature(descriptor = "(Lez;Lfn;III)V")
   @ObfuscatedName("au")
   void method5035(classEZ var1, classFN var2, int var3, int var4, int var5) {
      try {
         ...
         for (int var10 = 0; var10 < var9; var10++) {
            ...
            float var14 = classFN.field2337[var11];
            float var15 = classFN.field2337[var12];
            float var16 = classFN.field2337[var13];
            float var17 = classFN.field2340[var11];
            float var18 = classFN.field2340[var12];
            float var19 = classFN.field2340[var13];
            float var20 = classFN.field2338[var11];
            float var21 = classFN.field2338[var12];
            float var22 = classFN.field2338[var13];
            if ((var14 - var15) * (var19 - var18) - (var17 - var18) * (var16 - var15) > 0.0F) {
               if (classEZ.method4503(var1.field2045, var1.field2046, (int)var17, (int)var18, (int)var19, (int)var14, (int)var15, (int)var16)) {
                     ...
                     if (!classEZ.field2084) {
                        if (var2.field2319) {
                           ...
                           classFQ.method4962(
                              ...
                              var2.field2325[var10],
                              var2.field2328[var10],
                              classFN.field2339[var11],
                              classFN.field2339[var12],
                              classFN.field2339[var13],
                              classFN.field2335[var11],
                              classFN.field2335[var12],
                              classFN.field2335[var13],
                              classFN.field2341[var11],
                              classFN.field2341[var12],
                              classFN.field2341[var13],
                              var2.field2324[var10]
                           );
                        }
                     } else {
                        ...
                        classFQ.method4963(
                           ...
                           var21,
                           var22,
                           classEZ.method4454(var24, var2.field2332[var10]),
                           classEZ.method4454(var24, var2.field2325[var10]),
                           classEZ.method4454(var24, var2.field2328[var10])
                        );
                     }
   ...
   @ObfuscatedSignature(descriptor = "(Lee;IIIIJ)V")
   @ObfuscatedName("ab")
   abstract void vmethod423(classEE var1, int var2, int var3, int var4, int var5, long var6);

   @ObfuscatedSignature(descriptor = "(Lee;IIIIJ)V")
   @ObfuscatedName("ag")
   abstract void vmethod424(classEE var1, int var2, int var3, int var4, int var5, long var6);

   @ObfuscatedSignature(descriptor = "(Lez;Lfn;III)V")
   @ObfuscatedName("ae")
   abstract void vmethod431(classEZ var1, classFN var2, int var3, int var4, int var5);

   @ObfuscatedSignature(descriptor = "(Lee;IIIIJ)V")
   @ObfuscatedName("ax")
   abstract void vmethod425(classEE var1, int var2, int var3, int var4, int var5, long var6);

   @ObfuscatedSignature(descriptor = "(Lez;Lfj;III)V")
   @ObfuscatedName("ac")
   abstract void vmethod427(classEZ var1, classFJ var2, int var3, int var4, int var5);
   ...
   @ObfuscatedSignature(descriptor = "(Lee;IIIIJ)V")
   @ObfuscatedName("mv")
   public void method5037(classEE var1, int var2, int var3, int var4, int var5, long var6) {
      this.vmethod435(var1, var2, var3, var4, var5, var6);
   }

   @ObfuscatedSignature(descriptor = "(Lez;Lfj;III)V")
   @ObfuscatedName("aa")
   abstract void vmethod428(classEZ var1, classFJ var2, int var3, int var4, int var5);

   @ObfuscatedSignature(descriptor = "(Lez;Lfn;II)V")
   @ObfuscatedName("aq")
   abstract void vmethod433(classEZ var1, classFN var2, int var3, int var4);

   @ObfuscatedSignature(descriptor = "(Lez;Lfn;II)V")
   @ObfuscatedName("aj")
   abstract void vmethod432(classEZ var1, classFN var2, int var3, int var4);
         ...
         if ((var20 - var24) * (var21 - var23) - (var22 - var24) * (var19 - var23) > 0.0F) {
            ...
            if (var2.field2287 * 1479555085 == -1) {
               ...
               classFH.method4758(
                  ...
                  var28,
                  var26,
                  classEZ.method4142(var32, -1743886056 * var2.field2286),
                  classEZ.method4142(var32, var2.field2284 * 139844517),
                  classEZ.method4142(var32, var2.field2288 * 788574122)
               );
            }
         }
         ...
         if ((var24 - var20) * (var17 - var19) - (var23 - var19) * (var18 - var20) > 0.0F) {
            ...
            if (-1 == var2.field2287 * 1479555085) {
               ...
               classFH.method4758(
                  ...
                  var28,
                  classEZ.method4142(var34, var2.field2285 * 1145127777),
                  classEZ.method4142(var34, -633153015 * var2.field2288),
                  classEZ.method4142(var34, var2.field2284 * 1860831095)
               );
            }
         }
      }
   ...
   @ObfuscatedName("vu")
   public static void method5031(classER var0) {
      ...
      if ((var20 - var24) * (var21 - var23) - (var22 - var24) * (var19 - var23) > 0.0F) {
         ...
         if (var2.field2287 * 1479555085 == -1) {
            ...
            classFH.method4758(
               ...
               classEZ.method4142(var32, -665850825 * var2.field2286),
               classEZ.method4142(var32, var2.field2284 * 1860831095),
               classEZ.method4142(var32, var2.field2288 * -633153015)
            );
         }
      }
   ...
   void method5034(
      ...
      try {
         ...
         if ((var25 - var29) * (var26 - var28) - (var27 - var29) * (var24 - var28) > 0.0F) {
            if (classEZ.method4503(var1.field2045, var1.field2046, (int)var27, (int)var29, (int)var25, (int)var26, (int)var28, (int)var24)) {
            ...
            if (!classOE.field4843.isGpu()) {
               ...
               if (var2.field2287 * 1479555085 == -1) {
                  ...
                  classFQ.method4963(
                     ...
                     var33,
                     var31,
                     classEZ.method4454(var36, var2.field2286 * -665850825),
                     classEZ.method4454(var36, var2.field2284 * 1860831095),
                     classEZ.method4454(var36, var2.field2288 * -633153015)
                  );
               }
            }
         }
         ...
         if ((var29 - var25) * (var22 - var24) - (var23 - var25) * (var28 - var24) > 0.0F) {
            if (classEZ.method4503(var1.field2045, var1.field2046, (int)var23, (int)var25, (int)var29, (int)var22, (int)var24, (int)var28)) {
            ...
            if (!classOE.field4843.isGpu()) {
               ...
               if (var2.field2287 * 1479555085 == -1) {
                  ...
                  classFQ.method4963(
                     ...
                     var31,
                     var33,
                     classEZ.method4454(var41, var2.field2285 * 1145127777),
                     classEZ.method4454(var41, var2.field2288 * -633153015),
                     classEZ.method4454(var41, var2.field2284 * 1860831095)
                  );
               }
            }
         }
   ...
   @ObfuscatedSignature(descriptor = "(Lez;Lfn;II)V")
   @ObfuscatedName("av")
   void method5026(classEZ var1, classFN var2, int var3, int var4) {
      classFH.field2257.field2213 = 0;
      int var5 = var2.field2330.length;
   ...
   @ObfuscatedSignature(descriptor = "(Lez;Lfj;III)V")
   @ObfuscatedName("al")
   abstract void vmethod429(classEZ var1, classFJ var2, int var3, int var4, int var5);
   ...
   @ObfuscatedSignature(descriptor = "(Lez;Lfj;IIII)V")
   @ObfuscatedName("nd")
   public void method5033(classEZ var1, classFJ var2, int var3, int var4, int var5, int var6) {
      field2411 = var3;
   ...
   @ObfuscatedSignature(descriptor = "(Lez;Lfn;II)V")
   @ObfuscatedName("an")
   void method5027(classEZ var1, classFN var2, int var3, int var4) {
      classFH.field2257.field2213 = 0;
      int var5 = var2.field2330.length;
   ...
   @ObfuscatedSignature(descriptor = "(Lez;Lfn;II)V")
   @ObfuscatedName("am")
   void method5028(classEZ var1, classFN var2, int var3, int var4) {
      classFH.field2257.field2213 = 0;
      int var5 = var2.field2330.length;
      ...
      if ((var24 - var20) * (var17 - var19) - (var23 - var19) * (var18 - var20) > 0.0F) {
         ...
         if (-1 == var2.field2287 * -505554333) {
            ...
            classFH.method4758(
               ...
               var26,
               var28,
               classEZ.method4142(var34, var2.field2285 * -1226497550),
               classEZ.method4142(var34, -457502577 * var2.field2288),
               classEZ.method4142(var34, var2.field2284 * 1860831095)
            );
         }
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lez;Lfn;II)V")
   @ObfuscatedName("at")
   void method5029(classEZ var1, classFN var2, int var3, int var4) {
      ...
      for (int var6 = 0; var6 < var5; var6++) {
         ...
         int var9 = var2.field2329[var6];
         float var10 = classFN.field2340[var7];
         float var11 = classFN.field2338[var8];
         float var12 = classFN.field2340[var9];
         float var13 = classFN.field2338[var7];
         float var14 = classFN.field2337[var8];
         float var15 = classFN.field2337[var9];
         float var16 = classFN.field2340[var7];
         float var17 = classFN.field2337[var8];
         float var18 = classFN.field2337[var9];
         if ((var10 - var11) * (var15 - var14) - (var12 - var11) * (var13 - var14) > 0.0F) {
            classFH.field2257.field2211 = false;
            ...
            if (classEZ.method4144(var1.field2054, var1.field2054, (int)var13, (int)var14, (int)var15, (int)var10, (int)var11, (int)var12)) {
               float var20 = classVI.method11957(
            ...
            if (var2.field2332 != null && var2.field2324[var6] != -1) {
               if (!classEZ.field2084) {
                  ...
                  classFH.method4760(
                     ...
                     var17,
                     var18,
                     classEZ.method4142(var21, var2.field2324[var6]),
                     classEZ.method4142(var21, var2.field2332[var6]),
                     classEZ.method4142(var21, var2.field2328[var6])
                  );
               }
