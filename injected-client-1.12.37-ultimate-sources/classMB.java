...
public class classMB implements Runnable {
   ...
   public final void method7504(short var1) {
      try {
         ...
         throw classEG.method3884(var6, "mb.ab(" + ')');
      }
   }
      ...
      try {
         while (true) {
            ...
            try {
               ...
               if (var2 == 1) {
                  var1.field4518 = new Socket(InetAddress.getByName((String)var1.field4517), var1.field4513);
               } else if (2 == var2) {
                  Thread var3 = new Thread((Runnable)var1.field4517);
                  var3.setDaemon(true);
                  var3.start();
                  var3.setPriority(var1.field4513);
                  var1.field4518 = var3;
               } else if (4 == var2) {
                  var1.field4518 = new DataInputStream(((URL)var1.field4517).openStream());
               }
         ...
         throw classEG.method3884(var9, "mb.run(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;II)Lmj;")
   @ObfuscatedName("as")
   public final classMJ method7514(String var1, int var2, int var3) {
      try {
         return method7510(this, 1, var2, 0, var1, 143965232);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "mb.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lmb;IIILjava/lang/Object;I)Lmj;")
   @ObfuscatedName("oq")
   public static classMJ method7510(classMB var0, int var1, int var2, int var3, Object var4, int var5) {
      if (var0 == null) {
         var0.method7513(var1, var1, var1, var4, var1);
      }

      try {
         classMJ var6 = new classMJ();
         ...
         throw classEG.method3884(var10, "mb.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Runnable;II)Lmj;")
   @ObfuscatedName("ax")
   public final classMJ method7517(Runnable var1, int var2, int var3) {
      try {
         return method7510(this, 2, var2, 0, var1, -1883812875);
      } catch (RuntimeException var4) {
         throw classEG.method3884(var4, "mb.ax(" + ')');
      }
   }
   ...
   public static int method7520(classTE var0, int var1) {
      try {
         ...
         throw classEG.method3884(var9, "mb.as(" + 41);
      }
   }
   ...
   @ObfuscatedName("aa")
   public static classMJ method7511(classMB var0, int var1, int var2, int var3, Object var4) {
      if (var0 == null) {
         var0.method7507();
      }

      classMJ var5 = new classMJ();
   ...
   public static int method7502(int var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var2, "mb.af(" + 41);
      }
   }
   ...
   @ObfuscatedName("ao")
   final classMJ method7512(int var1, int var2, int var3, Object var4) {
      classMJ var5 = new classMJ();
   ...
   @ObfuscatedName("aj")
   public final classMJ method7515(String var1, int var2) {
      return method7510(this, 1, var2, 0, var1, -391069800);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;I)Lmj;")
   @ObfuscatedName("ay")
   public final classMJ method7516(String var1, int var2) {
      return method7510(this, 1, var2, 0, var1, -585293095);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Runnable;I)Lmj;")
   @ObfuscatedName("aq")
   public final classMJ method7518(Runnable var1, int var2) {
      return method7510(this, 2, var2, 0, var1, 1264907340);
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/Runnable;I)Lmj;")
   @ObfuscatedName("ap")
   public final classMJ method7519(Runnable var1, int var2) {
      return method7510(this, 2, var2, 0, var1, 1177595316);
   }

   @ObfuscatedSignature(descriptor = "(Lva;Lva;II)Lsn;")
   @ObfuscatedName("az")
   public static classSN method7509(classVA var0, classVA var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var9, "mb.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("ev")
   static classCT method7521(int var0) {
      try {
         classDZ var1 = client.field814.method1590(client.field846 * -2034209657, (short)13357);
         classCT var10000;
         if (var1 != null) {
            if (var0 == 120041229) {
               throw new IllegalStateException();
         ...
         throw classEG.method3884(var3, "mb.ev(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IIILjava/lang/Object;I)Lmj;")
   @ObfuscatedName("ag")
   final classMJ method7513(int var1, int var2, int var3, Object var4, int var5) {
      try {
         classMJ var6 = new classMJ();
         var6.field4515 = var1 * 1420219965;
         var6.field4513 = var2;
