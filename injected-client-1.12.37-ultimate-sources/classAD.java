...
public class classAD {
   ...
   @ObfuscatedName("de")
   static void method332(classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.method3884(var9, "ad.de(" + ')');
      }
   }
   ...
   static final void method329(classAH var0, byte var1) {
      try {
         ...
         throw classEG.method3884(var3, "ad.af(" + ')');
      }
   }
   ...
   static final void method327(int var0) {
      try {
         ...
         throw classEG.method3884(var2, "ad.af(" + ')');
      }
   }
