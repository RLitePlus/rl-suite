...
public class classLO {
   ...
   @ObfuscatedName("ct")
   static void method7134(classDZ var0, byte var1) {
      try {
   ...
   @ObfuscatedName("bv")
   static int method7135(int var0, classBL var1, boolean var2, int var3) {
      try {
         if (var0 == 6200) {
            if (var3 != -1503643048) {
               throw new IllegalStateException();
               ...
               client.field867 = (short)classZL.method14064(classBB.field323[-324749371 * classDY.field1679], -2001374514);
               ...
               client.field868 = (short)classZL.method14064(classBB.field323[1 + classDY.field1679 * -324749371], -2033994976);
            ...
            if (var3 != -1503643048) {
               ...
               classDY.field1679 -= 240082458;
               client.field869 = (short)classBB.field323[-324749371 * classDY.field1679];
               ...
               client.field862 = (short)classBB.field323[classDY.field1679 * -324749371 + 1];
            ...
            if (var3 != -1503643048) {
               ...
               client.field876 = (short)classBB.field323[classDY.field1679 * -324749371];
               ...
               client.field872 = (short)classBB.field323[classDY.field1679 * -324749371 + 1];
               ...
               client.field873 = (short)classBB.field323[2 + -324749371 * classDY.field1679];
               ...
               client.field874 = (short)classBB.field323[classDY.field1679 * -324749371 + 3];
            ...
            if (null != classWK.field6691.field6620) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = client.field990 * 27064125;
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1158148203 * client.field982;
            } else {
            ...
            if (var3 != -1503643048) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = client.field869;
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = client.field862;
               return 1;
            }
         } else if (6205 == var0) {
            if (var3 != -1503643048) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classIK.method6220(client.field867, (byte)-1);
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classIK.method6220(client.field868, (byte)-1);
               return 1;
            }
         } else if (6220 == var0) {
            if (var3 != -1503643048) {
