...
@ObfuscatedName("pt")
public class classPT extends classVJ implements VarbitComposition {
   @ObfuscatedName("ax")
   ...
   @ObfuscatedName("ab")
   public static classJZ field5418 = new classJZ(64);

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ab")
   public static void method9205(classVA var0) {
      field5423 = var0;
   }
   ...
   @ObfuscatedName("ac")
   public static classPT method9208(int var0) {
      classPT var1 = (classPT)field5418.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
         byte[] var2 = field5423.method11867(14, var0, -1917771461);
         var1 = new classPT(new classXY(var2));
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ag")
   public static void method9206(classVA var0) {
      field5423 = var0;
   }
   ...
   static final void method9216(String var0, byte var1) {
      try {
         if (var0.equalsIgnoreCase("toggleroof")) {
            classCY var10000 = classAB.field122;
            boolean var10001;
         ...
         if (var0.startsWith("zbuf")) {
            ...
            boolean var2 = var14;
            classOE.field4843.method11100(var2, 1150763619);
         ...
         if (var0.startsWith("settilerendermode")) {
            ...
            try {
               ...
               classIS.field3053.field1689.method4254(classEX.method4105()[var13]);
         ...
         if (313368463 * client.field911 >= 2) {
            ...
            if (var0.equalsIgnoreCase("clientreload")) {
               ...
               classCY.method2829(classAB.field122, true, -22926792);
            } else if (var0.equalsIgnoreCase("sfx16bit")) {
               if (var1 == 8) {
                  return;
               }

               classCY.method2829(classAB.field122, false, -1649203021);
         ...
         classJL var12 = classEF.method3849(classJS.CLIENT_CHEAT, client.field795.field1535, (byte)-10);
         if (289984869 * classAAU.field102 >= 240) {
            classXY.method12971(var12.field3343, var0.length() + 2, (byte)-104);
         } else {
            classXY.method12971(var12.field3343, var0.length() + 1, (byte)-34);
         }

         classXY.method12997(var12.field3343, var0, (short)20904);
         if (289984869 * classAAU.field102 >= 240) {
            if (var1 == 8) {
               throw new IllegalStateException();
            }

            classXY.method12971(var12.field3343, 0, (byte)-59);
         }

         client.field795.method3367(var12, -1301097035);
      } catch (RuntimeException var7) {
         throw classEG.method3884(var7, "pt.bj(" + ')');
      }
   }
   ...
   int method9212(int var1, short var2) {
      try {
         ...
         throw classEG.method3884(var4, "pt.ae(" + 41);
      }
   }

   classPT(classXY var1) {
      int var2 = 0;
      int var3 = 0;
      int var4 = 0;
         ...
         while (true) {
            ...
            switch (var5) {
               case 0:
                  break label30;
               case 1:
                  var2 = classXY.method13047(var1, 188196754);
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("as")
   public static void method9207(classVA var0) {
      field5423 = var0;
   }
   ...
   static int method9210(int var0, int[][][] var1, int var2, int var3, int var4, byte var5) {
      try {
         return var1[var2][classFJ.field2280[var0] + var3][classFJ.field2281[var0] + var4];
      } catch (RuntimeException var6) {
         throw classEG.method3884(var6, "pt.ae(" + 41);
      }
   }
   ...
   public static void method9215(classTE var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var4, "pt.av(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(I)Lpt;")
   @ObfuscatedName("ax")
   public static classPT method9209(int var0) {
      classPT var1 = (classPT)field5418.method6422(var0);
      if (null != var1) {
         return var1;
      } else {
      ...
      try {
         if (null == client.field866[var0]) {
            ...
            if (var1 >= 0) {
               ...
               if (var1 < classIE.method6183(client.field866[var0], (byte)-66)) {
                  classHN var4 = (classHN)client.field866[var0].field2955.get(var1);
                  classJL var5 = classEF.method3849(classJS.AFFINEDCLANSETTINGS_SETMUTED_FROMCHANNEL, client.field795.field1535, (byte)60);
                  classXY.method12971(var5.field3343, 4 + classAU.method712(var4.field2846.method164(1081337898), (byte)102), (byte)-60);
                  classXY.method12971(var5.field3343, var0, (byte)-78);
                  var5.field3343.method12973(var1, -1542382992);
                  classXY.method12994(var5.field3343, var2, -1737488759);
                  classXY.method12997(var5.field3343, var4.field2846.method164(752125537), (short)29816);
         ...
         throw classEG.method3884(var6, "pt.gj(" + ')');
      }
   }
}
