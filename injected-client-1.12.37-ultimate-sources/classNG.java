...
class classNG implements Callable {
   ...
   public static int method7836(classEK var0, Object var1, Object var2) {
      return var0 == null ? var0.method3907(var1, var1) : var0.method3905((classRI)var1, (classRI)var2, (short)31267);
   }
   ...
   @ObfuscatedName("cl")
   static void method7841(classDZ var0, int var1) {
      try {
      ...
      try {
         ...
         if (classBZ.method1381(var0, (byte)-59)) {
            ...
            if (var9) {
               ...
               var8 = (classDH)var7.field1698.method13404(var10);
            } else {
            ...
            if (var8 != null) {
               ...
               classKY var18 = ((classDH)var8).method3162(var7, (short)8639);
         ...
         if (var6 == null) {
            ...
            classSP var19 = (classSP)classCL.method1592(var4, 1101306946).field1700.method13595(2140889407 * var7.field1699);
            if (var19 != null) {
               if (var5 >= -314200228) {
                  throw new IllegalStateException();
               }
         ...
         classSP var13 = (classSP)classIS.field3053.field1700.method13595(var7.field1699 * 2140889407);
         if (null != var13) {
