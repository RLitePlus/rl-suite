...
@ObfuscatedName("ei")
public class classEI extends classFV implements FloatProjection {
   @ObfuscatedName("qk")
   ...
   void vmethod435(classEE var1, int var2, int var3, int var4, int var5, long var6) {
      if (client.field1096 == 0) {
         ...
         var1.method3839(var2, this.field1764, var3, var4, var5, var6);
   ...
   void method3894(long var1) {
      try {
         ...
         throw classEG.method3884(var3, "ei.ad(" + ')');
      }
   }
   ...
   void vmethod422(classEE var1, int var2, int var3, int var4, int var5, long var6) {
      ...
      var1.vmethod419(var2, this.field1764, var3, var4, var5, var6);
   ...
   void vmethod426(classEZ var1, classFJ var2, int var3, int var4, int var5, int var6) {
      try {
         if (1 == classFH.field2257.field2217) {
            ...
            this.field1764.method11616(var8, var15, var10, this.field1763, 1634822735);
            ...
            if (var10 < 50.0F) {
               ...
               this.field1764.method11616(var12, var16, var9, this.field1763, 1634822735);
               ...
               if (var9 < 50.0F) {
                  ...
                  this.field1764.method11616(var11, var17, var14, this.field1763, 1634822735);
                  var11 = this.field1763[0];
                  var17 = this.field1763[1];
                  var14 = this.field1763[2];
                  if (!(var14 < 50.0F)) {
                     this.field1764.method11616(var7, var18, var13, this.field1763, 1634822735);
         ...
         throw classEG.method3884(var19, "ei.af(" + ')');
      }
   }
      ...
      try {
         if (1 != classFH.field2257.field2217) {
            ...
            for (int var7 = 0; var7 < var6; var7++) {
               ...
               this.field1764.method11616(var8, var9, var10, this.field1763, 1634822735);
               var8 = this.field1763[0];
               ...
               if (var2.field2324 != null) {
                  classFN.field2339[var7] = (int)var8;
                  classFN.field2335[var7] = (int)var9;
                  classFN.field2341[var7] = (int)var10;
               }

               classFN.field2337[var7] = classFH.method4705() + var8 * classFH.method4727() / var10;
               classFN.field2340[var7] = classFH.method4710() + var9 * classFH.method4727() / var10;
               classFN.field2338[var7] = classJE.method6356(var10, 2104529011);
            }

            this.method5035(var1, var2, var3, var4, -404951706);
         }
      } catch (RuntimeException var11) {
         throw classEG.method3884(var11, "ei.ae(" + ')');
      }
   }
   ...
   void vmethod427(classEZ var1, classFJ var2, int var3, int var4, int var5) {
      if (1 != classFH.field2257.field2217) {
         ...
         this.field1764.method11616(var7, var14, var9, this.field1763, 1634822735);
         var7 = this.field1763[0];
         var14 = this.field1763[1];
         var9 = this.field1763[2];
         if (!(var9 < 50.0F)) {
            this.field1764.method11616(var11, var15, var8, this.field1763, 1634822735);
            var11 = this.field1763[0];
            var15 = this.field1763[1];
            var8 = this.field1763[2];
            if (!(var8 < 50.0F)) {
               this.field1764.method11616(var10, var16, var13, this.field1763, 1634822735);
               var10 = this.field1763[0];
               var16 = this.field1763[1];
               var13 = this.field1763[2];
               if (!(var13 < 50.0F)) {
                  this.field1764.method11616(var6, var17, var12, this.field1763, 1634822735);
   ...
   void vmethod432(classEZ var1, classFN var2, int var3, int var4) {
      if (1 != classFH.field2257.field2217) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            this.field1764.method11616(var7, var8, var9, this.field1763, 1634822735);
            var7 = this.field1763[0];
            ...
            if (var2.field2324 != null) {
               classFN.field2339[var6] = (int)var7;
               classFN.field2335[var6] = (int)var8;
               classFN.field2341[var6] = (int)var9;
            }

            classFN.field2337[var6] = classFH.method4705() + var7 * classFH.method4727() / var9;
            classFN.field2340[var6] = classFH.method4710() + var8 * classFH.method4727() / var9;
            classFN.field2338[var6] = classJE.method6356(var9, 2093454043);
         }
   ...
   public float[] project(float var1, float var2, float var3, float[] var4) {
      this.field1764.method11664(var1, var2, var3, var4);
      return var4;
   }
   ...
   void vmethod433(classEZ var1, classFN var2, int var3, int var4) {
      if (1 != classFH.field2257.field2217) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            classFN.field2337[var6] = classFH.method4705() + var7 * classFH.method4727() / var9;
            classFN.field2340[var6] = classFH.method4710() + var8 * classFH.method4727() / var9;
            classFN.field2338[var6] = classJE.method6356(var9, 2094720945);
         }
   ...
   public float[] getProjection() {
      this.field1764.method11647(field1766);
      return field1766;
   }
   ...
   void vmethod434(classEZ var1, classFN var2, int var3, int var4) {
      if (1 != classFH.field2257.field2217) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            classFN.field2337[var6] = classFH.method4705() + var7 * classFH.method4727() / var9;
            classFN.field2340[var6] = classFH.method4710() + var8 * classFH.method4727() / var9;
            classFN.field2338[var6] = classJE.method6356(var9, 2107472726);
         }
   ...
   static int method3896(int var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.method3884(var13, "ei.af(" + 41);
      }
   }
   ...
   public static int method3895(int var0, int var1) {
      try {
         ...
         throw classEG.method3884(var2, "ei.ae(" + 41);
      }
   }
