...
public class classCW {
   ...
   @ObfuscatedName("ax")
   static void method2690(classSP var0, int var1, int var2) {
      if (var1 == 65535) {
         byte var5 = -1;
         ...
         classOU var3 = var0.field6017.method9731((byte)87);
         if (var3 != null) {
   ...
   @ObfuscatedName("ae")
   static void method2687(classDZ var0, classXS var1) {
      ...
      if (var2 < classZH.method14003(var0.field1693, (byte)10)) {
         for (int var3 = var2; var3 < classZH.method14003(var0.field1693, (byte)10); var3++) {
            ...
            classSP var5 = (classSP)var0.field1700.method13595(var4);
            if (var5 != null) {
               var5.vmethod398();
            }
         }
      ...
      if (var2 > classZH.method14003(var0.field1693, (byte)10)) {
         ...
         for (int var19 = 0; var19 < var2; var19++) {
            ...
            classSP var6 = (classSP)var0.field1700.method13595(var21);
            ...
            if (0 == var7) {
               ...
               if (var7 != 1) {
                  ...
                  byte var8 = classXY.method13043(var1, (byte)17);
                  if (0 != var8) {
                  ...
                  if (var7 == 2) {
                     classSP.method10609(var6, var0, var18, (byte)0);
                  } else {
               ...
               if ((var25 & 1) != 0) {
                  int var27 = classXY.method13047(var1, -907540070);
         ...
         while (var1.method12931(294258401 * client.field795.field1525, 761810155) > 0) {
            int var20 = classXY.method13047(var1, -388693601);
            ...
            int var32 = 8 * var29;
            int var33 = 8 * var31;
            classDZ var13 = client.field814.method1582(var20, var32, var33, classAB.field122.method2817((byte)0), classEX.field1978, -1393038213);
            classSP var15 = new classSP(var20, var13);
            classYN.method13576(var0.field1700, var15, var20);
            var15.field6009 = var20 * -662280981;
            var15.field6020 = var0.field1699 * -1758428471;
            classSP.method10567(var15, classIR.method6309(var26, -340342746), -927574133);
            classOB.method8291(var1, var15.field6019, 0, 0, -482046160);
            classSP.method10609(var15, var0, var15.field6019, (byte)0);
            classSP.method10577(var15, (classKR)classOF.method8404(classOB.method8292((byte)-39), var24, 1309193695), -1459513721);
            if ((var22 & 1) != 0) {
               int var16 = classXY.method13047(var1, 650928042);
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;Lxs;)V")
   @ObfuscatedName("ab")
   static void method2688(classDZ var0, classXS var1) {
      int var2 = classXY.method13039(var1, -346779531);
      if (var2 < classZH.method14003(var0.field1693, (byte)10)) {
         for (int var3 = var2; var3 < classZH.method14003(var0.field1693, (byte)10); var3++) {
      ...
      if (var2 > classZH.method14003(var0.field1693, (byte)10)) {
         ...
         for (int var19 = 0; var19 < var2; var19++) {
            ...
            if (0 == var7) {
               ...
               int var25 = classXY.method13039(var1, -346779531);
               if ((var25 & 1) != 0) {
                  int var27 = classXY.method13047(var1, -293815640);
         ...
         while (var1.method12931(1265354011 * client.field795.field1525, 528001785) > 0) {
            int var20 = classXY.method13047(var1, 282124653);
            ...
            classSP.method10567(var15, classIR.method6309(var26, 1345348057), -1433354147);
            classOB.method8291(var1, var15.field6019, 0, 0, -482046160);
            classSP.method10609(var15, var0, var15.field6019, (byte)0);
            classSP.method10577(var15, (classKR)classOF.method8404(classOB.method8292((byte)-14), var24, 1067148466), -819973393);
            if ((var22 & 1) != 0) {
               int var16 = classXY.method13047(var1, 1304730707);
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;II)V")
   @ObfuscatedName("ag")
   static void method2691(classSP var0, int var1, int var2) {
      if (var1 == 65535) {
         byte var5 = -1;
         ...
         classOU var3 = var0.field6017.method9731((byte)81);
         if (var3 != null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;II)V")
   @ObfuscatedName("as")
   static void method2692(classSP var0, int var1, int var2) {
      if (var1 == 65535) {
         byte var5 = -1;
         ...
         classOU var3 = var0.field6017.method9731((byte)21);
         if (var3 != null) {
   ...
   @ObfuscatedName("cq")
   static void method2694(classDZ var0, int var1) {
      try {
         if (client.field851) {
            if (var1 <= 2004704828) {
         ...
         throw classEG.method3884(var2, "cw.cq(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILcl;I)Ldn;")
   @ObfuscatedName("af")
   public static classDN method2689(int var0, classCL var1, int var2) {
      try {
         for (classDZ var4 : var1) {
            classDN var5 = (classDN)var4.field1698.method13404(var0);
            if (var5 != null) {
               if (var2 >= 2038139370) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.method3884(var6, "cw.af(" + ')');
      }
   }
}
