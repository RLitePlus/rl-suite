...
public class classBU extends classGG {
   ...
   @ObfuscatedName("az")
   @Override
   protected boolean vmethod144(int var1, int var2, int var3, classGC var4, byte var5) {
      try {
         ...
         throw classEG.method3884(var6, "bu.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   @Override
   protected boolean vmethod145(int var1, int var2, int var3, classGC var4) {
   ...
   @ObfuscatedName("ae")
   @Override
   protected boolean vmethod146(int var1, int var2, int var3, classGC var4) {
   ...
   static int method1245(int var0, int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.method3884(var5, "bu.ae(" + 41);
      }
   }
   ...
   static void method1247(float[] var0, int var1) {
      try {
         ...
         throw classEG.method3884(var3, "bu.ag(" + ')');
      }
   }
      ...
      try {
         ...
         for (int var13 = 1; var13 < 103; var13++) {
            ...
            for (int var6 = 1; var6 < 103; var6++) {
               ...
               if ((classIS.field3053.field1702[var0][var6][var13] & 24) == 0) {
                  ...
                  classIS.field3053.field1689.method4459(var2, var5, 512, var0, var6, var13);
               }
               ...
               if (var0 < 3) {
                  ...
                  if ((classIS.field3053.field1702[var0 + 1][var6][var13] & 8) != 0) {
                     classIS.field3053.field1689.method4459(var2, var5, 512, 1 + var0, var6, var13);
                  }
               }
         ...
         for (int var17 = 0; var17 < 104; var17++) {
            ...
            for (int var18 = 0; var18 < 104; var18++) {
               long var8 = classIS.field3053.field1689.method4476(classIS.field3053.field1710 * -483624883, var17, var18);
               if (var8 != 0L) {
                  if (var1 != 1443313102) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (var11 >= 0) {
                     if (!classFJ.method4796(var11, (byte)-93).field5399) {
                        if (var1 != 1443313102) {
                           throw new IllegalStateException();
                        }
                     } else {
                        classBA.field310[classBA.field306 * 1296562401] = classFJ.method4796(var11, (byte)-22).method9199(false, 592907760);
         ...
         throw classEG.method3884(var12, "bu.aa(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IIIIIIIIIZB)V")
   @ObfuscatedName("dg")
   static void method1248(classDZ var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, boolean var10, byte var11) {
      try {
         classDL var12 = new classDL();
         ...
         throw classEG.method3884(var13, "bu.dg(" + ')');
      }
   }
}
