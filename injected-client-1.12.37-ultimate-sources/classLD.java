...
public class classLD {
   ...
   static final void method6746(int var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         classEZ var6 = classIS.field3053.field1689;
         ...
         if (var7 != 0L) {
            ...
            int var9 = classEZ.method4462(var6, var0, var1, var2, var7);
            int var10 = var9 >> 6 & 3;
            int var11 = var9 & 31;
            int var12 = var3;
            boolean var10000;
            ...
            if (var17.field4954 * 1680279607 != -1) {
               ...
               classYZ var18 = classOY.field5202[1680279607 * var17.field4954];
               if (null != var18) {
                  int var19 = (var17.field4944 * 1965741260 - var18.field7121) / 2;
                  int var20 = (1611505692 * var17.field4924 - var18.field7119) / 2;
                  classYZ.method13810(var18, 48 + 4 * var1 + var19, var20 + 4 * (104 - var2 - var17.field4924 * 402876423) + 48);
               }
            } else {
               if (0 == var11 || 2 == var11) {
                  if (0 == var10) {
         ...
         if (var7 != 0L) {
            ...
            int var24 = classEZ.method4462(var6, var0, var1, var2, var7);
            int var26 = var24 >> 6 & 3;
            int var28 = var24 & 31;
            ...
            if (-1 != 1680279607 * var13.field4954) {
               ...
               classYZ var34 = classOY.field5202[var13.field4954 * 1680279607];
               if (null != var34) {
                  if (var5 != 1) {
                     throw new IllegalStateException();
                  }
                  ...
                  classYZ.method13810(var34, var37 + 48 + 4 * var1, var38 + (104 - var2 - var13.field4924 * 402876423) * 4 + 48);
               }
            } else {
               label279:
               if (var28 == 9) {
         ...
         if (0L != var7) {
            ...
            if (-1 != var27.field4954 * 1680279607) {
               ...
               classYZ var29 = classOY.field5202[var27.field4954 * 1680279607];
               if (var29 != null) {
                  if (var5 != 1) {
                     return;
                  }
                  ...
                  classYZ.method13810(var29, var31 + 48 + 4 * var1, var32 + 48 + 4 * (104 - var2 - 402876423 * var27.field4924));
               }
            }
         }
         ...
         if (var3 <= 1) {
            ...
            if (var1 != 0) {
               ...
               if (var0.field6128 == classYY.field7111) {
                  ...
                  classDY.method3705(var7, 0, var3 - 1, 1303645518);
                  classDY.method3705(var7, 0, var1 - 1, 2074604693);
                  classDY.method3705(var7, var1, var3 - 1, 212841751);
               } else {
   ...
   @ObfuscatedName("ae")
   static void method6748(classZR var0, classBL var1, int var2, int var3, int var4) {
                  ...
                  label1432: {
                     ...
                     for (int var18 = 1; var18 < var9.length; var18++) {
                        ...
                        if (var9[var18] instanceof Integer) {
                           ...
                           if (var19 == -2147483645) {
                              int var10000;
                              if (classZR.method14092(var33, 1470996304) != null) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }

                                 var10000 = classZR.method14092(var33, -360630356).field4329 * -1163656551;
                              } else {
                                 var10000 = -1;
                              }
                           ...
                           if (-2147483644 == var19) {
                              ...
                              var19 = classZR.method14108(var33, -328310946);
                           }
                           ...
                           if (var19 == -2147483643) {
                              ...
                              int var87;
                              if (classZR.method14092(var33, -1926683648) != null) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }

                                 var87 = classZR.method14092(var33, 1965647036).field4260 * 63131743;
                              } else {
                                 var87 = -1;
                              }
                           ...
                           if (-2147483642 == var19) {
                              ...
                              int var88;
                              if (classZR.method14111(var33, (byte)-102) != null) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }

                                 var88 = classZR.method14111(var33, (byte)52).field4329 * -1163656551;
                              } else {
                                 var88 = -1;
                              }
                           ...
                           if (-2147483641 == var19) {
                              ...
                              int var89;
                              if (classZR.method14111(var33, (byte)73) != null) {
                                 if (var8 <= -581658423) {
                                    var29 = false;
                                    return;
                                 }

                                 var89 = classZR.method14111(var33, (byte)18).field4260 * 63131743;
                              } else {
                                 var89 = -1;
                              }
                           ...
                           if (-2147483640 == var19) {
                              ...
                              var19 = classZR.method14114(var33, -773759683);
                           }
                     ...
                     while (true) {
                        ...
                        if (var13 < 100) {
                           ...
                           if (var13 == 0) {
                              ...
                              classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var12[var10];
                           } else if (1 == var13) {
                              if (var8 <= -581658423) {
                                 throw new IllegalStateException();
                              }
                              ...
                              classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classLB.field4090[var52];
                           } else if (var13 == 2) {
                              int var51 = var12[var10];
                              classLB.field4090[var51] = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                              ...
                              if (classBB.field323[classDY.field1679 * -324749371 + 1] != classBB.field323[-324749371 * classDY.field1679]) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }
                              ...
                              classDY.field1679 -= 240082458;
                              if (classBB.field323[classDY.field1679 * -324749371] == classBB.field323[1 + classDY.field1679 * -324749371]) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }
                              ...
                              classDY.field1679 -= 240082458;
                              if (classBB.field323[-324749371 * classDY.field1679] < classBB.field323[1 + classDY.field1679 * -324749371]) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }
                              ...
                              classDY.field1679 -= 240082458;
                              if (classBB.field323[-324749371 * classDY.field1679] > classBB.field323[classDY.field1679 * -324749371 + 1]) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }
                              ...
                              classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classEM.method3922(var48, -1229922096);
                           } else if (var13 == 27) {
                              if (var8 <= -581658423) {
                                 throw new IllegalStateException();
                              }
                              ...
                              classGP.method5546(var47, classBB.field323[(classDY.field1679 -= 120041229) * -324749371], -390980656);
                           } else if (var13 == 31) {
                              if (var8 <= -581658423) {
                                 var29 = false;
                                 return;
                              ...
                              classDY.field1679 -= 240082458;
                              if (classBB.field323[classDY.field1679 * -324749371] <= classBB.field323[classDY.field1679 * -324749371 + 1]) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }
                              ...
                              classDY.field1679 -= 240082458;
                              if (classBB.field323[classDY.field1679 * -324749371] >= classBB.field323[-324749371 * classDY.field1679 + 1]) {
                                 if (var8 <= -581658423) {
                                    throw new IllegalStateException();
                                 }
                              ...
                              classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classDE.field1409[var12[var10]];
                           } else if (34 == var13) {
                              if (var8 <= -581658423) {
                                 throw new IllegalStateException();
                              }

                              classDE.field1409[var12[var10]] = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                           } else if (var13 == 35) {
                              if (var8 <= -581658423) {
                                 throw new IllegalStateException();
                              }
                              ...
                              classBL var62 = classSK.method10460(var45, 2050893446);
                              ...
                              if (306770163 * var62.field495 >= 0) {
                                 System.arraycopy(
                                    classBB.field323, -324749371 * classDY.field1679 - var62.field495 * 306770163 + 0, var65, 0, 306770163 * var62.field495
                                 );
                              }
                              ...
                              classDY.field1679 = classDY.field1679 - var62.field495 * 611277143;
                              ...
                              classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classSX.field6096.method3541(var12[var10], -468650129);
                           } else if (var13 == 43) {
                              if (var8 <= -581658423) {
                                 throw new IllegalStateException();
                              }

                              classSX.field6096.method3538(var12[var10], classBB.field323[(classDY.field1679 -= 120041229) * -324749371], -164759631);
                           } else if (51 == var13) {
                              if (var8 <= -581658423) {
                                 var29 = false;
                                 return;
                              ...
                              int var64 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                              if (var64 < 0) {
                                 break;
                              }
                              ...
                              int var56 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
                              ...
                              if (classYY.field7111 == var38.field6128) {
                                 ...
                                 classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var38.method10748(1782946828)[var56];
                              ...
                              if (classYY.field7111 == var39.field6128) {
                                 ...
                                 classDY.field1679 -= 240082458;
                                 int var57 = classBB.field323[classDY.field1679 * -324749371];
                                 classMA.method7501(var39, var57, 1531145389);
                                 var39.method10748(1519400143)[var57] = classBB.field323[1 + -324749371 * classDY.field1679];
                              ...
                              classYN var41 = var5.field505[var12[var10]];
                              classVG var60 = (classVG)var41.method13595(classBB.field323[(classDY.field1679 -= 120041229) * -324749371]);
                              if (null != var60) {
                                 var10 = client.field1095 = var10 + var60.field6503;
                              }
                           } else if (var13 == 63) {
                              if (var8 <= -581658423) {
                                 var29 = false;
   ...
   @ObfuscatedName("rf")
   public static classVH method6744(classOI var0) {
