...
public class classJF {
   ...
   @ObfuscatedName("je")
   public static void method6362(classEZ var0) {
      if (var0 == null) {
         var0.method4331();
      } else {
         var0.field2036 = -1;
   ...
   static int method6359(int var0, int var1, int var2) {
      try {
         ...
         if (var3 == null) {
            ...
            for (int var5 = 0; var5 < var3.field455.length; var5++) {
               if (var2 != 397563969) {
                  throw new IllegalStateException();
               }

               if (var1 == var3.field456[var5]) {
                  if (var2 != 397563969) {
                     throw new IllegalStateException();
                  }

                  var4 += var3.field455[var5];
               }
            }
   ...
   @ObfuscatedName("ae")
   static void method6361(classVA var0, classVA var1, classAAM var2, boolean var3, int var4, int var5) {
      ...
      try {
         if (classPA.field5209) {
            ...
            if ((var7 & classXE.field6840.vmethod8((byte)1)) != 0) {
               classFP.field2372 = classSU.method10680(var1, "logo_deadman_mode", "", 418903120);
            } else if ((var7 & classXE.field6851.vmethod8((byte)1)) != 0) {
               if (var5 != 1600397897) {
                  throw new IllegalStateException();
               }

               classFP.field2372 = classSU.method10680(var1, "logo_seasonal_mode", "", -595284173);
            } else if ((var7 & classXE.field6836.vmethod8((byte)1)) != 0) {
               classFP.field2372 = classSU.method10680(var1, "logo_speedrunning", "", 703015556);
            } else if ((var7 & classXE.field6839.vmethod8((byte)1)) != 0) {
               if (var5 != 1600397897) {
                  throw new IllegalStateException();
               }

               classFP.field2372 = classSU.method10680(var1, "logo_ugc_world", "", -953181053);
            } else {
               classFP.field2372 = classSU.method10680(var1, "logo", "", -1898186027);
            }
            ...
            classCG.field733 = classOT.method8732(var1, "title_mute", "", (byte)125);
            ...
            classYZ.method13810(classFP.field2372, -329898575 * classBF.field385 + 382 - classFP.field2372.field7121 / 2, 18);
            client.method2351(var0, var1, var2, var3, var4);
         }
   ...
   @ObfuscatedName("bi")
   static int method6364(int var0, classBL var1, boolean var2, byte var3) {
      try {
         if (var0 == 4100) {
            if (var3 != 4) {
               throw new IllegalStateException();
               ...
               int var54 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
            ...
            int var52 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
            ...
            if (var3 != 4) {
               ...
               int var37 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
            ...
            if (var3 != 4) {
               ...
               classBB.field338 -= -1849233978;
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classCH.method1500(
                  classDH.method3081(
            ...
            int var50 = classBB.field323[-324749371 * classDY.field1679];
            int var60 = classBB.field323[-324749371 * classDY.field1679 + 1];
            byte[] var64 = classYO.field7023.method11867(var60, 0, -848893336);
            classZV var68 = new classZV(var64);
            var35 = classUP.method11420(var35, classRR.method10179(14584714), classBB.field334, classBB.field333, (byte)0);
            classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var68.method43(var35, var50);
            return 1;
         } else if (var0 == 4109) {
            if (var3 != 4) {
               throw new IllegalStateException();
               ...
               classZV var67 = new classZV(var63);
               var33 = classUP.method11420(var33, classRR.method10179(-1534687957), classBB.field334, classBB.field333, (byte)0);
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var67.method41(var33, var49);
               return 1;
            }
         } else if (4110 == var0) {
            if (var3 != 4) {
            ...
            classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = classAAA.method8(var31);
            return 1;
         } else if (4112 == var0) {
            if (var3 != 4) {
               throw new IllegalStateException();
               ...
               int var47 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
            ...
            int var75 = (classDY.field1679 += 120041229) * -324749371 - 1;
            byte var76;
            ...
            if (var3 != 4) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classTT.method11165((char)var27, -2118205091) ? 1 : 0;
               return 1;
            }
         } else if (4116 == var0) {
            if (var3 != 4) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = classEB.method3802((char)var26, (byte)47) ? 1 : 0;
               return 1;
            }
         } else if (var0 == 4117) {
            if (var3 != 4) {
               ...
               if (null != var25) {
                  ...
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var25.length();
               } else {
            ...
            if (var3 != 4) {
               ...
               classDY.field1679 -= 240082458;
               int var46 = classBB.field323[classDY.field1679 * -324749371];
               int var58 = classBB.field323[1 + classDY.field1679 * -324749371];
            ...
            if (var3 != 4) {
               ...
               var22 = classUP.method11420(var22, classRR.method10179(-1474623602), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 != 4) {
               ...
               int var44 = classBB.field323[(classDY.field1679 -= 120041229) * -324749371];
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var21.indexOf(var44);
               return 1;
            }
         } else if (4121 == var0) {
            if (var3 != 4) {
               ...
               classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var20.indexOf(var43, var56);
               return 1;
            }
         } else if (var0 == 4122) {
            if (var3 != 4) {
            ...
            if (var3 != 4) {
               ...
               classCT var61 = classMB.method7521(518324687);
               if (null != var61) {
                  if (var3 != 4) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 != 4) {
               ...
               classCT var17 = classMB.method7521(1857940561);
               if (var17 != null) {
                  if (var3 != 4) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (var17.field1285 != null) {
                     ...
                     classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = var17.field1285.field4093 * -513083879;
                     return 1;
                  }
               }
            ...
            if (var3 != 4) {
               ...
               try {
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = Integer.parseInt(var4);
                  classBB.field323[(classDY.field1679 += 120041229) * -324749371 - 1] = 1;
   ...
   @ObfuscatedName("dc")
   static final void method6363(classXS var0, int var1) {
