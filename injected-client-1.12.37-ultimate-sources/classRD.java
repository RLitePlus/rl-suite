...
public abstract class classRD implements Comparator {
   ...
   @ObfuscatedName("ax")
   static classYM field5645;

   @ObfuscatedSignature(descriptor = "(IZIZI)V")
   @ObfuscatedName("ab")
   static void method9948(int var0, boolean var1, int var2, boolean var3, int var4) {
      try {
         if (classCM.field1170 != null) {
            if (var4 == 379541057) {
               return;
            }

            classLV.method7155(0, classCM.field1170.length - 1, var0, var1, var2, var3, (byte)1);
         }
      } catch (RuntimeException var5) {
         throw classEG.method3884(var5, "rd.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("jw")
   public static classLX method9949(classLW var0) {
   ...
   @ObfuscatedName("ga")
   public static int method9942(classRD var0, classRR var1, classRR var2, int var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.method3884(var4, "rd.aa(" + 41);
      }
   }
   ...
   final void method9940(Comparator var1, int var2) {
      try {
         ...
         throw classEG.method3884(var3, "rd.ac(" + ')');
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.method3884(var2, "rd.equals(" + ')');
      }
   }
   ...
   @ObfuscatedName("rx")
   public static int method9943(classRD var0, classRR var1, classRR var2) {
      return null == var0.field5644 ? 0 : var0.field5644.compare(var1, var2);
   }

   @ObfuscatedSignature(descriptor = "(Lrr;Lrr;)I")
   @ObfuscatedName("aj")
   protected final int method9944(classRR var1, classRR var2) {
   ...
   public static int method9941(classQR var0, int var1, classQV var2, int var3) {
      try {
         ...
         if (!var0.method9726(374233424)) {
            ...
            classOU var5 = var0.method9731((byte)51);
            ...
            if (!var5.method8768((byte)0)) {
               ...
               int var8 = var1;
               byte var9 = 0;
               classOU var10 = var0.method9731((byte)96);
         ...
         throw classEG.method3884(var14, "rd.az(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lrr;Lrr;I)I")
   @ObfuscatedName("aa")
   protected final int method9945(classRR var1, classRR var2, int var3) {
      try {
