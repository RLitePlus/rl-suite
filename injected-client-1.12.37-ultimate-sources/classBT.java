...
public class classBT {
   ...
   @ObfuscatedName("bf")
   static int method1243(classDH var0, classDZ var1, classDZ var2, int var3, int var4, byte var5) {
      try {
         ...
         if (var2.field1699 * 2140889407 != 2140889407 * var1.field1699) {
            ...
            if (0 == 2140889407 * var1.field1699) {
               classSP var8 = (classSP)classIS.field3053.field1700.method13595(2140889407 * var2.field1699);
               ...
               classSP var13 = (classSP)classIS.field3053.field1700.method13595(var1.field1699 * 2140889407);
               var7 = var13.method10621(var3, var4, (byte)6);
            } else {
               classSP var14 = (classSP)classIS.field3053.field1700.method13595(var2.field1699 * 2140889407);
               classSP var9 = (classSP)classIS.field3053.field1700.method13595(var1.field1699 * 2140889407);
   ...
   static void method1244(int var0) {
      try {
         int var1 = client.field974.field6797 * -1927903443 - 1;
         if (-1 != var1) {
            if (var0 <= -144383729) {
               throw new IllegalStateException();
            }
            ...
            client.method2381(-1);
            classON.field4993.field606 = client.field974.field6798[var1] * 100846287;
            classON.field4993.field613 = -385576485 * client.field974.field6799[var1];
            classON.field4993.field612 = -282371447 * client.field974.field6800[var1];
            classON.field4993.field608 = 1973962571 * client.field974.field6801[var1];
            classON.field4993.field609 = client.field974.field6802[var1] * 2074062867;
            classON.field4993.field616 = client.field974.field6804[var1];
            classON.field4993.field615 = client.field974.field6805[var1];
            classON.field4993.field610 = client.field974.field6803[var1] * 829407595;
            classON.field4993.field618 = client.field974.field6807[var1];
         }
      } catch (RuntimeException var3) {
