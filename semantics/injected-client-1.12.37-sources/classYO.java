...
final class classYO implements classYH {
   ...
   @ObfuscatedName("ud")
   public static void method13603(classYO var0, classTE var1, Buffer var2, int var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "yo.az(" + ')');
      }
   }
   ...
   public void vmethod656(Object var1, Buffer var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "yo.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("bg")
   public static void method13604(classYO var0, classTE var1, Buffer var2) {
      if (var0 == null) {
   ...
   public Object vmethod653(Buffer var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "yo.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("ag")
   void method13605(classTE var1, Buffer var2) {
      var1.method10795(var2, (byte)-63);
   }

   @ObfuscatedSignature(descriptor = "(Lte;Lxy;I)V")
   @ObfuscatedName("az")
   void method13606(classTE var1, Buffer var2, int var3) {
      try {
         var1.method10795(var2, (byte)-34);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "yo.az(" + ')');
