...
public class classGJ implements classHM {
   ...
   public static void method5465(AbstractArchive var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gj.az(" + ')');
      }
   }
   ...
   public void vmethod469(classHG var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "gj.az(" + ')');
      }
   }
   ...
   public boolean vmethod472(int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "gj.af(" + ')');
      }
   }
   ...
   public int[] vmethod478(int var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var6, "gj.ab(" + ')');
      }
   }
   ...
   public void vmethod484(Buffer var1, int var2) {
      try {
         this.field2606 = Buffer.method13039(var1, -346779531) * 764602599;
         this.field2599 = Buffer.method13039(var1, -346779531) * -882424765;
         this.field2598 = Buffer.method13047(var1, 513730862) * -1269422327;
         this.field2596 = Buffer.method13047(var1, -826755470) * 94217553;
         this.field2600 = Buffer.method13047(var1, 1882809038) * 654540389;
         this.field2604 = Buffer.method13047(var1, 856188930) * 899678031;
         this.field2605 = Buffer.method13047(var1, 1974015843) * -68517483;
         this.field2597 = Buffer.method13047(var1, 1407337964) * 1881728017;
         this.field2595 = Buffer.method13047(var1, 1090107343) * -1935896051;
         this.field2602 = Buffer.method13047(var1, 1463824616) * 1784507657;
         this.method5469((byte)68);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "gj.as(" + ')');
      }
   }
   ...
   public classKY vmethod480(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var6, "gj.ag(" + ')');
      }
   }
   ...
   public void vmethod485(Buffer var1) {
      this.field2606 = Buffer.method13039(var1, -346779531) * 764602599;
      this.field2599 = Buffer.method13039(var1, -346779531) * -882424765;
      this.field2598 = Buffer.method13047(var1, 1086922347) * -1269422327;
      this.field2596 = Buffer.method13047(var1, -258846604) * -893933113;
      this.field2600 = Buffer.method13047(var1, -1897665918) * 654540389;
      this.field2604 = Buffer.method13047(var1, -55539999) * 899678031;
      this.field2605 = Buffer.method13047(var1, 1292108813) * -743576161;
      this.field2597 = Buffer.method13047(var1, 96242450) * -2081182426;
      this.field2595 = Buffer.method13047(var1, 350670022) * 1876259037;
      this.field2602 = Buffer.method13047(var1, 1408015074) * -1094717737;
   ...
   public boolean vmethod476(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "gj.ae(" + ')');
      }
   }
   ...
   void method5469(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gj.ax(" + ')');
      }
   }
