...
public class classMR {
   ...
   public static classOC method7647(int var0, byte var1) {
      try {
         ...
         if (null != var2) {
            ...
            var2 = new classOC(new Buffer(var3));
            classOC.field4814.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "mr.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   public static void method7646(AbstractArchive var0, int var1) {
      try {
         classPA.field5208 = var0;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "mr.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;II)V")
   @ObfuscatedName("gf")
   static void method7648(Buffer var0, int var1, int var2) {
      try {
         classCK.method1577(var0.array, var1, 1087227559);
         classBZ.method1391(var0, var1, -1038651980);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "mr.gf(" + ')');
      }
   }
}
