...
public class FriendsList extends UserList implements FriendContainer {
   ...
   User vmethod555(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "rn.az(" + ')');
      }
   }
   ...
   User[] vmethod558(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "rn.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;IB)V")
   @ObfuscatedName("ax")
   public void method10135(Buffer var1, int var2, byte var3) {
      try {
         while (702114061 * var1.offset < var2) {
            ...
            int var7 = Buffer.method13047(var1, -553521674);
         ...
         throw classEG.newRunException(var15, "rn.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("ay")
   public void method10136(Buffer var1, int var2) {
      while (702114061 * var1.offset < var2) {
         boolean var3 = Buffer.method13039(var1, -346779531) == 1;
         ...
         int var6 = Buffer.method13047(var1, -1321718598);
   ...
   public static classYY method10130(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "rn.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("aq")
   public void method10137(Buffer var1, int var2) {
      while (702114061 * var1.offset < var2) {
         boolean var3 = Buffer.method13039(var1, -346779531) == 1;
         ...
         int var6 = Buffer.method13047(var1, -1192861307);
         int var7 = Buffer.method13039(var1, -346779531);
         int var8 = Buffer.method13039(var1, -346779531);
         boolean var9 = (var8 & 2) != 0;
         boolean var10 = (var8 & 1) != 0;
   ...
   public boolean method10134(classAAE var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var5, "rn.ae(" + ')');
      }
   }
}
