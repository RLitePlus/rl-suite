...
public final class FloorDecoration implements GroundObject, TileObject {
   ...
   void method3938(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "eo.af(" + ')');
      }
   }
   ...
   public static int method3936(FloorDecoration var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "eo.az(" + 41);
      }
   }

   public Shape getClickbox() {
      return Perspective.getClickbox(
         classOE.client, this.method3939(), this.method3941(), 0, this.field1806 * 1333275141, this.field1808 * 498815127, this.field1807 * -276908185
      );
   }
