...
public class classBM {
   ...
   @ObfuscatedName("cq")
   static IndexedSprite[] field514;
   @ObfuscatedSignature(descriptor = "Liq;")
   @ObfuscatedName("fo")
   static ClanSettings field513;
   ...
   public static void method1158(int var0) {
      try {
         ...
         throw classEG.newRunException(var4, "bm.az(" + ')');
      }
   }
   ...
   boolean method1160(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bm.af(" + ')');
      }
   }
   ...
   public static void method1151(classBM var0, float[] var1, int var2, int var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var17, "bm.az(" + ')');
      }
   }
   ...
   void method1163(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var10, "bm.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("ae")
   public static WidgetConfigNode method1157(WidgetConfigNode var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         WidgetConfigNode var6 = var0;

         for (WidgetConfigNode var7 = null; null != var6; var6 = var6.field4140) {
            if (-1057754721 * var6.field4136 >= var1) {
               ...
               if (1443675333 * var6.field4134 <= var2) {
                  ...
                  if (var6.field4134 * 1443675333 < var1) {
                     ...
                     WidgetConfigNode var8 = new WidgetConfigNode(
                        var6.field4134 * 1443675333, var1 - 1, var6.field4137 * -802457829, 123180743 * var6.field4135
                     );
                     if (var7 != null) {
                        if (var5 >= -1) {
                           throw new IllegalStateException();
                  ...
                  if (var6.field4136 * -1057754721 > var2) {
                     ...
                     WidgetConfigNode var13 = new WidgetConfigNode(
                        var2 + 1, var6.field4136 * -1057754721, var6.field4137 * -802457829, var6.field4135 * 123180743
                     );
                     if (var7 != null) {
                        if (var5 >= -1) {
                           throw new IllegalStateException();
         ...
         for (WidgetConfigNode var11 = var0; null != var11; var11 = var11.field4140) {
            if (var5 >= -1) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.newRunException(var9, "bm.ae(" + ')');
      }
   }
   ...
   public static classLJ[] method1149(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "bm.ag(" + ')');
      }
   }
