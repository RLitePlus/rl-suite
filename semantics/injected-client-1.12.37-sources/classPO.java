...
public class classPO implements classOZ, EntityOps {
   ...
   void method9049(int var1, int var2, String var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var6, "po.aw(" + ')');
      }
   }
   ...
   void method9051(int var1, int var2, int var3, int var4, int var5, String var6, byte var7) {
      try {
         ...
         throw classEG.newRunException(var9, "po.ak(" + ')');
      }
   }
   ...
   void method9054(int var1, int var2, int var3, int var4, int var5, int var6, String var7, byte var8) {
      try {
         ...
         throw classEG.newRunException(var10, "po.av(" + ')');
      }
   }
   ...
   void method9058(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "po.at(" + ')');
      }
   }
   ...
   boolean method9063(int var1, int var2, int[] var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var6, "po.an(" + ')');
      }
   }
   ...
   int method9068(int var1, int[] var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var8, "po.am(" + 41);
      }
   }
   ...
   public int vmethod539(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "po.af(" + 41);
      }
   }
   ...
   public String vmethod551(int var1, int[] var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var7, "po.ab(" + ')');
      }
   }
   ...
   public classOZ vmethod542(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "po.ag(" + ')');
      }
   }
   ...
   public boolean vmethod540(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "po.ae(" + ')');
      }
   }
   ...
   int method9074(int var1, int[] var2, int var3) {
      try {
         ...
         if (null != var5) {
            ...
            var5 = new VarbitComposition(new Buffer(var6));
         ...
         throw classEG.newRunException(var7, "po.bn(" + 41);
      }
   }
   ...
   @ObfuscatedName("bc")
   boolean method9042(Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (var2 >= var3 && var2 <= var4) {
         ...
         int var18 = Buffer.method13047(var1, 1146048691);
         int var21 = Buffer.method13047(var1, 1261360626);
         ...
         int var9 = Buffer.method13047(var1, -544671130);
         int var10 = Buffer.method13047(var1, 1332224802);
         int var11 = Buffer.method13047(var1, -1159540884);
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;IIIIII)Z")
   @ObfuscatedName("bp")
   boolean method9043(Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (var2 >= var3 && var2 <= var4) {
         int var17 = var2 - var3;
         ...
         int var15 = Buffer.method13039(var1, -346779531);
         int var18 = Buffer.method13047(var1, -469092688);
         int var21 = Buffer.method13047(var1, 1805746601);
         int var23 = var1.method13056((byte)1);
         int var24 = var1.method13056((byte)1);
         ...
         int var8 = Buffer.method13039(var1, -346779531);
         int var9 = Buffer.method13047(var1, 1380351365);
         int var10 = Buffer.method13047(var1, -1276607113);
         int var11 = Buffer.method13047(var1, 1591351283);
         int var12 = var1.method13056((byte)1);
         int var13 = var1.method13056((byte)1);
   ...
   public boolean vmethod546(byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "po.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("gu")
   public static boolean method9044(classPO var0, Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      if (var0 == null) {
      ...
      try {
         ...
         if (var5 == var2) {
            ...
            if (var8 != 1161561653) {
               ...
               int var20 = Buffer.method13047(var1, 1860506613);
               int var23 = Buffer.method13047(var1, 1976193522);
            ...
            if (var8 != 1161561653) {
               ...
               int var10 = Buffer.method13047(var1, -1756125196);
               int var11 = Buffer.method13047(var1, 67953986);
               int var12 = Buffer.method13047(var1, 1965030463);
               int var13 = var1.method13056((byte)1);
         ...
         throw classEG.newRunException(var16, "po.ai(" + ')');
      }
   }
   ...
   classPO method9071(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "po.ah(" + ')');
      }
   }
   ...
   void method9048(int var1, String var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var5, "po.ar(" + ')');
      }
   }
   ...
   int method9075(int var1, int[] var2) {
      ...
      if (null != var4) {
         ...
         var4 = new VarbitComposition(new Buffer(var5));
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;IIIIII)Z")
   @ObfuscatedName("bm")
   boolean method9045(Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (var2 >= var3 && var2 <= var4) {
         int var17 = var2 - var3;
         ...
         int var15 = Buffer.method13039(var1, -346779531);
         int var18 = Buffer.method13047(var1, -1572253125);
         int var21 = Buffer.method13047(var1, 846614506);
         int var23 = var1.method13056((byte)1);
         int var24 = var1.method13056((byte)1);
         ...
         int var8 = Buffer.method13039(var1, -346779531);
         int var9 = Buffer.method13047(var1, -798650124);
         int var10 = Buffer.method13047(var1, -1952101419);
         int var11 = Buffer.method13047(var1, -984448061);
         int var12 = var1.method13056((byte)1);
         int var13 = var1.method13056((byte)1);
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;IIIIII)Z")
   @ObfuscatedName("br")
   boolean method9046(Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (var2 >= var3 && var2 <= var4) {
         int var17 = var2 - var3;
         ...
         int var15 = Buffer.method13039(var1, -346779531);
         int var18 = Buffer.method13047(var1, -1087473394);
         int var21 = Buffer.method13047(var1, -1452890414);
         int var23 = var1.method13056((byte)1);
         int var24 = var1.method13056((byte)1);
         ...
         int var8 = Buffer.method13039(var1, -346779531);
         int var9 = Buffer.method13047(var1, -429605590);
         int var10 = Buffer.method13047(var1, 1888469593);
         int var11 = Buffer.method13047(var1, 406812709);
         int var12 = var1.method13056((byte)1);
         int var13 = var1.method13056((byte)1);
   ...
   @ObfuscatedName("ai")
   boolean method9047(Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         if (var2 >= var3) {
            if (var8 != 1161561653) {
               throw new IllegalStateException();
