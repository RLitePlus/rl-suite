...
public class classCL implements Iterable {
   ...
   @ObfuscatedName("az")
   final IterableNodeHashTable field782 = new IterableNodeHashTable(16);
   ...
   static float[] method1581(JSONObject var0, String var1, int var2) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var6, "cl.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IIIILex;I)Ldz;")
   @ObfuscatedName("af")
   WorldView method1582(int var1, int var2, int var3, int var4, classEX var5, int var6) {
      try {
         WorldView var7 = new WorldView(var1, var2, var3, var4, var5);
         IterableNodeHashTable.method13576(this.field782, var7, var1);
         this.field779 += -302879415;
         return var7;
      } catch (RuntimeException var8) {
         throw classEG.newRunException(var8, "cl.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("an")
   WorldView method1595(int var1, int var2) {
   ...
   @ObfuscatedName("ab")
   void method1587(WorldView var1, byte var2) {
      ...
      try {
         if (var1 != null) {
            ...
            WorldView.method3745(var1, (byte)-59);
            var1.vmethod398();
            this.field779 -= -302879415;
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "cl.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IS)Ldz;")
   @ObfuscatedName("ag")
   public WorldView method1590(int var1, short var2) {
      try {
         return (WorldView)this.field782.method13595(var1);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "cl.ag(" + ')');
      }
   }
   ...
   public Iterator iterator() {
      try {
         ...
         throw classEG.newRunException(var1, "cl.iterator(" + ')');
      }
   }
   ...
   public void method1632(int var1) {
      WorldEntity var2 = (WorldEntity)classIS.field3053.worldEntities.method13600(var1);
      if (var2 != null) {
         client.logger.debug("WorldEntity despawn: {}", var2.field6009 * -1807801405);
         classOE.client.getCallbacks().post(new WorldEntityDespawned(var2));
      }
   }
   ...
   public static void method1583(classCL var0, int var1, byte var2) {
      if (var0 == null) {
         ...
         try {
            WorldView var3 = (WorldView)var0.field782.method13595(var1);
            var0.method1587(var3, (byte)1);
            var0.method1632(var1);
         } catch (RuntimeException var4) {
            throw classEG.newRunException(var4, "cl.ae(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("ax")
   WorldView method1596(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var10, "cl.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("bc")
   WorldEntity method1599(int var1) {
      return (WorldEntity)method1592(this, -708227910).worldEntities.method13595(var1);
   }
   ...
   void method1615(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cl.aj(" + ')');
      }
   }
   ...
   classTN method1620(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "cl.ay(" + ')');
      }
   }
   ...
   void method1626(int var1) {
      try {
         ...
         IterableNodeHashTable.method13579(this.field782);
         this.field779 = 0;
         this.field780.clear();
         this.field781.clear();
         ...
         if (null != this.field785) {
            WorldView.method3724(this.field785, 1840403635);
            IterableNodeHashTable.method13576(this.field782, this.field785, 0L);
            this.field779 = -302879415;
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "cl.ad(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(III)Ldz;")
   @ObfuscatedName("ap")
   WorldView method1579(int var1, int var2, int var3) {
   ...
   void method1584(int var1) {
      WorldView var2 = (WorldView)this.field782.method13595(var1);
      this.method1587(var2, (byte)1);
   }

   @ObfuscatedSignature(descriptor = "(II)Ldz;")
   @ObfuscatedName("am")
   WorldView method1597(int var1, int var2) {
      for (WorldView var4 : this) {
         if (!var4.method3719(-2087374717)) {
            int var5 = -1444178379 * var4.field1709;
            int var6 = -351145363 * var4.field1708;
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;)V")
   @ObfuscatedName("ar")
   void method1589(WorldView var1) {
      if (var1 != null) {
         this.field780.remove(var1.field1699 * 2140889407);
         this.field781.remove(2140889407 * var1.field1699);
         WorldView.method3745(var1, (byte)-22);
         var1.vmethod398();
         this.field779 -= -302879415;
      }
   }
   ...
   static final void method1630(int var0, int var1, int var2) {
      try {
         if (-1927903443 * client.menu.field6797 < 2) {
            if (var2 != 1459476222) {
               throw new IllegalStateException();
            }
         ...
         if (!client.field858) {
            ...
            String var5;
            label79: {
               int var3 = -1927903443 * client.menu.field6797 - 1;
               ...
               var5 = Menu.method12648(client.menu, var3, -115655011);
            }

            if (client.menu.field6797 * -1927903443 > 2) {
               if (var2 != 1459476222) {
                  throw new IllegalStateException();
               }

               var5 = var5 + classQY.method9847(16777215, (byte)104) + " " + '/' + " " + (-1927903443 * client.menu.field6797 - 2) + classKK.field3778;
            }

            classBB.field341.method97(var5, 4 + var0, 15 + var1, 16777215, 0, 1612595797 * client.field855 / 1000);
         }
      } catch (RuntimeException var6) {
         throw classEG.newRunException(var6, "cl.eo(" + ')');
      }
   }
   ...
   public static void method1611(classCL var0, int var1, classTN var2, classTW var3, int var4) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "cl.al(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(II)Ldz;")
   @ObfuscatedName("at")
   WorldView method1598(int var1, int var2) {
      for (WorldView var4 : this) {
         if (!var4.method3719(-2087374717)) {
            int var5 = -1444178379 * var4.field1709;
            int var6 = -351145363 * var4.field1708;
   ...
   @ObfuscatedName("gn")
   public WorldView method1634(int var1) {
      return this.method1590(var1, (short)2276);
   }

   @ObfuscatedSignature(descriptor = "(II)Ldz;")
   @ObfuscatedName("yq")
   public WorldView method1635(int var1, int var2) {
      return this.method1596(var1, var2, -1987881682);
   }

   @ObfuscatedSignature(descriptor = "(I)Lsp;")
   @ObfuscatedName("ah")
   WorldEntity method1600(int var1) {
      return (WorldEntity)method1592(this, -1922624912).worldEntities.method13595(var1);
   }

   @ObfuscatedSignature(descriptor = "(Lcl;II)Lsp;")
   @ObfuscatedName("bl")
   public static WorldEntity method1601(classCL var0, int var1, int var2) {
      if (var0 == null) {
         return var0.method1603(var1, var1);
      } else {
         try {
            return (WorldEntity)method1592(var0, -1107644636).worldEntities.method13595(var1);
         } catch (RuntimeException var3) {
            throw classEG.newRunException(var3, "cl.ac(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(I)Lsp;")
   @ObfuscatedName("bx")
   WorldEntity method1602(int var1) {
      return (WorldEntity)method1592(this, -1954751538).worldEntities.method13595(var1);
   }

   @ObfuscatedSignature(descriptor = "(ILcl;)Ldz;")
   @ObfuscatedName("ms")
   public static WorldView method1636(int var0, classCL var1) {
   ...
   @ObfuscatedName("az")
   WorldView method1580(int var1, int var2, int var3, int var4) {
      try {
         this.field785 = this.method1582(0, var1, var2, var3, classEX.field1977, -1393038213);
         return this.field785;
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "cl.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("bq")
   void method1627() {
      for (WorldView var2 : this.field782) {
         this.method1587(var2, (byte)1);
      }
      ...
      this.field787 = classTW.field6243;
      if (null != this.field785) {
         WorldView.method3724(this.field785, -674612632);
         IterableNodeHashTable.method13576(this.field782, this.field785, 0L);
         this.field779 = -302879415;
      }
   }
   ...
   @ObfuscatedName("kk")
   public static WorldView method1592(classCL var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "cl.as(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(I)Ldz;")
   @ObfuscatedName("aw")
   public WorldView method1591(int var1) {
      return (WorldView)this.field782.method13595(var1);
   }
   ...
   @ObfuscatedSignature(descriptor = "(ILcl;)Ldz;")
   @ObfuscatedName("wa")
   public static WorldView method1638(int var0, classCL var1) {
   ...
   void method1610(classTN var1, classTW var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "cl.ao(" + ')');
      }
   }
   ...
   static int method1628(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var8, "cl.av(" + 41);
      }
   }
   ...
   @ObfuscatedName("yl")
   public WorldView method1639(int var1, int var2, int var3, int var4, classEX var5) {
   ...
   static void method1629(int var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var6, "cl.dn(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;)V")
   @ObfuscatedName("ng")
   public void method1631(WorldView var1) {
      if (var1 != null) {
         if (var1.field1713 != null) {
            classOE.client.getCallbacks().post(new WorldViewUnloaded(var1));
         }
   ...
   public static classTW method1622(classCL var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "cl.aq(" + ')');
      }
   }
   ...
   public static void method1586(String var0, String var1, String var2, int var3, int var4, byte var5) throws IOException {
      try {
         ...
         for (int var6 = 0; var6 < 4; var6++) {
            ...
            classDB.field1379 = new File(ClanChannel.field2954, "jagex_cl_" + var0 + "_" + var2 + var8 + ".dat");
            String var9 = null;
            String var10 = null;
            boolean var11 = false;
               ...
               label690: {
                  label689: {
                     try {
                        ...
                        Buffer var13 = new Buffer((int)var12.method257(-153393736));

                        while (702114061 * var13.offset < var13.array.length) {
                           if (var5 != 1) {
                              throw new IllegalStateException();
                           }

                           int var14 = var12.method260(var13.array, var13.offset * 702114061, var13.array.length - 702114061 * var13.offset, -1397369950);
                           if (var14 == -1) {
                              throw new IOException();
                           }

                           var13.offset += -1095856699 * var14;
                        }

                        var13.offset = 0;
                        int var67 = Buffer.method13039(var13, -346779531);
                        if (var67 >= 1) {
                           if (var5 != 1) {
                              throw new IllegalStateException();
                           }
                           ...
                           if (var67 <= 3) {
                              ...
                              if (var67 > 1) {
                                 ...
                                 var15 = Buffer.method13039(var13, -346779531);
                              }
                              ...
                              if (var67 <= 2) {
                                 ...
                                 var9 = Buffer.method13082(var13, 1921404263);
                                 if (var15 == 1) {
                                    if (var5 != 1) {
                                       throw new IllegalStateException();
                                    }

                                    var10 = Buffer.method13082(var13, -754422716);
                                    var33 = false;
                                 } else {
                                    var33 = false;
                                 }
            ...
            if (var11) {
               ...
               try {
                  ...
                  Buffer var72 = new Buffer(500);
                  Buffer.method12971(var72, 3, (byte)-55);
                  byte var10001;
                  if (null != var66) {
                     if (var5 != 1) {
                        throw new IllegalStateException();
                  ...
                  Buffer.method12971(var72, var10001, (byte)-74);
                  ...
                  var70.method242(var72.array, 0, 702114061 * var72.offset, -1522899189);
         ...
         if (classMT.field4586.exists()) {
            ...
            try {
               File var48 = new File(ClanChannel.field2954, "random.dat");
               if (var48.exists()) {
            ...
            for (int var49 = 0; var49 < -646722873 * classUP.field6363; var49++) {
               ...
               GraphicsObject.field477[var49] = new classAAC(
                  new classAAR(classBJ.method1113("main_file_cache.idx" + var49, -374206652), "rw", 1048576L), 6000, 0
               );
            }
         } else if (var5 == 1) {
         ...
         throw classEG.newRunException(var46, "cl.az(" + ')');
      }
   }
   ...
   public void method1633(int var1) {
      WorldView var2 = this.method1634(var1);
      if (var2 != null) {
         Callbacks var3 = classOE.client.getCallbacks();
   ...
   void method1585(int var1, byte var2) {
      ...
      try {
         WorldView var3 = (WorldView)this.field782.method13572(var1);
         this.method1587(var3, (byte)1);
         this.method1633(var1);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "cl.ae(" + ')');
   ...
   @ObfuscatedName("ac")
   WorldEntity method1603(int var1, int var2) {
      try {
         return (WorldEntity)method1592(this, -1107644636).worldEntities.method13600(var1);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "cl.ac(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(I)Ldz;")
   @ObfuscatedName("as")
   public WorldView method1594(int var1) {
      try {
         return this.field785;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "cl.as(" + ')');
