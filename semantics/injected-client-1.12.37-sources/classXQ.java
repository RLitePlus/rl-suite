...
public class classXQ implements classXZ {
   ...
   static final void method12876(int var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "xq.gz(" + ')');
      }
   }
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "xq.az(" + 41);
      }
   }
   ...
   static int method12872(String var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "xq.az(" + 41);
      }
   }
   ...
   static final void method12875(boolean var0, int var1) {
      try {
         if (var0) {
            ...
            classEN var3;
            if (classAB.field122.method2805(classBF.JX_CHARACTER_ID, (short)10983)) {
               if (var1 != 402128428) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.newRunException(var2, "xq.bn(" + ')');
      }
   }
   ...
   static classXQ[] method12870(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "xq.ag(" + ')');
      }
   }
   ...
   static void method12874(classCP var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "xq.aq(" + ')');
      }
   }
}
