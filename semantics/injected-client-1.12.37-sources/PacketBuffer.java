...
public class PacketBuffer extends Buffer implements net.runelite.api.PacketBuffer {
   ...
   public void method12896(int var1) {
      this.array[(this.offset += -1095856699) * 702114061 - 1] = (byte)(var1 + this.field6929.method13625((byte)1));
   }
   ...
   public void vmethod649(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "xs.az(" + ')');
      }
   }
   ...
   public void method12892(int[] var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "xs.af(" + ')');
      }
   }
   ...
   public boolean method12906(int var1) {
      try {
         int var2 = this.array[this.offset * 702114061] - classYT.method13626(this.field6929, -1969645377) & 0xFF;
         if (var2 < 128) {
            if (var1 != 127450546) {
         ...
         throw classEG.newRunException(var3, "xs.as(" + ')');
      }
   }
   ...
   public int method12902(int var1) {
      try {
         return this.array[(this.offset += -1095856699) * 702114061 - 1] - this.field6929.method13625((byte)1) & 0xFF;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "xs.ag(" + 41);
      }
   }
   ...
   public void method12917() {
      this.field6927 = this.offset * -1286969624;
   }
   ...
   public void method12913(byte[] var1, int var2, int var3, int var4) {
      try {
         for (int var5 = 0; var5 < var3; var5++) {
            ...
            var1[var5 + var2] = (byte)(this.array[(this.offset += -1095856699) * 702114061 - 1] - this.field6929.method13625((byte)1));
         }
      } catch (RuntimeException var6) {
         throw classEG.newRunException(var6, "xs.ac(" + ')');
      }
   }
   ...
   public static int method12909(PacketBuffer var0) {
      int var1 = var0.array[(var0.offset += -1095856699) * 702114061 - 1] - var0.field6929.method13625((byte)1) & 0xFF;
      return var1 < 128 ? var1 : (var1 - 128 << 8) + (var0.array[(var0.offset += -1095856699) * 702114061 - 1] - var0.field6929.method13625((byte)1) & 0xFF);
   }
   ...
   public int method12931(int var1, int var2) {
      try {
         return var1 - 702114061 * this.offset;
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "xs.ay(" + 41);
      }
   }
   ...
   public boolean method12907() {
      int var1 = this.array[this.offset * 702114061] - classYT.method13626(this.field6929, -1984765983) & 0xFF;
   ...
   public static int method12922(PacketBuffer var0, int var1) {
      ...
      for (var0.field6927 += var1 * -1278857492; var1 > var3; var3 = 8) {
         var4 += (var0.array[var2++] & field6926[var3]) << var1 - var3;
         var1 -= var3;
      }

      if (var3 == var1) {
         var4 += var0.array[var2] & field6926[var3];
      } else {
         var4 += var0.array[var2] >> var3 - var1 & field6926[var1];
      }
   ...
   public int method12929(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "xs.aj(" + 41);
      }
   }
   ...
   public void method12898(int var1) {
      this.array[(this.offset += -1095856699) * 670931612 - 1] = (byte)(var1 + this.field6929.method13625((byte)1));
   }
   ...
   public int method12904() {
      return this.array[(this.offset += -1095856699) * 305740227 - 1] - this.field6929.method13625((byte)1) & 0xFF;
   }
   ...
   public void method12900(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "xs.ab(" + ')');
      }
   }
   ...
   public static void method12919(PacketBuffer var0) {
      var0.field6927 = var0.offset * -1286969624;
   }
   ...
   public void method12894(classYT var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "xs.ae(" + ')');
      }
   }
   ...
   public boolean method12908() {
      int var1 = this.array[this.offset * 702114061] - classYT.method13626(this.field6929, -2023992503) & 0xFF;
      return var1 >= 128;
   }
   ...
   public int method12910() {
      int var1 = this.array[(this.offset += -1095856699) * 702114061 - 1] - this.field6929.method13625((byte)1) & 0xFF;
      return var1 < 128 ? var1 : (var1 - 128 << 8) + (this.array[(this.offset += -1095856699) * 702114061 - 1] - this.field6929.method13625((byte)1) & 0xFF);
   }
      ...
      if (var0 == null) {
         ...
         try {
            ...
            for (var0.field6927 += var1 * -2104238319; var1 > var4; var4 = 8) {
               var5 += (var0.array[var3++] & field6926[var4]) << var1 - var4;
               var1 -= var4;
            }
            ...
            if (var4 == var1) {
               ...
               var5 += var0.array[var3] & field6926[var4];
            } else {
               var5 += var0.array[var3] >> var4 - var1 & field6926[var1];
            }

            return var5;
         } catch (RuntimeException var6) {
            throw classEG.newRunException(var6, "xs.ao(" + 41);
         }
      }
   }
   ...
   public static void method12914(PacketBuffer var0, byte[] var1, int var2, int var3) {
      ...
      for (int var4 = 0; var4 < var3; var4++) {
         var1[var4 + var2] = (byte)(var0.array[(var0.offset += -1095856699) * 702114061 - 1] - var0.field6929.method13625((byte)1));
      }
   }
   ...
   public void method12915(byte[] var1, int var2, int var3) {
      for (int var4 = 0; var4 < var3; var4++) {
         var1[var4 + var2] = (byte)(this.array[(this.offset += 597900486) * 702114061 - 1] - this.field6929.method13625((byte)1));
      }
   }
   ...
   public int method12924(int var1) {
      ...
      for (this.field6927 += var1 * -1158609679; var1 > var3; var3 = 8) {
         var4 += (this.array[var2++] & field6926[var3]) << var1 - var3;
         var1 -= var3;
      }

      if (var3 == var1) {
         var4 += this.array[var2] & field6926[var3];
      } else {
         var4 += this.array[var2] >> var3 - var1 & field6926[var1];
      }
   ...
   public static void method12926(PacketBuffer var0, int var1) {
      if (var0 == null) {
         ...
         try {
            var0.offset = (7 + var0.field6927 * -653463055) / 8 * -1095856699;
         } catch (RuntimeException var2) {
            throw classEG.newRunException(var2, "xs.al(" + ')');
         }
      }
   }
   ...
   public void method12927() {
      this.offset = (7 + this.field6927 * -1058862881) / 8 * -1095856699;
   }

   @ObfuscatedSignature(descriptor = "()V")
   @ObfuscatedName("bi")
   public void method12928() {
      this.offset = (7 + this.field6927 * -653463055) / 8 * -1095856699;
   }
   ...
   static void method12934(int var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var6, "xs.du(" + ')');
      }
   }
   ...
   public static int method12911(PacketBuffer var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            int var2 = var0.array[(var0.offset += -1095856699) * 702114061 - 1] - var0.field6929.method13625((byte)1) & 0xFF;
            if (var2 < 128) {
               if (var1 <= 2) {
                  throw new IllegalStateException();
               } else {
               ...
               return (var2 - 128 << 8) + (var0.array[(var0.offset += -1095856699) * 702114061 - 1] - var0.field6929.method13625((byte)1) & 0xFF);
            }
         } catch (RuntimeException var3) {
            throw classEG.newRunException(var3, "xs.ax(" + 41);
         }
      }
   }
   ...
   public static void method12916(PacketBuffer var0, byte[] var1, int var2, int var3) {
      ...
      for (int var4 = 0; var4 < var3; var4++) {
         var1[var4 + var2] = (byte)(var0.array[(var0.offset += -1067028931) * 702114061 - 1] - var0.field6929.method13625((byte)1));
      }
   }
   ...
   public int method12912(byte var1) {
      try {
         int var2 = this.array[(this.offset += -1095856699) * 702114061 - 1] - this.field6929.method13625((byte)1) & 0xFF;
         if (var2 < 128) {
            if (var1 <= 2) {
               throw new IllegalStateException();
            } else {
            ...
            return (var2 - 128 << 8) + (this.array[(this.offset += -1095856699) * 702114061 - 1] - this.field6929.method13625((byte)1) & 0xFF);
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "xs.ax(" + 41);
      }
   ...
   public void method12920(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "xs.aa(" + ')');
      }
   }
