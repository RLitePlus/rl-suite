...
public class Widget extends Node implements net.runelite.api.widgets.Widget {
   ...
   public boolean method7212(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.ar(" + ')');
      }
   }
   ...
   Object[] method7161(Object[] var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "lw.af(" + ')');
      }
   }
   ...
   public net.runelite.api.widgets.Widget[] getStaticChildren() {
      if (this.field4260 * 63131743 > -1) {
         ...
         for (Widget var5 : classOE.client.method2255(WidgetUtil.componentToInterface(this.field4329 * -1163656551))) {
   ...
   SpritePixels method7187(classLY var1, classDA var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var7, "lw.ao(" + ')');
      }
   }
   ...
   public static void method7157(int var0) {
      try {
         ...
         throw classEG.newRunException(var3, "lw.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("as")
   void method7175(Buffer var1, int var2) {
      try {
   ...
   @ObfuscatedName("ac")
   int[] method7180(Buffer var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var6, "lw.ac(" + ')');
      }
   }
   ...
   public SpritePixels method7319(classLY var1, boolean var2, classDA var3, int var4) {
      ...
      try {
         ...
         throw classEG.newRunException(var15, "lw.aa(" + ')');
      }
   }
   ...
   public void method7230(int var1, Object var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var5, "lw.an(" + ')');
      }
   }
   ...
   boolean method7192(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.aj(" + ')');
      }
   }
   ...
   public Model method7200(classLY var1, SequenceDefinition var2, int var3, boolean var4, PlayerComposition var5, classPL var6, NpcOverrides var7, int var8) {
      try {
            ...
            if (null == var13) {
               ...
               switch (var9) {
                  ...
                  case 3:
                     ...
                     break;
                  case 4:
                     ItemComposition var17 = classOB.method8299(var10, (byte)77);
                     var14 = ItemComposition.method8655(var17, 10, -1145537891);
         ...
         throw classEG.newRunException(var18, "lw.ad(" + ')');
      }
   }
   ...
   public void method7210(int var1, int var2, String var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var6, "lw.ai(" + ')');
      }
   }
   ...
   public boolean method7249(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.bm(" + ')');
      }
   }
   ...
   public Object method7220(int var1, Object var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var5, "lw.ak(" + ')');
      }
   }
   ...
   public long method7228(int var1, long var2) {
      try {
         ...
         throw classEG.newRunException(var5, "lw.at(" + ')');
      }
   }
   ...
   public static void method7306(Widget var0, PlayerComposition var1, boolean var2, byte var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "lw.bl(" + ')');
      }
   }
   ...
   void method7239(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.bx(" + ')');
      }
   }
   ...
   public void method7241(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "lw.bc(" + ')');
      }
   }
   ...
   public boolean method7247(int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var10, "lw.br(" + ')');
      }
   }
   ...
   public static boolean method7215(Widget var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "lw.aw(" + ')');
      }
   }
   ...
   public void method7207(int var1, String var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var6, "lw.au(" + ')');
      }
   }
   ...
   public int getParentId() {
      if (!classOE.client.isClientThread()) {
         ...
         if (var1 != -1) {
            ...
            int var2 = this.getId();
            if (WidgetUtil.componentToInterface(var2) == classOE.client.getTopLevelInterfaceId()) {
               return -1;
            } else {
               ...
               for (InterfaceParent var7 : classOE.client.method1676()) {
                  if (var8 == var7.getId()) {
   ...
   public int method7250(String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "lw.bt(" + 41);
      }
   }
   ...
   public int method7257(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.bj(" + 41);
      }
   }
   ...
   public int method7260(byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "lw.bk(" + 41);
      }
   }
   ...
   public String method7263(int var1) {
      try {
         ...
         throw classEG.newRunException(var6, "lw.bo(" + ')');
      }
   }
   ...
   public int[] method7267(byte var1) {
      try {
         ...
         throw classEG.newRunException(var6, "lw.bu(" + ')');
      }
   }

   public net.runelite.api.widgets.Widget[] getDynamicChildren() {
      Widget var1 = classOE.client.method2295(this.field4329 * -1163656551);
      if (var1 == null) {
         return new net.runelite.api.widgets.Widget[0];
      } else {
   ...
   public classMA method7270(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.ba(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ag")
   void method7172(Buffer var1, int var2) {
      try {
         Buffer.method13039(var1, -346779531);
         this.field4275 = true;
         this.field4375 = Buffer.method13039(var1, -346779531) * 685068937;
         this.field4334 = Buffer.method13047(var1, -241947726) * -411168601;
         this.field4248 = var1.method13050((byte)16) * -1076753689;
         this.field4285 = var1.method13050((byte)16) * 1989424741;
         this.field4255 = Buffer.method13047(var1, 106831180) * 1034606045;
         if (9 == this.field4375 * -1510882375) {
            this.field4335 = var1.method13050((byte)16) * -259501473;
         } else {
            this.field4335 = Buffer.method13047(var1, 998811198) * -259501473;
         }

         this.field4251 = Buffer.method13043(var1, (byte)17) * -1430539503;
         this.field4252 = Buffer.method13043(var1, (byte)17) * -565540095;
         this.field4264 = Buffer.method13043(var1, (byte)17) * 1632281619;
         this.field4250 = Buffer.method13043(var1, (byte)17) * 454876301;
         this.field4342 = Buffer.method13047(var1, -1842555802) * -676768211;
         ...
         if (0 == -1510882375 * this.field4375) {
            this.field4258 = Buffer.method13047(var1, -126044868) * -803344527;
            this.field4269 = Buffer.method13047(var1, 1051631118) * -251301447;
            if (Buffer.method13039(var1, -346779531) == 1) {
               if (var2 != 1218236279) {
                  throw new IllegalStateException();
               }
         ...
         if (5 == this.field4375 * -1510882375) {
            ...
            this.field4351 = Buffer.method13047(var1, -359716027) * -727683123;
            if (Buffer.method13039(var1, -346779531) == 1) {
               if (var2 != 1218236279) {
                  throw new IllegalStateException();
               }
            ...
            this.field4347 = Buffer.method13039(var1, -346779531) * -2056841747;
            this.field4283 = Buffer.method13039(var1, -346779531) * -1993421947;
         ...
         if (6 == this.field4375 * -1510882375) {
            ...
            this.field4356 = Buffer.method13047(var1, 1370270829) * 1703663435;
            this.field4292 = Buffer.method13047(var1, 994802512) * 993003239;
            this.field4294 = Buffer.method13047(var1, 450674507) * 863028557;
            this.field4338 = Buffer.method13047(var1, -1508902731) * 1556726191;
            this.field4288 = Buffer.method13047(var1, -1221385387) * 742198477;
            ...
            Buffer.method13047(var1, -450046437);
            if (-1966367247 * this.field4251 != 0) {
               this.field4296 = Buffer.method13047(var1, -520213711) * 1299951355;
            }

            if (this.field4252 * 372143361 != 0) {
               Buffer.method13047(var1, -1192075905);
            }
         }
         ...
         if (4 == -1510882375 * this.field4375) {
            ...
            this.field4245 = Buffer.method13047(var1, -1135544449) * 590574429;
            ...
            this.field4303 = Buffer.method13039(var1, -346779531) * -763080175;
            this.field4304 = Buffer.method13039(var1, -346779531) * 571804797;
            this.field4305 = Buffer.method13039(var1, -346779531) * -2106140265;
            if (Buffer.method13039(var1, -346779531) == 1) {
               if (var2 != 1218236279) {
                  throw new IllegalStateException();
               }
         ...
         if (-1510882375 * this.field4375 == 3) {
            ...
            this.field4270 = var1.method13056((byte)1) * 1590850751;
            this.field4271 = Buffer.method13039(var1, -346779531) == 1;
            this.field4347 = Buffer.method13039(var1, -346779531) * -2056841747;
         }
         ...
         if (9 == this.field4375 * -1510882375) {
            ...
            this.field4277 = Buffer.method13039(var1, -346779531) * 327091521;
            this.field4270 = var1.method13056((byte)1) * 1590850751;
            if (Buffer.method13039(var1, -346779531) == 1) {
               if (var2 != 1218236279) {
                  throw new IllegalStateException();
         ...
         this.field4368 = Buffer.method13039(var1, -346779531) * 230129403;
         this.field4313 = Buffer.method13039(var1, -346779531) * -2074329479;
         if (Buffer.method13039(var1, -346779531) == 1) {
            if (var2 != 1218236279) {
               return;
            }
         ...
         throw classEG.newRunException(var5, "lw.ag(" + ')');
      }
   }
   ...
   public void method7281(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "lw.bi(" + ')');
      }
   }
   ...
   public classLH method7283(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.be(" + ')');
      }
   }
   ...
   public classLX method7294(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lw.bf(" + ')');
      }
   }
   ...
   boolean method7297(classLH var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "lw.bs(" + ')');
      }
   }
   ...
   public static SpritePixels method7190(Widget var0, classLY var1, classDA var2, byte var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "lw.al(" + ')');
      }
   }
   ...
   @ObfuscatedName("cq")
   void method7168(Buffer var1) {
      this.field4275 = false;
      this.field4375 = Buffer.method13039(var1, -346779531) * -128351660;
      this.field4247 = Buffer.method13039(var1, -346779531) * -811438059;
      this.field4334 = Buffer.method13047(var1, 1401870401) * -411168601;
      this.field4248 = var1.method13050((byte)16) * -1076753689;
      this.field4285 = var1.method13050((byte)16) * 1286043683;
      this.field4255 = Buffer.method13047(var1, -60978058) * -1283191478;
      this.field4335 = Buffer.method13047(var1, 1042200530) * -259501473;
      this.field4347 = Buffer.method13039(var1, -346779531) * 204805685;
      this.field4342 = Buffer.method13047(var1, 1143601347) * 328312260;
      ...
      this.field4316 = Buffer.method13047(var1, 1687274602) * 335111401;
      ...
      if (var2 > 0) {
         ...
         for (int var3 = 0; var3 < var2; var3++) {
            this.field4400[var3] = Buffer.method13039(var1, -346779531);
            this.field4401[var3] = Buffer.method13047(var1, -551266725);
         }
      }
      ...
      if (var7 > 0) {
         ...
         for (int var4 = 0; var4 < var7; var4++) {
            int var5 = Buffer.method13047(var1, -80780034);
            this.field4399[var4] = new int[var5];

            for (int var6 = 0; var6 < var5; var6++) {
               this.field4399[var4][var6] = Buffer.method13047(var1, -374051823);
      ...
      if (0 == 1850134265 * this.field4375) {
         this.field4269 = Buffer.method13047(var1, 1546002490) * 1065509630;
         this.field4289 = Buffer.method13039(var1, -346779531) == 1;
      }

      if (933354515 * this.field4375 == 1) {
         Buffer.method13047(var1, -1915000606);
         Buffer.method13039(var1, -346779531);
      }
      ...
      if (4 == -1510882375 * this.field4375 || 1 == this.field4375 * -683575018) {
         ...
         this.field4305 = Buffer.method13039(var1, -346779531) * -2106140265;
         this.field4303 = Buffer.method13039(var1, -346779531) * -763080175;
         this.field4245 = Buffer.method13047(var1, 399617741) * 590574429;
         if (65535 == this.field4245 * -1803847435) {
            this.field4245 = -590574429;
         }

         this.field4306 = Buffer.method13039(var1, -346779531) == 1;
      }
      ...
      if (-1510882375 * this.field4375 == 6) {
         ...
         this.field4288 = Buffer.method13047(var1, 1354374627) * 742198477;
         if (-142663889 == 511129499 * this.field4288) {
            this.field4288 = 439398981;
         }

         this.field4293 = Buffer.method13047(var1, -315022870) * 860859185;
         if (821151237 * this.field4293 == 343415003) {
            this.field4293 = -668997325;
         }

         this.field4338 = Buffer.method13047(var1, 1127683100) * 2091023102;
         this.field4356 = Buffer.method13047(var1, -1891040268) * 221177667;
         this.field4292 = Buffer.method13047(var1, 527139157) * 993003239;
      }
      ...
      if (this.field4247 * -851058883 == 2) {
         ...
         int var8 = Buffer.method13047(var1, -265984299) & 1535487212;
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("cl")
   void method7173(Buffer var1) {
      Buffer.method13039(var1, -346779531);
      this.field4275 = true;
      this.field4375 = Buffer.method13039(var1, -346779531) * 685068937;
      this.field4334 = Buffer.method13047(var1, 1226095204) * -411168601;
      this.field4248 = var1.method13050((byte)16) * -1076753689;
      this.field4285 = var1.method13050((byte)16) * 1989424741;
      this.field4255 = Buffer.method13047(var1, 1706687071) * 1034606045;
      if (9 == this.field4375 * -1510882375) {
         this.field4335 = var1.method13050((byte)16) * -259501473;
      } else {
         this.field4335 = Buffer.method13047(var1, -1796836835) * -259501473;
      }
      ...
      this.field4264 = Buffer.method13043(var1, (byte)17) * 1632281619;
      this.field4250 = Buffer.method13043(var1, (byte)17) * 454876301;
      this.field4342 = Buffer.method13047(var1, -1371666693) * -676768211;
      if (-1502647899 * this.field4342 == 65535) {
         this.field4342 = 676768211;
      } else {
         this.field4342 = -676768211 * (-1502647899 * this.field4342 + (-1163656551 * this.field4329 & -65536));
      ...
      this.field4289 = Buffer.method13039(var1, -346779531) == 1;
      if (0 == -1510882375 * this.field4375) {
         this.field4258 = Buffer.method13047(var1, -800624117) * -803344527;
         this.field4269 = Buffer.method13047(var1, -1235426038) * -251301447;
         this.field4403 = Buffer.method13039(var1, -346779531) == 1;
      }

      if (5 == this.field4375 * -1510882375) {
         this.field4348 = var1.method13056((byte)1) * 857041169;
         this.field4351 = Buffer.method13047(var1, -1604054585) * -727683123;
         this.field4282 = Buffer.method13039(var1, -346779531) == 1;
         this.field4347 = Buffer.method13039(var1, -346779531) * -2056841747;
         this.field4283 = Buffer.method13039(var1, -346779531) * -1993421947;
         this.field4284 = var1.method13056((byte)1) * 37017731;
         this.field4352 = Buffer.method13039(var1, -346779531) == 1;
         this.field4256 = Buffer.method13039(var1, -346779531) == 1;
      }
      ...
      if (6 == this.field4375 * -1510882375) {
         ...
         this.field4290 = var1.method13050((byte)16) * 1981476425;
         this.field4291 = var1.method13050((byte)16) * 1954863581;
         this.field4356 = Buffer.method13047(var1, -490902197) * 1703663435;
         this.field4292 = Buffer.method13047(var1, 30676335) * 993003239;
         this.field4294 = Buffer.method13047(var1, 144456973) * 863028557;
         this.field4338 = Buffer.method13047(var1, -109871164) * 1556726191;
         this.field4288 = Buffer.method13047(var1, 33839186) * 742198477;
         if (65535 == this.field4288 * 2114568197) {
            this.field4288 = -742198477;
         }

         this.field4297 = Buffer.method13039(var1, -346779531) == 1;
         Buffer.method13047(var1, -1573447692);
         if (-1966367247 * this.field4251 != 0) {
            this.field4296 = Buffer.method13047(var1, -181170079) * 1299951355;
         }

         if (this.field4252 * 372143361 != 0) {
            Buffer.method13047(var1, -434676914);
         }
      }

      if (4 == -1510882375 * this.field4375) {
         this.field4245 = Buffer.method13047(var1, 259000072) * 590574429;
         if (this.field4245 * -1803847435 == 65535) {
            this.field4245 = -590574429;
         }
      ...
      if (9 == this.field4375 * -1510882375) {
         this.field4277 = Buffer.method13039(var1, -346779531) * 327091521;
         this.field4270 = var1.method13056((byte)1) * 1590850751;
         this.field4278 = Buffer.method13039(var1, -346779531) == 1;
      }
      ...
      this.field4368 = Buffer.method13039(var1, -346779531) * 230129403;
      this.field4313 = Buffer.method13039(var1, -346779531) * -2074329479;
      this.field4314 = Buffer.method13039(var1, -346779531) == 1;
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("cd")
   void method7174(Buffer var1) {
      Buffer.method13039(var1, -346779531);
      this.field4275 = true;
      this.field4375 = Buffer.method13039(var1, -346779531) * 685068937;
      this.field4334 = Buffer.method13047(var1, -572661734) * -411168601;
      this.field4248 = var1.method13050((byte)16) * -1076753689;
      this.field4285 = var1.method13050((byte)16) * 1989424741;
      this.field4255 = Buffer.method13047(var1, 7580717) * 1034606045;
      if (9 == this.field4375 * -1510882375) {
         this.field4335 = var1.method13050((byte)16) * -259501473;
      } else {
         this.field4335 = Buffer.method13047(var1, 1807899564) * -259501473;
      }
      ...
      this.field4264 = Buffer.method13043(var1, (byte)17) * 1632281619;
      this.field4250 = Buffer.method13043(var1, (byte)17) * 454876301;
      this.field4342 = Buffer.method13047(var1, 960579237) * -676768211;
      if (-1502647899 * this.field4342 == 65535) {
         this.field4342 = 676768211;
      } else {
         this.field4342 = -676768211 * (-1502647899 * this.field4342 + (-1163656551 * this.field4329 & -65536));
      ...
      this.field4289 = Buffer.method13039(var1, -346779531) == 1;
      if (0 == -1510882375 * this.field4375) {
         this.field4258 = Buffer.method13047(var1, 1648727926) * -803344527;
         this.field4269 = Buffer.method13047(var1, -551555091) * -251301447;
         this.field4403 = Buffer.method13039(var1, -346779531) == 1;
      }

      if (5 == this.field4375 * -1510882375) {
         this.field4348 = var1.method13056((byte)1) * 857041169;
         this.field4351 = Buffer.method13047(var1, 807489590) * -727683123;
         this.field4282 = Buffer.method13039(var1, -346779531) == 1;
         this.field4347 = Buffer.method13039(var1, -346779531) * -2056841747;
         this.field4283 = Buffer.method13039(var1, -346779531) * -1993421947;
         this.field4284 = var1.method13056((byte)1) * 37017731;
      ...
      if (6 == this.field4375 * -1510882375) {
         ...
         this.field4290 = var1.method13050((byte)16) * 1981476425;
         this.field4291 = var1.method13050((byte)16) * 1954863581;
         this.field4356 = Buffer.method13047(var1, 17865158) * 1703663435;
         this.field4292 = Buffer.method13047(var1, 163568153) * 993003239;
         this.field4294 = Buffer.method13047(var1, -51558828) * 863028557;
         this.field4338 = Buffer.method13047(var1, 288905224) * 1556726191;
         this.field4288 = Buffer.method13047(var1, 924238525) * 742198477;
         if (65535 == this.field4288 * 2114568197) {
            this.field4288 = -742198477;
         }

         this.field4297 = Buffer.method13039(var1, -346779531) == 1;
         Buffer.method13047(var1, 1026166147);
         if (-1966367247 * this.field4251 != 0) {
            this.field4296 = Buffer.method13047(var1, 745655976) * 1299951355;
         }

         if (this.field4252 * 372143361 != 0) {
            Buffer.method13047(var1, -673847697);
         }
      }

      if (4 == -1510882375 * this.field4375) {
         this.field4245 = Buffer.method13047(var1, -1164198420) * 590574429;
         if (this.field4245 * -1803847435 == 65535) {
            this.field4245 = -590574429;
         }
   ...
   public static classTT method7287(Widget var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "lw.bq(" + ')');
      }
   }
   ...
   public static boolean method7273(Widget var0, classLY var1, classDA var2, int var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "lw.bw(" + ')');
         }
      }
   }
   ...
   public static void method7243(Widget var0, String var1, int var2, byte var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "lw.bp(" + ')');
         }
      }
   }
         ...
         if (null == var12) {
            ...
            switch (var8) {
               ...
               case 3:
                  ...
                  break;
               case 4:
                  ItemComposition var16 = classOB.method8299(var9, (byte)-53);
                  var13 = ItemComposition.method8655(var16, 10, 849174015);
   ...
   @ObfuscatedName("gf")
   public static void method7169(Widget var0, Buffer var1) {
      if (var0 == null) {
         var0.getCanvasLocation();
      }

      var0.field4275 = false;
      var0.field4375 = Buffer.method13039(var1, -346779531) * 685068937;
      var0.field4247 = Buffer.method13039(var1, -346779531) * -811438059;
      var0.field4334 = Buffer.method13047(var1, -1011630446) * -411168601;
      var0.field4248 = var1.method13050((byte)16) * -1076753689;
      var0.field4285 = var1.method13050((byte)16) * 1989424741;
      var0.field4255 = Buffer.method13047(var1, -545755246) * 1034606045;
      var0.field4335 = Buffer.method13047(var1, 1061592634) * -259501473;
      var0.field4347 = Buffer.method13039(var1, -346779531) * -2056841747;
      var0.field4342 = Buffer.method13047(var1, -1379916457) * -676768211;
      ...
      var0.field4316 = Buffer.method13047(var1, 1153615263) * -1709618187;
      ...
      if (var2 > 0) {
         ...
         for (int var3 = 0; var3 < var2; var3++) {
            var0.field4400[var3] = Buffer.method13039(var1, -346779531);
            var0.field4401[var3] = Buffer.method13047(var1, -1701590333);
         }
      }
      ...
      if (var7 > 0) {
         ...
         for (int var4 = 0; var4 < var7; var4++) {
            int var5 = Buffer.method13047(var1, 1393564595);
            var0.field4399[var4] = new int[var5];

            for (int var6 = 0; var6 < var5; var6++) {
               var0.field4399[var4][var6] = Buffer.method13047(var1, 697094154);
      ...
      if (0 == -1510882375 * var0.field4375) {
         var0.field4269 = Buffer.method13047(var1, -623648271) * -251301447;
         var0.field4289 = Buffer.method13039(var1, -346779531) == 1;
      }

      if (-1510882375 * var0.field4375 == 1) {
         Buffer.method13047(var1, 1932385003);
         Buffer.method13039(var1, -346779531);
      }

      if (3 == -1510882375 * var0.field4375) {
         var0.field4271 = Buffer.method13039(var1, -346779531) == 1;
      }

      if (4 == -1510882375 * var0.field4375 || 1 == var0.field4375 * -1510882375) {
         var0.field4304 = Buffer.method13039(var1, -346779531) * 571804797;
         var0.field4305 = Buffer.method13039(var1, -346779531) * -2106140265;
         var0.field4303 = Buffer.method13039(var1, -346779531) * -763080175;
         var0.field4245 = Buffer.method13047(var1, -798261243) * 590574429;
         if (65535 == var0.field4245 * -1803847435) {
            var0.field4245 = -590574429;
         }

         var0.field4306 = Buffer.method13039(var1, -346779531) == 1;
      }
      ...
      if (-1510882375 * var0.field4375 == 6) {
         ...
         var0.field4288 = Buffer.method13047(var1, 800533050) * 742198477;
         if (65535 == 2114568197 * var0.field4288) {
            var0.field4288 = -742198477;
         }

         var0.field4293 = Buffer.method13047(var1, -597253696) * 668997325;
         if (821151237 * var0.field4293 == 65535) {
            var0.field4293 = -668997325;
         }

         var0.field4338 = Buffer.method13047(var1, 1048196937) * 1556726191;
         var0.field4356 = Buffer.method13047(var1, -1415541469) * 1703663435;
         var0.field4292 = Buffer.method13047(var1, -1907413821) * 993003239;
      }
      ...
      if (var0.field4247 * -851058883 == 2) {
         ...
         int var8 = Buffer.method13047(var1, 176156968) & 63;
   ...
   void method7277(classLY var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var11, "lw.bb(" + ')');
      }
   }
   ...
   public classKH method7204(classLY var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var16, "lw.ap(" + ')');
      }
   }
   ...
   public void method7236(String var1, classDA var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "lw.bn(" + ')');
      }
   }
   ...
   @ObfuscatedName("ax")
   Object[] method7178(Buffer var1, int var2) {
      try {
         int var3 = Buffer.method13039(var1, -346779531);
         if (0 == var3) {
            if (var2 <= 227024831) {
         ...
         throw classEG.newRunException(var7, "lw.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("lz")
   public static Object[] method7179(Widget var0, Buffer var1) {
      if (var0 == null) {
         var0.getBounds();
      }
   ...
   public Font method7199(classLY var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var11, "lw.aq(" + ')');
      }
   }
   ...
   @ObfuscatedName("oi")
   public static int[] method7182(Widget var0, Buffer var1) {
      if (var0 == null) {
   ...
   public net.runelite.api.widgets.Widget getParent() {
      ...
      return var1 == -1 ? null : classOE.client.method2295(var1);
   }
   ...
   public static String method7253(Widget var0, String var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "lw.bg(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Llw;Lxy;)[I")
   @ObfuscatedName("lw")
   public static int[] method7183(Widget var0, Buffer var1) {
      if (var0 == null) {
         var0.method7258();
      }
   ...
   public void method7232(String var1, String var2, classDA var3, long var4) {
      try {
         ...
         throw classEG.newRunException(var6, "lw.am(" + ')');
      }
   }
   ...
   public Widget method7317(int var1, int var2) {
      if (!classOE.client.isClientThread()) {
         ...
         Widget var4 = classOE.client.method2295(this.field4329 * -1163656551);
         if (var4 == null) {
   ...
   @ObfuscatedName("sm")
   public static void method7170(Widget var0, Buffer var1, byte var2) {
      if (var0 == null) {
      ...
      try {
         ...
         var0.field4375 = Buffer.method13039(var1, -346779531) * 685068937;
         var0.field4247 = Buffer.method13039(var1, -346779531) * -811438059;
         var0.field4334 = Buffer.method13047(var1, 943248541) * -411168601;
         var0.field4248 = var1.method13050((byte)16) * -1076753689;
         var0.field4285 = var1.method13050((byte)16) * 1989424741;
         var0.field4255 = Buffer.method13047(var1, -772132885) * 1034606045;
         var0.field4335 = Buffer.method13047(var1, -1633239070) * -259501473;
         var0.field4347 = Buffer.method13039(var1, -346779531) * -2056841747;
         var0.field4342 = Buffer.method13047(var1, -1526083782) * -676768211;
         if (65535 == var0.field4342 * -1502647899) {
            var0.field4342 = 676768211;
         } else {
            var0.field4342 = -676768211 * ((-1163656551 * var0.field4329 & -65536) + -1502647899 * var0.field4342);
         ...
         var0.field4316 = Buffer.method13047(var1, -1245275110) * -1709618187;
         if (-2003253155 * var0.field4316 == 65535) {
            if (var2 >= 0) {
               return;
            }
         ...
         if (var3 > 0) {
            ...
            for (int var4 = 0; var4 < var3; var4++) {
               var0.field4400[var4] = Buffer.method13039(var1, -346779531);
               var0.field4401[var4] = Buffer.method13047(var1, 1091068094);
            }
         }

         int var9 = Buffer.method13039(var1, -346779531);
         if (var9 > 0) {
            if (var2 >= 0) {
               throw new IllegalStateException();
            }
            ...
            for (int var5 = 0; var5 < var9; var5++) {
               ...
               int var6 = Buffer.method13047(var1, -123746907);
               ...
               for (int var7 = 0; var7 < var6; var7++) {
                  ...
                  var0.field4399[var5][var7] = Buffer.method13047(var1, -980959917);
         ...
         if (0 == -1510882375 * var0.field4375) {
            ...
            var0.field4269 = Buffer.method13047(var1, 1175672359) * -251301447;
            var0.field4289 = Buffer.method13039(var1, -346779531) == 1;
         }
         ...
         if (-1510882375 * var0.field4375 == 1) {
            ...
            Buffer.method13047(var1, 920361216);
            Buffer.method13039(var1, -346779531);
         }
         ...
         label362: {
            ...
            var0.field4305 = Buffer.method13039(var1, -346779531) * -2106140265;
            var0.field4303 = Buffer.method13039(var1, -346779531) * -763080175;
            var0.field4245 = Buffer.method13047(var1, 1522529353) * 590574429;
            if (65535 == var0.field4245 * -1803847435) {
               if (var2 >= 0) {
                  throw new IllegalStateException();
               }
         ...
         if (-1510882375 * var0.field4375 == 6) {
            ...
            var0.field4288 = Buffer.method13047(var1, -495192957) * 742198477;
            if (65535 == 2114568197 * var0.field4288) {
               if (var2 >= 0) {
                  throw new IllegalStateException();
               }
            ...
            var0.field4293 = Buffer.method13047(var1, 1533818567) * 668997325;
            if (821151237 * var0.field4293 == 65535) {
               if (var2 >= 0) {
                  throw new IllegalStateException();
               }
            ...
            var0.field4338 = Buffer.method13047(var1, -1228383652) * 1556726191;
            var0.field4356 = Buffer.method13047(var1, 1322170790) * 1703663435;
            var0.field4292 = Buffer.method13047(var1, 1007031475) * 993003239;
         }
         ...
         if (var0.field4247 * -851058883 == 2) {
            ...
            int var10 = Buffer.method13047(var1, -909726546) & 63;
         ...
         throw classEG.newRunException(var8, "lw.ab(" + ')');
      }
   }
   ...
   public boolean isHidden() {
      if (!classOE.client.isClientThread()) {
         ...
         if (var1 == null) {
            if (WidgetUtil.componentToInterface(this.getId()) != classOE.client.getTopLevelInterfaceId()) {
               return true;
            }
   ...
   public static void method7195(Widget var0, SpritePixels var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "lw.ay(" + ')');
         }
      }
   }
   ...
   public static void method7233(Widget var0, String var1, String var2, String var3, String var4, String var5, classDA var6, int var7) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var8, "lw.ah(" + ')');
         }
      }
   }
   ...
   public net.runelite.api.widgets.Widget[] getNestedChildren() {
      if (!classOE.client.isClientThread()) {
         ...
         if (var1 == null) {
            ...
            for (Widget var7 : classOE.client.method2255(var2)) {
   ...
   static Script method7156(byte[] var0, int var1) {
      try {
         ...
         var3.offset = (var3.array.length - 2) * -1095856699;
         int var4 = Buffer.method13047(var3, -2136955376);
         int var5 = var3.array.length - 2 - var4 - 16;
         var3.offset = var5 * -1095856699;
         int var6 = var3.method13056((byte)1);
         var2.field493 = Buffer.method13047(var3, -966173398) * -420896219;
         var2.field496 = Buffer.method13047(var3, 1836786951) * -431593185;
         var2.field492 = Buffer.method13047(var3, 1297999619) * 2139455799;
         var2.field495 = Buffer.method13047(var3, 395083812) * 1424730171;
         var2.field494 = Buffer.method13047(var3, -2057306067) * 712179175;
         var2.field497 = Buffer.method13047(var3, 760736946) * 1116857197;
         int var7 = Buffer.method13039(var3, -346779531);
         if (var7 > 0) {
            if (var1 >= 642137221) {
               throw new IllegalStateException();
            }
            ...
            for (int var8 = 0; var8 < var7; var8++) {
               int var9 = Buffer.method13047(var3, 909554200);
         ...
         while (var3.offset * 702114061 < var5) {
            int var15 = Buffer.method13047(var3, 1509230209);
            switch (var15) {
               case 3:
               ...
               case 62:
               case 63:
                  var2.field502[var14] = Buffer.method13039(var3, -346779531);
                  break;
               case 61:
         ...
         throw classEG.newRunException(var13, "lw.ab(" + ')');
      }
   }
   ...
   public boolean method7303(classLY var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var10, "lw.bd(" + ')');
      }
   }
   ...
   @ObfuscatedName("ab")
   void method7171(Buffer var1, byte var2) {
      try {
         this.field4297 = false;
         this.field4245 = Buffer.method13039(var1, -346779531) * 685068937;
         this.field4344 = Buffer.method13039(var1, -346779531) * -811438059;
         this.field4261 = Buffer.method13047(var1, 943248541) * -411168601;
         this.field4249 = var1.method13122((byte)16) * -1076753689;
         this.field4333 = var1.method13159((byte)16) * 1989424741;
         this.field4248 = Buffer.method13047(var1, -772132885) * 1034606045;
         this.field4341 = Buffer.method13047(var1, -1633239070) * -259501473;
         this.field4342 = Buffer.method13039(var1, -346779531) * -2056841747;
         this.field4321 = Buffer.method13047(var1, -1526083782) * -676768211;
         ...
         this.field4277 = Buffer.method13047(var1, -1245275110) * -1709618187;
         ...
         if (var3 > 0) {
            ...
            for (int var4 = 0; var4 < var3; var4++) {
               this.field4404[var4] = Buffer.method13039(var1, -346779531);
               this.field4401[var4] = Buffer.method13047(var1, 1091068094);
            }
         }
         ...
         if (var9 > 0) {
            ...
            for (int var5 = 0; var5 < var9; var5++) {
               ...
               for (int var7 = 0; var7 < var6; var7++) {
                  ...
                  this.field4399[var5][var7] = Buffer.method13047(var1, -980959917);
         ...
         if (0 == -1510882375 * this.field4252) {
            ...
            this.field4342 = Buffer.method13047(var1, 1175672359) * -251301447;
            this.field4323 = Buffer.method13039(var1, -346779531) == 1;
         }
         ...
         if (3 == -1510882375 * this.field4241) {
            this.field4315 = Buffer.method13039(var1, -346779531) == 1;
         }
         ...
         label358: {
            ...
            this.field4259 = Buffer.method13039(var1, -346779531) * 571804797;
            this.field4261 = Buffer.method13039(var1, -346779531) * -2106140265;
            this.field4293 = Buffer.method13039(var1, -346779531) * -763080175;
            this.field4247 = Buffer.method13047(var1, 1522529353) * 590574429;
         ...
         if (-1510882375 * this.field4321 == 6) {
            ...
            this.field4320 = Buffer.method13047(var1, -495192957) * 742198477;
            ...
            this.field4295 = Buffer.method13047(var1, 1533818567) * 668997325;
            ...
            this.field4331 = Buffer.method13047(var1, -1228383652) * 1556726191;
            this.field4333 = Buffer.method13047(var1, 1322170790) * 1703663435;
            this.field4338 = Buffer.method13047(var1, 1007031475) * 993003239;
         }
   ...
   public static classLI method7285(Widget var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "lw.by(" + ')');
         }
      }
   }
   ...
   public static int method7226(Widget var0, int var1, int var2, byte var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "lw.av(" + 41);
         }
      }
   }
   ...
   public static int[] method7166(Widget var0, int[] var1, byte var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "lw.ae(" + ')');
      }
   }
