...
public class NpcOverrides implements net.runelite.api.NpcOverrides {
   ...
   public NpcOverrides(long var1, int[] var3, short[] var4, short[] var5, boolean var6, boolean var7, int var8, int[] var9) {
      this.field5372 = 0;
   ...
   @ObfuscatedName("ny")
   public static void method9089(Model var0, classEF var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("aj")
   public static boolean method9084(classVC var0, Widget var1) {
   ...
   @ObfuscatedName("ab")
   static void method9086(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6, boolean var7, classVV var8, classQN var9, int var10) {
      try {
         ...
         throw classEG.newRunException(var13, "pp.ab(" + ')');
      }
   }
   ...
   static float method9087(classSU var0, float var1, boolean var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var17, "pp.af(" + ')');
      }
   }
}
