...
public class classDC implements classSJ {
   ...
   @ObfuscatedName("lp")
   public static Player field1393;
   @ObfuscatedName("ab")
   byte field1390;
   ...
   void method2888(byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "dc.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lct;I)V")
   @ObfuscatedName("ab")
   void method2900(Player var1, int var2) {
      this.method2980(var1);

      try {
         this.field1389.add(var1);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "dc.ab(" + ')');
      }
   }
   ...
   void method2963(String[] var1) {
      ...
      for (int var2 = 0; var2 < this.field1389.size(); var2++) {
         ((Player)this.field1389.get(var2)).actions = Arrays.copyOf(var1, var1.length);
      }
   }
   ...
   public static void method2953(classDC var0, int var1, classKL var2, boolean var3, String var4, byte[] var5) {
      if (var0 == null) {
         ...
         for (int var8 = 0; var8 < var0.field1389.size(); var8++) {
            Player var9 = (Player)var0.field1389.get(var8);
   ...
   void method2907(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.as(" + ')');
      }
   }
   ...
   void method2918(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "dc.aq(" + ')');
      }
   }
   ...
   void method2954(int var1, classKL var2, boolean var3, String var4, byte[] var5) {
      ...
      for (int var8 = 0; var8 < this.field1389.size(); var8++) {
         Player var9 = (Player)this.field1389.get(var8);
         if (var9.field1283 != null && null != var9.field1285) {
            boolean var10 = false;
            if (var2.field3938 && classQQ.field5597.method1299(var9.field1283, -1181618808)) {
               var10 = true;
   ...
   void method2946(int var1, int var2, int var3, int var4, int var5) {
      for (int var6 = 0; var6 < this.field1389.size(); var6++) {
         ((Actor)this.field1389.get(var6)).method3130(var1, client.field855 * 1612595797, var2, var3, var4, var5, 1874940363);
      }
   }
   ...
   void method2957(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      for (int var8 = 0; var8 < this.field1389.size(); var8++) {
         Player var9 = (Player)this.field1389.get(var8);
         WorldView var10 = var9.method3166((byte)98);
   ...
   void method2896(int var1) {
      try {
         ...
         for (int var2 = 0; var2 < this.field1389.size(); var2++) {
            Player var3 = (Player)this.field1389.get(var2);
            var3.field1477 = null;
            Actor.method3189(var3, -1, -1, this.field1385, 1267335609);
            var3.field1476[0] = this.field1394;
            var3.method3215(this.field1380, -1590653909);
            var3.actions = Arrays.copyOf(this.field1384, 3);
            classCU.method2676(var3, -1, 0, -835845865);
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "dc.ae(" + ')');
      }
   }
   ...
   public int vmethod314(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.ay(" + 41);
      }
   }
   ...
   void method2958(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      for (int var8 = 0; var8 < this.field1389.size(); var8++) {
         Player var9 = (Player)this.field1389.get(var8);
         WorldView var10 = var9.method3166((byte)46);
   ...
   @ObfuscatedName("ap")
   void method2927(Buffer var1, int var2) {
      try {
         this.field1395 = var1;
         ...
         for (int var3 = 0; var3 < this.field1389.size(); var3++) {
            ...
            ((Player)this.field1389.get(var3)).method2620(this.field1395, -1316125685);
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "dc.ap(" + ')');
      }
   }
   ...
   public boolean vmethod302(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILxs;I)V")
   @ObfuscatedName("ai")
   void method2934(int var1, PacketBuffer var2, int var3) {
      try {
         this.field1380.method1382(var1, var2, (byte)2);
         this.method2936(1041343536);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "dc.ai(" + ')');
      }
   }
   ...
   void method2959(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         for (int var9 = 0; var9 < this.field1389.size(); var9++) {
            ...
            Player var10 = (Player)this.field1389.get(var9);
            WorldView var11 = var10.method3166((byte)8);
         ...
         throw classEG.newRunException(var14, "dc.am(" + ')');
      }
   }
   ...
   void method2976(int var1, int var2, boolean var3) {
      for (int var4 = 0; var4 < this.field1389.size(); var4++) {
         Player var5 = classEN.method3930(((Actor)this.field1389.get(var4)).field1480 * -1315528093, client.field814, 142211213);
         if (var5 != null) {
            if (-1 != var1 && var2 != -1) {
               ...
               if (var3) {
                  Actor.method3101(var5, 112932728);
               }
            }
         }
      }
   ...
   void method2942(int var1, int var2, int var3, int var4, byte var5) {
      try {
         for (int var6 = 0; var6 < this.field1389.size(); var6++) {
            ((Actor)this.field1389.get(var6)).method3126(var1, var2, client.field855 * 1612595797, var3, var4, 1694102512);
         }
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "dc.ak(" + ')');
      }
   }
   ...
   void method2947(int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         for (int var7 = 0; var7 < this.field1389.size(); var7++) {
            ((Actor)this.field1389.get(var7)).method3130(var1, client.field855 * 1612595797, var2, var3, var4, var5, 1874940363);
         }
      } catch (RuntimeException var8) {
         throw classEG.newRunException(var8, "dc.av(" + ')');
      }
   }
   ...
   void method2965(String[] var1, byte var2) {
      try {
         ...
         for (int var3 = 0; var3 < this.field1389.size(); var3++) {
            ...
            ((Player)this.field1389.get(var3)).actions = Arrays.copyOf(var1, var1.length);
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "dc.ah(" + ')');
      }
   }
   ...
   void method2968(int var1, int var2, byte var3, byte var4, byte var5, byte var6, int var7) {
      try {
         ...
         for (int var8 = 0; var8 < this.field1389.size(); var8++) {
            Player var9 = (Player)this.field1389.get(var8);
            Actor.method3189(var9, this.field1388 * 190337821, this.field1387 * -800586389, this.field1385, 833690333);
         }
      } catch (RuntimeException var10) {
         throw classEG.newRunException(var10, "dc.bn(" + ')');
      }
   }
   ...
   void method2970(int var1, int var2, int var3, byte var4, byte var5, boolean var6, byte var7) {
      try {
         ...
         throw classEG.newRunException(var10, "dc.bx(" + ')');
      }
   }
   ...
   public int vmethod309(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.aj(" + 41);
      }
   }
   ...
   void method2915(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "dc.ao(" + ')');
      }
   }
   ...
   void method2950(int var1, int var2) {
      try {
         for (int var3 = 0; var3 < this.field1389.size(); var3++) {
            ...
            ((Actor)this.field1389.get(var3)).method3132(var1, 1511865987);
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "dc.at(" + ')');
      }
   }
   ...
   void method2930(int var1, int var2) {
      for (int var3 = 0; var3 < this.field1389.size(); var3++) {
         classCU.method2676((Player)this.field1389.get(var3), var1, var2, -632450447);
      }
   }
   ...
   void method2897() {
      ...
      for (int var1 = 0; var1 < this.field1389.size(); var1++) {
         Player var2 = (Player)this.field1389.get(var1);
         var2.field1477 = null;
         Actor.method3189(var2, -1, -1, this.field1385, 924566172);
         var2.field1476[0] = this.field1394;
         var2.method3215(this.field1380, -1281555746);
         var2.actions = Arrays.copyOf(this.field1384, 3);
   ...
   void method2898() {
      ...
      for (int var1 = 0; var1 < this.field1389.size(); var1++) {
         Player var2 = (Player)this.field1389.get(var1);
         var2.field1477 = null;
         Actor.method3189(var2, -1, -1, this.field1385, 272102676);
         var2.field1476[0] = this.field1394;
   ...
   @ObfuscatedName("bw")
   void method2901(Player var1) {
      this.field1389.add(var1);
   }

   @ObfuscatedSignature(descriptor = "(Lct;)V")
   @ObfuscatedName("bb")
   void method2903(Player var1) {
   ...
   public static void method2977(classDC var0, int var1, int var2, boolean var3) {
      ...
      for (int var4 = 0; var4 < var0.field1389.size(); var4++) {
         Player var5 = classEN.method3930(((Actor)var0.field1389.get(var4)).field1480 * -1315528093, client.field814, 148539161);
         if (var5 != null) {
            if (-1 != var1 && var2 != -1) {
               var5.method3090(var1, var2, var3, (byte)1);
            } else {
               ...
               if (var3) {
                  Actor.method3101(var5, 1879378737);
               }
            }
         }
      }
   ...
   @ObfuscatedName("bs")
   Player method2911(int var1, WorldView var2) {
      ...
      Actor.method3189(var3, this.field1388 * 190337821, this.field1387 * -800586389, this.field1385, 1867802641);
      if (null != this.field1386) {
      ...
      var3.actions = Arrays.copyOf(var3.actions, var3.actions.length);
      var3.method3113(
   ...
   void method2936(int var1) {
      try {
         for (int var2 = 0; var2 < this.field1389.size(); var2++) {
            ...
            ((Actor)this.field1389.get(var2)).method3215(this.field1380, -429093985);
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "dc.ar(" + ')');
      }
   }
      ...
      if (var0 == null) {
         ...
         try {
            ...
            for (int var9 = 0; var9 < var0.field1389.size(); var9++) {
               ...
               Player var10 = (Player)var0.field1389.get(var9);
            ...
            throw classEG.newRunException(var12, "dc.an(" + ')');
         }
      }
   }
   ...
   void method2978(int var1, int var2, boolean var3, int var4) {
      try {
         for (int var5 = 0; var5 < this.field1389.size(); var5++) {
            ...
            Player var6 = classEN.method3930(((Actor)this.field1389.get(var5)).field1480 * -1315528093, client.field814, 408323482);
            if (var6 != null) {
               if (var4 == 811047921) {
                  throw new IllegalStateException();
               }
               ...
               if (var3) {
                  Actor.method3101(var6, -292214652);
               }
            }
         }
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "dc.bp(" + ')');
      }
   }
   ...
   void method2943(int var1, int var2, int var3, int var4) {
      for (int var5 = 0; var5 < this.field1389.size(); var5++) {
         ((Actor)this.field1389.get(var5)).method3126(var1, var2, client.field855 * 1612595797, var3, var4, 731061816);
      }
   }
   ...
   void method2922(classGT var1) {
      for (int var2 = 0; var2 < this.field1389.size(); var2++) {
         Player var3 = (Player)this.field1389.get(var2);
         WorldView var4 = var3.method3166((byte)-100);
   ...
   void method2923(classGT var1) {
      for (int var2 = 0; var2 < this.field1389.size(); var2++) {
         Player var3 = (Player)this.field1389.get(var2);
         WorldView var4 = var3.method3166((byte)-78);
   ...
   public static void method2893(classDC var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "dc.af(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("cc")
   void method2928(Buffer var1) {
      this.field1395 = var1;

      for (int var2 = 0; var2 < this.field1389.size(); var2++) {
         ((Player)this.field1389.get(var2)).method2620(this.field1395, -1316125685);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("cf")
   void method2929(Buffer var1) {
      this.field1395 = var1;
   ...
   public static void method2971(classDC var0, int var1, int var2, int var3, byte var4, byte var5, boolean var6) {
      ...
      for (int var7 = 0; var7 < var0.field1389.size(); var7++) {
         Player var8 = (Player)var0.field1389.get(var7);
   ...
   void method2931(int var1, int var2) {
      for (int var3 = 0; var3 < this.field1389.size(); var3++) {
         classCU.method2676((Player)this.field1389.get(var3), var1, var2, 555794902);
      }
   }

   @ObfuscatedSignature(descriptor = "(ILxs;)V")
   @ObfuscatedName("cz")
   void method2935(int var1, PacketBuffer var2) {
      this.field1380.method1382(var1, var2, (byte)2);
   ...
   void method2937() {
      for (int var1 = 0; var1 < this.field1389.size(); var1++) {
         ((Actor)this.field1389.get(var1)).method3215(this.field1380, -1243005492);
      }
   }
   ...
   void method2938() {
      for (int var1 = 0; var1 < this.field1389.size(); var1++) {
         ((Actor)this.field1389.get(var1)).method3215(this.field1380, -571836897);
      }
   }
   ...
   void method2939(String var1) {
      ...
      for (int var4 = 0; var4 < this.field1389.size(); var4++) {
         Player var5 = (Player)this.field1389.get(var4);
   ...
   public int vmethod308(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.al(" + 41);
      }
   }
   ...
   public static void method2951(classDC var0, int var1) {
      for (int var2 = 0; var2 < var0.field1389.size(); var2++) {
         ((Actor)var0.field1389.get(var2)).method3132(var1, -1950012684);
      }
   }
   ...
   void method2944(int var1, int var2, int var3, int var4) {
      for (int var5 = 0; var5 < this.field1389.size(); var5++) {
         ((Actor)this.field1389.get(var5)).method3126(var1, var2, client.field855 * 1612595797, var3, var4, 2138307786);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lct;)V")
   @ObfuscatedName("bk")
   public void method2981(Player var1) {
      classOE.client.getCallbacks().post(new PlayerDespawned(var1));
      if (field1393 == var1) {
         field1393 = null;
      }
   }
   ...
   void method2960(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      for (int var8 = 0; var8 < this.field1389.size(); var8++) {
         Player var9 = (Player)this.field1389.get(var8);
         WorldView var10 = var9.method3166((byte)41);
         int var11 = this.field1382.field4055 * 1870919123 - var10.field1709 * -1444178379;
         int var12 = 819227381 * this.field1382.field4056 - -351145363 * var10.field1708;
         var9.field1491 = -896779669 * (var11 + var1);
         var9.field1493 = (var12 + var2) * 749833987;
   ...
   public static void method2932(classDC var0, int var1, int var2, int var3) {
      if (var0 == null) {
         ...
         try {
            for (int var4 = 0; var4 < var0.field1389.size(); var4++) {
               classCU.method2676((Player)var0.field1389.get(var4), var1, var2, -1274605594);
            }
         } catch (RuntimeException var5) {
            throw classEG.newRunException(var5, "dc.au(" + ')');
         }
      }
   }
   ...
   void method2961(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      for (int var8 = 0; var8 < this.field1389.size(); var8++) {
         Player var9 = (Player)this.field1389.get(var8);
         WorldView var10 = var9.method3166((byte)-113);
         int var11 = this.field1382.field4055 * 1870919123 - var10.field1709 * -1444178379;
         int var12 = 819227381 * this.field1382.field4056 - -351145363 * var10.field1708;
         var9.field1491 = -896779669 * (var11 + var1);
         var9.field1493 = (var12 + var2) * 749833987;
   ...
   public static void method2952(classDC var0, int var1) {
      ...
      for (int var2 = 0; var2 < var0.field1389.size(); var2++) {
         ((Actor)var0.field1389.get(var2)).method3132(var1, 496850727);
      }
   }
   ...
   void method2940(String var1, int var2) {
      try {
         ...
         for (int var5 = 0; var5 < this.field1389.size(); var5++) {
            ...
            Player var6 = (Player)this.field1389.get(var5);
         ...
         throw classEG.newRunException(var7, "dc.aw(" + ')');
      }
   }
   ...
   @ObfuscatedName("ax")
   Player method2912(int var1, WorldView var2, int var3) {
      try {
         ...
         Actor.method3189(var4, this.field1388 * 190337821, this.field1387 * -800586389, this.field1385, 2032678852);
         if (null != this.field1386) {
            if (var3 != 844956059) {
               throw new IllegalStateException();
            }
         ...
         var4.actions = Arrays.copyOf(var4.actions, var4.actions.length);
         var4.method3113(
            1870919123 * this.field1382.field4055 - var2.field1709 * -1444178379, 819227381 * this.field1382.field4056 - var2.field1708 * -351145363, 527441438
         );
         return var4;
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "dc.ax(" + ')');
      }
   }
   ...
   void method2899() {
      ...
      for (int var1 = 0; var1 < this.field1389.size(); var1++) {
         Player var2 = (Player)this.field1389.get(var1);
         var2.field1477 = null;
         Actor.method3189(var2, -1, -1, this.field1385, 1394613206);
         var2.field1476[0] = this.field1394;
      ...
      if (var0 == null) {
         ...
         try {
            for (int var3 = 0; var3 < var0.field1389.size(); var3++) {
               ...
               Player var4 = (Player)var0.field1389.get(var3);
               WorldView var5 = var4.method3166((byte)-87);
            ...
            throw classEG.newRunException(var11, "dc.ad(" + ')');
         }
      }
   }
   ...
   void method2969(int var1, int var2, byte var3, byte var4, byte var5, byte var6) {
      ...
      for (int var7 = 0; var7 < this.field1389.size(); var7++) {
         Player var8 = (Player)this.field1389.get(var7);
         Actor.method3189(var8, this.field1388 * 190337821, this.field1387 * 814151382, this.field1385, 1706564511);
      }
   }
   ...
   public static void method2967(classDC var0, String[] var1) {
      ...
      for (int var2 = 0; var2 < var0.field1389.size(); var2++) {
         ((Player)var0.field1389.get(var2)).actions = Arrays.copyOf(var1, var1.length);
      }
   }
   ...
   void method2914(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.aa(" + ')');
      }
   }
   ...
   public static void method2962(classDC var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      for (int var8 = 0; var8 < var0.field1389.size(); var8++) {
         Player var9 = (Player)var0.field1389.get(var8);
         WorldView var10 = var9.method3166((byte)-100);
   ...
   void method2973(int var1, int var2, int var3, int var4, boolean var5) {
      for (int var6 = 0; var6 < this.field1389.size(); var6++) {
         Actor.method3134((Actor)this.field1389.get(var6), var1, var2, var3, var4, var5, (byte)71);
      }
   }
   ...
   void method2974(int var1, int var2, int var3, int var4, boolean var5, int var6) {
      try {
         for (int var7 = 0; var7 < this.field1389.size(); var7++) {
            ...
            Actor.method3134((Actor)this.field1389.get(var7), var1, var2, var3, var4, var5, (byte)-42);
         }
      } catch (RuntimeException var8) {
         throw classEG.newRunException(var8, "dc.bc(" + ')');
      }
   }
   ...
   void method2945(int var1, int var2, int var3, int var4) {
      for (int var5 = 0; var5 < this.field1389.size(); var5++) {
         ((Actor)this.field1389.get(var5)).method3126(var1, var2, client.field855 * 1612595797, var3, var4, 1181887244);
      }
   }
   ...
   public static void method2926(short var0) {
      try {
         EvictingDualNodeHashTable.method6431(classOM.field4966);
         EvictingDualNodeHashTable.method6431(classOM.field4968);
         EvictingDualNodeHashTable.method6431(classOM.field4972);
         EvictingDualNodeHashTable.method6431(classOM.field4967);
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "dc.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldc;Lct;B)V")
   @ObfuscatedName("yj")
   public static void method2905(classDC var0, Player var1, byte var2) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "dc.ag(" + ')');
      }
   }
   ...
   static void method2979(String var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dc.ge(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lct;)V")
   @ObfuscatedName("cv")
   public void method2980(Player var1) {
      if (var1.getId() == client.field845 * -2130951373) {
         field1393 = var1;
      }

      classOE.client.getCallbacks().postDeferred(new PlayerSpawned(var1));
   }
   ...
   void method2933(int var1, int var2, int var3) {
      try {
         for (int var4 = 0; var4 < this.field1389.size(); var4++) {
            classCU.method2676((Player)this.field1389.get(var4), var1, var2, -1274605594);
         }
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "dc.au(" + ')');
      }
   ...
   void method2925(classGT var1, byte var2) {
      try {
         for (int var3 = 0; var3 < this.field1389.size(); var3++) {
            ...
            Player var4 = (Player)this.field1389.get(var3);
            WorldView var5 = var4.method3166((byte)-87);
   ...
   public static void method2975(classDC var0, int var1, int var2, int var3, int var4, boolean var5) {
      ...
      for (int var6 = 0; var6 < var0.field1389.size(); var6++) {
         Actor.method3134((Actor)var0.field1389.get(var6), var1, var2, var3, var4, var5, (byte)1);
      }
   }
   ...
   @ObfuscatedName("ag")
   void method2906(Player var1, byte var2) {
