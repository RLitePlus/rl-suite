...
public class classPA extends classVJ {
   ...
   @ObfuscatedName("ae")
   static AbstractArchive field5208;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ab")
   static EvictingDualNodeHashTable field5203 = new EvictingDualNodeHashTable(64);
   @ObfuscatedName("ag")
   ...
   public static void method8828() {
      EvictingDualNodeHashTable.method6431(field5203);
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ab")
   public static void method8823(AbstractArchive var0) {
      field5208 = var0;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("as")
   public static void method8824(AbstractArchive var0) {
      field5208 = var0;
   }
   ...
   @ObfuscatedName("ks")
   public static int method8833(WorldMap var0) {
   ...
   public static classPA method8826(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classPA(new Buffer(var2));
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ag")
   public static void method8825(AbstractArchive var0) {
      field5208 = var0;
   }
   ...
   classPA(Buffer var1) {
      ...
      if (var1 != null && var1.array != null) {
         ...
         while (true) {
            ...
            var3 = Buffer.method13047(var1, -2006674292);
         }
      }
