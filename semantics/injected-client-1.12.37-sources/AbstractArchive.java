...
public abstract class AbstractArchive implements IndexDataBase {
   ...
   public int[] method11824(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "va.bv(" + ')');
      }
   }
   ...
   void method11794(byte[] var1, int var2) {
      try {
         ...
         Buffer var3 = new Buffer(classMD.method7538(var1, (byte)49));
         ...
         if (var4 >= 5) {
            if (var4 <= 7) {
               ...
               if (var4 >= 7) {
                  ...
                  this.field6440 = Buffer.method13047(var3, 555237632) * 911284189;
               }
               ...
               if (var4 >= 7) {
                  ...
                  for (int var21 = 0; var21 < this.field6440 * -1862600587; var21++) {
                     ...
                     this.field6447[var21] = var10 += Buffer.method13047(var3, -1355391222);
               ...
               if (var4 >= 7) {
                  ...
                  for (int var28 = 0; var28 < -1862600587 * this.field6440; var28++) {
                     ...
                     this.field6448[this.field6447[var28]] = Buffer.method13047(var3, -572332719);
                  }
                  ...
                  for (int var29 = 0; var29 < -1862600587 * this.field6440; var29++) {
                     ...
                     for (int var37 = 0; var37 < var33; var37++) {
                        ...
                        int var39 = this.field6456[var31][var37] = var10 += Buffer.method13047(var3, 398616294);
                        if (var39 > var35) {
                           if (var2 != 1479807699) {
                              throw new IllegalStateException();
                           }
         ...
         throw classEG.newRunException(var18, "va.bw(" + ')');
      }
   }
   ...
   public byte[] method11867(int var1, int var2, int var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var55, "va.bb(" + ')');
      }
      ...
      if (!OverlayIndex.hasOverlay(var5.method12054(), var1)) {
         ...
         if (var6 == null) {
            client.logger.warn("Missing overlay data for {}/{}", var5.method12054(), var1);
            return var4;
         } else {
            try {
               ...
               try {
                  if (var4 == null) {
                     if (var7 != null) {
                        client.logger.warn("Hash file for non existing archive {}/{}", var5.method12054(), var1);
                        return null;
                     } else {
                        client.logger.debug("Adding archive {}/{}", var5.method12054(), var1);

                        try {
                           return ByteStreams.toByteArray(var6);
                        } catch (IOException var57) {
                           client.logger.warn("error loading archive replacement", var57);
                           return null;
                        }
                     }
                  } else if (var7 == null) {
                     client.logger.warn("Missing hash file for {}/{}", var5.method12054(), var1);
                     return var4;
                  } else {
                     ...
                     try {
                        ...
                        if (var10.equals(var9)) {
                           client.logger.debug("Replacing archive {}/{}", var5.method12054(), var1);
                           return ByteStreams.toByteArray(var6);
                        }

                        client.logger.warn("Mismatch in overlaid cache archive hash for {}/{}: {} != {}", new Object[]{var5.method12054(), var1, var10, var9});
                        this.field6445 = true;
                     } catch (IOException var56) {
                        client.logger.warn("error checking hash", var56);
                     }
      ...
      if (var0 == null) {
         ...
         if (var6) {
            ...
            if (null == var2 || var2[0] == 0 && 0 == var2[1] && 0 == var2[2] && var2[3] == 0) {
               ...
               var8.method13136(var2, 5, var8.array.length, -1664008178);
            }
   ...
   public boolean method11871(int var1, int var2, byte var3) {
      synchronized (this) {
         ...
         try {
            ...
            throw classEG.newRunException(var10, "va.be(" + ')');
         }
   ...
   public boolean method11866(int var1, int var2) {
      synchronized (this) {
         ...
         try {
            ...
            throw classEG.newRunException(var8, "va.bq(" + ')');
         }
   ...
   void vmethod610(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "va.ab(" + ')');
      }
   }
   ...
   public byte[] method11854(String var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var6, "va.cd(" + ')');
      }
   }
   ...
   public boolean method11811(int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "va.bf(" + ')');
      }
   }
   ...
   public int method11832(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "va.bz(" + 41);
      }
   }
   ...
   boolean method11842(int var1, int[] var2, int var3) {
      ...
      try {
         if (null == this.field6453[var1]) {
            ...
            if (var7) {
               ...
               label188: {
                  ...
                  var9.method13136(var2, 5, var9.array.length, -1664008178);
               }
         ...
         throw classEG.newRunException(var20, "va.ct(" + ')');
      }
   }
   ...
   public boolean method11859(String var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var6, "va.cv(" + ')');
      }
   }
   ...
   public int method11848(String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "va.cp(" + 41);
      }
   }
   ...
   void method11795(byte[] var1) {
      ...
      Buffer var2 = new Buffer(classMD.method7538(var1, (byte)50));
      int var3 = Buffer.method13039(var2, -346779531);
      if (var3 >= 5 && var3 <= 7) {
         if (var3 >= 6) {
            var2.method13056((byte)1);
         }

         int var4 = Buffer.method13039(var2, -346779531);
         ...
         if (var6) {
            ...
            if (var3 >= 7) {
               ...
               this.field6440 = Buffer.method13047(var2, -1489112566) * 911284189;
            }
            ...
            if (var3 >= 7) {
               ...
               for (int var19 = 0; var19 < this.field6440 * -1862600587; var19++) {
                  this.field6447[var19] = var9 += Buffer.method13047(var2, 652549953);
            ...
            if (var3 >= 7) {
               ...
               for (int var26 = 0; var26 < -1399199723 * this.field6440; var26++) {
                  this.field6448[this.field6447[var26]] = Buffer.method13047(var2, 889767870);
               }
               ...
               for (int var27 = 0; var27 < -1862600587 * this.field6440; var27++) {
                  ...
                  for (int var35 = 0; var35 < var31; var35++) {
                     int var37 = this.field6456[var29][var35] = var9 += Buffer.method13047(var2, 556892208);
                     if (var37 > var33) {
                        var33 = var37;
                     }
                  }
   ...
   void method11796(byte[] var1) {
      ...
      Buffer var2 = new Buffer(classMD.method7538(var1, (byte)122));
      int var3 = Buffer.method13039(var2, -346779531);
      if (var3 >= 5 && var3 <= 7) {
         if (var3 >= 6) {
            var2.method13056((byte)1);
         ...
         if (var6) {
            ...
            if (var3 >= 7) {
               ...
               this.field6440 = Buffer.method13047(var2, 1120192273) * -2056517136;
            }
            ...
            if (var3 >= 7) {
               ...
               for (int var19 = 0; var19 < this.field6440 * -65952741; var19++) {
                  this.field6447[var19] = var9 += Buffer.method13047(var2, 155746105);
                  if (this.field6447[var19] > var10) {
                     var10 = this.field6447[var19];
                  }
               }
            ...
            if (var3 >= 7) {
               ...
               for (int var26 = 0; var26 < -1862600587 * this.field6440; var26++) {
                  this.field6448[this.field6447[var26]] = Buffer.method13047(var2, -1061707454);
               }
               ...
               for (int var27 = 0; var27 < 1313379298 * this.field6440; var27++) {
                  ...
                  for (int var35 = 0; var35 < var31; var35++) {
                     int var37 = this.field6456[var29][var35] = var9 += Buffer.method13047(var2, -963472163);
                     if (var37 > var33) {
                        var33 = var37;
                     }
                  }
   ...
   static boolean method11864(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "va.hl(" + ')');
      }
   }
   ...
   public static byte[] method11814(AbstractArchive var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "va.bs(" + ')');
      }
   }
   ...
   public static boolean method11853(AbstractArchive var0, String var1, String var2, int var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var6, "va.cl(" + ')');
         }
      }
   }
   ...
   public int method11851(int var1, String var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "va.cq(" + 41);
      }
   }
   ...
   public static byte[] method11822(AbstractArchive var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "va.bl(" + ')');
      }
   }
   ...
   public boolean method11807(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "va.by(" + ')');
      }
   }
      ...
      if (null == this.field6453[var1]) {
         ...
         if (var6) {
            ...
            if (null == var2 || var2[0] == 0 && 0 == var2[1] && 0 == var2[2] && var2[3] == 0) {
               ...
               var19 = PlayerComposition.method6663(this.field6453[var1], true, -174334988);
               Buffer var8 = new Buffer(var19);
               var8.method13135(var2, 5, var8.array.length, -1664008178);
            }
