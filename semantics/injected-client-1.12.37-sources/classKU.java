...
public class classKU implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ku.az(" + 41);
      }
   }
   ...
   public static void method6566(classTE var0, classTE var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ku.ak(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZI)I")
   @ObfuscatedName("bm")
   static int method6567(int var0, Script var1, boolean var2, int var3) {
      try {
         if (var0 == 3100) {
            String var24 = (String)classBB.field328[(classBB.field338 -= 1222866659) * 1375698635];
            var24 = classUP.method11420(var24, User.method10179(-1792975740), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 == 1524072698) {
               ...
               classCU.method2676(
                  ...
                  classBB.field323[-324749371 * DynamicObject.field1679],
            ...
            if (var3 == 1524072698) {
               ...
               int var33 = 0;
               if (IntProjection.method4078(var23, (byte)-1)) {
                  if (var3 == 1524072698) {
                     throw new IllegalStateException();
                  }
               ...
               PacketBufferNode var36 = classEF.getPacketBufferNode(ClientPacket.RESUME_P_COUNTDIALOG, client.packetWriter.isaacCipher, (byte)38);
               var36.packetBuffer.method12979(var33, 2021936256);
               client.packetWriter.addNode(var36, -1301097035);
               return 1;
            }
         } else if (var0 == 3105) {
            if (var3 == 1524072698) {
               ...
               PacketBufferNode var32 = classEF.getPacketBufferNode(ClientPacket.RESUME_P_NAMEDIALOG, client.packetWriter.isaacCipher, (byte)13);
               Buffer.method12971(var32.packetBuffer, var22.length() + 1, (byte)-120);
               Buffer.method12997(var32.packetBuffer, var22, (short)21980);
            ...
            if (var3 == 1524072698) {
               ...
               PacketBufferNode var31 = classEF.getPacketBufferNode(ClientPacket.RESUME_P_STRINGDIALOG, client.packetWriter.isaacCipher, (byte)-15);
               Buffer.method12971(var31.packetBuffer, var21.length() + 1, (byte)-37);
               Buffer.method12997(var31.packetBuffer, var21, (short)1254);
            ...
            if (var3 == 1524072698) {
               ...
               int var19 = classBB.field323[-324749371 * DynamicObject.field1679];
               int var29 = classBB.field323[1 + DynamicObject.field1679 * -324749371];
               int var35 = classBB.field323[-324749371 * DynamicObject.field1679 + 2];
               Widget var38 = classLY.method7375(classWK.field6691, var35, (byte)84);
            ...
            if (var3 == 1524072698) {
               ...
               int var28 = classBB.field323[-324749371 * DynamicObject.field1679 + 1];
               Widget var34 = var2 ? classSZ.field6110 : TileItem.field1558;
               if (!client.field973) {
                  if (var3 == 1524072698) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 == 1524072698) {
               ...
               classON.field4995 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] == 1;
               return 1;
            }
         } else if (3111 == var0) {
            if (var3 == 1524072698) {
               ...
               int var53 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
               byte var56;
            ...
            if (var3 == 1524072698) {
               ...
               ClientPreferences var46 = classAB.field122;
               boolean var52;
            ...
            if (var3 == 1524072698) {
               ...
               PacketBufferNode var37 = classEF.getPacketBufferNode(ClientPacket.RESUME_P_COUNTDIALOG_LONG, client.packetWriter.isaacCipher, (byte)74);
               var37.packetBuffer.method12987(var27);
            ...
            if (var3 == 1524072698) {
               ...
               PacketBufferNode var26 = classEF.getPacketBufferNode(ClientPacket.RESUME_P_OBJDIALOG, client.packetWriter.isaacCipher, (byte)-37);
               var26.packetBuffer.method12973(var15, -1542382992);
            ...
            if (var3 == 1524072698) {
               ...
               if (var5.length() > 500) {
                  ...
                  PacketBufferNode var7 = classEF.getPacketBufferNode(ClientPacket.BUG_REPORT, client.packetWriter.isaacCipher, (byte)-15);
                  var7.packetBuffer.method12973(1 + classAU.method712(var5, (byte)81) + classAU.method712(var6, (byte)67), -1542382992);
                  Buffer.method12997(var7.packetBuffer, var5, (short)25320);
                  Buffer.method12997(var7.packetBuffer, var6, (short)13882);
                  var7.packetBuffer.method13156(var14, (byte)47);
            ...
            if (var3 == 1524072698) {
               ...
               client.field858 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] == 1;
               return 1;
            }
         } else if (var0 == 3119) {
            if (var3 == 1524072698) {
            ...
            if (var3 == 1524072698) {
               ...
               client.field844 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] == 1;
               return 1;
            }
         } else if (var0 == 3127) {
            if (var3 == 1524072698) {
            ...
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classTT.method11166(921633490) ? 1 : 0;
            return 1;
         } else if (var0 == 3129) {
            DynamicObject.field1679 -= 240082458;
            client.field841 = classBB.field323[-324749371 * DynamicObject.field1679] * 1702334145;
            client.field951 = classBB.field323[-324749371 * DynamicObject.field1679 + 1] * 1847803151;
            return 1;
         } else if (var0 == 3130) {
            if (var3 == 1524072698) {
               throw new IllegalStateException();
            ...
            classWK.field6691.field6616 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 1264941915;
            return 1;
         } else if (3137 == var0) {
            ...
            if (var3 == 1524072698) {
               ...
               if (var2) {
                  ...
                  var51 = -1163656551 * TileItem.field1558.field4329;
               }
            ...
            if (var3 == 1524072698) {
               ...
               boolean var13 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] == 1;
            ...
            byte var55;
            if (ClientPreferences.method2724(classAB.field122, (short)16636)) {
               if (var3 == 1524072698) {
                  throw new IllegalStateException();
               }
            ...
            if (var3 == 1524072698) {
               ...
               ClientPreferences.method2736(classAB.field122, var48, (byte)16);
               return 1;
            }
         } else if (3147 == var0) {
            if (var3 == 1524072698) {
            ...
            if (var3 == 1524072698) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 2017820609 * classBF.field395;
               return 1;
            }
         } else if (var0 == 3154) {
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classXW.method12952(-642883550);
            return 1;
         } else if (var0 == 3155) {
            if (var3 == 1524072698) {
               throw new IllegalStateException();
            ...
            if (var3 == 1524072698) {
               ...
               classBY.method1359(classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], (byte)0);
               return 1;
            }
         } else if (var0 == 3182) {
            if (var3 == 1524072698) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = Projectile.method1223(698658207);
               return 1;
            }
         } else if (var0 == 3185) {
            if (var3 == 1524072698) {
            ...
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var9;
            return 1;
         } else if (var0 == 3189) {
            if (var3 == 1524072698) {
               throw new IllegalStateException();
         ...
         throw classEG.newRunException(var8, "ku.bm(" + 41);
      }
   }
}
