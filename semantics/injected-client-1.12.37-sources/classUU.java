...
public final class classUU {
   ...
   @ObfuscatedName("uk")
   public void method11648(Buffer var1, boolean var2) {
   ...
   public classUU(Buffer var1, boolean var2) {
   ...
   public void method11555(int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "uu.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;ZI)V")
   @ObfuscatedName("ab")
   void method11644(Buffer var1, boolean var2, int var3) {
      if (var2) {
         boolean var5 = var2;
         Buffer var4 = var1;
         classUU var18 = this;
         ...
         try {
            ...
            throw classEG.newRunException(var17, "uu.ab(" + ')');
         }
      } else {
   ...
   public void method11579(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "uu.ac(" + ')');
      }
   }
   ...
   public void method11616(float var1, float var2, float var3, float[] var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var6, "uu.aw(" + ')');
      }
   }
   ...
   public void method11588(float var1, float var2, float var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "uu.al(" + ')');
      }
   }
   ...
   public void method11599(classUL var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var13, "uu.ad(" + ')');
      }
   }
   ...
   public void method11605(classUX var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "uu.ap(" + ')');
      }
   }
   ...
   public static void method11594(classUU var0, classUU var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var19, "uu.ay(" + ')');
         }
      }
   }
   ...
   public void method11609(int var1) {
      try {
         ...
         throw classEG.newRunException(var19, "uu.ai(" + ')');
      }
   }
   ...
   public float method11623(float var1, float var2, float var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "uu.at(" + ')');
      }
   }
   ...
   public float method11622(float var1, float var2, float var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var5, "uu.av(" + ')');
      }
   }
   ...
   public float method11625(float var1, float var2, float var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "uu.an(" + ')');
      }
   }
   ...
   public float[] method11570(int var1) {
      try {
         ...
         throw classEG.newRunException(var13, "uu.as(" + ')');
      }
   }
   ...
   float method11608(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "uu.au(" + ')');
      }
   }
   ...
   public float[] method11636(int var1) {
      try {
         ...
         throw classEG.newRunException(var6, "uu.am(" + ')');
      }
   }
   ...
   public classUZ method11618(float var1, float var2, float var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var6, "uu.ak(" + ')');
      }
   }
   ...
   public static void method11613(classUU var0, float var1, float var2, float var3, float var4, int var5) {
      ...
      try {
         ...
         throw classEG.newRunException(var6, "uu.ar(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Z)V")
   @ObfuscatedName("bk")
   void method11560(Buffer var1, boolean var2) {
      if (var2) {
   ...
   public static float[] method11565(classUU var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "uu.ag(" + ')');
         }
      }
   }
   ...
   public static void method11574(classUU var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "uu.ax(" + ')');
      }
   }
   ...
   public void method11585(float var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "uu.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("qt")
   public static void method11561(classUU var0, Buffer var1, boolean var2) {
      if (var0 == null) {
         var0.method11557();
      }
   ...
   static boolean method11554(classOM var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var6, "uu.ae(" + ')');
      }
   }
