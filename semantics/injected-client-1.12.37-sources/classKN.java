...
public class classKN {
   ...
   static long method6498(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "kn.at(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;Ldh;II)V")
   @ObfuscatedName("bq")
   static final void method6499(WorldView var0, Actor var1, int var2, int var3) {
      Actor.method3275(var0, var1, var2);
      ...
      try {
            ...
            if (var8 != 0) {
               ...
               label465: {
                  ...
                  if (var8 >= -909895021 * var1.field1472) {
                     ...
                     if (var3 != -1128559099) {
                        Actor.method3271(var0, var1, var2);
                        return;
                     }
                  }
         ...
         throw classEG.newRunException(var14, "kn.bq(" + ')');
      }
   }
   ...
   static Object method6500(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "kn.cc(" + ')');
      }
   }
}
