...
public class classAC {
   ...
   @ObfuscatedName("qf")
   public static classVH method324(WorldEntityConfig var0) {
   ...
   void method320(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ac.ab(" + ')');
      }
   }
   ...
   public classAC(Buffer var1, classAE var2) {
      this.field129 = var1;
      this.field128 = var2;
   ...
   public void method314(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ac.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(B)Lxy;")
   @ObfuscatedName("ae")
   public Buffer method317(byte var1) {
      try {
         try {
            return (Buffer)this.field133.get();
         } catch (Exception var3) {
            return null;
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ac.ae(" + ')');
      }
   }
   ...
   public boolean method311(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ac.az(" + ')');
      }
   }
   ...
   static void method326(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ac.am(" + ')');
      }
   }
   ...
   static void method325(byte var0) {
      try {
         ...
         if (null != NpcOverrides.field5380) {
            ...
            NpcOverrides.field5380.field1539 = false;
         }

         NpcOverrides.field5380 = null;
         client.packetWriter.method3374((short)19926);
         ...
         GrandExchangeOffer.method7621(1434517176);
         ...
         while (var1.hasNext()) {
            ...
            WorldView.method3745(var2, (byte)-98);
         }
   ...
   public static void method316(int var0, int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var5, "ac.az(" + ')');
      }
   }
   ...
   public static int method310(CharSequence var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var6, "ac.az(" + 41);
      }
   }
}
