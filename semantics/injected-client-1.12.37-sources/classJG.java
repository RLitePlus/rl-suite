...
public class classJG {
   ...
   @ObfuscatedName("ah")
   static int method6367(int var0, Script var1, boolean var2, int var3) {
      try {
         if (1927 != var0) {
            if (var3 == 159285469) {
            ...
            if (var0 != 2927) {
               ...
               if (2928 == var0) {
                  ...
                  int var15 = classBB.field323[DynamicObject.field1679 * -324749371 + 1];
                  int var17 = classBB.field323[2 + -324749371 * DynamicObject.field1679];
                  if (var17 >= 1) {
                     if (var17 <= 10) {
                        Widget var19 = classLY.method7378(classWK.field6691, var12, var15, (byte)2);
                        if (null == var19) {
                           if (var3 == 159285469) {
                              throw new IllegalStateException();
                           }
               ...
               if (2929 == var0) {
                  ...
                  int var7 = classBB.field323[2 + -324749371 * DynamicObject.field1679];
                  int var8 = -1;
                  Widget var9 = classLY.method7378(classWK.field6691, var6, var7, (byte)-92);
                  if (null != var9) {
         ...
         if (1733013719 * classBB.field324 >= 10) {
            ...
            if (var0 >= 2000) {
               ...
               var4 = classLY.method7375(classWK.field6691, classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], (byte)85);
            } else {
               Widget var10000;
               if (var2) {
                  if (var3 == 159285469) {
            ...
            if (var4.field4246 == null) {
               ...
               ScriptEvent var5 = classZS.method14182(
                  classZS.method14180(
         ...
         throw classEG.newRunException(var10, "jg.ah(" + 41);
      }
   }
   ...
   public static boolean method6366(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "jg.af(" + ')');
      }
   }
}
