...
public abstract class classUY extends classTH implements classAAJ {
   ...
   public Object vmethod6(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var4, "uy.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("xn")
   public static classAAZ method11707(classUY var0, Buffer var1, int var2) {
      if (var0 == null) {
         return var0.method11709(var1, var2);
      } else {
         try {
            int var3 = Buffer.method13047(var1, -1621289879);
            ...
            throw classEG.newRunException(var10, "uy.ab(" + ')');
         }
      }
   }
   ...
   public int method11706(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "uy.af(" + 41);
      }
   }
   ...
   @ObfuscatedName("ay")
   public classAAZ method11708(Buffer var1) {
      int var2 = Buffer.method13047(var1, -1639067797);
   ...
   public static classPR method11710(int var0, int var1) {
      ...
      try {
         ...
         if (var6 != null) {
            ...
            var6 = new classPR(new Buffer(var7), var4);
            classPR.field5385.method6428(var6, var4);
            var10000 = var6;
         }
      } catch (RuntimeException var8) {
         throw classEG.newRunException(var8, "uy.az(" + ')');
      }
   ...
   @ObfuscatedName("ab")
   public classAAZ method11709(Buffer var1, int var2) {
      try {
         int var3 = Buffer.method13047(var1, -1621289879);
