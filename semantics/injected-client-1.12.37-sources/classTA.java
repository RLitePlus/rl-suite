...
public class classTA {
   ...
   public static final int method10732(String var0, String var1, int var2, int var3, int var4, int var5, byte var6) {
      try {
         return Friend.method10155(var0, var1, var2, var3, var4, var5, -1, false, 0, -324749371);
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "ta.fg(" + 41);
      }
   }
   ...
   static final int method10731(int var0, int var1, int var2, int var3) {
      try {
         ...
         int var8 = GraphicsObject.method1101(var4, var6, -1336616108);
         int var9 = GraphicsObject.method1101(1 + var4, var6, -546227840);
         int var10 = GraphicsObject.method1101(var4, var6 + 1, -1483735760);
         int var11 = GraphicsObject.method1101(1 + var4, var6 + 1, -1337985649);
         ...
         throw classEG.newRunException(var14, "ta.ap(" + 41);
      }
   }
}
