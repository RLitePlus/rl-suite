...
public class classBQ {
   ...
   @ObfuscatedName("aa")
   static AbstractArchive field531;
   @ObfuscatedName("on")
   static int field530;
   @ObfuscatedName("jg")
   static int field528;
   ...
   @ObfuscatedName("ab")
   static Message method1176(int var0, int var1) {
      try {
         return (Message)classCN.field1174.method13595(var0);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "bq.ab(" + ')');
      }
   }
   ...
   static String method1177(int var0) {
      try {
         String var10000;
         if (ClientPreferences.method2724(classAB.field122, (short)14302)) {
            if (var0 == 1990200307) {
               throw new IllegalStateException();
            }

            var10000 = classSL.method10470(classBF.JX_CHARACTER_ID, (short)-14678);
         } else {
            var10000 = classBF.JX_CHARACTER_ID;
         }

         return var10000;
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "bq.ag(" + ')');
      }
   }
   ...
   static void method1178(int var0, int var1, int var2, int var3, String var4, String var5, int var6) {
      try {
         Widget var7 = classLY.method7378(classWK.field6691, var0, var1, (byte)-72);
         if (var7 != null) {
            if (var6 != -2085845878) {
               return;
            }
            ...
            if (null != var7.field4381) {
               ...
               ScriptEvent var8 = classZS.method14182(classUQ.method11465(var7, 2126959045).method14145(var7.field4381, (byte)2), (byte)127);
         ...
         throw classEG.newRunException(var9, "bq.eb(" + ')');
      }
   }
}
