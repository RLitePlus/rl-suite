...
public final class classHO {
   ...
   static void method6078(classTE var0, classYY var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ho.bn(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;Loq;B)V")
   @ObfuscatedName("cv")
   static final void method6079(WorldView var0, classOQ var1, byte var2) {
      try {
         for (int var3 = 0; var3 < classZH.method14003(var0.field1697, (byte)10); var3++) {
            ...
            NPC var4 = (NPC)var0.field1698.method13404(var0.field1697.method14001(var3, 1761435756));
            if (null != var4 && var4.vmethod262((byte)50)) {
               if (var2 != 0) {
                  throw new IllegalStateException();
               }

               if (var4.definition.field5305 == var1 && var4.definition.method8959((byte)-97)) {
                  if (var2 != 0) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (var0.method3729(var6, var7, (byte)1)) {
                     ...
                     boolean var12;
                     if (!var4.definition.method8987(2095992902)) {
                        if (var2 != 0) {
                           throw new IllegalStateException();
                        }
                        ...
                        label150: {
                           for (int var13 = 0; var13 < classZH.method14003(classIS.field3053.field1693, (byte)10); var13++) {
                              ...
                              WorldEntity var14 = (WorldEntity)classIS.field3053
                                 .worldEntities
                                 .method13595(classIS.field3053.field1693.method14001(var13, 1570533187));
                              if (var14 != null) {
                                 if (var2 != 0) {
                                    return;
                                 }

                                 if (client.field855 * 1612595797 == var14.field6012.scene.field2142) {
                                    if (var2 != 0) {
                                       return;
                                    }
                     ...
                     boolean var16 = Scene.method4477(
                        var0.scene,
                        var5,
         ...
         throw classEG.newRunException(var15, "ho.cv(" + ')');
      }
   }

   classHO(WorldMapRenderer var1) {
      this.this$0 = var1;
   }

   @ObfuscatedSignature(descriptor = "(Lct;IIIIB)V")
   @ObfuscatedName("fx")
   static final void method6080(Player var0, int var1, int var2, int var3, int var4, byte var5) {
      ...
      if (var6) {
         ...
         try {
            if (var7.field1480 * -1315528093 == -2130951373 * client.field845) {
            ...
            } else if (-1927903443 * client.menu.field6797 >= 400) {
               if (var12 <= 0) {
                  throw new IllegalStateException();
               }
            } else {
               Player var14 = classMB.method7521(1766208156);
               int var10000;
               if (null != var14) {
                  if (var12 <= 0) {
                     return;
               ...
               int var13 = var10000;
               int var23 = var13;
               Player var16 = classMB.method7521(873668262);
               if (var16 != null) {
                  if (var12 <= 0) {
                     throw new IllegalStateException();
                  }
               ...
               if (1777039337 * var7.field1262 == 0) {
                  String var18 = var7.actions[0] + var7.field1283 + var7.actions[1];
                  ...
                  var17 = var18 + var19 + " " + classDO.field1593 + classKK.field3688 + 810892507 * var7.field1261 + classDO.field1591 + var7.actions[2];
               } else {
                  var17 = var7.actions[0]
                     + var7.field1283
                     + var7.actions[1]
                     + " "
                     + classDO.field1593
                     ...
                     if (client.field968[var25] != null) {
                        ...
                        if (client.field968[var25].equalsIgnoreCase(classKK.field3776)) {
                           ...
                           if (client.field916 == classCK.field768) {
                              ...
                              if (Player.method2648(var7, -1817263910)) {
                                 if (var12 <= 0) {
                                    return;
                                 }
               ...
               for (int var26 = 0; var26 < -1927903443 * client.menu.field6797; var26++) {
                  if (var12 <= 0) {
                     throw new IllegalStateException();
                  }

                  if (client.menu.menuIdentifiers[var26] == 23) {
                     if (var12 <= 0) {
                        throw new IllegalStateException();
                     }

                     client.menu.field6805[var26] = classQY.method9847(16777215, (byte)88) + var17;
                     break;
                  }
               }
            }
         } catch (RuntimeException var22) {
            throw classEG.newRunException(var22, "ho.fx(" + ')');
         }
      }
   }
}
