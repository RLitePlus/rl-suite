...
public class classKC implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "kc.az(" + 41);
      }
   }
   ...
   static final int method6458(int var0, int var1) {
      try {
         return Math.min(Math.max(var0, Scene.method4131(client.field839)), Scene.method4138(client.field839));
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "kc.bk(" + 41);
      }
   }
   ...
   @ObfuscatedName("ce")
   static int method6460(WorldView var0, int var1, int var2, int var3, int var4, short var5) {
      try {
         if (var4 == 0) {
         ...
         throw classEG.newRunException(var18, "kc.ce(" + 41);
      }
   }
   ...
   static boolean method6459(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "kc.cw(" + ')');
      }
   }
}
