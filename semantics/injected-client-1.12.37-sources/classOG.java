...
public class classOG {
   ...
   static boolean method8436(char var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "og.ay(" + ')');
      }
   }
   ...
   public static byte method8434(char var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "og.az(" + ')');
      }
   }
   ...
   static classSH[] method8435(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "og.ag(" + ')');
      }
   }
      ...
      if (!var3.isConsumed()) {
         ...
         try {
            ...
            for (int var10 = 0; var10 < var9; var10++) {
               ...
               ItemComposition var11 = classOB.method8299(var10, (byte)-39);
               if (var5) {
                  if (var6 == 3129) {
                     throw new IllegalStateException();
                  }
               ...
               if (-1 == 1236138331 * var11.field5051) {
                  ...
                  } else if (ItemComposition.method8704(var11, 1248604557).toLowerCase().indexOf(var4) == -1) {
                     if (var6 == 3129) {
                        throw new IllegalStateException();
                     }
                  } else {
            ...
            while (true) {
               ...
               var16[var17] = ItemComposition.method8704(classOB.method8299(var7[var17], (byte)-41), 1248604557);
               var17++;
            }
         } catch (RuntimeException var14) {
            throw classEG.newRunException(var14, "og.gr(" + ')');
         }
      }
   }
}
