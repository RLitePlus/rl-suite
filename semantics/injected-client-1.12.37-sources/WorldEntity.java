...
public class WorldEntity extends Node implements CameraFocusableEntity, net.runelite.api.WorldEntity {
   ...
   @ObfuscatedName("ax")
   public WorldEntityConfig field6026;
   @ObfuscatedName("au")
   ...
   public boolean method10557() {
      return this.field6012.scene.field2055 == 0.01F;
   }
   ...
   public void method10554(boolean var1, int var2) {
      try {
         ...
         classUU.method11574(this.field6012.scene.field2028, -1782703087);
         if (null != var4) {
            if (var2 <= 1772825224) {
               throw new IllegalStateException();
            }
            ...
            if (var4.method9734(500216846) != -1 && var4.method9765((byte)-52) && var4.method9731((byte)24).method8768((byte)0)) {
               ...
               if (var7 != null) {
                  ...
                  rl23.method10067(this.field6012.scene.field2028, classMN.method7625(var7, -2048083282), (byte)-94);
                  this.field6012.scene.field2028.field6399 = -this.field6012.scene.field2028.field6399;
               }
            }
         }

         this.field6012.scene.field2027 = -483624883 * this.field6012.field1710;
         if (var1) {
            if (var2 <= 1772825224) {
               return;
            }

            this.field6012.scene.field2030 = -1200;
            this.field6012.scene.field2055 = 0.01F;
            int var11 = WorldEntityConfig.method8497(this.field6026, -906701437);
            classFL var12 = this.field6012.scene.field2035;
            ...
            this.field6012.scene.field2030 = 0;
            this.field6012.scene.field2055 = 1.0F;
            classFL.method4836(this.field6012.scene.field2035);
         }
      } catch (RuntimeException var10) {
         throw classEG.newRunException(var10, "sp.ae(" + ')');
      }
   }
   ...
   public boolean method10558(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.ab(" + ')');
      }
   }
   ...
   public classKW method10573(boolean var1) {
      return var1 ? classKW.field4043 : WorldEntityConfig.method8488(this.field6026, 1221832000);
   }
   ...
   public int method10559(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.ag(" + 41);
      }
   }
   ...
   @ObfuscatedName("rc")
   public static void method10615(WorldEntity var0, classGY var1, int var2, int var3) {
   ...
   public int vmethod371(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.ea(" + 41);
      }
   }
   ...
   public int vmethod258(byte var1) {
      try {
         if (this.field6020 * -1427480299 != 0) {
            ...
            WorldView var2 = client.field814.method1590(-1427480299 * this.field6020, (short)30221);
            if (var2 != null) {
               if (var1 >= 0) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.newRunException(var3, "sp.az(" + 41);
      }
   }
   ...
   public int method10561(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.as(" + 41);
      }
   }
   ...
   public classGY method10563(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.ax(" + ')');
      }
   }
   ...
   public classKR method10571(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.aa(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lsp;Loi;I)V")
   @ObfuscatedName("ea")
   public static void method10567(WorldEntity var0, WorldEntityConfig var1, int var2) {
      if (var0 == null) {
      ...
      try {
         var0.field6026 = var1;
         var0.field6012.scene.field2029 = var1.method8474(-2078533940);
         var0.field6012.scene.field2047 = var1.method8478((byte)-10);
         var0.method10595(var1.method8479((byte)-18), (byte)-48);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "sp.ac(" + ')');
      }
   }
   ...
   public classKW method10574(boolean var1, int var2) {
      try {
         if (var1) {
            ...
            return WorldEntityConfig.method8488(this.field6026, 2136997395);
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "sp.ao(" + ')');
      }
   }
   ...
   public void method10583(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "sp.aj(" + ')');
      }
   }
   ...
   @ObfuscatedName("sa")
   public static void method10555(WorldEntity var0, boolean var1) {
      if (var0 == null) {
      ...
      classUU.method11574(var0.field6012.scene.field2028, -1327161563);
      if (null != var3 && var3.method9734(500216846) != -1 && var3.method9765((byte)-82) && var3.method9731((byte)110).method8768((byte)0)) {
         ...
         if (var6 != null) {
            ...
            rl23.method10067(var0.field6012.scene.field2028, classMN.method7625(var6, -1993724010), (byte)38);
            var0.field6012.scene.field2028.field6399 = -var0.field6012.scene.field2028.field6399;
         }
      }

      var0.field6012.scene.field2027 = -1606618975 * var0.field6012.field1710;
      if (var1) {
         var0.field6012.scene.field2030 = -1200;
         var0.field6012.scene.field2055 = 0.01F;
         int var9 = WorldEntityConfig.method8497(var0.field6026, -1845887744);
         classFL var10 = var0.field6012.scene.field2035;
         ...
         var0.field6012.scene.field2030 = 0;
         var0.field6012.scene.field2055 = 1.0F;
         classFL.method4836(var0.field6012.scene.field2035);
      }
   }
   ...
   @ObfuscatedName("gp")
   public static boolean method10584(WorldEntity var0, int var1) {
      if (var0 == null) {
   ...
   public int method10589(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.aq(" + 41);
      }
   }
   ...
   public int method10590(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.ad(" + 41);
      }
   }
   ...
   void method10595(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "sp.ap(" + ')');
      }
   }
   ...
   @ObfuscatedName("ij")
   public static void method10602(WorldEntity var0, int var1, int var2) {
      if (var0 == null) {
         var0.method10557();
      }
   ...
   public void method10603(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var5, "sp.ai(" + ')');
      }
   }
   ...
   public void method10612(classGY var1, byte var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "sp.aw(" + ')');
      }
   }
   ...
   public classUZ method10620(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var10, "sp.at(" + ')');
      }
   }
   ...
   public classUZ method10621(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var10, "sp.an(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lsp;IB)Z")
   @ObfuscatedName("hg")
   public static boolean method10585(WorldEntity var0, int var1, byte var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "sp.ay(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("gj")
   public static classUZ method10622(WorldEntity var0, int var1, int var2) {
      if (var0 == null) {
   ...
   public int vmethod259() {
      if (this.field6020 * -1427480299 != 0) {
         WorldView var1 = client.field814.method1590(-1427480299 * this.field6020, (short)-3992);
         if (var1 != null) {
   ...
   @ObfuscatedName("kn")
   public static void method10577(WorldEntity var0, classKR var1, int var2) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "sp.al(" + ')');
      }
   }
   ...
   void method10616(classGY var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var7, "sp.ak(" + ')');
      }
   }
   ...
   public void method10556(boolean var1) {
      ...
      classUU.method11574(this.field6012.scene.field2028, -246549455);
      if (null != var3 && var3.method9734(500216846) != -1 && var3.method9765((byte)-108) && var3.method9731((byte)44).method8768((byte)0)) {
         ...
         if (var6 != null) {
            ...
            rl23.method10067(this.field6012.scene.field2028, classMN.method7625(var6, -2087567950), (byte)-91);
            this.field6012.scene.field2028.field6399 = -this.field6012.scene.field2028.field6399;
         }
      }

      this.field6012.scene.field2027 = 2025563689 * this.field6012.field1710;
      if (var1) {
         this.field6012.scene.field2030 = -1002495153;
         this.field6012.scene.field2055 = 0.01F;
         int var9 = WorldEntityConfig.method8497(this.field6026, 1938294297);
         classFL var10 = this.field6012.scene.field2035;
   ...
   @ObfuscatedSignature(descriptor = "()Loi;")
   @ObfuscatedName("vr")
   public WorldEntityConfig method10629() {
   ...
   @ObfuscatedName("rq")
   public static void method10618(WorldEntity var0, int var1) {
   ...
   @ObfuscatedName("bu")
   public void method10568(WorldEntityConfig var1) {
      this.field6026 = var1;
      this.field6012.scene.field2029 = var1.method8474(-1652450642);
      this.field6012.scene.field2047 = var1.method8478((byte)-88);
      this.method10595(var1.method8479((byte)-77), (byte)-30);
   }

   @ObfuscatedSignature(descriptor = "(Loi;)V")
   @ObfuscatedName("bo")
   public void method10569(WorldEntityConfig var1) {
      this.field6026 = var1;
      this.field6012.scene.field2029 = var1.method8474(-1855780411);
      this.field6012.scene.field2047 = var1.method8478((byte)-9);
   ...
   public classKW method10575(boolean var1) {
      return var1 ? classKW.field4043 : WorldEntityConfig.method8488(this.field6026, 1278077171);
   }

   @ObfuscatedSignature(descriptor = "(Z)Lkw;")
   @ObfuscatedName("bq")
   public classKW method10576(boolean var1) {
      return var1 ? classKW.field4043 : WorldEntityConfig.method8488(this.field6026, 40625837);
   }
   ...
   classQR method10552(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.af(" + ')');
      }
   }
   ...
   public int vmethod368(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.ey(" + 41);
      }
   }
   ...
   public int method10598(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sp.au(" + 41);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;II)V")
   @ObfuscatedName("gt")
   public static void method10604(WorldEntity var0, int var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lsp;I)V")
   @ObfuscatedName("yl")
   public static void method10619(WorldEntity var0, int var1) {
   ...
   @ObfuscatedName("cn")
   public final void method10607(WorldView var1, classGY var2) {
   ...
   @ObfuscatedSignature(descriptor = "(Ldz;Lgy;)V")
   @ObfuscatedName("cf")
   public final void method10608(WorldView var1, classGY var2) {
   ...
   @ObfuscatedName("ji")
   public static void method10609(WorldEntity var0, WorldView var1, classGY var2, byte var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.newRunException(var8, "sp.ar(" + ')');
      }
   }
   ...
   static void method10624(String var0, String var1, String var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "sp.ar(" + ')');
      }
   }
   ...
   @ObfuscatedName("jb")
   public static classGY method10566(WorldEntity var0) {
   ...
   @ObfuscatedName("ac")
   public void method10570(WorldEntityConfig var1, int var2) {
      try {
         this.field6026 = var1;
         this.field6012.scene.field2147 = var1.method8502(-2078533940);
         this.field6012.scene.field2144 = var1.method8478((byte)-10);
   ...
   @ObfuscatedName("ar")
   public final void method10610(WorldView var1, classGY var2, byte var3) {
      try {
