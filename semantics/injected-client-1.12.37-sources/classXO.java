...
public class classXO implements classXZ {
   ...
   @ObfuscatedName("bq")
   static int method12866(int var0, Script var1, boolean var2, int var3) {
      try {
         if (var0 == 5306) {
            if (var3 <= -297600906) {
               throw new IllegalStateException();
            } else {
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classLH.method7105(591510276);
               return 1;
            }
         } else if (5307 == var0) {
            ...
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classAB.field122.method2797(-79298167);
            return 1;
         } else if (var0 != 5309) {
            if (var0 == 5310) {
               if (var3 <= -297600906) {
         ...
         throw classEG.newRunException(var5, "xo.bq(" + 41);
      }
   }
   ...
   String method12857(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "xo.as(" + ')');
      }
   }
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "xo.az(" + 41);
      }
   }
   ...
   static classXO[] method12855(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "xo.ag(" + ')');
      }
   }
   ...
   public static int method12865(long var0) {
      try {
         ...
         throw classEG.newRunException(var3, "xo.as(" + 41);
      }
   }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "xo.toString(" + ')');
      }
   }
}
