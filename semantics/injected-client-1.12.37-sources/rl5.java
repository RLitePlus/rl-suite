   ...
   public int getItemOp() {
      ...
      if (var1 == MenuAction.CC_OP || var1 == MenuAction.CC_OP_LOW_PRIORITY || var1 == MenuAction.RUNELITE_WIDGET) {
         ...
         if (var3 == 9764864) {
            switch (var2) {
               case 1:
                  Widget var5 = classOE.client.method2295(var3);
                  if (var5 != null && var4 != -1) {
                     net.runelite.api.widgets.Widget var7 = var5.getChild(var4);
                     if (var7 != null && var7.getItemId() > -1) {
                        int var6 = classOE.client.method2278(var7.getItemId()).getShiftClickActionIndex();
                        if (var6 >= 0) {
                           return var6 + 1;
                        }
                     }
   ...
   public net.runelite.api.widgets.Widget getWidget() {
      switch (this.getType()) {
         ...
         case RUNELITE_WIDGET:
            ...
            Object var3 = classOE.client.method2295(var1);
            if (var3 != null && var2 > -1) {
