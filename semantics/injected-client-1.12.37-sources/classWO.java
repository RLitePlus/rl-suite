...
public class classWO extends classWT {
   ...
   @ObfuscatedName("qi")
   public static AbstractRasterProvider field6763;
   @ObfuscatedName("af")
   int field6760;
   ...
   public classWO(classWT var1, int var2, boolean var3, int var4) {
      ...
      if (var2 >= 0) {
         if (var3 && var2 < classNP.field4697.size()) {
            this.field6761 = (MidiRequest)classNP.field4697.get(var2);
         } else if (!var3 && var2 < classNP.field4698.size()) {
            this.field6761 = (MidiRequest)classNP.field4698.get(var2);
         }
   ...
   public boolean vmethod627(byte var1) {
      try {
         ...
         throw classEG.newRunException(var4, "wo.az(" + ')');
      }
   }
