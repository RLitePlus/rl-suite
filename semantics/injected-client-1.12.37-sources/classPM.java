...
public class classPM {
   ...
   @ObfuscatedName("as")
   static final IterableNodeHashTable method9006(Buffer var0, IterableNodeHashTable var1) {
      int var2 = Buffer.method13039(var0, -346779531);
      if (var1 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Lyn;)Lyn;")
   @ObfuscatedName("ag")
   static final IterableNodeHashTable method9007(Buffer var0, IterableNodeHashTable var1) {
      int var2 = Buffer.method13039(var0, -346779531);
      if (var1 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Lyn;)Lyn;")
   @ObfuscatedName("ax")
   static final IterableNodeHashTable method9008(Buffer var0, IterableNodeHashTable var1) {
      int var2 = Buffer.method13039(var0, -346779531);
      if (var1 == null) {
   ...
   static final void method9016(short var0) {
      try {
         ...
         if (null != ItemComposition.field5078) {
            if (var0 == 255) {
               throw new IllegalStateException();
            }

            ItemComposition.field5078.method11863((byte)2);
         }
         ...
         throw classEG.newRunException(var1, "pm.an(" + ')');
      }
   }
}
