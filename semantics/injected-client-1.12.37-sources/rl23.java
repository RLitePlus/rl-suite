...
class rl23 extends Thread {
   ...
   @ObfuscatedName("mg")
   public static Projection field5750;
   @ObfuscatedSignature(descriptor = "Lez;")
   @ObfuscatedName("el")
   public static Scene field5749;
   @ObfuscatedSignature(descriptor = "Lnn;")
   @ObfuscatedName("ny")
   ...
   @ObfuscatedName("ti")
   public static void method10064(Projection var0, Scene var1) {
      field5750 = var0;
      field5749 = var1;
   }
   ...
   @ObfuscatedName("uk")
   public static void method10070(TileObject var0, DynamicObject var1, int var2, int var3, int var4, int var5) {
   ...
   public static void method10066(int var0, rl21 var1, rl22 var2) {
      DynamicObject var3 = var2.field5739;
      ...
      try {
         ...
         client.logger.debug("exception drawing dynamic game entity", var11);
         return;
      }
