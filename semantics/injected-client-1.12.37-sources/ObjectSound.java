...
@ObfuscatedName("dw")
public abstract class ObjectSound extends Node implements AmbientSoundEffect {
   ...
   void method3638(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, int var9) {
      try {
         ...
         throw classEG.newRunException(var16, "dw.ak(" + ')');
      }
   }
   ...
   boolean method3634(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dw.aw(" + ')');
      }
   }
   ...
   classWC method3650(int var1, int var2, int var3, byte var4) {
      try {
         int var5 = MouseHandler.field6273.method11868(var1, -1637846082) - 1;
         classAL var6 = classAL.method435(MouseHandler.field6273, var1, var5);
         if (null != var6) {
            classAJ var7;
            if (var5 == 0) {
               if (var4 == 56) {
               ...
               var7 = var6.method438(ClientPreferences.method2824(classAB.field122, 197040242));
            } else {
               if (var5 != 1) {
                  return null;
               }
         ...
         throw classEG.newRunException(var9, "dw.an(" + ')');
      }
   }
   ...
   void method3652(classWC var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var5, "dw.am(" + ')');
      }
   }
   ...
   void method3654(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "dw.ah(" + ')');
      }
   }
   ...
   void method3659(classWC var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "dw.bn(" + ')');
      }
   }
   ...
   void method3662(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dw.bx(" + ')');
      }
   }
   ...
   int method3665(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dw.bc(" + 41);
      }
   }
   ...
   int method3669(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dw.br(" + 41);
      }
   }
   ...
   public void vmethod398() {
      try {
         ...
         throw classEG.newRunException(var1, "dw.gr(" + ')');
      }
   }
   ...
   int method3671(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dw.bm(" + 41);
      }
   }
   ...
   @ObfuscatedName("qp")
   public static String method3673(ObjectSound var0) {
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "dw.toString(" + ')');
      }
   }
   ...
   @ObfuscatedName("ap")
   public static void method3656(ObjectSound var0) {
   ...
   static void method3630() {
      for (ObjectSound var0 = (ObjectSound)field1645.method7915(); var0 != null; var0 = (ObjectSound)classNN.method7924(field1645)) {
   ...
   @ObfuscatedName("kn")
   public static void method3648(ObjectSound var0, classWJ var1, classWW var2, byte var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "dw.at(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ldw;)Ljava/lang/String;")
   @ObfuscatedName("cs")
   public static String method3675(ObjectSound var0) {
      if (var0 == null) {
         var0.method3677();
      }
   ...
   @ObfuscatedName("qy")
   public static boolean method3637(ObjectSound var0) {
      if (var0 == null) {
         var0.vmethod400();
      }
   ...
   ObjectSound(int var1, classWJ var2, classWW var3) {
   ...
   int method3667(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dw.bp(" + 41);
      }
   }
   ...
   public static void method3676(classTE var0, classTE var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var8, "dw.aj(" + ')');
      }
   }
   ...
   @ObfuscatedName("bv")
   public static int method3670(ObjectSound var0) {
