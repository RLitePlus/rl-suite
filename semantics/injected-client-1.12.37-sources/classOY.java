...
public class classOY extends classVJ {
   ...
   @ObfuscatedName("ae")
   public static AbstractArchive field5201;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ab")
   public static EvictingDualNodeHashTable field5194 = new EvictingDualNodeHashTable(64);
   @ToRemove(unused = "true")
   @ObfuscatedName("bo")
   ...
   @ObfuscatedName("aq")
   static IndexedSprite[] field5202;
   @ToRemove(unused = "true")
   @ObfuscatedName("az")
         ...
         while (true) {
            ...
            switch (var3) {
               case 0:
                  break label26;
               case 5:
                  var2 = Buffer.method13047(var1, 1304636744);
            }
         }
      }
   ...
   @ObfuscatedName("mm")
   public static void method8821(PlayerComposition var0, int var1, int var2) {
   ...
   public static classOY method8819(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classOY(new Buffer(var2));
   ...
   @ObfuscatedName("cr")
   static int method8822(int var0, Script var1, boolean var2, int var3) {
      try {
         if (var0 == 6754) {
            ...
            if (var3 == -1506417701) {
               ...
               classPL var7 = classOH.method8448(classBB.field323[-324749371 * DynamicObject.field1679], -385869);
               int var5 = classBB.field323[1 + DynamicObject.field1679 * -324749371];
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var7.method8977(var5, (byte)-51);
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var7.method8984(var5, (byte)-74);
               return 1;
            }
         } else if (var0 == 6765) {
            if (var3 == -1506417701) {
               ...
               classPL var4 = classOH.method8448(classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], 826357941);
         ...
         throw classEG.newRunException(var6, "oy.cr(" + 41);
      }
   }
}
