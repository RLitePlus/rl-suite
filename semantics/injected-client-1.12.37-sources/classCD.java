...
@ObfuscatedName("cd")
public final class classCD extends Node {
   @ObfuscatedName("aq")
   int field672;
   @ObfuscatedName("ax")
   int field686;
   ...
   void method1411(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cd.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZB)I")
   @ObfuscatedName("ay")
   static int method1433(int var0, Script var1, boolean var2, byte var3) {
      try {
         Widget var4;
         if (var0 >= 2000) {
            if (var3 != 0) {
         ...
         if (var0 == 1100) {
            ...
            int var42 = classBB.field323[DynamicObject.field1679 * -324749371];
            int var50 = classBB.field323[1 + -324749371 * DynamicObject.field1679];
            ...
            if (var3 != 0) {
               ...
               var4.field4270 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 1590850751;
               return 1;
            }
         } else if (var0 == 1102) {
            boolean var64;
            ...
            var4.field4347 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * -2056841747;
            return 1;
         } else if (1104 == var0) {
            var4.field4277 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 327091521;
            return 1;
         } else if (var0 == 1105) {
            if (var3 != 0) {
               throw new IllegalStateException();
            } else {
               var4.field4348 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 857041169;
               return 1;
            }
         } else if (var0 == 1106) {
            if (var3 != 0) {
               ...
               var4.field4351 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * -727683123;
               return 1;
            }
         } else if (1107 == var0) {
            if (var3 != 0) {
            ...
            if (var3 != 0) {
               ...
               var4.field4290 = 1981476425 * classBB.field323[-324749371 * DynamicObject.field1679];
               var4.field4291 = 1954863581 * classBB.field323[1 + -324749371 * DynamicObject.field1679];
               var4.field4356 = 1703663435 * classBB.field323[2 + -324749371 * DynamicObject.field1679];
               var4.field4292 = classBB.field323[3 + -324749371 * DynamicObject.field1679] * 993003239;
               var4.field4294 = classBB.field323[-324749371 * DynamicObject.field1679 + 4] * 863028557;
               var4.field4338 = classBB.field323[DynamicObject.field1679 * -324749371 + 5] * 1556726191;
               return 1;
            }
         } else if (1110 == var0) {
            if (var3 != 0) {
               ...
               int var41 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
            ...
            if (var3 != 0) {
               ...
               var39 = classUP.method11420(var39, User.method10179(-1119970828), classBB.field334, classBB.field333, (byte)0);
               if (12 == -1510882375 * var4.field4375) {
                  if (var3 != 0) {
                     throw new IllegalStateException();
                  }
            ...
            var4.field4245 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 590574429;
            ...
            if (var3 != 0) {
               ...
               if (12 == var4.field4375 * -1510882375) {
                  ...
                  if (null != var37) {
                     classLH.method6840(
                        var37, classBB.field323[DynamicObject.field1679 * -324749371], classBB.field323[1 + -324749371 * DynamicObject.field1679], -981774839
                     );
                     var37.method6841(classBB.field323[DynamicObject.field1679 * -324749371 + 2], 879336967);
                  }
               } else {
                  var4.field4304 = 571804797 * classBB.field323[DynamicObject.field1679 * -324749371];
                  var4.field4305 = -2106140265 * classBB.field323[-324749371 * DynamicObject.field1679 + 1];
                  var4.field4303 = classBB.field323[2 + DynamicObject.field1679 * -324749371] * -763080175;
               }
            ...
            if (var3 != 0) {
               ...
               var4.field4283 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * -1993421947;
               return 1;
            }
         } else if (var0 == 1117) {
            if (var3 != 0) {
               ...
               var4.field4284 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 37017731;
               return 1;
            }
         } else if (1118 == var0) {
            if (var3 != 0) {
            ...
            if (var3 != 0) {
               ...
               DynamicObject.field1679 -= 240082458;
               var4.field4258 = -803344527 * classBB.field323[DynamicObject.field1679 * -324749371];
               var4.field4269 = -251301447 * classBB.field323[-324749371 * DynamicObject.field1679 + 1];
            ...
            if (var3 != 0) {
               ...
               var4.field4349 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 1515656587;
               return 1;
            }
         } else if (var0 == 1123) {
            if (var3 != 0) {
               ...
               var4.field4295 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * -1914223631;
               return 1;
            }
         } else if (var0 == 1124) {
            var4.field4276 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 61705535;
            return 1;
         } else if (var0 == 1125) {
            if (var3 != 0) {
               throw new IllegalStateException();
            ...
            if (var3 != 0) {
               ...
               DynamicObject.field1679 -= 240082458;
               var4.method7241(classBB.field323[DynamicObject.field1679 * -324749371], classBB.field323[DynamicObject.field1679 * -324749371 + 1], -1844055709);
               return 1;
            }
         } else if (1132 == var0) {
            if (var3 != 0) {
               ...
               Widget.method7243(
                  ...
                  classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371],
                  (byte)61
               );
               return 1;
            }
            ...
            if (var3 != 0) {
               ...
               classLI var32 = Widget.method7285(var4, 1601124651);
               if (var32 != null) {
                  if (var3 != 0) {
                     throw new IllegalStateException();
                  }

                  var32.field4172 = 1594234983 * classBB.field323[DynamicObject.field1679 * -324749371];
               }
            ...
            if (var3 != 0) {
               ...
               DynamicObject.field1679 -= 120041229;
               classLI var31 = Widget.method7285(var4, 553208368);
               if (null != var31) {
                  if (var3 != 0) {
                     throw new IllegalStateException();
                  }

                  var31.field4170 = classBB.field323[DynamicObject.field1679 * -324749371] * 27298427;
               }
            ...
            if (var3 != 0) {
               ...
               if (var30 != null) {
                  ...
                  var46 = classUP.method11420(var46, User.method10179(-518504381), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 != 0) {
               ...
               DynamicObject.field1679 -= 120041229;
               classLI var29 = Widget.method7285(var4, 1538856326);
               if (null != var29) {
                  if (var3 != 0) {
                     throw new IllegalStateException();
                  }

                  var29.field4169 = classBB.field323[DynamicObject.field1679 * -324749371] * 798448585;
               }
            ...
            if (var3 != 0) {
               ...
               if (var28 != null) {
                  ...
                  if (var28.method6820(classBB.field323[DynamicObject.field1679 * -324749371], -133076799) && var3 != 0) {
                     throw new IllegalStateException();
                  }
               }
            ...
            if (var27 != null) {
               ...
               if (var27.method6827(classBB.field323[-324749371 * DynamicObject.field1679], (byte)1)) {
               }
            }
            ...
            if (var3 != 0) {
               ...
               if (null != var26) {
                  ...
                  if (classLH.method6832(var26, classBB.field323[DynamicObject.field1679 * -324749371], (byte)-35)) {
                  }
               }
            ...
            if (var3 != 0) {
               ...
               if (null != var23) {
                  ...
                  if (classLH.method6882(
                        var23, classBB.field323[DynamicObject.field1679 * -324749371], classBB.field323[DynamicObject.field1679 * -324749371 + 1], 1122842785
                     )
                     && var3 != 0) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 != 0) {
               ...
               if (var22 != null) {
                  ...
                  if (classLH.method6882(
                        var22, classBB.field323[DynamicObject.field1679 * -324749371], classBB.field323[DynamicObject.field1679 * -324749371], 1122842785
                     )
                     && var3 != 0) {
                     throw new IllegalStateException();
                  }
            ...
            if (null != var21) {
               ...
               classLH.method7031(var21, classBB.field323[-324749371 * DynamicObject.field1679], (short)248);
            }
            ...
            if (var3 != 0) {
               ...
               if (var20 != null) {
                  ...
                  var20.method7020(classBB.field323[-324749371 * DynamicObject.field1679], (byte)0);
               }
            ...
            if (var19 != null) {
               var19.method6845(classBB.field323[DynamicObject.field1679 * -324749371], 1201353478);
            }
            ...
            if (var3 != 0) {
               ...
               if (null != var18) {
                  ...
                  classLH.method7043(var18, classBB.field323[-324749371 * DynamicObject.field1679], 2117141590);
               }
            ...
            DynamicObject.field1679 -= 240082458;
            classTT var17 = Widget.method7287(var4, 1289741507);
            if (var17 != null) {
               var17.method11132(classBB.field323[DynamicObject.field1679 * -324749371], classBB.field323[-324749371 * DynamicObject.field1679 + 1], 1658283540);
            }
            ...
            if (var3 != 0) {
               ...
               DynamicObject.field1679 -= 240082458;
               classTT var16 = Widget.method7287(var4, 1289741507);
               if (null != var16) {
                  var16.method11136(
                     (char)classBB.field323[DynamicObject.field1679 * -324749371], classBB.field323[1 + -324749371 * DynamicObject.field1679], (byte)67
                  );
               }
            ...
            if (var3 != 0) {
               ...
               Widget.method7233(var4, var15, var43, var7, var12, Long.toString(var10), classAV.field294, -1916406987);
               return 1;
            }
         } else if (1152 == var0) {
            if (var3 != 0) {
         ...
         throw classEG.newRunException(var13, "cd.ay(" + 41);
      }
   }
   ...
   boolean method1416(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cd.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("ps")
   public static void method1432(ClientPreferences var0, int var1) {
      if (var0 == null) {
   ...
   public static boolean method1420(classCD var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "cd.ab(" + ')');
      }
   }
   ...
   void method1415(String[] var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cd.af(" + ')');
      }
   }
   ...
   String method1425(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cd.ag(" + ')');
      }
   }
   ...
   static Class method1431(String var0, byte var1) throws ClassNotFoundException {
      try {
         ...
         throw classEG.newRunException(var2, "cd.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;IILvv;Lqn;I)V")
   @ObfuscatedName("as")
   public static void method1430(Widget var0, int var1, int var2, classVV var3, classQN var4, int var5) {
      try {
         Widget var10000;
         ...
         throw classEG.newRunException(var9, "cd.as(" + ')');
      }
   }
   ...
   public static int method1410(int var0, short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cd.af(" + 41);
      }
   }
