...
public class classQK implements Callable {
   ...
   @ObfuscatedName("af")
   public static int method9604(Buffer var0, byte var1, int var2, byte var3) {
      try {
         ...
         if (var4 == 3) {
            ...
            if (var3 <= 7) {
               ...
               return Buffer.method13043(var0, (byte)17);
            }
         } else {
            return 0;
         }
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "qk.af(" + 41);
      }
   }
   ...
   public Object call() throws Exception {
      try {
         ...
         throw classEG.newRunException(var3, "qk.call(" + ')');
      }
   }
