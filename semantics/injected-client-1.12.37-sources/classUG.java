...
public class classUG {
   ...
   public int hashCode() {
      try {
         ...
         throw classEG.newRunException(var3, "ug.hashCode(" + 41);
      }
   }
   ...
   public void method11306(int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "ug.af(" + ')');
      }
   }
   ...
   void method11308(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ug.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("qc")
   public static void method11305(PacketWriter var0) {
   ...
   @ObfuscatedName("zr")
   public static void method11320(Scene var0) {
      if (var0 == null) {
         var0.method4130();
      }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ug.equals(" + ')');
      }
   }
   ...
   public static classSN method11321(int var0, int var1) {
      try {
         classSN var2 = (classSN)SequenceDefinition.field5144.method6422(var0);
         if (null != var2) {
            return var2;
         } else {
            var2 = classMB.method7509(classGN.field2633, classIY.field3099, var0, -1929466463);
            if (var2 != null) {
               SequenceDefinition.field5144.method6428(var2, var0);
            }

            return var2;
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ug.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("vn")
   public static void method11304(PacketBuffer var0, classYT var1) {
      if (var0 == null) {
         var0.method12904();
      }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "ug.toString(" + ')');
      }
   }
