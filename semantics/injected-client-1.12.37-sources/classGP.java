...
public class classGP {
   ...
   @ObfuscatedName("av")
   void method5561(Widget var1, int var2) {
         ...
         if (null != var15
            ...
            if (classVV.method12152(var12, (byte)-67) == var15) {
               ...
               if (var19.method12253((short)15505) && var19.method12258(-1340309653)) {
                  ...
                  int var24 = MouseHandler.MouseHandler_x * -38255113;
                  int var25 = MouseHandler.MouseHandler_y * -2144333897;
            ...
            if (!var15.field4275 || var33 < var35 && var34 < var36) {
               ...
               if (0 == -1510882375 * var15.field4375) {
                  ...
                  if (-1 == var15.field4260 * 63131743) {
                     InterfaceParent var39 = (InterfaceParent)var12.field6613.method13363(var15.field4329 * -1163656551);
                     if (null != var39) {
               ...
               if (var15.field4375 * -1510882375 != 1) {
                  if (-1510882375 * var15.field4375 == 3) {
                     ...
                     Font var46 = var15.method7199(var12, (byte)-76);
                     if (var46 != null) {
                        ...
                        if (var15.field4275 && var15.field4319 * 2073671441 != -1) {
                           ItemComposition var75 = classOB.method8299(2073671441 * var15.field4319, (byte)34);
                           var67 = ItemComposition.method8704(var75, 1248604557);
                           if (var67 == null) {
                     ...
                     if (!var15.field4275) {
                        SpritePixels var45 = var15.method7319(var12, var0.method5579(var15, (byte)-72), var0.field2634.vmethod78((byte)-67), -304707674);
                        if (null != var45) {
                           SpritePixels.method13511(var45, var16, var17);
                        }
                     } else {
                        SpritePixels var44;
                        ...
                        if (null != var44) {
                           ...
                           if (!var15.field4282) {
                              ...
                              if (var15.field4351 * 142218501 != 0) {
                                 ...
                                 SpritePixels.method13511(var44, var16, var17);
                              } else {
                              ...
                              for (int var84 = 0; var84 < var73; var84++) {
                                 for (int var87 = 0; var87 < var81; var87++) {
                                    if (0 != var15.field4351 * 142218501) {
                                       ...
                                       SpritePixels.method13523(var44, var84 * var56 + var16, var17 + var87 * var66, 256 - (var18 & 0xFF));
                                    } else {
                                       SpritePixels.method13511(var44, var84 * var56 + var16, var17 + var66 * var87);
                                    }
                                 }
                              }
                     ...
                     if (var12.method12112(131338097).method11932(var15, (byte)93)) {
                        Font var42 = var0.field2637.vmethod105(classXJ.field6878, -725461430);
                        int var53 = 0;
                        int var63 = 0;
                        Font var71 = var42;
                     ...
                     classLI var51 = Widget.method7285(var15, 565240322);
                     if (var40 != null && var51 != null && var40.method6998((byte)-29)) {
                        Font var61 = var15.method7199(var12, (byte)11);
                        if (null != var61) {
                           var0.field2640
                              .method5281(
                                 var16,
   ...
   @ObfuscatedName("br")
   static String callStackCombiner(int var0) {
   ...
   @ObfuscatedName("ab")
   void method5562(Widget var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var5, "gp.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;IILvv;B)V")
   @ObfuscatedName("ag")
   void method5565(Widget var1, int var2, int var3, classVV var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var7, "gp.ag(" + ')');
      }
   }
   ...
   void method5569(int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var8, "gp.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "([Llw;IIIILvv;I)V")
   @ObfuscatedName("bw")
   void method5587(Widget[] var1, int var2, int var3, int var4, int var5, classVV var6, int var7) {
      for (int var8 = var2; var8 <= var3; var8++) {
         Widget var9 = var1[var8];
         if (null != var9
            ...
            if (var9.field4375 * -1510882375 == 0) {
               ...
               if (var9.field4260 * 63131743 == -1) {
                  InterfaceParent var10 = (InterfaceParent)var6.field6613.method13363(-1163656551 * var9.field4329);
                  if (null != var10) {
            ...
            if (6 == -1510882375 * var9.field4375) {
               if (var9.field4288 * 2114568197 != -1 || 821151237 * var9.field4293 != -1) {
                  ...
                  if (-1 != var11) {
                     SequenceDefinition var12 = classQA.method9430(var11, -957838605);
   ...
   @ObfuscatedName("ac")
   String method5575(String var1, Widget var2, int var3) {
      try {
         if (var1.indexOf("%") != -1) {
            if (var3 <= 1719251183) {
               throw new IllegalStateException();
         ...
         throw classEG.newRunException(var8, "gp.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;B)Z")
   @ObfuscatedName("ao")
   boolean method5579(Widget var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var6, "gp.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("lf")
   public static void method5566(classGP var0, Widget var1, int var2, int var3, classVV var4) {
      if (var0 == null) {
   ...
   void method5584(int var1, classVV var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var5, "gp.al(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "([Llw;IIIILvv;IB)V")
   @ObfuscatedName("aj")
   void method5588(Widget[] var1, int var2, int var3, int var4, int var5, classVV var6, int var7, byte var8) {
      try {
               ...
               if (653784551 * var10.field4263 != var5) {
                  ...
                  if (var10.field4375 * -1510882375 == 0) {
                     ...
                     if (var10.field4260 * 63131743 == -1) {
                        ...
                        InterfaceParent var11 = (InterfaceParent)var6.field6613.method13363(-1163656551 * var10.field4329);
                        if (null != var11) {
                           if (var8 >= 1) {
                              throw new IllegalStateException();
                           }
                  ...
                  if (6 == -1510882375 * var10.field4375) {
                     ...
                     label215: {
                        ...
                        if (-1 != var12) {
                           ...
                           SequenceDefinition var13 = classQA.method9430(var12, 1650869054);
         ...
         throw classEG.newRunException(var15, "gp.aj(" + ')');
      }
   }
   ...
   @ObfuscatedName("vz")
   public static boolean method5580(classGP var0, Widget var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("aw")
   void method5557(
      Widget[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, classVV var12, int var13
   ) {
      classYW.method13671(var6, var7, var8, var9);
      classFH.method4740();
            ...
            if (!var15.field4275 || var33 < var35 && var34 < var36) {
               ...
               if (var15.field4375 * -1510882375 != 1) {
                  if (-1510882375 * var15.field4375 == 3) {
                     ...
                     Font var46 = var15.method7199(var12, (byte)-2);
                     if (var46 != null) {
                        String var67 = var15.field4301;
                        int var57;
                        ...
                        if (var15.field4275 && var15.field4319 * 2073671441 != -1) {
                           ItemComposition var75 = classOB.method8299(2073671441 * var15.field4319, (byte)35);
                           var67 = ItemComposition.method8704(var75, 1248604557);
                           if (var67 == null) {
                              var67 = classKK.field3615;
                           }
                     ...
                     if (!var15.field4275) {
                        SpritePixels var45 = var15.method7319(var12, this.method5579(var15, (byte)-6), this.field2634.vmethod78((byte)49), -1694061909);
                        if (null != var45) {
                           SpritePixels.method13511(var45, var16, var17);
                        }
                     } else {
                     ...
                     if (var12.method12112(2106647350).method11932(var15, (byte)28)) {
                        Font var42 = this.field2637.vmethod105(classXJ.field6878, -725461430);
                        int var53 = 0;
                        int var63 = 0;
                        Font var71 = var42;
                        String var27 = var15.field4301;
                     ...
                     classLI var51 = Widget.method7285(var15, 1825762370);
                     if (var40 != null && var51 != null && var40.method6998((byte)-117)) {
                        Font var61 = var15.method7199(var12, (byte)-96);
                        if (null != var61) {
                           this.field2640
                              .method5281(
                                 var16,
   ...
   @ObfuscatedSignature(descriptor = "(Llw;I)V")
   @ObfuscatedName("ak")
   void method5563(Widget var1, int var2) {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;I)V")
   @ObfuscatedName("at")
   void method5564(Widget var1, int var2) {
      int var3 = var1.field4334 * -90794217;
      if (var3 == 324) {
   ...
   @ObfuscatedName("am")
   void method5567(Widget var1, int var2, int var3, classVV var4) {
   ...
   public void method5551(int var1, int var2, classVV var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var7, "gp.az(" + ')');
      }
   }
         ...
         if (null != var15
            ...
            if (classVV.method12152(var12, (byte)-100) == var15) {
               ...
               if (var19.method12253((short)1981) && var19.method12258(-1996589236)) {
                  ...
                  int var24 = MouseHandler.MouseHandler_x * -38255113;
                  int var25 = MouseHandler.MouseHandler_y * -2044969658;
            ...
            if (!var15.field4275 || var33 < var35 && var34 < var36) {
               ...
               if (0 == 794003742 * var15.field4375) {
                  ...
                  if (-1 == var15.field4260 * 477675055) {
                     InterfaceParent var39 = (InterfaceParent)var12.field6613.method13363(var15.field4329 * -1288939967);
                     if (null != var39) {
               ...
               if (var15.field4375 * 487390321 != 1) {
                  if (1961620684 * var15.field4375 == 3) {
                     ...
                     Font var46 = var15.method7199(var12, (byte)-22);
                     if (var46 != null) {
                        String var67 = var15.field4301;
                        int var57;
                        ...
                        if (var15.field4275 && var15.field4319 * 2073671441 != -1) {
                           ItemComposition var75 = classOB.method8299(2073671441 * var15.field4319, (byte)55);
                           var67 = ItemComposition.method8704(var75, 1248604557);
                           if (var67 == null) {
                              var67 = classKK.field3615;
                           }
                     ...
                     if (!var15.field4275) {
                        SpritePixels var45 = var15.method7319(var12, this.method5579(var15, (byte)18), this.field2634.vmethod78((byte)-33), -704709251);
                        if (null != var45) {
                           SpritePixels.method13511(var45, var16, var17);
                        }
                     } else {
                              ...
                              for (int var84 = 0; var84 < var73; var84++) {
                                 for (int var87 = 0; var87 < var81; var87++) {
                                    if (0 != var15.field4351 * -1375669202) {
                                       ...
                                       SpritePixels.method13523(var44, var84 * var56 + var16, var17 + var87 * var66, 1964883830 - (var18 & 0xFF));
                                    } else {
                                       SpritePixels.method13511(var44, var84 * var56 + var16, var17 + var66 * var87);
                                    }
                                 }
                     ...
                     classLI var51 = Widget.method7285(var15, 1746716631);
                     if (var40 != null && var51 != null && var40.method6998((byte)-20)) {
                        Font var61 = var15.method7199(var12, (byte)65);
                        if (null != var61) {
                           this.field2640
                              .method5281(
                                 var16,
   ...
   @ObfuscatedName("zo")
   public static void method5589(classGP var0, Widget[] var1, int var2, int var3, int var4, int var5, classVV var6, int var7) {
      if (var0 == null) {
         ...
         if (null != var9
            ...
            if (6 == -1510882375 * var9.field4375) {
               if (var9.field4288 * 2114568197 != -1 || 821151237 * var9.field4293 != -1) {
                  ...
                  if (-1 != var11) {
                     SequenceDefinition var12 = classQA.method9430(var11, 1873479033);
                     if (!var12.method8768((byte)0)) {
                        var9.field4327 += 650277867 * var7;
   ...
   public void method5591(
      ...
      for (int var14 = var2; var14 <= var3; var14++) {
         ...
         if (var15 != null && var15.field4342 * -1502647899 == var4 && var15.field4263 * 653784551 == var5 && !var15.isSelfHidden()) {
            ...
            if (var15.getType() == 3
               && var16 == classOE.client.getViewportXOffset()
               && var17 == classOE.client.getViewportYOffset()
               && var15.getWidth() == classOE.client.getViewportWidth()
               && var15.getHeight() == classOE.client.getViewportHeight()
               && var15.getOpacity() > 0
               && var15.isFilled()
               && var15.method7368().method13274() == 0
               && classOE.client.isGpu()) {
   ...
   @ObfuscatedName("bg")
   boolean method5581(Widget var1) {
      if (null == var1.field4400) {
         return false;
      } else {
         for (int var2 = 0; var2 < var1.field4400.length; var2++) {
   ...
   @ObfuscatedSignature(descriptor = "(Llw;)Z")
   @ObfuscatedName("bk")
   boolean method5582(Widget var1) {
      if (null == var1.field4400) {
         return false;
      } else {
         for (int var2 = 0; var2 < var1.field4400.length; var2++) {
   ...
   @ObfuscatedSignature(descriptor = "(Lgp;Llw;)Z")
   @ObfuscatedName("jy")
   public static boolean method5583(classGP var0, Widget var1) {
      if (var0 == null) {
   ...
   public static void method5573(classGP var0, int var1, int var2, int var3, int var4, int var5, byte var6) {
      ...
      try {
         IndexedSprite[] var7 = var0.field2637.vmethod108(1569969832);
         IndexedSprite.method13810(var7[0], var1, var2);
         IndexedSprite.method13810(var7[1], var1, var4 + var2 - 16);
         ...
         throw classEG.newRunException(var10, "gp.ax(" + ')');
      }
   }
            ...
            if (!var15.field4275 || var33 < var35 && var34 < var36) {
               ...
               if (var15.field4375 * -1510882375 != 1) {
                  if (-1510882375 * var15.field4375 == 3) {
                     ...
                     Font var46 = var15.method7199(var12, (byte)-21);
                     if (var46 != null) {
                        String var67 = var15.field4301;
                        int var57;
                        ...
                        if (var15.field4275 && var15.field4319 * 2073671441 != -1) {
                           ItemComposition var75 = classOB.method8299(2073671441 * var15.field4319, (byte)-48);
                           var67 = ItemComposition.method8704(var75, 1248604557);
                           if (var67 == null) {
                              var67 = classKK.field3615;
                           }
                     ...
                     if (!var15.field4275) {
                        SpritePixels var45 = var15.method7319(var12, this.method5579(var15, (byte)119), this.field2634.vmethod78((byte)-12), -1357849894);
                        if (null != var45) {
                           SpritePixels.method13511(var45, var16, var17);
                        }
                     } else {
                     ...
                     classLI var51 = Widget.method7285(var15, 1887235301);
                     if (var40 != null && var51 != null && var40.method6998((byte)-107)) {
                        Font var61 = var15.method7199(var12, (byte)90);
                        if (null != var61) {
                           this.field2640
                              .method5281(
                                 var16,
   ...
   @ObfuscatedName("ae")
   void method5560(
      Widget[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, classVV var12, int var13, int var14
   ) {
      ...
      try {
               ...
               if (var16.field4275 && var12.method12119(var16, (byte)0)) {
                  ...
                  if (classVV.method12152(var12, (byte)-105) == var16) {
                     ...
                     if (var20.method12253((short)1693)) {
                        ...
                        if (var20.method12258(-1223649978)) {
                           ...
                           int var25 = MouseHandler.MouseHandler_x * -38255113;
                           int var26 = MouseHandler.MouseHandler_y * -2144333897;
                  ...
                  if (0 == -1510882375 * var16.field4375) {
                     ...
                     if (-1 == var16.field4260 * 63131743) {
                        ...
                        InterfaceParent var41 = (InterfaceParent)var12.field6613.method13363(var16.field4329 * -1163656551);
                        if (null != var41) {
                           if (var14 != 1690058415) {
                              throw new IllegalStateException();
                           }
                  ...
                  if (var16.field4375 * -1510882375 == 1) {
                     ...
                     Font var48 = var16.method7199(var12, (byte)20);
                     if (var48 == null) {
                        if (var14 != 1690058415) {
                           throw new IllegalStateException();
                        }
                        ...
                        if (var16.field4275) {
                           ...
                           if (var16.field4319 * 2073671441 != -1) {
                              ...
                              ItemComposition var77 = classOB.method8299(2073671441 * var16.field4319, (byte)-66);
                              var69 = ItemComposition.method8704(var77, 1248604557);
                              if (var69 == null) {
                                 if (var14 != 1690058415) {
                                    this.method5592(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13);
                                    return;
                     ...
                     if (!var16.field4275) {
                        ...
                        SpritePixels var47 = var16.method7319(var12, this.method5579(var16, (byte)-76), this.field2634.vmethod78((byte)-1), 1522102538);
                        if (null != var47) {
                           SpritePixels.method13511(var47, var17, var18);
                        }
                     } else {
                        SpritePixels var46;
                              ...
                              if (var16.field4351 * 142218501 != 0) {
                                 ...
                                 if (var58 == var16.field4249 * 1115597881) {
                                    ...
                                    if (293773697 * var16.field4259 == var68) {
                                       SpritePixels.method13511(var46, var17, var18);
                                       continue;
                                    }
                                 }
                              ...
                              for (int var86 = 0; var86 < var75; var86++) {
                                 ...
                                 for (int var89 = 0; var89 < var83; var89++) {
                                    ...
                                    if (0 != var16.field4351 * 142218501) {
                                       ...
                                       SpritePixels.method13523(var46, var86 * var58 + var17, var18 + var89 * var68, 256 - (var19 & 0xFF));
                                    } else {
                                       SpritePixels.method13511(var46, var86 * var58 + var17, var18 + var68 * var89);
                                    }
                                 }
                              }
                     ...
                     if (var12.method12112(2061692895).method11932(var16, (byte)11)) {
                        ...
                        Font var44 = this.field2637.vmethod105(classXJ.field6878, -725461430);
                        int var55 = 0;
                        int var65 = 0;
                        Font var73 = var44;
                     ...
                     classLI var53 = Widget.method7285(var16, 810441855);
                     if (var42 != null) {
                        if (var14 != 1690058415) {
                           this.method5592(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13);
                           return;
                        ...
                        if (var53 != null) {
                           ...
                           if (var42.method6998((byte)-102)) {
                              ...
                              Font var63 = var16.method7199(var12, (byte)-37);
                              if (null != var63) {
                                 if (var14 != 1690058415) {
                                    throw new IllegalStateException();
                                 }
         ...
         throw classEG.newRunException(var34, "gp.ae(" + ')');
      }
   }
   ...
   public static void method5546(int var0, int var1, int var2) {
      try {
         ...
         int var7;
         label29: {
            VarbitComposition var3 = classOL.method8510(var0, (short)-2595);
         ...
         throw classEG.newRunException(var8, "gp.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("wh")
   public static String method5576(classGP var0, String var1, Widget var2) {
      if (var0 == null) {
   ...
   static SecureRandom method5547(byte var0) {
      try {
         ...
         throw classEG.newRunException(var2, "gp.ae(" + ')');
      }
   }
   ...
   public static void method5553(classGP var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, classVV var8, int var9, int var10) {
      ...
      try {
         ...
         throw classEG.newRunException(var11, "gp.af(" + ')');
      }
   }
   ...
   public static int method5548(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gp.af(" + 41);
      }
   }
   ...
   public void method5592(
      ...
      Callbacks var14 = classOE.client.getCallbacks();
      ...
      for (int var17 = var2; var17 <= var3; var17++) {
         ...
         if (var18 != null && var18.field4342 * -1502647899 == var4 && var18.field4263 * 653784551 == var5 && !var18.isSelfHidden()) {
            ...
            if (var19 == 5 && var18.getItemId() != -1 && var18.getItemId() != 6512) {
               ...
               if (var18 == classOE.client.method2333() && var15.field6626 && var15.field6621) {
                  int var21 = MouseHandler.MouseHandler_x * -38255113;
                  int var22 = MouseHandler.MouseHandler_y * -2144333897;
      ...
      if (var4 == -1412584499) {
         ...
         Widget var26 = classOE.client.method2295(var4);
         net.runelite.api.widgets.Widget[] var29 = var26.getChildren();
         ...
         for (int var31 = field2644.size() - 1; var31 >= 0; var31--) {
            net.runelite.api.widgets.Widget var34 = (net.runelite.api.widgets.Widget)field2644.get(var31);
   ...
   @ObfuscatedName("ar")
   static int method5590(int var0, Script var1, boolean var2, int var3) {
      try {
         Widget var4;
         if (var0 >= 2000) {
            if (var3 != 1839316601) {
            ...
            var0 -= 1000;
            var4 = classLY.method7375(classWK.field6691, classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], (byte)96);
         } else {
            Widget var10000;
            if (var2) {
               if (var3 != 1839316601) {
         ...
         if (!var5.isEmpty()) {
            ...
            if (var5.charAt(var5.length() - 1) == 'Y') {
               ...
               if (var7 > 0) {
                  ...
                  while (var7-- > 0) {
                     var6[var7] = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
                  }
               }
         ...
         for (int var8 = var11.length - 1; var8 >= 1; var8--) {
            switch (var5.charAt(var8 - 1)) {
               ...
               case 'Ï':
                  ...
                  break;
               default:
                  var11[var8] = new Integer(classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371]);
            }
         }
         ...
         throw classEG.newRunException(var10, "gp.ar(" + 41);
      }
   }
   ...
   void method5574(int var1, int var2, int var3, int var4, int var5, byte var6) {
      try {
         IndexedSprite[] var7 = this.field2637.vmethod108(1569969832);
         IndexedSprite.method13810(var7[0], var1, var2);
         IndexedSprite.method13810(var7[1], var1, var4 + var2 - 16);
