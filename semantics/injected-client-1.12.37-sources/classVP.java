...
public class classVP extends AbstractArchive {
   ...
   public int method12044(int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "vp.ay(" + 41);
      }
   }
   ...
   void vmethod610(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var10, "vp.ab(" + ')');
      }
   }
   ...
   void method12026(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "vp.ag(" + ')');
      }
   }
   ...
   public static void method12021(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "vp.af(" + ')');
      }
   }
   ...
   public int method12017(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "vp.af(" + 41);
      }
   }
   ...
   void method12033(int var1, byte[] var2, boolean var3, boolean var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var18, "vp.ax(" + ')');
      }
   }
   ...
   public int method12038(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "vp.ao(" + 41);
      }
   }
   ...
   public boolean method12040(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "vp.al(" + ')');
      }
   }
   ...
   public static void method12022(classVP var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "vp.ae(" + ')');
      }
   }
   ...
   public static boolean method12014(classVP var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "vp.az(" + ')');
         }
      }
   }
   ...
   void method12028(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var12, "vp.as(" + ')');
      }
   }
      ...
      if (var1 == this.field6541) {
         if (-1741645360 * this.field6539 == 1) {
            ...
            if (var9 != this.field6548 * -628655536) {
               ...
               Buffer var10 = new Buffer(classMD.method7538(var3, (byte)113));
               int var7 = Buffer.method13039(var10, -346779531);
               if (var7 < 5 || var7 > 7) {
      ...
      if (var1 == this.field6541) {
         ...
         if (var3 == null) {
            ...
            if (var6 != this.field6548 * 1694139451) {
               ...
               Buffer var16 = new Buffer(method12052(var3));
   ...
   public static void method12036(classVP var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var11, "vp.aa(" + ')');
         }
      }
   }
   ...
   public boolean method12042(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "vp.aj(" + ')');
      }
   }
