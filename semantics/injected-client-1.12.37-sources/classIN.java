...
public class classIN extends classHB {
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         this.field2999 = Buffer.method13047(var1, -160289159) * -536329785;
         this.field3003 = var1.method13056((byte)1) * -554661077;
         this.field3002 = Buffer.method13039(var1, -346779531) * -1077362017;
         this.field3000 = Buffer.method13039(var1, -346779531) * -423990687;
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "in.az(" + ')');
      }
   }
   ...
   void vmethod500(Buffer var1) {
      this.field2999 = Buffer.method13047(var1, -1529115716) * -1405253871;
   ...
   void vmethod501(Buffer var1) {
      this.field2999 = Buffer.method13047(var1, 1459142177) * -536329785;
      this.field3003 = var1.method13056((byte)1) * -2115098002;
      this.field3002 = Buffer.method13039(var1, -346779531) * -1077362017;
      this.field3000 = Buffer.method13039(var1, -346779531) * -305578291;
   }
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "in.af(" + ')');
      }
   }
   ...
   static final int method6229(int var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var6, "in.au(" + 41);
      }
   }
   ...
   static boolean method6226(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "in.af(" + ')');
      }
   }
}
