...
public class ClanChannel extends Node implements net.runelite.api.clan.ClanChannel {
   ...
   void method6187(Buffer var1) {
      ...
      this.field2950 = Buffer.method13043(var1, (byte)17);
      this.field2949 = Buffer.method13043(var1, (byte)17);
      int var4 = Buffer.method13047(var1, 1175331380);
      if (var4 > 0) {
         ...
         for (int var5 = 0; var5 < var4; var5++) {
            ...
            var6.field2841 = Buffer.method13043(var1, (byte)17);
            var6.field2842 = Buffer.method13047(var1, 50340404) * 180057721;
            if (var3 >= 3) {
   ...
   void method6179(int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "ie.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;B)V")
   @ObfuscatedName("as")
   void method6188(Buffer var1, byte var2) {
      try {
         ...
         this.field2950 = Buffer.method13043(var1, (byte)17);
         this.field2949 = Buffer.method13043(var1, (byte)17);
         int var5 = Buffer.method13047(var1, -1748913958);
         if (var5 > 0) {
            if (var2 >= 1) {
               throw new IllegalStateException();
            }
            ...
            for (int var6 = 0; var6 < var5; var6++) {
               ...
               var7.field2841 = Buffer.method13043(var1, (byte)17);
               var7.field2842 = Buffer.method13047(var1, -1944776342) * 179951339;
               if (var4 >= 3) {
         ...
         throw classEG.newRunException(var8, "ie.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("bk")
   public static void method6189(ClanChannel var0, Buffer var1) {
      if (var0 == null) {
      ...
      var0.field2950 = Buffer.method13043(var1, (byte)17);
      var0.field2949 = Buffer.method13043(var1, (byte)17);
      int var4 = Buffer.method13047(var1, 1660861027);
      if (var4 > 0) {
         ...
         for (int var5 = 0; var5 < var4; var5++) {
            ...
            var6.field2841 = Buffer.method13043(var1, (byte)17);
            var6.field2842 = Buffer.method13047(var1, -248176967) * 179951339;
            if (var3 >= 3) {
   ...
   public static int[] method6169(ClanChannel var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "ie.az(" + ')');
      }
   }
   ...
   public void method6194(ClanChannelMember var1) {
      classOE.client.getCallbacks().post(new ClanMemberJoined(this, var1));
   }
   ...
   void method6190(Buffer var1) {
      ...
      this.field2950 = Buffer.method13043(var1, (byte)17);
      this.field2949 = Buffer.method13043(var1, (byte)17);
      int var4 = Buffer.method13047(var1, -1127139805);
      if (var4 > 0) {
         this.field2955 = new ArrayList(var4);
         ...
         for (int var5 = 0; var5 < var4; var5++) {
            ...
            var6.field2841 = Buffer.method13043(var1, (byte)17);
            var6.field2842 = Buffer.method13047(var1, 1255418010) * 179951339;
            if (var3 >= 3) {
   ...
   void method6177(ClanChannelMember var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ie.af(" + ')');
      }
   }
   ...
   public void method6192(int var1) {
      ...
      classOE.client.getCallbacks().post(new ClanMemberLeft(this, var3));
   }
   ...
   public int method6186(String var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var4, "ie.ag(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("aw")
   void method6191(Buffer var1) {
      int var2 = Buffer.method13039(var1, -346779531);
      if (0 != (var2 & 1)) {
         this.field2956 = true;
      }
      ...
      this.field2950 = Buffer.method13043(var1, (byte)17);
      this.field2949 = Buffer.method13043(var1, (byte)17);
      int var4 = Buffer.method13047(var1, -296460857);
      if (var4 > 0) {
         this.field2955 = new ArrayList(var4);
         ...
         for (int var5 = 0; var5 < var4; var5++) {
            ...
            var6.field2841 = Buffer.method13043(var1, (byte)17);
            var6.field2842 = Buffer.method13047(var1, 829984968) * 179951339;
            if (var3 >= 3) {
   ...
   static void method6193(byte var0) {
      try {
         ...
         throw classEG.newRunException(var3, "ie.ep(" + ')');
      }
   }
   ...
   public static int method6183(ClanChannel var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "ie.ab(" + 41);
      }
   }
