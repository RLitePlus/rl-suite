...
public class classAAE implements Comparable {
   ...
   public String method166(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "aae.af(" + ')');
      }
   }
   ...
   public boolean method171(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "aae.ab(" + ')');
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var3, "aae.equals(" + ')');
      }
   }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "aae.toString(" + ')');
      }
   }
   ...
   public int hashCode() {
      try {
         ...
         throw classEG.newRunException(var1, "aae.hashCode(" + 41);
      }
   }
   ...
   public int compareTo(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "aae.compareTo(" + 41);
      }
   }
   ...
   public String method164(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "aae.az(" + ')');
      }
   }
   ...
   public static int method182(classAAE var0, classAAE var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "aae.ag(" + 41);
         }
      }
   }
