...
public class Friend extends Buddy implements net.runelite.api.Friend {
   ...
   public int vmethod565(Object var1) {
      return this.method10152((Friend)var1, 2138014830);
   }

   @ObfuscatedSignature(descriptor = "(Lrp;)I")
   @ObfuscatedName("ab")
   int method10150(Friend var1) {
   ...
   public int vmethod562(User var1, int var2) {
      try {
         return this.method10152((Friend)var1, 703801405);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "rp.aw(" + 41);
      }
   }
   ...
   public int compareTo(Object var1) {
      try {
         return this.method10152((Friend)var1, 346933967);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "rp.compareTo(" + 41);
      }
   }
   ...
   public int vmethod563(User var1) {
      return this.method10152((Friend)var1, -430446394);
   }
   ...
   @ObfuscatedName("cl")
   static int method10154(int var0, Script var1, boolean var2, byte var3) {
      try {
         if (var0 == 7500) {
            if (var3 >= 16) {
               ...
               int var36 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               ...
               if (null == var39) {
                  ...
                  int var42 = FloatProjection.method3895(var36, 685397891);
                  ...
                  if (null != classAB.field125) {
                     ...
                     if (var0 == 7500) {
                        ...
                        classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classAB.field125.size();
                     }
                  } else {
            ...
            if (var3 >= 16) {
               ...
               if (null != classCH.field741) {
                  ...
                  if (classCH.field741.hasNext()) {
                     ...
                     classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = (Integer)classCH.field741.next();
                     return 1;
                  }
               }
            ...
            if (var3 >= 16) {
               ...
               int var31 = classBB.field323[1 + -324749371 * DynamicObject.field1679];
               int var35 = classBB.field323[2 + -324749371 * DynamicObject.field1679];
               int var38 = classSA.method10354(var31, -348025329);
               int var41 = classKT.method6561(var31, (byte)123);
               int var44 = FloatProjection.method3895(var31, 1396095709);
               ...
               if (-1 == var25) {
                  for (int var48 = var47; var48 < var13; var48++) {
                     ...
                     classYY var49 = FriendsList.method10130(var46[var48], -53215312);
                     if (var49 == classYY.field7113) {
                        ...
                        classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classTM.method10934(var46[var48], -973324355);
                     }
                  }

                  return 1;
               } else {
                  DbRowType var14 = classFA.method4532(var25, (byte)-94);
                  if (var44 >= 0) {
                     if (var3 >= 16) {
                        throw new IllegalStateException();
                     }
                  ...
                  if (var15 == null) {
                     if (var3 >= 16) {
                        ...
                        for (int var50 = var47; var50 < var13; var50++) {
                           ...
                           classYY var52 = FriendsList.method10130(var51, 1431840310);
                           if (var52 == classYY.field7113) {
                              classBB.field328[(classBB.field338 += 1222866659) * 1375698635 - 1] = "";
                           } else {
                              classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classTM.method10934(var51, -973324355);
                           }
                        }
                     ...
                     if (var35 >= 0) {
                        ...
                        if (var35 < var16) {
                           for (int var17 = var47; var17 < var13; var17++) {
                              ...
                              classYY var19 = FriendsList.method10130(var46[var17], 1728636977);
                              if (classYY.field7113 == var19) {
                                 ...
                                 classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = (Integer)var15[var18];
                              }
                           }
            ...
            if (var3 >= 16) {
               ...
               int var30 = classBB.field323[1 + -324749371 * DynamicObject.field1679];
               int var34 = 0;
               int var37 = classSA.method10354(var30, -596418410);
               int var40 = classKT.method6561(var30, (byte)82);
               DbRowType var43 = classFA.method4532(var24, (byte)48);
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var34;
               return 1;
            }
         } else if (7504 == var0) {
            if (var3 >= 16) {
               ...
               int var23 = classBB.field323[-324749371 * DynamicObject.field1679];
               ...
               if (null == var29) {
                  ...
                  if (7504 == var0) {
                     ...
                     classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var33;
                  }
            ...
            DbRowType var28 = classFA.method4532(var22, (byte)-55);
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var28.field7173 * 1026569721;
            return 1;
         } else if (7506 == var0) {
            if (var3 >= 16) {
               throw new IllegalStateException();
            ...
            if (var3 >= 16) {
               ...
               if (null == var7) {
                  ...
                  int var8 = FloatProjection.method3895(var6, 891239732);
         ...
         throw classEG.newRunException(var20, "rp.cl(" + 41);
      }
   }
   ...
   public int vmethod564(User var1) {
      return this.method10152((Friend)var1, 1324484102);
   }

   @ObfuscatedSignature(descriptor = "(Lrp;I)I")
   @ObfuscatedName("az")
   int method10152(Friend var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "rp.az(" + 41);
      }
   }
   ...
   static final int method10155(String var0, String var1, int var2, int var3, int var4, int var5, int var6, boolean var7, int var8, int var9) {
      try {
         if (client.field973) {
            ...
            return client.menu.method12683(var0, var1, var2, var3, var4, var5, var6, var7, var8, -1354756541);
         }
      } catch (RuntimeException var10) {
         throw classEG.newRunException(var10, "rp.fb(" + 41);
      }
   }
   ...
   public static final void method10149(long var0) {
      try {
         ...
         throw classEG.newRunException(var8, "rp.az(" + ')');
      }
   }
}
