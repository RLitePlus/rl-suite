...
public class classST {
   ...
   @ObfuscatedName("yy")
   public static void method10641(Message var0) {
      if (var0 == null) {
         var0.method1478();
      }
      ...
      if (null == var0 || var0.method10685((byte)-126) == 0) {
         ...
         if (var1 > var0.field6068[var0.method10685((byte)-40) - 1].field6103 * 1210377865) {
            return classSE.field5911 == var0.field6062
               ...
               : NpcOverrides.method9087(var0, var1, false, (byte)1);
            ...
            if (null == var2) {
               ...
               if (0.0F == var2.field6098 && var2.field6100 == 0.0F) {
                  ...
                  if (var0.field6045) {
                     ...
                     if (var0.field6064) {
                        Projectile.method1220(var0, var5, var6, var7, var8, var9, var10, var11, var12, (byte)-110);
                     } else if (var0 != null) {
                        var0.field6057 = var5;
         ...
         return var0.field6063 == classSE.field5911 ? var0.field6068[0].field6102 : NpcOverrides.method9087(var0, var1, true, (byte)1);
      }
   }
   ...
   static void method10645(classSU var0, float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8) {
      if (null != var0) {
         ...
         if (var9 != 0.0F) {
            ...
            var0.field6057 = var1;
            var0.field6048 = var4;
            Script.method1147(0.0F, var12[0], var12[1], 1.0F, var0, 2105431674);
            float var15 = var6 - var5;
            ...
            if (null == var2) {
               ...
               if (0.0F == var2.field6098 && var2.field6100 == 0.0F) {
                  ...
                  if (var0.field6045) {
                     ...
                     float var11 = var12 - 0.33333334F * var2.field6104.field6099;
                     if (var0.field6064) {
                        Projectile.method1220(var0, var5, var6, var7, var8, var9, var10, var11, var12, (byte)-103);
                     } else if (var0 != null) {
                        var0.field6057 = var5;
                        float var13 = var8 - var5;
                        float var14 = var12 - var9;
