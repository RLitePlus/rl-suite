...
public class classSA implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sa.az(" + 41);
      }
   }
   ...
   public static long method10355(long var0, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var7, "sa.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(B)Lym;")
   @ObfuscatedName("aa")
   static SpritePixels method10357(byte var0) {
      try {
         ...
         throw classEG.newRunException(var5, "sa.aa(" + ')');
      }
   }
