...
public class classHQ implements classGE {
   ...
   @ObfuscatedName("az")
   public static PlayerCompositionColorTextureOverride method6093(int var0, Buffer var1, byte var2) {
      try {
         ...
         PlayerCompositionColorTextureOverride var8 = new PlayerCompositionColorTextureOverride(var0);
         if (var4) {
            int[] var10;
            label154: {
            ...
            for (int var12 = 0; var12 < 2; var12++) {
               ...
               if (15 != var10[var12]) {
                  ...
                  short var13 = (short)Buffer.method13047(var1, -2092843255);
                  if (var11) {
         ...
         if (var5) {
            ...
            for (int var18 = 0; var18 < 2; var18++) {
               ...
               if (15 != var16[var18]) {
                  ...
                  short var19 = (short)Buffer.method13047(var1, -1898895509);
                  if (var17) {
                     if (var2 <= 2) {
                        throw new IllegalStateException();
                     }
         ...
         throw classEG.newRunException(var14, "hq.az(" + ')');
      }
   }
   ...
   public classOW vmethod463(int var1, byte var2) {
      try {
         ...
         if (var4 != null) {
            ...
            var4 = new classOW(new Buffer(var5), var1);
         ...
         throw classEG.newRunException(var6, "hq.az(" + ')');
      }
   }
   ...
   public classOW vmethod464(int var1) {
      ...
      if (var3 != null) {
         ...
         var3 = new classOW(new Buffer(var4), var1);
