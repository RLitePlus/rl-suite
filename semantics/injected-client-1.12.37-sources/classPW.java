...
public class classPW extends classVJ {
   ...
   @ObfuscatedName("bn")
   public static EvictingDualNodeHashTable field5447 = new EvictingDualNodeHashTable(20);
   @ObfuscatedName("bx")
   final int field5451;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ah")
   public static EvictingDualNodeHashTable field5446 = new EvictingDualNodeHashTable(64);
   @ObfuscatedName("bc")
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("am")
   public static EvictingDualNodeHashTable field5445 = new EvictingDualNodeHashTable(64);
   @ObfuscatedName("bk")
   ...
   @ObfuscatedName("ax")
   public SpritePixels method9346(int var1) {
      try {
         if (1306359125 * this.field5457 < 0) {
            ...
            SpritePixels var2 = (SpritePixels)field5446.method6422(1306359125 * this.field5457);
            if (var2 != null) {
               if (var1 != 1009762333) {
                  throw new IllegalStateException();
               } else {
         ...
         throw classEG.newRunException(var3, "pw.ax(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Lym;")
   @ObfuscatedName("ag")
   public SpritePixels method9339(int var1) {
      try {
         if (this.field5450 * 1638332811 < 0) {
            ...
            SpritePixels var2 = (SpritePixels)field5446.method6422(1638332811 * this.field5450);
            if (null != var2) {
               if (var1 != -528056669) {
                  throw new IllegalStateException();
               } else {
         ...
         throw classEG.newRunException(var3, "pw.ag(" + ')');
      }
   }
         ...
         try {
            ...
            if (-1 != var3) {
               if (var1 == 2) {
                  ...
                  return PacketWriter.method3373(var3, (byte)65);
               }
            } else {
               return null;
            }
         } catch (RuntimeException var4) {
            throw classEG.newRunException(var4, "pw.ae(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("wc")
   public static boolean method9326(Message var0) {
   ...
   @ObfuscatedName("wd")
   public static boolean method9330(classVV var0, Widget var1) {
      return var0.field6617 == var1;
   }

   @ObfuscatedSignature(descriptor = "(I)Lym;")
   @ObfuscatedName("as")
   public SpritePixels method9342(int var1) {
      try {
         if (this.field5452 * -277141139 < 0) {
            ...
            SpritePixels var2 = (SpritePixels)field5446.method6422(-277141139 * this.field5452);
            if (null != var2) {
               return var2;
            } else {
         ...
         throw classEG.newRunException(var3, "pw.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("aa")
   public Font method9354(int var1) {
      try {
         if (-1 == this.field5451 * 1230047715) {
            ...
            Font var2 = (Font)field5447.method6422(1230047715 * this.field5451);
            if (null != var2) {
               if (var1 <= 120041229) {
                  throw new IllegalStateException();
               } else {
               ...
               AbstractArchive var4 = classWN.field6758;
               AbstractArchive var5 = classEN.field1803;
         ...
         throw classEG.newRunException(var10, "pw.aa(" + ')');
      }
   }
         ...
         while (true) {
            ...
            switch (var18) {
               case 0:
                  break label101;
               case 1:
                  var2 = Buffer.method13110(var1, -324749371);
                  continue;
               case 2:
                  var3 = var1.method13051(-758448158);
                  continue;
               case 3:
                  var5 = Buffer.method13110(var1, -324749371);
                  continue;
               case 4:
                  var7 = Buffer.method13110(var1, -324749371);
                  continue;
               case 5:
                  var6 = Buffer.method13110(var1, -324749371);
                  continue;
               case 6:
               ...
               case 8:
                  ...
                  continue;
               case 9:
                  var4 = Buffer.method13047(var1, -2069316888);
                  continue;
               case 10:
               ...
               case 13:
                  ...
                  continue;
               case 14:
                  var11 = Buffer.method13047(var1, -1497535228);
               case 15:
               case 16:
               default:
                  continue;
            ...
            var16 = Buffer.method13047(var1, -1302817445);
            if (65535 == var16) {
               var16 = -1;
            }

            var17 = Buffer.method13047(var1, 567738210);
            if (var17 == 65535) {
               var17 = -1;
            }
            ...
            int var19 = -1;
            if (var18 == 18) {
               var19 = Buffer.method13047(var1, -651351931);
               if (var19 == 65535) {
                  var19 = -1;
               }
            }

            int var20 = Buffer.method13039(var1, -346779531);
            var15 = new int[2 + var20];

            for (int var21 = 0; var21 <= var20; var21++) {
               var15[var21] = Buffer.method13047(var1, 1875731730);
   ...
   @ObfuscatedName("ao")
   public static void method9327(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2) {
      classES.field1904 = var0;
      classWN.field6758 = var1;
      classEN.field1803 = var2;
      PlatformInfo var10000 = classEB.field1727;
      classEB.field1727.field6576 = (Arrays.hashCode(classOE.client.field1117.getClass().getSigners()) >> 2) * 721999872
         + -1694189056
   ...
   @ObfuscatedName("aw")
   public SpritePixels method9340() {
      if (this.field5450 * 1638332811 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(1638332811 * this.field5450);
         if (null != var1) {
            return var1;
         } else {
   ...
   public static classPW method9329(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classPW(new Buffer(var2));
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("ak")
   public SpritePixels method9350() {
      if (-1889986885 * this.field5456 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(-1889986885 * this.field5456);
         if (null != var1) {
            return var1;
         } else {
   ...
   public final classPW method9332() {
      ...
      return -1 != var2 ? PacketWriter.method3373(var2, (byte)27) : null;
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;Lva;Lva;)V")
   @ObfuscatedName("al")
   public static void method9328(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2) {
      classES.field1904 = var0;
      classWN.field6758 = var1;
      classEN.field1803 = var2;
      PlatformInfo var10000 = classEB.field1727;
   ...
   @ObfuscatedName("cz")
   public static SpritePixels method9351(classPW var0, int var1) {
      if (var0 == null) {
      ...
      try {
         if (-1889986885 * var0.field5456 < 0) {
            ...
            SpritePixels var2 = (SpritePixels)field5446.method6422(-1889986885 * var0.field5456);
            if (null != var2) {
               return var2;
            } else {
         ...
         throw classEG.newRunException(var3, "pw.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("vm")
   public static SpritePixels method9341(classPW var0) {
      if (var0.field5450 * 488349178 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(1721302582 * var0.field5450);
         if (null != var1) {
            return var1;
         } else {
   ...
   public static classUQ method9325(int var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var8, "pw.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("ar")
   public SpritePixels method9343() {
      if (this.field5452 * 1645401236 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(-1195306926 * this.field5452);
         if (null != var1) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("an")
   public SpritePixels method9344() {
      if (this.field5452 * -277141139 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(-277141139 * this.field5452);
         if (null != var1) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("am")
   public SpritePixels method9347() {
      if (1306359125 * this.field5457 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(1306359125 * this.field5457);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("bn")
   public SpritePixels method9352() {
      if (-1889986885 * this.field5456 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(-1889986885 * this.field5456);
   ...
   public static String method9336(classPW var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "pw.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("bx")
   public Font method9355() {
      if (-1 == this.field5451 * 1230047715) {
         return null;
      } else {
         Font var1 = (Font)field5447.method6422(1230047715 * this.field5451);
         if (null != var1) {
            return var1;
         } else {
            AbstractArchive var3 = classWN.field6758;
            AbstractArchive var4 = classEN.field1803;
            ...
            if (!classHK.method6068(var3, var5, 0, (byte)-48)) {
               ...
               if (var7 == null) {
                  ...
                  Font var8 = new Font(var7, classYL.field7002, classYL.field7003, classPO.field5371, classGG.field2578, classRB.field5639, classYL.field7004);
      ...
      try {
         ...
         while (var1.hasNext()) {
            ...
            for (int var3 = 0; var3 < client.field837.field1419 * -2087374717; var3++) {
               Player var4 = (Player)var2.field1694.method13404(client.field837.field1423[var3]);
               if (null != var4) {
                  if (var0 == 1055994673) {
                     throw new IllegalStateException();
                  }
         ...
         throw classEG.newRunException(var5, "pw.gc(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Lym;")
   @ObfuscatedName("av")
   public SpritePixels method9345() {
   ...
   @ObfuscatedSignature(descriptor = "(Lpw;)Lym;")
   @ObfuscatedName("ce")
   public static SpritePixels method9348(classPW var0) {
      if (-269152068 * var0.field5457 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(-1968104432 * var0.field5457);
         if (var1 != null) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "(Lpw;)Lym;")
   @ObfuscatedName("zr")
   public static SpritePixels method9353(classPW var0) {
      if (-1889986885 * var0.field5456 < 0) {
         return null;
      } else {
         SpritePixels var1 = (SpritePixels)field5446.method6422(-1889986885 * var0.field5456);
         if (null != var1) {
            return var1;
         } else {
   ...
   @ObfuscatedSignature(descriptor = "(I)Lym;")
   @ObfuscatedName("ac")
   public SpritePixels method9349(int var1) {
      try {
         if (1306359125 * this.field5450 < 0) {
            ...
            SpritePixels var2 = (SpritePixels)field5445.method6444(1306359125 * this.field5450);
            if (var2 != null) {
               if (var1 != 1009762333) {
                  throw new IllegalStateException();
               } else {
