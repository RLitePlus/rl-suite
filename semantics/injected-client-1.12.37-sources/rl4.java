...
public class rl4 implements Runnable {
   ...
   public classOW method10100(int var1) {
      ...
      if (var2 != null) {
         ...
         return new classOW(new Buffer(var4), var1);
      }
   }
   ...
   @ObfuscatedName("cl")
   public void method10085(Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7) {
   ...
   public classPH method10098(int var1) {
      ...
      if (var2 != null) {
         ...
         var2 = new classPH(new Buffer(var4));
      ...
      if (var2 > 0) {
         ...
         if (!var27) {
            ...
            if (!this.field5771.isTopLevel()) {
               ...
               classOE.client.getCallbacks().post(new PreMapLoad(this.field5771, this.field5790));
               if (this.field5759 != null) {
