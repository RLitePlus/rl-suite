...
public class classDU implements Callable {
   ...
   public static int method3604(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var8, "du.az(" + 41);
      }
   }
   ...
   public Object call() {
      try {
         ...
         throw classEG.newRunException(var1, "du.call(" + ')');
      }
   }
   ...
   protected static final int method3609(byte var0) {
      try {
         return GameEngine.field6198.method10816(1732339090);
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "du.afp(" + 41);
      }
   }
   ...
   @ObfuscatedName("lp")
   public static OutputStream method3610(SecureRandomSSLSocket var0) throws IOException {
