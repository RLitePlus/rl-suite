...
public class classBD {
   ...
   boolean method979(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bd.af(" + ')');
      }
   }
      ...
      try {
         if (var0 == null) {
            ...
            switch (-900901303 * var0.field7107) {
               case 2:
                  classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = (Integer)var1;
                  break;
               case 3:
         ...
         throw classEG.newRunException(var3, "bd.cf(" + ')');
      }
   }
   ...
   public static SecureRandom method983(classBD var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "bd.ae(" + ')');
      }
   }
   ...
   static void method989(byte var0) {
      try {
         client.mouseLastPressedTimeMillis = 9147219051952896537L;
         if (null != NpcOverrides.field5380) {
            if (var0 <= 126) {
               throw new IllegalStateException();
            }

            NpcOverrides.field5380.field1538 = 0;
         }

         classDD.field1405 = true;
         client.field835 = true;
         client.field923 = -4495327398113701859L;
         classZJ.field7189 = new IterableNodeDeque();
         PacketWriter.method3360(client.packetWriter, -720419209);
         client.packetWriter.field1529 = 0;
         client.packetWriter.serverPacketBuffer.offset = 0;
         client.packetWriter.serverPacket = null;
         client.packetWriter.field1533 = null;
         client.packetWriter.field1532 = null;
         client.packetWriter.field1531 = null;
         client.packetWriter.serverPacketLength = 0;
         client.packetWriter.field1524 = 0;
         client.field939 = 0;
         client.field880 = "";
         client.field820 = 0;
         client.field941.method6521((byte)-40);
         AABB.method4919(-1512642514);
         MouseHandler.MouseHandler_idleCycles = 0;
         client.method1863(-1);
         classMD.method7534((byte)121);
         client.field945 = 0;
         client.field979 = false;
         GraphicsObject.field475.method10495(-1824285602);
         ...
         for (InterfaceParent var1 = (InterfaceParent)classWK.field6691.field6613.method13375();
            null != var1;
            var1 = (InterfaceParent)IndexedObjectSet.method13401(classWK.field6691.field6613)
         ) {
            if (var0 <= 126) {
               throw new IllegalStateException();
            }
         ...
         if (client.packetWriter != null) {
            ...
            if (client.packetWriter.isaacCipher == null) {
               ...
               PacketBufferNode var4 = classEF.getPacketBufferNode(ClientPacket.WINDOW_STATUS, client.packetWriter.isaacCipher, (byte)22);
               Buffer.method12971(var4.packetBuffer, classLH.method7105(1904094042), (byte)-55);
               var4.packetBuffer.method12973(773246731 * classSA.field5897, -1542382992);
               var4.packetBuffer.method12973(IntProjection.field1938 * 8379747, -1542382992);
         ...
         classXH.method12755(classOE.client.field790, (byte)-81);
         ...
         for (int var5 = 0; var5 < 8; var5++) {
            ...
            client.field864[var5] = new GrandExchangeOffer();
         ...
         client.field990 = 0;
         client.field982 = 0;
         classOE.client.method11100(true, 477266699);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "bd.au(" + ')');
      }
   }
   ...
   void method978(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bd.az(" + ')');
      }
   }
   ...
   public static void method988(boolean var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bd.ax(" + ')');
      }
   }
