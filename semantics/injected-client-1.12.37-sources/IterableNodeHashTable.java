...
public final class IterableNodeHashTable implements Iterable, IterableHashTable, net.runelite.api.IndexedObjectSet {
   ...
   @ObfuscatedName("az")
   public Node method13595(long var1) {
      Node var3 = this.field7017[(int)(var1 & this.field7018 - 1)];

      for (Node var4 = var3.field6554; var3 != var4; var4 = var4.field6554) {
   ...
   @ObfuscatedName("jy")
   public static void method13586(classYO var0, classTE var1, Buffer var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ig")
   public static Node method13569(IterableNodeHashTable var0, long var1) {
      Node var3 = var0.field7017[(int)(var1 & var0.field7018 - 1)];
   ...
   @ObfuscatedName("af")
   public void method13574(Node var1, long var2) {
      if (var1.field6553 != null) {
         var1.vmethod398();
      }

      Node var4 = this.field7017[(int)(var2 & this.field7018 - 1)];
   ...
   @ObfuscatedName("oj")
   public static void method13579(IterableNodeHashTable var0) {
      if (var0 == null) {
         var0.method13584();
      } else {
         for (int var1 = 0; var1 < var0.field7018; var1++) {
            Node var2 = var0.field7017[var1];

            while (true) {
               Node var3 = var2.field6554;
               if (var3 == var2) {
                  break;
               }
   ...
   @ObfuscatedSignature(descriptor = "(Lyn;)V")
   @ObfuscatedName("uw")
   public static void method13580(IterableNodeHashTable var0) {
      if (var0 == null) {
         var0.method13585();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lyn;)V")
   @ObfuscatedName("ya")
   public static void method13581(IterableNodeHashTable var0) {
      if (var0 == null) {
         var0.method13587();
      }
   ...
   @ObfuscatedSignature(descriptor = "(J)Lvq;")
   @ObfuscatedName("as")
   public Node method13570(long var1) {
      Node var3 = this.field7017[(int)(var1 & this.field7018 - 1)];
   ...
   @ObfuscatedSignature(descriptor = "()Lvq;")
   @ObfuscatedName("cb")
   public Node method13599() {
      return this.method13587();
   }

   public IterableNodeHashTable(int var1) {
      this.field7018 = var1;
      this.field7017 = new Node[var1];

      for (int var2 = 0; var2 < var1; var2++) {
         Node var3 = this.field7017[var2] = new Node();
         var3.field6554 = var3;
         var3.field6553 = var3;
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(J)Lvq;")
   @ObfuscatedName("uy")
   public Node method13600(long var1) {
      return this.method13595(var1);
   }

   @ObfuscatedSignature(descriptor = "(Lvq;J)V")
   @ObfuscatedName("al")
   public void method13597(Node var1, long var2) {
      Node var4 = this.method13600(var2);
      if (var4 != null) {
         var4.method12065();
      }
   ...
   @ObfuscatedName("kf")
   public static Node method13589(IterableNodeHashTable var0) {
      if (var0 == null) {
         var0.method13591();
      }

      if (var0.field7019 > 0 && var0.field7021 != var0.field7017[var0.field7019 - 1]) {
         Node var2 = var0.field7021;
         var0.field7021 = var2.field6554;
         return var2;
      } else {
         while (var0.field7019 < var0.field7018) {
            Node var1 = var0.field7017[var0.field7019++].field6554;
   ...
   @ObfuscatedSignature(descriptor = "(J)Lvq;")
   @ObfuscatedName("ax")
   public Node method13571(long var1) {
      Node var3 = this.field7017[(int)(var1 & this.field7018 - 1)];
   ...
   @ObfuscatedSignature(descriptor = "(Lvq;J)V")
   @ObfuscatedName("ay")
   public void method13601(Node var1, long var2) {
      method13576(this, var1, var2);
   }

   @ObfuscatedSignature(descriptor = "(J)Lvq;")
   @ObfuscatedName("aa")
   public Node method13572(long var1) {
      Node var3 = this.field7017[(int)(var1 & this.field7018 - 1)];
   ...
   @ObfuscatedSignature(descriptor = "(Lyn;J)Lvq;")
   @ObfuscatedName("fy")
   public static Node method13573(IterableNodeHashTable var0, long var1) {
      Node var3 = var0.field7017[(int)(var1 & var0.field7018 - 1)];
   ...
   @ObfuscatedSignature(descriptor = "(Lvq;J)V")
   @ObfuscatedName("sr")
   public void method13575(Node var1, long var2) {
      if (var1.field6553 != null) {
         var1.vmethod398();
      }
   ...
   @ObfuscatedName("pe")
   public static void method13576(IterableNodeHashTable var0, Node var1, long var2) {
      if (var0 == null) {
         ...
         Node var4 = var0.field7017[(int)(var2 & var0.field7018 - 1)];
         var1.field6553 = var4.field6553;
         var1.field6554 = var4;
         var1.field6553.field6554 = var1;
         var1.field6554.field6553 = var1;
   ...
   @ObfuscatedSignature(descriptor = "(Lvq;J)V")
   @ObfuscatedName("aj")
   public void method13577(Node var1, long var2) {
      if (var1.field6553 != null) {
         var1.vmethod398();
      }
   ...
   @ObfuscatedName("ic")
   public Node method13596(int var1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lyn;)Lvq;")
   @ObfuscatedName("ce")
   public static Node method13590(IterableNodeHashTable var0) {
      if (var0.field7019 > 0 && var0.field7021 != var0.field7017[var0.field7019 - 1]) {
         Node var2 = var0.field7021;
         var0.field7021 = var2.field6554;
         return var2;
   ...
   @ObfuscatedSignature(descriptor = "(Lvq;J)V")
   @ObfuscatedName("zb")
   public void method13578(Node var1, long var2) {
      if (var1.field6553 != null) {
         var1.vmethod401();
      }
