...
public abstract class Projection implements net.runelite.api.Projection {
   ...
   void method5035(Scene var1, SceneTileModel var2, int var3, int var4, int var5) {
      try {
         ...
         boolean var7 = classOE.client.isGpu();
            ...
            if ((var14 - var15) * (var19 - var18) - (var17 - var18) * (var16 - var15) > 0.0F) {
               if (Scene.method4503(var1.field2045, var1.field2046, (int)var17, (int)var18, (int)var19, (int)var14, (int)var15, (int)var16)) {
                  ...
                  if (var8 != null
                     ...
                     && var1.field2045 >= classOE.client.getViewportXOffset()
                     && var1.field2045 < classOE.client.getViewportXOffset() + classOE.client.getViewportWidth()
                     && var1.field2046 >= classOE.client.getViewportYOffset()
                     && var1.field2046 < classOE.client.getViewportYOffset() + classOE.client.getViewportHeight()) {
         ...
         client.logger.warn("error during overlay rendering", var25);
      }
   }
   ...
   public static void method5024(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "fv.af(" + ')');
      }
   }
      ...
      try {
         ...
         if ((var25 - var29) * (var26 - var28) - (var27 - var29) * (var24 - var28) > 0.0F) {
            if (Scene.method4503(var1.field2045, var1.field2046, (int)var27, (int)var29, (int)var25, (int)var26, (int)var28, (int)var24)) {
               ...
               if (var1.field2045 >= classOE.client.getViewportXOffset()
                  && var1.field2045 < classOE.client.getViewportXOffset() + classOE.client.getViewportWidth()
                  && var1.field2046 >= classOE.client.getViewportYOffset()
                  && var1.field2046 < classOE.client.getViewportYOffset() + classOE.client.getViewportHeight()
                  && var34 != null
         ...
         client.logger.warn("error during underlay rendering", var37);
      }
   }
