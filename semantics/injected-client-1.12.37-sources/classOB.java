...
public final class classOB {
   ...
   @ObfuscatedName("ac")
   static void method8301(Widget var0, int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ob.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("ae")
   public static ItemComposition method8299(int var0, byte var1) {
      try {
         ItemComposition var2 = (ItemComposition)ItemComposition.field5006.method6422(var0);
         if (null != var2) {
            if (var1 == 64) {
               throw new IllegalStateException();
            } else {
            ...
            if (null == var3) {
               ...
               var2 = new ItemComposition(null, var0, null, null, true);
            } else {
               Buffer var4;
               int[] var6;
               label61: {
                  ...
                  var6 = new int[2];
                  int var7 = Buffer.method13039(var4, -346779531);
                  if (var7 != 97) {
                     if (var1 == 64) {
                        throw new IllegalStateException();
                     }
                  ...
                  var6[0] = Buffer.method13047(var4, 945959292);
                  Buffer.method13039(var4, -346779531);
                  var6[1] = Buffer.method13047(var4, 130405734);
               }

               var4.offset = 0;
               ItemComposition var11 = var6[0] == -1 ? null : method8299(var6[0], (byte)13);
               ItemComposition var8 = var6[1] == -1 ? null : method8299(var6[1], (byte)-52);
               var2 = new ItemComposition(var4, var0, var11, var8, true);
            }

            ItemComposition.field5006.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var9) {
         throw classEG.newRunException(var9, "ob.ae(" + ')');
      }
   }
   ...
   static classSE method8298(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ob.as(" + ')');
      }
   }
   ...
   public static void method8300(classTE var0, int var1, Object var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ob.ar(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;Lgy;III)V")
   @ObfuscatedName("az")
   public static void method8291(Buffer var0, classGY var1, int var2, int var3, int var4) {
      try {
         ...
         byte var5 = Buffer.method13043(var0, (byte)17);
         if (var5 != 0) {
         ...
         throw classEG.newRunException(var10, "ob.az(" + ')');
      }
   }
   ...
   public static classKR[] method8292(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "ob.ag(" + ')');
      }
   }
}
