...
@ObfuscatedName("cv")
public class classCV extends Node {
   ...
   void method2680(int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var6, "cv.az(" + ')');
      }
   }
   ...
   public static int method2683(long var0) {
      try {
         ...
         throw classEG.newRunException(var2, "cv.ab(" + 41);
      }
   }
   ...
   static final void method2685(String var0, byte var1) {
      try {
         if (null == classIB.field2935) {
            ...
            PacketBufferNode var2 = classEF.getPacketBufferNode(ClientPacket.FRIENDCHAT_KICK, client.packetWriter.isaacCipher, (byte)-69);
            Buffer.method12971(var2.packetBuffer, classAU.method712(var0, (byte)77), (byte)-96);
            Buffer.method12997(var2.packetBuffer, var0, (short)7263);
            client.packetWriter.addNode(var2, -1301097035);
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "cv.gn(" + ')');
      }
   }
   ...
   public static int method2684(byte[] var0, int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cv.bs(" + 41);
      }
   }
}
