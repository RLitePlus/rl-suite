...
public class classDG {
   ...
   int method3058(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dg.az(" + 41);
      }
   }
   ...
   int method3070(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dg.ab(" + 41);
      }
   }
   ...
   @ObfuscatedName("tb")
   public static void method3078(classDF var0, WorldView var1) {
      if (var0 == null) {
         var0.method3025();
      } else {
   ...
   public static int method3062(classDG var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "dg.af(" + 41);
      }
   }
   ...
   static final boolean method3077(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         throw classEG.newRunException(var9, "dg.ak(" + ')');
      }
   }
   ...
   public static int method3066(classDG var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "dg.ae(" + 41);
      }
   }
   ...
   @ObfuscatedName("xr")
   public static HashMap method3076(WorldMapRenderer var0) {
      if (var0 == null) {
         var0.method5781();
      }
   ...
   public static int method3057(int var0, int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "dg.af(" + 41);
      }
   }
      ...
      try {
         if (client.field901 == classCP.field1197) {
            if (var0 >= 2133873433) {
               ...
               MouseHandler.field6273 = classCC.method1407(1060637953 * classUM.field6334.field6328, false, true, true, false, (byte)37);
               ...
               ItemContainer.field462 = classCC.method1407(classUM.field6344.field6328 * 1060637953, false, true, true, false, (byte)34);
               ...
               ItemContainer.field463 = classCC.method1407(1060637953 * classUM.field6346.field6328, true, true, true, false, (byte)12);
            ...
            if (var0 >= 2133873433) {
               ...
               label527: {
                  int var53 = 0;
                  var53 += MouseHandler.field6273.method12017(1857218819) * 53 / 100;
                  var53 += classFC.field2208.method12017(-606348877) * 5 / 100;
                  var53 += classHC.field2767.method12017(-1890665226) * 36 / 100;
                  var53 += ItemContainer.field462.method12017(-503033937) * 1 / 100;
                  ...
                  if (classVP.method12014(ItemContainer.field463, (byte)9)) {
                     if (var0 >= 2133873433) {
                        throw new IllegalStateException();
                     }

                     if (ItemContainer.field463.method11811(-121046838)) {
                        if (var0 >= 2133873433) {
                           throw new IllegalStateException();
                        }
               ...
               if (100 != var60) {
                  ...
                  classPC.method8840(MouseHandler.field6273, "Sound FX", 1380387156);
                  ...
                  classOV.field5169.method223(ItemContainer.field463, 1513224765);
            ...
            if (var0 >= 2133873433) {
               ...
               short var79 = 2048;
               if (0 == WidgetConfigNode.field4138 * 675076789) {
                  throw new IllegalStateException();
               } else {
                  if (var79 < 512) {
                     if (var0 >= 2133873433) {
                  ...
                  classVP var90 = MouseHandler.field6273;
                  classIA.field2927 = var87;
                  classRM.field5809 = var89;
                  classNP.field4705 = var90;
                  classNP.field4704 = var52;
                  client.field857.method10290(MouseHandler.field6273, classQO.field5580, 62656778);
            ...
            if (var0 < 2133873433) {
               ...
               if (client.field833.size() < var51) {
                  ...
                  classQJ.field5556 = (Font)client.field833.get(classXJ.field6874);
                  classVP.field6550 = (Font)client.field833.get(classXJ.field6878);
                  classBB.field341 = (Font)client.field833.get(classXJ.field6876);
                  classEB.field1727 = client.field877.vmethod625(971457923);
                  PlatformInfo.method12108(-1);
            ...
            if (var0 >= 2133873433) {
               ...
               int var50 = classVC.method11935(ItemContainer.field462, classHC.field2767, (byte)9);
            ...
            NPC.field1584 = classCC.method1407(1060637953 * classUM.field6347.field6328, false, true, true, true, (byte)16);
            ...
            ItemComposition.field5078 = classCC.method1407(classUM.field6342.field6328 * 1060637953, false, true, true, false, (byte)65);
            ...
            var34 += NPC.field1584.method12017(-255448783) * 1 / 100;
            ...
            var34 += ItemComposition.field5078.method12017(-933136960) * 1 / 100;
            ...
            if (var34 != 100) {
               ...
               classPC.method8840(NPC.field1584, "Animation Keyframes", 81832510);
            ...
            if (var0 < 2133873433) {
               ...
               classRD.field5645 = new SpritePixels(512, 512);
               classFQ.method4936(var33);
               Scene.method4257(var33);
            ...
            if (var0 >= 2133873433) {
               ...
               AABB.method4899(classBF.field427, -3113161);
               ...
               Font var9 = classQJ.field5556;
               classOT.field5117 = var85;
               WorldMapRenderer.field2702 = var7;
               ...
               classVP var12 = NPC.field1584;
               classVP var13 = classQE.field5525;
               SequenceDefinition.field5153 = var10;
               ...
               ItemContainer.method1074(classBF.field427, 2130004647);
               ...
               WorldMapElement.field5413 = var24;
               WorldMapElement.field5407 = var23.method11868(35, 479724292) * -1749753703;
               classYV.field7095 = new WorldMapElement[WorldMapElement.field5407 * 925594537];

               for (int var25 = 0; var25 < 925594537 * WorldMapElement.field5407; var25++) {
                  if (var0 >= 2133873433) {
                     throw new IllegalStateException();
                  }

                  byte[] var26 = var23.method11867(35, var25, -703079961);
                  classYV.field7095[var25] = new WorldMapElement(var25);
                  if (var26 != null) {
                     if (var0 >= 2133873433) {
                        throw new IllegalStateException();
                     }

                     WorldMapElement.method9187(classYV.field7095[var25], new Buffer(var26), (byte)-2);
            ...
            if (client.field901 == classCP.field1193) {
               if (!ItemComposition.field5078.method11811(-475832234)) {
                  if (var0 >= 2133873433) {
                     throw new IllegalStateException();
                  } else {
                  ...
                  Ignored.field5839 = new TextureProvider(ItemComposition.field5078, classHC.field2767, 20, classAB.field122.method2757(-1674478907), 128);
                  classFH.method4689(Ignored.field5839);
               ...
               if (var0 >= 2133873433) {
                  ...
                  int var31 = TextureProvider.method3806(Ignored.field5839, (byte)4);
                  if (var31 < 100) {
               ...
               if (var0 >= 2133873433) {
                  ...
                  NpcOverrides.field5380 = new classDK();
                  classWW.field6786.method7517(NpcOverrides.field5380, 10, -1779981336);
               ...
               if (!ItemContainer.field462.method11859("huffman", "", -337835981)) {
                  if (var0 >= 2133873433) {
                     throw new IllegalStateException();
                  } else {
                  ...
                  classLR var30 = new classLR(ItemContainer.field462.method11854("huffman", "", 1857645463));
               ...
               if (var0 < 2133873433) {
                  if (!classCC.field671.method11811(261960522)) {
                     ...
                     if (AbstractArchive.method11853(classWN.field6759, "version.dat", "", 926249338)) {
                        if (var0 >= 2133873433) {
                           throw new IllegalStateException();
                        }

                        Buffer var29 = new Buffer(classWN.field6759.method11854("version.dat", "", 1857645463));
                        Buffer.method13047(var29, 813829590);
                     }
            ...
            if (!classIN.method6226((byte)0)) {
               ...
               SpritePixels[] var62 = classIR.method6307(classHC.field2767, classOV.field5169.field65 * -1318207165, 0, -1253680523);
            ...
            if (!classQW.method9829(1973417774)) {
               ...
               SpritePixels[] var67 = classIR.method6307(classHC.field2767, 68430027 * classOV.field5169.field67, 0, -1253680523);
            ...
            label539: {
               if (classLJ.field4179 == null) {
                  ...
                  if (-1 != -1589101089 * classOV.field5169.field74) {
                     ModelData var70 = ModelData.method4047(classSX.field6097, -1589101089 * classOV.field5169.field74, 0);
                     if (var70 != null) {
                        if (var0 >= 2133873433) {
                           throw new IllegalStateException();
                        }
            ...
            if (classIY.field3098 == null && -1 != classOV.field5169.field59 * -1992983305) {
               ModelData var71 = ModelData.method4047(classSX.field6097, classOV.field5169.field59 * -1992983305, 0);
               if (null != var71) {
                  if (var0 >= 2133873433) {
                     throw new IllegalStateException();
                  }
            ...
            if (var1 < 13) {
               ...
               AbstractFont.field25 = classDT.field1630;
         ...
         throw classEG.newRunException(var28, "dg.ay(" + ')');
      }
   }
   ...
   public static classTE method3075(int[] var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "dg.ad(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;Lsp;ZI)V")
   @ObfuscatedName("cy")
   static void method3080(WorldView var0, WorldEntity var1, boolean var2, int var3) {
      try {
         boolean var10000;
         label132: {
         ...
         var1.field6012.scene.method4345(1612595797 * client.field855);
         var1.method10554(var2, 1915485008);
         boolean var14 = Scene.method4477(
            var0.scene,
         ...
         if (var14 && !var2) {
            ...
            WorldView var10 = var1.field6012;
            ...
            WorldView var11 = var1.field6012;

            for (GraphicsObject var12 = (GraphicsObject)var11.field1691.method7915();
               null != var12;
               var12 = (GraphicsObject)classNN.method7924(var11.field1691)
            ) {
         ...
         throw classEG.newRunException(var13, "dg.cy(" + ')');
      }
   }
   ...
   static String method3061(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dg.az(" + ')');
      }
   }
