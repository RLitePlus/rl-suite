...
@ObfuscatedName("ec")
public class TextureProvider implements classFG, net.runelite.api.TextureProvider {
   @ObfuscatedName("ag")
   double field1729;
   ...
   public int vmethod408(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ec.ab(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "()[Lfu;")
   @ObfuscatedName("hv")
   public Texture[] method3825() {
   ...
   public void method3811(double var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ec.af(" + ')');
      }
   }
   ...
   public int[] vmethod402(int var1, byte var2) {
      try {
         Texture var3 = this.field1734[var1];
         if (var3 != null) {
            if (var2 >= 2) {
               throw new IllegalStateException();
            }
            ...
            boolean var4 = Texture.method5004(var3, this.field1729, 1127091647 * this.field1732, this.field1731);
            if (var4) {
               if (var2 >= 2) {
                  throw new IllegalStateException();
               }
               ...
               if (0 == this.field1728 * 500420469) {
                  ...
                  Texture var5 = (Texture)this.field1733.method7914();
                  var5.method5011();
               } else {
         ...
         throw classEG.newRunException(var6, "ec.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;Lva;IDI)V")
   @ObfuscatedName("fq")
   public void method3823(AbstractArchive var1, AbstractArchive var2, int var3, double var4, int var6) {
      this.method3826(128);
      this.method3827(128);
   }
   ...
   public boolean vmethod412(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ec.ag(" + ')');
      }
   }
   ...
   public static void method3804(int var0, int[][][] var1, int var2, int var3, int var4, int[] var5, int[] var6, int[] var7, int var8) {
      try {
         int[] var9 = SceneTilePaint.field2282[var0];
         ...
         for (int var10 = 0; var10 < var9.length; var10++) {
            ...
            int var13 = (var3 << 7) + SceneTilePaint.field2280[var14] * 128;
            var5[var10] = var13;
            var6[var10] = VarbitComposition.method9210(var9[var10], var1, var2, var3, var4, (byte)-60);
            var7[var10] = classFO.method4850(var9[var10], var4, 260031741);
         }
      } catch (RuntimeException var15) {
         throw classEG.newRunException(var15, "ec.az(" + ')');
      }
   }
   ...
   public int[] vmethod403(int var1) {
      Texture var2 = this.field1734[var1];
      if (var2 != null) {
         ...
         boolean var3 = Texture.method5004(var2, this.field1729, 1127091647 * this.field1732, this.field1731);
         if (var3) {
            if (0 == this.field1728 * 500420469) {
               Texture var4 = (Texture)this.field1733.method7914();
               var4.method5011();
            } else {
   ...
   @ObfuscatedName("nd")
   public static void method3813(TextureProvider var0, double var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ge")
   public static boolean method3822(Scene var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
   ...
   @ObfuscatedName("wu")
   public static void method3815(TextureProvider var0) {
      if (var0 == null) {
         var0.method3816();
      } else {
   ...
   @ObfuscatedName("gt")
   public static void method3818(TextureProvider var0, int var1) {
      if (var0 == null) {
         var0.vmethod403(var1);
      }

      for (int var2 = 0; var2 < var0.field1734.length; var2++) {
         Texture var3 = var0.field1734[var2];
   ...
   @ObfuscatedName("wy")
   public static classQR method3809(WorldEntity var0) {
      if (var0 == null) {
         var0.vmethod385();
      }
   ...
   @ObfuscatedName("bl")
   public static void method3819(TextureProvider var0, int var1, int var2) {
      if (var0 == null) {
      ...
      try {
         for (int var3 = 0; var3 < var0.field1734.length; var3++) {
            ...
            Texture var4 = var0.field1734[var3];
            if (var4 != null) {
               if (var2 != -1467379791) {
                  var0.method3824(var1);
                  return;
         ...
         throw classEG.newRunException(var5, "ec.ax(" + ')');
      }
   }
   ...
   public TextureProvider(AbstractArchive var1, AbstractArchive var2, int var3, double var4, int var6) {
      ...
      if (var7 != null) {
         ...
         this.field1734 = new Texture[var1.method11868(0, 1597643874)];

         for (int var9 = 0; var9 < var8; var9++) {
            Buffer var10 = new Buffer(var1.method11867(0, var7[var9], -1089106860));
            this.field1734[var7[var9]] = new Texture(var10);
         }
      } else {
         this.field1734 = new Texture[0];
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lec;I)V")
   @ObfuscatedName("tk")
   public static void method3820(TextureProvider var0, int var1) {
      if (var0 == null) {
         var0.method3825();
      }
   ...
   @ObfuscatedName("ep")
   public static int method3806(TextureProvider var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var7, "ec.az(" + 41);
         }
      }
   }
   ...
   public int[] vmethod407(int var1) {
      ...
      if (var2 != null) {
         ...
         boolean var3 = Texture.method5004(var2, this.field1729, 941287448 * this.field1732, this.field1731);
         if (var3) {
            if (0 == this.field1728 * 500420469) {
               Texture var4 = (Texture)this.field1733.method7914();
               var4.method5011();
   ...
   public void method3824(int var1) {
      classOE.client.getCallbacks().drawAboveOverheads();
   }
   ...
   public void method3817(byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ec.as(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Ljl;")
   @ObfuscatedName("ae")
   public static PacketBufferNode method3810(int var0) {
      try {
         PacketBufferNode var1 = SceneTilePaint.method4793(1717678848);
         var1.clientPacket = null;
         var1.field3339 = 0;
         var1.packetBuffer = new PacketBuffer(5000);
         return var1;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "ec.ae(" + ')');
      }
   }
   ...
   public void method3821(int var1, int var2) {
      try {
         for (int var3 = 0; var3 < this.field1734.length; var3++) {
            ...
            Texture var4 = this.field1734[var3];
            if (var4 != null) {
               if (var2 != -1467379791) {
