...
public class classHK implements classHM {
   ...
   public void vmethod469(classHG var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "hk.az(" + ')');
      }
   }
   ...
   public int[] vmethod478(int var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var6, "hk.ab(" + ')');
      }
   }
   ...
   public boolean vmethod472(int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "hk.af(" + ')');
      }
   }
   ...
   public boolean vmethod476(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "hk.ae(" + ')');
      }
   }
   ...
   public static int method6069(classTE var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "hk.ap(" + 41);
      }
   }
   ...
   public static void method6065(classHK var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "hk.ax(" + ')');
         }
      }
   }
   ...
   public void vmethod484(Buffer var1, int var2) {
      try {
         this.field2829 = Buffer.method13039(var1, -346779531) * 467211539;
         this.field2819 = Buffer.method13039(var1, -346779531) * 62464449;
         this.field2818 = Buffer.method13047(var1, 1474365486) * 1825996785;
         this.field2827 = Buffer.method13039(var1, -346779531) * 81234849;
         this.field2815 = Buffer.method13039(var1, -346779531) * 1346583341;
         this.field2816 = Buffer.method13047(var1, 352073910) * 1982605125;
         this.field2817 = Buffer.method13039(var1, -346779531) * -641315699;
         this.field2824 = Buffer.method13039(var1, -346779531) * 203541133;
         this.field2820 = Buffer.method13047(var1, 158385951) * -634232723;
         this.field2822 = Buffer.method13039(var1, -346779531) * -842258595;
         this.field2828 = Buffer.method13039(var1, -346779531) * 2034147209;
         this.field2826 = Buffer.method13047(var1, 1922120835) * 1289741507;
         this.field2821 = Buffer.method13039(var1, -346779531) * -717986565;
         this.field2825 = Buffer.method13039(var1, -346779531) * -1833327255;
         method6065(this, (byte)11);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "hk.as(" + ')');
      }
   }
   ...
   public classKY vmethod480(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var6, "hk.ag(" + ')');
      }
   }
   ...
   public void vmethod485(Buffer var1) {
      this.field2829 = Buffer.method13039(var1, -346779531) * 217765975;
      this.field2819 = Buffer.method13039(var1, -346779531) * -1504494449;
      this.field2818 = Buffer.method13047(var1, 582928806) * -564296415;
      this.field2827 = Buffer.method13039(var1, -346779531) * 524241497;
      this.field2815 = Buffer.method13039(var1, -346779531) * 1346583341;
      this.field2816 = Buffer.method13047(var1, 1932326752) * 503789846;
      this.field2817 = Buffer.method13039(var1, -346779531) * -641315699;
      this.field2824 = Buffer.method13039(var1, -346779531) * 1527260716;
      this.field2820 = Buffer.method13047(var1, 1895967744) * -634232723;
      this.field2822 = Buffer.method13039(var1, -346779531) * 707177529;
      this.field2828 = Buffer.method13039(var1, -346779531) * 1653797282;
      this.field2826 = Buffer.method13047(var1, -285689684) * 1289741507;
      this.field2821 = Buffer.method13039(var1, -346779531) * -382456250;
      this.field2825 = Buffer.method13039(var1, -346779531) * 599077772;
   ...
   public static boolean method6068(AbstractArchive var0, int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var5, "hk.ao(" + ')');
      }
   }
