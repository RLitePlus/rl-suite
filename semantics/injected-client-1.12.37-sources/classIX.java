...
public class classIX {
   ...
   @ObfuscatedName("az")
   void method6325(Buffer var1, short var2) {
      try {
         ...
         for (int var3 = Buffer.method13039(var1, -346779531); 0 != var3; var3 = Buffer.method13039(var1, -346779531)) {
            ...
            IterableNodeDeque.method8156(this.field3083, (Node)var4);
         }
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "ix.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lie;B)V")
   @ObfuscatedName("af")
   public void method6330(ClanChannel var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var4, "ix.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("ku")
   public static void method6326(classIX var0, Buffer var1) {
      if (var0 == null) {
         ...
         for (int var2 = Buffer.method13039(var1, -346779531); 0 != var2; var2 = Buffer.method13039(var1, -346779531)) {
            ...
            IterableNodeDeque.method8156(var0.field3083, (Node)var3);
         }
      }
   }
   ...
   void method6327(Buffer var1) {
      ...
      for (int var2 = Buffer.method13039(var1, -346779531); 0 != var2; var2 = Buffer.method13039(var1, -346779531)) {
         ...
         IterableNodeDeque.method8156(this.field3083, (Node)var3);
      }
   }

   public classIX(Buffer var1) {
      this.field3083 = new IterableNodeDeque();
      this.method6325(var1, (short)-29660);
   }

   @ObfuscatedSignature(descriptor = "(Lie;)V")
   @ObfuscatedName("as")
   public void method6331(ClanChannel var1) {
   ...
   @ObfuscatedSignature(descriptor = "(Lix;Lxy;)V")
   @ObfuscatedName("la")
   public static void method6328(classIX var0, Buffer var1) {
      if (var0 == null) {
         var0.method6327(var1);
      } else {
   ...
   @ObfuscatedSignature(descriptor = "(Lie;)V")
   @ObfuscatedName("ax")
   public void method6332(ClanChannel var1) {
      if (var1.field6552 == this.field3088 && -8128530336532066645L * this.field3082 == -8293005437275873549L * var1.field2953) {
         for (classIS var2 = (classIS)this.field3083.method8167(); var2 != null; var2 = (classIS)classAAX.method294(this.field3083)) {
   ...
   @ObfuscatedName("af")
   static void method6333(WorldEntity var0, int var1, int var2, int var3) {
      try {
         if (var1 == 65535) {
            if (var3 > 360123687) {
               byte var7 = -1;
            ...
            SequenceDefinition var4 = var0.field6017.method9731((byte)30);
            if (var4 != null) {
               if (var3 <= 360123687) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.newRunException(var6, "ix.af(" + ')');
      }
   }
   ...
   public static int method6329(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ix.ae(" + 41);
      }
   }
}
