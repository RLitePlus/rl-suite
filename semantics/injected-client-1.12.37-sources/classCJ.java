...
public class classCJ extends Renderable {
   ...
   protected Model vmethod104(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "cj.ae(" + ')');
      }
   }
   ...
   protected boolean vmethod95(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "cj.ab(" + ')');
      }
   }
   ...
   protected int vmethod98(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.ag(" + 41);
      }
   }
   ...
   void method1524(classCL var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "cj.af(" + ')');
      }
   }
   ...
   classUZ method1529(int var1, int var2, int var3, int var4, classCL var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var15, "cj.as(" + ')');
      }
   }
   ...
   void method1531(classCL var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var24, "cj.ax(" + ')');
      }
   }
   ...
   float method1533(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var6, "cj.ac(" + ')');
      }
   }
   ...
   void method1543(float var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "cj.ao(" + ')');
      }
   }
   ...
   void method1548(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "cj.al(" + ')');
      }
   }
   ...
   int method1557(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.ay(" + 41);
      }
   }
   ...
   int method1562(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.am(" + 41);
      }
   }
   ...
   int method1564(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.ah(" + 41);
      }
   }
   ...
   int method1568(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.bn(" + 41);
      }
   }
   ...
   int method1570(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.bx(" + 41);
      }
   }
   ...
   public static int method1554(classCJ var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "cj.aj(" + 41);
      }
   }
   ...
   int method1561(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.aq(" + 41);
      }
   }
   ...
   public static boolean method1573(char var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.ar(" + ')');
      }
   }
   ...
   void method1523(classSS var1, int var2, boolean var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "cj.az(" + ')');
      }
   }
   ...
   float method1542(float var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var5, "cj.aa(" + ')');
      }
   }
   ...
   static boolean method1572(byte[] var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cj.ao(" + ')');
      }
   }
