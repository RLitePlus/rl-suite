...
public class classGD implements Comparator {
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gd.equals(" + ')');
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         ...
         throw classEG.newRunException(var3, "gd.compare(" + 41);
      }
   }
   ...
   @ObfuscatedName("cd")
   public static void method5400(GameEngine var0, WindowEvent var1) {
      if (var0 == null) {
         var0.method11021();
      }
   }
   ...
   @ObfuscatedName("aa")
   static int method5401(int var0, Script var1, boolean var2, byte var3) {
      try {
         if (var0 == 100) {
            if (var3 == 12) {
               ...
               int var38 = classBB.field323[DynamicObject.field1679 * -324749371];
               int var58 = classBB.field323[-324749371 * DynamicObject.field1679 + 1];
               int var73 = classBB.field323[DynamicObject.field1679 * -324749371 + 2];
               boolean var120;
               if (classBB.field323[DynamicObject.field1679 * -324749371 + 3] != 0) {
                  if (var3 == 12) {
                     throw new IllegalStateException();
                  }
               ...
               if (var73 < 0) {
                  ...
                  Widget var98 = classLY.method7375(classWK.field6691, var38, (byte)69);
            ...
            if (var3 == 12) {
               ...
               if (var2) {
                  ...
                  var119 = TileItem.field1558;
               }

               Widget var37 = var119;
               Widget var57 = classLY.method7375(classWK.field6691, var37.field4329 * -1163656551, (byte)38);
               classDM.method3434(var37, var57, (byte)-121);
               return 1;
            }
         } else if (102 == var0) {
            DynamicObject.field1679 -= 120041229;
            int var36 = classBB.field323[DynamicObject.field1679 * -324749371];
            Widget var56 = classLY.method7375(classWK.field6691, var36, (byte)36);
            ...
            if (var3 == 12) {
               ...
               int var35 = classBB.field323[-324749371 * DynamicObject.field1679];
               int var55 = classBB.field323[1 + -324749371 * DynamicObject.field1679];
               int var72 = classBB.field323[2 + -324749371 * DynamicObject.field1679];
               Widget var85 = classLY.method7375(classWK.field6691, var35, (byte)82);
               Widget var97 = classLY.method7378(classWK.field6691, var35, var55, (byte)-111);
               if (null == var85) {
                  throw new RuntimeException("");
               } else if (var55 < 0) {
                  if (var3 == 12) {
                  ...
                  if (var97.field4263 * 653784551 != -1) {
                     ...
                     Widget var100 = classLY.method7378(classWK.field6691, var35, 653784551 * var97.field4263, (byte)-55);
                     classOB.method8301(var100, var72, 427421377);
                  }

                  Widget var101 = new Widget(var97);
            ...
            if (var3 == 12) {
               ...
               int var34 = classBB.field323[-324749371 * DynamicObject.field1679];
               int var54 = classBB.field323[1 + -324749371 * DynamicObject.field1679];
               Widget var118;
               if (var2) {
                  if (var3 == 12) {
                     throw new IllegalStateException();
               ...
               if (var71 == null) {
                  ...
                  Widget var84 = classLY.method7375(classWK.field6691, var71.field4342 * -1502647899, (byte)81);
            ...
            if (var3 == 12) {
               ...
               Widget var70 = var2 ? classSZ.field6110 : TileItem.field1558;
               if (null == var70) {
                  throw new RuntimeException("");
               } else {
                  Widget var83 = classLY.method7378(classWK.field6691, var70.field4342 * -1502647899, var70.field4263 * 653784551, (byte)-43);
                  Widget var95 = classLY.method7375(classWK.field6691, -1502647899 * var83.field4342, (byte)87);
            ...
            int var52 = classBB.field323[DynamicObject.field1679 * -324749371 + 1];
            Widget var117;
            if (var52 != -1) {
               if (var3 == 12) {
                  throw new IllegalStateException();
            ...
            client.method1677(
               classLY.method7375(classWK.field6691, classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], (byte)127), var2, 2040822688
            );
            return 1;
         } else if (var0 == 204) {
            Widget var115;
            ...
            if (var3 == 12) {
               ...
               if (null == var29) {
                  ...
                  Widget var49 = classLY.method7375(classWK.field6691, var29.field4342 * -1502647899, (byte)120);
                  Widget var68 = null;
                  ...
                  for (int var82 = 1 + 63131743 * var29.field4260; var82 < var49.field4340.length; var82++) {
                     ...
                     Widget var94 = var49.field4340[var82];
                     if (null == var94) {
                        if (var3 == 12) {
                           throw new IllegalStateException();
                        }
            ...
            if (var3 == 12) {
               ...
               if (var28 == null) {
                  ...
                  Widget var48 = classLY.method7375(classWK.field6691, var28.field4342 * -1502647899, (byte)90);
                  Widget var67 = null;
                  ...
                  for (int var81 = 63131743 * var28.field4260 - 1; var81 >= 0; var81--) {
                     ...
                     Widget var93 = var48.field4340[var81];
                     if (var93 == null) {
                        if (var3 == 12) {
                           throw new IllegalStateException();
                        }
            ...
            if (var3 == 12) {
               ...
               if (null == var27) {
                  ...
                  Widget var47 = classLY.method7375(classWK.field6691, -1502647899 * var27.field4342, (byte)57);
                  if (var47.field4340 == null) {
                     ...
                     classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var66;
                     return 1;
                  }
               }
            }
            ...
            if (var3 == 12) {
               ...
               if (var2) {
                  ...
                  var108 = TileItem.field1558;
               }

               Widget var26 = var108;
               int[] var109 = classBB.field323;
               int var121 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
               int var10002;
               if (var26 != null) {
                  if (var3 == 12) {
                     throw new IllegalStateException();
            ...
            if (var3 == 12) {
               ...
               int var25 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               int var46 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               Object var65 = classKN.method6500(var25, -198268369);
               int var79 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               ...
               Widget var14;
               Widget var103 = classLY.method7375(classWK.field6691, classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], (byte)113);
               var14 = null;
               label951:
            ...
            if (var3 == 12) {
               ...
               DynamicObject.field1679 -= 360123687;
               int var24 = classBB.field323[-324749371 * DynamicObject.field1679];
               Widget var45 = classLY.method7375(classWK.field6691, classBB.field323[1 + -324749371 * DynamicObject.field1679], (byte)25);
               int var64 = classBB.field323[2 + -324749371 * DynamicObject.field1679];
               classBB.field326.method7399(var24, var45, var64, 1453250184);
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classLZ.method7412(classBB.field326, 1466660338);
               return 1;
            }
         } else if (var0 == 212) {
            int var23 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
            Widget var107;
            if (var2) {
               if (var3 == 12) {
                  throw new IllegalStateException();
            ...
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classLZ.method7412(classBB.field326, 2114277572);
            return 1;
         } else if (213 == var0) {
            if (var3 == 12) {
               throw new IllegalStateException();
            ...
            if (var3 == 12) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classBB.field326.method7420(-1442930153);
               return 1;
            }
         } else if (215 == var0) {
            ...
            if (var3 == 12) {
               ...
               int var63 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classLZ.method7412(classBB.field326, 1097202174);
               return 1;
            }
         } else if (217 == var0) {
            if (var3 == 12) {
               ...
               if (null == var42) {
                  ...
                  Widget var62 = classLY.method7375(classWK.field6691, -1502647899 * var42.field4342, (byte)82);
                  if (-1510882375 * var62.field4375 != 0) {
                     throw new RuntimeException();
                  } else {
                     Widget var77 = GraphicsObject.method1100(var21, var62, var42, (byte)0);
            ...
            if (var20 == null) {
               ...
               Widget var41 = classLY.method7375(classWK.field6691, -1502647899 * var20.field4342, (byte)58);
               if (var41 != null) {
                  if (var3 == 12) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (null != var41.field4340) {
                     ...
                     for (int var76 = 0; var76 < var41.field4340.length; var76++) {
                        Widget var89 = var41.field4340[var76];
                        if (var89 == null) {
                           if (var3 == 12) {
                              throw new IllegalStateException();
                           }
            ...
            if (var3 == 12) {
               ...
               Widget var19 = var2 ? classSZ.field6110 : TileItem.field1558;
               if (null == var19) {
                  if (var3 == 12) {
                     throw new IllegalStateException();
                  } else {
                  ...
                  Widget var40 = classLY.method7375(classWK.field6691, var19.field4342 * -1502647899, (byte)52);
                  if (var40 != null) {
                     if (var3 == 12) {
                        throw new IllegalStateException();
                     }
                     ...
                     if (var40.field4340 != null) {
                        ...
                        for (int var75 = var40.field4340.length - 1; var75 >= 0; var75--) {
                           ...
                           Widget var88 = var40.field4340[var75];
                           if (null == var88) {
                              if (var3 == 12) {
                                 throw new IllegalStateException();
                              }
            ...
            if (var3 == 12) {
               ...
               if (null == var18) {
                  ...
                  Widget var39 = classLY.method7375(classWK.field6691, -1502647899 * var18.field4342, (byte)71);
                  if (var39 != null) {
            ...
            if (null == var4) {
               ...
               Widget var5 = classLY.method7375(classWK.field6691, -1502647899 * var4.field4342, (byte)79);
               if (null != var5) {
                  if (var3 == 12) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (null != var5.field4340) {
                     ...
                     for (int var7 = var5.field4340.length - 1; var7 >= 0; var7--) {
                        ...
                        Widget var8 = var5.field4340[var7];
         ...
         throw classEG.newRunException(var17, "gd.aa(" + 41);
      }
   }
   ...
   int method5393(classGW var1, classGW var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "gd.az(" + 41);
      }
   }
   ...
   public static classJC[] method5390(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "gd.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IILup;Lkh;I)V")
   @ObfuscatedName("ab")
   static void method5399(WorldView var0, int var1, int var2, classUP var3, classKH var4, int var5) {
      try {
         int var6 = -2087374717 * client.field837.field1419;
         int[] var7 = client.field837.field1423;
         Player var9 = classMB.method7521(-1218173231);
         int var10000;
         if (var9 != null) {
            if (var5 != 1115597881) {
               throw new IllegalStateException();
         ...
         for (int var10 = 0; var10 < var6; var10++) {
            ...
            Player var11 = (Player)var0.field1694.method13404(var7[var10]);
         ...
         throw classEG.newRunException(var21, "gd.ab(" + ')');
      }
   }
