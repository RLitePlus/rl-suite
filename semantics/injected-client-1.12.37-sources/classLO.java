...
public class classLO {
   ...
   static int method7132(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lo.az(" + 41);
      }
   }
   ...
   static void method7134(WorldView var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "lo.ct(" + ')');
      }
   }
   ...
   @ObfuscatedName("ax")
   public static String method7130(Buffer var0) {
      String var1;
      try {
         ...
         var0.offset = var0.offset + classLR.method7145(classLF.field4133, var0.array, -1185599464 * var0.offset, var3, 0, var2, 989641049) * -1095856699;
   ...
   @ObfuscatedName("ag")
   public static int method7129(Buffer var0, String var1) {
      int var2 = var0.offset * 702114061;
      byte[] var3 = classVX.method12262(var1, -1987071451);
      var0.method13026(var3.length, 1699258130);
      var0.offset = var0.offset + classLF.field4133.method7143(var3, 0, var3.length, var0.array, var0.offset * 702114061, 951974267) * -1095856699;
      return var0.offset * 702114061 - var2;
   }
   ...
   static int method7135(int var0, Script var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "lo.bv(" + 41);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/String;")
   @ObfuscatedName("as")
   public static String method7131(Buffer var0) {
      String var1;
      try {
         ...
         byte[] var3 = new byte[var2];
         var0.offset = var0.offset + classLR.method7145(classLF.field4133, var0.array, -1035352745 * var0.offset, var3, 0, var2, -1937684609) * 295953285;
