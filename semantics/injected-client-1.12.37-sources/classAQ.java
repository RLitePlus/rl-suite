...
public class classAQ {
   ...
   @ObfuscatedName("as")
   final void method650(Buffer var1) {
      this.field250 = Buffer.method13039(var1, -346779531);
      this.field249 = new int[this.field250];
      this.field251 = new int[this.field250];

      for (int var2 = 0; var2 < this.field250; var2++) {
         this.field249[var2] = Buffer.method13047(var1, -1838758401);
         this.field251[var2] = Buffer.method13047(var1, -1797386924);
      }
   }
   ...
   @ObfuscatedName("ys")
   public static void method645(classAQ var0, Buffer var1) {
      if (var0 == null) {
         var0.method648(var1);
      }

      var0.field259 = Buffer.method13039(var1, -346779531);
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("aa")
   final void method651(Buffer var1) {
      this.field250 = Buffer.method13039(var1, -346779531);
      this.field249 = new int[this.field250];
      this.field251 = new int[this.field250];

      for (int var2 = 0; var2 < this.field250; var2++) {
         this.field249[var2] = Buffer.method13047(var1, -558593366);
         this.field251[var2] = Buffer.method13047(var1, -1806044823);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("az")
   final void method646(Buffer var1) {
      this.field259 = Buffer.method13039(var1, -346779531);
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ag")
   final void method652(Buffer var1) {
      this.field250 = Buffer.method13039(var1, -346779531);
      this.field249 = new int[this.field250];
      this.field251 = new int[this.field250];

      for (int var2 = 0; var2 < this.field250; var2++) {
         this.field249[var2] = Buffer.method13047(var1, -401698618);
         this.field251[var2] = Buffer.method13047(var1, -951704202);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ac")
   final void method653(Buffer var1) {
      this.field250 = Buffer.method13039(var1, -346779531);
      this.field249 = new int[this.field250];
      this.field251 = new int[this.field250];

      for (int var2 = 0; var2 < this.field250; var2++) {
         this.field249[var2] = Buffer.method13047(var1, -924138602);
         this.field251[var2] = Buffer.method13047(var1, 1514957370);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("af")
   final void method647(Buffer var1) {
      this.field259 = Buffer.method13039(var1, -346779531);
      this.field254 = var1.method13056((byte)1);
      this.field258 = var1.method13056((byte)1);
      this.method651(var1);
   ...
   @ObfuscatedName("zy")
   public static int method657(Actor var0) {
      if (var0 == null) {
         var0.method3292();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ax")
   final void method648(Buffer var1) {
      this.field252 = Buffer.method13039(var1, -346779531);
