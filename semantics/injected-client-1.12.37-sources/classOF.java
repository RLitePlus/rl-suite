...
public class classOF extends classVJ {
   ...
   @ObfuscatedName("av")
   static EvictingDualNodeHashTable field4852 = new EvictingDualNodeHashTable(64);
   @ObfuscatedName("at")
   final int[] field4845;
   @ObfuscatedName("bx")
   final int[] field4850;
   ...
   classOF(Buffer var1) {
      ...
      if (null != var1 && null != var1.array) {
         while (true) {
            ...
            switch (var10) {
               case 1:
                  var9 = Buffer.method13039(var1, -346779531);
                  break;
               case 3:
                  var8 = true;
                  break;
               case 5:
                  int var14 = Buffer.method13039(var1, -346779531);
                  var2 = new int[var14];
               ...
               case 40:
                  ...
                  for (int var15 = 0; var15 < var13; var15++) {
                     var3[var15] = (short)Buffer.method13047(var1, -1391345931);
                     var4[var15] = (short)Buffer.method13047(var1, -809343746);
                  }
                  break;
               case 41:
                  ...
                  for (int var12 = 0; var12 < var11; var12++) {
                     var5[var12] = (short)Buffer.method13047(var1, 601297684);
                     var6[var12] = (short)Buffer.method13047(var1, -461039493);
                  }
                  break;
               case 70:
               case 71:
   ...
   public boolean method8412(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "of.ae(" + ')');
      }
   }
   ...
   public boolean method8422(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "of.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("ax")
   public ModelData method8425(int var1) {
      try {
         ...
         for (int var4 = 0; var4 < 5; var4++) {
            ...
            if (-1 != this.field4850[var4]) {
               var2[var3++] = ModelData.method4047(classOX.field5192, this.field4850[var4], 0);
            }
         }
         ...
         throw classEG.newRunException(var6, "of.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("ai")
   public ModelData method8420() {
      if (this.field4845 == null) {
         return null;
      } else {
         ModelData[] var1 = new ModelData[this.field4845.length];

         for (int var2 = 0; var2 < this.field4845.length; var2++) {
            var1[var2] = ModelData.method4047(classOX.field5192, this.field4845[var2], 0);
         }
   ...
   public static classOF method8406(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classOF(new Buffer(var2));
   ...
   public static boolean method8417(classOF var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "of.ab(" + ')');
         }
      }
   }
   ...
   public static void method8409() {
      EvictingDualNodeHashTable.method6431(field4852);
   }
   ...
   @ObfuscatedSignature(descriptor = "()Ler;")
   @ObfuscatedName("at")
   public ModelData method8426() {
      ModelData[] var1 = new ModelData[5];
      int var2 = 0;

      for (int var3 = 0; var3 < 5; var3++) {
         if (-1 != this.field4850[var3]) {
            var1[var2++] = ModelData.method4047(classOX.field5192, this.field4850[var3], 0);
         }
      }
   ...
   @ObfuscatedName("cs")
   public static ModelData method8427(classOF var0) {
      if (var0 == null) {
         ...
         for (int var3 = 0; var3 < 5; var3++) {
            if (-1 != var0.field4850[var3]) {
               var1[var2++] = ModelData.method4047(classOX.field5192, var0.field4850[var3], 0);
            }
         }
   ...
   @ObfuscatedSignature(descriptor = "(I)Ler;")
   @ObfuscatedName("ag")
   public ModelData method8421(int var1) {
      try {
         if (this.field4845 == null) {
            if (var1 == 1835499108) {
               throw new IllegalStateException();
            ...
            ModelData[] var2 = new ModelData[this.field4845.length];
            ...
            for (int var3 = 0; var3 < this.field4845.length; var3++) {
               ...
               var2[var3] = ModelData.method4047(classOX.field5192, this.field4845[var3], 0);
            }
         ...
         throw classEG.newRunException(var5, "of.ag(" + ')');
      }
   }
   ...
   public static classXZ method8404(classXZ[] var0, int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var6, "of.az(" + ')');
      }
   }
