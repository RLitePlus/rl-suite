...
public class classIP extends classHB {
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         this.field3011 = Buffer.method13047(var1, -378925059) * -124079825;
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ip.az(" + ')');
      }
   }
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ip.af(" + ')');
      }
   }
   ...
   void vmethod500(Buffer var1) {
      this.field3011 = Buffer.method13047(var1, 226577069) * -124079825;
   }
   ...
   void vmethod501(Buffer var1) {
      this.field3011 = Buffer.method13047(var1, 1847032448) * -124079825;
   }
   ...
   static int method6232(int var0, Script var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var8, "ip.bx(" + 41);
      }
   }
}
