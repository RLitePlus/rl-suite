...
public class classAL {
   ...
   void method430(Buffer var1) {
      ...
      this.field220 = Buffer.method13047(var1, 839590941);
      this.field219 = Buffer.method13047(var1, -1608476688);
   }
   ...
   classAL(Buffer var1, int var2, classAI var3) {
      this.field216 = var2;
      this.field218 = var3;
      if (var2 == 0) {
         this.method430(var1);
   ...
   @ObfuscatedName("af")
   public static classAL method435(AbstractArchive var0, int var1, int var2) {
   ...
   void method431(Buffer var1) {
      ...
      this.field220 = Buffer.method13047(var1, -196184191);
      this.field219 = Buffer.method13047(var1, 1119115662);
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ao")
   void method432(Buffer var1) {
      this.field217 = 22050;

      for (int var2 = 0; var2 < 10; var2++) {
         int var3 = Buffer.method13039(var1, -346779531);
         if (var3 != 0) {
            var1.offset -= 1304342458;
            this.field215[var2] = new classBG();
            this.field215[var2].method1069(var1);
         }
      }

      this.field220 = Buffer.method13047(var1, 1792945556);
      this.field219 = Buffer.method13047(var1, -1921027467);
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("aa")
   void method433(Buffer var1) {
      this.field217 = 22050;
      ...
      this.field220 = Buffer.method13047(var1, -1458373146);
      this.field219 = Buffer.method13047(var1, -604954218);
   }

   @ObfuscatedSignature(descriptor = "(Lva;II)Lal;")
   @ObfuscatedName("aj")
   public static classAL method436(AbstractArchive var0, int var1, int var2) {
      classAI var3 = new classAI(field221);
   ...
   void method434(Buffer var1) {
      ...
      this.field220 = Buffer.method13047(var1, -188900414);
      this.field219 = Buffer.method13047(var1, -1849689812);
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;II)Lal;")
   @ObfuscatedName("ay")
   public static classAL method437(AbstractArchive var0, int var1, int var2) {
      classAI var3 = new classAI(field221);
