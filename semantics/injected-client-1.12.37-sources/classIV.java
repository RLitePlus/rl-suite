...
public class classIV extends classHB {
   ...
   static void method6320(boolean var0, byte var1) {
      try {
         ...
         if (!AbstractArchive.method11864(-2053271753)) {
            ...
            label91: {
               if (!classOE.client.method2149(1985617997)) {
                  if (var1 == 1) {
                     return;
                  }

                  if (!classOE.client.method2154((byte)80)) {
                     if (var1 == 1) {
                        throw new IllegalStateException();
                     }

                     if (!client.method2152(classOE.client, -956599779)) {
                        break label91;
                     }
         ...
         label81: {
            if (null != classBF.JX_CHARACTER_ID) {
               if (var1 == 1) {
                  return;
               }
         ...
         throw classEG.newRunException(var3, "iv.ap(" + ')');
      }
   }
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "iv.af(" + ')');
      }
   }
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "iv.az(" + ')');
      }
   }
   ...
   static final void method6321(PacketBuffer var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "iv.cm(" + ')');
      }
   }
   ...
   static World method6319(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "iv.ax(" + ')');
      }
   }
}
