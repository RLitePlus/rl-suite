...
public class classQI {
   ...
   void method9553(String var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var8, "qi.ae(" + ')');
      }
   }
   ...
   public static Boolean method9579(classQI var0, String var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "qi.aa(" + ')');
      }
   }
   ...
   void method9549(String var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "qi.af(" + ')');
      }
   }
   ...
   void method9556(String var1, String var2, short var3) {
      try {
         ...
         throw classEG.newRunException(var7, "qi.ab(" + ')');
      }
   }
   ...
   void method9561(String var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "qi.ag(" + ')');
      }
   }
   ...
   int method9565(String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "qi.as(" + 41);
      }
   }
   ...
   void method9583(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qi.ao(" + ')');
      }
   }
   ...
   public static int method9587(CharSequence var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "qi.ao(" + 41);
      }
   }
   ...
   public static long method9568(classQI var0, String var1, byte var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "qi.ax(" + ')');
         }
      }
   }
   ...
   String method9577(String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qi.ac(" + ')');
      }
   }
   ...
   void method9548(String var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var7, "qi.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZB)I")
   @ObfuscatedName("ad")
   static int method9588(int var0, Script var1, boolean var2, byte var3) {
      try {
         boolean var4 = true;
         Widget var5;
         if (var0 >= 2000) {
            ...
            var0 -= 1000;
            var5 = classLY.method7375(classWK.field6691, classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371], (byte)80);
            var4 = false;
         } else {
            Widget var10000;
            if (var2) {
         ...
         if (var0 == 1300) {
            if (var3 == 2) {
               ...
               int var23 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] - 1;
               if (var23 >= 0) {
                  if (var3 == 2) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (var23 < 32) {
                     ...
                     var29 = classUP.method11420(var29, User.method10179(-2032868552), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 == 2) {
               ...
               int var22 = classBB.field323[DynamicObject.field1679 * -324749371];
            ...
            if (var3 == 2) {
               ...
               var5.field4368 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * 230129403;
               return 1;
            }
         } else if (var0 == 1304) {
            if (var3 == 2) {
               ...
               var5.field4313 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] * -2074329479;
               return 1;
            }
         } else if (var0 == 1305) {
            if (var3 == 2) {
               ...
               var20 = classUP.method11420(var20, User.method10179(-1357449656), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 == 2) {
               ...
               var18 = classUP.method11420(var18, User.method10179(-860122174), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 == 2) {
               ...
               int var17 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] - 1;
               if (var17 >= 0) {
                  if (var3 == 2) {
                     throw new IllegalStateException();
                  }
            ...
            int var16 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] - 1;
            int var27 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] - 1;
            if (var27 >= 0) {
               if (var3 == 2) {
                  throw new IllegalStateException();
               }
               ...
               if (var27 <= 9) {
                  ...
                  if (var16 >= 0) {
                     ...
                     var36 = classUP.method11420(var36, User.method10179(-77610910), classBB.field334, classBB.field333, (byte)0);
            ...
            if (var3 == 2) {
               ...
               if (var4) {
                  ...
                  for (var33 = 0; var33 < 10; var33 += 2) {
                     ...
                     if (classBB.field323[DynamicObject.field1679 * -324749371 + var33] < 0) {
                        if (var3 == 2) {
                           throw new IllegalStateException();
                        }
                        break;
                  ...
                  if (var33 > 0) {
                     ...
                     for (int var34 = var33 - 2; var34 >= 0; var34 -= 2) {
                        var14[var34 / 2] = (byte)classBB.field323[DynamicObject.field1679 * -324749371 + var34];
                        var26[var34 / 2] = (byte)classBB.field323[1 + DynamicObject.field1679 * -324749371 + var34];
                     }
                  }
               } else {
                  DynamicObject.field1679 -= 240082458;
                  var14 = new byte[]{(byte)classBB.field323[DynamicObject.field1679 * -324749371]};
                  var26 = new byte[]{(byte)classBB.field323[DynamicObject.field1679 * -324749371 + 1]};
               }

               int var35 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] - 1;
               if (var35 >= 0) {
                  if (var35 <= 9) {
            ...
            DynamicObject.field1679 -= 240082458;
            byte var13 = 10;
            byte[] var25 = new byte[]{(byte)classBB.field323[-324749371 * DynamicObject.field1679]};
            byte[] var32 = new byte[]{(byte)classBB.field323[DynamicObject.field1679 * -324749371 + 1]};
            ...
            if (var3 == 2) {
               ...
               int var12 = classBB.field323[DynamicObject.field1679 * -324749371] - 1;
               int var24 = classBB.field323[1 + DynamicObject.field1679 * -324749371];
               int var31 = classBB.field323[-324749371 * DynamicObject.field1679 + 2];
               if (var12 >= 0) {
                  if (var12 <= 9) {
                     CollisionMap.method5382(var5, var12, var24, var31, 2090793764);
                     return 1;
                  }
            ...
            if (var3 == 2) {
               ...
               CollisionMap.method5382(var5, var11, var7, var8, 1253285194);
               return 1;
            }
         } else if (var0 == 1354) {
            if (var3 == 2) {
               ...
               DynamicObject.field1679 -= 120041229;
               int var10 = classBB.field323[DynamicObject.field1679 * -324749371] - 1;
               if (var10 >= 0) {
                  if (var3 == 2) {
                     throw new IllegalStateException();
                  }
         ...
         throw classEG.newRunException(var9, "qi.ad(" + 41);
      }
   }
