...
public class classLI {
   ...
   public static String method7107(classTE var0, String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var10, "li.ai(" + ')');
      }
   }
   ...
   static int method7106(World var0, World var1, int var2, boolean var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var7, "li.as(" + 41);
      }
   }
   ...
   public static void method7108(int var0) {
      try {
         EvictingDualNodeHashTable.method6431(ItemComposition.field5006);
         EvictingDualNodeHashTable.method6431(ItemComposition.field5007);
         EvictingDualNodeHashTable.method6431(ItemComposition.field5008);
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "li.as(" + ')');
      }
   }
   ...
   static int method7109(int var0, Script var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var6, "li.am(" + 41);
      }
   }
}
