...
public class Menu implements net.runelite.api.Menu {
   ...
   public final void method12653(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "wz.ae(" + ')');
      }
   }
   ...
   public static void method12685(Menu var0) {
      ...
      int var4 = MouseHandler.MouseHandler_x * -38255113;
      int var5 = -2144333897 * MouseHandler.MouseHandler_y;
   ...
   public final void method12661(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "wz.as(" + ')');
      }
   }
   ...
   public final void method12673(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "wz.aa(" + ')');
      }
   }
   ...
   public final int method12683(String var1, String var2, int var3, int var4, int var5, int var6, int var7, boolean var8, int var9, int var10) {
      try {
         ...
         throw classEG.newRunException(var11, "wz.aj(" + 41);
      }
   }
   ...
   final void method12680(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "wz.al(" + ')');
      }
   }
   ...
   public final boolean method12670(int var1, int var2, short var3) {
      try {
         ...
         throw classEG.newRunException(var5, "wz.ac(" + ')');
      }
   }
   ...
   public static void method12688(Menu var0) {
      if (var0 == null) {
         ...
         int var4 = MouseHandler.MouseHandler_x * 613408966;
         int var5 = -1630179091 * MouseHandler.MouseHandler_y;
   ...
   public static boolean method12701(Menu var0, int var1, int var2, int var3) {
      ...
      if (var0.field6816 * -1985221643 != -1
         ...
         if (var5 != -1 && var5 != var0.field6816 * -1985221643) {
            long var6 = classOE.client.getGameCycle();
            int var8 = var5;
            ...
            if (var0.field6819 * -7988158060854933767L <= var6) {
               ...
               if (var11 != null) {
                  ...
                  client.field1072 = 0;
                  client.field1080 = 0;
                  if (var11.field6814 * -531540521 > classOE.client.getCanvasHeight()) {
                     client.field1080 = 0;
                     client.field1072 = (var11.field6814 * -531540521 - classOE.client.getCanvasHeight() + 14) / 15;
                  }
               }
            }
         }
   ...
   public final void method12678(int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "wz.ao(" + ')');
      }
   }
   ...
   public static String method12648(Menu var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "wz.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   public static int method12644(Buffer var0, String var1, int var2) {
      try {
         int var3 = var0.offset * 702114061;
         byte[] var4 = classVX.method12262(var1, -1925400387);
         var0.method13026(var4.length, -1454653314);
         var0.offset = var0.offset + classLF.field4133.method7143(var4, 0, var4.length, var0.array, var0.offset * 702114061, -962292593) * -1095856699;
         return var0.offset * 702114061 - var3;
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "wz.af(" + 41);
      }
   }
   ...
   static void method12650(int var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var9, "wz.ab(" + ')');
      }
   }
   ...
   public final boolean method12702(int var1, int var2, int var3) {
      ...
      if (this.field6815 * -1985221643 != -1
         ...
         if (var5 != -1 && var5 != this.field6813 * -1985221643) {
            long var6 = classOE.client.getViewportYOffset();
            int var8 = var5;
            ...
            if (this.field6819 * -7988158060854933767L <= var6) {
               ...
               if (var11 != null) {
                  ...
                  client.field1096 = 0;
                  client.field1079 = 0;
                  if (var11.field6812 * -531540521 > classOE.client.getCameraMode()) {
                     client.field1084 = 0;
                     client.field1081 = (var11.field6817 * -531540521 - classOE.client.getCameraPitchTarget() + 14) / 15;
                  }
               }
            }
         }
