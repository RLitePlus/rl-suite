...
public class classGL extends classHA {
   ...
   void vmethod467(Buffer var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var5, "gl.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(ILbl;ZI)I")
   @ObfuscatedName("bw")
   static int method5496(int var0, Script var1, boolean var2, int var3) {
      try {
         if (3903 == var0) {
            if (var3 <= -53251402) {
               throw new IllegalStateException();
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = client.field864[var35].method7613(383438983);
               return 1;
            }
         } else if (3904 == var0) {
            if (var3 <= -53251402) {
               ...
               int var34 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = client.field864[var34].field4535 * 1561057361;
               return 1;
            }
         } else if (var0 == 3905) {
            if (var3 <= -53251402) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = client.field864[var33].field4534 * -1718041163;
               return 1;
            }
         } else if (3906 == var0) {
            if (var3 <= -53251402) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 29846541 * client.field864[var32].field4536;
               return 1;
            }
         } else if (3907 == var0) {
            int var31 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = client.field864[var31].field4537 * 834365773;
            return 1;
         } else if (var0 == 3908) {
            if (var3 <= -53251402) {
               throw new IllegalStateException();
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 464461553 * client.field864[var30].field4538;
               return 1;
            }
         } else if (3910 == var0) {
            int var29 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
            int var46 = GrandExchangeOffer.method7607(client.field864[var29], (short)3906);
            int[] var55 = classBB.field323;
            int var61 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
            byte var67;
            if (var46 == 0) {
               if (var3 <= -53251402) {
                  throw new IllegalStateException();
            ...
            int var45 = GrandExchangeOffer.method7607(client.field864[var28], (short)3906);
            int[] var54 = classBB.field323;
            int var60 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
            byte var66;
            if (var45 == 2) {
               if (var3 <= -53251402) {
                  throw new IllegalStateException();
            ...
            if (var3 <= -53251402) {
               ...
               int var59 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
               byte var65;
               if (5 == var44) {
                  if (var3 <= -53251402) {
                     throw new IllegalStateException();
            ...
            if (var3 <= -53251402) {
               ...
               int var58 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
               byte var64;
               if (var43 == 1) {
                  if (var3 <= -53251402) {
                     throw new IllegalStateException();
            ...
            if (var3 <= -53251402) {
               ...
               boolean var24 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371] == 1;
               if (null != classON.field4994) {
                  if (var3 <= -53251402) {
                     throw new IllegalStateException();
                  }
            ...
            if (var3 <= -53251402) {
               ...
               boolean var50;
               if (1 == classBB.field323[-324749371 * DynamicObject.field1679]) {
                  if (var3 <= -53251402) {
                     throw new IllegalStateException();
                  }
               ...
               boolean var23 = var50;
               boolean var42 = classBB.field323[1 + -324749371 * DynamicObject.field1679] == 1;
            ...
            int var57 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
            int var63;
            if (classON.field4994 == null) {
               if (var3 <= -53251402) {
                  throw new IllegalStateException();
            ...
            if (var3 <= -53251402) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var41.field4686 * -906797091;
               return 1;
            }
         } else if (var0 == 3921) {
            if (var3 <= -53251402) {
            ...
            if (var3 <= -53251402) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 29846541 * var37.field4685.field4536;
               return 1;
            }
         } else if (3925 == var0) {
            if (var3 <= -53251402) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var36.field4685.field4534 * -1718041163;
               return 1;
            }
         } else if (var0 == 3926) {
            ...
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = var5.field4685.field4535 * 1561057361;
            return 1;
         } else if (3931 == var0) {
            if (var3 <= -53251402) {
               throw new IllegalStateException();
               ...
               int var56 = (DynamicObject.field1679 += 120041229) * -324749371 - 1;
               byte var62;
         ...
         throw classEG.newRunException(var12, "gl.bw(" + 41);
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var3, "gl.equals(" + ')');
      }
   }
   ...
   public int hashCode() {
      try {
         ...
         throw classEG.newRunException(var1, "gl.hashCode(" + 41);
      }
   }
   ...
   @ObfuscatedName("va")
   public static void method5487(classGL var0, Buffer var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            if (classHI.field2802.field2801 * 1177860011 != var3) {
               ...
               var0.field2754 = Buffer.method13047(var1, -1098287353) * -735630941;
               var0.field2755 = Buffer.method13047(var1, 1575481484) * -1209921667;
               var0.field2751 = Buffer.method13047(var1, 481720397) * -1652832041;
               var0.field2750 = Buffer.method13047(var1, -1142101059) * -1381327085;
            }
         } catch (RuntimeException var4) {
            throw classEG.newRunException(var4, "gl.az(" + ')');
         }
      }
   }
   ...
   static float method5489(classSU var0, float var1, byte var2) {
      try {
         if (null != var0) {
            ...
            if (var0.method10685((byte)-26) != 0) {
               if (var1 < var0.field6068[0].field6103 * 1210377865) {
                  ...
                  return NpcOverrides.method9087(var0, var1, true, (byte)1);
               }
               ...
               if (var1 > var0.field6068[var0.method10685((byte)-120) - 1].field6103 * 1210377865) {
                  ...
                  return NpcOverrides.method9087(var0, var1, false, (byte)1);
               }
                     ...
                     label258: {
                        ...
                        if (null != var3.field6104) {
                           ...
                           if (var0.field6045) {
                              ...
                              if (var0.field6064) {
                                 Projectile.method1220(var0, var6, var7, var8, var9, var10, var11, var12, var13, (byte)-94);
                              } else if (var0 == null) {
                                 if (var2 != 127) {
                                    throw new IllegalStateException();
                                 }
         ...
         throw classEG.newRunException(var22, "gl.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("az")
   void method5488(Buffer var1, int var2) {
      try {
         int var3 = Buffer.method13039(var1, -346779531);
         if (classHI.field2803.field2801 * 1177860011 != var3) {
            ...
            super.field2752 = Buffer.method13039(var1, -346779531) * -2015926021;
            super.field2754 = Buffer.method13039(var1, -346779531) * -765552747;
            super.field2753 = Buffer.method13047(var1, -1098287353) * -735630941;
            super.field2753 = Buffer.method13047(var1, 1575481484) * -1209921667;
            super.field2755 = Buffer.method13047(var1, 481720397) * -1652832041;
            this.field2750 = Buffer.method13047(var1, -1142101059) * -1381327085;
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "gl.az(" + ')');
      }
