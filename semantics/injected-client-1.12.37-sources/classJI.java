...
public class classJI {
   ...
   @ObfuscatedName("bb")
   public static AbstractArchive field3167;
   @ToRemove(unused = "true")
   @ObfuscatedName("bf")
   ...
   @ObfuscatedName("az")
   static classNR method6371(AbstractArchive var0, int var1, int var2) {
      try {
         byte[] var3 = AbstractArchive.method11814(var0, var1, -1717700222);
         return null == var3 ? null : new classNR(var3);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ji.az(" + ')');
      }
   }
