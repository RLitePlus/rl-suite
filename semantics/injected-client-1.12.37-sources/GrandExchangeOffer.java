...
public class GrandExchangeOffer implements net.runelite.api.GrandExchangeOffer {
   ...
   public GrandExchangeOffer(Buffer var1, boolean var2) {
      this.field4539 = Buffer.method13043(var1, (byte)17);
      this.field4535 = Buffer.method13047(var1, 1747243124) * 443314353;
   ...
   void method7603(Integer var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "mm.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("ac")
   static Integer method7599(Buffer var0) {
      int var1 = 0;
      boolean var2 = false;
      ...
      while (true) {
         ...
         while (true) {
            ...
            var0.offset -= -507022095;
            if (Buffer.method13047(var0, 1291323804) != 0) {
               throw new IllegalStateException("");
            }
   ...
   public static void method7615(GrandExchangeOffer var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "mm.as(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/Integer;")
   @ObfuscatedName("ax")
   static Integer method7600(Buffer var0) {
      int var1 = 0;
      boolean var2 = false;
      ...
      while (true) {
         ...
         while (true) {
            ...
            var0.offset -= -1095856699;
            if (Buffer.method13047(var0, 1780122919) != 0) {
               throw new IllegalStateException("");
            }
   ...
   static void method7621(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "mm.ax(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/Integer;")
   @ObfuscatedName("aa")
   static Integer method7601(Buffer var0) {
      int var1 = 0;
      boolean var2 = false;
      ...
      while (true) {
         ...
         while (true) {
            ...
            var0.offset -= -1095856699;
            if (Buffer.method13047(var0, -1852010553) != 0) {
               throw new IllegalStateException("");
            }
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)Ljava/lang/Integer;")
   @ObfuscatedName("ao")
   static Integer method7602(Buffer var0) {
      int var1 = 0;
      boolean var2 = false;
      ...
      while (true) {
         ...
         while (true) {
            ...
            var0.offset -= -1095856699;
            if (Buffer.method13047(var0, -1630959316) != 0) {
               throw new IllegalStateException("");
            }
   ...
   void method7611(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "mm.ab(" + ')');
      }
   }
   ...
   public static int method7607(GrandExchangeOffer var0, short var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "mm.ae(" + 41);
         }
      }
   }
   ...
   public int method7613(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "mm.ag(" + 41);
      }
   }
   ...
   static void method7620(WorldView var0, Actor var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "mm.ax(" + ')');
      }
   }
   ...
   static boolean method7619(Model var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var16, "mm.ar(" + ')');
      }
   }
