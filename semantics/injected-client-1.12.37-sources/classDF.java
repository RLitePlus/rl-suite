...
public class classDF {
   ...
   static void method3053(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var6, "df.hr(" + ')');
      }
   }
   ...
   final void method2999(PacketBuffer var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var11, "df.af(" + ')');
      }
   }
   ...
   void method3028(WorldView var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var9, "df.ao(" + ')');
      }
   }
   ...
   boolean method3017(PacketBuffer var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var14, "df.ax(" + ')');
      }
   }
   ...
   void method3019(byte var1) {
      try {
         ...
         throw classEG.newRunException(var8, "df.ac(" + ')');
      }
   }
   ...
   void method3022(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "df.aa(" + ')');
      }
   }
   ...
   void method3032(PacketBuffer var1, int var2) {
      try {
         for (int var3 = 0; var3 < this.field1413 * -764574691; var3++) {
            ...
            if ((var5 & 128) != 0) {
               var5 += Buffer.method13039(var1, -346779531) << 8;
            }
            ...
            if (0 != (var5 & 8192)) {
               ...
               var5 += Buffer.method13039(var1, -346779531) << 16;
            }

            this.method3037(var1, var4, var5, -774455835);
         }
      } catch (RuntimeException var6) {
         throw classEG.newRunException(var6, "df.al(" + ')');
      }
   }
   ...
   void method3036(PacketBuffer var1, int var2, int var3) {
      ...
      if ((var3 & 2) != 0) {
         Buffer.method13194(var1, -1242549664);
         Buffer.method13039(var1, -346779531);
         var1.method13159((byte)-21);
         int var6 = var1.method13159((byte)-86);
         this.field1414.offset = 0;
         var1.method13084(this.field1414.array, 0, var6, (byte)111);
         this.field1414.offset = 0;
      }
      ...
      if ((var3 & 32) != 0) {
         ...
         for (int var7 = 0; var7 < var16; var7++) {
            ...
            int var9 = Buffer.method13194(var1, 1808170009);
      ...
      if ((var3 & 4096) != 0) {
         int var17 = Buffer.method13047(var1, -1519016485);
         int var30 = var17 >> 8;
         ...
         this.field1414.offset = 0;
         var1.method13255(this.field1414.array, 0, var63, 1726036428);
         this.field1414.offset = 0;
      ...
      if ((var3 & 4) != 0) {
         ...
         Buffer var42 = new Buffer(var32);
         var1.method13252(var32, 0, var19, -1366881648);
         var4.method2927(var42, 1555374895);
      }

      if (0 != (var3 & 262144)) {
         int var20 = Buffer.method13197(var1, -491609919);
         if (65535 == var20) {
            var20 = -1;
         }

         int var33 = Buffer.method13194(var1, 634982806);
         if (var33 == 65535) {
            var33 = -1;
         }
      ...
      if ((var3 & 64) != 0) {
         int var21 = Buffer.method13039(var1, -346779531);
      ...
      if ((var3 & 524288) != 0) {
         ...
         for (int var34 = 0; var34 < var23; var34++) {
            ...
            int var51 = Buffer.method13194(var1, -1437556953);
      ...
      if ((var3 & 32768) != 0) {
         byte var26 = Buffer.method13043(var1, (byte)17);
         byte var37 = var1.method13179((byte)73);
         byte var47 = Buffer.method13043(var1, (byte)17);
         byte var54 = Buffer.method13043(var1, (byte)17);
      ...
      if ((var3 & 1024) != 0) {
         ...
         byte var55 = Buffer.method13169(var1, (byte)120);
         byte var62 = Buffer.method13043(var1, (byte)17);
   ...
   void method3047(byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "df.ad(" + ')');
      }
   }
   ...
   void method3037(PacketBuffer var1, int var2, int var3, int var4) {
      try {
         ...
         if ((var3 & 2) != 0) {
            ...
            Buffer.method13194(var1, 673858310);
            Buffer.method13039(var1, -346779531);
            var1.method13159((byte)-83);
            int var7 = var1.method13159((byte)-56);
            this.field1414.offset = 0;
            var1.method13084(this.field1414.array, 0, var7, (byte)28);
            this.field1414.offset = 0;
         }
         ...
         if ((var3 & 32) != 0) {
            ...
            for (int var8 = 0; var8 < var18; var8++) {
               ...
               int var10 = Buffer.method13194(var1, 358439582);
         ...
         if ((var3 & 4096) != 0) {
            ...
            int var19 = Buffer.method13047(var1, -1252432806);
            int var32 = var19 >> 8;
            ...
            this.field1414.offset = 0;
            var1.method13255(this.field1414.array, 0, var65, 2020962747);
            this.field1414.offset = 0;
         ...
         if (0 != (var3 & 262144)) {
            ...
            int var22 = Buffer.method13197(var1, 1154591916);
            if (65535 == var22) {
               if (var4 != -774455835) {
                  throw new IllegalStateException();
               }
            ...
            int var35 = Buffer.method13194(var1, -453141936);
            if (var35 == 65535) {
               if (var4 != -774455835) {
                  throw new IllegalStateException();
               }
         ...
         if ((var3 & 64) != 0) {
            ...
            int var23 = Buffer.method13039(var1, -346779531);
         ...
         if ((var3 & 524288) != 0) {
            ...
            for (int var36 = 0; var36 < var25; var36++) {
               ...
               int var53 = Buffer.method13194(var1, 825001690);
         ...
         if ((var3 & 32768) != 0) {
            ...
            byte var28 = Buffer.method13043(var1, (byte)17);
            byte var39 = var1.method13179((byte)-17);
            byte var49 = Buffer.method13043(var1, (byte)17);
            byte var56 = Buffer.method13043(var1, (byte)17);
         ...
         if ((var3 & 1024) != 0) {
            ...
            byte var57 = Buffer.method13169(var1, (byte)29);
            byte var64 = Buffer.method13043(var1, (byte)17);
         ...
         throw classEG.newRunException(var16, "df.ay(" + ')');
      }
   }
   ...
   classDF() {
      this.field1414 = new Buffer(new byte[5000]);
   ...
   public static void method3041(classDF var0, Player var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "df.aq(" + ')');
      }
   }
   ...
   final void method3001(PacketBuffer var1, int var2) {
      int var3 = 702114061 * var1.offset;
      this.field1413 = 0;
      ...
      if (702114061 * var1.offset - var3 != var2) {
         throw new RuntimeException(832602734 * var1.offset - var3 + " " + var2);
      }
   }
   ...
   classSJ method2996(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "df.az(" + ')');
      }
   }
   ...
   public static int method3009(classDF var0, PacketBuffer var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "df.ag(" + 41);
         }
      }
   }
   ...
   void method3038(PacketBuffer var1, int var2, int var3) {
      ...
      if ((var3 & 2) != 0) {
         Buffer.method13194(var1, 1507836287);
         Buffer.method13039(var1, -346779531);
         var1.method13159((byte)-101);
         int var6 = var1.method13159((byte)-67);
         this.field1414.offset = 0;
         var1.method13084(this.field1414.array, 0, var6, (byte)96);
         this.field1414.offset = 0;
      }
      ...
      if ((var3 & 32) != 0) {
         ...
         for (int var7 = 0; var7 < var16; var7++) {
            ...
            int var9 = Buffer.method13194(var1, -1704471726);
            int var10 = var1.method13056((byte)1);
      ...
      if ((var3 & 4096) != 0) {
         int var17 = Buffer.method13047(var1, 1843894807);
         int var30 = var17 >> 8;
         int var40 = var30 >= 13 && var30 <= 20 ? var30 - 12 : 0;
         ...
         this.field1414.offset = 0;
         var1.method13255(this.field1414.array, 0, var63, 1408281021);
         this.field1414.offset = 0;
      ...
      if (0 != (var3 & 262144)) {
         int var20 = Buffer.method13197(var1, 536431689);
         if (65535 == var20) {
            var20 = -1;
         }

         int var33 = Buffer.method13194(var1, 1457152750);
         if (var33 == 1487282291) {
            var33 = -1;
         }
      ...
      if ((var3 & -461195278) != 0) {
         ...
         for (int var34 = 0; var34 < var23; var34++) {
            ...
            int var51 = Buffer.method13194(var1, -1284793398);
            int var58 = var1.method13241(-2100807916);
      ...
      if ((var3 & -1497164894) != 0) {
         ...
         byte var48 = var1.method13175((byte)-41);
         byte var55 = Buffer.method13169(var1, (byte)21);
         byte var62 = Buffer.method13043(var1, (byte)17);
   ...
   void method3039(PacketBuffer var1, int var2, int var3) {
      ...
      if ((var3 & 2) != 0) {
         Buffer.method13194(var1, 2119349051);
         Buffer.method13039(var1, -346779531);
         var1.method13159((byte)-46);
         int var6 = var1.method13159((byte)-65);
         this.field1414.offset = 0;
         var1.method13084(this.field1414.array, 0, var6, (byte)105);
         this.field1414.offset = 0;
      }
      ...
      if ((var3 & 32) != 0) {
         ...
         for (int var7 = 0; var7 < var16; var7++) {
            ...
            int var9 = Buffer.method13194(var1, 392602703);
            int var10 = var1.method13056((byte)1);
      ...
      if ((var3 & 4096) != 0) {
         int var17 = Buffer.method13047(var1, -1552996856);
         int var30 = var17 >> 8;
         int var40 = var30 >= 13 && var30 <= 20 ? var30 - 12 : 0;
         ...
         this.field1414.offset = 0;
         var1.method13255(this.field1414.array, 0, var63, 905340165);
         this.field1414.offset = 0;
      ...
      if (0 != (var3 & 262144)) {
         int var20 = Buffer.method13197(var1, 2132536915);
         if (65535 == var20) {
            var20 = -1;
         }

         int var33 = Buffer.method13194(var1, 971878551);
         if (var33 == 65535) {
            var33 = -1;
         }
      ...
      if ((var3 & 524288) != 0) {
         ...
         for (int var34 = 0; var34 < var23; var34++) {
            ...
            int var51 = Buffer.method13194(var1, -193908467);
            int var58 = var1.method13241(-2100807916);
      ...
      if ((var3 & 1024) != 0) {
         ...
         byte var55 = Buffer.method13169(var1, (byte)11);
         byte var62 = Buffer.method13043(var1, (byte)17);
   ...
   void method3040(PacketBuffer var1, int var2, int var3) {
      ...
      if ((var3 & 2) != 0) {
         Buffer.method13194(var1, -1023998179);
         Buffer.method13039(var1, -346779531);
         var1.method13159((byte)-59);
         int var6 = var1.method13159((byte)-4);
         this.field1414.offset = 0;
         var1.method13084(this.field1414.array, 0, var6, (byte)122);
         this.field1414.offset = 0;
      }
      ...
      if ((var3 & 32) != 0) {
         ...
         for (int var7 = 0; var7 < var16; var7++) {
            ...
            int var9 = Buffer.method13194(var1, 1621871389);
            int var10 = var1.method13056((byte)1);
      ...
      if ((var3 & 4096) != 0) {
         int var17 = Buffer.method13047(var1, -1726221169);
         int var30 = var17 >> 8;
         int var40 = var30 >= 13 && var30 <= 20 ? var30 - 12 : 0;
         ...
         this.field1414.offset = 0;
         var1.method13255(this.field1414.array, 0, var63, 851186209);
         this.field1414.offset = 0;
      ...
      if (0 != (var3 & 262144)) {
         int var20 = Buffer.method13197(var1, 968514833);
         if (65535 == var20) {
            var20 = -1;
         }

         int var33 = Buffer.method13194(var1, 1303374362);
         if (var33 == 65535) {
            var33 = -1;
         }
      ...
      if ((var3 & 524288) != 0) {
         ...
         for (int var34 = 0; var34 < var23; var34++) {
            ...
            int var51 = Buffer.method13194(var1, -267156906);
            int var58 = var1.method13241(-2100807916);
      ...
      if ((var3 & 1024) != 0) {
         ...
         byte var55 = Buffer.method13169(var1, (byte)61);
         byte var62 = Buffer.method13043(var1, (byte)17);
   ...
   final void method3002(PacketBuffer var1, int var2, int var3) {
      ...
      try {
         int var4 = 702114061 * var1.offset;
         this.field1413 = 0;
         method3008(this, var1, 448842070);
         this.method3019((byte)13);
         ...
         if (702114061 * var1.offset - var4 != var2) {
            if (var3 >= 1992762500) {
               throw new IllegalStateException();
            } else {
               throw new RuntimeException(702114061 * var1.offset - var4 + " " + var2);
            }
         } else {
            this.method3054(var1, var2);
         }
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "df.ae(" + ')');
      }
   }
   ...
   public static int method3050(classDF var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "df.ap(" + 41);
      }
   }
   ...
   public static void method3015(classDF var0, PacketBuffer var1, int var2, byte var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var13, "df.as(" + ')');
         }
      }
   }
   ...
   final void method3003(PacketBuffer var1, int var2) {
      ...
      if (702114061 * var1.offset - var3 != var2) {
         throw new RuntimeException(702114061 * var1.offset - var3 + " " + var2);
      }
   }
   ...
   public static void method3035(classDF var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "df.aj(" + ')');
         }
      }
   }
   ...
   public static classKE method2994(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var6, "df.az(" + ')');
      }
   }
   ...
   public static void method3008(classDF var0, PacketBuffer var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var7, "df.ab(" + ')');
      }
   }
