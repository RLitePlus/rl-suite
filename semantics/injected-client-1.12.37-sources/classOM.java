...
public class classOM extends classVJ implements ObjectComposition, rl9 {
   ...
   @ObfuscatedName("cb")
   static EvictingDualNodeHashTable field4966 = new EvictingDualNodeHashTable(4096);
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ct")
   public static EvictingDualNodeHashTable field4968 = new EvictingDualNodeHashTable(500);
   @ToRemove(unused = "true")
   @ObfuscatedName("az")
   static final int field4925 = 2;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("cd")
   static EvictingDualNodeHashTable field4972 = new EvictingDualNodeHashTable(256);
   @ObfuscatedName("cp")
   static boolean field4971 = false;
   @ObfuscatedSignature(descriptor = "[Ler;")
   @ObfuscatedName("cs")
   static ModelData[] field4969 = new ModelData[4];
   @ObfuscatedName("cy")
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("cv")
   static EvictingDualNodeHashTable field4967 = new EvictingDualNodeHashTable(256);
   @ObfuscatedName("dr")
   ...
   @ObfuscatedName("dp")
   IterableNodeHashTable field4931;
   ...
   public static classWW method8577(classOM var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "om.ai(" + ')');
      }
   }
   ...
   classPO method8527(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "om.ag(" + ')');
      }
   }

   classOM(Buffer var1, int var2, boolean var3) {
      ...
      boolean var43 = true;
      boolean var44 = false;
      IterableNodeHashTable var45 = null;
      if (var1 != null && var1.array != null) {
         label317:
         while (true) {
            int var46 = Buffer.method13039(var1, -346779531);
            switch (var46) {
               case 0:
                  break label317;
               case 1:
               ...
               case 6:
                  ...
                  if (null != var4 && !field4971) {
                     var1.offset = var1.offset + var61 * (classXM.field6888.method12840((byte)3) + 1) * -1095856699;
                  } else {
                     var5 = new int[var61];
                     var4 = new int[var61];
                     ...
                     for (int var68 = 0; var68 < var61; var68++) {
                        ...
                        var5[var68] = Buffer.method13039(var1, -346779531);
                     }
                  }
                  break;
               case 7:
                  int var60 = Buffer.method13039(var1, -346779531);
                  if (var60 <= 0) {
                     break;
                  }

                  if (var4 != null && !field4971) {
                     var1.offset = var1.offset + var60 * classXM.field6888.method12840((byte)3) * -1095856699;
                  } else {
                     var5 = null;
                     var4 = new int[var60];
               ...
               case 18:
                  ...
                  break;
               case 19:
                  var15 = Buffer.method13039(var1, -346779531);
                  break;
               case 21:
                  var16 = 0;
                  break;
               ...
               case 23:
                  ...
                  break;
               case 24:
                  var19 = Buffer.method13047(var1, -1323360305);
                  if (65535 == var19) {
                     var19 = -1;
                  }
                  break;
               ...
               case 28:
                  ...
                  break;
               case 29:
                  var21 = Buffer.method13043(var1, (byte)17);
                  break;
               case 30:
               case 31:
               case 32:
               ...
               case 102:
                  ...
                  break;
               case 39:
                  var22 = Buffer.method13043(var1, (byte)17) * 5;
                  break;
               case 40:
                  int var59 = Buffer.method13039(var1, -346779531);
                  var7 = new short[var59];
                  var8 = new short[var59];

                  for (int var66 = 0; var66 < var59; var66++) {
                     var7[var66] = (short)Buffer.method13047(var1, -1846630518);
                     var8[var66] = (short)Buffer.method13047(var1, -2047651131);
                  }
                  break;
               case 41:
                  int var58 = Buffer.method13039(var1, -346779531);
                  var9 = new short[var58];
                  var10 = new short[var58];

                  for (int var65 = 0; var65 < var58; var65++) {
                     var9[var65] = (short)Buffer.method13047(var1, -102554966);
                     var10[var65] = (short)Buffer.method13047(var1, 1164501279);
                  }
                  break;
               case 61:
                  Buffer.method13047(var1, -172294366);
                  break;
               case 62:
                  var26 = true;
                  break;
               case 64:
                  ...
                  break;
               case 65:
                  var28 = Buffer.method13047(var1, -2080287386);
                  break;
               case 66:
                  var29 = Buffer.method13047(var1, 38657320);
                  break;
               case 67:
                  var30 = Buffer.method13047(var1, 1915859492);
                  break;
               case 68:
                  var25 = Buffer.method13047(var1, -641531789);
                  break;
               case 69:
               ...
               case 74:
                  ...
                  break;
               case 75:
                  var36 = Buffer.method13039(var1, -346779531);
                  break;
               case 77:
               case 92:
                  var39 = Buffer.method13047(var1, 1946771396);
                  if (65535 == var39) {
                     var39 = -1;
                  }

                  var40 = Buffer.method13047(var1, -1928013773);
                  if (var40 == 65535) {
                     var40 = -1;
                  }
                  ...
                  int var57 = -1;
                  if (92 == var46) {
                     var57 = Buffer.method13047(var1, 1361074484);
                     if (65535 == var57) {
                        var57 = -1;
                     }
                  }

                  int var64 = Buffer.method13039(var1, -346779531);
                  var38 = new int[2 + var64];
                  int var69 = 0;

                  for (; var69 <= var64; var69++) {
                     var38[var69] = Buffer.method13047(var1, -1528622532);
                  ...
                  break;
               case 78:
                  var41.field6689 = Buffer.method13047(var1, -1827717086) * -418754533;
                  var41.field6686 = Buffer.method13039(var1, -346779531) * 39261697;
                  var41.field6688 = Buffer.method13039(var1, -346779531) * -286691225;
                  break;
               case 79:
                  var42.field6784 = Buffer.method13047(var1, -1148648289) * -1412665981;
                  var42.field6783 = Buffer.method13047(var1, -564967977) * -736985931;
                  var41.field6686 = Buffer.method13039(var1, -346779531) * 39261697;
                  var41.field6688 = Buffer.method13039(var1, -346779531) * -286691225;
                  int var56 = Buffer.method13039(var1, -346779531);
                  var42.field6785 = new int[var56];

                  for (int var63 = 0; var63 < var56; var63++) {
                     var42.field6785[var63] = Buffer.method13047(var1, 10166996);
                  }
                  break;
               case 81:
                  var16 = Buffer.method13039(var1, -346779531) * 256;
                  break;
               case 82:
                  var24 = Buffer.method13047(var1, -467223174);
                  break;
               case 89:
                  var43 = false;
                  break;
               ...
               case 91:
                  ...
                  int var49 = Buffer.method13039(var1, -346779531);
                  classZL var62 = classZL.field7201[var49];
                  var55.method12320(var62, -179178084);
                  break;
               case 93:
                  int var48 = Buffer.method13039(var1, -346779531);
                  classZL var47 = classZL.field7201[var48];
                  int var50 = Buffer.method13047(var1, 885772415) * 20;
                  var41.field6687.method12314(var47, var50, (byte)81);
                  int var52 = Buffer.method13039(var1, -346779531);
                  classZL var51 = classZL.field7201[var52];
                  int var54 = Buffer.method13047(var1, 1322257324) * 20;
                  var41.field6687.method12317(var51, var54, -388881497);
                  break;
               case 95:
                  var41.field6690 = (classKC)classOF.method8404(classHF.method6005(-966579297), Buffer.method13039(var1, -346779531), 145379329);
                  break;
               case 96:
                  var37 = Buffer.method13039(var1, -346779531);
                  break;
               case 249:
      ...
      if (null == var45) {
         this.field4931 = new IterableNodeHashTable(1);
      } else {
   ...
   @ObfuscatedName("ac")
   public final Renderable method8541(int var1, int var2, int[][] var3, int var4, int var5, int var6, int var7) {
      try {
         long var8;
         ...
         Object var10 = (Renderable)field4972.method6422(var8);
         if (var10 == null) {
            if (var7 >= 682279145) {
               throw new IllegalStateException();
            }

            ModelData var11 = this.method8595(var1, var2, -1973084331);
            if (var11 == null) {
               if (var7 >= 682279145) {
                  throw new IllegalStateException();
               }
         ...
         if (this.field4932) {
            ...
            var10 = ModelData.method3985((ModelData)var10);
         }
         ...
         if (this.field4949 * 1531627111 >= 0) {
            ...
            if (var10 instanceof Model) {
               ...
               var10 = ((Model)var10).method5246(var3, var4, var5, var6, true, 1531627111 * this.field4949);
            } else if (var10 instanceof ModelData) {
               if (var7 >= 682279145) {
                  throw new IllegalStateException();
               }

               var10 = ((ModelData)var10).method3987(var3, var4, var5, var6, true, this.field4949 * 1531627111);
            }
         }

         return (Renderable)var10;
      } catch (RuntimeException var12) {
         throw classEG.newRunException(var12, "om.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("ao")
   public final Model method8594(int var1, int var2, int[][] var3, int var4, int var5, int var6, SequenceDefinition var7, int var8, int var9) {
      return this.method8596(rl21.field5728, var1, var2, var3, var4, var5, var6, var7, var8);
   }

   @ObfuscatedSignature(descriptor = "(III)Ler;")
   @ObfuscatedName("al")
   final ModelData method8595(int var1, int var2, int var3) {
         ...
         try {
            ...
            if (var6.field4939 == null) {
               ...
               for (int var13 = 0; var13 < var12; var13++) {
                  ...
                  var10 = (ModelData)field4968.method6422(var15);
                  if (var10 == null) {
                     if (var9 != -1973084331) {
                        throw new IllegalStateException();
                     }

                     var10 = ModelData.method4047(classKD.field3554, var14, 0);
                     if (null == var10) {
                        if (var9 != -1973084331) {
                           throw new IllegalStateException();
                        }
               ...
               if (var12 > 1) {
                  ...
                  var10 = new ModelData(field4969, var12);
               }
            } else {
               int var24 = -1;
               ...
               var10 = (ModelData)field4968.method6422(var29);
               if (var10 == null) {
                  if (var9 != -1973084331) {
                     throw new IllegalStateException();
                  }

                  var10 = ModelData.method4047(classKD.field3554, var27, 0);
                  if (null == var10) {
                     if (var9 != -1973084331) {
                        throw new IllegalStateException();
                     }
            ...
            if (var7 == 4) {
               ...
               if (var8 > 3) {
                  ...
                  ModelData.method4040(var30, 45, 0, -45);
               }
            }
            ...
            if (var28) {
               ...
               ModelData.method4040(var30, 916605819 * var6.field4959, 2128147575 * var6.field4960, var6.field4961 * -1155641687);
            }

            var34 = var30;
         } catch (RuntimeException var16) {
            throw classEG.newRunException(var16, "om.al(" + ')');
         }
   ...
   @ObfuscatedName("bs")
   final ModelData method8546(int var1, int var2) {
      ModelData var3 = null;
      if (this.field4939 == null) {
         if (10 != var1) {
            return null;
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            var3 = (ModelData)field4968.method6422(var8);
            if (var3 == null) {
               var3 = ModelData.method4047(classKD.field3554, var7, 0);
               if (null == var3) {
                  return null;
               }
         ...
         if (var5 > 1) {
            var3 = new ModelData(field4969, var5);
         }
      } else {
         int var10 = -1;
         ...
         var3 = (ModelData)field4968.method6422(var15);
         if (var3 == null) {
            var3 = ModelData.method4047(classKD.field3554, var13, 0);
            if (null == var3) {
               return null;
            }
      ...
      ModelData var16 = new ModelData(var3, 0 == var2 && !var11 && !var14, null == this.field4940, null == this.field4942, true);
      if (var1 == 4 && var2 > 3) {
         var16.method3998(256);
         ModelData.method4040(var16, 45, 0, -45);
      }
      ...
      if (var14) {
         ModelData.method4040(var16, -2036368304 * this.field4959, -1514674730 * this.field4960, this.field4961 * -1155641687);
      }
   ...
   public int method8556(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "om.ay(" + 41);
      }
   }
   ...
   public long method8558(int var1, long var2) {
      try {
         ...
         throw classEG.newRunException(var4, "om.aq(" + ')');
      }
   }
   ...
   public String method8563(int var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "om.ad(" + ')');
      }
   }
   ...
   public classWJ method8573(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "om.au(" + ')');
      }
   }
   ...
   public int method8581(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "om.ar(" + 41);
      }
   }
   ...
   public static void method8524() {
      EvictingDualNodeHashTable.method6431(field4966);
      EvictingDualNodeHashTable.method6431(field4968);
      EvictingDualNodeHashTable.method6431(field4972);
      EvictingDualNodeHashTable.method6431(field4967);
   }
   ...
   @ObfuscatedName("an")
   public static void method8517(AbstractArchive var0, AbstractArchive var1, boolean var2) {
   ...
   public static boolean method8569(classOM var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var6, "om.ap(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;Lva;Z)V")
   @ObfuscatedName("am")
   public static void method8518(AbstractArchive var0, AbstractArchive var1, boolean var2) {
      classAK.field213 = var0;
      classKD.field3554 = var1;
      field4971 = var2;
   }
   ...
   public static classOM method8519(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classOM(new Buffer(var2), var0, true);
   ...
   @ObfuscatedName("kz")
   public Renderable method8599(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
   ...
   @ObfuscatedName("by")
   public final Model method8545(int var1, int var2, int[][] var3, int var4, int var5, int var6, SequenceDefinition var7, int var8) {
      long var9;
      if (this.field4939 == null) {
      ...
      Model var11 = (Model)field4967.method6422(var9);
      if (var11 == null) {
         ModelData var12 = this.method8595(var1, var2, -1973084331);
         if (var12 == null) {
            return null;
         }
   ...
   @ObfuscatedName("hd")
   public void method8593(Buffer var1, int var2, boolean var3) {
      ...
      classOE.client.getCallbacks().post(var4);
   }

   @ObfuscatedSignature(descriptor = "(II)Ler;")
   @ObfuscatedName("bq")
   final ModelData method8547(int var1, int var2) {
      ModelData var3 = null;
      if (this.field4939 == null) {
         if (10 != var1) {
            return null;
      ...
      if (var1 == 4 && var2 > 3) {
         ...
         ModelData.method4040(var16, -761527048, 0, -45);
      }
      ...
      if (var14) {
         ModelData.method4040(var16, 916605819 * this.field4959, 2128147575 * this.field4960, this.field4961 * -1155641687);
      }
   ...
   @ObfuscatedSignature(descriptor = "(II)Ler;")
   @ObfuscatedName("bf")
   final ModelData method8548(int var1, int var2) {
      ModelData var3 = null;
      if (this.field4939 == null) {
         if (10 != var1) {
            return null;
   ...
   @ObfuscatedName("be")
   public final Model method8543(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      long var7;
      if (null == this.field4939) {
      ...
      Model var9 = (Model)field4967.method6422(var7);
      if (null == var9) {
         ModelData var10 = this.method8595(var1, var2, -1973084331);
         if (null == var10) {
            return null;
         }
   ...
   @ObfuscatedSignature(descriptor = "(II)Ler;")
   @ObfuscatedName("bd")
   final ModelData method8549(int var1, int var2) {
      ModelData var3 = null;
      if (this.field4939 == null) {
         if (10 != var1) {
            return null;
   ...
   public static boolean method8538(classOM var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "om.ax(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(II)Ler;")
   @ObfuscatedName("ot")
   public ModelData method8604(int var1, int var2) {
   ...
   public int method8587(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "om.aw(" + 41);
      }
   }
   ...
   public classOZ method8516(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "om.az(" + ')');
      }
   }
   ...
   public String method8590(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "om.ak(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(II[[IIII)Lee;")
   @ObfuscatedName("bi")
   public final Renderable method8542(int var1, int var2, int[][] var3, int var4, int var5, int var6) {
      long var7;
      if (this.field4939 == null) {
      ...
      Object var9 = (Renderable)field4972.method6422(var7);
      if (var9 == null) {
         ModelData var10 = this.method8595(var1, var2, -1973084331);
         if (var10 == null) {
            return null;
      ...
      if (this.field4949 * 1531627111 >= 0) {
         if (var9 instanceof Model) {
            var9 = ((Model)var9).method5246(var3, var4, var5, var6, true, 1531627111 * this.field4949);
         } else if (var9 instanceof ModelData) {
            var9 = ((ModelData)var9).method3987(var3, var4, var5, var6, true, this.field4949 * -627801912);
         }
      }
   ...
   public static classOM method8553(classOM var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "om.aj(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("aa")
   public final Model method8544(int var1, int var2, int[][] var3, int var4, int var5, int var6, int var7) {
      try {
         long var8;
         if (null == this.field4939) {
            if (var7 >= 1106423215) {
         ...
         Model var10 = (Model)field4967.method6422(var8);
         if (null == var10) {
            if (var7 >= 1106423215) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.newRunException(var12, "om.aa(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lrl21;II[[IIIILou;I)Lfx;")
   @ObfuscatedName("bm")
   public Model method8596(
      @Nullable rl21 param1,
      int nullx,
      int nullxx,
      int[][] nullxxx,
      int nullxxxx,
      ...
      synchronized (field4967) {
         var12 = (Model)field4967.method6444(var10);
      }

      if (var12 == null) {
         ModelData var18 = this.method8604(nullx, nullxx);
         if (var18 == null) {
            return null;
         }
   ...
   public final boolean method8533(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var5, "om.as(" + ')');
      }
   }
