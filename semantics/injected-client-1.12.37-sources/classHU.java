...
public final class classHU {
   ...
   final int method6115(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "hu.az(" + 41);
      }
   }
   ...
   static void method6119(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         if (18 == var2) {
            ...
            int var9 = var3 & 65535;
            int var10 = var3 >> 16;
            PacketBufferNode var11 = classEF.getPacketBufferNode(ClientPacket.OPOBJ1_V2, client.packetWriter.isaacCipher, (byte)-36);
            var11.packetBuffer.method13153(var10, (byte)38);
            Buffer.method13186(var11.packetBuffer, var0 + var6, (byte)16);
            var11.packetBuffer.method13188(var1 + var7, (short)-5004);
            ...
            var11.packetBuffer.method12973(var9, -1542382992);
         ...
         if (var2 == 19) {
            ...
            int var17 = var3 >> 16;
            PacketBufferNode var21 = classEF.getPacketBufferNode(ClientPacket.OPOBJ2_V2, client.packetWriter.isaacCipher, (byte)-7);
            var21.packetBuffer.method13153(var17, (byte)34);
            var21.packetBuffer.method12973(var7 + var1, -1542382992);
            Buffer.method13186(var21.packetBuffer, var13, (byte)16);
            Buffer.method13186(var21.packetBuffer, var0 + var6, (byte)16);
         ...
         if (20 == var2) {
            ...
            int var18 = var3 >> 16;
            PacketBufferNode var22 = classEF.getPacketBufferNode(ClientPacket.OPOBJ3_V2, client.packetWriter.isaacCipher, (byte)35);
            Buffer.method13186(var22.packetBuffer, var0 + var6, (byte)16);
            ...
            Buffer.method12971(var22.packetBuffer, var18, (byte)-110);
            Buffer.method13180(var22.packetBuffer, var14, (byte)-71);
            var22.packetBuffer.method12973(var1 + var7, -1542382992);
         ...
         if (var2 == 21) {
            ...
            int var19 = var3 >> 16;
            PacketBufferNode var23 = classEF.getPacketBufferNode(ClientPacket.OPOBJ4_V2, client.packetWriter.isaacCipher, (byte)-60);
            var23.packetBuffer.method13153(var19, (byte)-10);
            ...
            var23.packetBuffer.method13188(var1 + var7, (short)-1309);
            Buffer.method13186(var23.packetBuffer, var15, (byte)16);
            Buffer.method13180(var23.packetBuffer, var6 + var0, (byte)-4);
         ...
         if (22 == var2) {
            ...
            int var20 = var3 >> 16;
            PacketBufferNode var24 = classEF.getPacketBufferNode(ClientPacket.OPOBJ5_V2, client.packetWriter.isaacCipher, (byte)-58);
            var24.packetBuffer.method13188(var16, (short)-32414);
            Buffer.method12971(var24.packetBuffer, var20, (byte)-73);
            Buffer.method13180(var24.packetBuffer, var6 + var0, (byte)-33);
            ...
            Buffer.method13186(var24.packetBuffer, var1 + var7, (byte)16);
            client.packetWriter.addNode(var24, -1301097035);
         }
      } catch (RuntimeException var12) {
         throw classEG.newRunException(var12, "hu.em(" + ')');
      }
   }
   ...
   static int method6118(int var0, Script var1, boolean var2, byte var3) {
      try {
            ...
            if (var3 >= 0) {
               ...
               if (null != classIB.field2935) {
                  ...
                  if (var32 < classIB.field2935.method10191(-1481923975)) {
                     ...
                     if (UserList.method10231(classIB.field2935, var32, 2092533098).method10166((byte)16).equals(classOE.client.vmethod255((byte)101))) {
                        classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 1;
                        return 1;
                     }
                  }
         ...
         throw classEG.newRunException(var6, "hu.bo(" + 41);
      }
   }
