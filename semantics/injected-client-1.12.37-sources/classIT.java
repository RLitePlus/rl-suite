...
public class classIT extends classIS {
   ...
   void vmethod506(Buffer var1) {
      ...
      if (null != this.field3061) {
         ...
         this.field3056 = Buffer.method13043(var1, (byte)17);
         this.field3055 = Buffer.method13043(var1, (byte)17);
      }
   }
   ...
   void vmethod507(Buffer var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "it.az(" + ')');
      }
   }
   ...
   void vmethod509(ClanChannel var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "it.af(" + ')');
      }
   }
   ...
   public static int method6315(int var0, int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "it.al(" + 41);
      }
   }
   ...
   @ObfuscatedName("az")
   public static final SpritePixels method6314(byte[] var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var10, "it.az(" + ')');
      }
   }
