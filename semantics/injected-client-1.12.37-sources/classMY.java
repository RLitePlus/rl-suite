...
final class classMY implements Comparator {
   ...
   int method7741(classNM var1, classNM var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "my.az(" + 41);
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         ...
         throw classEG.newRunException(var3, "my.compare(" + 41);
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "my.equals(" + ')');
      }
   }
   ...
   public static boolean method7740(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "my.as(" + ')');
      }
   }
}
