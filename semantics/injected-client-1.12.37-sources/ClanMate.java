...
public class ClanMate extends Buddy implements FriendsChatMember {
   ...
   void method10279(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ru.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lru;I)V")
   @ObfuscatedName("ws")
   public static void method10285(ClanMate var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ru.ax(" + ')');
         }
      }
   }
   ...
   void method10276(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ru.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lru;I)Z")
   @ObfuscatedName("vk")
   public static boolean method10272(ClanMate var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ru.af(" + ')');
         }
      }
   }
   ...
   public final boolean method10282(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ru.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("hn")
   public static void method10277(ClanMate var0) {
   ...
   @ObfuscatedSignature(descriptor = "(Lru;I)V")
   @ObfuscatedName("yd")
   public static void method10269(ClanMate var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ru.az(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("pk")
   public static boolean method10284(ClanMate var0) {
   ...
   static void method10275(classGY var0, classGY var1, float var2, classGY var3, short var4) {
      try {
         ...
         throw classEG.newRunException(var8, "ru.az(" + ')');
      }
   }
