...
public final class ItemLayer implements net.runelite.api.ItemLayer, TileObject {
   ...
   @ObfuscatedSignature(descriptor = "Lee;")
   @ObfuscatedName("ag")
   Renderable field1846;
   @ObfuscatedName("af")
   int field1840;
   @ObfuscatedSignature(descriptor = "Lee;")
   @ObfuscatedName("ab")
   Renderable field1845;
   @ObfuscatedName("ax")
   long field1844;
   @ObfuscatedName("ac")
   int field1838;
   ...
   public Shape getClickbox() {
      Area var1 = new Area();
      WorldView var2 = this.method3951();

      for (Renderable var6 : new Renderable[]{this.method3955(), this.method3956(), this.method3957()}) {
         if (var6 != null) {
            Model var7 = var6.method3842();
            if (var7 != null) {
   ...
   @ObfuscatedName("sj")
   public WorldView method3951() {
      return WorldView.method3780(this.method3954());
   }

   @ObfuscatedSignature(descriptor = "()Lee;")
   @ObfuscatedName("wu")
   public Renderable method3956() {
   ...
   public WorldPoint getWorldLocation() {
      WorldView var1 = WorldView.method3780(this.method3954());
      if (var1 == null) {
   ...
   @ObfuscatedName("af")
   static void method3952(ScriptEvent var0, int var1, int var2, byte var3) {
      ...
      if (var4 != null && var4.length > 0 && var4[0] instanceof JavaScriptCallback) {
         try {
            ...
            client.logger.error("Error in JavaScriptCallback", var17);
         }
      } else {
         try {
            ...
            try {
               ...
               if (classTS.method11131(var7.method14097(335454777), -324749371)) {
                  ...
                  WorldMapElement var13 = SceneTilePaint.method4796(classAC.field132.field2897 * -753629693, (byte)-48);
               ...
               throw classEG.newRunException(var18, "eq.af(" + ')');
            }
         } finally {
