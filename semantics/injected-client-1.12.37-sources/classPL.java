...
public class classPL extends classVJ implements NPCComposition, rl9 {
   ...
   @ObfuscatedName("ae")
   public static AbstractArchive field5294;
   @ObfuscatedSignature(descriptor = "Lva;")
   @ObfuscatedName("ab")
   public static AbstractArchive field5290;
   ...
   @ObfuscatedName("co")
   static EvictingDualNodeHashTable field5337 = new EvictingDualNodeHashTable(50);
   @ToRemove(unused = "true")
   @ObfuscatedName("cd")
   ...
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("cy")
   static EvictingDualNodeHashTable field5336 = new EvictingDualNodeHashTable(64);
   @ObfuscatedName("cz")
   ...
   @ObfuscatedName("ea")
   IterableNodeHashTable field5300;
   @ObfuscatedName("eq")
   ...
   classPO method8931(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.af(" + ')');
      }
   }

   classPL(Buffer var1, int var2) {
      ...
      boolean var41 = false;
      int var42 = -1;
      IterableNodeHashTable var43 = null;
      ...
      if (var1 != null && null != var1.array) {
         label299:
         while (true) {
            int var54 = Buffer.method13039(var1, -346779531);
            switch (var54) {
               case 0:
                  break label299;
               case 1:
               ...
               case 12:
                  ...
                  break;
               case 13:
                  var7 = Buffer.method13047(var1, -11551235);
                  break;
               case 14:
                  var10 = Buffer.method13047(var1, 674915822);
                  break;
               case 15:
                  var8 = Buffer.method13047(var1, 975161411);
                  break;
               case 16:
                  var9 = Buffer.method13047(var1, -1694115320);
                  break;
               case 17:
                  var10 = Buffer.method13047(var1, -525059563);
                  var11 = Buffer.method13047(var1, 1819068317);
                  var12 = Buffer.method13047(var1, -106680584);
                  var13 = Buffer.method13047(var1, 1105178497);
                  break;
               case 18:
                  Buffer.method13047(var1, -1614430796);
                  break;
               case 30:
               case 31:
               case 32:
               ...
               case 40:
                  ...
                  for (int var78 = 0; var78 < var70; var78++) {
                     var23[var78] = (short)Buffer.method13047(var1, -2087008104);
                     var24[var78] = (short)Buffer.method13047(var1, 1175337329);
                  }
                  break;
               case 41:
                  int var69 = Buffer.method13039(var1, -346779531);
                  var25 = new short[var69];
                  var26 = new short[var69];

                  for (int var77 = 0; var77 < var69; var77++) {
                     var25[var77] = (short)Buffer.method13047(var1, 1006054699);
                     var26[var77] = (short)Buffer.method13047(var1, -2139171520);
                  }
                  break;
               case 61:
                  int var68 = Buffer.method13039(var1, -346779531);
                  var5 = new int[var68];
                  ...
                  break;
               case 62:
                  int var67 = Buffer.method13039(var1, -346779531);
                  var6 = new int[var67];
                  ...
                  break;
               case 74:
                  var44[0] = Buffer.method13047(var1, -1821699879);
                  break;
               case 75:
                  var44[1] = Buffer.method13047(var1, -2120146721);
                  break;
               case 76:
                  var44[2] = Buffer.method13047(var1, -1124357946);
                  break;
               case 77:
                  var44[3] = Buffer.method13047(var1, -1693678342);
                  break;
               case 78:
                  var44[4] = Buffer.method13047(var1, 336447020);
                  break;
               case 79:
                  var44[5] = Buffer.method13047(var1, -1926068077);
                  break;
               case 93:
                  var28 = false;
                  break;
               case 95:
                  var29 = Buffer.method13047(var1, 24265317);
                  break;
               case 97:
                  var30 = Buffer.method13047(var1, 188656600);
                  break;
               case 98:
                  var31 = Buffer.method13047(var1, 237873694);
                  break;
               case 99:
                  var53 = classOQ.field5079;
                  break;
               case 100:
                  var32 = Buffer.method13043(var1, (byte)17);
                  break;
               case 101:
                  var33 = Buffer.method13043(var1, (byte)17) * 5;
                  break;
               case 102:
                  int var66 = Buffer.method13039(var1, -346779531);
                  int var74 = 0;
                  ...
                  for (int var81 = 0; var81 < var74; var81++) {
                     if ((var66 & 1 << var81) == 0) {
                        ...
                        var45[var81] = Buffer.method13110(var1, -324749371);
                        var46[var81] = (short)Buffer.method13096(var1, -730728427);
                     }
                  }
                  break;
               case 103:
                  var34 = Buffer.method13047(var1, 134377154);
                  break;
               case 106:
               case 118:
                  var36 = Buffer.method13047(var1, -360424813);
                  if (var36 == 65535) {
                     var36 = -1;
                  }

                  var37 = Buffer.method13047(var1, -635983963);
                  if (65535 == var37) {
                     var37 = -1;
                  }
                  ...
                  int var65 = -1;
                  if (118 == var54) {
                     var65 = Buffer.method13047(var1, 543231650);
                     if (var65 == 65535) {
                        var65 = -1;
                     }
                  }

                  int var73 = Buffer.method13039(var1, -346779531);
                  var35 = new int[2 + var73];

                  for (int var79 = 0; var79 <= var73; var79++) {
                     var35[var79] = Buffer.method13047(var1, 531671492);
               ...
               case 111:
                  ...
                  break;
               case 114:
                  var14 = Buffer.method13047(var1, -171247890);
                  break;
               case 115:
                  var14 = Buffer.method13047(var1, 576052994);
                  var15 = Buffer.method13047(var1, -1631180024);
                  var16 = Buffer.method13047(var1, -1498861295);
                  var17 = Buffer.method13047(var1, -1932561699);
                  break;
               case 116:
                  var18 = Buffer.method13047(var1, 388202665);
                  break;
               case 117:
                  var18 = Buffer.method13047(var1, 344265763);
                  var19 = Buffer.method13047(var1, -792186032);
                  var20 = Buffer.method13047(var1, 624450092);
                  var21 = Buffer.method13047(var1, -684860613);
                  break;
               case 122:
                  var40 = true;
                  break;
               case 123:
                  ...
                  break;
               case 124:
                  var42 = Buffer.method13047(var1, -242714651);
                  break;
               case 126:
                  var47 = Buffer.method13047(var1, 1481172224);
                  break;
               case 130:
                  var22 = true;
                  break;
               case 145:
                  ...
                  break;
               case 146:
                  var49 = Buffer.method13047(var1, -1210526976);
                  break;
               case 147:
                  var50 = false;
                  break;
               case 148:
                  var51.field6689 = Buffer.method13047(var1, 1934168574) * -418754533;
                  var51.field6686 = Buffer.method13039(var1, -346779531) * 39261697;
                  var51.field6688 = Buffer.method13039(var1, -346779531) * -286691225;
                  break;
               case 149:
                  classWD var64 = var51.field6687;
                  int var57 = Buffer.method13039(var1, -346779531);
               ...
               case 150:
                  ...
                  int var58 = Buffer.method13047(var1, -466516573) * 20;
                  ...
                  int var62 = Buffer.method13047(var1, 776673976) * 20;
                  var51.field6687.method12317(var59, var62, -388881497);
                  break;
               case 151:
                  var51.field6690 = (classKC)classOF.method8404(classHF.method6005(-966579297), Buffer.method13039(var1, -346779531), -2046684356);
                  break;
               case 152:
                  var52.field6784 = Buffer.method13047(var1, -1356571755) * -1412665981;
                  var52.field6783 = Buffer.method13047(var1, -2076965834) * -736985931;
                  var51.field6686 = Buffer.method13039(var1, -346779531) * 39261697;
                  var51.field6688 = Buffer.method13039(var1, -346779531) * -286691225;
                  int var55 = Buffer.method13039(var1, -346779531);
                  var52.field6785 = new int[var55];

                  for (int var56 = 0; var56 < var55; var56++) {
                     var52.field6785[var56] = Buffer.method13047(var1, 1445422137);
                  }
                  break;
               case 249:
      ...
      if (var43 == null) {
         this.field5300 = new IterableNodeHashTable(1);
      } else {
   ...
   public String method8967(int var1, String var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "pl.aj(" + ')');
      }
   }
   ...
   @ObfuscatedName("bi")
   ModelData method8948(int[] var1, NpcOverrides var2) {
      int[] var3 = var1;
      ...
      if (null == var3) {
         ...
         if (var4) {
            ...
            for (int var6 = 0; var6 < var3.length; var6++) {
               var9[var6] = ModelData.method4047(field5290, var3[var6], 0);
            }
   ...
   public String method8994(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.ak(" + ')');
      }
   }
   ...
   public final classPL method8955(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "pl.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("fp")
   public static void method8937(Player var0) {
      if (var0 == null) {
         var0.method2668();
      }
   ...
   public long method8963(int var1, long var2) {
      try {
         ...
         throw classEG.newRunException(var4, "pl.al(" + ')');
      }
   }
   ...
   @ObfuscatedName("as")
   public final ModelData method8943(NpcOverrides var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var4, "pl.as(" + ')');
      }
   }
   ...
   public boolean method8971(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.ay(" + ')');
      }
   }
   ...
   public int[] method8974(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.aq(" + ')');
      }
   }
   ...
   public int method8977(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "pl.ad(" + 41);
      }
   }
   ...
   public short[] method8981(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.ap(" + ')');
      }
   }
   ...
   public boolean method8987(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.ar(" + ')');
      }
   }
   ...
   public int method8989(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.aw(" + 41);
      }
   }
   ...
   public boolean method8998(byte var1) {
      try {
         ...
         throw classEG.newRunException(var6, "pl.av(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "([ILpp;)Ler;")
   @ObfuscatedName("be")
   ModelData method8949(int[] var1, NpcOverrides var2) {
      int[] var3 = var1;
      if (null != var2 && null != var2.field5374) {
         var3 = var2.field5374;
      }
   ...
   public static classPL method8933(int var0) {
      ...
      if (var1 != null) {
         ...
         var1 = new classPL(new Buffer(var2), var0);
   ...
   @ObfuscatedName("fq")
   public static Model method8939(classPL var0, SequenceDefinition var1, int var2, SequenceDefinition var3, int var4, NpcOverrides var5) {
      if (null != var0.field5325) {
         ...
         Model var8 = (Model)field5337.method6422(var6);
         if (var8 == null) {
            ModelData var9 = method8950(var0, var0.field5292, var5, 795096365);
            if (null == var9) {
               return null;
            }
         ...
         if (null != var1 && null != var3) {
            ...
            var11 = SequenceDefinition.method8793(var1, var8, var2, (byte)0);
         } else if (var3 != null) {
            var11 = SequenceDefinition.method8793(var3, var8, var4, (byte)0);
         } else {
   ...
   @ObfuscatedName("rs")
   public static ModelData method8950(classPL var0, int[] var1, NpcOverrides var2, int var3) {
      if (var0 == null) {
         ...
         try {
            ...
            if (null == var4) {
               ...
               if (var5) {
                  ...
                  for (int var7 = 0; var7 < var4.length; var7++) {
                     ...
                     var11[var7] = ModelData.method4047(field5290, var4[var7], 0);
                  }
            ...
            throw classEG.newRunException(var10, "pl.ax(" + ')');
         }
      }
   }
   ...
   public static void method8935() {
      EvictingDualNodeHashTable.method6431(field5336);
      EvictingDualNodeHashTable.method6431(field5337);
   }
   ...
   @ObfuscatedName("bj")
   public final ModelData method8944(NpcOverrides var1) {
      if (null != this.field5325) {
   ...
   @ObfuscatedSignature(descriptor = "(Lpp;)Ler;")
   @ObfuscatedName("bo")
   public final ModelData method8945(NpcOverrides var1) {
      if (null != this.field5325) {
         classPL var2 = this.method8955(652890385);
   ...
   @ObfuscatedSignature(descriptor = "([ILpp;)Ler;")
   @ObfuscatedName("ba")
   ModelData method8951(int[] var1, NpcOverrides var2) {
      int[] var3 = var1;
      if (null != var2 && null != var2.field5374) {
         var3 = var2.field5374;
      }
   ...
   @ObfuscatedSignature(descriptor = "([ILpp;)Ler;")
   @ObfuscatedName("bw")
   ModelData method8952(int[] var1, NpcOverrides var2) {
      int[] var3 = var1;
      if (null != var2 && null != var2.field5374) {
         var3 = var2.field5374;
      }
   ...
   public static int method8986(classPL var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "pl.ai(" + 41);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lpl;Lou;ILou;ILpp;)Lfx;")
   @ObfuscatedName("bk")
   public static Model method8940(classPL var0, SequenceDefinition var1, int var2, SequenceDefinition var3, int var4, NpcOverrides var5) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "([ILpp;)Ler;")
   @ObfuscatedName("bb")
   ModelData method8953(int[] var1, NpcOverrides var2) {
      int[] var3 = var1;
      if (null != var2 && null != var2.field5374) {
         var3 = var2.field5374;
      }
   ...
   public classOZ method8930(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pl.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lou;ILou;ILpp;)Lfx;")
   @ObfuscatedName("bg")
   public final Model method8941(SequenceDefinition var1, int var2, SequenceDefinition var3, int var4, NpcOverrides var5) {
      if (null != this.field5325) {
         ...
         Model var8 = (Model)field5337.method6422(var6);
         if (var8 == null) {
            ModelData var9 = method8950(this, this.field5292, var5, 795096365);
            if (null == var9) {
               return null;
            }
   ...
   @ObfuscatedName("ix")
   public static classLV method8938(Actor var0) {
   ...
   @ObfuscatedName("ag")
   public final Model method8942(SequenceDefinition var1, int var2, SequenceDefinition var3, int var4, NpcOverrides var5, int var6) {
      try {
         if (null != this.field5325) {
            ...
            Model var9 = (Model)field5337.method6422(var7);
            if (var9 == null) {
               if (var6 >= -160372750) {
                  throw new IllegalStateException();
               }

               ModelData var10 = method8950(this, this.field5292, var5, 795096365);
               if (null == var10) {
                  if (var6 >= -160372750) {
                     throw new IllegalStateException();
                  }
            ...
            label88: {
               ...
               if (var1 != null) {
                  ...
                  var13 = SequenceDefinition.method8793(var1, var9, var2, (byte)0);
               } else if (var3 != null) {
                  var13 = SequenceDefinition.method8793(var3, var9, var4, (byte)0);
               } else {
         ...
         throw classEG.newRunException(var11, "pl.ag(" + ')');
      }
   }
   ...
   public boolean method8959(byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "pl.aa(" + ')');
      }
   }
   ...
   public static int method8961(classPL var0, int var1, int var2, int var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "pl.ao(" + 41);
      }
   }
   ...
   public short method8984(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "pl.au(" + ')');
      }
   }
   ...
   @ObfuscatedName("tp")
   public static ModelData method8946(classPL var0, NpcOverrides var1) {
      if (null != var0.field5325) {
   ...
   @ObfuscatedSignature(descriptor = "(Lpp;)Ler;")
   @ObfuscatedName("bk")
   public final ModelData method8947(NpcOverrides var1) {
      if (null != this.field5325) {
         classPL var2 = this.method8955(652890385);
   ...
   @ObfuscatedName("ax")
   ModelData method8954(int[] var1, NpcOverrides var2, int var3) {
      try {
         int[] var4 = var1;
         if (null != var2) {
            if (var3 != 795096365) {
         ...
         if (null == var4) {
            ...
            if (var5) {
               ...
               for (int var7 = 0; var7 < var4.length; var7++) {
                  ...
                  var11[var7] = ModelData.method3959(field5294, var4[var7], 0);
               }
