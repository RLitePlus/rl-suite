...
public class classOC extends classVJ {
   ...
   @ObfuscatedName("ab")
   public static EvictingDualNodeHashTable field4814 = new EvictingDualNodeHashTable(64);
   ...
   @ObfuscatedName("as")
   final IterableNodeHashTable field4816;
   @ToRemove(unused = "true")
   @ObfuscatedName("al")
   ...
   public static classOC method8303(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classOC(new Buffer(var2));
   ...
   public int method8306(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "oc.ae(" + 41);
      }
   }
   ...
   public String method8308(int var1, String var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "oc.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("ag")
   public static void method8302(AbstractArchive var0) {
   ...
   classOC(Buffer var1) {
      ...
      if (var1 != null && var1.array != null) {
         while (true) {
            ...
            switch (var4) {
               case 2:
                  var2 = Buffer.method13047(var1, -1413961900);
                  break;
               case 249:
      ...
      if (var3 == null) {
         this.field4816 = new IterableNodeHashTable(1);
      } else {
         this.field4816 = var3;
      }
   }
