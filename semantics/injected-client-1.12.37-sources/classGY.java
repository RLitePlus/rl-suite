...
public class classGY {
   ...
   public int method5903(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gy.az(" + 41);
      }
   }
   ...
   public int method5905(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gy.af(" + 41);
      }
   }
   ...
   public int method5912(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gy.ab(" + 41);
      }
   }
   ...
   public int method5920(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gy.as(" + 41);
      }
   }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "gy.toString(" + ')');
      }
   }
   ...
   public void method5936(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "gy.al(" + ')');
      }
   }
   ...
   public void method5939(int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var6, "gy.aj(" + ')');
      }
   }
   ...
   public static int method5909(classGY var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "gy.ae(" + 41);
         }
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gy.equals(" + ')');
      }
   }
   ...
   boolean method5943(classGY var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "gy.ay(" + ')');
      }
   }
   ...
   public static void method5929(classGY var0, int var1, int var2, byte var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "gy.aa(" + ')');
      }
   }
   ...
   public void method5923(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "gy.ax(" + ')');
      }
   }
   ...
   public void method5926(classGY var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "gy.ac(" + ')');
      }
   }
   ...
   public static void method5933(classGY var0, int var1, short var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "gy.ao(" + ')');
      }
   }
   ...
   public static int method5918(classGY var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "gy.ag(" + 41);
      }
   }
   ...
   static final int method5922(long var0, String var2, byte var3) {
      try {
         ...
         Buffer.method12971(var5, 10, (byte)-5);
         ...
         Buffer.method12971(var6, 10, (byte)-98);
         ...
         if (null != client.randomDat) {
            ...
            Buffer.method13007(var6, client.randomDat, 0, client.randomDat.length, (byte)48);
         } else {
            byte[] var24 = PacketBufferNode.method6392((byte)0);
            Buffer.method13007(var6, var24, 0, var24.length, (byte)40);
         }
         ...
         Buffer var9 = new Buffer(var25);
         Buffer.method12997(var9, var2, (short)26214);
         var9.offset = -1095856699 * var25;
         var9.method13126(var7, (byte)17);
         Buffer var10 = new Buffer(702114061 * var9.offset + 702114061 * var6.offset + 5 + 702114061 * var5.offset);
         Buffer.method12971(var10, 2, (byte)-71);
         Buffer.method12971(var10, var5.offset * 702114061, (byte)-97);
         Buffer.method13007(var10, var5.array, 0, var5.offset * 702114061, (byte)44);
         Buffer.method12971(var10, 702114061 * var6.offset, (byte)-54);
         Buffer.method13007(var10, var6.array, 0, 702114061 * var6.offset, (byte)73);
         var10.method12973(702114061 * var9.offset, -1542382992);
         Buffer.method13007(var10, var9.array, 0, var9.offset * 702114061, (byte)19);
         byte[] var12 = var10.array;
         ...
         try {
            ...
            do {
               int var32 = var31.read(var10.array, var10.offset * 702114061, 1000 - var10.offset * 702114061);
               if (var32 == -1) {
                  var30.close();
                  var31.close();
                  String var33 = new String(var10.array);
                  if (var33.startsWith("OFFLINE")) {
                     ...
                     while (702114061 * var10.offset > 0) {
                        if (var3 >= 0) {
                           throw new IllegalStateException();
                        }

                        if (0 != var10.array[702114061 * var10.offset - 1]) {
                           break;
                        }
                        ...
                        var10.offset -= -1095856699;
                     }

                     String var34 = new String(var10.array, 0, var10.offset * 702114061);
               ...
               var10.offset += -1095856699 * var32;
            } while (var10.offset * 702114061 < 1000);
         ...
         throw classEG.newRunException(var21, "gy.az(" + 41);
      }
   }
