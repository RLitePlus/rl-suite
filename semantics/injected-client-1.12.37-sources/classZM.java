...
public class classZM {
   ...
   @ObfuscatedName("ae")
   public static PacketBufferNode method14065(int var0, String var1, classXO var2, int var3) {
      PacketBufferNode var4 = classEF.getPacketBufferNode(ClientPacket.MESSAGE_PUBLIC, client.packetWriter.isaacCipher, (byte)67);
      Buffer.method12971(var4.packetBuffer, 0, (byte)-92);
      int var5 = 702114061 * var4.packetBuffer.offset;
      Buffer.method12971(var4.packetBuffer, var0, (byte)-76);
      ...
      Buffer.method12971(var4.packetBuffer, var7, (byte)-10);
      Buffer.method12971(var4.packetBuffer, var18, (byte)-59);
      if (var8 != null) {
         for (int var19 = 0; var19 < var8.length; var19++) {
            Buffer.method12971(var4.packetBuffer, var8[var19], (byte)-13);
         }
      }

      Menu.method12644(var4.packetBuffer, var1, 1584111025);
      if (var0 == classKT.field4020.vmethod8((byte)1)) {
         Buffer.method12971(var4.packetBuffer, var3, (byte)-59);
      }

      Buffer.method13022(var4.packetBuffer, var4.packetBuffer.offset * 702114061 - var5, 2121161360);
      return var4;
   }
