...
public abstract class classHA {
   ...
   @ObfuscatedName("ar")
   void method5962(Buffer var1, byte var2) {
      try {
         if (var1 != null) {
            if (var2 <= 0) {
         ...
         throw classEG.newRunException(var3, "ha.ar(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IILxy;B)V")
   @ObfuscatedName("ak")
   void method5971(int var1, int var2, Buffer var3, byte var4) {
      try {
         int var5 = Buffer.method13039(var3, -346779531);
         if (0 == var5) {
            if (var4 < 33) {
               ;
            }
         ...
         throw classEG.newRunException(var6, "ha.ak(" + ')');
      }
   }
   ...
   int method5983(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ha.an(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(IILxy;IB)V")
   @ObfuscatedName("at")
   void method5979(int var1, int var2, Buffer var3, int var4, byte var5) {
      try {
         ...
         this.field2758[0][var1][var2] = (short)Buffer.method13047(var3, 130975000);
         if (var7) {
            if (var5 == 1) {
               throw new IllegalStateException();
            }

            int var9 = Buffer.method13039(var3, -346779531);
            ...
            for (int var10 = 0; var10 < var9; var10++) {
               ...
               int var11 = Buffer.method13047(var3, 1858909979);
               if (var11 != 0) {
                  if (var5 == 1) {
                     throw new IllegalStateException();
                  }
                  ...
                  int var12 = Buffer.method13039(var3, -346779531);
         ...
         if (var8) {
            ...
            for (int var16 = 0; var16 < var6; var16++) {
               ...
               int var17 = Buffer.method13039(var3, -346779531);
               if (0 == var17) {
                  if (var5 == 1) {
                     throw new IllegalStateException();
                  }
                  ...
                  for (int var19 = 0; var19 < var17; var19++) {
                     ...
                     int var14 = Buffer.method13039(var3, -346779531);
         ...
         throw classEG.newRunException(var15, "ha.at(" + ')');
      }
   }
   ...
   public static String method5954(long var0) {
      try {
         ...
         throw classEG.newRunException(var8, "ha.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("ab")
   abstract void vmethod466(Buffer var1);
   ...
   @ObfuscatedName("ds")
   public static void method5980(classHA var0, int var1, int var2, Buffer var3, int var4) {
      if (var0 == null) {
         ...
         var0.field2758[0][var1][var2] = (short)Buffer.method13047(var3, -509588321);
         if (var6) {
            int var8 = Buffer.method13039(var3, -346779531);

            for (int var9 = 0; var9 < var8; var9++) {
               int var10 = Buffer.method13047(var3, 1101615544);
               if (var10 != 0) {
                  var0.field2759[var9][var1][var2] = (short)var10;
                  int var11 = Buffer.method13039(var3, -346779531);
         ...
         if (var7) {
            for (int var14 = 0; var14 < var5; var14++) {
               int var15 = Buffer.method13039(var3, -346779531);
               if (0 != var15) {
                  ...
                  for (int var17 = 0; var17 < var15; var17++) {
                     ...
                     int var13 = Buffer.method13039(var3, -346779531);
   ...
   public static void method5968(classHA var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ha.aw(" + ')');
         }
      }
   }
   ...
   public static int method5986(classHA var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "ha.am(" + 41);
      }
   }
   ...
   public static int method5955(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ha.af(" + 41);
      }
   }
   ...
   @ObfuscatedName("bo")
   void method5972(int var1, int var2, Buffer var3) {
      int var4 = Buffer.method13039(var3, -346779531);
      if (0 != var4) {
         if ((var4 & 1) != 0) {
   ...
   @ObfuscatedSignature(descriptor = "(IILxy;)V")
   @ObfuscatedName("bu")
   void method5973(int var1, int var2, Buffer var3) {
      int var4 = Buffer.method13039(var3, -346779531);
      if (0 != var4) {
         if ((var4 & 1) != 0) {
   ...
   public static boolean method5959(classHA var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "ha.ai(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IILxy;)V")
   @ObfuscatedName("ba")
   void method5974(int var1, int var2, Buffer var3) {
      int var4 = Buffer.method13039(var3, -346779531);
      if (0 != var4) {
         if ((var4 & 1) != 0) {
   ...
   @ObfuscatedName("af")
   abstract void vmethod467(Buffer var1, int var2);

   @ObfuscatedSignature(descriptor = "(IILxy;I)V")
   @ObfuscatedName("bw")
   void method5975(int var1, int var2, Buffer var3, int var4) {
      boolean var5 = (var4 & 2) != 0;
      if (var5) {
         this.field2759[0][var1][var2] = (short)Buffer.method13047(var3, 369527776);
      }

      this.field2758[0][var1][var2] = (short)Buffer.method13047(var3, -1809869849);
   }
   ...
   @ObfuscatedName("zs")
   public static void method5976(classHA var0, int var1, int var2, Buffer var3, int var4, byte var5) {
      if (var0 == null) {
      ...
      try {
         ...
         if (var6) {
            ...
            var0.field2759[0][var1][var2] = (short)Buffer.method13047(var3, 221517528);
         }

         var0.field2758[0][var1][var2] = (short)Buffer.method13047(var3, 1753846269);
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "ha.av(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ae")
   abstract void vmethod468(Buffer var1);

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lha;Lxy;)V")
   @ObfuscatedName("dp")
   public static void method5965(classHA var0, Buffer var1) {
      if (var0 == null) {
         var0.method5960();
      }
   ...
   @ObfuscatedSignature(descriptor = "(IILxy;I)V")
   @ObfuscatedName("bi")
   void method5977(int var1, int var2, Buffer var3, int var4) {
      boolean var5 = (var4 & 2) != 0;
      if (var5) {
         this.field2759[0][var1][var2] = (short)Buffer.method13047(var3, 1702094832);
      }

      this.field2758[0][var1][var2] = (short)Buffer.method13047(var3, -1733085897);
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("bt")
   void method5966(Buffer var1) {
      if (var1 != null) {
         this.vmethod467(var1, -1811901292);
         this.field2748 = true;
         this.field2749 = true;
   ...
   static final void method5982(WorldView var0, byte[] var1, int var2, int var3, int var4, int var5, byte var6) {
      try {
         ...
         int var10000;
         if (702114061 * var14.offset < var14.array.length) {
            if (var6 == -1) {
               throw new IllegalStateException();
            }

            var10000 = Buffer.method13039(var14, -346779531);
         } else {
            var10000 = 0;
         }
         ...
         throw classEG.newRunException(var13, "ha.ab(" + ')');
      }
   }
   ...
   static final void method5989(double var0) {
      try {
         ...
         EvictingDualNodeHashTable.method6431(ItemComposition.field5008);
         classAB.field122.method2759(var0);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "ha.fm(" + ')');
      }
   }
   ...
   static final void method5988(int var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ha.bu(" + ')');
      }
   }
   ...
   static classCU[] method5953(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "ha.ag(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IILxy;I)V")
   @ObfuscatedName("bb")
   void method5981(int var1, int var2, Buffer var3, int var4) {
      int var5 = ((var4 & 24) >> 3) + 1;
      boolean var6 = 0 != (var4 & 2);
      boolean var7 = 0 != (var4 & 4);
      this.field2758[0][var1][var2] = (short)Buffer.method13047(var3, 1340774430);
      if (var6) {
         int var8 = Buffer.method13039(var3, -346779531);

         for (int var9 = 0; var9 < var8; var9++) {
            int var10 = Buffer.method13047(var3, -550142747);
            if (var10 != 0) {
   ...
   @ObfuscatedSignature(descriptor = "(IILxy;IB)V")
   @ObfuscatedName("av")
   void method5978(int var1, int var2, Buffer var3, int var4, byte var5) {
      try {
         boolean var10000;
         if ((var4 & 2) != 0) {
            if (var5 == -1) {
         ...
         if (var6) {
            ...
            this.field2759[0][var1][var2] = (short)Buffer.method13047(var3, 221517528);
         }

         this.field2759[0][var1][var2] = (short)Buffer.method13047(var3, 1753846269);
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "ha.av(" + ')');
      }
   }
