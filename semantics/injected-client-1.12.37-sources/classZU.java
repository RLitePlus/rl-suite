...
public class classZU extends classVJ {
   ...
   @ObfuscatedName("ae")
   static AbstractArchive field7277;
   @ObfuscatedSignature(descriptor = "Ljz;")
   @ObfuscatedName("ab")
   static EvictingDualNodeHashTable field7271 = new EvictingDualNodeHashTable(64);
   @ObfuscatedName("ag")
   ...
   @ObfuscatedName("vf")
   public static Model method14207(ItemComposition var0, PlayerCompositionColorTextureOverride var1) {
      if (var0 == null) {
         var0.method8699();
      }
   ...
   public static void method14204() {
      EvictingDualNodeHashTable.method6431(field7271);
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ab")
   public static void method14198(AbstractArchive var0) {
      field7277 = var0;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("as")
   public static void method14199(AbstractArchive var0) {
      field7277 = var0;
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ax")
   public static void method14200(AbstractArchive var0) {
      field7277 = var0;
   }
   ...
   public static classZU method14202(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classZU(new Buffer(var2), var0, -1);
   ...
   classZU(Buffer var1, int var2, int var3) {
      int[][] var4 = (int[][])null;
         ...
         while (true) {
            ...
            switch (var6) {
               case 0:
                  break label106;
               case 1:
                  int var7 = Math.max(Buffer.method13039(var1, -346779531), var3);
                  var4 = new int[var7][];
                  Object[][] var9 = var5;

                  for (int var10 = Buffer.method13039(var1, -346779531); 255 != var10; var10 = Buffer.method13039(var1, -346779531)) {
                     int var11 = var10 & 127;
                     boolean var12 = 0 != (var10 & 128);
                     int[] var13 = new int[Buffer.method13039(var1, -346779531)];
                     ...
                     if (var12) {
                        ...
                        for (int var19 = 0; var19 < var17; var19++) {
                           for (int var20 = 0; var20 < var13.length; var20++) {
                              ...
                              classYY var22 = FriendsList.method10130(var13[var20], 447096713);
   ...
   @ObfuscatedName("tc")
   public static void method14206(SecureRandomSSLSocket var0, boolean var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lva;)V")
   @ObfuscatedName("ag")
   public static void method14201(AbstractArchive var0) {
      field7277 = var0;
   }
}
