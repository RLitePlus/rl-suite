...
class SecureRandomSSLSocket extends SSLSocket {
   ...
   public InputStream getInputStream() throws IOException {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getInputStream(" + ')');
      }
   }
   ...
   public OutputStream getOutputStream() throws IOException {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getOutputStream(" + ')');
      }
   }
   ...
   public synchronized void close() throws IOException {
      try {
         ...
         throw classEG.newRunException(var1, "qc.close(" + ')');
      }
   }
   ...
   public void addHandshakeCompletedListener(HandshakeCompletedListener var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.addHandshakeCompletedListener(" + ')');
      }
   }
   ...
   public boolean getEnableSessionCreation() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getEnableSessionCreation(" + ')');
      }
   }
   ...
   public void setEnableSessionCreation(boolean var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.setEnableSessionCreation(" + ')');
      }
   }
   ...
   public String[] getEnabledCipherSuites() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getEnabledCipherSuites(" + ')');
      }
   }
   ...
   public void setEnabledCipherSuites(String[] var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.setEnabledCipherSuites(" + ')');
      }
   }
   ...
   public String[] getEnabledProtocols() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getEnabledProtocols(" + ')');
      }
   }
   ...
   public void setEnabledProtocols(String[] var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.setEnabledProtocols(" + ')');
      }
   }
   ...
   public boolean getNeedClientAuth() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getNeedClientAuth(" + ')');
      }
   }
   ...
   public String[] getSupportedCipherSuites() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getSupportedCipherSuites(" + ')');
      }
   }
   ...
   public boolean getUseClientMode() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getUseClientMode(" + ')');
      }
   }
   ...
   public void setUseClientMode(boolean var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.setUseClientMode(" + ')');
      }
   }
   ...
   public boolean getWantClientAuth() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getWantClientAuth(" + ')');
      }
   }
   ...
   public void removeHandshakeCompletedListener(HandshakeCompletedListener var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.removeHandshakeCompletedListener(" + ')');
      }
   }
   ...
   public void startHandshake() throws IOException {
      try {
         ...
         throw classEG.newRunException(var1, "qc.startHandshake(" + ')');
      }
   }
   ...
   @ObfuscatedName("cv")
   public static void method9478(SecureRandomSSLSocket var0) throws IOException {
   ...
   public void setWantClientAuth(boolean var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.setWantClientAuth(" + ')');
      }
   }
   ...
   public SSLSession getSession() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getSession(" + ')');
      }
   }
   ...
   public void setNeedClientAuth(boolean var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qc.setNeedClientAuth(" + ')');
      }
   }
   ...
   public String[] getSupportedProtocols() {
      try {
         ...
         throw classEG.newRunException(var1, "qc.getSupportedProtocols(" + ')');
      }
   }
