...
public class classPN extends classVJ {
   ...
   public boolean method9028(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pn.ag(" + ')');
      }
   }
   ...
   public Object method9031(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pn.as(" + ')');
      }
   }
         ...
         while (true) {
            ...
            switch (var9) {
               case 0:
                  break label61;
               case 1:
                  byte var11 = Buffer.method13043(var1, (byte)17);
                  int var12 = var11 & 255;
                  if (0 == var12) {
   ...
   public static classPN method9018(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classPN(new Buffer(var2), var0);
   ...
   public static boolean method9026(classPN var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "pn.ab(" + ')');
      }
   }
   ...
   public static int method9024(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pn.ae(" + 41);
      }
   }
   ...
   public static SpritePixels method9038(AbstractArchive var0, int var1, int var2, int var3) {
      ...
      if (var4 != null) {
         ...
         try {
            ...
            throw classEG.newRunException(var9, "pn.ae(" + ')');
         }
      }
   }
