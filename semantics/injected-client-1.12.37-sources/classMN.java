...
public class classMN {
   ...
   @ObfuscatedName("aq")
   public static AbstractArchive field4545;
   ...
   @ObfuscatedName("cc")
   static boolean method7624(WorldEntity var0, WorldView var1, int var2) {
      try {
         for (int var3 = 0; var3 < -2087374717 * client.field837.field1419; var3++) {
            ...
            Player var4 = (Player)var1.field1694.method13404(client.field837.field1423[var3]);
         ...
         for (int var8 = 0; var8 < classZH.method14003(var1.field1697, (byte)10); var8++) {
            ...
            NPC var10 = (NPC)var1.field1698.method13404(var1.field1697.method14001(var8, 2081965195));
            if (null != var10) {
               if (var2 >= 88068473) {
                  throw new IllegalStateException();
               }

               if (var10.definition.method8930(936289412).vmethod546((byte)0)) {
                  if (var2 >= 88068473) {
                     throw new IllegalStateException();
                  }
         ...
         classUQ var9 = PlayerComposition.method6675(var0.field6019, var0.field6026.method8482(-1468800021), -734679843);

         for (int var11 = 0; var11 < classZH.method14003(var1.field1693, (byte)10); var11++) {
            WorldEntity var5 = (WorldEntity)var1.worldEntities.method13595(var1.field1693.method14001(var11, 1881451855));
            if (null != var5) {
               if (var2 >= 88068473) {
                  throw new IllegalStateException();
               }
               ...
               if (var0 != var5) {
                  ...
                  if (1612595797 * client.field855 == var5.field6012.scene.field2142) {
                     classUQ var6 = PlayerComposition.method6675(var5.field6019, var5.field6026.method8482(1210286274), 181881556);
         ...
         throw classEG.newRunException(var7, "mn.cc(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   static Widget method7623(int var0, Widget var1, int var2, int var3, int var4, int var5, int var6, float[] var7, byte var8) {
      try {
         ...
         throw classEG.newRunException(var10, "mn.az(" + ')');
      }
   }
