...
public class classIM extends classIS {
   ...
   void vmethod506(Buffer var1) {
      this.field2992 = Buffer.method13047(var1, 1363314717) * 1242480657;
      Buffer.method13039(var1, -346779531);
      if (Buffer.method13039(var1, -346779531) != 1874736274) {
         var1.offset -= -82698895;
   ...
   void vmethod509(ClanChannel var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "im.af(" + ')');
      }
   }
   ...
   void vmethod505(Buffer var1) {
      this.field2992 = Buffer.method13047(var1, 1902951631) * -953626631;
      Buffer.method13039(var1, -346779531);
      if (Buffer.method13039(var1, -346779531) != 341801299) {
         var1.offset -= 1347578625;
   ...
   void vmethod507(Buffer var1, int var2) {
      try {
         this.field2992 = Buffer.method13047(var1, 1663062833) * -624187027;
         Buffer.method13039(var1, -346779531);
         ...
         throw classEG.newRunException(var3, "im.az(" + ')');
      }
   }
   ...
   public static void method6224(int var0, int var1, int var2, int var3, int var4) {
      try {
         if (classNP.field4698.size() > 1 && classNP.field4698.get(0) != null) {
            ...
            if (((MidiRequest)classNP.field4698.get(0)).field4641.method8041((byte)10)) {
               ...
               if (classNP.field4698.get(1) != null) {
                  ...
                  if (((MidiRequest)classNP.field4698.get(1)).field4641.method8041((byte)10)) {
                     if (var4 >= -545605385) {
                        throw new IllegalStateException();
                     }
                     ...
                     if (classNP.field4699.get(0) != null && classNP.field4699.get(1) != null) {
                        MidiRequest var6 = (MidiRequest)classNP.field4699.get(0);
         ...
         throw classEG.newRunException(var7, "im.as(" + ')');
      }
   }
}
