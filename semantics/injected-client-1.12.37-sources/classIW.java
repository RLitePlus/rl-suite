...
public class classIW extends classHB {
   ...
   static final void method6324(classBY var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "iw.eu(" + ')');
      }
   }
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "iw.af(" + ')');
      }
   }
   ...
   void vmethod500(Buffer var1) {
      this.field3072 = Buffer.method13047(var1, 3034607) * -547647313;
      this.field3073 = Buffer.method13043(var1, (byte)17);
   }
   ...
   void vmethod501(Buffer var1) {
      this.field3072 = Buffer.method13047(var1, -1461109209) * -547647313;
      this.field3073 = Buffer.method13043(var1, (byte)17);
   }
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         this.field3072 = Buffer.method13047(var1, -103951534) * -547647313;
         this.field3073 = Buffer.method13043(var1, (byte)17);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "iw.az(" + ')');
      }
   }
   ...
   static int[] method6322(int var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         for (int var7 = 0; var7 < 64; var7++) {
            ...
            var6[var7] = FloatProjection.method3896(var0, var1, var7, -2051091202);
         }

         for (int var9 = 0; var9 < 64; var9++) {
            var6[64 + var9] = FloatProjection.method3896(var1, var2, var9, -1874606988);
         }
         ...
         for (int var10 = 0; var10 < 64; var10++) {
            ...
            var6[128 + var10] = FloatProjection.method3896(var2, var3, var10, -1697785566);
         }

         for (int var11 = 0; var11 < 64; var11++) {
            var6[var11 + 192] = FloatProjection.method3896(var3, var4, var11, -2057552385);
         }

         return var6;
      } catch (RuntimeException var8) {
         throw classEG.newRunException(var8, "iw.az(" + ')');
      }
   }
   ...
   static int method6323(int var0, byte var1) {
      try {
         ...
         if (var2 == null) {
            ...
            return 707758669 * ((Message)var2.field6516).field725;
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "iw.ax(" + 41);
      }
   }
}
