...
public class classCZ implements classGZ {
   ...
   public void vmethod281(int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         if (client.field967 * -496203881 == 1) {
            ...
            WorldView var25 = client.field814.method1590(client.field846 * -2034209657, (short)-19746);
            Player var63 = var25.method3737(-2130951373 * client.field845, (byte)1);
            classUZ var53;
            if (null != var63) {
               if (var5 >= 281771763) {
                  throw new IllegalStateException();
            ...
            if (313368463 * client.field911 >= 2) {
               ...
               if (client.field855 * 1612595797 % 50 == 0) {
                  ...
                  ClientPacket.method6413(var29, var30, var67, true, -1060314874);
               }
            }
         ...
         label473: {
            var23 = MouseHandler.MouseHandler_x * -38255113;
            int var55 = -2144333897 * MouseHandler.MouseHandler_y;
            if (var23 >= var6) {
               if (var5 >= 281771763) {
                  throw new IllegalStateException();
               }
                  ...
                  if (var55 >= var7) {
                     ...
                     if (var55 < var9 + var7) {
                        ...
                        while (true) {
                           ...
                           WorldView var60 = (WorldView)var56.next();
                           var60.scene.method4326(-483624883 * var60.field1710, var23 - var6, var55 - var7);
                        }
                     }
                  }
               }
         ...
         classFH.method4684(classOE.client.field6203);
         ...
         classIS.field3053.scene.method4254(var61);
         classIS.field3053
            .scene
            .method4398(
         ...
         if (var5 < 281771763) {
            ...
            if (var66.method6529(2000036973) != 2) {
               ...
               WorldView var74 = var70.method1596(var66.method6535(680910494), var66.method6537(-1984556575), -2076017788);
               ...
               if (1269689307 * classCE.field690 > -1) {
                  ...
                  if (var73 % 20 < 10) {
                     ...
                     SpritePixels.method13511(classCE.field714[0], var6 + classCE.field690 * 1269689307 - 12, classCE.field700 * -690353985 + var7 - 28);
                  }
               }
            }

            classKQ var75 = client.field941;
            WorldView var77 = classIS.field3053;
            ...
            if (var75.method6529(-1593257328) != 4) {
               ...
               WorldEntity var79 = (WorldEntity)var77.worldEntities.method13595(var75.method6533(-906431094));
               if (null != var79) {
                  ...
                  if (1269689307 * classCE.field690 > -1) {
                     ...
                     if (var78 % 20 < 10) {
                        SpritePixels.method13511(classCE.field714[0], var6 + 1269689307 * classCE.field690 - 12, classCE.field700 * -690353985 + var7 - 28);
                     }
                  }
               }
            }

            TextureProvider.method3819((TextureProvider)classFH.field2257.field2239, client.field949 * -322689719, -1467379791);
            client.field836 = 0;
            Player var80 = classMB.method7521(2007530252);
            if (null != var80) {
               if (var5 >= 281771763) {
                  throw new IllegalStateException();
               }
            ...
            classIS.field3053.scene.method4479();

            for (int var37 = 0; var37 < classZH.method14003(classIS.field3053.field1693, (byte)10); var37++) {
               WorldEntity var38 = (WorldEntity)classIS.field3053.worldEntities.method13595(classIS.field3053.field1693.method14001(var37, 1665789766));
               if (var38 != null) {
                  var38.field6012.scene.method4479();
               }
            }
         }
      } catch (RuntimeException var36) {
         throw classEG.newRunException(var36, "cz.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   @Override
   public void vmethod298(Widget var1, int var2, int var3, short var4) {
   ...
   public void vmethod285(int var1, int var2, int var3, int var4, int var5, double var6) {
      try {
         ...
         throw classEG.newRunException(var8, "cz.ae(" + ')');
      }
   }
   ...
   public void vmethod296(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "cz.ag(" + ')');
      }
   }
   ...
   public void vmethod282(int var1, int var2, int var3, int var4) {
      ...
      if (client.field967 * -1459893314 == 1) {
         WorldView var24 = client.field814.method1590(client.field846 * -2034209657, (short)5850);
         Player var61 = var24.method3737(-387898057 * client.field845, (byte)1);
         classUZ var51;
         if (null != var61) {
         ...
         if (785215438 * client.field911 >= 2
            ...
            ClientPacket.method6413(var28, var29, var65, true, -814068082);
         }
      ...
      var22 = MouseHandler.MouseHandler_x * -38255113;
      int var53 = -2144333897 * MouseHandler.MouseHandler_y;
      if (var22 >= var5 && var22 < var5 + var7 && var53 >= var6 && var53 < var8 + var6) {
         classKS.method6559(var22 - var5, var53 - var6, (byte)0);

         for (WorldView var58 : client.field814) {
            var58.scene.method4326(-2142973985 * var58.field1710, var22 - var5, var53 - var6);
         }
      } else {
      ...
      classIS.field3053.scene.method4254(var59);
      classIS.field3053
         .scene
         .method4398(
            -325062789 * classKI.field3598,
      ...
      if (var64.method6529(-1098020493) == 2) {
         WorldView var72 = var68.method1596(var64.method6535(1223715463), var64.method6537(-2032374799), -1121689311);
         ...
         if (-1160319369 * classCE.field690 > -1 && var71 % 20 < 10) {
            SpritePixels.method13511(classCE.field714[0], var5 + classCE.field690 * 1269689307 - 12, classCE.field700 * -690353985 + var6 - 28);
         }
      }

      classKQ var73 = client.field941;
      WorldView var75 = classIS.field3053;
      int var76 = 1612595797 * client.field855;
      if (var73.method6529(595526630) == 4) {
         WorldEntity var77 = (WorldEntity)var75.worldEntities.method13595(var73.method6533(-452384430));
         if (null != var77) {
            ...
            if (-1239732645 * classCE.field690 > -1 && var76 % 20 < 10) {
               SpritePixels.method13511(classCE.field714[0], var5 + -247557412 * classCE.field690 - 12, classCE.field700 * -1113904354 + var6 - 28);
            }
         }
      }
      ...
      TextureProvider.method3819((TextureProvider)classFH.field2257.field2239, client.field949 * -322689719, -1467379791);
      client.field836 = 0;
      Player var78 = classMB.method7521(1978276076);
      if (null != var78) {
      ...
      for (int var35 = 0; var35 < classZH.method14003(classIS.field3053.field1693, (byte)10); var35++) {
         WorldEntity var36 = (WorldEntity)classIS.field3053.worldEntities.method13595(classIS.field3053.field1693.method14001(var35, 1728630060));
         if (var36 != null) {
            var36.field6012.scene.method4479();
         }
      }
   }
   ...
   public void vmethod291(int var1, int var2, int var3, int var4, int var5) {
      try {
         WorldMap.method12461(classIO.method6230((byte)-13), var1, var2, var3, var4, 1466331901);
      } catch (RuntimeException var6) {
         throw classEG.newRunException(var6, "cz.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("ac")
   @Override
   public void vmethod284(Widget var1, int var2, int var3) {
      ...
      if (var4 != null) {
         ...
         if (classBA.field305 * -782895767 != 2 && -782895767 * classBA.field305 != 5) {
            ...
            WorldView var33 = classIS.field3053;
            classUP var34 = client.field994;

            for (int var35 = 0; var35 < classZH.method14003(var33.field1693, (byte)10); var35++) {
               WorldEntity var11 = (WorldEntity)var33.worldEntities.method13595(var33.field1693.method14001(var35, 2033299512));
               if (var11 != null) {
                  ...
                  SpritePixels var14 = var11.field6026.method8492(-372328533);
                  byte var15 = 1;
                  if (!var11.method10558(1796779449)) {
                     ...
                     if (var14 != null) {
                        ...
                        if (var20 <= 12100) {
                           ...
                           SpritePixels.method13544(
                              var14, var29, var30, var27, var28, var31, var32, var19, var15 * 256, var2, var3, var4.field3587, var4.field3584
                           );
                        }
                     }
            ...
            if (client.field814.method1620(0, 206128317) == classTN.field6173 && classCQ.field1221.length >= 4) {
               ...
               if (classKH.method6479(var4, -38255113 * MouseHandler.MouseHandler_x - var2, -2144333897 * MouseHandler.MouseHandler_y - var3, 2061631842)) {
                  int var42 = -1246906611 * var4.field3586 / 2 + var2;
                  int var43 = var3 + var4.field3585 * -1637380195 / 2;
                  int var44 = MouseHandler.MouseHandler_x * -38255113 - var42;
                  int var45 = MouseHandler.MouseHandler_y * -2144333897 - var43;
            ...
            Player var39 = classMB.method7521(-1616151352);
   ...
   public void vmethod292(int var1, int var2, int var3, int var4) {
      WorldMap.method12461(classIO.method6230((byte)-99), var1, var2, var3, var4, 632010480);
   }
   ...
   public void vmethod283(int var1, int var2, int var3, int var4) {
      ...
      if (client.field967 * 1789610552 == 1) {
         WorldView var24 = client.field814.method1590(client.field846 * 1932249845, (short)-776);
         Player var61 = var24.method3737(-166899870 * client.field845, (byte)1);
         classUZ var51;
         if (null != var61) {
         ...
         if (313368463 * client.field911 >= 2
            ...
            ClientPacket.method6413(var28, var29, var65, true, 1343603856);
         }
      ...
      var22 = MouseHandler.MouseHandler_x * -909024992;
      int var53 = 1003715490 * MouseHandler.MouseHandler_y;
      if (var22 >= var5 && var22 < var5 + var7 && var53 >= var6 && var53 < var8 + var6) {
         classKS.method6559(var22 - var5, var53 - var6, (byte)0);

         for (WorldView var58 : client.field814) {
            var58.scene.method4326(-483624883 * var58.field1710, var22 - var5, var53 - var6);
         }
      } else {
      ...
      if (var64.method6529(498074410) == 2) {
         WorldView var72 = var68.method1596(var64.method6535(1048469317), var64.method6537(-1742355718), -929921509);
         ...
         if (1269689307 * classCE.field690 > -1 && var71 % 20 < 10) {
            SpritePixels.method13511(classCE.field714[0], var5 + classCE.field690 * 1269689307 - 12, classCE.field700 * 970436707 + var6 - 28);
         }
      }
      ...
      if (var73.method6529(-1319415454) == 4) {
         WorldEntity var77 = (WorldEntity)var75.worldEntities.method13595(var73.method6533(-563848561));
         if (null != var77) {
            int var33 = 1386308288 * var77.field6012.field1696;
            ...
            if (1269689307 * classCE.field690 > -1 && var76 % 20 < 10) {
               SpritePixels.method13511(classCE.field714[0], var5 + 1269689307 * classCE.field690 - 12, classCE.field700 * -690353985 + var6 - 28);
            }
         }
      }

      TextureProvider.method3819((TextureProvider)classFH.field2257.field2239, client.field949 * 368170240, -1467379791);
      client.field836 = 0;
      Player var78 = classMB.method7521(-1781181762);
      if (null != var78) {
      ...
      for (int var35 = 0; var35 < classZH.method14003(classIS.field3053.field1693, (byte)10); var35++) {
         WorldEntity var36 = (WorldEntity)classIS.field3053.worldEntities.method13595(classIS.field3053.field1693.method14001(var35, 1996971088));
         if (var36 != null) {
            var36.field6012.scene.method4479();
         }
      }
   ...
   @ObfuscatedName("dt")
   static void method2851(WorldView var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var9, "cz.dt(" + ')');
      }
   }
   ...
   static final int method2850(int var0) {
      try {
         ...
         throw classEG.newRunException(var13, "cz.ch(" + 41);
      }
   }
      ...
      try {
         for (WorldView var2 : client.field814) {
            ...
            while (var3.hasNext()) {
               ...
               NPC var4 = (NPC)var3.next();
               if (var4 != null) {
                  classKN.method6499(var2, var4, -1216348145 * var4.definition.field5284, -1128559099);
               }
            }
         ...
         throw classEG.newRunException(var5, "cz.by(" + ')');
      }
   }
   ...
   public void vmethod293(int var1, int var2, int var3, int var4) {
      WorldMap.method12461(classIO.method6230((byte)-80), var1, var2, var3, var4, -2183420);
   }
   ...
   public void vmethod294(int var1, int var2, int var3, int var4) {
      WorldMap.method12461(classIO.method6230((byte)1), var1, var2, var3, var4, -2026251431);
   }
   ...
   public static void method2848(String[] var0, int[] var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var12, "cz.ab(" + ')');
      }
   }
}
