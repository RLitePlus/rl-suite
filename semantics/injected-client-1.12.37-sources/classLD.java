...
public class classLD {
   ...
   static final void method6746(int var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var21, "ld.ao(" + ')');
      }
   }
   ...
   public static void method6745(classTE var0, int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var5, "ld.ao(" + ')');
      }
   }
   ...
   static void method6748(ScriptEvent var0, Script var1, int var2, int var3, int var4) {
      ...
      if (classOE.client.scriptVmMaxOps > var2) {
         var2 = classOE.client.scriptVmMaxOps;
      }

      if (var3 > 0 && classOE.client.scriptVmWarningOps > var3) {
         var3 = classOE.client.scriptVmWarningOps;
      }
      ...
      try {
         ...
         throw classEG.newRunException(var32, "ld.ae(" + ')');
      }
   }
   ...
   static int method6747(int var0, int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ld.fp(" + 41);
      }
   }
}
