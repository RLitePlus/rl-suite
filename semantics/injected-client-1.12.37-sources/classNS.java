...
public class classNS {
   ...
   static int method7997(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ns.ag(" + 41);
      }
   }
   ...
   public static final void method8001(Widget var0, int var1, int var2, byte var3) {
      if (classBA.field305 * -782895767 == 0 || classBA.field305 * -782895767 == 3) {
         if (!classOE.client.isMenuOpen()) {
            int var4 = MouseHandler.field6261 * 1229235359;
            if (var4 == 0) {
               int var5 = client.field926 * 1762426687;
               if (client.field1136 && var5 != 0) {
                  boolean var6 = MouseHandler.MouseHandler_x * -38255113 >= var1
                     && MouseHandler.MouseHandler_y * -2144333897 >= var2
                     && MouseHandler.MouseHandler_x * -38255113 < var1 + var0.getWidth()
                     && MouseHandler.MouseHandler_y * -2144333897 < var2 + var0.getHeight();
                  if (var6) {
               ...
               if (var4 == 1 || !classON.field4995 && var4 == 4) {
                  ...
                  if (var8 == classTN.field6172) {
                     ...
                     int var26 = MouseHandler.MouseHandler_x * -38255113 - var24;
                     int var27 = MouseHandler.MouseHandler_y * -2144333897 - var25;
   ...
   protected static int method7998(int var0) {
      try {
         ...
         throw classEG.newRunException(var11, "ns.afy(" + 41);
      }
   }
   ...
   static boolean method8000(WorldView var0, byte[] var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "ns.aa(" + ')');
      }
   }
