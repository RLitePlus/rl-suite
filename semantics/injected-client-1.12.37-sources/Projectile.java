...
public final class Projectile extends Renderable implements net.runelite.api.Projectile {
   ...
   static final int method1223(int var0) {
      try {
         ...
         throw classEG.newRunException(var2, "bs.fe(" + 41);
      }
   }
   ...
   protected final Model vmethod104(int var1) {
      try {
         if (classQR.method9763(this.field553, 30, -1564010216)) {
            ...
            Model var3 = var2.method8724(this.field553.method9738(1823720123), 1621840478);
            if (null == var3) {
               return null;
            } else {
         ...
         throw classEG.newRunException(var4, "bs.ae(" + ')');
      }
   }
   ...
   protected final Model vmethod92() {
      if (classQR.method9763(this.field553, 30, -236546980)) {
         ...
         Model var2 = var1.method8724(this.field553.method9738(2053825511), 1329699974);
         if (null == var2) {
            return null;
         } else {
   ...
   protected int vmethod98(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bs.ag(" + 41);
      }
   }
   ...
   @ObfuscatedName("hb")
   public static void method1224(Projectile var0, classCL var1, int var2, int var3, byte var4) {
      if (var0 == null) {
         ...
         if (var2 >= var0.field544 * -988090901) {
            ...
            classOE.client.getCallbacks().post(var23);
         }
         ...
         try {
            ...
            throw classEG.newRunException(var24, "bs.ac(" + ')');
         }
      }
   }
   ...
   public net.runelite.api.Actor getSourceActor() {
      ...
      if (var1 > 0) {
         int var4 = var1 - 1;
         return (net.runelite.api.Actor)var2.field1698.method13405(var4);
      } else if (var1 < 0) {
         int var3 = -var1 - 1;
         return (net.runelite.api.Actor)var2.field1694.method13405(var3);
      } else {
         return null;
      }
   }
   ...
   protected boolean vmethod96() {
      if (this.field553.method9726(374233424) && this.field553.method9731((byte)115).method8749(this.field553.method9738(2094498840), 1284412146)) {
         ...
         Model var2 = var1.method8726(1555762411);
   ...
   protected boolean vmethod94() {
      if (this.field553.method9726(374233424) && this.field553.method9731((byte)37).method8749(this.field553.method9738(1858921218), 1284412146)) {
         ...
         Model var2 = var1.method8726(400892565);
         return var2 != null && null != var2.field2444;
      }
   }
   ...
   protected boolean vmethod97() {
      if (this.field553.method9726(374233424) && this.field553.method9731((byte)115).method8749(this.field553.method9738(1735652441), 1284412146)) {
         ...
         Model var2 = var1.method8726(1864499634);
         return var2 != null && null != var2.field2444;
      }
   }
   ...
   protected boolean vmethod95(int var1) {
      try {
         ...
         Model var3 = var2.method8726(-306048504);
         return var3 != null && null != var3.field2444;
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "bs.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("cc")
   public static void method1211(Projectile var0, int var1, int var2, int var3) {
      if (var0 == null) {
      ...
      try {
         ...
         throw classEG.newRunException(var4, "bs.ax(" + ')');
      }
   }
   ...
   public int getRemainingCycles() {
      int var1 = classOE.client.getGameCycle();
   ...
   protected final Model vmethod93() {
      if (classQR.method9763(this.field553, 30, -226365416)) {
         ...
         Model var2 = var1.method8724(this.field553.method9738(2042238521), 1722059945);
         if (null == var2) {
            return null;
         } else {
            var2.method5144(-947616749 * this.field566);
   ...
   static classUZ method1218(int var0, int var1, int var2, int var3, classCL var4) {
      ...
      if (classBZ.method1381(var0, (byte)-74)) {
         ...
         if (var8) {
            ...
            var7 = (Actor)var6.field1698.method13404(var9);
         } else {
         ...
         if (var7 != null) {
            classKY var16 = ((Actor)var7).method3162(var6, (short)7751);
      ...
      if (var5 == null) {
         ...
         WorldEntity var17 = (WorldEntity)classCL.method1592(var4, -1404261670).worldEntities.method13595(2140889407 * var6.field1699);
         if (var17 != null) {
      ...
      WorldEntity var12 = (WorldEntity)classIS.field3053.worldEntities.method13595(var6.field1699 * 2140889407);
      if (null != var12) {
   ...
   @ObfuscatedName("cp")
   static int method1222(int var0, Script var1, boolean var2, int var3) {
      try {
         if (7108 == var0) {
            if (var3 >= -1565688993) {
               throw new IllegalStateException();
         ...
         throw classEG.newRunException(var4, "bs.cp(" + 41);
      }
   }
   ...
   static classRA method1207(String var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "bs.af(" + ')');
      }
   }
      ...
      try {
         if (null == var0) {
            ...
            if (var10 == 0.0F) {
               ...
               var0.field6057 = var1;
               var0.field6048 = var4;
               Script.method1147(0.0F, var13[0], var13[1], 1.0F, var0, 2000914988);
         ...
         throw classEG.newRunException(var20, "bs.ae(" + ')');
      }
   }
   ...
   static final int method1221(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var4, "bs.bo(" + 41);
      }
   }
   ...
   static final boolean method1219(
      ...
      try {
         if (!classAS.method660(2084378253)) {
            ...
            return GrandExchangeOffer.method7619(var0, var1, var2, var3, var4, (byte)76);
         }
      } catch (RuntimeException var13) {
         throw classEG.newRunException(var13, "bs.ai(" + ')');
      }
   }
