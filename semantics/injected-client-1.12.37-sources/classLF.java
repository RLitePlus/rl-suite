...
public class classLF {
   ...
   @ObfuscatedName("ab")
   static IndexedSprite method6779(boolean var0, boolean var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "lf.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ac")
   static void method6780(Buffer var0, int var1) {
      try {
         while (true) {
            int var2 = Buffer.method13047(var0, 170180413);
            if (var2 == 0) {
               if (var1 <= 188513080) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.newRunException(var3, "lf.ac(" + ')');
      }
   }
}
