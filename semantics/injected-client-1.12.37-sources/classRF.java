...
@ObfuscatedName("rf")
public class classRF extends UserList {
   ...
   User vmethod555(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "rf.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("ax")
   public void method9958(Buffer var1, int var2) {
      while (var1.offset * 702114061 < var2) {
         ...
         if (4 == var3) {
            ...
            Ignored var7 = (Ignored)UserList.method10209(this, var5, 781999007);
            if (var4) {
               Ignored var8 = (Ignored)UserList.method10209(this, var6, 1544105364);
            ...
            if (null != var7) {
               ...
               var7 = (Ignored)this.method10226(var5, var6, (byte)-3);
   ...
   User[] vmethod558(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "rf.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("gy")
   public static void method9959(classRF var0, Buffer var1, int var2) {
      if (var0 == null) {
      ...
      while (var1.offset * 702114061 < var2) {
         ...
         if (4 == var3) {
            ...
            Ignored var7 = (Ignored)UserList.method10209(var0, var10, -1528113242);
            if (var9) {
               Ignored var8 = (Ignored)UserList.method10209(var0, var6, 908692591);
               if (var8 != null && var8 != var7) {
                  if (null != var7) {
            ...
            if (null != var7) {
               ...
               var7 = (Ignored)var0.method10226(var10, var6, (byte)-5);
               var7.field5836 = -3340741 * var12;
            }
         }
      }
   ...
   public static long method9961(int var0, int var1, int var2, int var3, boolean var4, int var5, int var6, short var7) {
      try {
         ...
         throw classEG.newRunException(var10, "rf.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;II)V")
   @ObfuscatedName("ae")
   public void method9960(Buffer var1, int var2, int var3) {
      try {
         while (var1.offset * 702114061 < var2) {
            if (var3 != 400186886) {
               throw new IllegalStateException();
            ...
            if (4 == var4) {
               ...
               Ignored var8 = (Ignored)UserList.method10209(this, var6, -1470289739);
               if (var5) {
                  Ignored var9 = (Ignored)UserList.method10209(this, var7, 1893778780);
                  if (var9 != null) {
                     if (var3 != 400186886) {
                        throw new IllegalStateException();
                     }
               ...
               if (null != var8) {
                  ...
                  var8 = (Ignored)this.method10226(var6, var7, (byte)-25);
                  var8.field5836 = -3340741 * var14;
               }
            }
         }
      } catch (RuntimeException var10) {
         throw classEG.newRunException(var10, "rf.ae(" + ')');
      }
   }
}
