...
public class classND extends classAH {
   ...
   public static void method7819(classND var0, classNT var1, int[] var2, int var3, int var4, int var5, int var6) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var12, "nd.az(" + ')');
         }
      }
   }
   ...
   protected classAH vmethod29() {
      try {
         ...
         throw classEG.newRunException(var2, "nd.as(" + ')');
      }
   }
   ...
   protected classAH vmethod35() {
      try {
         ...
         throw classEG.newRunException(var2, "nd.ax(" + ')');
      }
   }
   ...
   protected int vmethod32() {
      try {
         ...
         throw classEG.newRunException(var1, "nd.ac(" + 41);
      }
   }
   ...
   protected void vmethod30(int[] var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var7, "nd.aa(" + ')');
      }
   }
   ...
   protected void vmethod31(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "nd.al(" + ')');
      }
   }
   ...
   public static classTW[] method7817(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "nd.ag(" + ')');
      }
   }
   ...
   @ObfuscatedName("ae")
   public static String method7818(Buffer var0, int var1) {
      try {
         String var2;
         try {
            ...
            var0.offset = var0.offset + classLR.method7145(classLF.field4133, var0.array, 702114061 * var0.offset, var4, 0, var3, 2023506199) * -1095856699;
         ...
         throw classEG.newRunException(var7, "nd.ae(" + ')');
      }
   }
   ...
   public static void method7826(classND var0, classNT var1, int var2, int var3) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var6, "nd.af(" + ')');
         }
      }
   }
