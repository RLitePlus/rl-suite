...
public class classEM extends Node {
   ...
   public classEF method3924(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "em.af(" + ')');
      }
   }
   ...
   public int method3923(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "em.az(" + 41);
      }
   }
   ...
   static void method3928(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "em.at(" + ')');
      }
   }
   ...
   public classEM(int var1, byte[] var2) {
      ...
      this.field1786 = Buffer.method13039(var3, -346779531) * 776449909;
      ...
      for (int var4 = 0; var4 < 1690200285 * this.field1786; var4++) {
         this.field1785[var4] = Buffer.method13039(var3, -346779531);
      }

      for (int var6 = 0; var6 < this.field1786 * 1690200285; var6++) {
         this.field1787[var6] = new int[Buffer.method13039(var3, -346779531)];
      }

      for (int var7 = 0; var7 < this.field1786 * 1690200285; var7++) {
         for (int var5 = 0; var5 < this.field1787[var7].length; var5++) {
            this.field1787[var7][var5] = Buffer.method13039(var3, -346779531);
         }
      }

      if (var3.offset * 702114061 < var3.array.length) {
         int var8 = Buffer.method13047(var3, 1114906404);
         if (var8 > 0) {
   ...
   public static int method3922(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var7, "em.az(" + 41);
      }
   }
   ...
   static final void method3929(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "em.fa(" + ')');
      }
   }
}
