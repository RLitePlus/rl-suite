...
public class classPG extends classVJ {
   ...
   public static classPG method8862(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new classPG(new Buffer(var2), var0);
   ...
   public int method8866(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pg.ab(" + 41);
      }
   }
   ...
   public int method8869(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pg.ag(" + 41);
      }
   }
   ...
   public int method8875(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pg.ax(" + 41);
      }
   }
   ...
   public classWD method8880(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "pg.aa(" + ')');
      }
   }
   ...
   public classWW method8877(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "pg.ac(" + ')');
      }
   }
            ...
            switch (var4) {
               ...
               case 1:
                  ...
                  for (int var15 = 0; var15 < var12; var15++) {
                     var3[var15] = Buffer.method13047(var1, -1461538641);
                  }
                  break;
               case 2:
                  int var11 = Buffer.method13047(var1, -36182986) * 20;
                  int var14 = Buffer.method13047(var1, 141911779) * 20;
                  int var7 = Buffer.method13039(var1, -346779531);
                  int[] var17 = new int[var7];

                  for (int var9 = 0; var9 < var7; var9++) {
                     var17[var9] = Buffer.method13047(var1, -1095243703);
                  }
               ...
               case 3:
                  ...
                  int var16 = Buffer.method13047(var1, 1583176156) * 20;
               ...
               case 4:
                  ...
                  int var8 = Buffer.method13047(var1, 665438358) * 20;
   ...
   public int method8873(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "pg.as(" + 41);
      }
   }
