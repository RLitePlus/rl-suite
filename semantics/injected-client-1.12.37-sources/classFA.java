...
public class classFA implements classTL {
   ...
   public boolean vmethod446(int var1, byte var2) {
      if (classTP.field6185) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "fa.ab(" + ')');
         }
   ...
   public boolean vmethod447(int var1, byte var2) {
      if (classTP.field6185) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "fa.ag(" + ')');
         }
   ...
   public boolean vmethod448(char var1, int var2) {
      if (!classTP.field6185) {
         ...
         try {
            ...
            throw classEG.newRunException(var6, "fa.as(" + ')');
         }
      }
   ...
   public boolean vmethod444(boolean var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "fa.ax(" + ')');
      }
   }
   ...
   public void method4528(int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "fa.af(" + ')');
      }
   }
   ...
   void method4527(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var4, "fa.az(" + ')');
      }
   }
   ...
   public boolean method4533(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "fa.ac(" + ')');
      }
   }
   ...
   static boolean method4551(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      Scene.method4388(var0, var1, var2, var3, var4, var5, var6);

      try {
         Scene var8 = classCQ.field1220.scene;
         if (var5 == 1946452601 * classKV.field4034.field4038) {
            if (var7 != -208526133) {
               throw new IllegalStateException();
            }

            BoundaryObject var9 = var8.method4467(var0, var1, var2);
            if (null != var9) {
               if (var7 != -208526133) {
                  throw new IllegalStateException();
               }
               ...
               if (78062377 * classKB.field3517.field3538 == var3) {
                  ...
                  var9.field2249 = new DynamicObject(classCQ.field1220, var10, 2, var4 + 4, var0, var1, var2, var6, false, var9.field2249);
                  var9.field2248 = new DynamicObject(classCQ.field1220, var10, 2, var4 + 1 & 3, var0, var1, var2, var6, false, var9.field2248);
               } else {
                  var9.field2249 = new DynamicObject(classCQ.field1220, var10, var3, var4, var0, var1, var2, var6, false, var9.field2249);
               }

               Scene.method4419(var0, var1, var2, var3, var4, var5, var6);
               return true;
            }
            ...
            WallDecoration var12 = var8.method4420(var0, var1, var2);
            if (null != var12) {
               if (var7 != -208526133) {
                  throw new IllegalStateException();
               }
               ...
               label111: {
                  ...
                  if (var3 != classKB.field3520.field3538 * 78062377) {
                     ...
                     if (78062377 * classKB.field3525.field3538 != var3) {
                        if (78062377 * classKB.field3522.field3538 == var3) {
                           ...
                           var12.field2279 = new DynamicObject(classCQ.field1220, var15, 4, 4 + var4, var0, var1, var2, var6, false, var12.field2279);
                        } else if (var3 == 78062377 * classKB.field3523.field3538) {
                           if (var7 != -208526133) {
                              throw new IllegalStateException();
                           }

                           var12.field2279 = new DynamicObject(classCQ.field1220, var15, 4, (var4 + 2 & 3) + 4, var0, var1, var2, var6, false, var12.field2279);
                        } else if (classKB.field3524.field3538 * 78062377 == var3) {
                           var12.field2279 = new DynamicObject(classCQ.field1220, var15, 4, 4 + var4, var0, var1, var2, var6, false, var12.field2279);
                           var12.field2278 = new DynamicObject(classCQ.field1220, var15, 4, 4 + (var4 + 2 & 3), var0, var1, var2, var6, false, var12.field2278);
                        }
                        break label111;
                     }
                  ...
                  var12.field2279 = new DynamicObject(classCQ.field1220, var15, 4, var4, var0, var1, var2, var6, false, var12.field2279);
               }
            ...
            GameObject var13 = var8.method4395(var0, var1, var2);
            ...
            if (null != var13) {
               ...
               var13.field2200 = new DynamicObject(
            ...
            FloorDecoration var14 = Scene.method4457(var8, var0, var1, var2);
            if (null != var14) {
               if (var7 != -208526133) {
                  throw new IllegalStateException();
               }

               var14.field1816 = new DynamicObject(
         ...
         throw classEG.newRunException(var11, "fa.dq(" + ')');
      }
   }
   ...
   public boolean method4543(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "fa.ao(" + ')');
      }
   }
   ...
   public static boolean method4540(classFA var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "fa.aa(" + ')');
      }
   }
   ...
   public final boolean method4531(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "fa.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("ca")
   static boolean method4550(WorldEntity var0, Actor var1, int var2) {
      try {
         if (null != var0) {
            if (var2 != -1555620546) {
               throw new IllegalStateException();
         ...
         throw classEG.newRunException(var10, "fa.ca(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   public static DbRowType method4532(int var0, byte var1) {
      try {
         DbRowType var2 = (DbRowType)DbRowType.field7171.method6422(var0);
         if (null != var2) {
            return var2;
         } else {
            byte[] var3 = DbRowType.field7177.method11867(38, var0, -2122935696);
            var2 = new DbRowType(new Buffer(var3), var0, -1);
            DbRowType.field7171.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "fa.af(" + ')');
      }
   }
