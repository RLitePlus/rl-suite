...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
   ...
   public final synchronized void mouseMoved(MouseEvent var1) {
      if (this.field6272 == 0) {
         var1 = classOE.client.getCallbacks().mouseMoved(var1);
      }
      ...
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            try {
               ...
               throw classEG.newRunException(var7, "tz.mouseMoved(" + ')');
            }
         } finally {
            this.field6272--;
         }
   ...
   final int method11213(MouseEvent var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "tz.af(" + 41);
      }
   }
   ...
   public final synchronized void mousePressed(MouseEvent var1) {
      if (this.field6272 == 0) {
         var1 = classOE.client.getCallbacks().mousePressed(var1);
      }
      ...
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            try {
               ...
               throw classEG.newRunException(var7, "tz.mousePressed(" + ')');
            }
         } finally {
            this.field6272--;
         }
   ...
   public final void mouseClicked(MouseEvent var1) {
      var1 = classOE.client.getCallbacks().mouseClicked(var1);
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "tz.mouseClicked(" + ')');
         }
      }
   }
   ...
   public final synchronized void mouseEntered(MouseEvent var1) {
      if (this.field6272 == 0) {
         var1 = classOE.client.getCallbacks().mouseEntered(var1);
      }
      ...
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            try {
               ...
               throw classEG.newRunException(var7, "tz.mouseEntered(" + ')');
            }
         } finally {
            this.field6272--;
         }
   ...
   public final synchronized void mouseExited(MouseEvent var1) {
      if (this.field6272 == 0) {
         var1 = classOE.client.getCallbacks().mouseExited(var1);
      }
      ...
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            try {
               ...
               throw classEG.newRunException(var7, "tz.mouseExited(" + ')');
            }
         } finally {
            this.field6272--;
         }
   ...
   public final void focusGained(FocusEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tz.focusGained(" + ')');
      }
   }
   ...
   public static void method11211() {
      if (null != MouseHandler_instance) {
         synchronized (MouseHandler_instance) {
            MouseHandler_instance = null;
         }
      }
   }
   ...
   public final synchronized void mouseDragged(MouseEvent var1) {
      if (this.field6272 == 0) {
         var1 = classOE.client.getCallbacks().mouseDragged(var1);
      }
      ...
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            try {
               ...
               throw classEG.newRunException(var7, "tz.mouseDragged(" + ')');
            }
         } finally {
            this.field6272--;
         }
   ...
   public final synchronized void mouseReleased(MouseEvent var1) {
      if (this.field6272 == 0) {
         var1 = classOE.client.getCallbacks().mouseReleased(var1);
      }
      ...
      if (!var1.isConsumed()) {
         ...
         try {
            ...
            try {
               ...
               throw classEG.newRunException(var7, "tz.mouseReleased(" + ')');
            }
         } finally {
            this.field6272--;
         }
   ...
   @ObfuscatedName("wv")
   public static int method11214(MouseHandler var0, MouseEvent var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ltz;Ljava/awt/event/MouseEvent;)I")
   @ObfuscatedName("lp")
   public static int method11215(MouseHandler var0, MouseEvent var1) {
      if (var0 == null) {
   ...
   public final synchronized void focusLost(FocusEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tz.focusLost(" + ')');
      }
   }
