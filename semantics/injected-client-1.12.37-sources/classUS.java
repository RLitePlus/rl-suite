...
public final class classUS {
   ...
   boolean method11537(int var1, byte[] var2, int var3, boolean var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var18, "us.ae(" + ')');
      }
   }
   ...
   public byte[] method11527(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var20, "us.az(" + ')');
      }
   }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "us.toString(" + ')');
      }
   }
   ...
   public static boolean method11531(classUS var0, int var1, byte[] var2, int var3, int var4) {
      ...
      try {
         ...
         throw classEG.newRunException(var9, "us.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("dp")
   public static boolean method11546(World var0) {
   ...
   @ObfuscatedName("tn")
   public static int method11540(WorldEntityConfig var0) {
   ...
   @ObfuscatedName("jy")
   public static void method11545(SecureRandomSSLSocket var0, boolean var1) {
      if (var0 == null) {
         var0.getSession();
      }
   }
