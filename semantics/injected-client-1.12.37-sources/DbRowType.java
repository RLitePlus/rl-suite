...
public class DbRowType extends classVJ implements DBRowConfig {
   ...
   public Object[] method13989(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ze.ae(" + ')');
      }
   }
   ...
   public static DbRowType method13985(int var0) {
      ...
      if (null != var1) {
         ...
         var1 = new DbRowType(new Buffer(var2), var0, -1);
   ...
   DbRowType(Buffer var1, int var2, int var3) {
         ...
         while (true) {
            ...
            switch (var7) {
               ...
               default:
                  break;
               case 3:
                  int var8 = Math.max(Buffer.method13039(var1, -346779531), var3);
                  var4 = new Object[var8][];
                  var5 = new int[var8][];

                  for (int var9 = Buffer.method13039(var1, -346779531); 255 != var9; var9 = Buffer.method13039(var1, -346779531)) {
                  ...
                  break;
               case 4:
                  var6 = Buffer.method13119(var1, -1071170881);
            }
         }
      }
