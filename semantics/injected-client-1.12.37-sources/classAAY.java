...
public class classAAY {
   ...
   @ObfuscatedName("eg")
   static void method297(WorldView var0, PacketBuffer var1, int var2) {
      client.method2344(var0, var1);

      try {
         WorldView var3 = classCQ.field1220;
         var3.field1709 = Buffer.method13047(var1, -1596984619) * 182422557;
         var3.field1708 = Buffer.method13047(var1, 1871705287) * 771221349;
         ...
         WidgetConfigNode.field4141 = new byte[classXK.method12809(client.field1006, -251280248)][];
         DynamicObject.field1684 = new byte[classXK.method12809(client.field1006, 852620275)][];
         ...
         throw classEG.newRunException(var6, "aay.eg(" + ')');
      }
   }
}
