...
@ObfuscatedName("vt")
public class PlatformInfo extends Node implements classZG {
   @ObfuscatedName("be")
   boolean field6569;
   @ObfuscatedName("bi")
   ...
   @ObfuscatedName("re")
   public static String method12104(PlatformInfo var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("ng")
   public static int method12106(PlayerComposition var0, int var1) {
      if (var0 == null) {
   ...
   public void write(Buffer var1, int var2) {
      try {
         Buffer.method12971(var1, 9, (byte)-118);
         Buffer.method12971(var1, this.field6573 * 857134555, (byte)-5);
         byte var10001;
         if (this.field6569) {
            if (var2 >= -1018984066) {
         ...
         Buffer.method12971(var1, var10001, (byte)-73);
         var1.method12973(this.field6570 * -1531936339, -1542382992);
         Buffer.method12971(var1, 846122123 * this.field6571, (byte)-86);
         Buffer.method12971(var1, -198600713 * this.field6572, (byte)-105);
         Buffer.method12971(var1, this.field6568 * 2058030431, (byte)-50);
         Buffer.method12971(var1, 540215665 * this.field6574, (byte)-115);
         if (this.field6575) {
            if (var2 >= -1018984066) {
               throw new IllegalStateException();
            }
         ...
         Buffer.method12971(var1, var10001, (byte)-89);
         var1.method12973(1158232215 * this.field6584, -1542382992);
         Buffer.method12971(var1, -1837601275 * this.field6567, (byte)-46);
         Buffer.method12978(var1, this.field6579 * 1077828361, (byte)-105);
         ...
         Buffer.method12971(var1, 1274675311 * this.field6578, (byte)-34);
         var1.method12973(this.field6587 * 1347703095, -1542382992);
         var1.method12999(this.field6588, -966414083);
         var1.method12999(this.clientName, -966414083);
         Buffer.method12971(var1, this.field6586 * -429369269, (byte)-102);
         Buffer.method12971(var1, this.field6581 * 2029548605, (byte)-126);
         ...
         throw classEG.newRunException(var4, "vt.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("uc")
   public static int method12102(PlatformInfo var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var27, "vt.af(" + 41);
         }
      }
   }
   ...
   public int method12103(int var1) {
      try {
         ...
         int var13 = var14.length() + 2;
         var2 += var13;
         String var17 = this.clientName;
         int var16 = var17.length() + 2;
         var2 = var16 + var2;
         String var20 = this.field6592;
         int var19 = var20.length() + 2;
         var2 += var19;
         String var23 = this.clientName;
         int var22 = var23.length() + 2;
         var2 += var22;
