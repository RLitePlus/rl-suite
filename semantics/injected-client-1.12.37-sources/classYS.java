...
public class classYS implements Comparator {
   ...
   @ObfuscatedName("af")
   int method13616(User var1, User var2) {
   ...
   @ObfuscatedName("az")
   int method13617(User var1, User var2, int var3) {
      try {
         int var10000;
         if (this.field7075) {
            if (var3 >= -1886357123) {
         ...
         throw classEG.newRunException(var4, "ys.az(" + 41);
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         return this.method13617((User)var1, (User)var2, -1974561099);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ys.compare(" + 41);
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ys.equals(" + ')');
      }
   }
   ...
   public int method13618(Object var1, Object var2) {
      return this.method13617((User)var1, (User)var2, -2147024240);
   }
   ...
   public int method13619(Object var1, Object var2) {
      return this.method13617((User)var1, (User)var2, -2097789335);
   }
   ...
   @ObfuscatedName("vw")
   public static Object[] method13623(DbRowType var0, int var1) {
   ...
   static void method13624(byte[] var0, int var1) {
      try {
         ...
         var2.offset = (var0.length - 2) * -1095856699;
         classYL.field7001 = Buffer.method13047(var2, 1707980289) * 1826761615;
         ...
         var2.offset = -1095856699 * (var0.length - 7 - classYL.field7001 * 44342136);
         classYL.field7000 = Buffer.method13047(var2, 1410422866) * 1527476973;
         classYL.field6999 = Buffer.method13047(var2, -767132224) * 1330952715;
         int var3 = (Buffer.method13039(var2, -346779531) & 0xFF) + 1;
         ...
         for (int var4 = 0; var4 < classYL.field7001 * 1616155503; var4++) {
            ...
            classYL.field7002[var4] = Buffer.method13047(var2, -436762751);
         }
         ...
         for (int var15 = 0; var15 < classYL.field7001 * 1616155503; var15++) {
            ...
            classYL.field7003[var15] = Buffer.method13047(var2, -433462387);
         }
         ...
         for (int var16 = 0; var16 < classYL.field7001 * 1616155503; var16++) {
            ...
            classPO.field5371[var16] = Buffer.method13047(var2, -715078765);
         }
         ...
         for (int var17 = 0; var17 < classYL.field7001 * 1616155503; var17++) {
            ...
            classGG.field2578[var17] = Buffer.method13047(var2, -996484208);
         }

         var2.offset = (var0.length - 7 - classYL.field7001 * 44342136 - (var3 - 1) * 3) * -1095856699;
         ...
         for (int var19 = 0; var19 < classYL.field7001 * 1616155503; var19++) {
            ...
            int var9 = Buffer.method13039(var2, -346779531);
            boolean var10000;
            if ((var9 & 1) == 1) {
               if (var1 != -1108124092) {
                  return;
            ...
            if (!var10) {
               ...
               for (int var20 = 0; var20 < var7; var20++) {
                  ...
                  var8[var20] = Buffer.method13043(var2, (byte)17);
               }
            } else {
               for (int var12 = 0; var12 < var5; var12++) {
                  ...
                  for (int var13 = 0; var13 < var6; var13++) {
                     ...
                     var8[var12 + var5 * var13] = Buffer.method13043(var2, (byte)17);
                  }
               }
            }
            ...
            if (var11) {
               ...
               var2.offset += -1095856699 * var7;
            }
         }
      } catch (RuntimeException var14) {
         throw classEG.newRunException(var14, "ys.aj(" + ')');
      }
   }
}
