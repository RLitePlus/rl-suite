...
final class classYV implements classYH {
   ...
   @ObfuscatedName("ag")
   public static WorldMapElement[] field7095;
   @ToRemove(unused = "true")
   @ObfuscatedName("af")
   ...
   @ObfuscatedName("nn")
   public static void method13661(SecureRandomSSLSocket var0, HandshakeCompletedListener var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("az")
   void method13659(Integer var1, Buffer var2, byte var3) {
      try {
         var2.method12979(var1, 1138228602);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "yv.az(" + ')');
      }
   }
   ...
   public Object vmethod653(Buffer var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "yv.af(" + ')');
      }
   }
   ...
   public void vmethod656(Object var1, Buffer var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "yv.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("ab")
   void method13660(Integer var1, Buffer var2) {
