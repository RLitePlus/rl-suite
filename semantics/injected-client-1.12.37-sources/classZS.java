...
public final class classZS implements ScriptEventBuilder {
   ...
   public classZS method14138(boolean var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.az(" + ')');
      }
   }
   ...
   public classZS method14151(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.ab(" + ')');
      }
   }
   ...
   public static classZS method14148(classZS var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "zs.ae(" + ')');
      }
   }
   ...
   public classZS method14156(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.ag(" + ')');
      }
   }
   ...
   public classZS method14165(String var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.ax(" + ')');
      }
   }
   ...
   public classZS method14173(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("ac")
   public classZS method14168(Widget var1, byte var2) {
      try {
         this.field7258 = var1;
         return this;
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "zs.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("fz")
   public static Node method14136(NodeHashTable var0) {
   ...
   @ObfuscatedName("op")
   public static ScriptEvent method14182(classZS var0, byte var1) {
      if (var0 == null) {
         var0.method14184(var1);
      }

      try {
         return new ScriptEvent(var0);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "zs.aj(" + ')');
      }
   }
   ...
   @ObfuscatedName("gx")
   public static classZS method14169(classZS var0, Widget var1) {
      if (var0 == null) {
         var0.method14188();
      }
   ...
   @ObfuscatedName("bq")
   public ScriptEvent method14183() {
      return new ScriptEvent(this);
   }
   ...
   @ObfuscatedName("ji")
   public classZS method14189(net.runelite.api.widgets.Widget var1) {
      this.field7259 = (Widget)var1;
      return this;
   }
   ...
   public classZS method14145(Object[] var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.af(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "()Lzr;")
   @ObfuscatedName("wu")
   public ScriptEvent method14185() {
      return new ScriptEvent(this);
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lnet/runelite/api/widgets/Widget;)Lzs;")
   @ObfuscatedName("xs")
   public classZS method14190(net.runelite.api.widgets.Widget var1) {
      this.field7258 = (Widget)var1;
      return this;
   }
   ...
   public classZS method14177(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("bk")
   public classZS method14170(Widget var1) {
      this.field7258 = var1;
      return this;
   }
   ...
   public classZS method14163(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "zs.as(" + ')');
      }
   }
   ...
   public static classZS method14180(classZS var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "zs.al(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Llw;)Lzs;")
   @ObfuscatedName("bu")
   public classZS method14171(Widget var1) {
      this.field7258 = var1;
      return this;
   }
   ...
   @ObfuscatedName("aj")
   public ScriptEvent method14184(byte var1) {
      try {
         return new ScriptEvent(this);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "zs.aj(" + ')');
