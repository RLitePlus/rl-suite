...
public class classHJ implements classHM {
   ...
   void method6059(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "hj.ax(" + ')');
      }
   }
   ...
   public void vmethod469(classHG var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "hj.az(" + ')');
      }
   }
   ...
   public boolean vmethod472(int var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var5, "hj.af(" + ')');
      }
   }
   ...
   public boolean vmethod476(int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "hj.ae(" + ')');
      }
   }
   ...
   public classKY vmethod480(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var6, "hj.ag(" + ')');
      }
   }
   ...
   public void vmethod484(Buffer var1, int var2) {
      try {
         this.field2814 = Buffer.method13039(var1, -346779531) * 1400260991;
         this.field2810 = Buffer.method13039(var1, -346779531) * -1458096383;
         this.field2809 = Buffer.method13047(var1, 1325494905) * 2024834607;
         this.field2807 = Buffer.method13047(var1, 1501800655) * 200052791;
         this.field2811 = Buffer.method13047(var1, -2007941386) * -1771631903;
         this.field2813 = Buffer.method13047(var1, 782877627) * -565296129;
         this.method6059(-1433152232);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "hj.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("dj")
   public static ItemComposition method6063(Player var0, int var1) {
      if (var0 == null) {
   ...
   public void vmethod485(Buffer var1) {
      this.field2814 = Buffer.method13039(var1, -346779531) * 1400260991;
      this.field2810 = Buffer.method13039(var1, -346779531) * -1458096383;
      this.field2809 = Buffer.method13047(var1, -1410019451) * 2024834607;
      this.field2807 = Buffer.method13047(var1, -1803105477) * 200052791;
      this.field2811 = Buffer.method13047(var1, 1787004792) * -1771631903;
      this.field2813 = Buffer.method13047(var1, -799777673) * -565296129;
      this.method6059(-1433152232);
   }
   ...
   public int[] vmethod478(int var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var6, "hj.ab(" + ')');
      }
   }
