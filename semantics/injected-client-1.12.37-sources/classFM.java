...
@ObfuscatedName("fm")
public class classFM extends Node {
   @ObfuscatedName("ag")
   ...
   public classFM(int var1, int var2, int var3, Widget var4) {
   ...
   public static boolean method4846(int var0, byte var1) {
      try {
         if (classNP.field4699.isEmpty()) {
            ...
            MidiRequest var2 = (MidiRequest)classNP.field4699.get(0);
            if (var2 != null) {
               if (var1 == 3) {
         ...
         throw classEG.newRunException(var3, "fm.ax(" + ')');
      }
   }
   ...
   static void method4848(int var0, String var1, String var2, String var3, byte var4) {
      ...
      try {
         ChatChannel var15 = (ChatChannel)classCN.field1171.get(var10);
         if (null == var15) {
            if (var14 == 0) {
               throw new IllegalStateException();
            }
         ...
         Message var16 = var15.method1249(var10, var11, var12, var13, -424837532);
         IterableNodeHashTable.method13576(classCN.field1174, var16, var16.field725 * 707758669);
         classNZ.method8265(classCN.field1173, var16);
         classPV.method9261(client.field824, 1682853972);
      } catch (RuntimeException var17) {
         throw classEG.newRunException(var17, "fm.af(" + ')');
      }

      Map var5 = classOE.client.getChatLineMap();
      ...
      classOE.client.getCallbacks().post(var18);
   }

   @ObfuscatedSignature(descriptor = "(Ldz;I)V")
   @ObfuscatedName("ad")
   static final void method4847(WorldView var0, int var1) {
      try {
         ...
         CollisionMap[] var7 = var0.field1687;
         ...
         for (int var54 = 0; var54 < 4; var54++) {
            ...
            byte[][] var57 = BoundaryObject.field2250[var54];
            byte var60 = 96;
            short var62 = 768;
            byte var12 = -50;
            byte var13 = -10;
            ...
            for (int var69 = 0; var69 < var3; var69++) {
               ...
               GraphicsObject.field476[var69] = 0;
                  ...
                  if (var77 >= 0) {
                     ...
                     if (var77 < var2) {
                        ...
                        if (var98 > 0) {
                           ...
                           GraphicsObject.field476[var73] = GraphicsObject.field476[var73] + var111.field5251 * 658768917;
                  ...
                  if (var83 >= 0) {
                     ...
                     if (var83 < var2) {
                        ...
                        if (var112 > 0) {
                           ...
                           GraphicsObject.field476[var73] = GraphicsObject.field476[var73] - var117.field5251 * 658768917;
                           classIC.field2941[var73]--;
                        }
                     }
                  }
                     ...
                     for (int var100 = -5; var100 < var3 + 5; var100++) {
                        ...
                        if (var113 >= 0) {
                           ...
                           if (var113 < var3) {
                              ...
                              var89 += GraphicsObject.field476[var113];
                        ...
                        if (var118 >= 0) {
                           ...
                           if (var118 < var3) {
                              ...
                              var89 -= GraphicsObject.field476[var118];
                           ...
                           if (var100 < var3 - 1) {
                              ...
                              if (var54 > 0) {
                                 ...
                                 if (var30 > 0) {
                                    ...
                                    if (var44 != null) {
                                       ...
                                       var44 = new classOW(new Buffer(var45), var134);
                              ...
                              if (var30 == 0) {
                                 ...
                                 if (null != var46) {
                                    ...
                                    var46 = new classOW(new Buffer(var47), var138);
            ...
            BoundaryObject.field2250[var54] = (byte[][])null;
         }
         ...
         throw classEG.newRunException(var53, "fm.ad(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Lcy;")
   @ObfuscatedName("az")
   static ClientPreferences method4845(int var0) {
      try {
         classAAR var1 = null;
         ClientPreferences var2 = new ClientPreferences();

         try {
            var1 = BoundaryObject.method4612("", classYP.field7028.field4053, false, (byte)1);
         ...
         throw classEG.newRunException(var8, "fm.az(" + ')');
      }
   }
}
