...
class classRQ implements Comparator {
   ...
   @ObfuscatedName("uo")
   public static int[] method10164(Widget var0, Buffer var1) {
      if (var0 == null) {
   ...
   static void method10165(int var0, String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "rq.bx(" + ')');
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "rq.equals(" + ')');
      }
   }
   ...
   int method10158(classRO var1, classRO var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "rq.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("az")
   public static boolean method10161(WorldEntity var0, WorldEntity var1, boolean var2, byte var3) {
      try {
         if (var0 == var1) {
            if (var3 == 7) {
               throw new IllegalStateException();
         ...
         throw classEG.newRunException(var4, "rq.az(" + ')');
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         ...
         throw classEG.newRunException(var3, "rq.compare(" + 41);
      }
   }
}
