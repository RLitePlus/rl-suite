...
public class classIB extends classIS {
   ...
   void vmethod507(Buffer var1, int var2) {
      try {
         ...
         this.field2928 = Buffer.method13047(var1, 1225577849) * -1162888885;
         this.field2929 = Buffer.method13043(var1, (byte)17);
         this.field2931 = Buffer.method13047(var1, 1375876317) * 1069804709;
         var1.method13059(961837390);
         this.field2933 = var1.method13071(2084487682);
         Buffer.method13039(var1, -346779531);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ib.az(" + ')');
      }
   }
   ...
   void vmethod509(ClanChannel var1, int var2) {
      try {
         ClanChannelMember var3 = (ClanChannelMember)var1.field2955.get(287508579 * this.field2928);
         var3.field2841 = this.field2929;
         var3.field2842 = this.field2931 * 735809615;
         var3.field2846 = new classAAE(this.field2933);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ib.af(" + ')');
      }
   }
   ...
   void vmethod508(ClanChannel var1) {
      ClanChannelMember var2 = (ClanChannelMember)var1.field2955.get(287508579 * this.field2928);
   ...
   void vmethod506(Buffer var1) {
      Buffer.method13039(var1, -346779531);
      this.field2928 = Buffer.method13047(var1, 447793970) * -1162888885;
      this.field2929 = Buffer.method13043(var1, (byte)17);
      this.field2931 = Buffer.method13047(var1, 1660926076) * -1340994134;
   ...
   void vmethod505(Buffer var1) {
      Buffer.method13039(var1, -346779531);
      this.field2928 = Buffer.method13047(var1, -1090619147) * -1162888885;
      this.field2929 = Buffer.method13043(var1, (byte)17);
      this.field2931 = Buffer.method13047(var1, 1897556601) * -1804201015;
   ...
   public static boolean method6139(char var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "ib.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxs;I)V")
   @ObfuscatedName("af")
   public static void method6138(PacketBuffer var0, int var1) {
      try {
         ...
         if (var2 == null) {
            ...
            int var3 = 702114061 * var0.offset;
            ...
            for (int var4 = 0; var4 < var2.field7235 * 569821081; var4++) {
               ...
               if (0 != var2.field7239[var4]) {
                  ...
                  Buffer.method12971(var0, var2.field7239[var4], (byte)-12);
               } else {
                  try {
                     ...
                     if (0 == var5) {
                        ...
                        Buffer.method12971(var0, 0, (byte)-78);
                        ...
                        Buffer.method12971(var0, 0, (byte)-75);
                     } else if (var5 == 2) {
                        if (var1 != 1238864384) {
                           throw new IllegalStateException();
                        }
                        ...
                        Buffer.method12971(var0, 0, (byte)-27);
                     ...
                     if (var5 != 3) {
                        if (4 == var5) {
                           ...
                           Buffer.method12971(var0, 0, (byte)-54);
                        ...
                        if (null == var31) {
                           ...
                           Buffer.method12971(var0, 0, (byte)-59);
                        } else if (var31 instanceof Number) {
                           if (var1 != 1238864384) {
                              throw new IllegalStateException();
                           }

                           Buffer.method12971(var0, 1, (byte)-105);
                           var0.method12987(((Number)var31).longValue());
                        } else if (var31 instanceof String) {
                           Buffer.method12971(var0, 2, (byte)-1);
                           Buffer.method12997(var0, (String)var31, (short)29215);
                        } else {
                           Buffer.method12971(var0, 4, (byte)-93);
                        }
                     }
                  } catch (ClassNotFoundException var11) {
                     Buffer.method12971(var0, -10, (byte)-62);
                  } catch (InvalidClassException var12) {
                     Buffer.method12971(var0, -11, (byte)-60);
                  } catch (StreamCorruptedException var13) {
                     Buffer.method12971(var0, -12, (byte)-29);
                  } catch (OptionalDataException var14) {
                     Buffer.method12971(var0, -13, (byte)-75);
                  } catch (IllegalAccessException var15) {
                     Buffer.method12971(var0, -14, (byte)-47);
                  } catch (IllegalArgumentException var16) {
                     Buffer.method12971(var0, -15, (byte)-73);
                  } catch (InvocationTargetException var17) {
                     Buffer.method12971(var0, -16, (byte)-62);
                  } catch (SecurityException var18) {
                     Buffer.method12971(var0, -17, (byte)-124);
                  } catch (IOException var19) {
                     Buffer.method12971(var0, -18, (byte)-1);
                  } catch (NullPointerException var20) {
                     Buffer.method12971(var0, -19, (byte)-95);
                  } catch (Exception var21) {
                     Buffer.method12971(var0, -20, (byte)-14);
                  } catch (Throwable var22) {
                     Buffer.method12971(var0, -21, (byte)-53);
                  }
               }
            }
         ...
         throw classEG.newRunException(var23, "ib.af(" + ')');
      }
   }
}
