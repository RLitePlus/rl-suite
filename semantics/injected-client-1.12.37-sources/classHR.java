...
public class classHR implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "hr.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("bk")
   static int method6099(int var0, Script var1, boolean var2, byte var3) {
      try {
         if (3500 == var0) {
            int var7 = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
            classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = classFA.method4540(client.field931, var7, 1280114740) ? 1 : 0;
            return 1;
         } else if (var0 == 3501) {
            if (var3 == 1) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = client.field931.method4533(var6, -653933511) ? 1 : 0;
               return 1;
            }
         } else if (var0 == 3502) {
            if (var3 == 1) {
         ...
         throw classEG.newRunException(var5, "hr.bk(" + 41);
      }
   }
   ...
   static classHR[] method6097(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "hr.ag(" + ')');
      }
   }
}
