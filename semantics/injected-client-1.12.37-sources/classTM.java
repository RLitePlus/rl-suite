...
public class classTM {
   ...
   public static int method10934(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tm.az(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;Llw;I)V")
   @ObfuscatedName("fj")
   static void method10935(Widget var0, Widget var1, int var2) {
      try {
         if (var1 != null) {
            if (var2 != 1238625483) {
               throw new IllegalStateException();
            ...
            if (classWK.field6691.method12139(var0, (byte)-89) != null) {
               PacketBufferNode var3 = classEF.getPacketBufferNode(ClientPacket.IF_BUTTOND, client.packetWriter.isaacCipher, (byte)-72);
               Buffer.method13186(var3.packetBuffer, 63131743 * var0.field4260, (byte)16);
               var3.packetBuffer.method12979(var1.field4329 * -1163656551, 118945049);
               var3.packetBuffer.method12973(var1.field4260 * 63131743, -1542382992);
               var3.packetBuffer.method12979(-1163656551 * var0.field4329, -458203294);
               Buffer.method13186(var3.packetBuffer, var1.field4319 * 2073671441, (byte)16);
               var3.packetBuffer.method13188(2073671441 * var0.field4319, (short)-25158);
               client.packetWriter.addNode(var3, -1301097035);
            }
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "tm.fj(" + ')');
      }
   }
