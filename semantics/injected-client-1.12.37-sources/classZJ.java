...
public class classZJ {
   ...
   @ObfuscatedName("az")
   public static IterableNodeDeque field7189 = new IterableNodeDeque();
   ...
   @ObfuscatedName("ax")
   public static void method14046(PacketBuffer var0) {
      classZQ var1 = (classZQ)field7189.method8167();
      if (var1 != null) {
         int var2 = 702114061 * var0.offset;
         ...
         for (int var3 = 0; var3 < var1.field7235 * 569821081; var3++) {
            if (0 != var1.field7239[var3]) {
               Buffer.method12971(var0, var1.field7239[var3], (byte)-125);
            } else {
               try {
                  ...
                  if (var4 != 3) {
                     if (4 == var4) {
                        ...
                        Buffer.method12971(var0, 0, (byte)-47);
                     ...
                     if (null == var29) {
                        Buffer.method12971(var0, 0, (byte)-19);
                     } else if (var29 instanceof Number) {
                        Buffer.method12971(var0, 1, (byte)-35);
                        var0.method12987(((Number)var29).longValue());
                     } else if (var29 instanceof String) {
                        Buffer.method12971(var0, 2, (byte)-78);
                        Buffer.method12997(var0, (String)var29, (short)24468);
                     } else {
                        Buffer.method12971(var0, 4, (byte)-92);
                     }
                  }
               } catch (ClassNotFoundException var10) {
                  Buffer.method12971(var0, -10, (byte)-43);
               } catch (InvalidClassException var11) {
                  Buffer.method12971(var0, -11, (byte)-28);
               } catch (StreamCorruptedException var12) {
                  Buffer.method12971(var0, 30597723, (byte)-15);
               } catch (OptionalDataException var13) {
                  Buffer.method12971(var0, -13, (byte)-73);
               } catch (IllegalAccessException var14) {
                  Buffer.method12971(var0, -14, (byte)-36);
               } catch (IllegalArgumentException var15) {
                  Buffer.method12971(var0, -15, (byte)-80);
               } catch (InvocationTargetException var16) {
                  Buffer.method12971(var0, -16, (byte)-105);
               } catch (SecurityException var17) {
                  Buffer.method12971(var0, 512175335, (byte)-87);
               } catch (IOException var18) {
                  Buffer.method12971(var0, -18, (byte)-64);
               } catch (NullPointerException var19) {
                  Buffer.method12971(var0, 1315714708, (byte)-95);
               } catch (Exception var20) {
                  Buffer.method12971(var0, -20, (byte)-15);
               } catch (Throwable var21) {
                  Buffer.method12971(var0, -21, (byte)-6);
               }
            }
         }
   ...
   @ObfuscatedName("ac")
   public static void method14047(Buffer var0, int var1) {
      classZQ var2 = new classZQ();
      var2.field7235 = Buffer.method13039(var0, -346779531) * -1690461015;
         ...
         try {
            ...
            if (0 != var4 && var4 != 1 && var4 != 2) {
               if (var4 == 3 || var4 == 4) {
                  ...
                  int var27 = Buffer.method13039(var0, -346779531);
      ...
      IterableNodeDeque.method8156(field7189, var2);
   }
   ...
   @ObfuscatedName("be")
   static final void getLoginError(int var0) {
      try {
         if (-496203881 * client.field967 == 0) {
            WorldView var2 = classIS.field3053;
            ...
            switch (-1921957715 * classLE.field4126.field4024) {
               case 0:
                  var25 = (CameraFocusableEntity)var2.field1694.method13404(1778071523 * client.field849);
                  break;
               case 1:
                  var25 = (CameraFocusableEntity)var2.field1698.method13404(1778071523 * client.field849);
                  break;
               case 2:
                  var25 = (CameraFocusableEntity)var2.worldEntities.method13595(client.field849 * 1778071523);
                  break;
               case 3:
            ...
            client.field962 = ((CameraFocusableEntity)var25).vmethod368(311606126) * 1126376453;
            client.field986 = ((CameraFocusableEntity)var25).vmethod371(-1314369959) * 320618265;
            if (classIS.field3053 != var2) {
               if (var0 != 1161256214) {
                  throw new IllegalStateException();
               }

               classUZ var30 = classYY.method13790(
                  var2, ((CameraFocusableEntity)var25).vmethod368(311606126), ((CameraFocusableEntity)var25).vmethod371(-1769115976), (byte)114
               );
            ...
            label506: {
               client.field1040 = ((CameraFocusableEntity)var25).vmethod258((byte)-102) * -686553453;
            ...
            if (var46 > Scene.method4138(client.field839) * 256) {
               var46 = Scene.method4138(client.field839) * 256;
            }

            if (var46 < Scene.method4131(client.field839) * 256) {
               var46 = Scene.method4131(client.field839) * 256;
            }
            ...
            int var47 = ((CameraFocusableEntity)var25).vmethod368(311606126);
            int var48 = ((CameraFocusableEntity)var25).vmethod371(-1925650647);
            int var12 = client.field1040 * 1741031323;
            int var13 = classKV.method6571(var2, var47, var48, var12, (byte)122);
            WorldEntity var14 = (WorldEntity)classIS.field3053.worldEntities.method13595(2140889407 * var2.field1699);
            if (null != var14) {
               if (var0 != 1161256214) {
                  return;
               }
            ...
            WorldView var21 = client.field814.method1590(client.field846 * -2034209657, (short)-7746);
            Player var32 = var21.method3737(-2130951373 * client.field845, (byte)1);
            classUZ var1;
            if (null != var32) {
               if (var0 != 1161256214) {
                  throw new IllegalStateException();
            ...
            int var35 = Scene.method4131(client.field839) * 256;
            ...
            if (classFA.method4540(client.field931, 13, -35163126)) {
               ...
               client.packetWriter.addNode(classEF.getPacketBufferNode(ClientPacket.EXIT_FREECAM, client.packetWriter.isaacCipher, (byte)-43), -1301097035);
               client.field967 = 0;
            }
         }

         label528: {
            if (2090434187 * MouseHandler.field6251 == 4) {
               if (var0 != 1161256214) {
                  throw new IllegalStateException();
               }
               ...
               if (classON.field4995) {
                  int var49;
                  label448: {
                     int var19 = -2144333897 * MouseHandler.MouseHandler_y - -958869211 * client.field921;
                     ...
                     if (-1 != var19) {
                        ...
                        if (1 != var19) {
                           var49 = (-2144333897 * MouseHandler.MouseHandler_y + client.field921 * -958869211) / 2;
                           break label448;
                        }
                     ...
                     var49 = -2144333897 * MouseHandler.MouseHandler_y;
                  }

                  label441: {
                     client.field921 = var49 * -1074208083;
                     int var24 = 1832988085 * client.field812 - -38255113 * MouseHandler.MouseHandler_x;
                     ...
                     if (var24 != -1) {
                        ...
                        if (var24 != 1) {
                           var49 = (1832988085 * client.field812 + -38255113 * MouseHandler.MouseHandler_x) / 2;
                           break label441;
                        }
                     ...
                     var49 = -38255113 * MouseHandler.MouseHandler_x;
                  }
            ...
            client.field921 = MouseHandler.MouseHandler_y * -794678101;
            client.field812 = -1310977925 * MouseHandler.MouseHandler_x;
         }
         ...
         throw classEG.newRunException(var15, "zj.be(" + ')');
      }
   }
}
