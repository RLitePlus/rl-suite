...
public class classZC extends classVJ {
   ...
   public classZC(AbstractArchive var1, int var2) {
      byte[] var3 = var1.method11867(var2, 0, -1251911506);
      if (null != var3) {
         this.method13832(new Buffer(var3), (byte)2);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ax")
   void method13831(Buffer var1) {
      int var2 = Buffer.method13119(var1, -1101542591);
      this.field7152 = new classYY[var2];
      this.field7151 = new ArrayList(var2);

      for (int var3 = 0; var3 < var2; var3++) {
         this.field7152[var3] = (classYY)classOF.method8404(classYY.method13782((byte)76), Buffer.method13039(var1, -346779531), 1583855012);
         int var4 = Buffer.method13119(var1, -747970285);
         HashMap var5 = new HashMap(var4);

         while (var4-- > 0) {
            Object var6 = this.field7152[var3].method13787(var1, 827988912);
            int var7 = Buffer.method13119(var1, -151343769);
            ArrayList var8 = new ArrayList();

            while (var7-- > 0) {
               int var9 = Buffer.method13119(var1, -1881555353);
               var8.add(var9);
            }
   ...
   public boolean method13828(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "zc.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;B)V")
   @ObfuscatedName("af")
   void method13832(Buffer var1, byte var2) {
      try {
         int var3 = Buffer.method13119(var1, -1998324959);
         ...
         for (int var4 = 0; var4 < var3; var4++) {
            ...
            this.field7152[var4] = (classYY)classOF.method8404(classYY.method13782((byte)-4), Buffer.method13039(var1, -346779531), 54392156);
            int var5 = Buffer.method13119(var1, -1788832399);
            ...
            while (var5-- > 0) {
               ...
               int var8 = Buffer.method13119(var1, -1373334814);
               ...
               while (var8-- > 0) {
                  ...
                  int var10 = Buffer.method13119(var1, 176951995);
                  var9.add(var10);
               }
         ...
         throw classEG.newRunException(var11, "zc.af(" + ')');
      }
   }
   ...
   public List method13834(Object var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var5, "zc.ae(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("as")
   void method13833(Buffer var1) {
      int var2 = Buffer.method13119(var1, 221140724);
      this.field7152 = new classYY[var2];
      this.field7151 = new ArrayList(var2);

      for (int var3 = 0; var3 < var2; var3++) {
         this.field7152[var3] = (classYY)classOF.method8404(classYY.method13782((byte)55), Buffer.method13039(var1, -346779531), -1159903959);
         int var4 = Buffer.method13119(var1, -249936447);
         HashMap var5 = new HashMap(var4);

         while (var4-- > 0) {
            Object var6 = this.field7152[var3].method13787(var1, 827988912);
            int var7 = Buffer.method13119(var1, -915204940);
            ArrayList var8 = new ArrayList();

            while (var7-- > 0) {
               int var9 = Buffer.method13119(var1, -1022044693);
               var8.add(var9);
            }
   ...
   public classZC(AbstractArchive var1, int var2, int var3) {
      byte[] var4 = var1.method11867(var2, var3 + 1, -960653587);
      if (null != var4) {
         this.method13832(new Buffer(var4), (byte)32);
      }
   }
