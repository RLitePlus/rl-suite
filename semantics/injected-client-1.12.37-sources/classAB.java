...
public final class classAB {
   @ObfuscatedName("rq")
   static java.awt.Font field123;
   @ObfuscatedSignature(descriptor = "Lcy;")
   @ObfuscatedName("kn")
   static ClientPreferences field122;
   @ObfuscatedName("au")
   static int[] field126;
      ...
      try {
         if (var0 == null) {
            ...
            switch (-900901303 * var0.field7107) {
               case 2:
                  return classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
               case 3:
         ...
         throw classEG.newRunException(var2, "ab.ca(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V")
   @ObfuscatedName("al")
   static void setLoginResponse(String var0, String var1, String var2, int var3) {
      try {
         classAC.method326(7, 2121783381);
         WorldEntity.method10624(var0, var1, var2, (byte)-121);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ab.al(" + ')');
      }
   }
   ...
   static int method309(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "ab.hi(" + 41);
      }
   }
}
