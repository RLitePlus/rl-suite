...
public final class classUL {
   ...
   public static void method11377(classUL var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ul.ay(" + ')');
         }
      }
   }
   ...
   public void method11357(int var1) {
      try {
         ...
         throw classEG.newRunException(var5, "ul.ax(" + ')');
      }
   }
   ...
   void method11361(float var1, float var2, float var3, float var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var6, "ul.ac(" + ')');
      }
   }
   ...
   public static float method11386(classUL var0, classUL var1, byte var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "ul.ap(" + ')');
      }
   }
   ...
   public void method11368(classUZ var1, float var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ul.ao(" + ')');
      }
   }
   ...
   public void method11371(float var1, float var2, float var3, float var4, short var5) {
      try {
         ...
         throw classEG.newRunException(var8, "ul.al(" + ')');
      }
   }
   ...
   public void method11373(float var1, float var2, float var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var6, "ul.aj(" + ')');
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ul.equals(" + ')');
      }
   }
   ...
   public final void method11390(classUL var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ul.au(" + ')');
      }
   }
   ...
   public int hashCode() {
      try {
         ...
         throw classEG.newRunException(var3, "ul.hashCode(" + 41);
      }
   }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "ul.toString(" + ')');
      }
   }
   ...
   void method11365(classUL var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ul.aa(" + ')');
      }
   }
   ...
   final void method11381(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ul.aq(" + ')');
      }
   }
   ...
   static void method11401(int var0, int var1, int var2) {
      try {
         PacketBufferNode var3 = classEF.getPacketBufferNode(ClientPacket.RESUME_PAUSEBUTTON, client.packetWriter.isaacCipher, (byte)-81);
         var3.packetBuffer.method12979(var0, 478308754);
         var3.packetBuffer.method13188(var1, (short)-25700);
         client.packetWriter.addNode(var3, -1301097035);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ul.ec(" + ')');
      }
   }
   ...
   public static void method11384(classUL var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "ul.ad(" + ')');
      }
   }
