...
@ObfuscatedName("cg")
public class Message extends classVJ implements MessageNode {
   @ObfuscatedName("az")
   int field727;
   @ObfuscatedName("ae")
   int field724;
      ...
      try {
         ...
         if (var3 != null) {
            ...
            if (var1 >= 0) {
               ...
               if (var1 < ClanChannel.method6183(var3, (byte)-40)) {
                  ClanChannelMember var4 = (ClanChannelMember)var3.field2955.get(var1);
                  if (-1 != var4.field2841) {
                     return;
                  }

                  String var5 = var4.field2846.method164(1679046558);
                  PacketBufferNode var6 = classEF.getPacketBufferNode(ClientPacket.CLANCHANNEL_KICKUSER, client.packetWriter.isaacCipher, (byte)-16);
                  Buffer.method12971(var6.packetBuffer, 3 + classAU.method712(var5, (byte)109), (byte)-119);
                  Buffer.method12971(var6.packetBuffer, var0, (byte)-30);
                  var6.packetBuffer.method12973(var1, -1542382992);
                  Buffer.method12997(var6.packetBuffer, var5, (short)6913);
         ...
         throw classEG.newRunException(var7, "cg.gy(" + ')');
      }
   }
   ...
   void method1469(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cg.af(" + ')');
      }
   }
   ...
   final boolean method1473(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cg.ae(" + ')');
      }
   }
   ...
   void method1466(int var1, String var2, String var3, String var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var7, "cg.az(" + ')');
      }
   }
   ...
   final void method1491(int var1) {
      try {
         if (null != this.field729) {
            ...
            this.field728 = new classAAE(classKW.method6577(this.field729, 88707466), InterfaceParent.field5279);
         } else {
            this.field728 = null;
         }
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "cg.ac(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lcg;I)Z")
   @ObfuscatedName("ti")
   public static boolean method1486(Message var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "cg.as(" + ')');
         }
      }
   }
   ...
   public static classKU[] method1465(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "cg.ag(" + ')');
      }
   }
   ...
   void method1490(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cg.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("of")
   public static void method1492(Message var0) {
      if (var0 == null) {
         var0.method1471();
      }

      if (null != var0.field729) {
         var0.field728 = new classAAE(classKW.method6577(var0.field729, 1572821090), InterfaceParent.field5279);
      } else {
         var0.field728 = null;
      }
   }
   ...
   public void method1498(int var1, String var2, String var3, String var4) {
      ...
      if (var2 != null) {
         ...
         if (var5 != -1) {
            this.field728 = new classAAE(var2.substring(var5 + 1), InterfaceParent.field5279);
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lcg;)V")
   @ObfuscatedName("xb")
   public static void method1493(Message var0) {
      if (null != var0.field729) {
         var0.field728 = new classAAE(classKW.method6577(var0.field729, -1026176828), InterfaceParent.field5279);
      } else {
         var0.field728 = null;
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Lcg;)V")
   @ObfuscatedName("ca")
   public static void method1494(Message var0) {
      if (null != var0.field729) {
         var0.field728 = new classAAE(classKW.method6577(var0.field729, 1689865045), InterfaceParent.field5279);
      } else {
         var0.field728 = null;
      }
   }
   ...
   void method1480(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cg.ab(" + ')');
      }
   }
   ...
   void method1484(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cg.ag(" + ')');
      }
   }
   ...
   public void setName(String var1) {
      if (var1 == null) {
         ...
         this.field728 = new classAAE(var1, InterfaceParent.field5279);
      }
   }
   ...
   public static boolean method1497(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "cg.hz(" + ')');
      }
   }
   ...
   static boolean method1495(String var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "cg.af(" + ')');
      }
   }
