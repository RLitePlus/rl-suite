...
@ObfuscatedName("ps")
public class WorldMapElement extends classVJ implements MapElementConfig {
   @ObfuscatedName("ap")
   int[] field5415;
   @ObfuscatedName("af")
   ...
   @ObfuscatedName("ae")
   static EvictingDualNodeHashTable field5406 = new EvictingDualNodeHashTable(256);
   @ObfuscatedSignature(descriptor = "Lva;")
   @ObfuscatedName("ab")
   public static AbstractArchive field5413;
   @ObfuscatedName("as")
   ...
   public static void method9185() {
      EvictingDualNodeHashTable.method6431(field5406);
   }

   @ToRemove(unused = "true")
   @ObfuscatedSignature(descriptor = "(I)Lps;")
   @ObfuscatedName("aa")
   public static WorldMapElement method9183(int var0) {
      return var0 >= 0 && var0 < classYV.field7095.length && classYV.field7095[var0] != null ? classYV.field7095[var0] : new WorldMapElement(var0);
   }
   ...
   SpritePixels method9201(int var1, short var2) {
      try {
         if (var1 < 0) {
            ...
            SpritePixels var3 = (SpritePixels)field5406.method6422(var1);
            if (null != var3) {
               if (var2 <= 232) {
                  throw new IllegalStateException();
               } else {
         ...
         throw classEG.newRunException(var4, "ps.ax(" + ')');
      }
   }
   ...
   @ObfuscatedName("dv")
   public static void method9195(WorldMapElement var0) {
   ...
   @ObfuscatedSignature(descriptor = "(Lps;)V")
   @ObfuscatedName("vx")
   public static void method9196(WorldMapElement var0) {
      if (null != var0.field5416) {
         for (byte var1 = 0; var1 < var0.field5416.length; var1 += 2) {
            if (var0.field5416[var1] < var0.field5396 * -1409238271) {
               var0.field5396 = var0.field5416[var1] * 429409537;
   ...
   public int method9203(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ps.ac(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;Lxy;B)V")
   @ObfuscatedName("th")
   public static void method9187(WorldMapElement var0, Buffer var1, byte var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var4, "ps.ae(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(I)Lps;")
   @ObfuscatedName("ao")
   public static WorldMapElement method9184(int var0) {
      return var0 >= 0 && var0 < classYV.field7095.length && classYV.field7095[var0] != null ? classYV.field7095[var0] : new WorldMapElement(var0);
   }

   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("ay")
   public void method9188(Buffer var1) {
      while (true) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;)V")
   @ObfuscatedName("aq")
   public void method9189(Buffer var1) {
      while (true) {
         int var2 = Buffer.method13039(var1, -346779531);
         if (0 == var2) {
            return;
   ...
   @ObfuscatedName("ad")
   void method9191(Buffer var1, int var2) {
      if (1 == var2) {
         this.field5395 = Buffer.method13110(var1, -324749371) * 776403169;
      } else if (2 == var2) {
         this.field5393 = Buffer.method13110(var1, -324749371) * -998477221;
      } else if (var2 == 3) {
         ...
         this.field5394 = Buffer.method13039(var1, -346779531) * -1551911823;
      } else if (var2 == 7) {
         int var3 = Buffer.method13039(var1, -346779531);
         if (0 == (var3 & 1)) {
         ...
         for (int var9 = 0; var9 < var6; var9++) {
            this.field5414[var9] = Buffer.method13043(var1, (byte)17);
         }
      } else if (var2 != 16) {
         if (17 == var2) {
            this.field5411 = var1.method13071(-637679169);
         } else if (var2 == 18) {
            Buffer.method13110(var1, -324749371);
         } else if (19 == var2) {
            this.field5404 = Buffer.method13047(var1, 336475091) * -1772509582;
         } else if (var2 == 21) {
            var1.method13056((byte)1);
         } else if (var2 == 22) {
            var1.method13056((byte)1);
            ...
            this.field5402 = (classPE)classOF.method8404(classLP.method7140(494844112), Buffer.method13039(var1, -346779531), -1114593499);
         } else if (var2 == 30) {
            classOL[] var7 = new classOL[]{classOL.field4915, classOL.field4914, classOL.field4916};
            this.field5397 = (classOL)classOF.method8404(var7, Buffer.method13039(var1, -346779531), 1980613816);
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Z)Lym;")
   @ObfuscatedName("jl")
   public SpritePixels method9200(boolean var1) {
   ...
   @ObfuscatedName("ak")
   SpritePixels method9202(int var1) {
      if (var1 < 0) {
         return null;
      } else {
         SpritePixels var2 = (SpritePixels)field5406.method6422(var1);
         if (null != var2) {
            return var2;
         } else {
   ...
   static int method9182(int var0, int var1, classGE var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var7, "ps.az(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lxy;II)V")
   @ObfuscatedName("ab")
   void method9192(Buffer var1, int var2, int var3) {
      try {
         if (1 == var2) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            ...
            this.field5394 = Buffer.method13110(var1, -324749371) * 776403169;
         } else if (2 == var2) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            }

            this.field5396 = Buffer.method13110(var1, -324749371) * -998477221;
         } else if (var2 == 3) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            }
            ...
            this.field5394 = Buffer.method13039(var1, -346779531) * -17682209;
         } else if (var2 == 7) {
            ...
            int var10 = Buffer.method13039(var1, -346779531);
            ...
            for (int var11 = 0; var11 < var8; var11++) {
               ...
               this.field5414[var11] = Buffer.method13043(var1, (byte)17);
            }
         } else if (var2 == 16) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            ...
            this.field5394 = Buffer.method13047(var1, -696547813) * 384460919;
         } else if (var2 == 21) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            }
            ...
            this.field5402 = (classPE)classOF.method8404(classLP.method7140(874163108), Buffer.method13039(var1, -346779531), -971717788);
         } else if (var2 == 30) {
            if (var3 >= -1241739344) {
               return;
            }
            ...
            this.field5397 = (classOL)classOF.method8404(var9, Buffer.method13039(var1, -346779531), 414905435);
         }
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "ps.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lps;Lxy;II)V")
   @ObfuscatedName("eh")
   public static void method9193(WorldMapElement var0, Buffer var1, int var2, int var3) {
      if (var0 == null) {
      ...
      try {
         if (1 == var2) {
            ...
            var0.field5395 = Buffer.method13110(var1, -324749371) * 776403169;
         } else if (2 == var2) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            }

            var0.field5393 = Buffer.method13110(var1, -324749371) * -998477221;
         } else if (var2 == 3) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            }
            ...
            var0.field5394 = Buffer.method13039(var1, -346779531) * -17682209;
         } else if (var2 == 7) {
            int var4 = Buffer.method13039(var1, -346779531);
            if (0 == (var4 & 1)) {
            ...
            for (int var11 = 0; var11 < var8; var11++) {
               ...
               var0.field5414[var11] = Buffer.method13043(var1, (byte)17);
            }
         } else if (var2 == 16) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            ...
            var0.field5404 = Buffer.method13047(var1, -696547813) * 384460919;
         } else if (var2 == 21) {
            if (var3 >= -1241739344) {
               throw new IllegalStateException();
            }
            ...
            var0.field5402 = (classPE)classOF.method8404(classLP.method7140(874163108), Buffer.method13039(var1, -346779531), -971717788);
         } else if (var2 == 30) {
            if (var3 >= -1241739344) {
               return;
            }
            ...
            var0.field5397 = (classOL)classOF.method8404(var9, Buffer.method13039(var1, -346779531), 414905435);
         }
      } catch (RuntimeException var7) {
         throw classEG.newRunException(var7, "ps.ab(" + ')');
      }
   ...
   @ObfuscatedName("ae")
   public void method9190(Buffer var1, byte var2) {
      try {
         while (true) {
            int var3 = Buffer.method13039(var1, -346779531);
            if (0 == var3) {
