...
public class classIG extends classHB {
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ig.az(" + ')');
      }
   }
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ig.af(" + ')');
      }
   }
   ...
   void vmethod501(Buffer var1) {
      if (Buffer.method13039(var1, -346779531) != -1087359743) {
         var1.offset -= -1095856699;
   ...
   @ObfuscatedName("aj")
   static int method6210(int var0, Script var1, boolean var2, int var3) {
      try {
         Widget var4;
         if (var0 >= 2000) {
            if (var3 != -1306305670) {
         ...
         if (1000 == var0) {
            if (var3 != -1306305670) {
               ...
               var4.field4248 = classBB.field323[DynamicObject.field1679 * -324749371] * -1076753689;
               var4.field4285 = 1989424741 * classBB.field323[1 + DynamicObject.field1679 * -324749371];
               var4.field4264 = 1632281619 * classBB.field323[DynamicObject.field1679 * -324749371 + 2];
               var4.field4250 = classBB.field323[3 + DynamicObject.field1679 * -324749371] * 454876301;
               classCD.method1430(var4, classSA.field5897 * 773246731, IntProjection.field1938 * 8379747, classWK.field6691, client.field823, -2055866783);
            ...
            if (var3 != -1306305670) {
               ...
               DynamicObject.field1679 -= 480164916;
               var4.field4255 = classBB.field323[DynamicObject.field1679 * -324749371] * 1034606045;
               var4.field4335 = -259501473 * classBB.field323[1 + DynamicObject.field1679 * -324749371];
               var4.field4251 = classBB.field323[2 + DynamicObject.field1679 * -324749371] * -1430539503;
               var4.field4252 = classBB.field323[DynamicObject.field1679 * -324749371 + 3] * -565540095;
               classCD.method1430(var4, 773246731 * classSA.field5897, IntProjection.field1938 * 8379747, classWK.field6691, client.field823, -1983695323);
         ...
         throw classEG.newRunException(var6, "ig.aj(" + 41);
      }
   }
   ...
   static String method6209(long var0, int var2, int var3, boolean var4, classRZ var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var19, "ig.ab(" + ')');
      }
   }
}
