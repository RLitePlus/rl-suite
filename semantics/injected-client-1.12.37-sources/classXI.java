...
class classXI implements Iterator {
   ...
   @ObfuscatedName("sk")
   public static void method12789(SecureRandomSSLSocket var0, boolean var1) {
      if (var0 == null) {
         var0.method9449();
      }
   }
   ...
   public void remove() {
      try {
         ...
         throw classEG.newRunException(var1, "xi.remove(" + ')');
      }
   }
   ...
   public boolean hasNext() {
      try {
         ...
         throw classEG.newRunException(var1, "xi.hasNext(" + ')');
      }
   }
   ...
   public Object next() {
      try {
         ...
         throw classEG.newRunException(var3, "xi.next(" + ')');
      }
   }
