...
public class classVZ {
   ...
   public static void method12278(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "vz.ay(" + ')');
      }
   }
   ...
   public String toString() {
      try {
         ...
         throw classEG.newRunException(var1, "vz.toString(" + ')');
      }
   }
   ...
   @ObfuscatedName("oi")
   public static void method12276(KeyHandler var0, classTL var1, int var2) {
