...
public class classHS extends classHB {
   ...
   public static classMU method6101(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "hs.az(" + ')');
      }
   }
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         ...
         this.field2881 = Buffer.method13043(var1, (byte)17);
         this.field2880 = Buffer.method13043(var1, (byte)17);
         this.field2879 = Buffer.method13043(var1, (byte)17);
         this.field2882 = Buffer.method13043(var1, (byte)17);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "hs.az(" + ')');
      }
   }
   ...
   public static final int method6100(double var0, double var2, double var4) {
      try {
         ...
         throw classEG.newRunException(var22, "hs.az(" + 41);
      }
   }
   ...
   void vmethod500(Buffer var1) {
      this.field2883 = Buffer.method13039(var1, -346779531) == 1;
      this.field2881 = Buffer.method13043(var1, (byte)17);
      this.field2880 = Buffer.method13043(var1, (byte)17);
      this.field2879 = Buffer.method13043(var1, (byte)17);
      this.field2882 = Buffer.method13043(var1, (byte)17);
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "hs.af(" + ')');
      }
   }
   ...
   static void method6102(Font var0, Font var1, Font var2, int var3) {
      ...
      try {
         ...
         if (classBF.field413) {
            ...
            label694: {
               ...
               if (-47366135 * classBF.field384 == 0) {
                  ...
                  if (classBF.JX_DISPLAY_NAME.isEmpty()) {
                     if (var3 >= -1329525269) {
                        return;
                     }
                     ...
                     var0.method65(classBF.JX_DISPLAY_NAME, var72, 68 + var119 - 15, 16776960, 0);
                  }
         ...
         throw classEG.newRunException(var12, "hs.ai(" + ')');
      }
   }
   ...
   static int method6103(int var0, Script var1, boolean var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var8, "hs.bz(" + 41);
      }
   }
