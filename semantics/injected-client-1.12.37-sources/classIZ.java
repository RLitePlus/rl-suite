...
public class classIZ extends classHB {
   ...
   void vmethod498(Buffer var1, int var2) {
      try {
         this.field3100 = Buffer.method13047(var1, -1009266385) * 1376629843;
         this.field3105 = Buffer.method13039(var1, -346779531) == 1;
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "iz.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("tc")
   public static int method6341(AbstractArchive var0) {
      if (var0 == null) {
         var0.method11834();
      }
   ...
   void vmethod499(ClanSettings var1, byte var2) {
      try {
         ClanSettings.method6276(var1, 800501723 * this.field3100, this.field3105, 2072579966);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "iz.af(" + ')');
      }
   }
   ...
   void vmethod501(Buffer var1) {
      this.field3100 = Buffer.method13047(var1, -1334039576) * 1376629843;
      this.field3105 = Buffer.method13039(var1, -346779531) == 1;
   }
   ...
   void vmethod502(ClanSettings var1) {
      ClanSettings.method6276(var1, -2086270710 * this.field3100, this.field3105, 1901524512);
   }
   ...
   public static final classUZ method6340(classUZ var0, classUZ var1, int var2) {
      try {
         classUZ var3 = WorldMapArea.method5840(var0, (byte)-35);
         var3.method11768(var1, -1351554887);
         return var3;
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "iz.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("cp")
   public static int method6342(ItemComposition var0, int var1, int var2) {
   ...
   void vmethod503(ClanSettings var1) {
      ClanSettings.method6276(var1, 800501723 * this.field3100, this.field3105, 1923317305);
   }
   ...
   void vmethod504(ClanSettings var1) {
      ClanSettings.method6276(var1, 800501723 * this.field3100, this.field3105, 2070297393);
   }
   ...
   public static int method6339(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "iz.az(" + 41);
      }
   }
   ...
   void vmethod500(Buffer var1) {
      this.field3100 = Buffer.method13047(var1, -236751831) * 1376629843;
      this.field3105 = Buffer.method13039(var1, -346779531) == 1;
   }
   ...
   public static int method6338(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var8, "iz.az(" + 41);
      }
   }
}
