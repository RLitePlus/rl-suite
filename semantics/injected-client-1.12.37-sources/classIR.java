...
public class classIR extends classIS {
   ...
   void vmethod509(ClanChannel var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "ir.af(" + ')');
      }
   }
   ...
   public static SpritePixels[] method6307(AbstractArchive var0, int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var12, "ir.af(" + ')');
      }
   }
   ...
   void vmethod506(Buffer var1) {
      if (Buffer.method13039(var1, -346779531) != 104191455) {
         var1.offset -= 796120900;
         var1.method13059(302631968);
      }

      this.field3046 = var1.method13069((byte)-1);
      this.field3048 = Buffer.method13047(var1, -1035866912) * -680867885;
      this.field3047 = Buffer.method13043(var1, (byte)17);
   ...
   void vmethod507(Buffer var1, int var2) {
      try {
         ...
         this.field3048 = Buffer.method13047(var1, 692985437) * -1116245705;
         this.field3047 = Buffer.method13043(var1, (byte)17);
         var1.method13059(1821852560);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ir.az(" + ')');
      }
   }
   ...
   public static boolean method6310(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "ir.ag(" + ')');
      }
   }
   ...
   public static WorldEntityConfig method6309(int var0, int var1) {
      try {
         ...
         if (var2 != null) {
            ...
            var2 = new WorldEntityConfig(new Buffer(var3), var0);
            WorldEntityConfig.field4872.method6428(var2, var0);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ir.az(" + ')');
      }
   }
   ...
   static String method6311(classRY var0, String var1, boolean var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var6, "ir.ax(" + ')');
      }
   }
   ...
   void vmethod505(Buffer var1) {
      if (Buffer.method13039(var1, -346779531) != -303577241) {
         var1.offset -= -1095856699;
         var1.method13059(-1136569179);
      }

      this.field3046 = var1.method13069((byte)-11);
      this.field3048 = Buffer.method13047(var1, 348431888) * -1116245705;
      this.field3047 = Buffer.method13043(var1, (byte)17);
