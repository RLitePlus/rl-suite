...
public class classSN extends classVJ {
   ...
   public int method10516(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sn.ab(" + 41);
      }
   }
   ...
   @ObfuscatedName("mi")
   public static void method10513(classSN var0, Buffer var1, int var2) {
      if (var0 == null) {
         var0.method10537(var1);
      } else {
         Buffer.method13047(var1, 676450745);
         Buffer.method13047(var1, 1682992360);
         var0.field5992 = Buffer.method13039(var1, -346779531) * -514062117;
         int var3 = Buffer.method13047(var1, 1198305036);
         ...
         for (int var5 = 0; var5 < var3; var5++) {
            ...
            classSH var10 = IntProjection.method4079(Buffer.method13039(var1, -346779531), 2101652372);
   ...
   @ObfuscatedName("ph")
   public void method10535(Buffer var1) {
      try {
         ...
         client.logger.error("AnimMaya{}", this.field5982 * 36494709, var15);
         throw var15;
      }
   }
   ...
   classSN(AbstractArchive var1, AbstractArchive var2, int var3) {
      ...
      Buffer var4 = new Buffer(var1.loadData(this.field5982 * 36494709 >> 16 & 65535, this.field5982 * 36494709 & 65535));
   ...
   void method10527(classUU var1, int var2, classSG var3, int var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var13, "sn.ac(" + ')');
      }
   }
   ...
   void method10529(classUU var1, int var2, classSG var3, int var4, short var5) {
      try {
         ...
         throw classEG.newRunException(var13, "sn.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   void method10514(Buffer var1, int var2, int var3) {
      try {
         Buffer.method13047(var1, -1008441641);
         Buffer.method13047(var1, 1360168439);
         this.field5992 = Buffer.method13039(var1, -346779531) * -514062117;
         int var4 = Buffer.method13047(var1, -1112808975);
         ...
         for (int var6 = 0; var6 < var4; var6++) {
            ...
            classSH var11 = IntProjection.method4079(Buffer.method13039(var1, -346779531), -2064244240);
         ...
         throw classEG.newRunException(var15, "sn.af(" + ')');
      }
   }
   ...
   public static boolean method10518(classSN var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "sn.ag(" + ')');
         }
      }
   }
   ...
   public static boolean method10532(char var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sn.aq(" + ')');
      }
   }
   ...
   public static void method10525(classSN var0, classUU var1, int var2, classSG var3, int var4, int var5) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var15, "sn.ax(" + ')');
         }
      }
   }
