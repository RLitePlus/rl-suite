...
public class classCK implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ck.az(" + 41);
      }
   }
   ...
   static void method1577(byte[] var0, int var1, int var2) {
      try {
         if (null == client.randomDat) {
            ...
            client.randomDat = new byte[24];
         }

         classZZ.method14238(var0, var1, client.randomDat, 0, 24);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ck.gu(" + ')');
      }
   }
