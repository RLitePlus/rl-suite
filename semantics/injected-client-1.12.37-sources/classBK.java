...
public class classBK implements classJT {
   ...
   @ObfuscatedName("az")
   @Override
   public Font vmethod105(classXJ var1, int var2) {
      try {
         return (Font)client.field833.get(var1);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "bk.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("ax")
   @Override
   public SpritePixels vmethod110() {
   ...
   @ObfuscatedName("af")
   @Override
   public IndexedSprite[] vmethod108(int var1) {
      try {
         return AABB.field2373;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "bk.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("ae")
   @Override
   public SpritePixels vmethod111(int var1) {
      try {
         return classGG.field2577;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "bk.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("ag")
   @Override
   public Font vmethod106(classXJ var1) {
      return (Font)client.field833.get(var1);
   }
   ...
   @ObfuscatedName("as")
   @Override
   public SpritePixels vmethod112() {
      return classGG.field2577;
   }
   ...
   @ObfuscatedName("ao")
   @Override
   public IndexedSprite[] vmethod109() {
      return AABB.field2373;
   }
   ...
   @ObfuscatedName("ac")
   @Override
   public SpritePixels vmethod113() {
      return classGG.field2577;
   }
   ...
   @ObfuscatedName("aa")
   @Override
   public SpritePixels vmethod114() {
      return classGG.field2577;
   }
   ...
   @ObfuscatedName("ab")
   @Override
   public Font vmethod107(classXJ var1) {
      return (Font)client.field833.get(var1);
   }

   @ObfuscatedSignature(descriptor = "(Ldz;[BIIB)V")
   @ObfuscatedName("aj")
   static final void method1119(WorldView var0, byte[] var1, int var2, int var3, byte var4) {
      try {
         ...
         while (true) {
            ...
            while (true) {
               ...
               int var11 = var8 >> 6 & 63;
               int var12 = var8 >> 12;
               int var13 = Buffer.method13039(var5, -346779531);
               int var14 = var13 >> 2;
               int var15 = var13 & 3;
         ...
         throw classEG.newRunException(var20, "bk.aj(" + ')');
      }
   }
   ...
   public static void method1118(int var0, int var1, byte var2) {
      try {
         ...
         if (classNP.field4698.isEmpty()) {
            ...
            if (var2 <= 1) {
               ...
               while (var5.hasNext()) {
                  ...
                  MidiRequest var6 = (MidiRequest)var5.next();
                  var4.add(var6);
               }
         ...
         throw classEG.newRunException(var7, "bk.ab(" + ')');
      }
   }
}
