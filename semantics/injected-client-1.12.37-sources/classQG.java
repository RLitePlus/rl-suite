...
public class classQG {
   ...
   @ObfuscatedName("oc")
   public static void method9520(Model var0) {
      if (var0 == null) {
         var0.method5207();
      } else {
         var0.field2422 = null;
   ...
   public String method9506(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qg.af(" + ')');
      }
   }
   ...
   public Map method9512(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qg.ae(" + ')');
      }
   }
   ...
   public String method9517(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qg.ab(" + ')');
      }
   }
   ...
   @ObfuscatedName("tl")
   public static void method9519(Scene var0) {
      if (var0 == null) {
         var0.method4342();
      } else {
         var0.field2036 = -1;
   ...
   public static int method9504(classQG var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "qg.az(" + 41);
      }
   }
   ...
   static void method9521(int var0) {
      try {
         ...
         throw classEG.newRunException(var3, "qg.hm(" + ')');
      }
   }
