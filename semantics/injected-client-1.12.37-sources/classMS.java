...
public class classMS {
   ...
   int method7660(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ms.ab(" + 41);
      }
   }
   ...
   void method7661(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ms.ag(" + ')');
      }
   }
   ...
   void method7667(JSONArray var1, classDA var2, int var3) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var8, "ms.ax(" + ')');
      }
   }
   ...
   void method7672(JSONObject var1, classDA var2, byte var3) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var6, "ms.ac(" + ')');
      }
   }
   ...
   void method7676(JSONObject var1, int var2) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var4, "ms.ao(" + ')');
      }
   }
   ...
   void method7678(JSONObject var1, int var2) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var9, "ms.al(" + ')');
      }
   }
   ...
   void method7680(JSONObject var1, int var2) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var9, "ms.aj(" + ')');
      }
   }
   ...
   String method7657(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ms.ae(" + ')');
      }
   }
   ...
   boolean method7665(JSONObject var1, int var2, classDA var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var15, "ms.as(" + ')');
      }
   }
   ...
   void method7675(JSONArray var1, byte var2) throws JSONException {
      try {
         ...
         throw classEG.newRunException(var6, "ms.aa(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   public static classFS method7649(AbstractArchive var0, AbstractArchive var1, int var2, int var3) {
      try {
         boolean var4 = true;
         int var5 = -1;
         ...
         throw classEG.newRunException(var10, "ms.az(" + ')');
      }
   }
