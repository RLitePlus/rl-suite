...
public class classSY {
   ...
   @ObfuscatedName("az")
   void method10715(Buffer var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "sy.az(" + ')');
      }
   }
   ...
   @ObfuscatedName("ae")
   void method10716(Buffer var1, int var2) {
      this.field6103 = var1.method13050((byte)16) * -1704955975;
      ...
      try {
         ...
         for (int var3 = var1.length() - 1; var3 >= 0; var3--) {
            ...
            if (var1.charAt(var3) == 'i') {
               ...
               var2[var3] = classBB.field323[(DynamicObject.field1679 -= 120041229) * -324749371];
            } else {
         ...
         throw classEG.newRunException(var4, "sy.bn(" + ')');
      }
   }
   ...
   public static int method10714(classTE var0, classTE var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var10, "sy.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("cp")
   public static void method10717(classSY var0, Buffer var1, int var2) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;I)V")
   @ObfuscatedName("ab")
   void method10718(Buffer var1, int var2) {
      this.field6103 = var1.method13050((byte)16) * -1704955975;
