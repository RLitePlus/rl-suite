...
public class Script extends classVJ implements net.runelite.api.Script {
   ...
   String method1136(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "bl.ag(" + ')');
      }
   }
   ...
   long method1138(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "bl.as(" + ')');
      }
   }
   ...
   IterableNodeHashTable[] method1144(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "bl.ac(" + ')');
      }
   }
   ...
   static void method1147(float var0, float var1, float var2, float var3, classSU var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var10, "bl.as(" + ')');
      }
   }
   ...
   static Script method1131(byte[] var0) {
      ...
      var2.offset = (var2.array.length - 2) * 591824939;
      int var3 = Buffer.method13047(var2, -1997748751);
      int var4 = var2.array.length - 2 - var3 - 16;
      var2.offset = var4 * 863910035;
      int var5 = var2.method13056((byte)1);
      var1.field493 = Buffer.method13047(var2, -687423316) * -96297281;
      var1.field496 = Buffer.method13047(var2, 1640438330) * -728515915;
      var1.field492 = Buffer.method13047(var2, 956906237) * 2139455799;
      var1.field495 = Buffer.method13047(var2, -777980594) * 1424730171;
      var1.field494 = Buffer.method13047(var2, -1616901640) * 1267443041;
      var1.field497 = Buffer.method13047(var2, 950104031) * 1116857197;
      int var6 = Buffer.method13039(var2, -346779531);
      if (var6 > 0) {
         var1.field505 = var1.method1144(var6, (byte)111);

         for (int var7 = 0; var7 < var6; var7++) {
            int var8 = Buffer.method13047(var2, 934050826);
      ...
      while (var2.offset * -746506163 < var4) {
         int var13 = Buffer.method13047(var2, -553357535);
         switch (var13) {
            case 3:
            ...
            case 62:
            case 63:
               var1.field502[var12] = Buffer.method13039(var2, -346779531);
               break;
            case 61:
   ...
   static Script method1132(byte[] var0) {
      Script var1 = new Script();
      Buffer var2 = new Buffer(var0);
      var2.offset = (var2.array.length - 2) * -831905392;
      int var3 = Buffer.method13047(var2, 1735685840);
      int var4 = var2.array.length - 2 - var3 - 16;
      var2.offset = var4 * -1971317387;
      int var5 = var2.method13056((byte)1);
      var1.field493 = Buffer.method13047(var2, -2054581581) * -420896219;
      var1.field496 = Buffer.method13047(var2, -462106200) * -431593185;
      var1.field492 = Buffer.method13047(var2, -253414877) * 296206261;
      var1.field495 = Buffer.method13047(var2, 1744834755) * 1489098409;
      var1.field494 = Buffer.method13047(var2, -1239296121) * -1788347878;
      var1.field497 = Buffer.method13047(var2, -528961325) * 1116857197;
      int var6 = Buffer.method13039(var2, -346779531);
      if (var6 > 0) {
         var1.field505 = var1.method1144(var6, (byte)44);

         for (int var7 = 0; var7 < var6; var7++) {
            int var8 = Buffer.method13047(var2, -1701507871);
      ...
      while (var2.offset * -615329442 < var4) {
         int var13 = Buffer.method13047(var2, -1248895536);
         switch (var13) {
            case 3:
   ...
   static Script method1133(byte[] var0) {
      Script var1 = new Script();
      Buffer var2 = new Buffer(var0);
      var2.offset = (var2.array.length - 2) * 1075468663;
      int var3 = Buffer.method13047(var2, 969181288);
      int var4 = var2.array.length - 2 - var3 - 16;
      var2.offset = var4 * -1095856699;
      int var5 = var2.method13056((byte)1);
      var1.field493 = Buffer.method13047(var2, -409833244) * -1837812610;
      var1.field496 = Buffer.method13047(var2, 1329446624) * -431593185;
      var1.field492 = Buffer.method13047(var2, -608959795) * -2093708809;
      var1.field495 = Buffer.method13047(var2, -320326370) * 1629253394;
      var1.field494 = Buffer.method13047(var2, 1922177295) * 712179175;
      var1.field497 = Buffer.method13047(var2, 243402036) * 1116857197;
      int var6 = Buffer.method13039(var2, -346779531);
      if (var6 > 0) {
         var1.field505 = var1.method1144(var6, (byte)50);

         for (int var7 = 0; var7 < var6; var7++) {
            int var8 = Buffer.method13047(var2, 221096906);
      ...
      while (var2.offset * 702114061 < var4) {
         int var13 = Buffer.method13047(var2, 16925233);
         switch (var13) {
            case 3:
   ...
   static Script method1134(byte[] var0) {
      Script var1 = new Script();
      Buffer var2 = new Buffer(var0);
      var2.offset = (var2.array.length - 2) * -1095856699;
      int var3 = Buffer.method13047(var2, 839616590);
      int var4 = var2.array.length - 2 - var3 - 16;
      var2.offset = var4 * -1095856699;
      int var5 = var2.method13056((byte)1);
      var1.field493 = Buffer.method13047(var2, -1479087212) * -420896219;
      var1.field496 = Buffer.method13047(var2, -1028103447) * -431593185;
      var1.field492 = Buffer.method13047(var2, 208388031) * 2139455799;
      var1.field495 = Buffer.method13047(var2, -1956778276) * 1424730171;
      var1.field494 = Buffer.method13047(var2, 1924510187) * 712179175;
      var1.field497 = Buffer.method13047(var2, -1007543406) * 1116857197;
      int var6 = Buffer.method13039(var2, -346779531);
      if (var6 > 0) {
         var1.field505 = var1.method1144(var6, (byte)4);

         for (int var7 = 0; var7 < var6; var7++) {
            int var8 = Buffer.method13047(var2, 980725575);
      ...
      while (var2.offset * 702114061 < var4) {
         int var13 = Buffer.method13047(var2, -1371653577);
         switch (var13) {
            case 3:
   ...
   static void method1148(int var0, int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "bl.bp(" + ')');
      }
   }
   ...
   public static final classUZ method1135(classUZ var0, float var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "bl.ax(" + ')');
      }
   }
}
