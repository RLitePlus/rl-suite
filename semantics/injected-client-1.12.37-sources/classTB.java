...
class classTB implements Callable {
   ...
   public static void method10733(int var0) {
      try {
         ...
         throw classEG.newRunException(var8, "tb.ab(" + ')');
      }
   }
   ...
   public Object call() {
      try {
         ...
         throw classEG.newRunException(var2, "tb.call(" + ')');
      }
   }
   ...
   static final void method10737(byte var0) {
      try {
         PacketBufferNode var1 = classEF.getPacketBufferNode(ClientPacket.CLOSE_MODAL, client.packetWriter.isaacCipher, (byte)-86);
         client.packetWriter.addNode(var1, -1301097035);
         classBB.field335 = true;

         for (InterfaceParent var2 = (InterfaceParent)classWK.field6691.field6613.method13375();
            null != var2;
            var2 = (InterfaceParent)IndexedObjectSet.method13401(classWK.field6691.field6613)
         ) {
            if (var0 == 1) {
               return;
            }
         ...
         throw classEG.newRunException(var3, "tb.gp(" + ')');
      }
   }
   ...
   static final boolean method10736(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "tb.et(" + ')');
      }
   }
}
