...
final class classSF implements ThreadFactory {
   ...
   public Thread newThread(Runnable var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sf.newThread(" + ')');
      }
   }
   ...
   @ObfuscatedName("hy")
   public static IterableNodeHashTable[] method10379(Script var0, int var1) {
      return var0 == null ? var0.method1145(var1) : new IterableNodeHashTable[var1];
   }
