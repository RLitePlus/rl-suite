...
public class classHL {
   ...
   static final void method6071(
      ...
      try {
         ...
         int var10000;
         if (var32.offset * 702114061 < var32.array.length) {
            if (var11 == -842430615) {
               throw new IllegalStateException();
            }

            var10000 = Buffer.method13039(var32, -346779531);
         } else {
            var10000 = 0;
         }
         ...
         throw classEG.newRunException(var31, "hl.ag(" + ')');
      }
   }
   ...
   static boolean method6070(
      ...
      try {
         ...
         throw classEG.newRunException(var13, "hl.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lez;Lfv;Z)V")
   @ObfuscatedName("ay")
   public static void method6073(Scene var0, Projection var1, boolean var2) {
      if (var0 == null) {
   ...
   public static void method6072(int[] var0, int[] var1, int var2, int var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var13, "hl.ax(" + ')');
      }
   }
}
