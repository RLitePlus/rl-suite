...
public class classQN {
   ...
   public static ScriptEvent method9666(classQN var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "qn.ag(" + ')');
         }
      }
   }
   ...
   void method9664(classFM var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.ab(" + ')');
      }
   }
   ...
   void method9661(ScriptEvent var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.ae(" + ')');
      }
   }
   ...
   classFM method9677(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qn.ac(" + ')');
      }
   }
   ...
   public static ScriptEvent method9673(classQN var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "qn.ax(" + ')');
         }
      }
   }
   ...
   void method9679(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.aa(" + ')');
      }
   }
   ...
   void method9682(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.ao(" + ')');
      }
   }
   ...
   void method9685(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.al(" + ')');
      }
   }
   ...
   public static ScriptEvent method9671(classQN var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "qn.as(" + ')');
         }
      }
   }
   ...
   public void method9658(ScriptEvent var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.az(" + ')');
      }
   }
   ...
   void method9659(ScriptEvent var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qn.af(" + ')');
      }
   }
