...
public final class SceneTilePaint implements net.runelite.api.SceneTilePaint {
   ...
   @ObfuscatedName("dh")
   static IndexedSprite field2294;
   @ObfuscatedName("ax")
   int field2289;
   ...
   @ObfuscatedName("ro")
   public static void method4803(UserList var0, User var1) {
   ...
   @ObfuscatedName("az")
   public static WorldMapElement method4796(int var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "fj.az(" + ')');
      }
   }
   ...
   public static void method4794(int var0, int[][][] var1, int var2, int var3, int var4, int[] var5, int[] var6, int[] var7) {
      ...
      for (int var9 = 0; var9 < var8.length; var9++) {
         ...
         var5[var9] = var12;
         var6[var9] = VarbitComposition.method9210(var8[var9], var1, var2, var3, var4, (byte)9);
   ...
   public static void method4795(int var0, int[][][] var1, int var2, int var3, int var4, int[] var5, int[] var6, int[] var7) {
      ...
      for (int var9 = 0; var9 < var8.length; var9++) {
         ...
         int var12 = (var3 << 7) + field2280[var13] * 128;
         var5[var9] = var12;
         var6[var9] = VarbitComposition.method9210(var8[var9], var1, var2, var3, var4, (byte)-32);
   ...
   static void method4805(int var0, int var1, int var2, int var3, int var4, short var5, int var6, short var7, int var8, int var9, int var10) {
      try {
         WorldView.method3773(classCQ.field1220, var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, 1465980917);
      } catch (RuntimeException var11) {
         throw classEG.newRunException(var11, "fj.db(" + ')');
      }
   }
   ...
   static classTE method4804(String[] var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "fj.aq(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(I)Ljl;")
   @ObfuscatedName("az")
   static PacketBufferNode method4793(int var0) {
      try {
         if (1275112637 * PacketBufferNode.field3334 == 0) {
            if (var0 <= 1375698635) {
               throw new IllegalStateException();
            } else {
            ...
            return PacketBufferNode.field3333[(PacketBufferNode.field3334 -= 766488213) * 1275112637];
         }
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "fj.az(" + ')');
      }
   }
}
