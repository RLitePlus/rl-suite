...
@ObfuscatedName("cr")
public final class classCR extends ObjectSound {
   @ObfuscatedName("ae")
   final int field1225;
   @ObfuscatedName("af")
   final int field1224;
      ...
      try {
         if (this.field1226 != null) {
            ...
            if (var2 == null) {
               ...
               ObjectSound.method3648(this, var2.method8573(-1791192545), classOM.method8577(var2, -505192310), (byte)-115);
         ...
         throw classEG.newRunException(var4, "cr.az(" + ')');
      }
   }
   ...
   int vmethod194(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cr.af(" + 41);
      }
   }
   ...
   int vmethod197(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cr.ae(" + 41);
      }
   }
   ...
   int vmethod202(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cr.ab(" + 41);
      }
   }
   ...
   void vmethod191() {
      if (this.field1226 != null) {
         ...
         if (var1 == null) {
            ...
            ObjectSound.method3648(this, var1.method8573(-1965626288), classOM.method8577(var1, 1434627516), (byte)-14);
   ...
   int vmethod205(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "cr.ag(" + 41);
      }
   }
   ...
   @ObfuscatedName("rw")
   public static void method2574(ModelData var0) {
      if (var0 == null) {
         var0.method4050();
      }
   ...
   void vmethod192() {
      if (this.field1226 != null) {
         ...
         if (var1 == null) {
            ...
            int var2 = this.field1653.field6689 * -1727985133;
            ObjectSound.method3648(this, var1.method8573(-1500222471), classOM.method8577(var1, -185001088), (byte)-13);
            if (var2 != this.field1653.field6689 * -1727985133) {
               this.field1643 = true;
            }
         }
   ...
   void vmethod193() {
      if (this.field1226 != null) {
         ...
         if (var1 == null) {
            ...
            int var2 = this.field1653.field6689 * -1727985133;
            ObjectSound.method3648(this, var1.method8573(-1417431927), classOM.method8577(var1, 1018823552), (byte)-32);
            if (var2 != this.field1653.field6689 * -1727985133) {
               this.field1643 = true;
            }
         }
   ...
   void vmethod190() {
      if (this.field1226 != null) {
         ...
         if (var1 == null) {
            ...
            ObjectSound.method3648(this, var1.method8573(-1210954853), classOM.method8577(var1, 1705588069), (byte)-81);
            if (var2 != this.field1653.field6689 * -1727985133) {
               this.field1643 = true;
            }
         }
   ...
   @ObfuscatedName("ga")
   static final boolean method2575(Widget var0, int var1) {
      try {
         ...
         if (205 == var2) {
            ...
            if (var2 >= 300) {
               ...
               if (var2 <= 313) {
                  ...
                  PlayerComposition.method6684(client.field992, var3, var10002, (short)6341);
               }
            }
            ...
            if (var2 >= 314) {
               ...
               if (var2 <= 323) {
                  ...
                  PlayerComposition.method6687(client.field992, var6, var9, (byte)-22);
               }
            }
            ...
            if (var2 == 326) {
               if (var1 <= -1935244272) {
                  ...
                  PacketBufferNode var7 = classEF.getPacketBufferNode(ClientPacket.UPDATE_PLAYER_MODEL_V2, client.packetWriter.isaacCipher, (byte)-9);
                  client.field992.method6693(var7.packetBuffer, 840149137);
         ...
         throw classEG.newRunException(var5, "cr.ga(" + ')');
      }
   }
   ...
   static final void method2573(String var0, int var1, int var2) {
      try {
         PacketBufferNode var3 = classEF.getPacketBufferNode(ClientPacket.FRIENDCHAT_SETRANK, client.packetWriter.isaacCipher, (byte)-61);
         Buffer.method12971(var3.packetBuffer, classAU.method712(var0, (byte)59) + 1, (byte)-3);
         var3.packetBuffer.method13153(var1, (byte)72);
         Buffer.method12997(var3.packetBuffer, var0, (short)12406);
         client.packetWriter.addNode(var3, -1301097035);
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "cr.ag(" + ')');
      }
   }
}
