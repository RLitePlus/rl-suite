...
public class classZT {
   ...
   @ObfuscatedName("ae")
   public static void method14197(Buffer var0, int var1, byte var2) {
      try {
         classZQ var3 = new classZQ();
         var3.field7235 = Buffer.method13039(var0, -346779531) * -1690461015;
            ...
            try {
               ...
               if (0 != var5 && var5 != 1) {
                  if (var5 != 2) {
                     ...
                     int var29 = Buffer.method13039(var0, -346779531);
         ...
         throw classEG.newRunException(var26, "zt.ae(" + ')');
      }
   }
   ...
   public static int method14193(classZT var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var6, "zt.az(" + 41);
      }
   }
