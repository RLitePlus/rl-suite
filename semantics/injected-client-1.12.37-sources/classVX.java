...
public class classVX extends classVI {
   ...
   public int vmethod620(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "vx.ae(" + 41);
      }
   }
   ...
   public int vmethod618(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "vx.af(" + 41);
      }
   }
   ...
   public int vmethod614(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "vx.az(" + 41);
      }
   }
   ...
   static int method12261(int var0, byte var1) {
      try {
         Message var2 = (Message)classCN.field1174.method13595(var0);
         if (var2 == null) {
            if (var1 != 2) {
            ...
            return 707758669 * ((Message)var2.field6515).field725;
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "vx.ac(" + 41);
      }
   }
   ...
   public static byte[] method12262(CharSequence var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var6, "vx.ab(" + ')');
      }
   }
      ...
      try {
         if (null == client.field866[var0]) {
            ...
            if (var1 >= 0) {
               ...
               if (var1 < ClanChannel.method6183(client.field866[var0], (byte)3)) {
                  ClanChannelMember var3 = (ClanChannelMember)client.field866[var0].field2955.get(var1);
                  if (var3.field2841 != -1) {
                     return;
                  }

                  PacketBufferNode var4 = classEF.getPacketBufferNode(
                     ClientPacket.AFFINEDCLANSETTINGS_ADDBANNED_FROMCHANNEL, client.packetWriter.isaacCipher, (byte)59
                  );
                  Buffer.method12971(var4.packetBuffer, 3 + classAU.method712(var3.field2846.method164(1461228078), (byte)80), (byte)-100);
                  Buffer.method12971(var4.packetBuffer, var0, (byte)-127);
                  var4.packetBuffer.method12973(var1, -1542382992);
                  Buffer.method12997(var4.packetBuffer, var3.field2846.method164(652075722), (short)19367);
         ...
         throw classEG.newRunException(var5, "vx.gs(" + ')');
      }
   }
