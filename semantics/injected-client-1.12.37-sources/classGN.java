...
public class classGN {
   ...
   @ObfuscatedName("an")
   public static AbstractArchive field2633;
   @ObfuscatedName("ab")
   final int[] field2623;
   @ObfuscatedName("af")
   final int[][] field2627;
   ...
   public static int method5513(classGN var0, short var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "gn.ae(" + 41);
         }
      }
   }
   ...
   int method5521(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gn.ag(" + 41);
      }
   }
   ...
   int method5524(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gn.as(" + 41);
      }
   }
   ...
   int[] method5534(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gn.aa(" + ')');
      }
   }
   ...
   int[] method5537(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gn.ao(" + ')');
      }
   }
   ...
   public static int method5540(classGN var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "gn.al(" + 41);
      }
   }
   ...
   public static int method5518(classGN var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "gn.ab(" + 41);
      }
   }
   ...
   void method5507(byte var1) {
      try {
         ...
         throw classEG.newRunException(var4, "gn.az(" + ')');
      }
   }
   ...
   int[][] method5528(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gn.ax(" + ')');
      }
   }
   ...
   int[][] method5531(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "gn.ac(" + ')');
      }
   }
   ...
   void method5512(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "gn.af(" + ')');
      }
   }
   ...
   static final void method5544(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "gn.am(" + ')');
      }
   }
   ...
   static int method5503(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "gn.az(" + 41);
      }
   }
   ...
   public static classOY method5504(int var0, byte var1) {
      try {
         ...
         if (null != var2) {
            ...
            var2 = new classOY(new Buffer(var3));
