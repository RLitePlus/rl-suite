...
public class classLY {
   ...
   public static boolean method7381(classLY var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
                     ...
                     if (null == var0.field4440[var1][var4]) {
                        ...
                        if (null != var5) {
                           ...
                           if (-1 == var5[0]) {
                              ...
                              var6.method7172(new Buffer(var5), 1218236279);
                           } else {
                              Widget.method7170(var6, new Buffer(var5), (byte)-16);
                           }
                           ...
                           if (null != var0.field4439) {
                              ...
                              if (null != var7) {
                                 ...
                                 if (var7.length > 0) {
                                    ...
                                    var6.method7175(new Buffer(var7), -1144744404);
            ...
            throw classEG.newRunException(var8, "ly.ae(" + ')');
         }
      }
   }
               ...
               for (int var3 = 0; var3 < var2; var3++) {
                  if (null == this.field4440[var1][var3]) {
                     ...
                     if (null != var4) {
                        ...
                        if (-1 == var4[0]) {
                           var5.method7172(new Buffer(var4), 1218236279);
                        } else {
                           Widget.method7170(var5, new Buffer(var4), (byte)-119);
                        }

                        if (null != this.field4439) {
                           byte[] var6 = this.field4439.method11867(var1, var3, -1471794850);
                           if (null != var6 && var6.length > 0) {
                              var5.method7175(new Buffer(var6), -1161191361);
   ...
   public void method7387(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var4, "ly.ab(" + ')');
      }
   }
   ...
   public void method7393(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ly.ag(" + ')');
      }
   }
   ...
   public static Widget method7378(classLY var0, int var1, int var2, byte var3) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "ly.af(" + ')');
      }
   }
   ...
   public static Widget method7375(classLY var0, int var1, byte var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var6, "ly.az(" + ')');
         }
      }
   }
                  ...
                  if (null == this.field4440[var1][var3]) {
                     ...
                     if (null != var4) {
                        ...
                        if (-1 == var4[0]) {
                           ...
                           Widget.method7170(var5, new Buffer(var4), (byte)-71);
                        }

                        if (null != this.field4439) {
                           byte[] var6 = this.field4439.method11867(var1, var3, -1569057326);
                           if (null != var6 && var6.length > 0) {
                              var5.method7175(new Buffer(var6), 394206728);
                              this.field4441.put(var5.field4332, var1);
                           }
                        }
                     }
                  ...
                  if (null == this.field4440[var1][var3]) {
                     ...
                     if (null != var4) {
                        ...
                        if (-1 == var4[0]) {
                           ...
                           Widget.method7170(var5, new Buffer(var4), (byte)-6);
                        }

                        if (null != this.field4439) {
                           byte[] var6 = this.field4439.method11867(var1, var3, -1233602195);
                           if (null != var6 && var6.length > 0) {
                              var5.method7175(new Buffer(var6), -472614399);
                              this.field4441.put(var5.field4332, var1);
                           }
                        }
                     }
