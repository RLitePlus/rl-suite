...
public abstract class classMH {
   ...
   static final void method7571(int var0, int var1, short var2) {
      try {
         ...
         if (var3 < var0) {
            ...
            var3 += WorldMapRenderer.field2699 * -463609277 * (var0 - var3) / 1000 + classHE.field2781 * 836632525;
            if (var3 > var0) {
               if (var2 == 255) {
                  throw new IllegalStateException();
               }
            ...
            var3 -= -463609277 * WorldMapRenderer.field2699 * (var3 - var0) / 1000 + classHE.field2781 * 836632525;
            if (var3 < var0) {
               if (var2 == 255) {
                  throw new IllegalStateException();
               }
         ...
         if (var5 > 0) {
            ...
            var4 += var5 * WorldMapRenderer.field2699 * -463609277 / 1000 + 836632525 * classHE.field2781;
         } else if (var5 < 0) {
            if (var2 == 255) {
               throw new IllegalStateException();
            }

            var4 -= 836632525 * classHE.field2781 + -var5 * -463609277 * WorldMapRenderer.field2699 / 1000;
         }
         ...
         throw classEG.newRunException(var13, "mh.ba(" + ')');
      }
   }
   ...
   public static int method7570(int var0, int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "mh.az(" + 41);
      }
   }
   ...
   static final int method7572(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "mh.gv(" + 41);
      }
   }
