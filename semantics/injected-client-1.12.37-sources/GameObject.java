...
public final class GameObject implements net.runelite.api.GameObject, TileObject {
   ...
   public WorldPoint getWorldLocation() {
      WorldView var1 = WorldView.method3780(this.method4559());
      if (var1 == null) {
   ...
   public Shape getClickbox() {
      return Perspective.getClickbox(classOE.client, this.method4560(), this.method4561(), this.getModelOrientation(), this.getX(), this.getY(), this.getZ());
   }
   ...
   @ObfuscatedName("oa")
   public void method4567(Renderable var1) {
      this.field2200 = var1;
   }
   ...
   @ObfuscatedName("ru")
   public Model method4561() {
      if (this.field2200 == null) {
         return null;
      } else {
         return this.field2200 instanceof Model ? (Model)this.field2200 : this.field2200.method3842();
      }
   }
   ...
   @ObfuscatedName("ro")
   public WorldView method4560() {
      return WorldView.method3780(this.method4559());
   }
