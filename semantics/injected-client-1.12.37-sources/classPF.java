...
public class classPF extends classVJ {
   ...
   static void method8855(Widget var0, int var1, int var2, boolean var3, classVV var4, classQN var5, short var6) {
      try {
         ...
         throw classEG.newRunException(var10, "pf.ag(" + ')');
      }
   }
   ...
   static void method8856(int var0, int var1, int var2, int var3, Object[] var4, byte var5) {
      try {
         ...
         PacketBufferNode var18 = classEF.getPacketBufferNode(ClientPacket.IF_SCRIPT_TRIGGER, client.packetWriter.isaacCipher, (byte)74);
         var18.packetBuffer.method12973(0, -1542382992);
         int var19 = 702114061 * var18.packetBuffer.offset;
         Buffer.method13235(var18.packetBuffer, var3, -1529732366);
         var18.packetBuffer.method12973(var2, -1542382992);
         Buffer.method13235(var18.packetBuffer, var0, -701215652);
         Buffer.method13180(var18.packetBuffer, var1, (byte)22);
         Object[] var10 = var4;
         ...
         for (int var11 = 0; var11 < var10.length; var11++) {
            ...
            if (var12 instanceof Integer) {
               ...
               var18.packetBuffer.method13036((Integer)var12, (byte)-49);
            } else if (var12 instanceof String) {
               if (var5 == 4) {
                  throw new IllegalStateException();
               }

               Buffer.method12997(var18.packetBuffer, (String)var12, (short)25054);
               ...
               var18.packetBuffer.method13026(var14, -169584588);
               if (classYY.field7111 == var13.field6128) {
                  ...
                  for (int var21 = 0; var21 < var14; var21++) {
                     ...
                     var18.packetBuffer.method13036(var20[var21], (byte)-48);
                  }
               } else {
                  ...
                  for (int var16 = 0; var16 < var14; var16++) {
                     ...
                     Buffer.method12997(var18.packetBuffer, (String)var15[var16], (short)21661);
                  }
               }
            } else if (null == var12) {
               if (var5 == 4) {
               ...
               Buffer.method12971(var18.packetBuffer, 0, (byte)-21);
            }
         }

         var18.packetBuffer.method13016(702114061 * var18.packetBuffer.offset - var19, 2119019222);
         client.packetWriter.addNode(var18, -1301097035);
      } catch (RuntimeException var17) {
         throw classEG.newRunException(var17, "pf.fl(" + ')');
      }
   }
   ...
   public static void method8854(byte var0) {
      try {
         ...
         throw classEG.newRunException(var1, "pf.af(" + ')');
      }
   }
   ...
   public static boolean method8853(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, byte var8) {
      try {
         ...
         throw classEG.newRunException(var9, "pf.af(" + ')');
      }
   }
}
