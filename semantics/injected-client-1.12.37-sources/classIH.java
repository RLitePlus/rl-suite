...
public class classIH {
   ...
   static final void method6211(short var0) {
      try {
         for (classCJ var1 = (classCJ)classYE.field6977.method13587(); null != var1; var1 = (classCJ)IterableNodeHashTable.method13589(classYE.field6977)) {
            if (var0 == 209) {
         ...
         throw classEG.newRunException(var2, "ih.cn(" + ')');
      }
   }
