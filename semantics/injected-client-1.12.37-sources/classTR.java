...
public class classTR {
   ...
   @ObfuscatedName("co")
   static int method11126(int var0, Script var1, boolean var2, int var3) {
      try {
         if (var0 == 13337) {
            if (var3 <= 1490009034) {
               throw new IllegalStateException();
            } else {
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 1023779009 * classBB.field327;
               return 1;
            }
         } else {
            return 2;
         ...
         throw classEG.newRunException(var4, "tr.co(" + 41);
      }
   }
