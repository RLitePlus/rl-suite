...
@ObfuscatedName("hf")
public class classHF extends AbstractWorldMapIcon {
   @ObfuscatedName("ab")
   final int field2784;
   ...
   int vmethod494(short var1) {
      try {
         ...
         throw classEG.newRunException(var2, "hf.ag(" + 41);
      }
   }
   ...
   public static String method6006(long var0) {
      try {
         ...
         throw classEG.newRunException(var10, "hf.af(" + ')');
      }
   }
   ...
   classHF(classKY var1, classKY var2, int var3, classHW var4) {
      ...
      this.field2783 = var4;
      WorldMapElement var5 = SceneTilePaint.method4796(this.vmethod486((byte)-31), (byte)-50);
      SpritePixels var6 = var5.method9199(false, -1163794975);
      if (null != var6) {
   ...
   int vmethod493(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "hf.ab(" + 41);
      }
   }
   ...
   classHW vmethod491(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "hf.ae(" + ')');
      }
   }
   ...
   public static classKC[] method6005(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "hf.ag(" + ')');
      }
   }
   ...
   public int vmethod486(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "hf.af(" + 41);
      }
   }
}
