...
public class classPJ implements Iterator {
   ...
   public boolean hasNext() {
      try {
         ...
         throw classEG.newRunException(var1, "pj.hasNext(" + ')');
      }
   }

   classPJ(class468 var1) {
   ...
   public void remove() {
      try {
         ...
         throw classEG.newRunException(var1, "pj.remove(" + ')');
      }
   }
   ...
   public Object next() {
      try {
         ...
         throw classEG.newRunException(var2, "pj.next(" + ')');
      }
   }
   ...
   @ObfuscatedName("od")
   public static int method8916(VarbitComposition var0, int var1) {
      int var2 = VarbitComposition.field5417[1870062131 * var0.field5421 - -526564793 * var0.field5419];
   ...
   static void method8926(Object[] var0, int var1, int var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var5, "pj.bp(" + ')');
      }
   }
}
