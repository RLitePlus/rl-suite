...
public class classKR implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "kr.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("cv")
   static int method6558(int var0, Script var1, boolean var2, byte var3) {
      try {
         if (7900 == var0) {
            if (var3 >= 96) {
            ...
            if (var3 >= 96) {
               ...
               classBB.field323[(DynamicObject.field1679 += 120041229) * -324749371 - 1] = 1387630175 * client.field882;
               return 1;
            }
         } else {
            return 2;
         ...
         throw classEG.newRunException(var5, "kr.cv(" + 41);
      }
   }
   ...
   static char method6556(char var0, classXO var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "kr.af(" + ')');
      }
   }
   ...
   public static void method6557(ArrayList var0, int var1, int var2, int var3, int var4, byte var5) {
      try {
         ...
         throw classEG.newRunException(var6, "kr.ay(" + ')');
      }
   }
