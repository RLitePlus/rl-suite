...
public final class Player extends Actor implements net.runelite.api.Player {
   ...
   boolean method2622(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.as(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   final void method2620(Buffer var1, int var2) {
      try {
         var1.offset = 0;
         byte var3 = Buffer.method13043(var1, (byte)17);
         byte var4 = -1;
         this.field1271 = Buffer.method13043(var1, (byte)17) * 1626737391;
         this.field1266 = Buffer.method13043(var1, (byte)17) * 1744797409;
         int var5 = -1;
         this.field1265 = 0;
         int[] var6 = new int[12];
            ...
            if (0 == var8) {
               ...
               if (var7 == 0) {
                  ...
                  if (var10 == 65535) {
                     ...
                     var5 = Buffer.method13047(var1, 88418643);
                     break;
                  }
               }
         ...
         for (int var17 = 0; var17 < var16.length; var17++) {
            ...
            if (0 == var19) {
               ...
               int var22 = Buffer.method13039(var1, -346779531);
         ...
         this.field1436 = Buffer.method13047(var1, 541644167) * -506237411;
         ...
         this.field1444 = Buffer.method13047(var1, -1026926631) * -349066389;
         ...
         this.field1445 = Buffer.method13047(var1, 1919426113) * -950783279;
         if (65535 == -1657575887 * this.field1445) {
            this.field1445 = 950783279;
         }

         this.field1462 = Buffer.method13047(var1, 536561908) * 164191859;
         if (-412780869 * this.field1462 == 65535) {
            this.field1462 = -164191859;
         }

         this.field1450 = Buffer.method13047(var1, -1867894167) * 1936897965;
         ...
         this.field1448 = Buffer.method13047(var1, 218986588) * -1239814673;
         ...
         this.field1449 = Buffer.method13047(var1, 1475516210) * -627296855;
         ...
         this.field1261 = Buffer.method13039(var1, -346779531) * 785932115;
         this.field1262 = Buffer.method13047(var1, -1289622180) * 1111937113;
         boolean var10001;
         ...
         boolean var24 = false;
         int var26 = Buffer.method13047(var1, 623493113);
         boolean var10000;
         if ((var26 >> 15 & 1) == 1) {
            if (var2 != -1316125685) {
               throw new IllegalStateException();
         ...
         for (int var27 = 0; var27 < 3; var27++) {
            ...
            this.actions[var27] = var1.method13071(383025457);
         }

         var4 = Buffer.method13043(var1, (byte)17);
         if (null == this.field1285) {
            if (var2 != -1316125685) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.newRunException(var14, "ct.af(" + ')');
      }
   }
   ...
   void method2624(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.ax(" + ')');
      }
   }
   ...
   void method2625(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.ac(" + ')');
      }
   }
   ...
   @ObfuscatedName("bk")
   final void method2621(Buffer var1) {
      var1.offset = 0;
      byte var2 = Buffer.method13043(var1, (byte)17);
      byte var3 = -1;
      this.field1271 = Buffer.method13043(var1, (byte)17) * 1626737391;
      this.field1266 = Buffer.method13043(var1, (byte)17) * 1744797409;
      int var4 = -1;
      ...
      for (int var6 = 0; var6 < var5.length; var6++) {
         ...
         if (0 == var7) {
            ...
            if (var6 == 0 && var9 == 868351295) {
               var4 = Buffer.method13047(var1, 1120511050);
               break;
            }
      ...
      for (int var15 = 0; var15 < var14.length; var15++) {
         int var17 = Buffer.method13039(var1, -346779531);
         if (0 == var17) {
            var14[var15] = 0;
         } else {
      ...
      this.field1436 = Buffer.method13047(var1, -2133433831) * -581266605;
      if (-1225740365 * this.field1436 == 65535) {
         this.field1436 = 836503440;
      }

      this.field1444 = Buffer.method13047(var1, 1543659694) * -349066389;
      if (1486109052 == 1201940803 * this.field1444) {
         this.field1444 = 2108400268;
      }

      this.field1457 = -731776138 * this.field1444;
      this.field1445 = Buffer.method13047(var1, -1564925662) * -950783279;
      if (65535 == -1657575887 * this.field1445) {
         this.field1445 = 741411103;
      }

      this.field1462 = Buffer.method13047(var1, -306424782) * 164191859;
      if (1288035674 * this.field1462 == 65535) {
         this.field1462 = -164191859;
      }

      this.field1450 = Buffer.method13047(var1, -123180571) * 1596485319;
      if (840214921 == 553536946 * this.field1450) {
         this.field1450 = -1560238992;
      }

      this.field1448 = Buffer.method13047(var1, 1735837669) * 1290668580;
      if (62142960 == this.field1448 * -2005215583) {
         this.field1448 = -2107904130;
      }

      this.field1449 = Buffer.method13047(var1, -457924943) * -627296855;
      ...
      this.field1261 = Buffer.method13039(var1, -346779531) * -179718946;
      this.field1262 = Buffer.method13047(var1, -1740420563) * 1997669203;
      this.field1259 = Buffer.method13039(var1, -346779531) == 1;
      ...
      boolean var22 = false;
      int var24 = Buffer.method13047(var1, -1779175332);
      var22 = (var24 >> 15 & 1) == 1;
      ...
      for (int var25 = 0; var25 < 3; var25++) {
         this.actions[var25] = var1.method13071(1188791031);
      }

      var3 = Buffer.method13043(var1, (byte)17);
      if (null == this.field1285) {
         this.field1285 = new PlayerComposition();
      }
   ...
   void method2634(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.al(" + ')');
      }
   }
   ...
   void method2638(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ct.aj(" + ')');
      }
   }
   ...
   public void method2666() {
      classOE.client.getCallbacks().post(new PlayerChanged(this));
   }
   ...
   protected classFZ vmethod260(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.bg(" + ')');
      }
   }
   ...
   final void method2650(WorldView var1, int var2, int var3, classGT var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var19, "ct.am(" + ')');
      }
   }
   ...
   void method2654(int var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ct.ah(" + ')');
      }
   }
   ...
   final boolean vmethod262(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.bn(" + ')');
      }
   }
   ...
   @ObfuscatedName("bc")
   ItemComposition method2662(int var1, int var2) {
      try {
         return classOB.method8299(var1 - 2048, (byte)-5);
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "ct.bc(" + ')');
      }
   }
   ...
   int vmethod267(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.bp(" + 41);
      }
   }
   ...
   public int vmethod278(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.bt(" + 41);
      }
   }
   ...
   public int vmethod258(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.az(" + 41);
      }
   }
   ...
   public static boolean method2629(Player var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ct.aa(" + ')');
         }
      }
   }
   ...
   public float vmethod276(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.bm(" + ')');
      }
   }
   ...
   void method2633(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.ao(" + ')');
      }
   }
   ...
   @ObfuscatedName("cz")
   ItemComposition method2663(int var1) {
   ...
   public static boolean method2648(Player var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "ct.aq(" + ')');
      }
   }
   ...
   protected boolean vmethod95(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "ct.ab(" + ')');
      }
   }
   ...
   public Model method2665() {
      ...
      try {
         ...
         throw classEG.newRunException(var13, "ct.ae(" + ')');
      }
   }
   ...
   public static void method2642(Player var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "ct.ay(" + ')');
         }
      }
   }
   ...
   public Shape getConvexHull() {
      ...
      if (var1 == null) {
         ...
         int var3 = Perspective.getFootprintTileHeight(classOE.client, this.getLocalLocation(), var2.field1710 * -483624883, this.getFootprintSize());
   ...
   public classFL vmethod274(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ct.br(" + ')');
      }
   }
   ...
   boolean method2660(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ct.bx(" + ')');
      }
   }
   ...
   static void method2664(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "ct.an(" + ')');
      }
   }
