...
public class classYL {
   ...
   static void method13429(byte[] var0) {
      ...
      var1.offset = (var0.length - 2) * 2053553688;
      field7001 = Buffer.method13047(var1, 18008090) * 130492380;
      ...
      var1.offset = 659177515 * (var0.length - 7 - field7001 * -2107671026);
      field7000 = Buffer.method13047(var1, -1607706557) * 1527476973;
      field6999 = Buffer.method13047(var1, -1669447094) * 1769247414;
      int var2 = (Buffer.method13039(var1, -346779531) & -982406193) + 1;

      for (int var3 = 0; var3 < field7001 * 2064483529; var3++) {
         field7002[var3] = Buffer.method13047(var1, 1619527892);
      }

      for (int var13 = 0; var13 < field7001 * 320654209; var13++) {
         field7003[var13] = Buffer.method13047(var1, -1189459514);
      }

      for (int var14 = 0; var14 < field7001 * 1616155503; var14++) {
         classPO.field5371[var14] = Buffer.method13047(var1, 978824665);
      }

      for (int var15 = 0; var15 < field7001 * -749412981; var15++) {
         classGG.field2578[var15] = Buffer.method13047(var1, -1402523735);
      }

      var1.offset = (var0.length - 7 - field7001 * -482586195 - (var2 - 1) * 3) * -1095856699;
      ...
      for (int var17 = 0; var17 < field7001 * 1616155503; var17++) {
         ...
         if (!var9) {
            for (int var18 = 0; var18 < var6; var18++) {
               var7[var18] = Buffer.method13043(var1, (byte)17);
            }
         } else {
            for (int var11 = 0; var11 < var4; var11++) {
               for (int var12 = 0; var12 < var5; var12++) {
                  var7[var11 + var4 * var12] = Buffer.method13043(var1, (byte)17);
               }
            }
         }

         if (var10) {
            var1.offset += -1095856699 * var6;
         }
      }
   }
   ...
   static void method13430(byte[] var0) {
      Buffer var1 = new Buffer(var0);
      var1.offset = (var0.length - 2) * 1601993802;
      field7001 = Buffer.method13047(var1, -1901436227) * -931176980;
      field7002 = new int[1616155503 * field7001];
      ...
      var1.offset = -1894381068 * (var0.length - 7 - field7001 * 44342136);
      field7000 = Buffer.method13047(var1, -542899814) * -1821953140;
      field6999 = Buffer.method13047(var1, 1694860603) * 1330952715;
      int var2 = (Buffer.method13039(var1, -346779531) & 0xFF) + 1;

      for (int var3 = 0; var3 < field7001 * 1616155503; var3++) {
         field7002[var3] = Buffer.method13047(var1, 908218162);
      }

      for (int var13 = 0; var13 < field7001 * 1196463563; var13++) {
         field7003[var13] = Buffer.method13047(var1, 1752261971);
      }

      for (int var14 = 0; var14 < field7001 * 219892676; var14++) {
         classPO.field5371[var14] = Buffer.method13047(var1, -816174142);
      }

      for (int var15 = 0; var15 < field7001 * 1371418118; var15++) {
         classGG.field2578[var15] = Buffer.method13047(var1, -1453648936);
      }

      var1.offset = (var0.length - 7 - field7001 * 44342136 - (var2 - 1) * 3) * -70107574;
      classRB.field5639 = new int[var2];
   ...
   static void method13431(byte[] var0) {
      Buffer var1 = new Buffer(var0);
      var1.offset = (var0.length - 2) * -1095856699;
      field7001 = Buffer.method13047(var1, 943946862) * 502976131;
      ...
      var1.offset = -1095856699 * (var0.length - 7 - field7001 * -992851953);
      field7000 = Buffer.method13047(var1, -768676231) * 703458394;
      field6999 = Buffer.method13047(var1, 340122354) * 1330952715;
      int var2 = (Buffer.method13039(var1, -346779531) & 1436952347) + 1;

      for (int var3 = 0; var3 < field7001 * -505134487; var3++) {
         field7002[var3] = Buffer.method13047(var1, 666512451);
      }

      for (int var13 = 0; var13 < field7001 * -236368806; var13++) {
         field7003[var13] = Buffer.method13047(var1, -751040237);
      }

      for (int var14 = 0; var14 < field7001 * 149113308; var14++) {
         classPO.field5371[var14] = Buffer.method13047(var1, -2097997327);
      }

      for (int var15 = 0; var15 < field7001 * 1616155503; var15++) {
         classGG.field2578[var15] = Buffer.method13047(var1, 601903699);
      }

      var1.offset = (var0.length - 7 - field7001 * 44342136 - (var2 - 1) * 3) * -1095856699;
      classRB.field5639 = new int[var2];
   ...
   static void method13432(byte[] var0) {
      Buffer var1 = new Buffer(var0);
      var1.offset = (var0.length - 2) * -1095856699;
      field7001 = Buffer.method13047(var1, 68052884) * 1826761615;
      field7002 = new int[1616155503 * field7001];
      field7003 = new int[field7001 * 1616155503];
      classPO.field5371 = new int[1616155503 * field7001];
      classGG.field2578 = new int[1616155503 * field7001];
      field7004 = new byte[field7001 * 1616155503][];
      var1.offset = -1095856699 * (var0.length - 7 - field7001 * 44342136);
      field7000 = Buffer.method13047(var1, -1401084917) * 1527476973;
      field6999 = Buffer.method13047(var1, 1300250818) * 1330952715;
      int var2 = (Buffer.method13039(var1, -346779531) & 0xFF) + 1;

      for (int var3 = 0; var3 < field7001 * 1616155503; var3++) {
         field7002[var3] = Buffer.method13047(var1, 769479827);
      }

      for (int var13 = 0; var13 < field7001 * 1616155503; var13++) {
         field7003[var13] = Buffer.method13047(var1, -1668468611);
      }

      for (int var14 = 0; var14 < field7001 * 1616155503; var14++) {
         classPO.field5371[var14] = Buffer.method13047(var1, -1612178738);
      }

      for (int var15 = 0; var15 < field7001 * 1616155503; var15++) {
         classGG.field2578[var15] = Buffer.method13047(var1, 442670040);
      }
   ...
   static void method13433(byte[] var0) {
      Buffer var1 = new Buffer(var0);
      var1.offset = (var0.length - 2) * -1240084969;
      field7001 = Buffer.method13047(var1, 1632575619) * 1826761615;
      ...
      field7004 = new byte[field7001 * 1616155503][];
      var1.offset = -2098783334 * (var0.length - 7 - field7001 * 739361259);
      field7000 = Buffer.method13047(var1, 834313450) * 1527476973;
      field6999 = Buffer.method13047(var1, -1362278303) * 413996496;
      int var2 = (Buffer.method13039(var1, -346779531) & -911573328) + 1;

      for (int var3 = 0; var3 < field7001 * 1953080487; var3++) {
         field7002[var3] = Buffer.method13047(var1, -882835619);
      }

      for (int var13 = 0; var13 < field7001 * 1616155503; var13++) {
         field7003[var13] = Buffer.method13047(var1, 1398469454);
      }

      for (int var14 = 0; var14 < field7001 * 1616155503; var14++) {
         classPO.field5371[var14] = Buffer.method13047(var1, -1909030951);
      }

      for (int var15 = 0; var15 < field7001 * 1616155503; var15++) {
         classGG.field2578[var15] = Buffer.method13047(var1, 638896044);
      }
