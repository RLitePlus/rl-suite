...
public class classLJ implements classXZ {
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "lj.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("es")
   static final void method7116(WorldView var0, int var1, int var2, int var3, byte var4) {
      try {
         ...
         if (null == var5) {
            if (var4 == -1) {
               ...
               Scene.method4495(var0.scene, var1, var2, var3);
            ...
            for (TileItem var9 = (TileItem)var5.method7915(); var9 != null; var9 = (TileItem)classNN.method7924(var5)) {
               if (var4 == -1) {
                  throw new IllegalStateException();
               }

               ItemComposition var10 = classOB.method8299(-1370204663 * var9.field1552, (byte)76);
            ...
            if (null == var8) {
               ...
               for (TileItem var17 = (TileItem)var5.method7915(); var17 != null; var17 = (TileItem)classNN.method7924(var5)) {
                  if (var4 == -1) {
                     throw new IllegalStateException();
                  }
               ...
               int var12 = Scene.method4492(var0.scene, var1, var2, var3);
         ...
         throw classEG.newRunException(var16, "lj.es(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(IIIIIZIII)Lym;")
   @ObfuscatedName("ab")
   public static final SpritePixels method7114(int var0, int var1, int var2, int var3, int var4, boolean var5, int var6, int var7, int var8) {
      try {
         label272: {
            if (var6 == 36) {
               if (var8 != 1683831829) {
         ...
         if (!var5) {
            ...
            if (var6 == 36) {
               ...
               if (var7 == 32) {
                  ...
                  SpritePixels var11 = (SpritePixels)ItemComposition.field5008.method6422(var9);
                  if (var11 != null) {
                     if (var8 != 1683831829) {
                        throw new IllegalStateException();
                     }
         ...
         ItemComposition var12 = classOB.method8299(var0, (byte)1);
         if (var1 > 1) {
            if (var8 != 1683831829) {
               throw new IllegalStateException();
            }
         ...
         Model var26 = var12.method8657(1, -1367725887);
         if (var26 == null) {
            if (var8 != 1683831829) {
               throw new IllegalStateException();
            } else {
            ...
            if (var12.field5065 * -2023616411 != -1) {
               ...
               SpritePixels.method13511(var27, 0, 0);
            }
            ...
            if (!var5) {
               ...
               if (36 == var6) {
                  ...
                  if (32 == var7) {
                     ItemComposition.field5008.method6428(var25, var9);
                  }
               }
            }
         ...
         throw classEG.newRunException(var24, "lj.ab(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Llw;IZLbl;I)V")
   @ObfuscatedName("ax")
   static void method7115(Widget var0, int var1, boolean var2, Script var3, int var4) {
      try {
         ...
         if (var0.field4340.length <= var1) {
            ...
            Widget var7 = var0.field4340[var1];
            if (var7 != null) {
               if (var4 >= -259325141) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.newRunException(var6, "lj.ax(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;IB)Lyz;")
   @ObfuscatedName("ax")
   public static IndexedSprite method7113(AbstractArchive var0, int var1, byte var2) {
      try {
         if (!classLN.method7126(var0, var1, (byte)0)) {
            ...
            var4.pixels = classYL.field7004[0];
            classVZ.method12278((byte)63);
            return var4;
         }
      } catch (RuntimeException var5) {
         throw classEG.newRunException(var5, "lj.ax(" + ')');
      }
   }
   ...
   static Object[] method7112(int[] var0, byte var1) {
      try {
         ...
         for (int var3 = 0; var3 < var0.length; var3++) {
            ...
            switch (FriendsList.method10130(var0[var3], 1474882567).field7107 * -900901303) {
               case 0:
               case 1:
                  var2[var3] = null;
                  break;
         ...
         throw classEG.newRunException(var4, "lj.az(" + ')');
      }
   }
}
