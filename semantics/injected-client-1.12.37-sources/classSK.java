...
public class classSK implements classXZ {
   ...
   public static int method10461(classSK var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "sk.as(" + 41);
      }
   }
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "sk.az(" + 41);
      }
   }
   ...
   @ObfuscatedName("az")
   static Script method10460(int var0, int var1) {
      try {
         Script var2 = (Script)Script.field491.method6422(var0);
         if (null != var2) {
            if (var1 == 57435997) {
            ...
            if (var3 == null) {
               ...
               var2 = Widget.method7156(var3, -2042870765);
               Script.field491.method6428(var2, var0);
               return var2;
            }
         }
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "sk.az(" + ')');
      }
   }
