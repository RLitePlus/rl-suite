...
public class classBR {
   ...
   @ObfuscatedName("aw")
   final void method1197(Buffer var1, classAQ var2) {
      int var3 = Buffer.method13039(var1, -346779531);
      this.field537[0] = var3 >> 4;
      this.field537[1] = var3 & 15;
      if (var3 != 0) {
         this.field536[0] = Buffer.method13047(var1, -120821262);
         this.field536[1] = Buffer.method13047(var1, -1050428271);
         int var4 = Buffer.method13039(var1, -346779531);

         for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field537[var5]; var6++) {
               this.field534[var5][0][var6] = Buffer.method13047(var1, 745889330);
               this.field535[var5][0][var6] = Buffer.method13047(var1, 1039437292);
            }
         }
         ...
         for (int var8 = 0; var8 < 2; var8++) {
            for (int var9 = 0; var9 < this.field537[var8]; var9++) {
               if ((var4 & 1 << var8 * 4 << var9) != 0) {
                  this.field534[var8][1][var9] = Buffer.method13047(var1, 600275122);
                  this.field535[var8][1][var9] = Buffer.method13047(var1, 191312679);
               } else {
   ...
   @ObfuscatedName("wc")
   public static void method1198(classBR var0, Buffer var1, classAQ var2) {
      if (var0 == null) {
      ...
      if (var3 != 0) {
         var0.field536[0] = Buffer.method13047(var1, -2121147162);
         var0.field536[1] = Buffer.method13047(var1, -1877691436);
         int var4 = Buffer.method13039(var1, -346779531);

         for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < var0.field537[var5]; var6++) {
               var0.field534[var5][0][var6] = Buffer.method13047(var1, 1263451732);
               var0.field535[var5][0][var6] = Buffer.method13047(var1, 52295180);
            }
         }
         ...
         for (int var8 = 0; var8 < 2; var8++) {
            for (int var9 = 0; var9 < var0.field537[var8]; var9++) {
               if ((var4 & 1 << var8 * 4 << var9) != 0) {
                  var0.field534[var8][1][var9] = Buffer.method13047(var1, 591703181);
                  var0.field535[var8][1][var9] = Buffer.method13047(var1, 1290869053);
               } else {
   ...
   @ObfuscatedSignature(descriptor = "(Lxy;Laq;)V")
   @ObfuscatedName("ag")
   final void method1199(Buffer var1, classAQ var2) {
      int var3 = Buffer.method13039(var1, -346779531);
      this.field537[0] = var3 >> 4;
      this.field537[1] = var3 & 15;
      if (var3 != 0) {
         this.field536[0] = Buffer.method13047(var1, 1894169737);
         this.field536[1] = Buffer.method13047(var1, -1903153327);
         int var4 = Buffer.method13039(var1, -346779531);

         for (int var5 = 0; var5 < 2; var5++) {
            for (int var6 = 0; var6 < this.field537[var5]; var6++) {
               this.field534[var5][0][var6] = Buffer.method13047(var1, 1408665254);
               this.field535[var5][0][var6] = Buffer.method13047(var1, 1852375077);
            }
         }
         ...
         for (int var8 = 0; var8 < 2; var8++) {
            for (int var9 = 0; var9 < this.field537[var8]; var9++) {
               if ((var4 & 1 << var8 * 4 << var9) != 0) {
                  this.field534[var8][1][var9] = Buffer.method13047(var1, -2127207615);
                  this.field535[var8][1][var9] = Buffer.method13047(var1, -386772588);
               } else {
                  this.field534[var8][1][var9] = this.field534[var8][0][var9];
                  this.field535[var8][1][var9] = this.field535[var8][0][var9];
               }
