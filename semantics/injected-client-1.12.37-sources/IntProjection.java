...
public class IntProjection extends Projection implements net.runelite.api.IntProjection {
   ...
   @ObfuscatedName("wq")
   public static IntProjection field1939;
   @ObfuscatedName("aa")
   float field1925;
   @ObfuscatedName("at")
   ...
   void vmethod426(Scene var1, SceneTilePaint var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var20, "eu.af(" + ')');
      }
   }
      ...
      if (1 != classFH.field2257.field2217) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            if (null != var2.field2324) {
               SceneTileModel.field2339[var6] = (int)var10;
               SceneTileModel.field2335[var6] = (int)var10;
               SceneTileModel.field2341[var6] = (int)var9;
            }

            SceneTileModel.field2337[var6] = classFH.method4705() + var10 * classFH.method4727() / var9;
            SceneTileModel.field2340[var6] = classFH.method4710() + var10 * classFH.method4727() / var9;
            SceneTileModel.field2338[var6] = classJE.method6356(var9, 2113227426);
         }
   ...
   void vmethod434(Scene var1, SceneTileModel var2, int var3, int var4) {
      if (1 != classFH.field2257.field2217) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            SceneTileModel.field2337[var6] = classFH.method4705() + var10 * classFH.method4727() / var9;
            SceneTileModel.field2340[var6] = classFH.method4710() + var10 * classFH.method4727() / var9;
            SceneTileModel.field2338[var6] = classJE.method6356(var9, 2090944221);
         }
   ...
   IntProjection(int var1, int var2, int var3, classUP var4, classUP var5, int var6, int var7) {
         ...
         if (1 != classFH.field2257.field2217) {
            ...
            for (int var7 = 0; var7 < var6; var7++) {
               ...
               if (null != var2.field2324) {
                  ...
                  SceneTileModel.field2339[var7] = (int)var11;
                  SceneTileModel.field2335[var7] = (int)var11;
                  SceneTileModel.field2341[var7] = (int)var10;
               }

               SceneTileModel.field2337[var7] = classFH.method4705() + var11 * classFH.method4727() / var10;
               SceneTileModel.field2340[var7] = classFH.method4710() + var11 * classFH.method4727() / var10;
               SceneTileModel.field2338[var7] = classJE.method6356(var10, 2107920547);
            }

            this.method5035(var1, var2, var3, var4, 474971057);
         }
      } catch (RuntimeException var12) {
         throw classEG.newRunException(var12, "eu.ae(" + ')');
      }
   }
   ...
   void vmethod432(Scene var1, SceneTileModel var2, int var3, int var4) {
      if (1 != classFH.field2257.field2217) {
         ...
         for (int var6 = 0; var6 < var5; var6++) {
            ...
            SceneTileModel.field2337[var6] = classFH.method4705() + var10 * classFH.method4727() / var9;
            SceneTileModel.field2340[var6] = classFH.method4710() + var10 * classFH.method4727() / var9;
            SceneTileModel.field2338[var6] = classJE.method6356(var9, 2109625642);
         }
   ...
   public static boolean method4078(CharSequence var0, byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "eu.af(" + ')');
      }
   }
   ...
   static classSH method4079(int var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "eu.as(" + ')');
      }
   }
   ...
   static final void method4081(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "eu.gg(" + ')');
      }
   }
   ...
   public static void method4076(int var0) {
      try {
         EvictingDualNodeHashTable.method6431(classPF.field5235);
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "eu.af(" + ')');
      }
   }
   ...
   public static boolean method4077(int var0) {
      try {
         ...
         throw classEG.newRunException(var2, "eu.az(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IIIIIII)V")
   @ObfuscatedName("dk")
   static void method4080(WorldView var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         if (null != var8) {
            ...
            for (TileItem var9 = (TileItem)var8.method7915(); var9 != null; var9 = (TileItem)classNN.method7924(var8)) {
               if (var7 >= 1531627111) {
                  throw new IllegalStateException();
               }
         ...
         throw classEG.newRunException(var10, "eu.dk(" + ')');
      }
   }
