...
public class classJB implements classXZ {
   ...
   @ObfuscatedName("cl")
   static IndexedSprite field3120;
   ...
   public int vmethod8(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "jb.az(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Ldz;IIIIII)V")
   @ObfuscatedName("dv")
   static void method6346(WorldView var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         if (var7 != null) {
            ...
            for (TileItem var8 = (TileItem)var7.method7915(); var8 != null; var8 = (TileItem)classNN.method7924(var7)) {
               if (var6 <= -1090888932) {
                  return;
               }
         ...
         throw classEG.newRunException(var9, "jb.dv(" + ')');
      }
   }
      ...
      try {
         if (var0 == -44590225 * client.field828) {
            ...
            if (-44590225 * client.field828 == 0) {
               ...
               classOE.client.method11071(-2025028862);
            }
            ...
            label175: {
               if (5 != var0) {
                  ...
                  if (var0 != 10) {
                     if (var0 == 20) {
                        ...
                        classJF.method6361(ItemContainer.field462, classHC.field2767, classOV.field5169, false, var4, 1600397897);
                     } else if (var0 == 11) {
                        if (var1 != -1192966987) {
                           throw new IllegalStateException();
                        }

                        classJF.method6361(ItemContainer.field462, classHC.field2767, classOV.field5169, false, 4, 1600397897);
                     } else if (50 == var0) {
                        if (var1 != -1192966987) {
                           return;
                        }

                        WorldEntity.method10624("", "Updating date of birth...", "", (byte)-44);
                        classJF.method6361(ItemContainer.field462, classHC.field2767, classOV.field5169, false, 7, 1600397897);
                     } else if (var0 != 0) {
                        if (var1 != -1192966987) {
                           throw new IllegalStateException();
                        }
               ...
               byte var2 = var10000;
               classJF.method6361(ItemContainer.field462, classHC.field2767, classOV.field5169, true, var2, 1600397897);
            }
         ...
         throw classEG.newRunException(var3, "jb.ac(" + ')');
      }
   }
}
