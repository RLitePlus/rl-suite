...
public class classQH {
   ...
   @ObfuscatedName("cs")
   static IndexedSprite field5544;
   ...
   public boolean method9526(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qh.af(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   static final IterableNodeHashTable method9525(Buffer var0, IterableNodeHashTable var1, int var2) {
      try {
         ...
         for (int var9 = 0; var9 < var3; var9++) {
            ...
            int var5 = Buffer.method13039(var0, -346779531);
            ...
            if (var5 == 1) {
               ...
               var7 = new IntegerNode(var0.method13056((byte)1));
            }

            IterableNodeHashTable.method13576(var1, (Node)var7, var6);
         }

         return var1;
      } catch (RuntimeException var8) {
         throw classEG.newRunException(var8, "qh.az(" + ')');
      }
   }
   ...
   public static boolean method9536(classQH var0, int var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var3, "qh.ag(" + ')');
         }
      }
   }
   ...
   public boolean method9535(int var1, short var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qh.ab(" + ')');
      }
   }
   ...
   public static void method9523(classQH var0, int var1, int var2, boolean var3, int var4) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "qh.az(" + ')');
         }
      }
   }
   ...
   public static void method9543(classQH var0, int var1, int var2) {
      ...
      try {
         ...
         throw classEG.newRunException(var3, "qh.as(" + ')');
      }
   }
   ...
   protected static final boolean method9545(int var0) {
      try {
         return GameEngine.field6198.method10819(-1914370237);
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "qh.afb(" + ')');
      }
   }
   ...
   public boolean method9533(int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qh.ae(" + ')');
      }
   }
