...
public class classCI implements Comparator {
   ...
   int method1510(classNM var1, classNM var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ci.az(" + 41);
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ci.compare(" + 41);
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ci.equals(" + ')');
      }
   }
   ...
   static final void method1518(WorldView var0, int var1, int var2, int var3, int var4, int var5, int var6, CollisionMap var7, int var8) {
      ...
      if (var6 == 22) {
         ...
         client.logger.debug("unknown loc type {}", var6);
      }
   }
   ...
   static void method1506(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         throw classEG.newRunException(var7, "ci.au(" + ')');
      }
   }
   ...
   @ObfuscatedName("ar")
   static void setLoginIndex(int var0, byte var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "ci.ar(" + ')');
      }
   }
   ...
   static void method1508(WorldView var0, int var1, Model var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var15, "ci.cp(" + ')');
      }
   }
