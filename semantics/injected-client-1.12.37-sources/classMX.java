...
final class classMX implements Comparator {
   ...
   int method7733(classNM var1, classNM var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "mx.az(" + 41);
      }
   }
   ...
   public int compare(Object var1, Object var2) {
      try {
         ...
         throw classEG.newRunException(var3, "mx.compare(" + 41);
      }
   }
   ...
   public boolean equals(Object var1) {
      try {
         ...
         throw classEG.newRunException(var2, "mx.equals(" + ')');
      }
   }
   ...
   static void method7739(classTE var0, int var1, classTE var2, int var3, int var4, int var5) {
      try {
         ...
         throw classEG.newRunException(var6, "mx.br(" + ')');
      }
   }
}
