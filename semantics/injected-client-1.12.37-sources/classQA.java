...
public class classQA {
   ...
   public void method9418(classWG var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "qa.af(" + ')');
      }
   }
   ...
   public classQA(URL var1, classQQ var2, classQY var3, boolean var4) throws IOException {
      if (!var2.method9705(1240044487)) {
         ...
         if (!var4) {
            this.field5502.setSSLSocketFactory(SecureRandomSSLSocketFactory.method9610(1598274060));
         }
   ...
   public classQY method9416(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "qa.az(" + ')');
      }
   }
   ...
   boolean method9423(int var1) throws IOException {
      try {
         ...
         throw classEG.newRunException(var2, "qa.ab(" + ')');
      }
   }
   ...
   static void method9414(String[] var0, short[] var1, int var2, int var3, int var4) {
      try {
         ...
         throw classEG.newRunException(var12, "qa.af(" + ')');
      }
   }
   ...
   classQG method9427(byte var1) {
      try {
         ...
         throw classEG.newRunException(var13, "qa.ag(" + ')');
      }
   }
   ...
   @ObfuscatedName("az")
   public static SequenceDefinition method9430(int var0, int var1) {
      synchronized (SequenceDefinition.field5141) {
         int var5 = var0;
         int var6 = -1676962954;

         SequenceDefinition var10000;
         try {
            SequenceDefinition var7 = (SequenceDefinition)SequenceDefinition.field5141.method6422(var5);
            if (var7 != null) {
               if (var6 == 793448697) {
                  throw new IllegalStateException();
               }
               ...
               byte[] var8 = SequenceDefinition.field5153.method11867(12, var5, -617271788);
               var7 = new SequenceDefinition(new Buffer(var8), var5);
               SequenceDefinition.field5141.method6428(var7, var5);
               var10000 = var7;
            }
         } catch (RuntimeException var9) {
            throw classEG.newRunException(var9, "qa.az(" + ')');
         }

         SequenceDefinition var3 = var10000;
         if (var3.field5118 == -1) {
            var3.field5118 = var0;
            classOE.client.getCallbacks().post(new PostAnimation(var3));
         }
   ...
   public static long method9429(classTE var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var7, "qa.ad(" + ')');
      }
   }
   ...
   void method9422(int var1) throws ProtocolException {
      try {
         ...
         throw classEG.newRunException(var15, "qa.ae(" + ')');
      }
   }
}
