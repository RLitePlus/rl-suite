...
public class classSV implements Callable {
   ...
   @ObfuscatedName("ez")
   public static void method10696(Menu var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedName("os")
   public static void method10689(classYF var0, Long var1, Buffer var2) {
      if (var0 == null) {
   ...
   @ObfuscatedName("xc")
   public static void method10694(GameEngine var0, WindowEvent var1) {
      if (var0 == null) {
         var0.method10975();
      }
   }
   ...
   public Object call() {
      try {
         ...
         throw classEG.newRunException(var2, "sv.call(" + ')');
      }
   }
   ...
   static Date method10695(int var0) {
      try {
         ...
         throw classEG.newRunException(var2, "sv.ao(" + ')');
      }
   }
}
