...
public final class GraphicsObject extends Renderable implements net.runelite.api.GraphicsObject {
   ...
   public static void method1093(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "bi.af(" + ')');
      }
   }
   ...
   protected boolean vmethod95(int var1) {
      try {
         ...
         throw classEG.newRunException(var4, "bi.ab(" + ')');
      }
   }
   ...
   protected int vmethod98(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bi.ag(" + 41);
      }
   }
   ...
   boolean method1091(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "bi.az(" + ')');
      }
   }
   ...
   public Model method1107() {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "bi.ae(" + ')');
      }
   }
   ...
   static Widget method1100(int var0, Widget var1, Widget var2, byte var3) {
      try {
         ...
         throw classEG.newRunException(var8, "bi.ao(" + ')');
      }
   }
   ...
   static void method1102(int var0) {
      try {
         ...
         if (client.packetWriter != null && client.packetWriter.isaacCipher != null) {
            PacketBufferNode var1 = classEF.getPacketBufferNode(ClientPacket.WINDOW_STATUS, client.packetWriter.isaacCipher, (byte)-43);
            Buffer.method12971(var1.packetBuffer, classLH.method7105(-2145629943), (byte)-76);
            var1.packetBuffer.method12973(classSA.field5897 * 773246731, -1542382992);
            var1.packetBuffer.method12973(IntProjection.field1938 * 8379747, -1542382992);
            client.packetWriter.addNode(var1, -1301097035);
         }
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "bi.ai(" + ')');
      }
   }
   ...
   public void method1106(int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var6, "bi.af(" + ')');
      }
   }
   ...
   static final int method1101(int var0, int var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var6, "bi.ai(" + 41);
      }
   }
