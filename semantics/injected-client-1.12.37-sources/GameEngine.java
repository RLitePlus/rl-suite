...
@ObfuscatedName("tq")
public abstract class GameEngine extends Panel implements Runnable, FocusListener, WindowListener, rl0, net.runelite.api.GameEngine {
   @ObfuscatedName("rb")
   ...
   @ObfuscatedName("qw")
   static GameEngine field6189 = null;
   @ObfuscatedName("ss")
   ...
   @ObfuscatedName("rn")
   static KeyHandler field6198 = new KeyHandler();
   @ObfuscatedName("rd")
   ...
   @ObfuscatedName("js")
   public static void method11027(GameEngine var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            if ((field6196 += 2069175365) * 801347213 - 1 > 50) {
               ...
               field6196 -= 379553146;
               var0.field6207 = true;
               var0.canvas.setSize(classSA.field5897 * 773246731, IntProjection.field1938 * 8379747);
               ...
               if (var2 == var0.field6221) {
                  ...
                  var0.canvas.setLocation(var9.left + 1451619303 * var0.field6205, var9.top + -673776453 * var0.field6206);
               } else {
                  var0.canvas.setLocation(var0.field6205 * 1451619303, var0.field6206 * -673776453);
               }
            }
            ...
            throw classEG.newRunException(var8, "tq.agi(" + ')');
         }
      }
   }
   ...
   final void method11108(Object var1, byte var2) {
      if (!classOE.client.isGpu() && this.field6211 != null) {
   ...
   protected void method10960(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.aft(" + ')');
      }
   }
   ...
   protected final void method10986(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "tq.afm(" + ')');
      }
   }
   ...
   final void method10990(int var1) {
      ...
      try {
         ...
         if (null == var2) {
            ...
            client.method2315(-1);
            IntProjection.field1938 = Math.min(1525008759 * this.field6213, 697093715 * this.field6217) * 841518155;
            client.method2345(-1);
            this.field6205 = 828993495 * ((39467035 * this.field6214 - classSA.field5897 * 773246731) / 2);
            this.field6206 = 0;
            this.canvas.setSize(773246731 * classSA.field5897, 8379747 * IntProjection.field1938);
            classWO.field6763 = new RasterProvider(classSA.field5897 * 773246731, IntProjection.field1938 * 8379747, this.canvas, this.field6203);
            if (var2 == this.field6221) {
               ...
               this.canvas.setLocation(1451619303 * this.field6205 + var4.left, -673776453 * this.field6206 + var4.top);
            } else {
               this.canvas.setLocation(this.field6205 * 1451619303, this.field6206 * -673776453);
            }
         ...
         throw classEG.newRunException(var5, "tq.agm(" + ')');
      }
   }
   ...
   protected final void method11024(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.aga(" + ')');
      }
   }
   ...
   void method10996(byte var1) {
      try {
         ...
         int var5 = 1525008759 * this.field6213 - 8379747 * IntProjection.field1938 - var3;
         if (var2 <= 0) {
            if (var1 >= 0) {
               throw new IllegalStateException();
            }
         ...
         throw classEG.newRunException(var11, "tq.age(" + ')');
      }
   }
   ...
   protected final void method11000(int var1, int var2, int var3, int var4, int var5) {
      try {
         try {
            ...
            client.method2315(-1);
            IntProjection.field1938 = 841518155 * var2;
            client.method2345(-1);
         ...
         throw classEG.newRunException(var8, "tq.agf(" + ')');
      }
   }
   ...
   public void method11092() {
      this.addHierarchyListener(var0 -> {
         if ((var0.getChangeFlags() & 2L) != 0L && classOE.client.isDisplayable()) {
            client.method2370();
         }
      });
   }
   ...
   @ObfuscatedName("gd")
   public static void method11025(GameEngine var0) {
      if (var0 == null) {
         var0.method11096();
      }
   ...
   void method11019(int var1) {
      try {
         ...
         throw classEG.newRunException(var9, "tq.agu(" + ')');
      }
   }
   ...
   @ObfuscatedName("jt")
   public static void method10961(GameEngine var0, String var1) {
   ...
   final void method11032(int var1) {
      try {
         ...
         throw classEG.newRunException(var3, "tq.agz(" + ')');
      }
   }
   ...
   final synchronized void method11038(byte var1) {
      try {
         ...
         throw classEG.newRunException(var7, "tq.agr(" + ')');
      }
   }
   ...
   public final void start() {
      ...
      try {
         ...
         throw classEG.newRunException(var1, "tq.start(" + ')');
      }
   }
   ...
   public final void destroy() {
      try {
         if (field6189 == this && !field6192) {
            ...
            Friend.method10149(5000L);
            this.method11038((byte)-11);
         }
      } catch (RuntimeException var1) {
         throw classEG.newRunException(var1, "tq.destroy(" + ')');
      }
   }
      ...
      try {
         if (field6189 == this && !field6192) {
            ...
            if (classDD.method2983(16711680) - this.field6210 * -5853619249873121909L > 1000L) {
               ...
               if (null == var2 || var2.width >= 773246731 * classSA.field5897 && var2.height >= 8379747 * IntProjection.field1938) {
                  this.field6209 = true;
               }
            }
         }
      } catch (RuntimeException var3) {
         throw classEG.newRunException(var3, "tq.paint(" + ')');
      }
   }
   ...
   protected final void method11071(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.agv(" + ')');
      }
   }
   ...
   public final void focusLost(FocusEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.focusLost(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("ny")
   public static void method11041(GameEngine var0) {
      if (var0 == null) {
         var0.method11017();
   ...
   public final void windowActivated(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowActivated(" + ')');
      }
   }
   ...
   public final void windowClosed(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowClosed(" + ')');
      }
   }
   ...
   public final void windowDeactivated(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowDeactivated(" + ')');
      }
   }
   ...
   public final void windowDeiconified(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowDeiconified(" + ')');
      }
   }
   ...
   public final void windowOpened(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowOpened(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("nv")
   public static void method10991(GameEngine var0) {
      if (var0 == null) {
         var0.method10983();
      }
      ...
      if (null != var1) {
         ...
         IntProjection.field1938 = Math.min(1525008759 * var0.field6213, 697093715 * var0.field6217) * 841518155;
         var0.field6205 = 579240516 * ((1216810758 * var0.field6214 - classSA.field5897 * -448671383) / 2);
         var0.field6206 = 0;
         var0.canvas.setSize(-1925046179 * classSA.field5897, 1483836700 * IntProjection.field1938);
         classWO.field6763 = new RasterProvider(classSA.field5897 * 1492222171, IntProjection.field1938 * 1962161828, var0.canvas, var0.field6203);
         if (var1 == var0.field6221) {
            Insets var3 = var0.field6221.getInsets();
            var0.canvas.setLocation(1451619303 * var0.field6205 + var3.left, 2086326995 * var0.field6206 + var3.top);
         } else {
            var0.canvas.setLocation(var0.field6205 * 812696419, var0.field6206 * -673776453);
         }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;I)V")
   @ObfuscatedName("ck")
   public static void method11034(GameEngine var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "tq.ags(" + ')');
         }
      }
   }
   ...
   public void run() {
      ...
      try {
         ...
         while (0L == field6191 * -4157353362753048141L) {
            ActorSpotAnim.field5964 = classTW.field6250.vmethod536(20, 1) * -1242900443;

            for (int var1 = 0; var1 < ActorSpotAnim.field5964 * 1906148269; var1++) {
               this.method11109();
            }

            if (classMG.field4503) {
               this.method11113();
               this.method11119(this.canvas);
            }
         }
      ...
      try {
         try {
            ...
            if (null == classAB.field123) {
               classAB.field123 = new java.awt.Font("Helvetica", 1, 13);
               classAF.field145 = this.canvas.getFontMetrics(classAB.field123);
            }
            ...
            if (var3) {
               ...
               if (!var4) {
                  ...
                  var6.fillRect(0, 0, classSA.field5897 * 773246731, 8379747 * IntProjection.field1938);
               }
            }
            ...
            try {
               if (null == classLY.field4443) {
                  ...
                  classLY.field4443 = this.canvas.createImage(304, 34);
               }
               ...
               int var10003 = IntProjection.field1938 * 8379747 / 2;
               byte var10004;
               if (var4) {
                  if (var5 == 1) {
                     throw new IllegalStateException();
               ...
               int var10 = 8379747 * IntProjection.field1938 / 2 - 18;
               var6.setColor(var7);
         ...
         throw classEG.newRunException(var13, "tq.agk(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ltq;Ljava/lang/String;I)V")
   @ObfuscatedName("oq")
   public static void method11076(GameEngine var0, String var1, int var2) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var5, "tq.agh(" + ')');
         }
      }
   }
   ...
   Container method11079(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.agj(" + ')');
      }
   }
   ...
   @ObfuscatedName("vo")
   public static boolean method10953(IterableNodeDeque var0) {
      if (var0 == null) {
         var0.method8191();
      }
   ...
   protected final boolean method11088(byte var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.agt(" + ')');
      }
   }
   ...
   public void method11016() {
      try {
         if (null != classDQ.field1604) {
            ...
            if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
               ...
               if (var2.startsWith("1.6.0_")) {
                  ...
                  if (IntProjection.method4078(var4, (byte)-1) && classJF.method6360(var4, 215229911) < 10) {
         ...
         while (-4157353362753048141L * field6191 == 0L || classDD.method2983(16711680) < field6191 * -4157353362753048141L) {
            ActorSpotAnim.field5964 = classTW.field6250.vmethod535(field6187 * -124206665, -1581411499 * field6194, -1162884564) * -1242900443;

            for (int var6 = 0; var6 < 1906148269 * ActorSpotAnim.field5964; var6++) {
               this.method11019(-252904814);
            }

            method11027(this, 1159221952);
            this.method11108(this.canvas, (byte)-1);
         }
      } catch (Exception var5) {
   ...
   public void method11017() {
      try {
         if (null != classDQ.field1604) {
            ...
            if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
               ...
               if (var2.startsWith("1.6.0_")) {
                  ...
                  String var4 = var2.substring(6, var3);
                  if (IntProjection.method4078(var4, (byte)-1) && classJF.method6360(var4, -700834590) < 10) {
         ...
         while (-4157353362753048141L * field6191 == 0L || classDD.method2983(16711680) < field6191 * -4157353362753048141L) {
            ActorSpotAnim.field5964 = classTW.field6250.vmethod535(field6187 * 1440739541, 1149475075 * field6194, -1162884564) * -193062407;

            for (int var6 = 0; var6 < 279313160 * ActorSpotAnim.field5964; var6++) {
   ...
   public final void focusGained(FocusEvent var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var2, "tq.focusGained(" + ')');
      }
   }
   ...
   protected final void method10971() {
      ...
      field6198.method10824(this.canvas, 828566663);
   }
   ...
   protected final void method10972(int var1) {
      try {
         ...
         field6198.method10824(this.canvas, 1110326982);
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "tq.afn(" + ')');
      }
   }
   ...
   final void method10998() {
      field6198.method10826(this.canvas, (byte)-92);
      ...
      MouseHandler.field6256 = 0;
      if (null != this.field6226) {
         this.field6226.method10743(this.canvas, 1886339831);
      }

      this.method11009(1596975679);
      field6198.method10824(this.canvas, 1509592828);
      java.awt.Canvas var2 = this.canvas;
      var2.addMouseListener(MouseHandler.MouseHandler_instance);
      var2.addMouseMotionListener(MouseHandler.MouseHandler_instance);
      var2.addFocusListener(MouseHandler.MouseHandler_instance);
      if (this.field6226 != null) {
         this.field6226.method10740(this.canvas, -1191183928);
      }
   ...
   protected final void method11068(int var1, String var2, boolean var3, boolean var4) {
      try {
         ...
         if (var3 && !var4) {
            ...
            var5.fillRect(0, 0, classSA.field5897 * 773246731, 8379747 * IntProjection.field1938);
         }
         ...
         try {
            ...
            var5.drawImage(classLY.field4443, classSA.field5897 * 773246731 / 2 - 152, IntProjection.field1938 * 302815990 / 2 + (var4 ? 50 : -18), null);
         } catch (Exception var10) {
            int var8 = classSA.field5897 * 773246731 / 2 - 152;
            int var9 = 8379747 * IntProjection.field1938 / 2 - 18;
            var5.setColor(var6);
   ...
   protected void method11010(boolean var1) {
      if (this.field6203 != var1) {
         ...
         if (classWO.field6763 != null) {
            AbstractRasterProvider.method13317(classWO.field6763, var1, (byte)28);
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("ay")
   public static void method11028(GameEngine var0) {
      if (var0 == null) {
         var0.run();
      }
      ...
      if ((field6196 += -961246446) * 801347213 - 1 > 50) {
         field6196 -= 379553146;
         var0.field6207 = true;
         var0.canvas.setSize(classSA.field5897 * -186829873, IntProjection.field1938 * 8379747);
         var0.canvas.setVisible(true);
         if (var1 == var0.field6221) {
            Insets var7 = var0.field6221.getInsets();
            var0.canvas.setLocation(var7.left + 605956500 * var0.field6205, var7.top + -673776453 * var0.field6206);
         } else {
            var0.canvas.setLocation(var0.field6205 * 1688986815, var0.field6206 * -94523477);
         }
      }
   ...
   @ObfuscatedName("tc")
   public static void method11001(GameEngine var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "()V")
   @ObfuscatedName("ady")
   protected abstract void callStackPacker2();
   ...
   public void method11098() {
      if (classOE.client.isStretchedEnabled()) {
         java.awt.Canvas var1 = this.getCanvas();
         Dimension var2 = classOE.client.getStretchedDimensions();
         var1.setSize(var2);
   ...
   public final void windowClosing(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowClosing(" + ')');
      }
   }
   ...
   @ObfuscatedName("si")
   public static classMF method10957(GameEngine var0, byte var1) {
      if (var0 == null) {
      ...
      try {
         if (var0.field6226 == null) {
            var0.field6226 = new MouseWheelHandler();
            var0.field6226.method10740(var0.canvas, 1087436969);
         }

         return var0.field6226;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "tq.afo(" + ')');
      }
   }
   ...
   @ObfuscatedName("qh")
   public static Clipboard method10966(GameEngine var0, byte var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "tq.afv(" + ')');
         }
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("ir")
   public static void method11018(GameEngine var0) {
      if (var0 == null) {
         var0.method10981();
      } else {
         try {
            if (null != classDQ.field1604) {
               ...
               if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
                  ...
                  if (var2.startsWith("1.6.0_")) {
                     ...
                     String var4 = var2.substring(6, var3);
                     if (IntProjection.method4078(var4, (byte)-1) && classJF.method6360(var4, 1137653930) < 10) {
            ...
            while (-4157353362753048141L * field6191 == 0L || classDD.method2983(16711680) < field6191 * -4157353362753048141L) {
               ActorSpotAnim.field5964 = classTW.field6250.vmethod535(field6187 * 867481676, -2028709291 * field6194, -1162884564) * -1025597522;

               for (int var6 = 0; var6 < -219142571 * ActorSpotAnim.field5964; var6++) {
                  var0.method11019(2045060950);
               }

               method11027(var0, 1899420747);
               var0.method11108(var0.canvas, (byte)-1);
            }
         } catch (Exception var5) {
   ...
   public final synchronized void method11049(Graphics var1) {
      if (field6189 == this && !field6192) {
         ...
         if (classDD.method2983(16711680) - this.field6210 * -5853619249873121909L > 1000L) {
            Rectangle var2 = var1.getClipBounds();
            if (null == var2 || var2.width >= -1526156459 * classSA.field5897 && var2.height >= 8379747 * IntProjection.field1938) {
               this.field6209 = true;
            }
         }
      }
   ...
   final synchronized void method11006() {
      ...
      IntProjection.field1938 = Math.max(var1.getHeight(), this.field6218 * -450704939) * 841518155;
      if (null != this.field6221) {
         Insets var2 = this.field6221.getInsets();
         classSA.field5897 = classSA.field5897 - (var2.left + var2.right) * -2089155421;
         IntProjection.field1938 = IntProjection.field1938 - 841518155 * (var2.top + var2.bottom);
      }
      ...
      this.canvas.setSize(classSA.field5897 * 773246731, IntProjection.field1938 * 8379747);
      this.canvas.setVisible(true);
      this.canvas.setBackground(Color.BLACK);
      if (this.field6221 == var1) {
         Insets var3 = this.field6221.getInsets();
         this.canvas.setLocation(var3.left + -695928323 * this.field6205, this.field6206 * 438949312 + var3.top);
      } else {
         this.canvas.setLocation(1451619303 * this.field6205, this.field6206 * 315102557);
      }
      ...
      if (null != classWO.field6763
         ...
         && IntProjection.field1938 * 1793131877 == classWO.field6763.field6968 * 1855103015) {
         RasterProvider.method10802((RasterProvider)classWO.field6763, this.canvas, (byte)-113);
         classWO.field6763.vmethod578(0, 0, (byte)113);
      } else {
         classWO.field6763 = new RasterProvider(-2043236416 * classSA.field5897, 8379747 * IntProjection.field1938, this.canvas, this.field6203);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("li")
   public static void method10973(GameEngine var0) {
      if (var0 == null) {
         var0.method11036();
      } else {
         classQY.method9885(-2010438817);
         field6198.method10824(var0.canvas, -723229338);
      }
   }
   ...
   public final void update(Graphics var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.update(" + ')');
      }
   }
   ...
   final synchronized void method11007() {
      ...
      if (this.field6221 == var1) {
         Insets var3 = this.field6221.getInsets();
         this.canvas.setLocation(var3.left + 1451619303 * this.field6205, this.field6206 * -673776453 + var3.top);
      } else {
         this.canvas.setLocation(1451619303 * this.field6205, this.field6206 * -673776453);
      }
      ...
      if (null != classWO.field6763
         ...
         && IntProjection.field1938 * 8379747 == classWO.field6763.field6968 * 1855103015) {
         RasterProvider.method10802((RasterProvider)classWO.field6763, this.canvas, (byte)-120);
         classWO.field6763.vmethod578(0, 0, (byte)119);
      } else {
         classWO.field6763 = new RasterProvider(773246731 * classSA.field5897, 8379747 * IntProjection.field1938, this.canvas, this.field6203);
      }
   ...
   protected final void method11097(int var1, int var2, byte var3) {
      if (classOE.client.isStretchedEnabled() && classOE.client.isResized()) {
         Dimension var4 = classOE.client.getRealDimensions();
         var1 = var4.width;
         var2 = var4.height;
      }
      ...
      try {
         ...
         throw classEG.newRunException(var9, "tq.afu(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("ww")
   public static void method11072(GameEngine var0) {
      if (var0 == null) {
         var0.method10981();
      }
   ...
   protected final void method10974() {
      ...
      field6198.method10824(this.canvas, -126373605);
   }
   ...
   protected final void method10975() {
      ...
      field6198.method10824(this.canvas, 1670143838);
   }
   ...
   protected final void method10976() {
      ...
      field6198.method10824(this.canvas, -2110296974);
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("kk")
   public static void method10978(GameEngine var0) {
      if (var0 == null) {
         var0.method10983();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("nh")
   public static void method11073(GameEngine var0) {
      if (var0 == null) {
         var0.method10983();
      }
   ...
   @ObfuscatedName("wr")
   public static boolean method11012(GameEngine var0) {
      if (var0 == null) {
         var0.method11074();
      }
   ...
   @ObfuscatedName("bi")
   public static int method11089(Model var0, int var1) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("ib")
   public static void method11035(GameEngine var0) {
      if (var0 == null) {
         var0.method11037();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("cl")
   public static void method11043(GameEngine var0) {
      if (var0 == null) {
         var0.method11094();
      } else if (field6189 == var0 && !field6192) {
         field6191 = classDD.method2983(16711680) * -7013317878618397317L;
   ...
   void method10997() {
      ...
      int var4 = 1525008759 * this.field6213 - 8379747 * IntProjection.field1938 - var2;
   ...
   @ObfuscatedName("wm")
   public static Container method11081(GameEngine var0) {
   ...
   public final void stop() {
      try {
         ...
         throw classEG.newRunException(var1, "tq.stop(" + ')');
      }
   }
   ...
   final synchronized void method11008() {
      ...
      var1.setLayout(null);
      var1.add(this.canvas);
      this.canvas.setSize(classSA.field5897 * -405479738, IntProjection.field1938 * 8379747);
      this.canvas.setVisible(true);
      this.canvas.setBackground(Color.BLACK);
      if (this.field6221 == var1) {
         Insets var3 = this.field6221.getInsets();
         this.canvas.setLocation(var3.left + 1451619303 * this.field6205, this.field6206 * 948918294 + var3.top);
      } else {
         this.canvas.setLocation(255584615 * this.field6205, this.field6206 * -673776453);
      }
      ...
      if (null != classWO.field6763
         ...
         && IntProjection.field1938 * 1683477505 == classWO.field6763.field6968 * 623188320) {
         RasterProvider.method10802((RasterProvider)classWO.field6763, this.canvas, (byte)-126);
   ...
   public final void windowIconified(WindowEvent var1) {
      try {
         ...
         throw classEG.newRunException(var2, "tq.windowIconified(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("vc")
   public static void method10989(GameEngine var0) {
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("eb")
   public static void method11033(GameEngine var0) {
      if (var0 == null) {
         var0.method11111();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("bq")
   public static void method10999(GameEngine var0) {
      field6198.method10826(var0.canvas, (byte)31);
      java.awt.Canvas var1 = var0.canvas;
      var1.removeMouseListener(MouseHandler.MouseHandler_instance);
      var1.removeMouseMotionListener(MouseHandler.MouseHandler_instance);
      var1.removeFocusListener(MouseHandler.MouseHandler_instance);
      ...
      if (null != var0.field6226) {
         var0.field6226.method10743(var0.canvas, 798417951);
      }

      var0.method11009(2058027058);
      field6198.method10824(var0.canvas, 796787445);
      java.awt.Canvas var2 = var0.canvas;
      var2.addMouseListener(MouseHandler.MouseHandler_instance);
      var2.addMouseMotionListener(MouseHandler.MouseHandler_instance);
      var2.addFocusListener(MouseHandler.MouseHandler_instance);
      if (var0.field6226 != null) {
         var0.field6226.method10740(var0.canvas, -571610227);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;IIII)V")
   @ObfuscatedName("lc")
   public static void method11002(GameEngine var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
         var0.method11032(var1);
      } else {
         try {
            ...
            IntProjection.field1938 = -329626580 * var2;
            classAAL.field57 = var3 * -154973313;
   ...
   void method11029() {
      ...
      if ((field6196 += 2069175365) * 801347213 - 1 > 50) {
         ...
         if (var1 == this.field6221) {
            ...
            this.canvas.setLocation(var7.left + 1451619303 * this.field6205, var7.top + -673776453 * this.field6206);
         } else {
            this.canvas.setLocation(this.field6205 * 1451619303, this.field6206 * -673776453);
         }
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;I)V")
   @ObfuscatedName("lt")
   public static void method10982(GameEngine var0, int var1) {
      if (var0 == null) {
         ...
         try {
            ...
            throw classEG.newRunException(var2, "tq.afi(" + ')');
         }
      }
   }
   ...
   @ObfuscatedName("zw")
   public static classUQ method11085(GameEngine var0) {
      if (var0 == null) {
   ...
   protected void method10985(classTL var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "tq.afa(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("dm")
   public static void method10992(GameEngine var0) {
      if (var0 == null) {
         var0.method11029();
      }
      ...
      if (null != var1) {
         ...
         IntProjection.field1938 = Math.min(1119626313 * var0.field6213, -777828750 * var0.field6217) * 841518155;
         var0.field6205 = 1962298787 * ((39467035 * var0.field6214 - classSA.field5897 * -579192442) / 2);
         var0.field6206 = 0;
         var0.canvas.setSize(89789507 * classSA.field5897, 2143590714 * IntProjection.field1938);
         classWO.field6763 = new RasterProvider(classSA.field5897 * 773246731, IntProjection.field1938 * -1607235138, var0.canvas, var0.field6203);
         if (var1 == var0.field6221) {
            Insets var3 = var0.field6221.getInsets();
            var0.canvas.setLocation(1023492508 * var0.field6205 + var3.left, -673776453 * var0.field6206 + var3.top);
         } else {
            var0.canvas.setLocation(var0.field6205 * 1451619303, var0.field6206 * -1827559305);
         }
   ...
   @ObfuscatedName("yh")
   public static void method10955(GameEngine var0, int var1, int var2) {
   ...
   protected classMF method10958() {
      if (this.field6226 == null) {
         this.field6226 = new MouseWheelHandler();
         this.field6226.method10740(this.canvas, -347735156);
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("nz")
   public static void method11026(GameEngine var0) {
      if (var0 == null) {
         var0.method10958();
      }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;IIII)V")
   @ObfuscatedName("ms")
   public static void method11003(GameEngine var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("jp")
   public static void method11023(GameEngine var0) {
      if (var0 == null) {
         var0.method11093();
      }
   ...
   public void method11094() {
      if (classOE.client.isStretchedEnabled()) {
         classOE.client.invalidateStretching(false);
         if (classOE.client.isResized()) {
            Dimension var1 = classOE.client.getRealDimensions();
   ...
   classUQ method11086(int var1) {
      try {
         ...
         throw classEG.newRunException(var6, "tq.agw(" + ')');
      }
   }
   ...
   public void method11093() {
      if (this.canvas != null) {
         this.canvas.removeComponentListener(this.field6201);
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("nb")
   public static void method10993(GameEngine var0) {
      if (var0 == null) {
         var0.method11044();
      } else {
         ...
         if (null != var1) {
            ...
            IntProjection.field1938 = Math.min(-322847495 * var0.field6213, 697093715 * var0.field6217) * 841518155;
            var0.field6205 = 828993495 * ((39467035 * var0.field6214 - classSA.field5897 * 773246731) / 2);
            var0.field6206 = 0;
            var0.canvas.setSize(2108718372 * classSA.field5897, 1302063658 * IntProjection.field1938);
            classWO.field6763 = new RasterProvider(classSA.field5897 * -449368026, IntProjection.field1938 * 8379747, var0.canvas, var0.field6203);
            if (var1 == var0.field6221) {
               Insets var3 = var0.field6221.getInsets();
               var0.canvas.setLocation(1451619303 * var0.field6205 + var3.left, -2105698082 * var0.field6206 + var3.top);
            } else {
               var0.canvas.setLocation(var0.field6205 * -200174874, var0.field6206 * -1650576623);
            }
   ...
   final synchronized void method11009(int var1) {
      ...
      try {
         ...
         client.method2315(-1);
         IntProjection.field1938 = Math.max(var2.getHeight(), this.field6218 * -450704939) * 841518155;
         client.method2345(-1);
         if (null != this.field6221) {
            if (var1 <= 1278010550) {
               throw new IllegalStateException();
            ...
            client.method2315(-1);
            IntProjection.field1938 = IntProjection.field1938 - 841518155 * (var3.top + var3.bottom);
            client.method2345(-1);
         }
         ...
         if (this.field6221 == var2) {
            ...
            Insets var5 = this.field6221.getInsets();
            this.canvas.setLocation(var5.left + 1451619303 * this.field6205, this.field6206 * -673776453 + var5.top);
         } else {
            this.canvas.setLocation(1451619303 * this.field6205, this.field6206 * -673776453);
         }
         ...
         label60: {
            ...
            if (null != classWO.field6763 && classSA.field5897 * 773246731 == classWO.field6763.field6967 * -1238133717) {
               ...
               if (IntProjection.field1938 * 8379747 == classWO.field6763.field6968 * 1855103015) {
                  if (var1 <= 1278010550) {
                     throw new IllegalStateException();
                  }

                  RasterProvider.method10802((RasterProvider)classWO.field6763, this.canvas, (byte)-69);
         ...
         throw classEG.newRunException(var4, "tq.agl(" + ')');
      }
   }
   ...
   protected final void method11069(int var1, String var2, boolean var3, boolean var4) {
      try {
         ...
         try {
            ...
            var5.drawImage(classLY.field4443, classSA.field5897 * -699590131 / 2 - 152, IntProjection.field1938 * 8379747 / 2 + (var4 ? 50 : 1729743090), null);
         } catch (Exception var10) {
            int var8 = classSA.field5897 * 773246731 / 2 - 152;
            int var9 = -775651097 * IntProjection.field1938 / 2 - 18;
            var5.setColor(var6);
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;IIII)V")
   @ObfuscatedName("zd")
   public static void method11004(GameEngine var0, int var1, int var2, int var3, int var4) {
      if (var0 == null) {
         var0.method10998();
      } else {
         try {
   ...
   protected final void method11070(int var1, String var2, boolean var3, boolean var4) {
      try {
         ...
         try {
            if (null == classLY.field4443) {
               classLY.field4443 = this.canvas.createImage(-144180440, 34);
            }
            ...
            var5.drawImage(
               classLY.field4443, classSA.field5897 * -15963207 / 2 - 1764028865, IntProjection.field1938 * 8379747 / 2 + (var4 ? 1124945180 : -18), null
            );
         } catch (Exception var10) {
            int var8 = classSA.field5897 * -142546908 / 2 - 152;
            int var9 = -1020043590 * IntProjection.field1938 / 2 - 18;
            var5.setColor(var6);
   ...
   protected void method10965(String var1, int var2) {
      try {
         ...
         throw classEG.newRunException(var3, "tq.afw(" + ')');
      }
   }
   ...
   public void method11102() {
      this.canvas.addComponentListener(this.field6201);
      this.field6220 = this.canvas.getSize();
   }
   ...
   protected final boolean method11015(byte var1) {
      try {
         ...
         throw classEG.newRunException(var3, "tq.ago(" + ')');
      }
   }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;)V")
   @ObfuscatedName("iy")
   public static void method10994(GameEngine var0) {
      if (var0 == null) {
         var0.method11017();
      }
      ...
      if (null != var1) {
         ...
         var0.field6205 = 828993495 * ((39467035 * var0.field6214 - classSA.field5897 * 773246731) / 2);
         var0.field6206 = 0;
         var0.canvas.setSize(773246731 * classSA.field5897, 8379747 * IntProjection.field1938);
         classWO.field6763 = new RasterProvider(classSA.field5897 * 773246731, IntProjection.field1938 * 8379747, var0.canvas, var0.field6203);
         if (var1 == var0.field6221) {
            Insets var3 = var0.field6221.getInsets();
            var0.canvas.setLocation(1451619303 * var0.field6205 + var3.left, -673776453 * var0.field6206 + var3.top);
         } else {
            var0.canvas.setLocation(var0.field6205 * 1451619303, var0.field6206 * -673776453);
         }
   ...
   protected classMF method10959(byte var1) {
      try {
         if (this.field6226 == null) {
            this.field6226 = new MouseWheelHandler();
            this.field6226.method10740(this.canvas, 1087436969);
         }
   ...
   final void method10995(int var1) {
      ...
      try {
         ...
         if (null == var2) {
            ...
            client.method2139(-1);
            IntProjection.field1938 = Math.min(1525008759 * this.field6213, 697093715 * this.field6215) * 841518155;
            client.method2357(-1);
            ...
            if (var2 == this.field6221) {
               ...
               Insets var4 = this.field6221.getInsets();
               this.canvas.setLocation(1451619303 * this.field6215 + var4.left, -673776453 * this.field6217 + var4.top);
            } else {
               this.canvas.setLocation(this.field6214 * 1451619303, this.field6206 * -673776453);
            }
      ...
      try {
         ...
         if ((field6196 = field6200 + 2069175365) * 801347213 - 1 > 50) {
            ...
            if (var2 == this.field6221) {
               ...
               Insets var9 = this.field6221.getInsets();
               this.canvas.setLocation(var9.left + 1451619303 * this.field6218, var9.top + -673776453 * this.field6213);
            } else {
               this.canvas.setLocation(this.field6216 * 1451619303, this.field6217 * -673776453);
            }
         }
   ...
   @ObfuscatedSignature(descriptor = "(Ltq;II)V")
   @ObfuscatedName("he")
   public static void method10956(GameEngine var0, int var1, int var2) {
      if (1937290719 * var0.field6216 != var1 || var0.field6217 * 697093715 != var2) {
