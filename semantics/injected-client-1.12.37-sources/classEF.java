...
public class classEF {
   ...
   static void method3867(int var0, int var1, int var2, SpritePixels var3, byte var4) {
      try {
         ...
         throw classEG.newRunException(var23, "ef.ax(" + ')');
      }
   }
   ...
   public int method3850(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ef.af(" + 41);
      }
   }
   ...
   public classSG method3854(int var1, byte var2) {
      try {
         ...
         throw classEG.newRunException(var3, "ef.ae(" + ')');
      }
   }
   ...
   @ObfuscatedName("af")
   public static PacketBufferNode getPacketBufferNode(ClientPacket var0, classYT var1, byte var2) {
      try {
         PacketBufferNode var3 = SceneTilePaint.method4793(2062869276);
         var3.clientPacket = var0;
         var3.field3339 = -1950310809 * var0.length;
         ...
         var3.packetBuffer.method12894(var1, -1178783538);
         var3.packetBuffer.method12900(var3.clientPacket.id * 484572505, (byte)-68);
         var3.field3335 = 0;
         return var3;
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "ef.af(" + ')');
      }
   }
   ...
   public static void method3847(classEF var0, int var1) {
      ...
      try {
         ...
         throw classEG.newRunException(var5, "ef.az(" + ')');
      }
   }

   classEF(Buffer var1, int var2) {
      this.field1745 = new classSG[var2];
      this.field1744 = Buffer.method13039(var1, -346779531) * -983578009;
   ...
   public void method3865(classSN var1, int var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var4, "ef.ag(" + ')');
      }
   }
   ...
   public static classMH method3843(byte var0) {
      try {
         ...
         throw classEG.newRunException(var3, "ef.ax(" + ')');
      }
   }
   ...
   classSG[] method3860(int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "ef.ab(" + ')');
      }
   }
   ...
   static int method3870(int var0, Script var1, boolean var2, int var3) {
      try {
         ...
         throw classEG.newRunException(var9, "ef.bj(" + 41);
      }
   }
