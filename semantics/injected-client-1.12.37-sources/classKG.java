...
public class classKG {
   ...
   public static int method6472(int var0) {
      try {
         ...
         throw classEG.newRunException(var1, "kg.ae(" + 41);
      }
   }
   ...
   @ObfuscatedName("ax")
   static final void method6474(WorldView var0, Buffer var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
                  ...
                  if (var3 < var9[0].length - 1) {
                     ...
                     if (var4 >= 0) {
                        ...
                        if (var4 < var9[0][0].length - 1) {
                           ...
                           while (true) {
                              int var11 = Buffer.method13047(var1, -1095812026);
                              if (0 == var11) {
                                 if (var8 == -1316961501) {
                                    return;
                                 }
         ...
         throw classEG.newRunException(var18, "kg.ax(" + ')');
      }
   }
}
