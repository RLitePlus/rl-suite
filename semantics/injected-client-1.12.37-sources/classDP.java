...
public class classDP extends classDA {
   ...
   public static URLConnection method3517(classDP var0, classEY var1) throws IOException {
      ...
      if (!var0.field1596) {
         var2.setSSLSocketFactory(SecureRandomSSLSocketFactory.method9610(29970527));
      }
   ...
   void vmethod299(classEY var1, int var2) throws IOException {
      try {
         ...
         throw classEG.newRunException(var14, "dp.ab(" + ')');
      }
   }
   ...
   URLConnection method3513(classEY var1, int var2) throws IOException {
      try {
         ...
         throw classEG.newRunException(var4, "dp.bx(" + ')');
      }
   }

   @ObfuscatedSignature(descriptor = "(Ltq;I)V")
   @ObfuscatedName("ak")
   static void method3520(GameEngine var0, int var1) {
      try {
         ...
         if (1229235359 * MouseHandler.field6261 != 1) {
            if (var1 != -644062932) {
               throw new IllegalStateException();
            }
            ...
            if (4 != MouseHandler.field6261 * 1229235359) {
               return;
            }
         ...
         if (MouseHandler.field6266 * 1422993977 >= var4) {
            ...
            if (MouseHandler.field6266 * 1422993977 <= var4 + 14) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }

               if (1243590197 * MouseHandler.field6257 >= 4) {
                  if (var1 != -644062932) {
                     throw new IllegalStateException();
                  }

                  if (1243590197 * MouseHandler.field6257 <= 18) {
                     ServerPacket.method6373(0, 0, (byte)-55);
                     return;
                  }
               }
            }
         ...
         if (1422993977 * MouseHandler.field6266 >= var4 + 15) {
            ...
            if (MouseHandler.field6266 * 1422993977 <= var4 + 80 && 1243590197 * MouseHandler.field6257 >= 4) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }

               if (MouseHandler.field6257 * 1243590197 <= 18) {
                  if (var1 != -644062932) {
                     return;
                  }

                  ServerPacket.method6373(0, 1, (byte)108);
                  return;
               }
            }
         }
         ...
         if (MouseHandler.field6266 * 1422993977 >= var5) {
            ...
            if (1422993977 * MouseHandler.field6266 <= 14 + var5) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }
               ...
               if (1243590197 * MouseHandler.field6257 >= 4) {
                  ...
                  if (1243590197 * MouseHandler.field6257 <= 18) {
                     ...
                     ServerPacket.method6373(1, 0, (byte)-18);
                     return;
                  }
               }
            }
         ...
         if (1422993977 * MouseHandler.field6266 >= var5 + 15) {
            if (var1 != -644062932) {
               throw new IllegalStateException();
            }

            if (1422993977 * MouseHandler.field6266 <= var5 + 80) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }
               ...
               if (1243590197 * MouseHandler.field6257 >= 4) {
                  ...
                  if (1243590197 * MouseHandler.field6257 <= 18) {
                     ...
                     ServerPacket.method6373(1, 1, (byte)85);
                     return;
                  }
               }
            }
         ...
         if (MouseHandler.field6266 * 1422993977 >= var6) {
            ...
            if (MouseHandler.field6266 * 1422993977 <= 14 + var6 && MouseHandler.field6257 * 1243590197 >= 4 && 1243590197 * MouseHandler.field6257 <= 18) {
               if (var1 != -644062932) {
                  return;
               }

               ServerPacket.method6373(2, 0, (byte)14);
               return;
            }
         }

         if (1422993977 * MouseHandler.field6266 >= 15 + var6) {
            if (var1 != -644062932) {
               return;
            }

            if (MouseHandler.field6266 * 1422993977 <= var6 + 80 && MouseHandler.field6257 * 1243590197 >= 4) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }

               if (1243590197 * MouseHandler.field6257 <= 18) {
                  ServerPacket.method6373(2, 1, (byte)41);
                  return;
               }
            }
         }
         ...
         if (MouseHandler.field6266 * 1422993977 >= var7) {
            if (var1 != -644062932) {
               throw new IllegalStateException();
            }

            if (1422993977 * MouseHandler.field6266 <= var7 + 14) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }

               if (MouseHandler.field6257 * 1243590197 >= 4) {
                  if (var1 != -644062932) {
                     throw new IllegalStateException();
                  }
                  ...
                  if (1243590197 * MouseHandler.field6257 <= 18) {
                     ...
                     ServerPacket.method6373(3, 0, (byte)29);
                     return;
                  }
               }
            }
         ...
         if (MouseHandler.field6266 * 1422993977 >= var7 + 15) {
            if (var1 != -644062932) {
               throw new IllegalStateException();
            }

            if (MouseHandler.field6266 * 1422993977 <= 80 + var7 && 1243590197 * MouseHandler.field6257 >= 4) {
               if (var1 != -644062932) {
                  return;
               }
         ...
         if (MouseHandler.field6266 * 1422993977 >= 708 + classBF.field385 * -329898575
            && 1243590197 * MouseHandler.field6257 >= 4
            && MouseHandler.field6266 * 1422993977 <= classBF.field385 * -329898575 + 708 + 50) {
            if (var1 != -644062932) {
               throw new IllegalStateException();
            }

            if (1243590197 * MouseHandler.field6257 <= 20) {
               if (var1 != -644062932) {
                  throw new IllegalStateException();
               }
         ...
         if (-1 != classBF.field400 * -2105609177) {
            ...
            if (classBF.field408 * -942812997 > 0) {
               ...
               if (ChatChannel.field590 != null) {
                  ...
                  if (MouseHandler.field6266 * 1422993977 >= 0 && MouseHandler.field6266 * 1422993977 <= ChatChannel.field590.field7121) {
                     if (var1 != -644062932) {
                        throw new IllegalStateException();
                     }

                     if (1243590197 * MouseHandler.field6257 >= 8379747 * IntProjection.field1938 / 2 - 50) {
                        if (var1 != -644062932) {
                           throw new IllegalStateException();
                        }

                        if (MouseHandler.field6257 * 1243590197 <= 50 + 8379747 * IntProjection.field1938 / 2) {
                           if (var1 != -644062932) {
                              return;
                           }
            ...
            if (-942812997 * classBF.field408 < classBF.field409 * -343302073) {
               ...
               if (classUR.field6374 != null) {
                  ...
                  if (1422993977 * MouseHandler.field6266 >= 773246731 * classSA.field5897 - classUR.field6374.field7121 - 5) {
                     if (var1 != -644062932) {
                        return;
                     }

                     if (1422993977 * MouseHandler.field6266 <= classSA.field5897 * 773246731) {
                        if (var1 != -644062932) {
                           throw new IllegalStateException();
                        }

                        if (MouseHandler.field6257 * 1243590197 >= IntProjection.field1938 * 8379747 / 2 - 50) {
                           if (var1 != -644062932) {
                              throw new IllegalStateException();
                           }

                           if (MouseHandler.field6257 * 1243590197 <= 50 + IntProjection.field1938 * 8379747 / 2) {
                              classBF.field408 += -1581517709;
                           }
                        }
                     }
         ...
         throw classEG.newRunException(var14, "dp.ak(" + ')');
      }
   }
   ...
   URLConnection method3518(classEY var1, int var2) throws IOException {
      try {
         ...
         if (!this.field1596) {
            ...
            var3.setSSLSocketFactory(SecureRandomSSLSocketFactory.method9610(828442215));
         }

         this.method2862(var3, (byte)50);
         return var3;
      } catch (RuntimeException var4) {
         throw classEG.newRunException(var4, "dp.bc(" + ')');
      }
   }
   ...
   URLConnection method3519(classEY var1) throws IOException {
      HttpsURLConnection var2 = (HttpsURLConnection)var1.field1981.openConnection();
      if (!this.field1596) {
         var2.setSSLSocketFactory(SecureRandomSSLSocketFactory.method9610(1975161598));
      }
   ...
   static int method3511(String var0, int var1) {
      try {
         ...
         throw classEG.newRunException(var2, "dp.af(" + 41);
      }
   }

   @ObfuscatedSignature(descriptor = "(Lva;I)V")
   @ObfuscatedName("az")
   public static void method3510(AbstractArchive var0, int var1) {
      try {
         ;
      } catch (RuntimeException var2) {
         throw classEG.newRunException(var2, "dp.az(" + ')');
      }
   }
}
